...
execute store result storage luigis_mansion:data current_state.my_money.money.red_diamond int 1 run scoreboard players add #temp Time 1
...
execute store result storage luigis_mansion:data current_state.my_money_data.money.red_diamond int 1 run scoreboard players add #temp Time 1
