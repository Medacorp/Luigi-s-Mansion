execute positioned ~-0.5 ~-0.5 ~-0.5 run tag @e[dx=0,dy=0,dz=0,tag=portrait_ghost,tag=!scan_ignore,limit=1] add target
execute positioned ~-0.5 ~-0.5 ~-0.5 run tag @e[dx=0,dy=0,dz=0,tag=toad,tag=!scan_ignore,limit=1] add target
execute positioned ~-0.5 ~-0.5 ~-0.5 run tag @e[dx=0,dy=0,dz=0,tag=e_gadd,tag=!scan_ignore,limit=1] add target
execute positioned ~-0.5 ~-0.5 ~-0.5 run tag @a[dx=0,dy=0,dz=0,gamemode=!spectator,limit=1,tag=!scanning_player] add target
