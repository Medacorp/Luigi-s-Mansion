...
execute if entity @s[tag=!catch_portrait_ghost,tag=!catch_ghost] as @a[tag=same_room] if entity @s[scores={MusicType=28..29}] run function luigis_mansion:other/music/set/silence
