...
execute if entity @s[scores={Dialog=856}] run tellraw @a[tag=same_room,gamemode=!spectator] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mysterious_power","color":"green"},{"translate":"luigis_mansion:dialog.mysterious_power.4"}]}
...
execute if entity @s[scores={Dialog=1398}] run teleport @a[tag=same_room,gamemode=!spectator] 751.0 11 7.0
...
execute if entity @s[scores={Dialog=1624}] if score #players Totals matches 1 run tellraw @a[tag=same_room,gamemode=!spectator] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mysterious_power","color":"green"},{"translate":"luigis_mansion:dialog.mysterious_power.repeat.3"}]}
execute if entity @s[scores={Dialog=1624}] if score #players Totals matches 2.. run tellraw @a[tag=same_room,gamemode=!spectator] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mysterious_power","color":"green"},{"translate":"luigis_mansion:dialog.mysterious_power.repeat.3.more"}]}
execute if entity @s[scores={Dialog=1704}] run tellraw @a[tag=same_room,gamemode=!spectator] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mysterious_power","color":"green"},{"translate":"luigis_mansion:dialog.mysterious_power.repeat.4"}]}
...
execute if entity @s[scores={Dialog=1782}] run teleport @a[tag=same_room,gamemode=!spectator] 751.0 11 7.0
...
execute if entity @s[scores={Dialog=1996}] run teleport @a[tag=same_room,gamemode=!spectator] 751.0 11 7.0
