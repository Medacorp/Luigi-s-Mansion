...
execute if entity @s[scores={Dialog=776}] run data modify storage luigis_mansion:data current_state.current_data.technical_data merge value {portrait_ghosts:1b}
