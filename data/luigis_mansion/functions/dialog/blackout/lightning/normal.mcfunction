...
execute if entity @s[scores={Time=70..}] run function luigis_mansion:dialog/blackout/lightning/particles_normal
execute if entity @s[scores={Time=130}] as @e[type=!minecraft:player,limit=1] run function luigis_mansion:dialog/blackout/lightning/reset_normal
