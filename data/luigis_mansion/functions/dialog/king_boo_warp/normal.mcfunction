...
execute if entity @s[scores={Dialog=840}] if score @s Boos matches 39 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.13.1"}]}
execute if entity @s[scores={Dialog=840}] if score @s Boos matches 38 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.13.2"}]}
execute if entity @s[scores={Dialog=840}] if score @s Boos matches 37 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.13.3"}]}
execute if entity @s[scores={Dialog=840}] if score @s Boos matches 36 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.13.4"}]}
execute if entity @s[scores={Dialog=840}] if score @s Boos matches 35 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.13.5"}]}
...
execute if entity @s[scores={Dialog=920}] if score @s Boos matches 35..37 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.14"}]}
execute if entity @s[scores={Dialog=920}] if score @s Boos matches 35..37 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.14.more"}]}
execute if entity @s[scores={Dialog=920}] unless score @s Boos matches 35..37 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.king_boo","color":"green"},{"translate":"luigis_mansion:dialog.king_boo_warp.14.alt"}]}
...
execute if entity @s[scores={Dialog=980}] run teleport @a[tag=warp_target] 751.0 11 9.0
