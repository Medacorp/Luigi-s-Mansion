...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.clock.coo_coo block @a[scores={Room=49}] 693 121 18.0 1
execute if score #temp Searched matches 10 run playsound luigis_mansion:block.clock.door block @a[scores={Room=49}] 693 121 18.0 1
