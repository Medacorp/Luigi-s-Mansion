...
execute unless block 714 12 73 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/laundry_room/search_washing_machine