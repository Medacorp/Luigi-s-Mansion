...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=55}] 752 29 41.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=56}] 749 29 35.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=55}] 752 29 41.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=56}] 749 29 35.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=752.0,y=29,z=41.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=752.0,y=29,z=41.0,dx=0,dy=1,dz=0] run teleport @s 749 29 33
execute if score #temp Searched matches 1..2 as @a[x=749.0,y=29,z=34.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=749.0,y=29,z=34.0,dx=0,dy=1,dz=0] run teleport @s 752 29 42
