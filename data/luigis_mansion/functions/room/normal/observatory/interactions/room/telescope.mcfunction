...
execute if score #observatory_telescope Searching matches 20 if block 645 24 -78 minecraft:redstone_lamp run function luigis_mansion:room/normal/observatory/search_telescope