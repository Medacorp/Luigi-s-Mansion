...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 643 12 -33 run function luigis_mansion:room/normal/rec_room/threadmill
