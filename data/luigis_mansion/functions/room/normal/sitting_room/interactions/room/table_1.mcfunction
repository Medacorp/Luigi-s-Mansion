...
execute unless block 746 20 -21 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/sitting_room/search_table_1
execute unless block 746 21 -21 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/sitting_room/search_table_1