...
execute positioned 643 20 67.0 run function luigis_mansion:blocks/dust
scoreboard players set #tea_room_table_2 Searched 1
tag @e[x=643.5,y=20,z=66.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=643.5,y=20,z=66.5,distance=..0.7,tag=ghost,tag=hidden] add spawn