...
execute if score #temp Searched matches 1..2 as @a[x=673.0,y=20,z=-16.0,dx=0,dy=1,dz=0] run teleport @s 658 20 18
execute if score #temp Searched matches 1..2 as @a[x=658.0,y=20,z=17.0,dx=0,dy=1,dz=0] run teleport @s 673 20 -17
