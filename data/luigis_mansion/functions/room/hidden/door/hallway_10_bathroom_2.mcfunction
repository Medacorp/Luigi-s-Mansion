...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=36}] 673 20 4.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=43}] 654 20 -0.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=36}] 673 20 4.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=43}] 654 20 -0.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=673.0,y=20,z=4.0,dx=0,dy=1,dz=0] run teleport @s 654 20 -2
execute if score #temp Searched matches 1..2 as @a[x=654.0,y=20,z=-1.0,dx=0,dy=1,dz=0] run teleport @s 673 20 5
