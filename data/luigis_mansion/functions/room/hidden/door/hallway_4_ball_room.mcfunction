...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=12}] 706 11 38.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=17}] 705 11 53.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=12}] 706 11 38.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=17}] 705 11 53.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=37.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=37.0,dx=0,dy=1,dz=0] run teleport @s 705 11 54
execute if score #temp Searched matches 1..2 as @a[x=705.0,y=11,z=53.0,dx=0,dy=1,dz=0] run teleport @s 706 11 36
