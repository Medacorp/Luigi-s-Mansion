...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=743.0,y=11,z=7.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{hallway_3:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_3:1b} positioned 743 11 7.0 run function luigis_mansion:room/hidden/hallway_3/unlock_door
execute if block 743 11 7 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_3:1b} positioned 743 11 7 run function luigis_mansion:blocks/closed_door
execute if block 743 11 6 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_3:1b} positioned 743 11 6 run function luigis_mansion:blocks/closed_door
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=11}] 721.0 11 21.0 1 1
...
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=11}] 721.0 11 21.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=743.0,y=11,z=6.0,dx=0,dy=1,dz=1] run teleport @s 718 11 21.0
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=11,z=20.0,dx=0,dy=1,dz=1] run teleport @s 744 11 7.0
