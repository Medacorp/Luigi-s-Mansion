...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=739.5,y=20,z=-3.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{hallway_2:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_2:1b} positioned 739 20 -3 run function luigis_mansion:room/hidden/hallway_2/unlock_door
execute if block 739 20 -3 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_2:1b} positioned 739 20 -3 run function luigis_mansion:blocks/closed_door
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=2}] 739 20 -3.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=7}] 726 20 -26.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=2}] 739 20 -3.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=7}] 726 20 -26.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=739.0,y=20,z=-3.0,dx=0,dy=1,dz=0] run teleport @s 726 20 -28
execute if score #temp Searched matches 1..2 as @a[x=726.0,y=20,z=-27.0,dx=0,dy=1,dz=0] run teleport @s 739 20 -2
