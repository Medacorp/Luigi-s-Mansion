...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=60}] 700.0 2 33 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=61}] 686.0 2 33 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=60}] 700.0 2 33 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=61}] 686.0 2 33 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=700.0,y=2,z=33.0,dx=0,dy=1,dz=0] run teleport @s 684 2 33
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=2,z=33.0,dx=0,dy=1,dz=0] run teleport @s 701 2 33
