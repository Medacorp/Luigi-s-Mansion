...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=58}] 741 2 58.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=59}] 726 2 37.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=58}] 741 2 58.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=59}] 726 2 37.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=2,z=58.0,dx=0,dy=1,dz=0] run teleport @s 726 2 35
execute if score #temp Searched matches 1..2 as @a[x=726.0,y=2,z=36.0,dx=0,dy=1,dz=0] run teleport @s 741 2 59
