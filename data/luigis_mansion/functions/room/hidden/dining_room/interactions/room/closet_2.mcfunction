...
execute unless block 699 12 -20 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/dining_room/search_closet_2
execute unless block 699 12 -18 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/dining_room/search_closet_2