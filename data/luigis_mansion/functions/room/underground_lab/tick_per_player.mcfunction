execute unless entity @s[x=788,y=90,z=21,dx=1,dy=1,dz=0] unless entity @s[scores={MusicGroup=0,MusicType=2}] unless entity @s[scores={MusicGroup=0,MusicType=-1}] run function luigis_mansion:other/music/set/lab
