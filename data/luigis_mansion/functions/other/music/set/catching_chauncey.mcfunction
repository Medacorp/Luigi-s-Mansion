...
execute unless entity @s[scores={MusicGroup=0,MusicType=32}] run scoreboard players set @s[tag=catching_chauncey] Music 0
execute unless entity @s[scores={MusicGroup=0,MusicType=32}] run scoreboard players set @s[tag=catching_chauncey] MusicType 32
