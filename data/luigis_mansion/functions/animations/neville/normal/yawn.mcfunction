...
data merge entity @s[scores={AnimationProg=1}] {Pose:{RightArm:[-10.0f,20.0f,0.01f],LeftArm:[-50.0f,0.01f,0.0f],Head:[10.0f,0.01f,20.0f]}}
...
execute if entity @s[scores={AnimationProg=1..30}] store result entity @s Pose.LeftArm[0] float 1 run scoreboard players add #temp Time 1
execute if entity @s[scores={AnimationProg=31..60}] store result entity @s Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 1
