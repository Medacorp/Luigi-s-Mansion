...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=floating_whirlindas_right_arm,limit=1] {Pose:{Head:[0.0f,0.01f,90.01f]}}
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=floating_whirlindas_left_arm,limit=1] {Pose:{Head:[0.0f,0.01f,-90.01f]}}
...
execute if entity @s[scores={AnimationProg=1..10}] store result entity @e[tag=this_model,tag=floating_whirlindas_right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=floating_whirlindas_right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 2
...
execute if entity @s[scores={AnimationProg=1..10}] store result entity @e[tag=this_model,tag=floating_whirlindas_left_arm,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=floating_whirlindas_left_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 2
