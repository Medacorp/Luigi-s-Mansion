...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=mr_luggs_right_arm,limit=1] {Pose:{Head:[-70.0f,0.0f,0.01f]}}
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=mr_luggs_left_arm,limit=1] {Pose:{Head:[-70.0f,0.0f,0.01f]}}
