...
execute if entity @s[scores={Dialog=100}] run teleport @s ~ ~ ~ facing 689 111.6 42
execute if entity @s[scores={Dialog=110}] run teleport @s ~ ~ ~ facing 685 111.6 42
execute if entity @s[scores={Dialog=136}] run teleport @s ~ ~ ~ facing 685 111.6 45
execute if entity @s[scores={Dialog=136..163}] run fill 684 112 42 684 115 ~ minecraft:white_wool
execute if entity @s[scores={Dialog=163}] run teleport @s ~ ~ ~ facing 689 111.6 43
execute if entity @s[scores={Dialog=197}] run teleport @s ~ ~ ~ facing 690 111.6 41
