...
summon minecraft:marker 645 20 52 {Tags:["choice"]}
summon minecraft:marker 641 20 56 {Tags:["choice"]}
summon minecraft:marker 645 20 56 {Tags:["choice"]}
summon minecraft:marker 641 20 65 {Tags:["choice"]}
summon minecraft:marker 645 20 65 {Tags:["choice"]}
...
summon minecraft:marker 643 20 66 {Tags:["choice"]}
