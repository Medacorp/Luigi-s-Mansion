...
execute at @s[tag=!hurt,tag=!fleeing,tag=!collided,tag=!vanish,scores={StunTime=0},tag=!carless] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
