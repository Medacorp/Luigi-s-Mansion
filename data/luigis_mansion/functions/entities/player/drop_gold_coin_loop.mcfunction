...
execute if score #temp2 LastTotalDamage matches 0 if score #temp ActionTime matches 1.. positioned ~ ~2 ~ run function luigis_mansion:entities/player/drop_gold_coin
