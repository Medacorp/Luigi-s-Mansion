...
execute if entity @s[scores={Dialog=333}] at @e[tag=same_room,tag=!spectator] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
...
execute if entity @s[scores={Dialog=334..}] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
