execute if entity @s[tag=dead,tag=normal_death] run playsound luigis_mansion:entity.haunted_book.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead,tag=element_death] run playsound luigis_mansion:entity.haunted_book.element_death hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead] run function luigis_mansion:entities/haunted_book/drop_loot
...
execute if entity @s[scores={WaitTime=60..},tag=!moving] run playsound luigis_mansion:entity.haunted_book.spawn hostile @a[tag=same_room] ~ ~ ~ 1
