...
execute if entity @s[tag=was_activated,tag=!fleeing,tag=!complain,tag=!attack,tag=!windless,scores={WaitTime=0}] positioned ^ ^ ^0.7 if entity @e[tag=same_room,tag=!spectator,distance=..0.7,limit=1] run tag @s add attack
...
execute at @s[tag=was_activated,tag=!attack,tag=!complain,scores={Distance=0,WaitTime=0}] run function luigis_mansion:entities/clockwork_soldier/target
execute at @s[tag=was_activated,tag=!attack,tag=!complain,scores={Distance=1..,WaitTime=0}] run function luigis_mansion:entities/clockwork_soldier/move
execute if entity @s[tag=was_activated,tag=!attack,tag=complain] run function luigis_mansion:entities/clockwork_soldier/complain
