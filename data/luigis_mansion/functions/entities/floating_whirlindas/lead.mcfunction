...
execute if entity @s[scores={Dialog=..300}] at @a[tag=same_room,gamemode=!spectator] unless entity @e[tag=ball_floor,distance=..4.999999,limit=1] run function luigis_mansion:entities/floating_whirlindas/turn_invisible
execute if entity @s[scores={Dialog=..300}] at @a[tag=same_room,gamemode=!spectator] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:entities/floating_whirlindas/turn_invisible

execute if entity @s[scores={Dialog=1}] positioned ^ ^ ^-0.7 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[scores={Dialog=1}] positioned ^ ^ ^0.7 run teleport @e[tag=this_model,tag=floating_whirlindas_female,limit=1] ~ ~ ~ ~-180 ~
...
execute if entity @s[scores={Dialog=..299}] if score #mirrored Selected matches 0 rotated ~4 ~ positioned ^ ^ ^0.7 as @e[tag=this_model,tag=floating_whirlindas_female,limit=1] run teleport @s ~ ~ ~ facing ^ ^ ^-0.5
execute if entity @s[scores={Dialog=..299}] if score #mirrored Selected matches 1 rotated ~-4 ~ positioned ^ ^ ^0.7 as @e[tag=this_model,tag=floating_whirlindas_female,limit=1] run teleport @s ~ ~ ~ facing ^ ^ ^-0.5
...
execute if entity @s[scores={Dialog=300..319}] if score #mirrored Selected matches 0 positioned ^ ^ ^0.7 as @e[tag=this_model,tag=floating_whirlindas_female,limit=1] rotated as @s run teleport @s ~ ~ ~ ~18 ~
