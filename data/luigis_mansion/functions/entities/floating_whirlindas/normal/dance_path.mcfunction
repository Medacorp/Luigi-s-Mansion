execute if entity @s[x=700.5,y=11,z=-54.0,distance=..0.7] run scoreboard players set @s PathStep 1
execute if entity @s[x=699.5,y=11,z=-44.5,distance=..0.7,scores={PathStep=1}] run scoreboard players set @s PathStep 2
execute if entity @s[x=702.5,y=11,z=-41.5,distance=..0.7,scores={PathStep=2}] run scoreboard players set @s PathStep 3
execute if entity @s[x=704.0,y=11,z=-44.0,distance=..0.7,scores={PathStep=3}] run scoreboard players set @s PathStep 4
execute if entity @s[x=700.5,y=11,z=-46.5,distance=..0.7,scores={PathStep=4}] run scoreboard players set @s PathStep 5
execute if entity @s[x=704.5,y=11,z=-50.0,distance=..0.7,scores={PathStep=5}] run scoreboard players set @s PathStep 6
execute if entity @s[x=705.5,y=11,z=-46.5,distance=..0.7,scores={PathStep=6}] run scoreboard players set @s PathStep 7
execute if entity @s[x=704.0,y=11,z=-44.0,distance=..0.7,scores={PathStep=7}] run scoreboard players set @s PathStep 8
execute if entity @s[x=705.5,y=11,z=-41.5,distance=..0.7,scores={PathStep=8}] run scoreboard players set @s PathStep 9
execute if entity @s[x=708.5,y=11,z=-44.5,distance=..0.7,scores={PathStep=9}] run scoreboard players set @s PathStep 10
execute if entity @s[x=707.0,y=11,z=-47.0,distance=..0.7,scores={PathStep=10}] run scoreboard players set @s PathStep 11
execute if entity @s[x=704.5,y=11,z=-44.5,distance=..0.7,scores={PathStep=11}] run scoreboard players set @s PathStep 12
execute if entity @s[x=702.5,y=11,z=-47.0,distance=..0.7,scores={PathStep=12}] run scoreboard players set @s PathStep 13
execute if entity @s[x=704.5,y=11,z=-47.5,distance=..0.7,scores={PathStep=13}] run scoreboard players set @s PathStep 14
execute if entity @s[x=707.0,y=11,z=-47.0,distance=..0.7,scores={PathStep=14}] run scoreboard players set @s PathStep 15
execute if entity @s[x=708.5,y=11,z=-47.5,distance=..0.7,scores={PathStep=15}] run scoreboard players set @s PathStep 16
execute if entity @s[x=708.5,y=11,z=-53.5,distance=..0.7,scores={PathStep=16}] run scoreboard players set @s PathStep 17
execute if entity @s[x=706.5,y=11,z=-55.5,distance=..0.7,scores={PathStep=17}] run scoreboard players set @s PathStep 18
execute if entity @s[x=702.5,y=11,z=-55.5,distance=..0.7,scores={PathStep=18}] run scoreboard players set @s PathStep 19
execute if entity @s[x=699.5,y=11,z=-58.5,distance=..0.7,scores={PathStep=19}] run scoreboard players set @s PathStep 20
execute if entity @s[x=699.5,y=11,z=-61.5,distance=..0.7,scores={PathStep=20}] run scoreboard players set @s PathStep 21
execute if entity @s[x=701.5,y=11,z=-63.5,distance=..0.7,scores={PathStep=21}] run scoreboard players set @s PathStep 22
execute if entity @s[x=704.0,y=11,z=-61.5,distance=..0.7,scores={PathStep=22}] run scoreboard players set @s PathStep 23
execute if entity @s[x=706.5,y=11,z=-63.5,distance=..0.7,scores={PathStep=23}] run scoreboard players set @s PathStep 24
execute if entity @s[x=708.5,y=11,z=-62.0,distance=..0.7,scores={PathStep=24}] run scoreboard players set @s PathStep 25
