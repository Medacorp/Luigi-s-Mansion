...
execute at @s[scores={PathStep=73..93}] facing 745 11.6 66 run function luigis_mansion:entities/shivers/move_forward
...
teleport @s[tag=disappear,scores={PathStep=..93}] 682 11.6 0
teleport @s[tag=disappear,scores={PathStep=93..}] 738 11.6 61
