...
scoreboard players set @s[x=682.5,y=11,z=29.5,distance=..0.7,scores={PathStep=1}] PathStep 2
...
teleport @s[scores={PathStep=47}] ~ ~ ~ facing 716 11 -9
scoreboard players set @s[x=716.5,y=11,z=-8.5,distance=..0.7,scores={PathStep=47}] PathStep 48
teleport @s[x=716.0,y=11,z=-9.0,dx=0,dy=1,dz=0] 726 11 -43
execute at @s run teleport @s[scores={PathStep=48}] ~ ~ ~ facing 716 11 -50
scoreboard players set @s[x=716.5,y=11,z=-49.5,distance=..0.7,scores={PathStep=48}] PathStep 49
teleport @s[scores={PathStep=49}] ~ ~ ~ facing 719 11 -50
scoreboard players set @s[x=719.5,y=11,z=-49.5,distance=..0.7,scores={PathStep=49}] PathStep 50
teleport @s[x=719.0,y=11,z=-50.0,dx=0,dy=1,dz=0] 738 11 -46
execute at @s run teleport @s[scores={PathStep=50}] ~ ~ ~ facing 740 11 -46
scoreboard players set @s[x=740.5,y=11,z=-45.5,distance=..0.7,scores={PathStep=50}] PathStep 51
teleport @s[scores={PathStep=51}] ~ ~ ~ facing 742 11 -54
scoreboard players set @s[x=742.5,y=11,z=-53.5,distance=..0.7,scores={PathStep=51}] PathStep 52
teleport @s[scores={PathStep=52}] ~ ~ ~ facing 745 11 -52
execute if entity @s[scores={PathStep=53..}] run scoreboard players add @s PathStep 1
scoreboard players set @s[x=745.5,y=11,z=-51.5,distance=..0.7,scores={PathStep=52}] PathStep 53
...
execute at @s[scores={PathStep=73..93}] facing 745 11 -51 run function luigis_mansion:entities/shivers/move_forward
...
teleport @s[tag=disappear,scores={PathStep=..93}] 682 11 26
teleport @s[tag=disappear,scores={PathStep=93..}] 739 11 -46
