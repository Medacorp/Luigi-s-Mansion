...
execute if entity @s[tag=!spawned_heart,tag=!hidden] unless entity @s[tag=!burning_heart,tag=!watery_heart,tag=!frozen_heart] run function luigis_mansion:entities/ghost/spawn_heart
