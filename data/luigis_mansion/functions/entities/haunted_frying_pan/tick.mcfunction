execute if entity @s[tag=dead,tag=normal_death] run playsound luigis_mansion:entity.haunted_frying_pan.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead,tag=element_death] run playsound luigis_mansion:entity.haunted_frying_pan.element_death hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead] run function luigis_mansion:entities/haunted_frying_pan/drop_loot
...
execute if entity @s[scores={WaitTime=60..},tag=!moving] run playsound luigis_mansion:entity.haunted_frying_pan.spawn hostile @a[tag=same_room] ~ ~ ~ 1
