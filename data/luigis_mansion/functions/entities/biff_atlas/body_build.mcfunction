...
execute if entity @s[scores={Dialog=81}] positioned ^ ^ ^0.7 if entity @e[tag=same_room,tag=!spectator,distance=..0.7,limit=1] at @s run function luigis_mansion:entities/biff_atlas/attack
