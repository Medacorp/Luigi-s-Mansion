...
execute at @s[tag=yawn,tag=!vanish] run function luigis_mansion:animations/neville/yawn
execute at @s[tag=!yawn,tag=!vanish] run function luigis_mansion:animations/neville/idle