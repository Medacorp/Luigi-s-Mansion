...
execute store result score @s HomeX run data get entity @e[type=minecraft:marker,tag=new,limit=1] Pos[0] 100
execute store result score @s HomeZ run data get entity @e[type=minecraft:marker,tag=new,limit=1] Pos[2] 100
