...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.biff_atlas"}',Invisible:1b,NoGravity:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","found_owner","biff_atlas_body","this_entity"],DisabledSlots:2039583}
...
scoreboard players operation @e[tag=model_piece,tag=this_entity,limit=1] GhostNr = @e[tag=biff_atlas,tag=this_entity,limit=1] GhostNr
