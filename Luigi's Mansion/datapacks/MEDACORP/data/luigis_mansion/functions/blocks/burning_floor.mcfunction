...
data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:burning_floor",amount:10,knockback:"burn",no_delete:1b}
execute at @a[gamemode=!spectator,distance=..1.5] run function luigis_mansion:entities/player/take_damage
