...
execute if entity @s[tag=dying,scores={DeathTime=1}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"black_bogmire"}}}}]}] add remove_from_existence
...
execute if entity @s[tag=dead] run function luigis_mansion:old_entities/bogmire/at_death
...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!flee,tag=!dying] run playsound luigis_mansion:entity.bogmire.hurt hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={HurtTime=1},tag=hurt,tag=!flee,tag=!dying] Sound 40
execute if entity @s[scores={Sound=0},tag=flee,tag=!dying] run playsound luigis_mansion:entity.bogmire.flee hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0},tag=flee,tag=!dying] Sound 40
execute if entity @s[scores={Sound=0},tag=!hurt,tag=!flee,tag=visible] run playsound luigis_mansion:entity.bogmire.ambient hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0},tag=!hurt,tag=!flee,tag=visible] Sound 30

execute if entity @s[tag=!flee,tag=!hurt,tag=!vanish,scores={StunTime=0}] run function #luigis_mansion:entities/bogmire/tick

execute at @s[tag=vanish] run function luigis_mansion:old_entities/bogmire/vanish
execute at @s[tag=flee,tag=!second_flee_state] run function luigis_mansion:old_animations/bogmire/flee
execute at @s[tag=flee,tag=second_flee_state] run function luigis_mansion:old_entities/bogmire/second_flee_state
execute at @s[tag=!flee,tag=hurt] run tag @e[tag=bogmires_shadow] add dead
execute at @s[tag=!flee,tag=hurt] run function luigis_mansion:old_animations/bogmire/hurt
