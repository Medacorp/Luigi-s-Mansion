...
execute at @s if block ~ 15 ~ minecraft:lime_wool if block ^ ^ ^1 #luigis_mansion:all_ignore run function luigis_mansion:old_entities/ghost/turn_visible
execute at @s if block ~ 15 ~ minecraft:lime_wool if block ^ ^ ^1 #luigis_mansion:all_ignore run function luigis_mansion:old_entities/bogmire/spawn_shadow