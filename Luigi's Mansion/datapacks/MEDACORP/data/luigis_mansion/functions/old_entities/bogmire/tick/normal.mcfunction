execute at @s[scores={Room=29},tag=!vanish] run function luigis_mansion:old_entities/bogmire/tick/intro/normal
execute at @s[scores={Room=74},tag=!vanish] run function luigis_mansion:old_entities/bogmire/tick/fight/normal
