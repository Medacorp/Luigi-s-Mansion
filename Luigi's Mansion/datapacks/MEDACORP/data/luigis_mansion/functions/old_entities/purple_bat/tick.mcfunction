...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!dead,tag=!removed_from_existence] run function luigis_mansion:old_entities/purple_bat/collide
...
execute if entity @s[tag=attack,tag=!targetted,tag=!turn_back] run function luigis_mansion:old_entities/purple_bat/target
execute if entity @s[tag=turn_back,tag=!dead] run function luigis_mansion:old_entities/purple_bat/return
execute if entity @s[tag=targetted,tag=!dead] run function luigis_mansion:old_entities/purple_bat/move
execute if entity @s[tag=returned,tag=!dead] run function luigis_mansion:old_entities/purple_bat/returned
