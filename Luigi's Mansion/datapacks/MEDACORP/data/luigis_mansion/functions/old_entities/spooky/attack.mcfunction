...
execute at @s[scores={ActionTime=1..19}] run function luigis_mansion:old_entities/ghost/move_forward
...
execute if entity @s[scores={ActionTime=30}] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"bite"},amount:0,animation:"knockback/bite",attacker:-1}
...
execute at @s[scores={ActionTime=53..92}] rotated ~-180 0 run function luigis_mansion:old_entities/ghost/move_forward
