...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!in_vacuum,tag=!can_spit_2,tag=!spit] if entity @s[tag=!dead,tag=!removed_from_existence] run function luigis_mansion:old_entities/shining_ghost/collide
...
execute if entity @s[tag=spit] run function luigis_mansion:old_entities/shining_ghost/spit
...
execute if entity @s[tag=!in_vacuum,tag=!spit] run function luigis_mansion:old_entities/shining_ghost/move
execute if entity @s[tag=collision,tag=spit] run function luigis_mansion:old_entities/shining_ghost/capture
...
execute at @s[tag=in_vacuum] unless entity @a[distance=..1.5,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=player,tag=vacuuming] feet run teleport @s ^ ^ ^0.3 ~ ~
execute at @s[tag=in_vacuum] at @p[distance=..1.5,tag=!spectator,tag=player,tag=vacuuming] positioned ~ ~0.5 ~ run teleport @s ^ ^ ^0.3 ~ ~
...
execute if entity @s[tag=disappear] positioned ~ ~0.7 ~ run function luigis_mansion:old_entities/shining_ghost/back_to_start
