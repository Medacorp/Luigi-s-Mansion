...
execute if entity @s[tag=hit] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"water"},amount:10,animation:"knockback/soak",attacker:-1,no_delete:1b}
