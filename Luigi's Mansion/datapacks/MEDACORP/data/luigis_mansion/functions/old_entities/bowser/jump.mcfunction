...
scoreboard players set @s[scores={ActionTime=21}] AnimationProgress 0
...
scoreboard players set @s[scores={ActionTime=41..50}] AnimationProgress 0
...
scoreboard players set @s[scores={ActionTime=73..100}] AnimationProgress 0
...
scoreboard players set @s[scores={ActionTime=101}] AnimationProgress 0
