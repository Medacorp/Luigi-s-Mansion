...
execute if entity @s[scores={ActionTime=90}] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"swallow"},amount:30,animation:"knockback/large",attacker:-1}
