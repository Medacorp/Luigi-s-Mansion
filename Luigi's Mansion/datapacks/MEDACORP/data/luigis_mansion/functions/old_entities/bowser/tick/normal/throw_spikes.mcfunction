...
execute if entity @s[scores={ActionTime=40}] rotated ~-15 0 positioned ^-2 ^ ^1 run function luigis_mansion:old_entities/bowser/throw_spike
execute if entity @s[scores={ActionTime=50}] run playsound luigis_mansion:entity.bowser.throw hostile @a[tag=same_room] ~ ~ ~ 3
execute if entity @s[scores={ActionTime=50}] rotated ~12 0 positioned ^2 ^ ^1 run function luigis_mansion:old_entities/bowser/throw_spike
execute if entity @s[scores={ActionTime=60}] run playsound luigis_mansion:entity.bowser.throw_last hostile @a[tag=same_room] ~ ~ ~ 3
execute if entity @s[scores={ActionTime=60}] rotated ~-5 0 positioned ^-2 ^ ^1 run function luigis_mansion:old_entities/bowser/throw_spike
