...
execute if entity @s[scores={Dialog=..330}] as @a[tag=same_room] at @s run function luigis_mansion:old_entities/bowser/freeze_player
...
execute if entity @s[scores={Dialog=220..329}] if score #mirrored Selected matches 0 at @e[tag=this_model,tag=right_leg] positioned ^0.63 ^ ^0.7 as @a[tag=same_room,scores={IdleTime=-21}] at @s positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] at @s rotated ~5 0 positioned ^ ^ ^-0.1 run function luigis_mansion:entities/player/animation/scare/bash_force_move
execute if entity @s[scores={Dialog=220..329}] if score #mirrored Selected matches 1 at @e[tag=this_model,tag=right_leg] positioned ^0.63 ^ ^0.7 as @a[tag=same_room,scores={IdleTime=-21}] at @s positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] positioned ^ ^ ^1 unless entity @e[tag=this_model,distance=..3,limit=1] at @s rotated ~-5 0 positioned ^ ^ ^-0.1 run function luigis_mansion:entities/player/animation/scare/bash_force_move
execute if entity @s[scores={Dialog=220..329}] at @e[tag=this_model,tag=right_leg] positioned ^0.63 ^ ^0.7 as @a[tag=same_room,scores={IdleTime=-21},distance=..9] at @s positioned ^ ^ ^5 if entity @e[tag=this_model,distance=..5,limit=1] at @s facing entity @e[tag=bowser,scores={Dialog=220..329},limit=1] feet rotated ~ 0 positioned ^ ^ ^-0.1 run function luigis_mansion:entities/player/animation/scare/bash_force_move
