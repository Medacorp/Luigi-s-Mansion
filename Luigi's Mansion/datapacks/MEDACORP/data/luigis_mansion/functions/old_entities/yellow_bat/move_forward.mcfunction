...
execute if score #temp Move matches 1.. positioned as @s[tag=!returned] unless entity @s[tag=turn_back,tag=targetted] run function luigis_mansion:old_entities/yellow_bat/move_forward