...
execute store result score #temp Time run data get storage luigis_mansion:data entity.loot.contents.luigis_mansion.red_ruby
execute store result storage luigis_mansion:data entity.loot.contents.luigis_mansion.red_ruby int 1 run scoreboard players add #temp Time 1
