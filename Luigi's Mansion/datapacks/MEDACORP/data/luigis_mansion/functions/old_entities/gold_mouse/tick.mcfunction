...
execute at @s[tag=flee,tag=!played_sound] run playsound luigis_mansion:entity.gold_mouse.ambient hostile @a[tag=same_room] ~ ~ ~ 1
tag @s[tag=flee,tag=!played_sound] add played_sound
...
execute at @s[tag=!dead,scores={SpawnTime=20..}] run function luigis_mansion:old_entities/gold_mouse/move_forward
