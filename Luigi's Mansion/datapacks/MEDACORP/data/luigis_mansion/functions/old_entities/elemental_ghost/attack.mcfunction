...
execute at @s[tag=fire] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"fire"},amount:0,animation:"knockback/burn",attacker:-1,no_delete:1b}
execute at @s[tag=water] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"water"},amount:0,animation:"knockback/soak",attacker:-1,no_delete:1b}
execute at @s[tag=ice] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"ice"},amount:0,animation:"knockback/freeze",attacker:-1,no_delete:1b}
