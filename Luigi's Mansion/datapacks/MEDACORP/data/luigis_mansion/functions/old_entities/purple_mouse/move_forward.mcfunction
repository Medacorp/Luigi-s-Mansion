...
execute if score #temp Move matches 1.. positioned as @s[tag=!disappear] if entity @s[tag=!walk_up_wall,tag=!walked_on_ceiling] run function luigis_mansion:old_entities/purple_mouse/move_forward
execute if score #temp Move matches 1.. positioned as @s[tag=!disappear] if entity @s[tag=walk_up_wall,tag=walked_on_ceiling] run function luigis_mansion:old_entities/purple_mouse/move_forward
