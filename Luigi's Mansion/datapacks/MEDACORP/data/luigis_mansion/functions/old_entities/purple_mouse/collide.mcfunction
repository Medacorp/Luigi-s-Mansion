...
advancement grant @a[tag=!spectator,scores={Invulnerable=0},distance=..0.7] only luigis_mansion:vanilla/waluigi_pinball/purple_mouse
...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mouse"},amount:0,animation:{namespace:"luigis_mansion",id:"knockback/small"},attacker:-1,no_delete:1b}
