...
execute if entity @s[tag=walk_down_wall] store result entity @s Rotation[0] float 1 run scoreboard players get @s HomeRotation
execute if score #temp Move matches 1.. positioned as @s[tag=!walk_down_wall] run function luigis_mansion:old_entities/purple_mouse/move_ceiling