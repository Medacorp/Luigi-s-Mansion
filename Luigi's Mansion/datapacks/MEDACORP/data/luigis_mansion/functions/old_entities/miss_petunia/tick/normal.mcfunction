...
execute unless entity @s[scores={Dialog=3..59},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
execute if entity @s[scores={Dialog=1},tag=visible] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible
execute if entity @s[scores={Dialog=61,VulnerableTime=0},tag=visible] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible
...
execute if entity @s[scores={Dialog=59}] run function luigis_mansion:old_entities/miss_petunia/attack
