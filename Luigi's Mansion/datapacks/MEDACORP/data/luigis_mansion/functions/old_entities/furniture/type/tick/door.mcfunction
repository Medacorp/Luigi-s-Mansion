...
execute if entity @s[tag=in_water,tag=burning] run function luigis_mansion:old_entities/furniture/type/tick/door/extinguish with entity @s ArmorItems[3].tag
execute if entity @s[tag=burning] run function luigis_mansion:old_entities/furniture/type/tick/door/burn
execute if entity @s[tag=try_open,tag=!open_door,tag=!bash_door,tag=!unlock_door] run function luigis_mansion:old_entities/furniture/type/tick/door/use
tag @s remove try_open

fill ^ ^ ^-0.5 ^ ^1 ^-0.5 minecraft:light_gray_stained_glass replace minecraft:air
execute if entity @s[tag=!open_door,tag=!bash_door,tag=!unlock_door,tag=!barricade] unless entity @s[tag=!in_vacuum,tag=!was_shaking] run function luigis_mansion:old_entities/furniture/type/tick/door/shake
execute unless entity @s[tag=!open_door,tag=!forced_animation] run function luigis_mansion:old_entities/furniture/type/tick/door/open_door
execute if entity @s[tag=bash_door] run function luigis_mansion:old_entities/furniture/type/tick/door/bash_door
execute if entity @s[tag=unlock_door] run function luigis_mansion:old_entities/furniture/type/tick/door/unlock_door
