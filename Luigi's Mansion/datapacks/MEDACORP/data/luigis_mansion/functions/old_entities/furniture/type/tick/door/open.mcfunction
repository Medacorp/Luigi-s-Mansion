execute if data entity @s ArmorItems[3].tag.key run function luigis_mansion:old_entities/furniture/type/tick/door/check_lock with entity @s ArmorItems[3].tag
