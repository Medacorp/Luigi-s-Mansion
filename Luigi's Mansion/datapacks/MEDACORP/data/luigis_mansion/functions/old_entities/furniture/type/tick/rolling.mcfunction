...
execute if entity @s[scores={FurnitureVacuum=1..}] run function luigis_mansion:old_entities/furniture/type/tick/rolling/roll
execute if entity @s[scores={FurnitureVacuum=0},tag=!shake,tag=!long_shake,tag=was_shaking,tag=!rock] run function luigis_mansion:old_entities/furniture/revert_to_default_orientation

execute if score @s[tag=!searched] FurnitureVacuum >= @s FurnitureSearch run function luigis_mansion:old_entities/furniture/search/roll
