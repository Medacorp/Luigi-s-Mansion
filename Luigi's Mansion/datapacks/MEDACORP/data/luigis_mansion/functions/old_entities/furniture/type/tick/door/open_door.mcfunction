...
execute if entity @s[scores={AnimationProgress=1},tag=!forced_animation] run function luigis_mansion:old_entities/furniture/type/tick/door/force_other_end with entity @s ArmorItems[3].tag.other_end
execute if entity @s[scores={AnimationProgress=1},tag=!forced_animation] if data entity @s ArmorItems[3].tag.other_end.dimension run function luigis_mansion:old_entities/furniture/type/tick/door/end_dimension with entity @s ArmorItems[3].tag.other_end
