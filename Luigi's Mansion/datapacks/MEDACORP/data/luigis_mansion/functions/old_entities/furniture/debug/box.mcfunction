...
execute as @e[tag=temp,tag=left_up_forward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft -= #temp FurnitureSizeLeft
execute if entity @s[tag=!hanging_furniture] run scoreboard players operation #temp2 FurnitureSizeUp = #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward = #temp FurnitureSizeForward
execute as @e[tag=temp,tag=right_up_forward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft = #temp FurnitureSizeLeft
execute if entity @s[tag=!hanging_furniture] run scoreboard players operation #temp2 FurnitureSizeUp = #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward -= #temp FurnitureSizeForward
execute as @e[tag=temp,tag=left_up_backward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft -= #temp FurnitureSizeLeft
execute if entity @s[tag=!hanging_furniture] run scoreboard players operation #temp2 FurnitureSizeUp = #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward -= #temp FurnitureSizeForward
execute as @e[tag=temp,tag=right_up_backward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft = #temp FurnitureSizeLeft
execute if entity @s[tag=!standing_furniture] run scoreboard players operation #temp2 FurnitureSizeUp -= #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward = #temp FurnitureSizeForward
execute as @e[tag=temp,tag=left_down_forward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft -= #temp FurnitureSizeLeft
execute if entity @s[tag=!standing_furniture] run scoreboard players operation #temp2 FurnitureSizeUp -= #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward = #temp FurnitureSizeForward
execute as @e[tag=temp,tag=right_down_forward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft = #temp FurnitureSizeLeft
execute if entity @s[tag=!standing_furniture] run scoreboard players operation #temp2 FurnitureSizeUp -= #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward -= #temp FurnitureSizeForward
execute as @e[tag=temp,tag=left_down_backward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box

scoreboard players operation #temp2 FurnitureSizeLeft -= #temp FurnitureSizeLeft
execute if entity @s[tag=!standing_furniture] run scoreboard players operation #temp2 FurnitureSizeUp -= #temp FurnitureSizeUp
scoreboard players operation #temp2 FurnitureSizeForward -= #temp FurnitureSizeForward
execute as @e[tag=temp,tag=right_down_backward,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/debug/move_box
