...
function luigis_mansion:old_entities/furniture/type/tick/swinging/cosx
#amplifier
...
execute if entity @s[scores={FurnitureXProgress=0}] run function luigis_mansion:old_entities/furniture/type/tick/swinging/reached/x
