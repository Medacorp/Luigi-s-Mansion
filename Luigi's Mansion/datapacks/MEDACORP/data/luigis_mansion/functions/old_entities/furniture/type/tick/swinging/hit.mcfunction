...
execute at @s run function luigis_mansion:old_entities/furniture/type/tick/swinging/hit_x_pos
...
scoreboard players add #temp Time 900
execute store result entity @s Rotation[1] float 0.1 run scoreboard players operation #temp Time += #temp2 Time
execute at @s run function luigis_mansion:old_entities/furniture/type/tick/swinging/hit_z_pos
teleport @s ~ ~1.4 ~ ~ ~
...
execute as @e[tag=collision_check,tag=z,limit=1] at @s unless entity @s[scores={FurnitureSizeForward=0}] run function luigis_mansion:old_entities/furniture/type/tick/swinging/hit_pos/merge
execute as @e[tag=collision_check,tag=z,limit=1] at @s unless score @s Steps = @s FurnitureSizeUp run function luigis_mansion:old_entities/furniture/type/tick/swinging/hit_pos/set_to_highest_y
tag @s add me
...
execute at @e[tag=collision_check,tag=z,limit=1] facing entity @s feet as @e[tag=collision_check,tag=z,limit=1] run function luigis_mansion:old_entities/furniture/type/tick/swinging/harm
