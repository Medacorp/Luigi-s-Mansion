execute if entity @s[tag=must_face] run function luigis_mansion:old_entities/furniture/save_rotation
...
execute if data entity @s ArmorItems[3].tag.luigis_mansion.interact_animation run function luigis_mansion:old_entities/furniture/interact_animation_set with entity @s ArmorItems[3].tag.luigis_mansion.interact_animation