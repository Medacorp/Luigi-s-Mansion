...
execute at @s[scores={ActionTime=1..52}] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"chandelier"},amount:10,animation:"knockback/large",no_delete:1b}
...
execute as @e[tag=location,limit=1] positioned as @s run function luigis_mansion:old_entities/furniture/spawn/move
scoreboard players reset #temp Time
scoreboard players reset #temp2 Time
scoreboard players reset #temp3 Time
execute positioned as @e[tag=location,limit=1] run function luigis_mansion:old_entities/furniture/type/tick/lamp/light
execute if entity @s[scores={MirrorX=-2147483648..}] as @e[tag=location,limit=1] at @s run function luigis_mansion:old_entities/furniture/type/tick/lamp/mirror_x
execute if entity @s[scores={MirrorZ=-2147483648..}] as @e[tag=location,limit=1] at @s run function luigis_mansion:old_entities/furniture/type/tick/lamp/mirror_z
