execute if entity @s[tag=shake,tag=long_shake] run function luigis_mansion:old_entities/furniture/shake
execute unless data entity @s Pose.Head[1] run data merge entity @s {Pose:{Head:[0.0f,0.001f,0.0f]}}

execute if entity @s[scores={FurnitureXTarget=-900..900}] run function luigis_mansion:old_entities/furniture/type/tick/swinging/x
execute if entity @s[scores={FurnitureZTarget=-900..900}] run function luigis_mansion:old_entities/furniture/type/tick/swinging/z
...
execute if score @s[tag=searchable_by_time,tag=!open] FurnitureSearch <= @s FurnitureTime run function luigis_mansion:old_entities/furniture/search/generic
execute if score @s[tag=!searched] FurnitureVacuum >= @s FurnitureSearch run function luigis_mansion:old_entities/furniture/search/swing
execute if score @s[tag=swinging_harms] FurnitureVacuum >= @s FurnitureSearch run function luigis_mansion:old_entities/furniture/type/tick/swinging/hit
...
execute if entity @s[tag=drop_loot] run function luigis_mansion:old_entities/furniture/search/swing
