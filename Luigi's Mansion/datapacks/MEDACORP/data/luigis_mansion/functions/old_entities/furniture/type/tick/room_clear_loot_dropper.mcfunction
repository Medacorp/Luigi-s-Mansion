...
execute if entity @s[tag=was_dark_room,tag=!dark_room] run function luigis_mansion:old_entities/furniture/search/room_clear_loot_dropper
execute if entity @s[tag=drop_loot] run function luigis_mansion:old_entities/furniture/search/room_clear_loot_dropper
