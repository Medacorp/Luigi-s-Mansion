...
execute if entity @s[scores={Dialog=1},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
...
execute if entity @s[scores={Dialog=472..998,Variant=1}] run function luigis_mansion:old_entities/melody_pianissima/composer
execute if entity @s[scores={Dialog=472..998,Variant=2}] run function luigis_mansion:old_entities/melody_pianissima/game
...
execute if entity @s[scores={Dialog=1200}] if score #players Totals matches 1 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.melody_pianissima","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.melody_pianissima.no.3"}]}
...
execute if entity @s[scores={Dialog=1272}] as @a[tag=same_room,tag=!spectator] run function luigis_mansion:other/music/set/room
scoreboard players set @s[scores={Dialog=1272}] AnimationProgress 0
tag @s[scores={Dialog=1272}] add vanish
execute if entity @s[scores={Dialog=1272}] as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
...
execute if score #conservatory Wave matches 4 run function luigis_mansion:old_entities/melody_pianissima/battle