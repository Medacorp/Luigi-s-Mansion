...
execute if entity @s[tag=talk,tag=!vanish] run function luigis_mansion:old_entities/melody_pianissima/tick/normal/play
execute if entity @s[tag=!talk,tag=!vanish] if entity @a[tag=!spectator,distance=..5] run function luigis_mansion:old_entities/melody_pianissima/tick/normal/play
