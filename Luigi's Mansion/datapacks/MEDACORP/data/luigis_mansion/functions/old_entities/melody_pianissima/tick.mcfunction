...
execute if entity @s[tag=dead] run function luigis_mansion:old_entities/melody_pianissima/at_death
...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!flee,tag=!dying] run playsound luigis_mansion:entity.melody_pianissima.hurt hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={HurtTime=1},tag=hurt,tag=!flee,tag=!dying] Sound 40
execute if entity @s[scores={Sound=0},tag=flee,tag=!dying] run playsound luigis_mansion:entity.melody_pianissima.flee hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0},tag=flee,tag=!dying] Sound 40

execute if entity @s[tag=!flee,tag=!hurt,scores={StunTime=0}] run function #luigis_mansion:entities/melody_pianissima/tick

execute if entity @s[tag=vanish] run function luigis_mansion:old_entities/melody_pianissima/vanish
execute at @s[tag=flee,tag=!second_flee_state] run function luigis_mansion:old_animations/melody_pianissima/flee
execute at @s[tag=flee,tag=second_flee_state] run function luigis_mansion:old_entities/melody_pianissima/second_flee_state
execute at @s[tag=!flee,tag=hurt] run function luigis_mansion:old_animations/melody_pianissima/hurt
