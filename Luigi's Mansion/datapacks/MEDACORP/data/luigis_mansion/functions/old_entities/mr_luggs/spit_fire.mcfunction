...
execute as @e[tag=shot_fire,tag=new,limit=1] at @s rotated as @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"mr_luggs"}}}}]},limit=1] run teleport @s ~ ~ ~ ~ ~
