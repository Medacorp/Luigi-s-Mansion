...
execute if entity @s[scores={WaitTime=10}] run function luigis_mansion:old_entities/ice_spike/select_spike_to_fall
...
execute if entity @s[scores={WaitTime=30..},tag=moving] run function luigis_mansion:old_entities/ice_spike/fall

execute if entity @s[tag=breaking] run function luigis_mansion:old_entities/ice_spike/breaking
