...
execute at @s run function luigis_mansion:old_animations/ceiling_ghost/attack
...
execute if entity @s[scores={ActionTime=1}] run data modify entity @e[tag=bomb,distance=..0.1,limit=1] ArmorItems[3].tag.luigis_mansion.damage set from entity @s ArmorItems[3].tag.luigis_mansion.damage
