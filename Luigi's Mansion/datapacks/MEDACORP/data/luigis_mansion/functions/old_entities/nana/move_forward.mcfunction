...
execute unless block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/nana/move_forward
execute unless block ^ ^1 ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/nana/move_forward
execute if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/nana/move_forward