...
execute if entity @s[scores={Dialog=1..2},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
execute if entity @s[scores={Dialog=1}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible
execute if entity @s[scores={Dialog=2}] if entity @e[tag=wool,tag=can_spit,limit=1] run function luigis_mansion:old_entities/nana/tick/hidden/move
...
execute if entity @s[scores={Dialog=12}] if entity @e[tag=wool,tag=can_spit,limit=1] unless entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:old_entities/nana/tick/hidden/move
execute if entity @s[scores={Dialog=12}] if entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:old_entities/nana/try_attack
...
execute if entity @s[scores={Dialog=22}] if entity @e[tag=wool,tag=can_spit,limit=1] unless entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:old_entities/nana/tick/hidden/move
execute if entity @s[scores={Dialog=22}] if entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:old_entities/nana/try_attack
scoreboard players set @s[scores={Dialog=23}] AnimationProgress 0
execute if entity @s[scores={Dialog=24},tag=!visible,tag=!vanish] run function luigis_mansion:old_entities/ghost/turn_visible
...
execute if entity @s[scores={Dialog=55}] run function luigis_mansion:old_entities/ghost/turn_invisible
