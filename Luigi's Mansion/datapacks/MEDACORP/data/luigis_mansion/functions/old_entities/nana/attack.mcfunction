...
execute at @s anchored eyes run summon minecraft:armor_stand ^ ^-0.5 ^0.3 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shot_needle"}',Marker:1b,Invulnerable:1b,Tags:["shot_needle","new"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:28,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"shot_needle"}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,DisabledSlots:2039583,Small:1b}
...
execute as @e[tag=shot_needle,tag=new,limit=1] at @s rotated as @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"nana"}}}}]},limit=1] run teleport @s ~ ~ ~ ~ ~
