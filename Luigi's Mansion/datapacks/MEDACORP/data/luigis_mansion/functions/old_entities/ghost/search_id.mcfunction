...
execute if entity @s[tag=!vacuuming_this_ghost] if data storage luigis_mansion:data ghost_list[-1] run function luigis_mansion:old_entities/ghost/search_id