...
scoreboard players set #temp Health 192
...
execute at @s[tag=portrait_ghost,tag=pearl_dropper,scores={Room=1..,Health=1..}] run function luigis_mansion:old_entities/ghost/pearl_dropper
function luigis_mansion:old_entities/ghost/top_vacuum_damage
tag @s remove attack
tag @s remove laugh
