...
execute if score #temp Move matches ..-1 positioned as @s unless entity @a[tag=vacuuming_this_ghost,distance=..3,limit=1] run function luigis_mansion:old_entities/ghost/move_pulled