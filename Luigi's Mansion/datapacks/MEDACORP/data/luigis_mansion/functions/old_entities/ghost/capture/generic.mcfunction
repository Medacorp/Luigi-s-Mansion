$execute unless data storage luigis_mansion:data current_state.ghost_caught.caught.$(namespace).$(id) run data modify storage luigis_mansion:data current_state.ghost_caught.caught.$(namespace) merge value {$(id):0}
