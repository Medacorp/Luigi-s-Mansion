...
execute if entity @s[scores={Time=40..}] run function luigis_mansion:old_entities/ghost/hidden/turn
...
execute at @s[tag=spawn] unless entity @s[tag=has_partner,tag=!partner_died] run function luigis_mansion:old_entities/ghost/hidden/selection

execute at @s[tag=!spawn] if entity @s[scores={SpawnTime=1..},tag=!new_ghost,tag=!no_hidden_move] run function luigis_mansion:old_entities/ghost/hidden/move
