...
execute if score #temp MoveFlee matches 1.. positioned as @s if entity @a[tag=vacuuming_this_ghost,distance=..6,limit=1] run function luigis_mansion:old_entities/ghost/move_flee