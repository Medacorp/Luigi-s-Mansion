summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ghost_heart"}',HasVisualFire:1b,Marker:1b,Invisible:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:30,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"ghost_heart"}}}}],Tags:["ghost_heart","this_entity"]}
