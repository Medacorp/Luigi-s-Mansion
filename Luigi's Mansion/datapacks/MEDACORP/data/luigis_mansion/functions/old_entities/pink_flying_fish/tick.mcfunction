...
execute if entity @s[scores={WaitTime=1..79}] run function luigis_mansion:old_entities/pink_flying_fish/hover
execute if entity @s[scores={WaitTime=80..}] run function luigis_mansion:old_entities/pink_flying_fish/attack
