...
execute if entity @s[scores={ActionTime=1..40}] run function luigis_mansion:old_animations/puncher/basher_stun
scoreboard players set @s[scores={ActionTime=41}] AnimationProgress 0
execute if entity @s[scores={ActionTime=41..60}] run function luigis_mansion:old_animations/puncher/basher_appear
scoreboard players set @s[scores={ActionTime=61}] AnimationProgress 0
execute if entity @s[scores={ActionTime=61..90}] run function luigis_mansion:old_animations/puncher/basher_complain

tag @s[scores={ActionTime=1},tag=!frozen_heart] add stunable
tag @s[scores={ActionTime=1}] add visible
execute if entity @s[scores={ActionTime=1..40},tag=visible] run function luigis_mansion:old_entities/ghost/turn_invisible
execute at @s[scores={ActionTime=1..40}] run particle minecraft:dust 0.7 1 1 1 ~-0.2 ~0.2 ~-0.2 0.4 0.4 0.4 0 50 force
execute if entity @s[scores={ActionTime=41}] run playsound luigis_mansion:entity.flash.spawn hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=41},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
execute if entity @s[scores={ActionTime=41}] run summon minecraft:armor_stand ~ ~0.5 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:message.basher_scare","color":"yellow","bold":true}',Marker:1b,Invisible:1b,NoGravity:1b,CustomNameVisible:1b,HasVisualFire:1b,Tags:["basher_scare"],ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"basher_scare"}}}}]}
...
execute if entity @s[scores={ActionTime=81}] run playsound luigis_mansion:entity.flash.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
