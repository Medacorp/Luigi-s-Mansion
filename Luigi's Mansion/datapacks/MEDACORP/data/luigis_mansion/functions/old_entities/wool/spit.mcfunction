...
execute if score #temp Move matches 1.. unless block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore run function luigis_mansion:old_entities/wool/spit
execute if score #temp Move matches 1.. positioned as @s[tag=!collision] run function luigis_mansion:old_entities/wool/spit