...
execute at @s[scores={Boos=1..40}] run function luigis_mansion:old_animations/boo/laugh
execute at @s[scores={Boos=41..80}] run function luigis_mansion:old_animations/boo/taunt
