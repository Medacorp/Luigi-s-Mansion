...
execute unless entity @s[scores={Boos=1..}] run scoreboard players set @s AnimationProgress 0
scoreboard players operation #temp GhostCount = @s MaxHealth
scoreboard players operation #temp GhostCount -= @s GhostCount
execute unless entity @s[scores={Boos=1000..}] run scoreboard players operation @s Boos += #temp GhostCount
execute unless entity @s[scores={Boos=1000..}] run scoreboard players operation @s Boos += #temp GhostCount
execute unless entity @s[scores={Boos=1000..}] run scoreboard players operation @s Boos += #temp GhostCount
...
execute at @s[scores={Boos=1000..}] run function luigis_mansion:old_entities/boo/move_forward
teleport @s[tag=wall] ~ ~ ~ ~ ~
scoreboard players set @s[tag=wall] Time 600
tag @s remove wall
scoreboard players set @s[scores={Boos=1020}] AnimationProgress 0
