...
execute if entity @s[tag=!flee,tag=!attack,tag=!laugh,scores={Wave=80,GhostCount=15}] run tag @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}] add laugh
execute if entity @s[tag=!flee,tag=!attack,tag=!laugh,scores={Wave=80,GhostCount=8..14}] if predicate luigis_mansion:boolossus_laugh_chance run tag @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}] add laugh
...
execute at @s if entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}},distance=0.1..,limit=1] run scoreboard players add @s Wave 1
