...
execute if entity @s[scores={Dialog=..242},tag=!visible,tag=!vanish] run function luigis_mansion:old_entities/ghost/turn_visible
execute if entity @s[scores={Dialog=243..366},tag=visible,tag=!vanish] run function luigis_mansion:old_entities/ghost/turn_invisible
execute if entity @s[scores={Dialog=243..366}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_visible
...
execute if entity @s[scores={Dialog=367},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
...
execute if entity @s[scores={Dialog=467}] run function luigis_mansion:old_entities/ghost/turn_invisible
