...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!flee,tag=!dying] run playsound luigis_mansion:entity.gold_ghost.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Sound=0},tag=flee,tag=!dying] run playsound luigis_mansion:entity.gold_ghost.flee hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Sound=0},tag=!vanish,tag=!flee,tag=!attack,tag=!laugh,tag=!complain,tag=!appear,tag=!basher] run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0}] Sound 40

execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!no_ai,tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,scores={AttackType=0},tag=!hurt,tag=!flee,tag=!element_hurt] run function luigis_mansion:old_entities/gold_ghost/collide
execute if entity @s[scores={AttackType=0}] run function luigis_mansion:old_entities/gold_ghost/select_attack/punch
execute if entity @s[scores={AttackType=1}] run function luigis_mansion:old_entities/gold_ghost/select_attack/basher
execute if entity @s[scores={AttackType=2}] run function luigis_mansion:old_entities/gold_ghost/select_attack/laugh
...
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!flee,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function luigis_mansion:old_entities/gold_ghost/laugh
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!flee,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function luigis_mansion:old_entities/gold_ghost/complain
...
execute if entity @s[tag=vanish] run function luigis_mansion:old_entities/gold_ghost/vanish
execute if entity @s[tag=appear,tag=!beta_appear] run function luigis_mansion:old_entities/gold_ghost/appear
execute if entity @s[tag=appear,tag=beta_appear] run function luigis_mansion:old_entities/gold_ghost/beta_appear
...
execute at @s[tag=flee,tag=second_flee_state] run function luigis_mansion:old_entities/gold_ghost/second_flee_state
