...
execute at @e[type=minecraft:marker,tag=clockwork_soldier_target,limit=1] facing entity @s feet rotated ~ 0 run function luigis_mansion:old_entities/clockwork_soldier/target_step
