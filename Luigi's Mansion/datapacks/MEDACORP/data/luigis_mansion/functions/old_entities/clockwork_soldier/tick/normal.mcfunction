...
execute if entity @s[tag=activated,tag=!was_activated,scores={WaitTime=0}] run function luigis_mansion:old_entities/clockwork_soldier/activate
...
execute if entity @s[tag=!windless,scores={VacuumTime=40..}] run function luigis_mansion:old_entities/clockwork_soldier/lose_wind

execute at @s[tag=!vanish,scores={VulnerableTime=0},tag=!visible] run function luigis_mansion:old_entities/clockwork_soldier/get_wind
...
execute at @s[tag=!vanish,scores={VulnerableTime=1..}] run function luigis_mansion:old_entities/clockwork_soldier/complain
...
execute if entity @s[tag=was_activated,tag=!vanish,tag=attack,tag=!windless,scores={StunTime=0}] run function luigis_mansion:old_entities/clockwork_soldier/attack

scoreboard players set @s[tag=attack] Distance 0
execute at @s[tag=was_activated,tag=!attack,tag=!complain,tag=!vanish,scores={Distance=0,WaitTime=0}] run function luigis_mansion:old_entities/clockwork_soldier/target
execute at @s[tag=was_activated,tag=!attack,tag=!complain,tag=!vanish,scores={Distance=1..,WaitTime=0}] rotated ~ 0 run function luigis_mansion:old_entities/clockwork_soldier/move
