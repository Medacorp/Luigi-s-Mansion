...
execute if entity @s[tag=!no_bounce] run function luigis_mansion:old_entities/billiards_ball/bounce
tag @s remove no_bounce
execute at @s run teleport @s ^ ^ ^0.01
scoreboard players remove #temp Move 1
execute if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/billiards_ball/move_forward