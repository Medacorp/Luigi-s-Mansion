...
execute at @s[scores={SpawnTime=1},tag=vacuumable] run function luigis_mansion:old_entities/billiards_ball/rotate
execute at @s[tag=!in_vacuum,tag=vacuumable] run function luigis_mansion:old_entities/billiards_ball/move_forward
execute at @s[tag=move] run function luigis_mansion:old_entities/billiards_ball/move_forward
execute at @s[tag=move] run function luigis_mansion:old_entities/billiards_ball/move_forward
...
execute at @s if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=vacuumable,tag=!in_vacuum,tag=!can_spit_2,tag=!spit,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence] run function luigis_mansion:old_entities/billiards_ball/collide

execute at @s[tag=collision] run function luigis_mansion:old_entities/billiards_ball/back_to_start
