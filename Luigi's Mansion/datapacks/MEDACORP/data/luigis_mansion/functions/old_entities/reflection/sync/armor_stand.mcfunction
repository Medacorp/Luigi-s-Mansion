...
function luigis_mansion:old_entities/reflection/swap_model

execute if entity @s[tag=!immobile] run function luigis_mansion:old_entities/reflection/mobile_entity
