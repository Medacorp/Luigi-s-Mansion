...
execute if entity @s[scores={Dialog=1}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible_partially
execute if entity @s[scores={Dialog=21}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible_partially
execute if entity @s[scores={Dialog=41}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible_partially
execute if entity @s[scores={Dialog=1}] run function luigis_mansion:old_entities/slim_bankshot/tick/hidden/path
execute if entity @s[scores={Dialog=2}] run playsound luigis_mansion:entity.slim_bankshot.scream hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Dialog=2}] AnimationProgress 0
scoreboard players set @s[scores={Dialog=2,PathStep=9..100}] PathStep 1
execute if entity @s[scores={Dialog=21}] run function luigis_mansion:old_entities/slim_bankshot/tick/hidden/path
execute if entity @s[scores={Dialog=22}] run playsound luigis_mansion:entity.slim_bankshot.scream hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Dialog=22}] AnimationProgress 0
scoreboard players set @s[scores={Dialog=22,PathStep=9..100}] PathStep 1
execute if entity @s[scores={Dialog=41}] run function luigis_mansion:old_entities/slim_bankshot/tick/hidden/path
...
scoreboard players set @s[scores={Dialog=42}] AnimationProgress 0
