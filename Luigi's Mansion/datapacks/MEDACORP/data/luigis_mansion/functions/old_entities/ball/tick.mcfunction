...
execute at @s[tag=spit] run function luigis_mansion:old_entities/ball/move_forward
scoreboard players set @s[tag=!spit] Time 0
scoreboard players set @s[tag=!bounced] Dialog 0
tag @s[scores={Time=100}] add collision
execute at @s[tag=chauncey,tag=!vacuumable] rotated ~ 0 run function luigis_mansion:old_entities/ball/move_forward
execute at @s[scores={Move=1..}] run function luigis_mansion:old_entities/ball/move
tag @s add me
tag @e[tag=ball,tag=!me,sort=nearest,distance=..5,limit=1] add target
execute at @s[tag=big] positioned ~ ~-0.4 ~ facing entity @e[tag=target,limit=1] feet positioned ^ ^ ^2 if entity @e[tag=target,distance=..2,limit=1] run function luigis_mansion:old_entities/ball/bounce
execute at @s[tag=!big] positioned ~ ~-1 ~ facing entity @e[tag=target,limit=1] feet positioned ^ ^ ^1 if entity @e[tag=target,distance=..1,limit=1] run function luigis_mansion:old_entities/ball/bounce
...
execute at @s[tag=!in_vacuum,tag=chauncey] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"ball"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/large"},no_delete:1b}
...
execute at @s[tag=explode] run function luigis_mansion:old_entities/ball/spike_explode
