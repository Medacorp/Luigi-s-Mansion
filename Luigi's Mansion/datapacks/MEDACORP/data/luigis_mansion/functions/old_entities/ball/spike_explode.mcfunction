...
execute if data entity @s ArmorItems[3].tag.luigis_mansion.damage.attack run data modify entity @e[distance=..0.1,tag=burning_floor,limit=1] ArmorItems[3].tag.luigis_mansion.damage set from entity @s ArmorItems[3].tag.luigis_mansion.damage
