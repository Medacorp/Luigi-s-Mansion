...
execute unless entity @e[tag=rocking_horse,scores={Room=10},tag=was_in_vacuum,limit=1] run scoreboard players remove @s[scores={Dialog=2..49}] Dialog 3
execute unless entity @s[scores={Dialog=1..}] run scoreboard players add @s Dialog 1
tag @s[scores={Dialog=1}] add sleep
scoreboard players set @s[scores={Dialog=1},tag=wake_up] AnimationProgress 0
scoreboard players set @s[scores={Dialog=1},tag=scream_wake] AnimationProgress 0
tag @s[scores={Dialog=1}] remove wake_up
tag @s[scores={Dialog=1}] remove scream_wake
execute if entity @s[scores={Dialog=1..50},tag=!visible] run function luigis_mansion:old_entities/ghost/turn_visible
execute if entity @s[scores={Dialog=1..48}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:old_entities/ghost/turn_invisible
...
scoreboard players set @s[scores={Dialog=2},tag=wake_up] AnimationProgress 0
tag @s[scores={Dialog=10},tag=!wake_up] remove sleep
tag @s[scores={Dialog=10},tag=!wake_up] add scream_wake
scoreboard players set @s[scores={Dialog=10},tag=!wake_up] AnimationProgress 0
...
execute if entity @s[scores={Dialog=170}] if entity @e[tag=haunted_teddy_bear,scores={WaitTime=60}] run scoreboard players set @s AnimationProgress 0
...
tag @s[scores={Dialog=170},tag=attack] remove move
execute at @s[scores={Dialog=170},tag=!attack,tag=!rambling,tag=!laugh,tag=!complain] run function luigis_mansion:old_entities/ghost/move
...
scoreboard players set @s[scores={Dialog=171}] AnimationProgress 0
...
execute if entity @s[scores={Dialog=211}] run function luigis_mansion:old_entities/ghost/turn_visible_no_equipment
...
execute if entity @s[scores={Dialog=290}] run function luigis_mansion:old_entities/chauncey/grab_rambler
...
scoreboard players set @s[scores={Dialog=642}] AnimationProgress 0
