execute if entity @s[tag=!intro_done] run function luigis_mansion:old_entities/chauncey/battle_intro/hidden
...
execute if entity @s[scores={Dialog=80,Health=..5000},tag=intro_done] run data modify storage luigis_mansion:data entity set value {tags:["zigzag_left"]}
...
tag @s[scores={Dialog=1782}] add fast_bounce
scoreboard players set @s[scores={Dialog=1782}] PathStep 0
scoreboard players add @s[scores={Dialog=1783}] PathStep 1
teleport @s[scores={Dialog=1783,PathStep=1..5}] ^ ^0.4 ^0.4
teleport @s[scores={Dialog=1783,PathStep=6..10}] ^ ^-0.4 ^0.4
...
execute at @s[scores={Dialog=1783,PathStep=10}] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"bounced_on"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/large"},attacker:-1,no_delete:1b}
