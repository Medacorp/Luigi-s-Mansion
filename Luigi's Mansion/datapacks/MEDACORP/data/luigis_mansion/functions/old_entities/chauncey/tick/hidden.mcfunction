execute at @s[scores={Room=10},tag=!vanish] positioned ~ ~1 ~ run function luigis_mansion:old_entities/chauncey/tick/nursery/hidden
execute at @s[scores={Room=73},tag=!vanish] run function luigis_mansion:old_entities/chauncey/tick/fight/hidden
