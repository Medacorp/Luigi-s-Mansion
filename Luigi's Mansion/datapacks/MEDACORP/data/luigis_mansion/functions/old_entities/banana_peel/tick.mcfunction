...
execute at @s[tag=!dead] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"bannana"},durning_knockback_amount:5,animation:"knockback/slip",no_delete:1b}
