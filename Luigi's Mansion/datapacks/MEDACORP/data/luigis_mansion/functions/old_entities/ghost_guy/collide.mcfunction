...
execute if entity @a[tag=!spectator,scores={Invulnerable=0},distance=..0.7] if entity @s[tag=!stop_dancing] run function luigis_mansion:old_entities/ghost_guy/stop_dancing
