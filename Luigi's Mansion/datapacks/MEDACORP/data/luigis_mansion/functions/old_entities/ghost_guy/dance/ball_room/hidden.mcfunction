execute if entity @s[scores={Path=1}] run function luigis_mansion:old_entities/ghost_guy/dance/ball_room/hidden/1
execute if entity @s[scores={Path=2}] run function luigis_mansion:old_entities/ghost_guy/dance/ball_room/hidden/2
execute if entity @s[scores={Path=3}] run function luigis_mansion:old_entities/ghost_guy/dance/ball_room/hidden/3
