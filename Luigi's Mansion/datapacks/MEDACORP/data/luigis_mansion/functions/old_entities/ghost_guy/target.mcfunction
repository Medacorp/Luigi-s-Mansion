...
execute at @e[type=minecraft:marker,tag=ghost_guy_target,limit=1] facing entity @s feet rotated ~ 0 run function luigis_mansion:old_entities/ghost_guy/target_step
