...
execute if entity @s[tag=lift_fail] run function luigis_mansion:old_entities/biff_atlas/move_weights/fail
execute if entity @s[tag=lift_succeed] run function luigis_mansion:old_entities/biff_atlas/move_weights/succeed
