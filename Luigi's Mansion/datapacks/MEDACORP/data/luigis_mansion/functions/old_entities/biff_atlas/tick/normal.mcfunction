...
execute if entity @s[scores={Dialog=1}] run function luigis_mansion:old_entities/biff_atlas/idle
execute if entity @s[scores={Dialog=2}] as @e[tag=these_weights,limit=1] run function luigis_mansion:old_entities/biff_atlas/move_weights/home
...
execute at @s[scores={Dialog=121},tag=!laugh] run function luigis_mansion:old_entities/ghost/move_forward
...
scoreboard players set @s[scores={Dialog=240}] AnimationProgress 0
...
execute at @s[scores={Dialog=241},tag=!laugh] run function luigis_mansion:old_entities/ghost/move_forward
scoreboard players set @s[scores={Dialog=242}] AnimationProgress 0
...
execute at @s[tag=laugh] run function luigis_mansion:old_entities/biff_atlas/laugh
execute at @s[tag=attack] run function luigis_mansion:old_entities/biff_atlas/attack
