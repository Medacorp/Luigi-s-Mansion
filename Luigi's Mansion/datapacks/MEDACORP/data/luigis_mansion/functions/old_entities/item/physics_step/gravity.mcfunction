...
execute if entity @s[scores={Move=0}] if block ~ ~-0.1 ~ #minecraft:stairs[half=bottom] run function luigis_mansion:old_entities/item/physics_step/stairs
...
execute if entity @s[scores={Move=..-1}] if score #temp Move matches 1.. run function luigis_mansion:old_entities/item/physics_step/fall
execute if entity @s[scores={Move=1..}] if score #temp Move matches 1.. run function luigis_mansion:old_entities/item/physics_step/fly
