...
execute at @s run summon minecraft:marker ~ ~ ~ {Tags:["boo_marker","cannot_be_removed","new","caught_by_boo_radar"],CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',data:{entity:{namespace:"luigis_mansion",id:"boo_marker"}}}
...
function luigis_mansion:old_entities/boo/warp/update_data