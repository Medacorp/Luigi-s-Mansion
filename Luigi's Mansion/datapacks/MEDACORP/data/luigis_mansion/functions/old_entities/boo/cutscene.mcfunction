...
execute at @s[scores={ActionTime=10..},tag=move_up] run function luigis_mansion:old_entities/boo/move_up
execute at @s[scores={ActionTime=10..},tag=!move_up] run function luigis_mansion:old_entities/boo/move_down
execute at @s[scores={Time=600..}] run function luigis_mansion:old_entities/boo/turn
execute if entity @s[tag=wall] run function luigis_mansion:old_entities/boo/warp/cutscene
