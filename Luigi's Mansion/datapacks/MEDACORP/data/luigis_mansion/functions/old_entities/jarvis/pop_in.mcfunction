...
execute at @s run function luigis_mansion:old_animations/jarvis/pop_in
teleport @s[scores={ActionTime=6..15}] ~ ~-0.1 ~
execute if entity @s[scores={ActionTime=15}] run function luigis_mansion:old_entities/ghost/turn_invisible
