...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[scores={VulnerableTime=0},tag=!vanish,tag=!hurt,tag=!flee] run function luigis_mansion:old_entities/henry/collide
...
execute if entity @s[tag=!carless,scores={VacuumTime=40}] run function luigis_mansion:old_entities/henry/lose_car
...
execute at @s[tag=laugh] run function luigis_mansion:old_entities/henry/laugh
execute at @s[tag=grab_vehicle] run function luigis_mansion:old_entities/henry/grab_vehicle
...
execute at @s[tag=!vanish,tag=!laugh,tag=!carless,tag=!grab_vehicle,scores={StunTime=0}] run function luigis_mansion:old_entities/henry/move
execute at @s run tp @s ~ ~-0.2 ~
