...
execute if entity @s[tag=!no_ai,tag=!hide_and_seek] run function luigis_mansion:old_entities/henry/drive
execute if entity @s[tag=hide_and_seek] run function luigis_mansion:old_entities/henry/hide_and_seek/hidden

execute at @s[tag=appear] run function luigis_mansion:old_entities/henry/appear
