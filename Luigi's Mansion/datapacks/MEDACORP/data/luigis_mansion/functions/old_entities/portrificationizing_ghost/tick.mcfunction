...
execute if entity @s[scores={Dialog=570},tag=!dead] run function luigis_mansion:old_entities/portrificationizing_ghost/portrait with entity @s ArmorItems[3].tag.luigis_mansion.ghost
