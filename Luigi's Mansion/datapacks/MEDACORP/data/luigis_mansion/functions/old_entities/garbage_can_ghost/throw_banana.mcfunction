summon minecraft:armor_stand ^ ^1 ^0.3 {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.banana_peel"}',ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"banana_peel"}}}}],Small:1b,Invisible:1b,NoGravity:1b,Marker:1b,Tags:["banana_peel","affected_by_vacuum","new","thrown"]}
