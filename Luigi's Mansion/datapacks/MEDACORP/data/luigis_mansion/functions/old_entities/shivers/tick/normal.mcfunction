execute if entity @s[scores={PathStep=1..2},tag=!partially_invisible,tag=!vanish] run function luigis_mansion:old_entities/ghost/turn_invisible_partially
execute if entity @s[scores={PathStep=3..},tag=!visible,tag=!vanish] run function luigis_mansion:old_entities/ghost/turn_visible
...
data modify entity @s[tag=burning,scores={PathStep=1..2}] ArmorItems[3].tag.luigis_mansion.scan_message set value {sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.shivers.scan.2"}'}
...
execute at @s[scores={PathStep=..52},tag=!vanish] unless entity @s[scores={PathStep=3..43}] run function luigis_mansion:old_entities/shivers/move_forward
...
teleport @s[scores={PathStep=53}] ~ ~ ~ -60 0
...
execute at @s[scores={PathStep=70..93},tag=!vanish] facing 744.3 11.3 66 run function luigis_mansion:old_entities/shivers/move_forward
...
data modify entity @s[scores={PathStep=233}] ArmorItems[3].tag.luigis_mansion.scan_message set value {sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.shivers.scan.1"}'}
...
execute at @s[tag=look_around] run function luigis_mansion:old_animations/shivers/look_around
execute at @s[tag=panic] run function luigis_mansion:old_animations/shivers/panic
execute at @s[tag=run] run function luigis_mansion:old_animations/shivers/run
execute at @s[tag=sit_down] run function luigis_mansion:old_animations/shivers/sit_down
execute at @s[tag=burn,tag=!vanish] run function luigis_mansion:old_animations/shivers/burn
execute at @s[tag=!burn,tag=!vanish,tag=!look_around,tag=!panic,tag=!run,tag=!sit_down] run function luigis_mansion:old_animations/shivers/idle
execute at @s[tag=visible,tag=!vanish] as @e[tag=this_model,tag=right_arm] at @s run function luigis_mansion:old_entities/shivers/candle_flame
