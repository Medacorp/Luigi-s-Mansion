...
execute at @s[scores={PathStep=70..93},tag=!vanish] facing 744.3 11.3 -51 run function luigis_mansion:old_entities/shivers/move_forward
...
execute at @s[tag=visible,tag=!vanish] as @e[tag=this_model,tag=left_arm] at @s run function luigis_mansion:old_entities/shivers/candle_flame
