...
execute if entity @s[scores={ActionTime=1},tag=visible] run playsound luigis_mansion:entity.bowling_ghost.disappear hostile @a[tag=same_room] ~ ~ ~ 1
execute at @s run function luigis_mansion:old_animations/bowling_ghost/vanish
