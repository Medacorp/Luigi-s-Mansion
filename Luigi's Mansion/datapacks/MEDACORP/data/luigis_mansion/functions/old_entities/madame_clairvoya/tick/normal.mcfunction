...
execute if entity @s[tag=!visible] run function luigis_mansion:old_entities/madame_clairvoya/shine
execute if entity @s[tag=visible,tag=!vanish] run function luigis_mansion:old_entities/madame_clairvoya/tick/normal/visible
