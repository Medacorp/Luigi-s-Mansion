execute if entity @s[scores={ClairvoyaSpoke=5,VulnerableTime=0}] run function luigis_mansion:old_entities/madame_clairvoya/tick/hidden/laugh
...
execute if entity @s[tag=talk,scores={Dialog=0}] run function luigis_mansion:old_entities/madame_clairvoya/tick/hidden/select_dialog
