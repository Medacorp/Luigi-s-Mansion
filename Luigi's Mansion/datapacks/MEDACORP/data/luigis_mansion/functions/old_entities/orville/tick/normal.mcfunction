...
execute if entity @s[tag=!vanish,tag=!no_ai,tag=!hide_and_seek] run function luigis_mansion:old_entities/orville/fly
execute if entity @s[tag=no_ai] run function luigis_mansion:dialog/twins/normal

execute at @s[tag=appear] run function luigis_mansion:old_entities/orville/appear
