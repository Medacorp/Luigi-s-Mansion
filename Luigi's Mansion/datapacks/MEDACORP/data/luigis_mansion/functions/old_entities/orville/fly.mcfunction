...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[scores={VulnerableTime=0},tag=!vanish,tag=!hurt,tag=!flee] run function luigis_mansion:old_entities/orville/collide
...
execute if entity @s[tag=!planeless,scores={VacuumTime=40}] run function luigis_mansion:old_entities/orville/lose_plane
...
execute at @s[tag=laugh] run function luigis_mansion:old_entities/orville/laugh
execute at @s[tag=grab_vehicle] run function luigis_mansion:old_entities/orville/grab_vehicle
...
execute at @s at @s[tag=!laugh,tag=!vanish,tag=!planeless,tag=!grab_vehicle,scores={StunTime=0}] run function luigis_mansion:old_entities/orville/move
execute at @s run tp @s ~ ~-0.2 ~
