...
execute unless block ~ ~ ~ #luigis_mansion:ghosts_ignore run teleport @s ^ ^ ^0.01
...
execute at @s unless block ~ ~ ~0.3 #luigis_mansion:ghosts_ignore if block ~ ~ ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~ ~-0.1
execute at @s unless block ~ ~ ~-0.3 #luigis_mansion:ghosts_ignore if block ~ ~ ~ #luigis_mansion:ghosts_ignore run teleport @s ~ ~ ~0.1
execute at @s if entity @a[distance=..1,tag=!spectator,limit=1] run tag @s add collision
...
execute unless block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/haunted_object/move_forward
execute unless block ^ ^1 ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/haunted_object/move_forward
execute unless entity @s[tag=collision] if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/haunted_object/move_forward