...
execute if score #temp Move matches 1.. positioned as @s if block ~ ~ ~ #luigis_mansion:ghosts_ignore run function luigis_mansion:old_entities/bowling_ball/move_forward
execute if score #temp Move matches 1.. positioned as @s if block ~ ~ ~ #minecraft:slabs[type=bottom] run function luigis_mansion:old_entities/bowling_ball/move_forward