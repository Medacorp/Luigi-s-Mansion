...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["clockwork_room"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["clockwork_room"]} positioned 3698 160 18 run function luigis_mansion:items/game_boy_horror/map/spawn_key/variant_0/single
