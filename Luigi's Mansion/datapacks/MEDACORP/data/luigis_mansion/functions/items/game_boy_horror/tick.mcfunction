...
execute if entity @s[scores={UseItem=1..},tag=game_boy_horror_selected,tag=!show_credits] run function luigis_mansion:selection_menu/game_boy_horror/original_menu
