...
data modify entity @s ArmorItems[3].tag.luigis_mansion.hit_by.ice append value 0
execute store result entity @s ArmorItems[3].tag.luigis_mansion.hit_by.ice[-1] int 1 run scoreboard players get #temp ID