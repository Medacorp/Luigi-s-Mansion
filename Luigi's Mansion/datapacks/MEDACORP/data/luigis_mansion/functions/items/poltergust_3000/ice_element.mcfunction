...
data modify storage luigis_mansion:data inventory[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"poltergust_3000"}}}].tag merge value {display:{Lore:['{"italic":false,"color":"gray","translate":"luigis_mansion:item.poltergust_3000.element","with":[{"translate":"luigis_mansion:item.poltergust_3000.element.ice","color":"white"}]}']}}
