...
execute as @e[tag=same_room,tag=!model_piece,tag=affected_by_fire,tag=!hit_by_poltergust] run function luigis_mansion:items/poltergust_3000/effect_on_entity/root_fire