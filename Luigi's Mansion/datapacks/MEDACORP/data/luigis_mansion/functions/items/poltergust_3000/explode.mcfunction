...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"poltergust_explosion"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/medium_forward"}}
