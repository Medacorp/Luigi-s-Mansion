data modify storage luigis_mansion:data memory append value {uuid:[I;],id:0,inventory:{},model:{color:0,variant:0b},hurt_by:{method:""},revived_by:"",poltergust_element:"none"}
