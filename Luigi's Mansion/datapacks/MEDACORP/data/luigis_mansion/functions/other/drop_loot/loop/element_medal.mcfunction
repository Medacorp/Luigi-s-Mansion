...
execute if data storage luigis_mansion:data {element_medal:"fire"} unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"element_medal",variant:"fire"}}]},limit=1] unless data storage luigis_mansion:data current_state.current_data.obtained_items{fire_element_medal:1b} run function luigis_mansion:spawn_entities/item/fire_element_medal
execute if data storage luigis_mansion:data {element_medal:"water"} unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"element_medal",variant:"water"}}]},limit=1] unless data storage luigis_mansion:data current_state.current_data.obtained_items{water_element_medal:1b} run function luigis_mansion:spawn_entities/item/water_element_medal
execute if data storage luigis_mansion:data {element_medal:"ice"} unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"element_medal",variant:"ice"}}]},limit=1] unless data storage luigis_mansion:data current_state.current_data.obtained_items{ice_element_medal:1b} run function luigis_mansion:spawn_entities/item/ice_element_medal
