give @s minecraft:diamond_pickaxe{HideFlags:63,Damage:5,Unbreakable:1b,CustomModelData:29,display:{Name:'{"italic":false,"color":"white","type":"translatable","translate":"luigis_mansion:item.contest_reward_map"}'},luigis_mansion:{id:"luigis_mansion:contest_reward_map"}}
