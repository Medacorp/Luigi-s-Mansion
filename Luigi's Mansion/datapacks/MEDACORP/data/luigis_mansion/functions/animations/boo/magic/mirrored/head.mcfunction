...
execute if entity @s[scores={AnimationProgress=21..40}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 8
execute if entity @s[scores={AnimationProgress=41..100}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 9
