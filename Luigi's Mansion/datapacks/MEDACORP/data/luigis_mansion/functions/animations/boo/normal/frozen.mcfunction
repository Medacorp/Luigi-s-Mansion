...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @s Pose.RightArm[2] float 0.1 run scoreboard players add #temp Time 25
execute if entity @s[scores={AnimationProgress=5..12}] store result entity @s Pose.RightArm[2] float 0.1 run scoreboard players remove #temp Time 25
execute if entity @s[scores={AnimationProgress=13..16}] store result entity @s Pose.RightArm[2] float 0.1 run scoreboard players add #temp Time 25
execute store result score #temp Time run data get entity @s Pose.LeftArm[2] 10
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @s Pose.LeftArm[2] float 0.1 run scoreboard players remove #temp Time 25
