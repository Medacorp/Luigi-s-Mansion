...
teleport @s[scores={AnimationProgress=11}] ^ ^ ^ ~36 ~
teleport @s[scores={AnimationProgress=12}] ^ ^ ^ ~72 ~
teleport @s[scores={AnimationProgress=13}] ^ ^ ^ ~108 ~
teleport @s[scores={AnimationProgress=14}] ^ ^ ^ ~144 ~
teleport @s[scores={AnimationProgress=15}] ^ ^ ^ ~180 ~
teleport @s[scores={AnimationProgress=16}] ^ ^ ^ ~216 ~
teleport @s[scores={AnimationProgress=17}] ^ ^ ^ ~252 ~
teleport @s[scores={AnimationProgress=18}] ^ ^ ^ ~288 ~
teleport @s[scores={AnimationProgress=19}] ^ ^ ^ ~324 ~
