...
data modify entity @s[scores={ActionTime=1}] Pose set from entity @s ArmorItems[3].tag.luigis_mansion.default_orientation
...
data modify entity @s[tag=!dark_room] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.default
