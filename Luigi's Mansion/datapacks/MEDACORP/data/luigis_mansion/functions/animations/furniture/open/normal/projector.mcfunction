...
data modify entity @s[scores={ActionTime=1}] Pose set from entity @s ArmorItems[3].components."minecraft:custom_data".default_orientation
execute store result score #temp Time run data get entity @s Pose.Head[2]
execute if entity @s[scores={ActionTime=2..3}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={ActionTime=4..7}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={ActionTime=8..11}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
...
data modify entity @s[scores={ActionTime=2}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.open
...
data modify entity @s[tag=!dark_room] Pose set from entity @s ArmorItems[3].components."minecraft:custom_data".default_orientation
tag @s[tag=!dark_room] remove lit
data modify entity @s[tag=!dark_room] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.default
