...
execute if entity @s[scores={AnimationProgress=6..7}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProgress=9..10}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 20
execute if entity @s[scores={AnimationProgress=16..17}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProgress=19..20}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 20
