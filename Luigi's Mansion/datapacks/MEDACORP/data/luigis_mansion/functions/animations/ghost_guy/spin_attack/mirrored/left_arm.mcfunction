...
execute if entity @s[scores={AnimationProgress=1..10}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 18
execute if entity @s[scores={AnimationProgress=20..30}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 18
