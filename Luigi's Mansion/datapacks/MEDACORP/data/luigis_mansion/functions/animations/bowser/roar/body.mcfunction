...
execute if entity @s[scores={AnimationProgress=31..50}] store result entity @s Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 35
scoreboard players reset #temp Time
execute if entity @s[scores={AnimationProgress=32}] run playsound luigis_mansion:entity.bowser.roar hostile @a[tag=same_room] ~ ~ ~ 3
