...
data modify entity @s[scores={AnimationProgress=3}] HandItems[0] merge from entity @s HandItems[0].tag.luigis_mansion.model_data.no_food
data modify entity @s[scores={AnimationProgress=5}] HandItems[1] merge from entity @s HandItems[1].tag.luigis_mansion.model_data.no_food
