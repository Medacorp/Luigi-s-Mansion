...
data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 88
...
execute if score #temp2 Time matches -176..0 store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp2 Time 4
execute if score #temp2 Time matches 0..176 store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp2 Time 4
