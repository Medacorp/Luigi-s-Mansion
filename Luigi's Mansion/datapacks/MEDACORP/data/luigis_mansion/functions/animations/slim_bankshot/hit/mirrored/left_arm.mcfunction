...
execute if entity @s[scores={AnimationProgress=1..8}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProgress=11..18}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 2
...
data modify entity @s[tag=!visible] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.invisible
