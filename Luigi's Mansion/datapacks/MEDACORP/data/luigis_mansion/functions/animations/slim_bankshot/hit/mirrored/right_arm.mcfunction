...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 12
...
execute if entity @s[scores={AnimationProgress=15..18}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 12
