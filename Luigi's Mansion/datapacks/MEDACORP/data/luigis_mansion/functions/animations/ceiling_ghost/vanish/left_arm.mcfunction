...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 7
execute if entity @s[scores={AnimationProgress=8..17}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 13
