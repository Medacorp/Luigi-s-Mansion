...
execute if entity @s[scores={AnimationProgress=1}] run data merge entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=right_arm,limit=1] {Pose:{Head:[0.0f,40.0f,0.01f]}}
execute if entity @s[scores={AnimationProgress=1}] run data merge entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=left_arm,limit=1] {Pose:{Head:[0.0f,-40.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProgress=5..8}] store result entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 2
...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=left_arm,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProgress=5..8}] store result entity @e[tag=this_model,tag=!floating_whirlindas_female,tag=left_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 2
