...
$execute if entity @s[tag=!freeze_animation] as @e[type=minecraft:armor_stand,tag=e_gadd_model,scores={PassiveNr=$(id)}] run function luigis_mansion:animations/passive/main with storage luigis_mansion:data macro
