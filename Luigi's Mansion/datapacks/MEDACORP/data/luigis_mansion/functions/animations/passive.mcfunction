data modify storage luigis_mansion:data passive set value {tags:[],room:0,initial_animation_progress:0,animation:{namespace:"luigis_mansion",id:"idle"},rotation:[0.0f,0.0f]}
