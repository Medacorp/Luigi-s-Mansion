...
execute if entity @s[scores={AnimationProgress=11..22}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProgress=23..24}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
