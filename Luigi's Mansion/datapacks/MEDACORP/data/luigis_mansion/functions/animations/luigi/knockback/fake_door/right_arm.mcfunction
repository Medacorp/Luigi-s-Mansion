...
data merge entity @s[scores={AnimationProgress=80,Animation=38}] {Pose:{Head:[90.0f,-22.5f,0.01f]}}
data merge entity @s[scores={AnimationProgress=80,Animation=37}] {Pose:{Head:[90.0f,-45.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProgress=1..5,Animation=37}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 12
...
execute if entity @s[scores={AnimationProgress=6..15,Animation=37}] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 400
execute if entity @s[scores={AnimationProgress=111..120,Animation=38}] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 225
execute if entity @s[scores={AnimationProgress=111..120,Animation=37}] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 450
