...
data merge entity @s[scores={AnimationProgress=80,Animation=38}] {Pose:{Head:[112.5f,0.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProgress=111..120,Animation=38}] store result entity @s Pose.Head[0] float 0.01 run scoreboard players remove #temp Time 1125
execute if entity @s[scores={AnimationProgress=111..120,Animation=37}] store result entity @s Pose.Head[0] float 0.01 run scoreboard players remove #temp Time 900
