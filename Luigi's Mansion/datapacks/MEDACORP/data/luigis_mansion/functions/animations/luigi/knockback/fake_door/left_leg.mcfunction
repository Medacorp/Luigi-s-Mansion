...
data merge entity @s[scores={AnimationProgress=80},tag=left_door] {Pose:{Head:[112.5f,0.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProgress=111..120},tag=left_door] store result entity @s Pose.Head[0] float 0.01 run scoreboard players remove #temp Time 1125
execute if entity @s[scores={AnimationProgress=111..120},tag=!left_door] store result entity @s Pose.Head[0] float 0.01 run scoreboard players remove #temp Time 900
execute store result score #temp Time run data get entity @s Pose.Head[1] 100
execute if entity @s[scores={AnimationProgress=111..120},tag=!left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players remove #temp Time 225
