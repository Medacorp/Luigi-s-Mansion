...
teleport @s[scores={AnimationProgress=..50},tag=!flipped_gravity,tag=!shrunk] ~ ~-0.5 ~ ~ ~
...
teleport @s[scores={AnimationProgress=58},tag=flipped_gravity,tag=!shrunk] ~ ~0.1 ~ ~ ~
teleport @s[scores={AnimationProgress=59},tag=flipped_gravity,tag=!shrunk] ~ ~0.05 ~ ~ ~
teleport @s[scores={AnimationProgress=..50},tag=!flipped_gravity,tag=shrunk] ~ ~-0.25 ~ ~ ~
...
execute if entity @s[scores={AnimationProgress=1..10}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 5
