...
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{tag:{CustomModelData:19}}]}] ArmorItems[3].tag merge value {Damage:2,CustomModelData:20}
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{tag:{CustomModelData:23}}]}] ArmorItems[3].tag merge value {Damage:2,CustomModelData:24}
