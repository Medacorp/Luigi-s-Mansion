...
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":19}}]}] ArmorItems[3].components merge value {"minecraft:damage":2,"minecraft:custom_model_data":20}
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":23}}]}] ArmorItems[3].components merge value {"minecraft:damage":2,"minecraft:custom_model_data":24}
