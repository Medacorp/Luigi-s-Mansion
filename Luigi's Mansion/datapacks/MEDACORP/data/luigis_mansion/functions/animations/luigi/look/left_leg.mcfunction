...
execute if entity @s[scores={AnimationProgress=1..20}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 0.1 run scoreboard players add #temp Time 5
