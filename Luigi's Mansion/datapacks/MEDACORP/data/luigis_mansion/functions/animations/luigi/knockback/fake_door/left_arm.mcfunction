...
execute if entity @s[scores={AnimationProgress=6..15},tag=left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players remove #temp Time 400
execute if entity @s[scores={AnimationProgress=111..120},tag=left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players remove #temp Time 450
