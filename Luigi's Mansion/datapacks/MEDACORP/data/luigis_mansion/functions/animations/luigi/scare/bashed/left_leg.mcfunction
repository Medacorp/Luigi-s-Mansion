...
execute if entity @s[scores={IdleTime=-22,AnimationProgress=1..4},tag=moved] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={IdleTime=-22,AnimationProgress=5..8},tag=moved] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
