...
teleport @s[scores={IdleTime=-2},tag=flipped_gravity,nbt={Small:1b}] ~ ~0.05 ~ ~ ~
teleport @s[scores={IdleTime=-1},tag=flipped_gravity,nbt={Small:1b}] ~ ~0.025 ~ ~ ~
data merge entity @s[scores={IdleTime=-51}] {Pose:{Head:[-90.0f,-5.0f,0.01f]}}
data merge entity @s[scores={IdleTime=-51},tag=flipped_gravity] {Pose:{Head:[-90.0f,-5.0f,-180.0f]}}
...
data merge entity @s[scores={IdleTime=-22},tag=!moved] {Pose:{Head:[-90.0f,-5.0f,0.01f]}}
data merge entity @s[scores={IdleTime=-22},tag=!moved,tag=flipped_gravity] {Pose:{Head:[-90.0f,-5.0f,-180.0f]}}
...
execute if entity @s[scores={IdleTime=-22,AnimationProgress=1..4},tag=moved] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={IdleTime=-22,AnimationProgress=5..8},tag=moved] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={IdleTime=-22,AnimationProgress=1..4},tag=moved] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={IdleTime=-22,AnimationProgress=5..8},tag=moved] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
...
data merge entity @s[scores={IdleTime=-21}] {Pose:{Head:[-90.0f,-5.0f,0.01f]}}
data merge entity @s[scores={IdleTime=-21},tag=flipped_gravity] {Pose:{Head:[-90.0f,-5.0f,-180.0f]}}
execute if entity @s[scores={IdleTime=-10..-1}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 9
execute store result score #temp Time run data get entity @s Pose.Head[1] 10
execute if entity @s[scores={IdleTime=-10..-1}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 5
