...
execute if entity @s[scores={AnimationProgress=41..60}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 5
...
execute if entity @s[scores={AnimationProgress=11..20}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 1
