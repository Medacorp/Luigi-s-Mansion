...
execute if entity @s[scores={AnimationProgress=1..20}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 5
