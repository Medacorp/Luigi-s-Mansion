...
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":19}}]}] ArmorItems[3].components merge value {"minecraft:damage":3,"minecraft:custom_model_data":20}
data modify entity @s[scores={AnimationProgress=15..109},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":23}}]}] ArmorItems[3].components merge value {"minecraft:damage":3,"minecraft:custom_model_data":24}
...
data modify entity @s[scores={AnimationProgress=110},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":24}}]}] ArmorItems[3].components merge value {"minecraft:damage":1,"minecraft:custom_model_data":23}
data modify entity @s[scores={AnimationProgress=110},nbt={ArmorItems:[{components:{"minecraft:custom_model_data":20}}]}] ArmorItems[3].components merge value {"minecraft:damage":1,"minecraft:custom_model_data":19}
