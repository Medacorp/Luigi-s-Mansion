...
execute if entity @s[scores={ClairvoyaSpoke=3}] run function luigis_mansion:dialog/mario_item/hidden/item_4
execute if entity @s[scores={ClairvoyaSpoke=4}] run function luigis_mansion:dialog/mario_item/hidden/item_5
