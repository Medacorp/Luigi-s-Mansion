...
execute if entity @s[scores={Dialog=469}] at @e[tag=parlor_key,limit=1] positioned ~-0.7 ~0.9 ~-0.7 run function luigis_mansion:spawn_entities/item/key {door:"parlor"}
