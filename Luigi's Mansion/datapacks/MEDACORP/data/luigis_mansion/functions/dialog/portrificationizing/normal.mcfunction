...
execute if entity @s[scores={Dialog=1050}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:0} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.peaceful"}]}
execute if entity @s[scores={Dialog=1050}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:1} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.easy"}]}
execute if entity @s[scores={Dialog=1050}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:2} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.normal"}]}
execute if entity @s[scores={Dialog=1050}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:3} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.hard"}]}
...
scoreboard players set @s[scores={Dialog=1069},tag=!ending] AnimationProgress 0
...
execute if entity @s[scores={Dialog=1070},tag=ending] run scoreboard players set @a[tag=same_room,limit=1] EGaddGhostPortrificationizerRoomChoice 2
execute if entity @s[scores={Dialog=1070}] unless entity @a[tag=same_room,limit=1] run scoreboard players set @s Dialog 1072
execute if entity @s[scores={Dialog=1072}] as @a[scores={EGaddGhostPortrificationizerRoomChoice=1},limit=1] run function luigis_mansion:data/save
