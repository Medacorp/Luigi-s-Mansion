...
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run teleport @a[scores={Room=57},tag=!looking_at_map] 714 2 62
...
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run scoreboard players set @a[scores={Room=57},tag=!looking_at_map] PosZ 6250
...
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run scoreboard players set @a[scores={Room=57},tag=looking_at_map] HomeZ 6250
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run data modify entity @e[x=700.0,y=2,z=62.5,distance=..0.7,tag=furniture,tag=door,limit=1] ArmorItems[3].components."minecraft:custom_data".key set value "breaker_room"
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run data modify entity @e[x=713.0,y=2,z=62.5,distance=..0.7,tag=furniture,tag=door,limit=1] ArmorItems[3].components."minecraft:custom_data".key set value "breaker_room"
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run tag @a[tag=looking_at_map,nbt={Dimension:"luigis_mansion:hidden"},limit=1] add regenerate_map
