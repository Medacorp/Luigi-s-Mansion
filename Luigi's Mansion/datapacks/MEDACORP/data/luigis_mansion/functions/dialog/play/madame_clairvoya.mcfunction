...
execute if score #dialog Dialog matches ..47 unless score #dialog Dialog matches 3 unless score #dialog Dialog matches 26 unless score #dialog Dialog matches 48 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 3 as @a[tag=same_room,tag=dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/madame_clairvoya
...
#Branch: Yes
execute if score #dialog Dialog matches 4 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/nod
...
#Branch: No
execute if score #dialog Dialog matches 27 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches -1 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
