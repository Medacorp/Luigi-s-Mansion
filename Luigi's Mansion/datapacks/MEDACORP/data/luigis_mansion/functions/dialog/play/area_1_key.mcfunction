...
execute if score #dialog Dialog matches 21..29 unless score #dialog Dialog matches 24..43 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
