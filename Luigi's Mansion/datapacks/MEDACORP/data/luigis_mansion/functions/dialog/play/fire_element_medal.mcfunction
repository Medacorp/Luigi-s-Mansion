...
execute if score #dialog Dialog matches 42..112 unless score #dialog Dialog matches 44..103 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
