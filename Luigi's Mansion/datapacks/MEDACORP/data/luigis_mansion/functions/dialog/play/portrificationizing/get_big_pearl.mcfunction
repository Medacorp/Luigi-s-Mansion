...
execute if data storage luigis_mansion:data current_state.current_data.new_money_grabbed[0] run function luigis_mansion:dialog/play/portrificationizing/get_money_loop {namespace:"luigis_mansion",id:"big_pearl"}
...
scoreboard players operation #temp2 Money *= #1000 Constants