...
execute if score #dialog Dialog matches ..52 unless score #dialog Dialog matches 4..23 unless score #dialog Dialog matches 28..47 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
