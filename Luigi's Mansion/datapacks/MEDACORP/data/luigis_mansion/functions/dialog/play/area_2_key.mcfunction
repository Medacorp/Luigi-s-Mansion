...
execute if score #dialog Dialog matches 44.. as @a[tag=same_room,tag=same_room] run function luigis_mansion:entities/player/animation/set/game_boy_horror
...
execute if score #dialog Dialog matches 72 as @a[tag=same_room,tag=same_room] run function luigis_mansion:entities/player/animation/set/none
