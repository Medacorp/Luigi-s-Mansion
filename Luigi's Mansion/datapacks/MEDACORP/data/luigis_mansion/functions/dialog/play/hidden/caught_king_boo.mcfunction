...
execute if score #dialog Dialog matches 22..56 unless score #dialog Dialog matches 32..52 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] unless entity @s[tag=using_selection_menu,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
...
execute if score #dialog Dialog matches 32..51 run tag @a[tag=painting_grabbing_player,limit=1,x=636.5,y=93,z=33.5,distance=0.2..] add walking
execute if score #dialog Dialog matches 32..51 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 33 run teleport @s[x=636.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.1 ~ ~
...
execute if score #dialog Dialog matches 97..176 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 33 run teleport @s[x=636.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.05 ~ ~
execute if score #dialog Dialog matches 176..177 as @a[tag=painting_grabbing_player,limit=1] at @s run teleport @s 636 93 33 90 0
...
execute if score #dialog Dialog matches 297..356 as @a[tag=same_room] at @s facing 653 93 33 run teleport @s ~ ~ ~ ~ ~
...
execute if score #dialog Dialog matches 298..356 run tag @a[tag=same_room,tag=!painting_grabbing_player,x=653.5,y=93,z=33.5,distance=0.2..] add walking
execute if score #dialog Dialog matches 298..356 as @a[tag=same_room,tag=!painting_grabbing_player] at @s facing 653 93 33 run teleport @s[x=653.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.1 ~ ~
execute if score #dialog Dialog matches 357 run function luigis_mansion:room/normal/end
