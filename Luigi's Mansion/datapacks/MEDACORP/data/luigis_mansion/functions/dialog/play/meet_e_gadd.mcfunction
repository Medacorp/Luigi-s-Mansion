...
execute if score #dialog Dialog matches 729 run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"get_up"}
execute if score #dialog Dialog matches 749 run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"explain_1_hand"}
