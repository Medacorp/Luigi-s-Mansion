...
execute if score #dialog Dialog matches 62..103 unless score #dialog Dialog matches 67..97 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
