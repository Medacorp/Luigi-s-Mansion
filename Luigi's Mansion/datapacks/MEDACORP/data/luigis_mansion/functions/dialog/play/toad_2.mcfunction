...
execute if score #dialog Dialog matches ..26 unless score #dialog Dialog matches 5..25 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
