...
execute if score #dialog Dialog matches 74..75 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players add #dialog Dialog 1
...
execute if score #dialog Dialog matches 28 if entity @a[tag=same_room,tag=select_dialog_branch_yes,limit=1] run scoreboard players set #dialog Dialog 9
...
execute if score #dialog Dialog matches ..97 unless score #dialog Dialog matches 28..49 unless score #dialog Dialog matches 51..71 unless score #dialog Dialog matches 74 unless score #dialog Dialog matches 76 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 28 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/toad_1
execute if score #dialog Dialog matches 74 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/save
...
execute if score #dialog Dialog matches 1..4 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 4 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches 24..27 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 26 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.toad","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.toad_1.5"}]}
...
execute if score #dialog Dialog matches 28 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/think

#Branch: Yes
execute if score #dialog Dialog matches 29 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/enthusiastic
...
execute if score #dialog Dialog matches 49 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 76 run scoreboard players set #temp Dialog -1
...
execute if score #dialog Dialog matches 77 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches 77 if entity @a[tag=sel,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.toad","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.toad_1.no.1"}]}
execute if score #dialog Dialog matches 97 as @a[tag=same_room,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 98 run scoreboard players set #temp Dialog -1
