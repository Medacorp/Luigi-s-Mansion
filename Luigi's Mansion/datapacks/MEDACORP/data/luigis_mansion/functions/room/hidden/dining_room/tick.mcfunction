...
execute as @a[x=697,y=8,z=-43,dx=14,dy=9,dz=30] unless entity @s[scores={Room=26}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=26},limit=1] run function luigis_mansion:room/hidden/dining_room/ghosts