...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 700 12 -50 run function luigis_mansion:room/hidden/kitchen/closet
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] run data modify storage luigis_mansion:data entity set value {room:27}
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 700 12 -50 run function luigis_mansion:spawn_entities/item/room_search/small_heart
