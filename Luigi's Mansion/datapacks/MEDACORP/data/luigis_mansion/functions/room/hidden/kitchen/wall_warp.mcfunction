...
teleport @s[scores={PositionIntX=710,PositionIntZ=-75..-59}] ~4 ~ ~15
teleport @s[scores={PositionIntX=698,PositionIntZ=-56..-48}] ~-12 ~ ~-17
teleport @s[scores={PositionIntX=698,PositionIntZ=-58..-57}] ~1 ~ ~
teleport @s[scores={PositionIntX=698,PositionIntZ=-75..-59}] ~-14 ~91 ~35
teleport @s[scores={PositionIntZ=-76}] ~ ~ ~1
teleport @s[scores={PositionIntZ=-47}] ~ ~ ~6

teleport @s[scores={PositionIntY=9}] ~ ~1 ~
teleport @s[scores={PositionIntY=16,PositionIntZ=-56..-48}] ~6 ~3 ~10
teleport @s[scores={PositionIntY=16,PositionIntZ=-58..-57}] ~ ~-1 ~
teleport @s[scores={PositionIntY=16,PositionIntZ=-75..-59}] ~-12 ~94 ~35