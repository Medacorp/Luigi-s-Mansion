...
execute if score #hidden_room_hole Searched matches 1 run particle minecraft:dust 0.5 0.5 1 1 757 11 -31 0.2 0.2 0.2 0 4
...
execute if score #hidden_room_hole Searched matches 1 as @e[x=741.5,y=11,z=-30.5,distance=..0.7,tag=game_boy_horror_location] run function luigis_mansion:entities/game_boy_horror_location/bring_player_back
