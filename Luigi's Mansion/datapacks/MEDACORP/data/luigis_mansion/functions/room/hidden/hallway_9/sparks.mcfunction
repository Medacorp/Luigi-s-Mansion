...
execute as @e[type=minecraft:marker,tag=choice] at @s store result score @s Move if entity @e[distance=..1,nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"spark"}}]}]
