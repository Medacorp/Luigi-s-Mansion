...
execute if score #temp Variant matches 5 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["ceramics_studio_orange_stained_vase"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"ceramics_studio_orange_stained_vase",contents:{luigis_mansion:{gold_coin:5}}}
scoreboard players reset #temp Variant
execute positioned 709 29 -57 rotated -90 0 run function luigis_mansion:spawn_furniture/orange_stained_vase