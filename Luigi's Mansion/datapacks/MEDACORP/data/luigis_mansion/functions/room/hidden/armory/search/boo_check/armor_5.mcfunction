...
execute if block 753 33 -47 minecraft:andesite as @a[x=754.5,y=29,z=-45.5,distance=..1,tag=!spectator] positioned 754.0 29 -46.0 run function luigis_mansion:entities/player/damage
