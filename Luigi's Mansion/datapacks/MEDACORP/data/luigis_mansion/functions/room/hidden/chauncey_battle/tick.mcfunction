...
execute as @a[x=782,y=4,z=-69,dx=41,dy=34,dz=41] run scoreboard players set @s LastRoom 73
...
execute if entity @a[tag=!pause_dialog,scores={Room=73},limit=1] run function luigis_mansion:room/hidden/chauncey_battle/ghosts
