...
execute if score #temp Searched matches 0 run playsound luigis_mansion:furniture.clock.coo_coo block @a[scores={Room=62}] 693 121 -3.0 1
execute if score #temp Searched matches 10 run playsound luigis_mansion:furniture.clock.door block @a[scores={Room=62}] 693 121 -3.0 1
