...
execute as @a[x=734,y=8,z=34,dx=14,dy=9,dz=20] unless entity @s[scores={Room=20}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=20},limit=1] run function luigis_mansion:room/hidden/fortune_tellers_room/ghosts