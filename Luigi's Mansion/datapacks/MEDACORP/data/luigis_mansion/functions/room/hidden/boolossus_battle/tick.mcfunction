...
execute as @a[x=562,y=13,z=-9,dx=48,dy=78,dz=87] run scoreboard players set @s LastRoom 75
...
execute if entity @a[tag=!pause_dialog,scores={Room=75},limit=1] run function luigis_mansion:room/hidden/boolossus_battle/ghosts