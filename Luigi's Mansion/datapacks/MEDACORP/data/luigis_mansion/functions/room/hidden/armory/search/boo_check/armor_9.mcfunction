...
execute if block 761 33 -41 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mace"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/large"},no_delete:1b}
execute if block 761 33 -41 minecraft:andesite as @a[x=761.5,y=29,z=-42.5,distance=..1,tag=!spectator] positioned 761 29 -42.0 run function luigis_mansion:entities/player/damage
