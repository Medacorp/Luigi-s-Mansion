...
execute as @a[x=644,y=101,z=-40,dx=27,dy=7,dz=18] unless entity @s[scores={Room=29}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=644,y=101,z=-40,dx=27,dy=7,dz=18] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 29
