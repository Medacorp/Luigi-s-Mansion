...
execute as @a[x=644,y=99,z=-40,dx=27,dy=9,dz=18] unless entity @s[scores={Room=29}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=29},limit=1] run function luigis_mansion:room/hidden/graveyard/ghosts