...
execute if entity @s[x=655.0,y=2,z=29.0,dx=4,dy=7,dz=7,tag=!spectator] unless score #temp Boos matches 45.. unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"king_boo"}}]},scores={Room=61},limit=1] run data modify storage luigis_mansion:data entity set value {show_health:0b}
execute if entity @s[x=655.0,y=2,z=29.0,dx=4,dy=7,dz=7,tag=!spectator] unless score #temp Boos matches 45.. unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"king_boo"}}]},scores={Room=61},limit=1] positioned 656 2 33 run function luigis_mansion:spawn_entities/portrait_ghost/king_boo
