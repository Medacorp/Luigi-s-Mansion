...
execute unless score #foyer_lamp Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_muchroom"],Duration:1}
execute unless score #foyer_lamp Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_muchroom] run data modify storage luigis_mansion:data entity set value {room:1}
