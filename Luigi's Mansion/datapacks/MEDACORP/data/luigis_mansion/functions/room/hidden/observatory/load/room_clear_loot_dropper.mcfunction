...
execute unless data storage luigis_mansion:data current_state.current_data.obtained_items{marios_star:1b} positioned 642.0 20 155.0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
