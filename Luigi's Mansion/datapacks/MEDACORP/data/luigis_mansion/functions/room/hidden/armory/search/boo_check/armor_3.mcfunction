...
execute if block 759 33 -53 minecraft:andesite as @a[x=760.5,y=29,z=-51.5,distance=..1,tag=!spectator] positioned 760.0 29 -52.0 run function luigis_mansion:entities/player/damage
