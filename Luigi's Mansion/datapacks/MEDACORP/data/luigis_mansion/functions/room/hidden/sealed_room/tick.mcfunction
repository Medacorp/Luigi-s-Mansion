...
execute as @a[x=693,y=17,z=70,dx=17,dy=9,dz=33] unless entity @s[scores={Room=66}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=693,y=17,z=70,dx=17,dy=9,dz=33] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 66
...
execute if entity @a[tag=!pause_dialog,scores={Room=66},limit=1] run function luigis_mansion:room/hidden/sealed_room/ghosts