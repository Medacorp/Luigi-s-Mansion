...
execute as @e[x=645,y=90,z=14,dx=6,dy=7,dz=10] unless entity @s[x=648.5,y=93,z=25.5,distance=..0.7] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 31
...
execute if entity @a[tag=exact_same_room,limit=1] run function luigis_mansion:room/hidden/bottom_of_the_well/ghosts
