...
execute as @a[x=637,y=17,z=44,dx=12,dy=9,dz=33] unless entity @s[scores={Room=34}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=34},limit=1] run function luigis_mansion:room/hidden/tea_room/ghosts