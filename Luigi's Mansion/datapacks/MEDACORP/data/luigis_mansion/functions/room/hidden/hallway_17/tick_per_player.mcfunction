...
execute if entity @s[x=726.0,y=120,z=23.0,dx=4,dy=7,dz=7,tag=!spectator] unless score #temp Boos matches 20.. unless entity @e[tag=mysterious_power,limit=1] run data modify storage luigis_mansion:data entity set value {room:52,mansion:{namespace:"luigis_mansion",id:"hidden"}}
execute if entity @s[x=726.0,y=120,z=23.0,dx=4,dy=7,dz=7,tag=!spectator] unless score #temp Boos matches 20.. unless entity @e[tag=mysterious_power,limit=1] positioned 726 29 28 run function luigis_mansion:spawn_entities/portrait_ghost/boolossus/mysterious_power
