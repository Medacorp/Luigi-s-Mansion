...
execute as @e[x=682,y=130,z=-31,dx=31,dy=16,dz=77] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 63
...
execute if entity @a[tag=!pause_dialog,scores={Room=63},tag=!spectator,limit=1] run function luigis_mansion:room/hidden/roof/ghosts
