...
execute as @a[x=648,y=17,z=-14,dx=12,dy=9,dz=14] unless entity @s[scores={Room=43}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=43},limit=1] run function luigis_mansion:room/hidden/bathroom_2/ghosts