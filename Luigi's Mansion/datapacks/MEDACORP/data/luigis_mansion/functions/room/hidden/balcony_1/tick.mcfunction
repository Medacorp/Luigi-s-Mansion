...
execute as @e[x=672,y=108,z=-29,dx=10,dy=9,dz=8] unless entity @s[x=672,y=99,z=-29,dx=10,dy=9,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 6
...
execute if entity @a[tag=exact_same_room,limit=1] run function luigis_mansion:room/hidden/balcony_1/ghosts
