...
execute as @a[x=672,y=110,z=-29,dx=10,dy=7,dz=8] unless entity @s[x=672,y=101,z=-29,dx=10,dy=7,dz=8] unless entity @s[scores={Room=6}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=672,y=110,z=-29,dx=10,dy=7,dz=8] unless entity @s[x=672,y=101,z=-29,dx=10,dy=7,dz=8] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 6
