...
execute as @a[x=672,y=108,z=-29,dx=10,dy=9,dz=8] unless entity @s[x=672,y=99,z=-29,dx=10,dy=9,dz=8] unless entity @s[scores={Room=6}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=6},limit=1] run function luigis_mansion:room/hidden/balcony_1/ghosts