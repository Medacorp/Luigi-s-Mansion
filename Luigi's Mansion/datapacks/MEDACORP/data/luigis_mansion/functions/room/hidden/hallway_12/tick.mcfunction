...
execute as @a[x=697,y=17,z=30,dx=15,dy=9,dz=8] unless entity @s[scores={Room=38}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=697,y=17,z=30,dx=15,dy=9,dz=8] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 38
