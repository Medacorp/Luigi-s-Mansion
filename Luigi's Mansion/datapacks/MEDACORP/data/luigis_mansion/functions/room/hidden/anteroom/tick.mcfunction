...
execute as @a[x=683,y=17,z=-28,dx=12,dy=9,dz=21] unless entity @s[scores={Room=4}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=4},limit=1] run function luigis_mansion:room/hidden/anteroom/ghosts