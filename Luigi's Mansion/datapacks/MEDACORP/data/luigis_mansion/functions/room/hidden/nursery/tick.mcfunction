...
execute as @a[x=737,y=17,z=-58,dx=14,dy=9,dz=20] unless entity @s[scores={Room=10}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=10},limit=1] run function luigis_mansion:room/hidden/nursery/ghosts