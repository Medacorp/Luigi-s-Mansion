...
execute if block 701 11 -54 minecraft:iron_block as @a[x=702.5,y=11,z=-54.0,distance=..2,tag=!spectator] positioned 701 11 -54.0 run function luigis_mansion:entities/player/damage
