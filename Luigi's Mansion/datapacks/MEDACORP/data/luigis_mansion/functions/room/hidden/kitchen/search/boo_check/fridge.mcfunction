...
execute if block 701 11 -54 minecraft:iron_block run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"swinging_door"},amount:10,animation:"knockback/large",no_delete:1b}
execute if block 701 11 -54 minecraft:iron_block as @a[x=702.5,y=11,z=-54.0,distance=..2,gamemode=!spectator] positioned 701 11 -54.0 run function luigis_mansion:entities/player/damage
