...
execute if score #butlers_room_water_bucket Searching matches 20 run function luigis_mansion:room/hidden/butlers_room/search/boo_check/water_bucket
...
execute unless block 747 11 -40 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/butlers_room/search/boo_check/water_bucket