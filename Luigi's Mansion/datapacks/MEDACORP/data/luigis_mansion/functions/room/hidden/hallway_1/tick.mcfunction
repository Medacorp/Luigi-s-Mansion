...
execute as @e[x=735,y=17,z=-4,dx=7,dy=9,dz=21] unless entity @s[x=743,y=8,z=-4,dx=15,dy=18,dz=21] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 2
