data modify storage luigis_mansion:data entity set value {room:66}
execute positioned 696.0 21 -77.0 run function luigis_mansion:spawn_entities/ghost/empty_marker
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["sealed_room_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:66,loot:{name:"sealed_room_speedy_spirit"},tags:["hiding_in_furniture"]}
