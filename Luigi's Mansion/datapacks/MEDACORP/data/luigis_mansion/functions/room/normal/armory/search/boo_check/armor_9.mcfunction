...
execute if block 761 33 56 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mace"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/large"},no_delete:1b}
execute if block 761 33 56 minecraft:andesite as @a[x=761.5,y=29,z=58.5,distance=..1,gamemode=!spectator] positioned 761 29 58.0 run function luigis_mansion:entities/player/damage
...
execute unless entity @e[x=762.5,y=29,z=57.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function luigis_mansion:room/normal/armory/search/armor_9
