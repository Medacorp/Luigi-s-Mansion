...
scoreboard players set @e[x=734,y=19,z=-39,dx=14,dy=7,dz=20] Room 69
...
execute if entity @a[tag=!pause_dialog,scores={Room=69},tag=!spectator,limit=1] run function luigis_mansion:room/normal/sitting_room/ghosts