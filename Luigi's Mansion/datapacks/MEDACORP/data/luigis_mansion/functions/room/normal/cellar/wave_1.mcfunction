data modify storage luigis_mansion:data entity set value {room:58,tags:["hiding_in_furniture"]}
...
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cellar_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:58,loot:{name:"billiards_room_speedy_spirit"},tags:["hiding_in_furniture"]}
