...
execute as @e[x=744,y=28,z=54,dx=22,dy=7,dz=25] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 64
...
execute if entity @a[tag=!pause_dialog,scores={Room=64},tag=!spectator,limit=1] run function luigis_mansion:room/normal/armory/ghosts