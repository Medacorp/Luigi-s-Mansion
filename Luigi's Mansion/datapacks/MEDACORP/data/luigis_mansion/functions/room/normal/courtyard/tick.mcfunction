...
execute as @e[x=644,y=101,z=-41,dx=10,dy=7,dz=78] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 30
...
execute if entity @a[tag=!pause_dialog,scores={Room=30},tag=!spectator,limit=1] run function luigis_mansion:room/normal/courtyard/ghosts