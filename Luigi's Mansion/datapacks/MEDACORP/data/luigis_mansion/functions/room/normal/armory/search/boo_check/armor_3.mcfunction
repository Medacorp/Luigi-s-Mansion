...
execute if block 759 33 68 minecraft:andesite as @a[x=760.5,y=29,z=67.5,distance=..1,tag=!spectator] positioned 760.0 29 68.0 run function luigis_mansion:entities/player/damage
