...
execute as @a[x=627,y=14,z=-145,dx=24,dy=12,dz=72] unless entity @s[scores={Room=46}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=46},limit=1] run function luigis_mansion:room/normal/observatory/ghosts