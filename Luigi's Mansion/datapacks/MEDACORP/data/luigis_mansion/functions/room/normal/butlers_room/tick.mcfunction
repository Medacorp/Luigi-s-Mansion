...
execute as @e[x=737,y=10,z=53,dx=14,dy=7,dz=20] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 23
...
execute if entity @a[tag=!pause_dialog,scores={Room=23},tag=!spectator,limit=1] run function luigis_mansion:room/normal/butlers_room/ghosts