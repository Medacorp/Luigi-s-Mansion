...
execute as @e[x=736,y=26,z=0,dx=24,dy=9,dz=35] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 56
...
execute if entity @a[tag=exact_same_room,limit=1] run function luigis_mansion:room/normal/telephone_room/ghosts
