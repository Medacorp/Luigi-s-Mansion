...
execute as @e[x=777,y=3,z=-26,dx=51,dy=38,dz=55] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 74
...
execute if entity @a[gamemode=!spectator,tag=!pull_open_door,tag=!push_open_door,scores={Room=74},limit=1] run function luigis_mansion:room/normal/bogmire_battle/ghosts