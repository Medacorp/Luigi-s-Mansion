...
execute as @a[x=777,y=3,z=-26,dx=51,dy=38,dz=55] run scoreboard players set @s LastRoom 74
...
execute if entity @a[tag=!pause_dialog,scores={Room=74},limit=1] run function luigis_mansion:room/normal/bogmire_battle/ghosts