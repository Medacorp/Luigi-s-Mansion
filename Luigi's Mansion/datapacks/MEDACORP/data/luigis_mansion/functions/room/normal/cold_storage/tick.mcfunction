...
execute as @e[x=721,y=1,z=-6,dx=21,dy=7,dz=18] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 68
...
execute if entity @a[tag=!pause_dialog,scores={Room=68},tag=!spectator,limit=1] run function luigis_mansion:room/normal/cold_storage/ghosts