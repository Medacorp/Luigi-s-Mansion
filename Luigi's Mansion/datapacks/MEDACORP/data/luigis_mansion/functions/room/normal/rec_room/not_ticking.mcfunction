...
execute as @e[scores={Room=32},nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"biff_atlas"}}]}] run function luigis_mansion:entities/biff_atlas/disappear/normal
