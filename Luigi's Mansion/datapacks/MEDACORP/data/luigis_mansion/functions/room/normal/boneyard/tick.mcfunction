...
execute as @e[x=672,y=101,z=37,dx=13,dy=7,dz=19] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 28
...
execute if entity @a[tag=!pause_dialog,scores={Room=28},tag=!spectator,limit=1] run function luigis_mansion:room/normal/boneyard/ghosts