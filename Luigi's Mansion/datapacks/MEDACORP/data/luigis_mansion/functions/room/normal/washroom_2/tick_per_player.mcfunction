...
execute if data storage luigis_mansion:data current_state.current_data.rooms.washroom_2{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/normal/washroom_2/set_seen
