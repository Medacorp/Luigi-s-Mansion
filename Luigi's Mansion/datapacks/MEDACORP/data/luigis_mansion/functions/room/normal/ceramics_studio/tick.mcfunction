...
execute as @e[x=696,y=28,z=56,dx=17,dy=7,dz=25] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 65
...
execute if entity @a[tag=!pause_dialog,scores={Room=65},tag=!spectator,limit=1] run function luigis_mansion:room/normal/ceramics_studio/ghosts