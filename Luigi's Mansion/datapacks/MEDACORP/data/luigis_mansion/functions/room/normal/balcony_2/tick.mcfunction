...
execute as @e[x=653,y=119,z=-42,dx=30,dy=25,dz=80] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 53
...
execute if entity @a[tag=!pause_dialog,scores={Room=53},tag=!spectator,limit=1] run function luigis_mansion:room/normal/balcony_2/ghosts