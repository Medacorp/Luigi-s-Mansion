...
execute as @e[x=645,y=92,z=-9,dx=6,dy=7,dz=10] unless entity @s[x=648.5,y=93,z=-9.5,distance=..0.7] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 31
...
execute if entity @a[tag=!pause_dialog,scores={Room=31},tag=!spectator,limit=1] run function luigis_mansion:room/normal/bottom_of_the_well/ghosts