...
execute as @a[x=645,y=90,z=-9,dx=6,dy=7,dz=10] unless entity @s[x=648.5,y=93,z=-9.5,distance=..0.7] unless entity @s[scores={Room=31}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=31},limit=1] run function luigis_mansion:room/normal/bottom_of_the_well/ghosts