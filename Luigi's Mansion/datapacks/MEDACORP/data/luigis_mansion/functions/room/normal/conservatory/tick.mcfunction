...
execute as @a[x=652,y=8,z=-29,dx=12,dy=9,dz=28] unless entity @s[scores={Room=25}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=25},limit=1] run function luigis_mansion:room/normal/conservatory/ghosts