...
execute as @a[x=676,y=17,z=55,dx=12,dy=9,dz=21] unless entity @s[scores={Room=5}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=5},limit=1] run function luigis_mansion:room/normal/wardrobe_room/ghosts