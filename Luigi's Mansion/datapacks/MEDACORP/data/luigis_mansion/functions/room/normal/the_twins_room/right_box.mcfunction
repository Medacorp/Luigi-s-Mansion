...
execute unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"orville"}}]},limit=1] run data modify storage luigis_mansion:data entity set value {scan_message:{sender:"me",message:'{"translate":"luigis_mansion:message.orville.scan"}'}}
