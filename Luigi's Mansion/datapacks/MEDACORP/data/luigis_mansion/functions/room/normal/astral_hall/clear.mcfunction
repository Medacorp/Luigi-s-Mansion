...
data remove entity @e[x=666.5,y=20.0,z=-92.0,distance=..0.7,tag=furniture,tag=door,limit=1] ArmorItems[3].tag.luigis_mansion.go_through_command
data modify entity @e[x=666.5,y=20.0,z=-92.0,distance=..0.7,tag=furniture,tag=door,limit=1] ArmorItems[3].tag.luigis_mansion.other_end set value {x:645,y:20,z:-73}
