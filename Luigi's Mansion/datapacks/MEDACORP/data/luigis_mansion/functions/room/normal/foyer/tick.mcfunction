...
execute as @a[x=743,y=8,z=-2,dx=15,dy=18,dz=21] unless entity @s[scores={Room=1}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=1},limit=1] run function luigis_mansion:room/normal/foyer/ghosts