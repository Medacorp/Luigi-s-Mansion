...
execute if block 757 33 73 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mace"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/large"},no_delete:1b}
execute if block 757 33 73 minecraft:andesite as @a[x=758.5,y=29,z=72.5,distance=..1,tag=!spectator] positioned 758.0 29 73.0 run function luigis_mansion:entities/player/damage
