...
execute if score #boneyard_dog_house Searched matches 1 run particle minecraft:dust{color:[0.5f,0.5f,1f],scale:1f} 674 102 53 0.2 0.2 0.2 0 4
execute if score #boneyard_dog_house Searched matches 1 as @e[x=674.5,y=102,z=53.5,distance=..0.7,tag=game_boy_horror_location] run function luigis_mansion:entities/game_boy_horror_location/bring_player_back
