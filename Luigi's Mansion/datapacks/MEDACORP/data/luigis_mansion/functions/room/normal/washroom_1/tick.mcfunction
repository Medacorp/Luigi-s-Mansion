...
execute as @e[x=660,y=8,z=34,dx=8,dy=9,dz=14] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 19
...
execute if entity @a[tag=exact_same_room,limit=1] run function luigis_mansion:room/normal/washroom_1/ghosts
