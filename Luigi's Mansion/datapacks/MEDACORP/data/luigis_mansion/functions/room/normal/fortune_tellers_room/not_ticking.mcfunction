...
execute as @e[scores={Room=20},nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"madame_clairvoya"}}]}] run function luigis_mansion:old_entities/ghost/turn_invisible