...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 684.0 11.3 33 run function luigis_mansion:room/normal/projection_room/closet
