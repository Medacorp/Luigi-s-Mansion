...
scoreboard players set @e[x=723,y=28,z=40,dx=16,dy=7,dz=8] Room 54
...
execute if entity @a[tag=same_room,tag=!spectator,limit=1] run function luigis_mansion:room/normal/hallway_18/ghosts
