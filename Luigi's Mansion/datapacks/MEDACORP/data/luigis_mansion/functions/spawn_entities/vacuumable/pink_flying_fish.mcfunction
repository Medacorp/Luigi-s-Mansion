summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.pink_flying_fish"}',Tags:["optional_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","flying_fish","vacuumable","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"pink_flying_fish"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.pink_flying_fish"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:16,luigis_mansion:{invisible:"minecraft:stone_button",visible:"minecraft:leather_chestplate"},display:{color:16740863}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","flying_fish_model","found_owner","this_entity"],DisabledSlots:2039583}
