summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.haunted_frying_pan"}',Tags:["affected_by_vacuum","affected_by_dust","affected_by_fire","affected_by_water","affected_by_ice","ghost","vacuumable","haunted_frying_pan","optional_ghost","no_remove_on_non_ticking","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"haunted_object"},flying_animation:{namespace:"luigis_mansion",id:"spin_yaw"},shake_sound:{namespace:"luigis_mansion",id:"metal"}}}
