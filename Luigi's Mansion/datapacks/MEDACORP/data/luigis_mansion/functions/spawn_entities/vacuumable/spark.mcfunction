summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.spark"}',Tags:["optional_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","ghost","vacuumable","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"spark"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.spark"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:105,luigis_mansion:{invisible:"minecraft:stone_button",visible:"minecraft:diamond_pickaxe"}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","spark_model","found_owner","this_entity"],DisabledSlots:2039583}
