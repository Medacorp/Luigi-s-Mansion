summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.spark"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{namespace:"luigis_mansion",id:"spark",Unbreakable:1b,Damage:1,CustomModelData:105}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["optional_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","ghost","vacuumable","this_entity"],DisabledSlots:2039583}
...
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.loot set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.spark.loot
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.damage set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.spark.damage
