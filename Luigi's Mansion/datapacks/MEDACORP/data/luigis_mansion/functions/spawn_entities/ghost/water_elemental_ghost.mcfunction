summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.water_elemental_ghost"}',Tags:["water","affected_by_vacuum","affected_by_ice","ghost","optional_ghost","no_delete_on_room_clear","vacuumable","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"elemental_ghost"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.water_elemental_ghost"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:109,luigis_mansion:{model_data:{default:{tag:{CustomModelData:109}},hurt:{tag:{CustomModelData:110}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","elemental_ghost_model","found_owner","this_entity"],DisabledSlots:2039583}
...
data modify entity @e[tag=this_entity,limit=1] data.loot set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.water_elemental_ghost.loot
