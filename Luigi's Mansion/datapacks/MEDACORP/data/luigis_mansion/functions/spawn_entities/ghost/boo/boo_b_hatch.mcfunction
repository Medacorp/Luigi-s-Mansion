data modify storage luigis_mansion:data entity merge value {id:"boo_b_hatch",name:'{"type":"translatable","translate":"luigis_mansion:entity.boo_b_hatch"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
