data modify storage luigis_mansion:data entity merge value {id:"boolderdash",name:'{"type":"translatable","translate":"luigis_mansion:entity.boolderdash"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
...
data modify storage luigis_mansion:data entity.damage set from storage luigis_mansion:data current_state.current_data.boos[{name:"boolderdash"}].damage
