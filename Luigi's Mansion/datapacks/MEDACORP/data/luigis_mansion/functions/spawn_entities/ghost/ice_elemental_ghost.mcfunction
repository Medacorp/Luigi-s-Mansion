summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ice_elemental_ghost"}',Tags:["ice","affected_by_vacuum","affected_by_fire","ghost","optional_ghost","no_delete_on_room_clear","vacuumable","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"elemental_ghost"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ice_elemental_ghost"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:111,luigis_mansion:{model_data:{default:{tag:{CustomModelData:111}},hurt:{tag:{CustomModelData:112}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","elemental_ghost_model","found_owner","this_entity"],DisabledSlots:2039583}
