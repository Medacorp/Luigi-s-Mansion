data modify storage luigis_mansion:data entity merge value {id:"kung_boo",name:'{"type":"translatable","translate":"luigis_mansion:entity.kung_boo"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
