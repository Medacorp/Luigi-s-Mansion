data modify storage luigis_mansion:data entity merge value {id:"limbooger",name:'{"translate":"luigis_mansion:entity.limbooger"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
