summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fire_elemental_source"}',NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Tags:["elemental_source","fire","enabled","this_entity"]}
