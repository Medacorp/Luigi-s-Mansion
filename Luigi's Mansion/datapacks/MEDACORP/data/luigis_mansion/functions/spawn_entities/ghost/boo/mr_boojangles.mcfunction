data modify storage luigis_mansion:data entity merge value {id:"mr_boojangles",name:'{"translate":"luigis_mansion:entity.mr_boojangles"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
