data modify storage luigis_mansion:data entity merge value {id:"gameboo_advance",name:'{"translate":"luigis_mansion:entity.gameboo_advance"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
