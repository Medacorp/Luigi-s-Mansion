summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shining_ghost"}',Tags:["ball","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","this_entity","vacuumable"],data:{entity:{namespace:"luigis_mansion",id:"shining_ghost"}}}
