summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shining_ghost"}',Invisible:1b,NoGravity:1b,Marker:0b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"shining_ghost"}},Unbreakable:1b,Damage:1,CustomModelData:17,display:{color:16771072}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["ball","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","this_entity","vacuumable"],DisabledSlots:2039583}
