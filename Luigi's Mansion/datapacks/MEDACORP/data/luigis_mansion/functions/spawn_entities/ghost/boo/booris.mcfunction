data modify storage luigis_mansion:data entity merge value {id:"booris",name:'{"translate":"luigis_mansion:entity.booris"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
