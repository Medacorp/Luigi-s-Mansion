data modify storage luigis_mansion:data entity merge value {id:"taboo",name:'{"translate":"luigis_mansion:entity.taboo"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
