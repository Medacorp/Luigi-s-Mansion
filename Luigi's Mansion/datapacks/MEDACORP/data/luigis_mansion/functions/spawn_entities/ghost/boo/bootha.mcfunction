data modify storage luigis_mansion:data entity merge value {id:"bootha",name:'{"type":"translatable","translate":"luigis_mansion:entity.bootha"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
