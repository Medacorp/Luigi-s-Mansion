data modify storage luigis_mansion:data entity merge value {id:"peekaboo",name:'{"type":"translatable","translate":"luigis_mansion:entity.peekaboo"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
...
data modify storage luigis_mansion:data entity.damage set from storage luigis_mansion:data current_state.current_data.boos[{name:"peekaboo"}].damage
