data modify storage luigis_mansion:data entity merge value {id:"boonswoggle",name:'{"translate":"luigis_mansion:entity.boonswoggle"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
