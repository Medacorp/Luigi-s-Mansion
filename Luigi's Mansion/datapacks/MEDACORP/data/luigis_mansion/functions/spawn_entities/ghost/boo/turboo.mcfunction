data modify storage luigis_mansion:data entity merge value {id:"turboo",name:'{"translate":"luigis_mansion:entity.turboo"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
