data modify storage luigis_mansion:data entity merge value {id:"underboo",name:'{"type":"translatable","translate":"luigis_mansion:entity.underboo"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
