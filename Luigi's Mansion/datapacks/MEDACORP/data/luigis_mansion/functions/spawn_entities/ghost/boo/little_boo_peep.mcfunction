data modify storage luigis_mansion:data entity merge value {id:"little_boo_peep",name:'{"translate":"luigis_mansion:entity.little_boo_peep"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
