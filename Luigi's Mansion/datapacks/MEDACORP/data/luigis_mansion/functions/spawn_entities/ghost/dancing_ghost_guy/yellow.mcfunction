...
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.loot set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.loot
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.damage set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.damage
...
execute if entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] run tag @e[tag=this_entity,limit=1] add has_partner
tag @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] add has_partner
