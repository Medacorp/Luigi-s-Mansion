...
execute if entity @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] run scoreboard players operation @e[tag=this_entity,limit=1] GhostGuyCouple = @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] GhostGuyCouple
execute if entity @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] run tag @e[tag=this_entity,limit=1] add has_partner
tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}}]},distance=..2,tag=!this_entity,tag=!has_partner,limit=1] add has_partner
