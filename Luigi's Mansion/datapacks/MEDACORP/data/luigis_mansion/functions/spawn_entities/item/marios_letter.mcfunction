summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:item.marios_letter"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{luigis_mansion:{namespace:"luigis_mansion",id:"mario_item",physics_offset:1.1d,pick_up_range:0.7f,variant:"letter"},Unbreakable:1b,Damage:5,CustomModelData:25}}],Tags:["item","generic","affected_by_vacuum","eternal","this_entity"],DisabledSlots:2039583}
