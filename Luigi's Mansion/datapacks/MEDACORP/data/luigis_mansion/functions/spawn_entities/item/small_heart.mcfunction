...
execute unless score #temp Money >= #heart_money_count Selected run summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion:item.heart"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"luigis_mansion",id:"heart",variant:10,Unbreakable:1b,Damage:5,CustomModelData:13}}],Tags:["item","heart","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
execute if score #temp Money >= #heart_money_count Selected run summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion:item.heart"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"luigis_mansion",id:"heart",variant:20,Unbreakable:1b,Damage:5,CustomModelData:30}}],Tags:["item","heart","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
