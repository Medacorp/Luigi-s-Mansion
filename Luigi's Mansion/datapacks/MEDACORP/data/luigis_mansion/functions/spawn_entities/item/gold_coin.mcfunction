summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.gold_coin"}',Pose:{Head:[-90.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{luigis_mansion:{namespace:"luigis_mansion",id:"gold_coin",physics_offset:1.4d,pick_up_range:0.7f,particle:{chance:400,name:"minecraft:crit"}},Unbreakable:1b,Damage:5,CustomModelData:9}}],Tags:["item","coin","no_capture_sound","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
