summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:item.bill"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{luigis_mansion:{namespace:"luigis_mansion",id:"bill",physics_offset:1.3d,pick_up_range:0.7f},Unbreakable:1b,Damage:5,CustomModelData:10}}],Tags:["item","paper","no_capture_sound","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
