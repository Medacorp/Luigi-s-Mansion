summon minecraft:armor_stand ~ ~-0.8 ~ {CustomName:'{"translate":"luigis_mansion:item.medium_pearl"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{assign_rank:{namespace:"luigis_mansion",id:"null"},Unbreakable:1b,Damage:5,CustomModelData:4}}],Tags:["item","affected_by_vacuum","medium_pearl","no_move","this_entity"],DisabledSlots:2039583}
