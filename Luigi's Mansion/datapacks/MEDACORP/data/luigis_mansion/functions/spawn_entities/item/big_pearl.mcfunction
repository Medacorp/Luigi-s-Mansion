summon minecraft:armor_stand ~ ~-0.8 ~ {CustomName:'{"translate":"luigis_mansion:item.big_pearl"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"luigis_mansion",id:"big_pearl",assign_rank:{namespace:"luigis_mansion",id:"null"},particle:{chance:1,name:"minecraft:crit"},Unbreakable:1b,Damage:5,CustomModelData:5}}],Tags:["item","generic","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
