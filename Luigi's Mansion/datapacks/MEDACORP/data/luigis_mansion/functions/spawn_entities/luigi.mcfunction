...
summon minecraft:armor_stand ~ ~ ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["head","luigi_model","model_piece","new","found_owner"],CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.luigi"}',ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:18,display:{color:37129}}}]}
...
summon minecraft:armor_stand ~ ~ ~ {NoGravity:1b,Marker:1b,Invisible:1b,Tags:["poltergust_body","luigi_model","model_piece","new","found_owner"],CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.luigi"}',ArmorItems:[{},{},{},{}]}
