summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.wind"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:24,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"vacuumable_object"}}}}],Pose:{Head:[0.0f,0.01f,0.0f]},Tags:["wind","affected_by_vacuum","vacuumable_object","this_entity"],DisabledSlots:2039583}
