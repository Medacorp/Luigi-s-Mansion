summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.rocking_horse"}',Tags:["rocking_horse","battle","this_entity"],Pose:{Head:[0.0f,0.0f,0.01f]},NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:9,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"rocking_horse"}}}}],Invisible:1b,DisabledSlots:2039583}
