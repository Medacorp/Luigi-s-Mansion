summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ice_spike"}',Tags:["ice_spikes_spawner","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"ice_spikes_spawner"}}}
