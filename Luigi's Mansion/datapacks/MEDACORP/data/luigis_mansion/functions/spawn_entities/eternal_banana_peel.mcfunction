summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.banana_peel"}',ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"banana_peel"}}}}],Small:1b,Invisible:1b,NoGravity:1b,Marker:1b,Tags:["vacuumable","affected_by_vacuum","banana_peel","eternal","this_entity"]}
