...
scoreboard players set @e[tag=black_bogmire,tag=this_entity,limit=1] EntitySizeWidth 14
scoreboard players set @e[tag=black_bogmire,tag=this_entity,limit=1] EntitySizeHeight 30
