...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.king_boo"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:3,CustomModelData:86,luigis_mansion:{mirror:{tag:{Damage:2}},model_data:{default:{id:"minecraft:diamond_pickaxe"},attacking:{id:"minecraft:stone_button"}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","left_arm","this_entity"]}
