summon minecraft:armor_stand ~ ~-1.5 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.jarvis"}',Invisible:1b,NoGravity:1b,Marker:0b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:77,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"jarvis"},visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",model_data:{default:{tag:{CustomModelData:77}},frozen:{tag:{CustomModelData:78}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["portrait_ghost","portrait_ghost_pop","pearl_dropper","affected_by_vacuum","affected_by_ice","ghost","this_entity"],DisabledSlots:2039583}
...
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.luigis_mansion.loot set from storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.jarvis.loot
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].tag.luigis_mansion.damage set from storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.jarvis.damage
