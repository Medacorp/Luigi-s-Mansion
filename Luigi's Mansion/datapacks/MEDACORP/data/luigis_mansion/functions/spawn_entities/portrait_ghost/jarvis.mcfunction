...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.jarvis"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:77,luigis_mansion:{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",model_data:{default:{tag:{CustomModelData:77}},frozen:{tag:{CustomModelData:78}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","jarvis_model","found_owner","this_entity"],DisabledSlots:2039583}
