...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"water"},amount:10,animation:{namespace:"luigis_mansion",id:"knockback/soak"},attacker:-1,no_delete:1b}
