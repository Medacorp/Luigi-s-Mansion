...
function luigis_mansion:entities/floating_whirlindas_male/reset_mansion_specific with entity @s data.mansion
function luigis_mansion:entities/floating_whirlindas_male/save_stats