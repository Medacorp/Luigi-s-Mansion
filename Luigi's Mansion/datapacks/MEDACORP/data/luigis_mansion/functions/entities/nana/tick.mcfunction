...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..1.6,limit=1] if entity @s[tag=!vanish,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,tag=!hurt,tag=!fleeing] run function luigis_mansion:entities/nana/collide
...
execute at @s[tag=fleeing,tag=!second_flee_state] run function luigis_mansion:old_animations/nana/flee
...
execute at @s[tag=!fleeing,tag=hurt] run function luigis_mansion:old_animations/nana/hurt
