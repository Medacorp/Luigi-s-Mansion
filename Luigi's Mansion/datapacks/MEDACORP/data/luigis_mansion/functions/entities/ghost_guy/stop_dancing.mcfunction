...
execute as @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"dancing_ghost_guy"}}}]},tag=dancing,tag=!me] if score @s GhostGuyCouple = #temp GhostGuyCouple run tag @s add partner
