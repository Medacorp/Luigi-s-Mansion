...
execute if entity @s[scores={ActionTime=30}] positioned 681 10.8125 79 unless entity @e[nbt={ArmorItems:[{components:{"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"billiards_ball"}}}}]},distance=..0.7,limit=1] positioned ~ ~1.1875 ~ rotated -165 0 run function luigis_mansion:spawn_entities/ball/billiards/white
