...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!fleeing,tag=!dying] run playsound luigis_mansion:entity.slim_bankshot.hurt hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={HurtTime=1},tag=hurt,tag=!fleeing,tag=!dying] Sound 40
execute if entity @s[scores={Sound=0},tag=fleeing,tag=!dying] run playsound luigis_mansion:entity.slim_bankshot.flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s[tag=fleeing,tag=!second_flee_state] run function luigis_mansion:old_animations/slim_bankshot/flee
...
execute at @s[tag=!fleeing,tag=hurt] run function luigis_mansion:old_animations/slim_bankshot/hurt
