...
execute if entity @s[tag=visible] run function luigis_mansion:entities/ghost/set_random_path
execute if entity @s[tag=visible] run function luigis_mansion:entities/blue_mouse/set_home
