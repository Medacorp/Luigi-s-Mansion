...
advancement grant @a[tag=!spectator,scores={Invulnerable=0},distance=..0.7] only luigis_mansion:challenges/waluigi_pinball purple_mouse
...
data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:mouse",amount:0,knockback:"small",attacker:-1,no_delete:1b}
