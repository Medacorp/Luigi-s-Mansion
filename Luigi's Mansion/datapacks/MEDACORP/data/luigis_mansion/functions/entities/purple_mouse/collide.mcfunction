...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mouse"},amount:0,animation:"knockback/small",attacker:-1,no_delete:1b}
