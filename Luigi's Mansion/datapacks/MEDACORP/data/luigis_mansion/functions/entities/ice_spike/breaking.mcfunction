...
data modify entity @s[scores={ActionTime=1}] ArmorItems[3].components."minecraft:custom_model_data" set value 26
...
data modify entity @s[scores={ActionTime=7}] ArmorItems[3] merge value {id:"minecraft:diamond_pickaxe",components:{"minecraft:custom_model_data":25}}
