...
execute if entity @s[scores={AnimationProgress=1}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
...
execute if entity @s[scores={AnimationProgress=2..3}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 4
...
execute if entity @s[scores={AnimationProgress=4}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
