...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"billiards_ball"},amount:0,animation:"knockback/medium",no_delete:1b}
