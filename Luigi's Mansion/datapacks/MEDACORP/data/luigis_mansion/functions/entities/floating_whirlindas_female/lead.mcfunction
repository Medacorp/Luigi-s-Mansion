...
execute if entity @s[scores={Dialog=300},nbt={data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.bow hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=400},nbt={data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.bow hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=400},nbt=!{data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.dance hostile @a[tag=same_room] ~ ~ ~ 1
