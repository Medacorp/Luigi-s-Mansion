...
execute if data entity @s[tag=dead,tag=hit] ArmorItems[3].tag.luigis_mansion.owner run function luigis_mansion:entities/ghost/owner_laugh with entity @s ArmorItems[3].tag.luigis_mansion
execute if data entity @s[tag=dead,tag=!hit] ArmorItems[3].tag.luigis_mansion.owner run function luigis_mansion:entities/ghost/owner_complain with entity @s ArmorItems[3].tag.luigis_mansion