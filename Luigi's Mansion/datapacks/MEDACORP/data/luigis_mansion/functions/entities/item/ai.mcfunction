...
execute if entity @s[tag=picked_up] run function luigis_mansion:entities/item/picked_up with entity @s ArmorItems[3].components."minecraft:custom_data".item
