...
execute unless block ~ ~0.6 ~ #luigis_mansion:items_ignore unless block ~ ~1.1 ~ #minecraft:slabs[type=top] run function luigis_mansion:entities/item/physics/step/bounce
