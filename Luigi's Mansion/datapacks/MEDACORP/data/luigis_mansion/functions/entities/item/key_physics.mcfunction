...
execute unless entity @s[scores={ActionTime=1..}] if entity @s at @s positioned ~ ~0.1 ~ if block ^ ^ ^0.2 #luigis_mansion:items_ignore unless block ^ ^ ^0.2 #minecraft:slabs at @s run teleport @s ^ ^ ^0.1
execute if entity @s[scores={ActionTime=1}] at @s positioned ~ ~0.1 ~ if block ^ ^ ^0.1 #luigis_mansion:items_ignore unless block ^ ^ ^0.1 #minecraft:slabs at @s run teleport @s ^ ^ ^0.05
execute if entity @s[scores={ActionTime=2}] at @s positioned ~ ~0.1 ~ if block ^ ^ ^0.05 #luigis_mansion:items_ignore unless block ^ ^ ^0.05 #minecraft:slabs at @s run teleport @s ^ ^ ^0.025
execute if entity @s[scores={ActionTime=3},tag=!bounce] at @s positioned ~ ~0.1 ~ if block ^ ^ ^0.025 #luigis_mansion:items_ignore unless block ^ ^ ^0.025 #minecraft:slabs at @s run teleport @s ^ ^ ^0.0125
...
execute at @s[tag=bounce,scores={ActionTime=4..}] positioned ~ ~0.3 ~ if block ~ ~0.6 ~ #minecraft:slabs[type=bottom] run teleport @s ~ ~0.1 ~
...
execute at @s unless block ~ ~0.3 ~0.3 #luigis_mansion:item_pull_ignore if block ~ ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore run teleport @s ~ ~ ~-0.3
execute at @s unless block ~ ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore if block ~ ~0.3 ~0.3 #luigis_mansion:item_pull_ignore run teleport @s ~ ~ ~0.3
execute at @s unless block ~0.3 ~0.3 ~ #luigis_mansion:item_pull_ignore if block ~-0.3 ~0.3 ~ #luigis_mansion:item_pull_ignore run teleport @s ~0.3 ~ ~
execute at @s unless block ~-0.3 ~0.3 ~ #luigis_mansion:item_pull_ignore if block ~0.3 ~0.3 ~ #luigis_mansion:item_pull_ignore run teleport @s ~-0.3 ~ ~
execute at @s unless block ~0.3 ~0.3 ~0.3 #luigis_mansion:item_pull_ignore if block ~-0.3 ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore run teleport @s ~-0.3 ~ ~-0.3
execute at @s unless block ~0.3 ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore if block ~-0.3 ~0.3 ~0.3 #luigis_mansion:item_pull_ignore run teleport @s ~-0.3 ~ ~0.3
execute at @s unless block ~-0.3 ~0.3 ~0.3 #luigis_mansion:item_pull_ignore if block ~0.3 ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore run teleport @s ~0.3 ~ ~-0.3
execute at @s unless block ~-0.3 ~0.3 ~-0.3 #luigis_mansion:item_pull_ignore if block ~0.3 ~0.3 ~0.3 #luigis_mansion:item_pull_ignore run teleport @s ~0.3 ~ ~0.3

execute at @s positioned ~ ~0.3 ~ if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] run tag @s add picked_up
execute at @s positioned ~ ~0.3 ~ run tag @a[tag=same_room,tag=!spectator,distance=..0.7,limit=1] add collector
execute at @s positioned ~ ~0.3 ~ unless entity @a[tag=collector,limit=1] as @e[tag=same_room,tag=game_boy_horror_location,tag=!spectator,tag=player,distance=..0.7,limit=1] run function luigis_mansion:entities/game_boy_horror_location/tag_for_collecting