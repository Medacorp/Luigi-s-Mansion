...
execute if entity @s[tag=bounce,scores={ActionTime=0}] if block ~ ~-0.6 ~ #luigis_mansion:item_bounce_ignore if block ~ ~0.4 ~ #luigis_mansion:item_bounce_ignore run function luigis_mansion:entities/item/bounce_top
...
execute if entity @s[tag=bounce,scores={ActionTime=2}] if block ~ ~0.4 ~ #luigis_mansion:item_bounce_ignore run function luigis_mansion:entities/item/bounce_top
execute if entity @s[tag=bounce,scores={ActionTime=3}] if block ~ ~0.9 ~ #luigis_mansion:item_bounce_ignore run function luigis_mansion:entities/item/bounce_top

execute store result score @s HomeY run data get entity @s Pos[1] 100
execute unless entity @s[scores={ActionTime=1..}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.2 #luigis_mansion:items_ignore unless block ^ ^ ^0.2 #minecraft:slabs at @s run teleport @s ^ ^ ^0.2
execute if entity @s[scores={ActionTime=1}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.1 #luigis_mansion:items_ignore unless block ^ ^ ^0.1 #minecraft:slabs at @s run teleport @s ^ ^ ^0.1
execute if entity @s[scores={ActionTime=2}] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.05 #luigis_mansion:items_ignore unless block ^ ^ ^0.05 #minecraft:slabs at @s run teleport @s ^ ^ ^0.05
execute if entity @s[scores={ActionTime=3},tag=!bounce] at @s positioned ~ ~1.4 ~ if block ^ ^ ^0.025 #luigis_mansion:items_ignore unless block ^ ^ ^0.025 #minecraft:slabs at @s run teleport @s ^ ^ ^0.025
...
execute at @s positioned ~ ~1.6 ~ if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] run tag @s add picked_up
execute at @s positioned ~ ~1.6 ~ run tag @a[tag=same_room,tag=!spectator,distance=..0.7,limit=1] add collector
execute at @s positioned ~ ~1.6 ~ unless entity @a[tag=collector,limit=1] as @e[tag=same_room,tag=game_boy_horror_location,tag=!spectator,tag=player,distance=..0.7,limit=1] run function luigis_mansion:entities/game_boy_horror_location/tag_for_collecting