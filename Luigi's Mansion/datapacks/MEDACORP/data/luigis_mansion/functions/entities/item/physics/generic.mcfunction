...
$execute at @s positioned ~ ~$(physics_offset) ~ run function luigis_mansion:entities/item/physics/step/gravity
scoreboard players set @s[scores={Move=0},tag=keep_bouncing,tag=!falling] Move 12
$execute unless entity @s[scores={Move=0}] at @s positioned ~ ~$(physics_offset) ~ run function luigis_mansion:entities/item/physics/step/horizontal_motion
$execute unless entity @s[scores={Move=0}] at @s[tag=wall_bounce] positioned ~ ~$(physics_offset) ~ run function luigis_mansion:entities/item/physics/step/wall_bounce
