data modify storage luigis_mansion:data entity merge value {boo:{namespace:"luigis_mansion",id:"null"},mansion:{namespace:"luigis_mansion",id:"empty"},name:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',say_message:0b,can_attack:0b,damage:{},health:1,loot:{},speed:0}
