...
execute at @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=!vanish,tag=!laugh,tag=!appear,scores={StunTime=0}] run function luigis_mansion:old_animations/ghost/flee
