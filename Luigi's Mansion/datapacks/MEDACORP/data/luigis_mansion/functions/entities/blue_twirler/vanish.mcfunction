...
execute if entity @s[scores={ActionTime=1},tag=visible] run playsound luigis_mansion:entity.blue_twirler.disappear hostile @a[tag=same_room] ~ ~ ~ 1
execute at @s run function luigis_mansion:old_animations/twirler/vanish
