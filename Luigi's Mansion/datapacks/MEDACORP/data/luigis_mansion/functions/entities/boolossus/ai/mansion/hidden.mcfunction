execute if entity @s[tag=mysterious_power] run function luigis_mansion:entities/boolossus/ai/mansion/hidden/mysterious_power
...
execute if entity @s[tag=!mysterious_power,scores={Room=75},tag=split] run function luigis_mansion:entities/boolossus/ai/mansion/hidden/split