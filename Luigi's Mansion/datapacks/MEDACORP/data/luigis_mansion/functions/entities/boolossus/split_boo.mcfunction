execute store result entity @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"boolossus"}}}]},tag=merged,limit=1] Rotation[0] float 1 run scoreboard players get #temp HomeRotation
