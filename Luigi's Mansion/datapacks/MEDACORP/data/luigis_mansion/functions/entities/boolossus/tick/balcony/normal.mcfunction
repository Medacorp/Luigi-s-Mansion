...
execute unless entity @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"boolossus"}}}]},tag=talk,limit=1] run tag @p[tag=!spectator,tag=player,distance=..2] add boolossus_target
