...
data modify storage luigis_mansion:data entity set value {mansion:{namespace:"luigis_mansion",id:"hidden"},affected_by:["fire","ice"]}
...
execute if score @s Health matches 1.. run function luigis_mansion:entities/boolossus/ai/mansion/hidden/split_boo