...
execute if data entity @s data.target_pos unless data entity @s data.path{force_move:1b} at @s facing entity @e[tag=target_pos,limit=1] feet run function luigis_mansion:entities/ghost/move_forward
execute if data entity @s data.target_pos if data entity @s data.path{force_move:1b} at @s facing entity @e[tag=target_pos,limit=1] feet run function luigis_mansion:entities/ghost/move_forward_force
execute if score #temp Move matches -1 run data remove entity @s data.target_pos
execute at @s at @e[tag=target_pos,distance=..0.1] run data remove entity @s data.target_pos
