...
execute unless entity @s[scores={VulnerableTime=0}] unless entity @s[tag=!burning_heart,tag=!watery_heart,tag=!frozen_heart] as @e[tag=this_heart,limit=1] run function luigis_mansion:entities/ghost/heart/update_elemental with storage luigis_mansion:data macro
execute unless entity @s[scores={VulnerableTime=0},tag=!burning_heart,tag=!watery_heart,tag=!frozen_heart] if entity @s[tag=!dying] unless entity @e[tag=this_heart,limit=1] run function luigis_mansion:entities/ghost/heart/spawn with storage luigis_mansion:data macro
execute unless entity @e[tag=this_heart,limit=1] run tag @s remove spawned_ghost_heart
