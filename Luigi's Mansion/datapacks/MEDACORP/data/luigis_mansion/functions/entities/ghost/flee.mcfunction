...
tag @s remove wall
tag @s add me
function luigis_mansion:entities/ghost/flee/pull
tag @s remove me
...
execute unless entity @a[tag=vacuuming_this_ghost,limit=1] run scoreboard players operation #temp MoveFlee = @s Move
...
execute if score #temp Move matches ..-1 at @s[tag=!ground_bound] facing entity @p[tag=!spectator,tag=vacuuming_this_ghost] feet rotated ~ 0 run function luigis_mansion:entities/ghost/flee/move_pulled
execute if score #temp Move matches ..-1 at @s[tag=ground_bound] facing entity @p[tag=!spectator,tag=vacuuming_this_ghost] feet rotated ~ 0 run function luigis_mansion:entities/ghost/flee/move_pulled_ground_bound
