...
execute if entity @s[tag=burning_heart] run data modify entity @e[tag=this_heart,limit=1] ArmorItems[3].tag.CustomModelData set value 31
execute if entity @s[tag=watery_heart] run tag @e[tag=this_heart,limit=1] add watery
execute if entity @s[tag=watery_heart] run data modify entity @e[tag=this_heart,limit=1] ArmorItems[3].tag.CustomModelData set value 32
execute if entity @s[tag=frozen_heart] run tag @e[tag=this_heart,limit=1] add frozen
execute if entity @s[tag=frozen_heart] run data modify entity @e[tag=this_heart,limit=1] ArmorItems[3].tag.CustomModelData set value 33
