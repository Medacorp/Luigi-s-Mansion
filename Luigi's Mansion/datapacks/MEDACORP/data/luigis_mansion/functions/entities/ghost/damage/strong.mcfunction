...
execute at @s[tag=portrait_ghost,tag=pearl_dropper,scores={Room=1..,Health=1..}] run function luigis_mansion:entities/ghost/damage/pearl_dropper
function luigis_mansion:entities/ghost/damage/top
