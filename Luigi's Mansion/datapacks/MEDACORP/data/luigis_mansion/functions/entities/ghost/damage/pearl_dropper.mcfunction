...
data modify storage luigis_mansion:data entity.assign_rank.namespace set from entity @s ArmorItems[3].tag.luigis_mansion.entity.namespace
data modify storage luigis_mansion:data entity.assign_rank.id set from entity @s ArmorItems[3].tag.luigis_mansion.entity.id
