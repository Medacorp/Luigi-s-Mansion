...
execute at @s[tag=!hurt,tag=!flee,tag=!freeze,scores={TargetTask=6,StunTime=0,ActionTime=0}] run function luigis_mansion:entities/ghost/target_task/circle_above_target
