...
execute if entity @s[scores={TargetTime=60}] at @e[tag=potential_target,distance=..10,sort=nearest,limit=1] run function luigis_mansion:entities/ghost/set_target
