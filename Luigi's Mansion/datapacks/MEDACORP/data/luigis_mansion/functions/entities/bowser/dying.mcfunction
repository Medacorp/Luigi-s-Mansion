...
scoreboard players set @s[scores={DeathTime=1}] AnimationProgress 0
function luigis_mansion:old_animations/bowser/dying
...
tag @s[scores={AnimationProgress=100}] add dead