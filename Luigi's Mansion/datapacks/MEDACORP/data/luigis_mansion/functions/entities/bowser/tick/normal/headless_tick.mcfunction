execute at @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"king_boo"}}}]},limit=1] run tag @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] add bowser_target
