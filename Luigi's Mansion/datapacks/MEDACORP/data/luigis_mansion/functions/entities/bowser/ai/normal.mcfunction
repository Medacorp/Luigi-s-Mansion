...
execute if entity @s[tag=intro_done,tag=!decapitate] unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] run function luigis_mansion:entities/bowser/ai/normal/choice
