...
execute if entity @s[tag=!vacuum_attack] as @a[distance=..3,tag=!spectator] run function luigis_mansion:entities/player/damage
execute if entity @s[tag=vacuum_attack] as @a[tag=!target,distance=..3,tag=!spectator] run function luigis_mansion:entities/player/damage
