...
execute if entity @s[scores={Dialog=20}] unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] run data modify storage luigis_mansion:data entity set value {mansion:{namespace:"luigis_mansion",id:"normal"}}
