...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"flying_fish"},amount:0,animation:{namespace:"luigis_mansion",id:"knockback/small"},no_delete:1b}
