tag @s[tag=east,y_rotation=-135..-45,x_rotation=-45..45] add warp_east
tag @s[tag=north,y_rotation=135..-135,x_rotation=-45..45] add warp_north
tag @s[tag=south,y_rotation=-45..45,x_rotation=-45..45] add warp_south
tag @s[tag=west,y_rotation=45..135,x_rotation=-45..45] add warp_west
