...
teleport @s[scores={Room=14}] 674 11 7
teleport @s[scores={Room=16}] 654 11 -7
teleport @s[scores={Room=17}] 704.0 11 69.0
teleport @s[scores={Room=18}] 685 11 69.0
teleport @s[scores={Room=19}] 664 11 -26
...
data modify storage luigis_mansion:data entity set value {boo:{namespace:"luigis_mansion",id:"null"},mansion:{namespace:"luigis_mansion",id:"hidden"},name:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',spawn_time:-601,tags:["caught_by_boo_radar","cannot_be_removed"]}
...
function luigis_mansion:entities/boo/warp/update_data with entity @s data.boo
