...
execute at @s run summon minecraft:marker ~ ~ ~ {Tags:["boo_marker","cannot_be_removed","new","caught_by_boo_radar"],CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}'}
