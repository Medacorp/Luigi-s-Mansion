...
data modify storage luigis_mansion:data entity set value {boo:{namespace:"luigis_mansion",id:"null"},mansion:{namespace:"luigis_mansion",id:"normal"},name:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',spawn_time:-601,tags:["caught_by_boo_radar","cannot_be_removed"]}
