...
execute if score #temp Move matches 1.. positioned as @s[tag=appear] facing entity @e[tag=target] feet run function luigis_mansion:entities/boo/force_move_forward
