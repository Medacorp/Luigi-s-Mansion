...
execute if entity @a[tag=!spectator,distance=..0.7] run scoreboard players set @s WaitTime 0
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"haunted_object"},amount:0,animation:{namespace:"luigis_mansion",id:"knockback/small"},attacker:-1,no_delete:1b}
