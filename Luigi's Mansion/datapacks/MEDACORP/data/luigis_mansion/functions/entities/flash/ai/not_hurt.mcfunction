...
execute if entity @e[tag=exact_same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,scores={AttackType=1}] run function luigis_mansion:entities/purple_puncher/collide with entity @s data.entity
execute if entity @s[tag=!collided,tag=!smug,tag=!vanish,tag=!appear] run function luigis_mansion:entities/purple_puncher/try_attack

execute if entity @s[tag=!attack,tag=!collided,tag=!vanish,tag=!laugh,tag=!complain,tag=!smug,tag=!appear] run function luigis_mansion:entities/purple_puncher/haunt
...
execute if entity @s[tag=!collided,tag=smug] run function luigis_mansion:entities/flash/smug with entity @s data.entity
execute if entity @s[tag=collided] run function luigis_mansion:entities/purple_puncher/collided
