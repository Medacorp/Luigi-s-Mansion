...
execute if score #temp ActionTime matches -1..0 run data modify entity @s ArmorItems[3].tag.CustomModelData set value 32
execute if score #temp ActionTime matches 1 run data modify entity @s ArmorItems[3].tag.CustomModelData set value 33
execute if score #temp ActionTime matches 2 run data modify entity @s ArmorItems[3].tag.CustomModelData set value 34
