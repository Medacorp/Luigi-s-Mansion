...
execute if entity @s[scores={Dialog=690}] run data modify storage luigis_mansion:data entity set value {mansion:{namespace:"luigis_mansion",id:"empty"},tags:["done_portrificationizing"]}
execute if entity @s[scores={Dialog=690}] run data modify storage luigis_mansion:data entity.mansion set from entity @s ArmorItems[3].tag.luigis_mansion.mansion
