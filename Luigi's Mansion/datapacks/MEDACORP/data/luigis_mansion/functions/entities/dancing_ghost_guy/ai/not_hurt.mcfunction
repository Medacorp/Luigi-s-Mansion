...
execute if entity @s[tag=!attack,tag=!collided,tag=!vanish,tag=!complain,tag=!dodge,tag=!appear,tag=!stop_dancing] run function luigis_mansion:entities/dancing_ghost_guy/dance
