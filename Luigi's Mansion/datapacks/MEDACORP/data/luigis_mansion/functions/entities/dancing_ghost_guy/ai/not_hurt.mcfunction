execute unless data entity @s data.path.steps[0] if entity @s[scores={TargetTask=0,ActionTime=0,WaitTime=0},tag=!stop_dancing] run function luigis_mansion:entities/ghost/set_random_path
execute if data entity @s data.path.steps[0] run scoreboard players set @s[scores={TargetTask=0,ActionTime=0,WaitTime=0},tag=!stop_dancing] TargetTask 5
...
execute if entity @e[tag=exact_same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear] run function luigis_mansion:entities/dancing_ghost_guy/collide with entity @s data.entity
...
execute if entity @s[tag=!attack,tag=!collided,tag=!vanish,tag=!complain,tag=!dodge,tag=!appear,tag=!stop_dancing] run function luigis_mansion:entities/ghost_guy/dance
