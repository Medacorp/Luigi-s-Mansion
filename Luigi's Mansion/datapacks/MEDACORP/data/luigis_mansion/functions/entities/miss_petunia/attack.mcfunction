...
summon minecraft:armor_stand ^ ^0.3 ^0.3 {CustomName:'{"translate":"luigis_mansion:entity.shot_water"}',Pose:{Head:[0.0f,0.0f,0.01f]},HasVisualFire:1b,Marker:1b,Invulnerable:1b,Tags:["shot_water","new"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:13}}],Invisible:1b,DisabledSlots:2039583,Small:1b}
...
execute as @e[tag=shot_water,tag=new,limit=1] at @s rotated as @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"miss_petunia"}}}]},limit=1] run teleport @s ~ ~ ~ ~ ~
