execute if block ^ ^ ^1 minecraft:air if predicate luigis_mansion:black_bogmire/spawn_chance run tag @s add spawn
...
execute if entity @s[tag=!spawn] positioned ~ ~-1.43 ~ run function luigis_mansion:entities/bogmire/create_shadow/new
