...
execute if entity @s[tag=dying,scores={DeathTime=1}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"black_bogmire"}}}]}] add remove_from_existence
