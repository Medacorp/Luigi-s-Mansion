execute at @s[scores={Room=29},tag=!vanish] run function luigis_mansion:entities/bogmire/tick/intro/hidden
execute at @s[scores={Room=74},tag=!vanish] run function luigis_mansion:entities/bogmire/tick/fight/hidden
