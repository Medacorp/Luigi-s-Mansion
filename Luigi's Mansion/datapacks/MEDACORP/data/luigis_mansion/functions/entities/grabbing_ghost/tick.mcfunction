...
execute if entity @s[scores={AttackType=0..1}] run function luigis_mansion:entities/grabbing_ghost/select_attack/grab
execute if entity @s[scores={AttackType=2}] run function luigis_mansion:entities/grabbing_ghost/select_attack/basher
...
execute at @s[tag=fleeing,tag=second_flee_state] run function luigis_mansion:entities/grabbing_ghost/second_flee_state
