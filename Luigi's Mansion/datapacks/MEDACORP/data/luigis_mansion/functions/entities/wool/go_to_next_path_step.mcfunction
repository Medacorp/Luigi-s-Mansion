...
execute if data entity @s ArmorItems[3].tag.luigis_mansion.path.steps[0] store result score @s TargetTime run data entity @s ArmorItems[3].tag.luigis_mansion.step.wait
