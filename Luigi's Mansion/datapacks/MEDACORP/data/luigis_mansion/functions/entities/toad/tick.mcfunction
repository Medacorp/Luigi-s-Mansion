...
execute at @s[tag=happy,tag=!explain] run function luigis_mansion:old_animations/toad/happy
execute at @s[tag=explain] run function luigis_mansion:old_animations/toad/explain
execute at @s[tag=!happy,tag=!explain] run function luigis_mansion:old_animations/toad/crying
