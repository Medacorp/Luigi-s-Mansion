...
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={Animation=27..33}] run scoreboard players set @s IdleTime -41
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={Animation=27..33}] run scoreboard players set @s Animation 31