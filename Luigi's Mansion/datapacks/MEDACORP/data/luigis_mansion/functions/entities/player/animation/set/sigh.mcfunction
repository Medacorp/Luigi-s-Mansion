...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"sigh"} run function luigis_mansion:entities/player/animation/set/none
data modify storage luigis_mansion:data my_memory.animation set value {namespace:"luigis_mansion",id:"sigh"}
