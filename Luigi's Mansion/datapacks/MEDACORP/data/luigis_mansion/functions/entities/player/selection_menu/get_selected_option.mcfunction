...
data modify storage luigis_mansion:data temp set from entity @s Inventory[8].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[7].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[6].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[5].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[4].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[3].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[2].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[1].tag.luigis_mansion.option
...
data modify storage luigis_mansion:data temp set from entity @s Inventory[0].tag.luigis_mansion.option
