...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/open/pull/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/open/pull/left"} run function luigis_mansion:entities/player/animation/set/none
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/open/pull/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/open/pull/left"} store result score @s HomeRotation run data get entity @s Rotation[0]
