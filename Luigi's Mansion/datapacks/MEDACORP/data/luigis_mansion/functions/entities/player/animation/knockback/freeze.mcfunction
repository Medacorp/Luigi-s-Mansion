...
execute at @s[scores={IdleTime=-80,Sound=0,Shrunk=0}] run playsound luigis_mansion:entity.player.hurt_freeze player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={IdleTime=-80,Sound=0,Shrunk=1..}] run playsound luigis_mansion:entity.player.hurt_freeze player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={IdleTime=..-10,Sound=0}] Sound 2
...
execute at @s[scores={IdleTime=-8,Sound=0,Health=41..,Shrunk=0}] run playsound luigis_mansion:entity.player.sigh.high_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={IdleTime=-8,Sound=0,Health=41..,Shrunk=1..}] run playsound luigis_mansion:entity.player.sigh.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute at @s[scores={IdleTime=-8,Sound=0,Health=..40,Shrunk=0}] run playsound luigis_mansion:entity.player.sigh.low_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={IdleTime=-8,Sound=0,Health=..40,Shrunk=1..}] run playsound luigis_mansion:entity.player.sigh.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={IdleTime=-8,Sound=0}] Sound 15
