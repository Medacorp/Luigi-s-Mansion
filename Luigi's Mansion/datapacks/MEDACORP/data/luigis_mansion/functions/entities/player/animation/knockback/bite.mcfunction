...
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=41..,Shrunk=0}] run playsound luigis_mansion:entity.player.hurt_bitten.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=41..,Shrunk=1..}] run playsound luigis_mansion:entity.player.hurt_bitten.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=..40,Shrunk=0}] run playsound luigis_mansion:entity.player.hurt_bitten.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=..40,Shrunk=1..}] run playsound luigis_mansion:entity.player.hurt_bitten.low_health player @a[tag=same_room] ~ ~ ~ 1 2
