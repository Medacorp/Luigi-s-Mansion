...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"leave_with_marios_painting"} run function luigis_mansion:entities/player/animation/set/none
