...
execute unless data storage luigis_mansion:data my_memory.animation run scoreboard players add @s[tag=!warp,tag=!scanning,tag=!poltergust_selected,tag=!riding_poltergust,scores={Walk=0,Run=0,Sneak=0},tag=!sneak_pos] IdleTime 1
execute unless data storage luigis_mansion:data my_memory.animation unless entity @s[tag=!warp,tag=!scanning,tag=!poltergust_selected,tag=!riding_poltergust,scores={Walk=0,Run=0,Sneak=0},tag=!sneak_pos] run scoreboard players set @s IdleTime 0
...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=20..,Health=..30}] run function luigis_mansion:entities/player/animation/set/low_health_idle
...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=20..,Health=31..},tag=cold_room] run function luigis_mansion:entities/player/animation/set/cold_room_idle
...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=200..,Health=31..},tag=!cold_room] run function luigis_mansion:entities/player/animation/set/high_health_idle
