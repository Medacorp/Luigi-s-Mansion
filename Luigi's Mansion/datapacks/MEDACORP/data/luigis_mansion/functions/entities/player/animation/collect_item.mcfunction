...
execute unless data storage luigis_mansion:data my_memory.animation.item.tag.luigis_mansion{collect_orchestra:1b} run playsound luigis_mansion:item.item.get music @a[tag=same_room] ~ ~ ~ 1
execute if data storage luigis_mansion:data my_memory.animation.item.tag.luigis_mansion{collect_orchestra:1b} run playsound luigis_mansion:item.key.get_area music @a[tag=same_room] ~ ~ ~ 1
