execute if entity @s[scores={Walk=1..},tag=!looking_at_map] run particle minecraft:dust{color:[0.5f,0.5f,0.5f],scale:1.2f} ~ ~0.2 ~ 0 0 0 0 1
execute if entity @s[scores={Run=1..},tag=!looking_at_map] run particle minecraft:dust{color:[0.5f,0.5f,0.5f],scale:2f} ~ ~0.2 ~ 0 0 0 0 1
execute if entity @s[scores={Sneak=1..},tag=!looking_at_map] run particle minecraft:dust{color:[0.5f,0.5f,0.5f],scale:0.7f} ~ ~0.2 ~ 0 0 0 0 1
