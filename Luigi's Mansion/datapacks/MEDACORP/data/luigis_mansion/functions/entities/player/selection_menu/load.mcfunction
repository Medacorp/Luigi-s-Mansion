...
execute unless data storage luigis_mansion:data menu_options.no_exit run data modify storage luigis_mansion:data inventory set value [{Slot:0b,id:"minecraft:diamond_pickaxe",Count:1b,tag:{Damage:22,Unbreakable:1b,CustomModelData:0,HideFlags:63,AttributeModifiers:[],display:{Name:'{"color":"white","italic":false,"translate":"luigis_mansion:item.menu.exit"}'},luigis_mansion:{id:"luigis_mansion:menu_option",option:{id:"exit"},kill:1b}}}]
execute unless data storage luigis_mansion:data menu_options.no_exit if data storage luigis_mansion:data menu_options.back run data modify storage luigis_mansion:data inventory append value {Slot:1b,id:"minecraft:diamond_pickaxe",Count:1b,tag:{Damage:22,Unbreakable:1b,CustomModelData:1,HideFlags:63,AttributeModifiers:[],display:{Name:'{"color":"white","italic":false,"translate":"luigis_mansion:item.menu.back"}'},luigis_mansion:{id:"luigis_mansion:menu_option",option:{id:"back"},kill:1b}}}
execute if data storage luigis_mansion:data menu_options.no_exit if data storage luigis_mansion:data menu_options.back run data modify storage luigis_mansion:data inventory append value {Slot:0b,id:"minecraft:diamond_pickaxe",Count:1b,tag:{Damage:22,Unbreakable:1b,CustomModelData:1,HideFlags:63,AttributeModifiers:[],display:{Name:'{"color":"white","italic":false,"translate":"luigis_mansion:item.menu.back"}'},luigis_mansion:{id:"luigis_mansion:menu_option",option:{id:"back"},kill:1b}}}
execute if data storage luigis_mansion:data menu_options.back.to in minecraft:overworld run setblock 1 0 1 minecraft:oak_sign{front_text:{messages:['{"color":"white","italic":false,"translate":"luigis_mansion:item.menu.back_to","with":[{"storage":"luigis_mansion:data","nbt":"menu_options.back.to","interpret":true}]}','{"text":""}','{"text":""}','{"text":""}']}}
...
data modify storage luigis_mansion:data my_memory.selection_menu.options append from entity @s Inventory[{tag:{luigis_mansion:{id:"luigis_mansion:menu_option"}}}].tag.luigis_mansion.option
