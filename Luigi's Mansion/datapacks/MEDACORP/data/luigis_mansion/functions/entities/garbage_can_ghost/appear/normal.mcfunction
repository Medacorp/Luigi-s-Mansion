...
execute unless score #mirrored Selected matches 1 at @s run teleport @s[scores={ActionTime=1}] ~ ~2 ~ ~-80 ~
execute if score #mirrored Selected matches 1 at @s run teleport @s[scores={ActionTime=1}] ~ ~2 ~ ~80 ~
execute unless score #mirrored Selected matches 1 at @s run teleport @s[scores={ActionTime=2..11}] ~ ~-0.2 ~ ~8 ~
