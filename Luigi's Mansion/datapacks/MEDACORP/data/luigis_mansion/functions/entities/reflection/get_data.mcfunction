...
execute unless score #temp Time = @s ReflectionNr if data storage luigis_mansion:data reflections[-1] run function luigis_mansion:entities/reflection/get_data 