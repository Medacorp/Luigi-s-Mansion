...
execute if entity @s[tag=!hurt,tag=!element_hurt,scores={StunTime=0}] run function luigis_mansion:entities/bowling_ghost/ai/not_hurt with entity @s data.entity
