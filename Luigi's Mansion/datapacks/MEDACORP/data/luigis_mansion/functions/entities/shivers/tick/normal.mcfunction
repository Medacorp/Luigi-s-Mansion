...
data modify entity @s[tag=burning,scores={PathStep=1..2}] ArmorItems[3].tag.luigis_mansion.scan_message set value {sender:"me",message:'{"translate":"luigis_mansion:message.shivers.scan.2"}'}
...
data modify entity @s[scores={PathStep=233}] ArmorItems[3].tag.luigis_mansion.scan_message set value {sender:"me",message:'{"translate":"luigis_mansion:message.shivers.scan.1"}'}
