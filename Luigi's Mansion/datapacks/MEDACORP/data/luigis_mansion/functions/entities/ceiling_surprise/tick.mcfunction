...
execute at @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!collided,tag=!vanish,tag=!laugh,tag=!complain,tag=!appear,tag=!attack,scores={StunTime=0}] run function luigis_mansion:old_animations/ceiling_ghost/haunt
