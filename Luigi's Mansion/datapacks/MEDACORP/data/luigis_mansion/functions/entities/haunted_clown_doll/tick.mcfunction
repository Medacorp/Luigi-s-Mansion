...
execute if entity @s[scores={WaitTime=100},tag=moving] run playsound luigis_mansion:entity.haunted_clown_doll.flying_start hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={WaitTime=100},tag=moving] Sound 14
execute if entity @s[scores={WaitTime=101..,Sound=0},tag=moving] run playsound luigis_mansion:entity.haunted_clown_doll.flying hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s[scores={WaitTime=100..},tag=moving] run function luigis_mansion:old_animations/haunted_object/move_sideways