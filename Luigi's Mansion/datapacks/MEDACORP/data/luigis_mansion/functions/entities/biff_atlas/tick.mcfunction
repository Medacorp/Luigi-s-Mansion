...
execute at @s[tag=fleeing,tag=!second_flee_state] run function luigis_mansion:old_animations/biff_atlas/flee
execute at @s[tag=fleeing,tag=second_flee_state] run function luigis_mansion:entities/biff_atlas/second_flee_state
execute at @s[tag=!fleeing,tag=hurt] run function luigis_mansion:old_animations/biff_atlas/hurt
