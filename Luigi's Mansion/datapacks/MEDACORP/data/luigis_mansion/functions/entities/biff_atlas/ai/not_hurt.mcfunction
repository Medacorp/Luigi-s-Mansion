...
execute if entity @s[tag=attack,tag=!laugh] run function luigis_mansion:entities/biff_atlas/attack/swing_arms
execute if entity @s[tag=laugh] run function luigis_mansion:entities/biff_atlas/laugh
