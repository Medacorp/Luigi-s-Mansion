...
execute if entity @s[tag=hit] run data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:fire",amount:10,knockback:"burn",attacker:-1,no_delete:1b}
