...
execute at @s[tag=!player_shot] positioned ~-0.5 ~-1 ~-0.5 if entity @e[dx=0,dy=1,dz=0,tag=player,tag=!spectator,limit=1] run function luigis_mansion:entities/shot_fire/hit_player
