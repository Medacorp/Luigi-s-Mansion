...
execute positioned as @s[x_rotation=0..90] unless entity @s[tag=!spit,tag=land] unless block ~ ~-0.1 ~ #luigis_mansion:all_ignore if block ~ ~ ~ #luigis_mansion:all_ignore run function luigis_mansion:entities/ball/bounce/ny
