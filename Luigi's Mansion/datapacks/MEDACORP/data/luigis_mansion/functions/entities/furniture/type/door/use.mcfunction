execute if entity @s[tag=burning] as @a[tag=try_opening_door,limit=1,sort=nearest] run function luigis_mansion:entities/furniture/type/door/burning
execute unless entity @s[tag=!blockade,tag=!area_blockade] if entity @s[tag=!burning] as @a[tag=try_opening_door,limit=1,sort=nearest] run function luigis_mansion:entities/furniture/type/door/blockade
