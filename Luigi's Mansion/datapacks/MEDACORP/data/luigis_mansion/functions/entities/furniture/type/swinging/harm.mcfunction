...
execute as @e[tag=same_room,tag=!furniture,tag=!model_piece,tag=!spectator,tag=!hit_by_swinging_furniture] run function luigis_mansion:entities/furniture/type/swinging/try_to_hit
...
execute as @e[tag=hit_by_swinging_furniture,type=!minecraft:player] at @s run function luigis_mansion:entities/furniture/type/swinging/hit_non_player
execute as @a[tag=hit_by_swinging_furniture] run function luigis_mansion:entities/furniture/type/swinging/hit_player
