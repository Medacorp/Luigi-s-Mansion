...
execute as @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"elemental_ghost"}}]}] if score @s ElementalNr = #temp ElementalNr run tag @s add this_elemental_ghost
