...
execute if entity @s[tag=push] run function luigis_mansion:old_animations/furniture/bash_door/push
execute if entity @s[tag=!push] run function luigis_mansion:old_animations/furniture/bash_door/pull
