...
function luigis_mansion:entities/furniture/type/tick/swinging/cosz
#amplifier
...
execute if entity @s[scores={FurnitureZProgress=0}] run function luigis_mansion:entities/furniture/type/tick/swinging/reached/z
