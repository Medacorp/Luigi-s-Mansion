...
execute if entity @s[scores={AnimationProgress=1},tag=!forced_animation] unless data entity @s ArmorItems[3].components."minecraft:custom_data".other_end.dimension run function luigis_mansion:entities/furniture/type/door/force_other_end with entity @s ArmorItems[3].components."minecraft:custom_data".other_end
execute if entity @s[scores={AnimationProgress=1},tag=!forced_animation] if data entity @s ArmorItems[3].components."minecraft:custom_data".other_end.dimension run function luigis_mansion:entities/furniture/type/door/force_other_end_dimension with entity @s ArmorItems[3].components."minecraft:custom_data".other_end
...
data remove entity @s[scores={AnimationProgress=50..}] ArmorItems[3].components."minecraft:custom_data".animation
...
execute store result entity @s[tag=forced_animation] ArmorItems[3].components."minecraft:custom_data".initial_animation_progress int 1 run scoreboard players get @s AnimationProgress