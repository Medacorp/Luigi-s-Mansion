...
execute if entity @s[scores={AnimationProgress=1},tag=!forced_animation] if data entity @s ArmorItems[3].tag.other_end.dimension run function luigis_mansion:entities/furniture/type/door/end_dimension with entity @s ArmorItems[3].tag.other_end
