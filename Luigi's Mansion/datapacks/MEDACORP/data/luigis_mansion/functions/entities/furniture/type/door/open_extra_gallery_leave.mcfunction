...
execute unless entity @a[tag=extra_gallery_door_menu,tag=!camera] positioned ^ ^ ^0.5 rotated ~-180 ~ align xz positioned ~0.5 ~ ~0.5 as @a[tag=try_opening_door,limit=1,sort=nearest] run function luigis_mansion:entities/player/set_position
