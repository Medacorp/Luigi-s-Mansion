...
execute at @e[tag=location] unless entity @e[distance=..0.1,tag=hidden_boo,tag=caught_by_boo_radar,limit=1] at @s rotated ~ 0 if entity @s[nbt={ArmorItems:[{tag:{loot:{no_roll:1b}}}]}] if entity @s[tag=!no_dust] run function luigis_mansion:entities/furniture/spawn/dust
execute at @e[tag=location] unless entity @e[distance=..0.1,tag=hidden_boo,tag=caught_by_boo_radar,limit=1] at @s rotated ~ 0 if entity @s[nbt={ArmorItems:[{tag:{loot:{}}}]}] unless entity @s[nbt={ArmorItems:[{tag:{loot:{no_roll:1b}}}]}] run function luigis_mansion:entities/furniture/spawn/contents
