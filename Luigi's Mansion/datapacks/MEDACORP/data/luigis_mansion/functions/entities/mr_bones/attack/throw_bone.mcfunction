...
execute if entity @s[scores={ActionTime=40}] run data modify storage luigis_mansion:data entity set value {owner:-1,damage:{},tags:["no_ai"]}
...
execute if entity @s[scores={ActionTime=40}] store result storage luigis_mansion:data entity.owner run scoreboard players get @s GhostNr
