...
execute unless entity @e[tag=haunted_music_sheet,scores={WaitTime=0..}] if entity @s[scores={VulnerableTime=0}] run scoreboard players set @e[tag=haunted_music_sheet,scores={WaitTime=-59..}] WaitTime -60
