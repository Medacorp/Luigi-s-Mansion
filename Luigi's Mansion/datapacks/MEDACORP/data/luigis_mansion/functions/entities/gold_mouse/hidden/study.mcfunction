...
scoreboard players set @s[x=713.5,y=20,z=-33.5,distance=..0.7,scores={PathStep=3}] PathStep 4
teleport @s[scores={PathStep=4}] ~ ~ ~ facing 712 20 -38
scoreboard players set @s[x=712.5,y=20,z=-37.5,distance=..0.7,scores={PathStep=4}] PathStep 5
teleport @s[scores={PathStep=5}] ~ ~ ~ facing 709 20 -39
scoreboard players set @s[x=709.5,y=20,z=-38.5,distance=..0.7,scores={PathStep=5}] PathStep 6
