...
data modify entity @e[tag=extra_gallery_door,limit=1] ArmorItems[3].tag.luigis_mansion.other_end set from storage luigis_mansion:data selected_option.other_end
data modify entity @e[tag=extra_gallery_door,limit=1] ArmorItems[3].tag.luigis_mansion.go_through_command set from storage luigis_mansion:data selected_option.go_through_command