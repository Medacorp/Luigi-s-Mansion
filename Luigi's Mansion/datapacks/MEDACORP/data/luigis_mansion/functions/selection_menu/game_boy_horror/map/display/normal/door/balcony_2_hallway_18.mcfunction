...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["hallway_18"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["hallway_18"]} positioned 3682 160 -14 run function luigis_mansion:selection_menu/game_boy_horror/map/spawn_key/variant_3/single
