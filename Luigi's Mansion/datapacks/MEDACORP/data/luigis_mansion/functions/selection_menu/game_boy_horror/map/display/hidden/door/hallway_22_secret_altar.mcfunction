...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["secret_altar"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["secret_altar"]} positioned 3653 10 32 run function luigis_mansion:selection_menu/game_boy_horror/map/spawn_key/variant_4/single
