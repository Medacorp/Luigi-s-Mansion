...
execute if entity @s[scores={AnimationProgress=40..}] run function luigis_mansion:old_animations/chauncey/bring_home
data modify entity @s[scores={AnimationProgress=6},tag=!big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.screaming
data modify entity @s[scores={AnimationProgress=20},tag=!big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.default
data modify entity @s[scores={AnimationProgress=26},tag=!big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.screaming
data modify entity @s[scores={AnimationProgress=40},tag=!big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.default
data modify entity @s[scores={AnimationProgress=6},tag=big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.big_screaming
data modify entity @s[scores={AnimationProgress=20},tag=big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.big
data modify entity @s[scores={AnimationProgress=26},tag=big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.big_screaming
data modify entity @s[scores={AnimationProgress=40},tag=big] ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.big
