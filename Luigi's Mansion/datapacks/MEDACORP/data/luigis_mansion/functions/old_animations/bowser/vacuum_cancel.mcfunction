...
execute if entity @s[scores={AnimationProgress=5}] run data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].tag.luigis_mansion.model_data.default
