...
execute if entity @s[scores={AnimationProgress=1..2}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 15
execute if entity @s[scores={AnimationProgress=3..6}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 15
execute if entity @s[scores={AnimationProgress=7..8}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 15
...
execute if entity @s[scores={AnimationProgress=1..2}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=left_arm,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 15
execute if entity @s[scores={AnimationProgress=3..6}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=left_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 15
execute if entity @s[scores={AnimationProgress=7..8}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=left_arm,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 15
