teleport @s ~ ~-0.55 ~ ~ ~
teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.05 ~ ~ ~
scoreboard players add @s AnimationProgress 1
data merge entity @s[scores={AnimationProgress=1}] {Pose:{RightArm:[-40.0f,0.01f,40.0f],LeftArm:[-40.0f,-0.01f,-40.0f],Head:[0.0f,0.0f,0.01f]}}
