summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.wooden_chest"}',Tags:["furniture","immobile","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:57,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic"},open_animation:{namespace:"luigis_mansion",id:"wooden_chest"},model_data:{default:{tag:{CustomModelData:57}},open:{tag:{CustomModelData:61}}}}}],Invisible:1b,DisabledSlots:2039583}
