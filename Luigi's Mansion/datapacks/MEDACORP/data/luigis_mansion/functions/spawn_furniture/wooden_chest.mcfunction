summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.wooden_chest"}',Tags:["furniture","generic","immobile","wooden_chest","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:57,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],Invisible:1b,DisabledSlots:2039583}
