execute unless data storage luigis_mansion:data furniture.pose[2] run data modify storage luigis_mansion:data furniture.pose set from entity @e[tag=this_entity,limit=1] Pose.Head
execute unless data storage luigis_mansion:data furniture.pose[2] run data modify storage luigis_mansion:data furniture.pose set value [0.0f,0.0f,0.0f]
execute if data storage luigis_mansion:data furniture.pose[3] run data modify storage luigis_mansion:data furniture.pose set from entity @e[tag=this_entity,limit=1] Pose.Head
execute if data storage luigis_mansion:data furniture.pose[3] run data modify storage luigis_mansion:data furniture.pose set value [0.0f,0.0f,0.0f]
