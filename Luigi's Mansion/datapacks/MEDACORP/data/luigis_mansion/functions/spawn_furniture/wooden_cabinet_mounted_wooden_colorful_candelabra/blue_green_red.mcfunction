summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.wooden_cabinet_mounted_wooden_colorful_candelabra"}',Tags:["furniture","standing_furniture","candelabra","immobile","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:20,CustomModelData:8,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",open_animation:{namespace:"luigis_mansion",id:"wooden_cabinet_mounted_wooden_colorful_candelabra"},model_data:{default:{tag:{CustomModelData:8}},open:{tag:{CustomModelData:20}}},mirror:{tag:{Damage:21}}}}}],Invisible:1b,DisabledSlots:2039583}
