summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.room_clear_loot_dropper"}',Tags:["furniture","no_reflection","this_entity","room_clear_loot_dropper","dark_room","was_dark_room"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{}}],NoGravity:1b,Invisible:1b,DisabledSlots:2039583}
