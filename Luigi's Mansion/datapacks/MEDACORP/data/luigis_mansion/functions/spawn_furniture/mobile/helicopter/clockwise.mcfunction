summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.helicopter_mobile"}',Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:21,CustomModelData:1,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}},luigis_mansion:{mirror:{tag:{Damage:20}}}}}],Tags:["swirling","furniture","hanging_furniture","this_entity"],DisabledSlots:2039583}
