summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.nightstand_mounted_blue_flower_pot"}',Tags:["furniture","standing_furniture","nightstand","generic","immobile","can_be_water_elemental_source","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:169}}],Invisible:1b,DisabledSlots:2039583}
