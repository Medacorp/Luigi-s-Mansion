summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.table_mounted_tea_set_and_huge_candelabra"}',Tags:["furniture","standing_furniture","generic","candelabra","immobile","this_entity"],Pose:{Head:[0.0f,0.01f,0.0f]},NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:21,CustomModelData:23,mirror:{tag:{Damage:20}}}}],Invisible:1b,DisabledSlots:2039583}
