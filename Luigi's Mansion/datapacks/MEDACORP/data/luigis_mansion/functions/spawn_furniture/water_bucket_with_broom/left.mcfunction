summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.water_bucket_with_broom"}',Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:21,CustomModelData:28,luigis_mansion:{mirror:{tag:{Damage:20}}}}}],Tags:["furniture","generic","immobile","standing_furniture","can_be_water_elemental_source","this_entity"],DisabledSlots:2039583}
