summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.torch"}',Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:20,CustomModelData:25,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}},luigis_mansion:{mirror:{tag:{Damage:21}}}}}],Tags:["furniture","generic","immobile","standing_furniture","can_be_fire_elemental_source","this_entity"],DisabledSlots:2039583}
