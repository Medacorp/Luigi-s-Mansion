summon minecraft:armor_stand ~ ~-0.94 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.cobweb"}',Pose:{Head:[0.01f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"cobweb"}}}}],Tags:["cobweb","affected_by_vacuum","immobile","this_entity"],DisabledSlots:2039583}
