summon minecraft:armor_stand ~ ~-0.94 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.cobweb"}',Pose:{Head:[0.01f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":19,"minecraft:custom_model_data":0,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"cobweb"}}}}],Tags:["cobweb","affected_by_vacuum","immobile","this_entity"],DisabledSlots:2039583}
