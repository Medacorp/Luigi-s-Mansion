summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.metal_bucket"}',Tags:["furniture","generic","immobile","standing_furniture","this_entity"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:124,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],NoGravity:1b,Marker:1b,Marker:1b,Invisible:1b,DisabledSlots:2039583}
