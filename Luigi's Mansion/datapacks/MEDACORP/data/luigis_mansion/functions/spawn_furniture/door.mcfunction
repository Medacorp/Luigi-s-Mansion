execute if data storage luigis_mansion:data furniture.door.left_hinge run summon minecraft:armor_stand ^0.125 ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,HandItems:[{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:16,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:16,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],Tags:["furniture","door","affected_by_interact","affected_by_vacuum","searchable_by_vacuum","standing_furniture","left","this_entity"],DisabledSlots:2039583}
execute unless data storage luigis_mansion:data furniture.door.left_hinge run summon minecraft:armor_stand ^-0.125 ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,HandItems:[{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:16,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:16,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"}}}}],Tags:["furniture","door","affected_by_interact","affected_by_vacuum","searchable_by_vacuum","standing_furniture","this_entity"],DisabledSlots:2039583}
