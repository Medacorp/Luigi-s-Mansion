...
execute unless data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:armor_stand ^-0.125 ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,HandItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:16,CustomModelData:0,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"door"}}}],Tags:["furniture","affected_by_interact","affected_by_vacuum","searchable_by_vacuum","standing_furniture","this_entity"],DisabledSlots:2039583}
