...
execute unless data storage luigis_mansion:data furniture.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":16,"minecraft:custom_model_data":0,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"door"}}}],Tags:["furniture","affected_by_interact","affected_by_vacuum","shaken_by_vacuum","standing_furniture","door","this_entity"],DisabledSlots:2039583}
