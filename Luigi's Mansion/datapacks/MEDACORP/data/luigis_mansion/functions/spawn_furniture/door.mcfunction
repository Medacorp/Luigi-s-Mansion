...
execute if data storage luigis_mansion:data furniture.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{Head:[0.0f,90.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b}],Tags:["model_piece","door_model","found_owner","left","this_entity"],DisabledSlots:2039583}
...
execute unless data storage luigis_mansion:data furniture.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.door"}',Pose:{Head:[0.0f,-90.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b}],Tags:["model_piece","door_model","found_owner","right","this_entity"],DisabledSlots:2039583}
