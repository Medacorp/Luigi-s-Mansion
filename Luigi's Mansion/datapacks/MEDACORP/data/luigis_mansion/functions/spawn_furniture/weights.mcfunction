summon minecraft:armor_stand ~ ~-1.16 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.weights"}',Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:197,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"null"}}}],Tags:["furniture","standing_furniture","this_entity"],Invisible:1b,DisabledSlots:2039583}
