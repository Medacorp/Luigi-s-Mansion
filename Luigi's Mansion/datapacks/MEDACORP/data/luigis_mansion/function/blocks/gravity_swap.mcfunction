...
attribute @s[tag=flipped_gravity,tag=!looking_at_map] minecraft:gravity base set -0.08
execute unless entity @s[tag=flipped_gravity,tag=!looking_at_map] run attribute @s minecraft:gravity base set 0.08