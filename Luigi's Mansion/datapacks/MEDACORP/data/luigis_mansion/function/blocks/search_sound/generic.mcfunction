...
execute if data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"search/knock"} if entity @a[tag=searcher,scores={AnimationProgress=..7},limit=1] run playsound luigis_mansion:furniture.search.generic block @a[tag=same_room] ~ ~ ~ 1 0.9
execute if data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"search/knock"} if entity @a[tag=searcher,scores={AnimationProgress=8..},limit=1] run playsound luigis_mansion:furniture.search.generic block @a[tag=same_room] ~ ~ ~ 1 1
