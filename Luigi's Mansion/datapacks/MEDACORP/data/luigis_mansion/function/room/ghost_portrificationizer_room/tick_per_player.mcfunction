...
execute if data storage luigis_mansion:data current_state.luigis_mansion.rooms.ghost_portrificationizer_room{seen:0b} if entity @s[tag=!spectator,tag=!fully_separated_camera] run function luigis_mansion:room/ghost_portrificationizer_room/set_seen
