...
execute as @a[x=782,y=73,z=-21,dx=17,dy=9,dz=25] unless entity @s[scores={Room=-2}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @a[x=782,y=73,z=-21,dx=17,dy=9,dz=25] Room -2
