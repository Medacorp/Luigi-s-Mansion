$data modify storage luigis_mansion:data current_state.luigis_mansion.current_data set from storage luigis_mansion:data current_state.luigis_mansion.mansion_data[{data_index:$(index)}]
$data remove storage luigis_mansion:data current_state.luigis_mansion.mansion_data[{data_index:$(index)}]
