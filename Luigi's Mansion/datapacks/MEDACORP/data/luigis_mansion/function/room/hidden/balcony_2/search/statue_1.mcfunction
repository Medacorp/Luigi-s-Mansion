...
execute unless score #balcony_2_statue_1 Searched matches 1 as @a if score #balcony_2_statue_1 SearcherID = @s ID run tag @s add searcher
execute unless score #balcony_2_statue_1 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_4
execute unless score #balcony_2_statue_1 Searched matches 1 run tag @a remove searcher
