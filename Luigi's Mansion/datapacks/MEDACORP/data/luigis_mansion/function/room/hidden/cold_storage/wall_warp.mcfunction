...
execute if entity @s[scores={PositionIntZ=20}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~-9 ~ ~11"}
...
execute if entity @s[scores={PositionIntY=9,PositionIntX=730..740,PositionIntZ=5..7}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~14 ~2 ~8"}
execute if entity @s[scores={PositionIntY=9,PositionIntX=730..740,PositionIntZ=8..9}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~-1 ~"}
execute if entity @s[scores={PositionIntY=9,PositionIntX=730..740,PositionIntZ=10..19}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~6 ~2 ~26"}