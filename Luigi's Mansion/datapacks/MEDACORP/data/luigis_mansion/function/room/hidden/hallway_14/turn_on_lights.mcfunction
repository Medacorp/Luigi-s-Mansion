data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.hallway_14 merge value {cleared:1b}
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} run function #luigis_mansion:room/hidden/hallway_14/turn_lights/on
