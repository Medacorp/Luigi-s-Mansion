...
execute unless score #telephone_room_closet_2 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["telephone_room_large_bookcase_2"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"telephone_room_large_bookcase_2"}
execute unless score #telephone_room_closet_2 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["telephone_room_large_bookcase_2"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.current_data.loot_collections.furniture.20_gold_coins
