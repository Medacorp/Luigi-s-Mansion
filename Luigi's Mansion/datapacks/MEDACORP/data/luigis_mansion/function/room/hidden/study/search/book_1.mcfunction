...
execute unless score #study_book_1 Searched matches 1 as @e[tag=luigi] if score #study_book_1 SearcherID = @s ID run tag @s add searcher
...
execute unless score #study_book_1 Searched matches 1 run tag @e[tag=searcher] remove searcher
