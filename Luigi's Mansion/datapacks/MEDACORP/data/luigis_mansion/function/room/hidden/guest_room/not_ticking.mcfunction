...
execute if block 741 21 68 minecraft:redstone_lamp[lit=true] run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"guest_room_flips"},progress:0}
