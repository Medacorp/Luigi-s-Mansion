...
execute unless block 741 21 68 minecraft:redstone_lamp if data storage luigis_mansion:data current_state.current_data{boos:[{}],obtained_items:{boo_radar:1b}} run function luigis_mansion:room/hidden/guest_room/load_boos
