...
teleport @s[scores={PositionIntY=28,PositionIntX=756..760}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=738..742,PositionIntZ=-18..-14}] ~-14 ~-2 ~-14
teleport @s[scores={PositionIntY=28,PositionIntX=743..744,PositionIntZ=-18..-14}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=745..755,PositionIntZ=-18..-14}] ~-7 ~-2 ~-2
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=-13..-12}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=-11..6}] ~-1 ~-2 ~9
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=7..8}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=738..742,PositionIntZ=9..13}] ~-24 ~-2 ~23
teleport @s[scores={PositionIntY=28,PositionIntX=743..744,PositionIntZ=9..13}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=745..755,PositionIntZ=9..13}] ~-9 ~-2 ~27

teleport @s[scores={PositionIntY=36,PositionIntX=739..749}] ~-38 ~95 ~10
teleport @s[scores={PositionIntY=36,PositionIntX=750..760}] ~ ~-1 ~