...
execute unless storage luigis_mansion:data dialogs[{name:{namespace:"luigis_mansion",id:"boolossus_opening"}}] run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"boolossus_opening"},progress:0,room:75}
