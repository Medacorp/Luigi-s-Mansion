...
execute as @e[tag=player,x=667,y=19,z=3,dx=11,dy=7,dz=8] unless entity @s[scores={Room=36}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=667,y=19,z=3,dx=11,dy=7,dz=8] Room 36
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/hidden/hallway_10/ghosts
