...
execute unless score #laundry_room_lamp Searched matches 1 as @a if score #laundry_room_lamp SearcherID = @s ID run tag @s add searcher
...
execute unless score #laundry_room_lamp Searched matches 1 run tag @a remove searcher
