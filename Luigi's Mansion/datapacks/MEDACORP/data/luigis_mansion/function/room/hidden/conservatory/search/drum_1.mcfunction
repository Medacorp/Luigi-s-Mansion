execute unless score #conservatory_drum_1 Searched matches 1 as @a[scores={Room=21}] if entity @s[scores={MusicType=7..9}] run function luigis_mansion:other/music/set/silence
