...
function luigis_mansion:room/hidden/sealed_room/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=66}] run function luigis_mansion:other/music/set/force/lit_room
