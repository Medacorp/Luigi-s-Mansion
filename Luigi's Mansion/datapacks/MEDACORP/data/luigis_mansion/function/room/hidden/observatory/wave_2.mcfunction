execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{observatory_destroyed:1b} run function luigis_mansion:room/hidden/observatory/destroy
