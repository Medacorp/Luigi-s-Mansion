...
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.king_boo{health:0} unless score #king_boo_battle Wave matches 1.. unless data storage luigis_mansion:data dialogs[{room:76}] run function luigis_mansion:room/hidden/king_boo_battle/clear_secret_altar
