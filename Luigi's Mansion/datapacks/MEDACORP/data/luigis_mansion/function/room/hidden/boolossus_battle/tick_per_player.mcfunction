...
execute if entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}},tag=intro_done,limit=1] unless entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"poltergust_3000"}}}},nbt=!{Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"poltergust_3000"}}}]}] run tag @s add riding_poltergust
execute if entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}},tag=split,limit=1] unless entity @s[nbt=!{SelectedItem:{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"poltergust_3000"}}}},nbt=!{Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"poltergust_3000"}}}]}] run tag @s add riding_poltergust
