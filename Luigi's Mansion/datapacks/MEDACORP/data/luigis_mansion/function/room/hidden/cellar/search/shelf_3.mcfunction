...
execute unless score #cellar_shelf_3 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cellar_shelf_trophies_plate_and_vase_1"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_shelf_trophies_plate_and_vase_1",contents:{luigis_mansion:{gold_coin:10}}}
