...
execute if data storage luigis_mansion:data current_state.current_data.rooms.storage_room{seen:0b} if entity @s[tag=!spectator,tag=!fully_separated_camera] run function luigis_mansion:room/hidden/storage_room/set_seen
