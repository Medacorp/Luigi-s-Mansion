...
execute if entity @s[x=747.0,y=22,z=44.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run scoreboard players operation #sitting_room_painting_4 SearcherID = #temp ID
