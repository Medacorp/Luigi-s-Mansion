...
execute unless score #nursery_table_2 Searched matches 1 as @e[tag=luigi] if score #nursery_table_2 SearcherID = @s ID run tag @s add searcher
execute unless score #nursery_table_2 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/m60
execute unless score #nursery_table_2 Searched matches 1 run tag @e[tag=searcher] remove searcher
