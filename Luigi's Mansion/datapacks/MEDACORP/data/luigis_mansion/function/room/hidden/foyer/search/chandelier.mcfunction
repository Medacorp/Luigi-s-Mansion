...
execute unless data storage luigis_mansion:data furniture.loot positioned 751.0 21 7.0 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 751.0 20 7.0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
