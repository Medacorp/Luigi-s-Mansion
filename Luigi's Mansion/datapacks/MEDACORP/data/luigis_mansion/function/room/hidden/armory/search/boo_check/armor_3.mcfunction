...
execute if block 759 33 -53 minecraft:andesite as @e[tag=luigi,x=760.5,y=29,z=-51.5,distance=..1] positioned 760.0 29 -52.0 run function luigis_mansion:entities/luigi/damage
