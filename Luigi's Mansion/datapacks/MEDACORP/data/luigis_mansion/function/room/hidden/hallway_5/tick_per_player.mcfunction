...
function luigis_mansion:entities/run_command_as_model {command:'execute if data storage luigis_mansion:data my_memory.animation if entity @s[nbt={data:{animation:{namespace:"luigis_mansion",id:"door/locked/pull/left"}}},x=682.5,y=11.0,z=5.5,scores={AnimationProgress=39}] run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"toad_3_locked_door"},room:13,progress:0}'}