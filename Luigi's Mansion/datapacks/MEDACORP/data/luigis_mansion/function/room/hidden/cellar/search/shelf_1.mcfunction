...
execute unless score #cellar_shelf_contents_vases_1 Searched matches 1 as @a if score #cellar_shelf_1 SearcherID = @s ID run tag @s add searcher
...
execute unless score #cellar_shelf_contents_vases_1 Searched matches 1 run tag @a remove searcher
...
execute unless score #cellar_shelf_1 Searched matches 1 as @a if score #cellar_shelf_1 SearcherID = @s ID run tag @s add searcher
...
execute unless score #cellar_shelf_1 Searched matches 1 run tag @a remove searcher
execute unless data storage luigis_mansion:data furniture.loot positioned 742 3 67 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 741 3 67 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
