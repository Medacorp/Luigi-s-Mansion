...
execute unless data storage luigis_mansion:data furniture.loot positioned 647 103 27 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 647 104 27 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
