...
function luigis_mansion:room/hidden/billiards_room/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=47}] run function luigis_mansion:other/music/set/force/light
