...
execute unless score #roof_pillar_5 Searched matches 1 as @e[tag=luigi] if score #roof_pillar_5 SearcherID = @s ID run tag @s add searcher
execute unless score #roof_pillar_5 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/m15
execute unless score #roof_pillar_5 Searched matches 1 run tag @e[tag=searcher] remove searcher
