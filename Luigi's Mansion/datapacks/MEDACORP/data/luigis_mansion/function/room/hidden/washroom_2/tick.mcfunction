...
execute as @e[tag=player,x=660,y=19,z=-33,dx=8,dy=7,dz=14] unless entity @s[scores={Room=42}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=660,y=19,z=-33,dx=8,dy=7,dz=14] Room 42
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=42},limit=1] run function luigis_mansion:room/hidden/washroom_2/ghosts