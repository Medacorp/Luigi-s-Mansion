...
execute if block 761 33 -41 minecraft:andesite as @e[tag=luigi,x=761.5,y=29,z=-42.5,distance=..1] positioned 761 29 -42.0 run function luigis_mansion:entities/luigi/damage
