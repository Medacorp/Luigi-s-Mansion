...
execute unless score #safari_room_table Searched matches 1 as @a if score #safari_room_table SearcherID = @s ID run tag @s add searcher
execute unless score #safari_room_table Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/m30
execute unless score #safari_room_table Searched matches 1 run tag @a remove searcher
