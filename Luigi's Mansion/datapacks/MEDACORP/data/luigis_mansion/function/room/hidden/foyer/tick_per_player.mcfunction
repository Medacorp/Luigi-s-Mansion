...
function luigis_mansion:entities/run_command_as_model {command:'execute if entity @s[x=745.5,y=11,z=7.0,distance=..4] if data storage luigis_mansion:data current_state.current_data{obtained_keys:["hallway_3"]} run function luigis_mansion:room/hidden/foyer/clear_blockade'}
...
function luigis_mansion:entities/run_command_as_model {command:'tag @s[x=751.0,y=11,z=7.0,distance=..3,tag=!chance_check] add chance_check'}
function luigis_mansion:entities/run_command_as_model {command:'tag @s[x=751.0,y=11,z=7.0,distance=4..5,tag=chance_check] remove chance_check'}
