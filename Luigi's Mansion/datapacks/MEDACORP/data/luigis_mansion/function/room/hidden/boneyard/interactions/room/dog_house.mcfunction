...
execute if score #boneyard_dog_house Searched matches 1 run particle minecraft:dust{color:8355839,scale:1f} 674 102 -38 0.2 0.2 0.2 0 4
execute if score #boneyard_dog_house Searched matches 1 as @e[tag=luigi,x=674.5,y=102,z=-37.5,distance=..0.7] run function luigis_mansion:room/hidden/boneyard/go_through_dog_house