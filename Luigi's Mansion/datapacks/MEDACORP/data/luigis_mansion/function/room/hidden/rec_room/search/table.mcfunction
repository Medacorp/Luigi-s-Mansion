...
execute unless score #rec_room_table Searched matches 1 as @a if score #rec_room_table SearcherID = @s ID run tag @s add searcher
...
execute unless score #rec_room_table Searched matches 1 run tag @a remove searcher
