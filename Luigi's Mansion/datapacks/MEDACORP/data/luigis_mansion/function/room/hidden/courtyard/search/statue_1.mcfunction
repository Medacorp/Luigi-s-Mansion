execute unless score #courtyard_statue_1 Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:30,tags:["drop_loot"],loot_chances:{namespace:"luigis_mansion",id:"big_heart"}}
