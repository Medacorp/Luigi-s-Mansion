...
execute if data storage luigis_mansion:data current_state.current_data.rooms.clockwork_room{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/hidden/clockwork_room/set_seen
