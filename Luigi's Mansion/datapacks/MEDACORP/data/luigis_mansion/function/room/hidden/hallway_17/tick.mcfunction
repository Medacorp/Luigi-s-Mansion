...
execute as @e[tag=player,x=724,y=28,z=24,dx=16,dy=7,dz=8] unless entity @s[scores={Room=52}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=724,y=28,z=24,dx=16,dy=7,dz=8] Room 52
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/hidden/hallway_17/ghosts
