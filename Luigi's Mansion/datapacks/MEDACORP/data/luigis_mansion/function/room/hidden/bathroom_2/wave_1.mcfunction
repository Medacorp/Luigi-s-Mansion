data modify storage luigis_mansion:data entity set value {room:43,scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.miss_petunia.scan"}'},affected_by:["ice"]}
