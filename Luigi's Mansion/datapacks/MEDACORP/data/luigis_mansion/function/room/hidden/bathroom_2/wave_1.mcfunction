...
execute positioned 652 21 -9 rotated -180 0 run function luigis_mansion:spawn_entities/portrait_ghost/miss_petunia
data modify storage luigis_mansion:data entity set value {room:43}
execute positioned 654.7 21 -9 rotated -180 0 run function luigis_mansion:spawn_entities/showering_shadow
