...
execute as @e[tag=player,x=734,y=10,z=57,dx=14,dy=7,dz=21] unless entity @s[scores={Room=21}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=734,y=10,z=57,dx=14,dy=7,dz=21] Room 21
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=21},limit=1] run function luigis_mansion:room/hidden/mirror_room/ghosts