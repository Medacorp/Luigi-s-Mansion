...
execute if entity @s[x=702.5,y=29,z=72.5,distance=..0.7,tag=!sound,tag=!check] run scoreboard players operation #the_artists_studio_chairs SearcherID = #temp ID
