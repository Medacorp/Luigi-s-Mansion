...
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.bogmire{health:0} unless score #bogmire_battle Wave matches 1.. unless data storage luigis_mansion:data dialogs[{room:74}] run function luigis_mansion:room/hidden/bogmire_battle/clear_graveyard
