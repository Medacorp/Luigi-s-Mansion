...
#todelete - old furniture
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{closed_pipe:1b} run setblock 689 4 5 minecraft:lever[face=wall,facing=east,powered=true]
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{closed_pipe:1b} if block 689 4 5 minecraft:lever[face=wall,facing=east,powered=true] unless data storage luigis_mansion:data dialogs[{room:67}] run function luigis_mansion:room/hidden/pipe_room/close_pipe
