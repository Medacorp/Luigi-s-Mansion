...
execute unless score #observatory_table Searched matches 1 as @a if score #observatory_table SearcherID = @s ID run tag @s add searcher
...
execute unless score #observatory_table Searched matches 1 run tag @a remove searcher
