...
execute unless score #observatory_table Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["observatory_cabinet_mounted_planet"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"observatory_cabinet_mounted_planet"}
