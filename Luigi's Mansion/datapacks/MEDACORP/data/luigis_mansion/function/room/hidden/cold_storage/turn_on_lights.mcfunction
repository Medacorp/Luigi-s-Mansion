data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.cold_storage merge value {cleared:1b}
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b,boos:[{}],obtained_items:{boo_radar:1b}} run function luigis_mansion:room/hidden/cold_storage/load_boos
