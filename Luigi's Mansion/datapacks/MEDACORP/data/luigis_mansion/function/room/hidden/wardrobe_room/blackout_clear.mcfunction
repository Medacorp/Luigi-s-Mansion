data modify storage luigis_mansion:data furniture set value {room:5,searchable:["interact"],shake_animation:["interact"],no_dust:1b,must_face:1b,cannot_search_when_open:1b,use_medium_shake:1b,sound:{namespace:"luigis_mansion",id:"chest"},loot:{contents:[{name:{namespace:"luigis_mansion",id:"item/key {door:'breaker_room'}"},variables:{rotation:[0.0f,0.0f]}}]}}
