...
execute if entity @s[x=663.0,y=11,z=-31.0,dx=2,dy=4,dz=1,tag=!sound,tag=!check] run scoreboard players operation #washroom_1_toilet_storage SearcherID = #temp ID
