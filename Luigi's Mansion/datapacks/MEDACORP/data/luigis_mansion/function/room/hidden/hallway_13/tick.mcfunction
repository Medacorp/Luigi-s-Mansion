...
execute as @e[tag=player,x=713,y=19,z=30,dx=7,dy=7,dz=27] unless entity @s[scores={Room=39}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=713,y=19,z=30,dx=7,dy=7,dz=27] Room 39
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/hidden/hallway_13/ghosts
