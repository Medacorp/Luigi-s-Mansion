...
execute if entity @s[x=648.0,y=104,z=-31.0,dx=1,dy=1,dz=2,tag=!sound,tag=!check] run scoreboard players operation #graveyard_gravestone_4 SearcherID = #temp ID
