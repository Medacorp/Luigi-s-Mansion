...
execute as @e[tag=player,x=637,y=10,z=44,dx=12,dy=7,dz=33] unless entity @s[scores={Room=32}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=637,y=10,z=44,dx=12,dy=7,dz=33] Room 32
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=32},limit=1] run function luigis_mansion:room/hidden/rec_room/ghosts