...
function luigis_mansion:entities/player/run_command_as_model {command:'execute if entity @s[x=726.0,y=29,z=26.0,dx=4,dy=7,dz=7] unless score #temp Boos matches 20.. unless entity @e[tag=mysterious_power,limit=1] run data modify storage luigis_mansion:data entity set value {room:52}'}
