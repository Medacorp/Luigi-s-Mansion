...
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/d50_m10_p10
...
execute positioned 743 3 76 run function luigis_mansion:blocks/dust
