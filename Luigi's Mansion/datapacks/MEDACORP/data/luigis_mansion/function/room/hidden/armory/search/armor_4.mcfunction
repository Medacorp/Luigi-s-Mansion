...
execute unless score #armory_armor_4 Searched matches 1 as @e[tag=luigi] if score #armory_armor_4 SearcherID = @s ID run tag @s add searcher
execute unless score #armory_armor_4 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/h10_p20
execute unless score #armory_armor_4 Searched matches 1 run tag @e[tag=searcher] remove searcher
