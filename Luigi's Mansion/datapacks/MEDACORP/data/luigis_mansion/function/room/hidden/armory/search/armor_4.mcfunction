...
execute unless score #armory_armor_4 Searched matches 1 as @a if score #armory_armor_4 SearcherID = @s ID run tag @s add searcher
execute unless score #armory_armor_4 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_4
execute unless score #armory_armor_4 Searched matches 1 run tag @a remove searcher
