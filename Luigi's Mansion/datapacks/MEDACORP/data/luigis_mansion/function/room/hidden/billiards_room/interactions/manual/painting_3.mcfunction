...
execute if entity @s[x=687.0,y=13,z=-67.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run scoreboard players operation #billiards_room_painting_3 SearcherID = #temp ID
