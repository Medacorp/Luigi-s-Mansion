...
data remove entity @e[x=666.5,y=20.0,z=107.0,distance=..0.7,tag=furniture,tag=door,limit=1] data.go_through_command
data modify entity @e[x=666.5,y=20.0,z=107.0,distance=..0.7,tag=furniture,tag=door,limit=1] data.other_end set value {x:645,y:20,z:88}
