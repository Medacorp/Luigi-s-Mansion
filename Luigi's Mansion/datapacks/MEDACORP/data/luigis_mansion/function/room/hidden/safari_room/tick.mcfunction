...
execute as @e[tag=player,x=732,y=28,z=49,dx=14,dy=7,dz=25] unless entity @s[scores={Room=50}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=732,y=28,z=49,dx=14,dy=7,dz=25] Room 50
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=50},limit=1] run function luigis_mansion:room/hidden/safari_room/ghosts