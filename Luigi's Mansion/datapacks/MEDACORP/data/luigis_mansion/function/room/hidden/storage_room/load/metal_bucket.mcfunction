data modify storage luigis_mansion:data furniture set value {room:18,searchable:["interact","vacuum"],shake_animation:["interact","vacuum"],sound:{namespace:"luigis_mansion",id:"metal"},scan_message:'{"type":"translatable","translate":"luigis_mansion:message.player.scan_furniture.77"}'}
...
execute positioned 681 11 70 rotated -45 0 run function luigis_mansion:spawn_furniture/metal_bucket