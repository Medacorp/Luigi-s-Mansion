...
execute if entity @s[x=681.5,y=120,z=-13.0,tag=!spectator,distance=..4] if data storage luigis_mansion:data current_state.current_data{obtained_keys:["hallway_18"]} run function luigis_mansion:room/hidden/balcony_2/clear_blockade
