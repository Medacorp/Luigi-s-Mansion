...
execute unless score #nanas_room_closet Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["nanas_room_stacked_drawer_cabinet"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"nanas_room_stacked_drawer_cabinet"}
execute unless score #nanas_room_closet Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["nanas_room_stacked_drawer_cabinet"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.20_gold_coins_and_bills
