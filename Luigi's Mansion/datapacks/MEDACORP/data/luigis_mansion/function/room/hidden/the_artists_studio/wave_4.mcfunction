...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{red_grabbing_ghost_easel:1b} run function luigis_mansion:room/hidden/the_artists_studio/wave_5