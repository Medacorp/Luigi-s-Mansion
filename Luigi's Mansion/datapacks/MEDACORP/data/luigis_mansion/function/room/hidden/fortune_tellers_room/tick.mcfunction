...
execute as @e[tag=player,x=734,y=10,z=34,dx=14,dy=7,dz=20] unless entity @s[scores={Room=20}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=734,y=10,z=34,dx=14,dy=7,dz=20] Room 20
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=20},limit=1] run function luigis_mansion:room/hidden/fortune_tellers_room/ghosts