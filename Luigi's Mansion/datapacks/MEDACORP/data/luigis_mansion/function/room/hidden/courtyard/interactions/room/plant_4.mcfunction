...
execute if score #courtyard_stone_bowl_potted_fern_4 Searching matches 20 run function luigis_mansion:room/hidden/courtyard/search/plant_4
scoreboard players operation #temp Searching = #courtyard_stone_bowl_potted_fern_4 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 650 102 8 run function luigis_mansion:blocks/search_sound/plant
