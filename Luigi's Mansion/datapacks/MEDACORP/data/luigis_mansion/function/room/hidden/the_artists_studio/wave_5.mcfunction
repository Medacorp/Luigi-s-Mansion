...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{ghost_guy_easel:1b} run function luigis_mansion:room/hidden/the_artists_studio/wave_6