...
execute unless score #roof_pillar_2 Searched matches 1 as @a if score #roof_pillar_2 SearcherID = @s ID run tag @s add searcher
execute unless score #roof_pillar_2 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_4
execute unless score #roof_pillar_2 Searched matches 1 run tag @a remove searcher
