...
execute as @e[tag=player,x=736,y=19,z=-35,dx=14,dy=7,dz=21] unless entity @s[scores={Room=49}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=736,y=19,z=-35,dx=14,dy=7,dz=21] Room 49
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=49},limit=1] run function luigis_mansion:room/hidden/the_twins_room/ghosts