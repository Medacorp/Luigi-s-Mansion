...
execute if score #temp Searched matches 0 run playsound luigis_mansion:furniture.clock.coo_coo block @a[scores={Room=62}] 684 121 22 1
execute if score #temp Searched matches 20 run playsound luigis_mansion:furniture.clock.door block @a[scores={Room=62}] 684 121 22 1
execute if score #clockwork_room_clock_3 Searched matches 1.. run scoreboard players operation #temp Searched = #clockwork_room_clock_3 Searched
execute if score #clockwork_room_clock_3 Searched matches 1.. run scoreboard players operation #temp Searched %= #200 Constants
execute if score #temp Searched matches 140 run playsound luigis_mansion:furniture.clock.music_box block @a[scores={Room=62}] 684 121 22 1
scoreboard players reset #temp Searched
execute if score #clockwork_room_clock_3 Searched matches 800 run playsound luigis_mansion:furniture.clock.winding_up block @a[scores={Room=62}] 684 121 22 1
...
execute if score #clockwork_room_clock_3 Searched matches 10 run playsound luigis_mansion:furniture.clock.winding_down block @a[scores={Room=62}] 684 121 22 1
