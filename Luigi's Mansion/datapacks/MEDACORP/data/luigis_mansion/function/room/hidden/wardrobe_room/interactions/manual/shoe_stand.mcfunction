...
execute if entity @s[x=684.0,y=20,z=-42.0,dx=2,dy=1,dz=0,tag=!sound,tag=!check] run scoreboard players operation #wardrobe_room_shoe_stand SearcherID = #temp ID
