...
execute unless score #graveyard_gravestone_6 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_4
execute unless score #graveyard_gravestone_6 Searched matches 1 run tag @a remove searcher
execute unless data storage luigis_mansion:data furniture.loot positioned 667.0 103 -28.0 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 667.0 103.5 -28.0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
