...
execute as @e[tag=player,x=740,y=28,z=-33,dx=23,dy=7,dz=8] unless entity @s[scores={Room=55}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=740,y=28,z=-33,dx=23,dy=7,dz=8] Room 55
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/hidden/hallway_19/ghosts
