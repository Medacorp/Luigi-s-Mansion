...
execute unless score #the_twins_room_table_1 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["the_twins_room_cabinet_mounted_globe"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"the_twins_room_cabinet_mounted_globe"}
