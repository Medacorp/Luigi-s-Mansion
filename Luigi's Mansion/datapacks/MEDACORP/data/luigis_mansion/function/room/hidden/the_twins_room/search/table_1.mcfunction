...
execute unless score #the_twins_room_table_1 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["the_twins_room_cabinet_mounted_globe"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"the_twins_room_cabinet_mounted_globe"}
...
execute unless score #the_twins_room_table_1 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_3
execute unless score #the_twins_room_table_1 Searched matches 1 run tag @e[tag=searcher] remove searcher
execute unless data storage luigis_mansion:data furniture.loot positioned 738 20 -32.0 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 738 21 -32.0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
