...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id{namespace:"luigis_mansion",id:"hidden"} run scoreboard players set #temp Time 1
execute unless data storage luigis_mansion:data current_state.luigis_mansion.mansion_data[{data_index:0}] run scoreboard players set #temp Time 0
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{data_index:0} if data storage luigis_mansion:data current_state.luigis_mansion.current_data.data_index run function luigis_mansion:room/save_mansion_data with storage luigis_mansion:data current_state.luigis_mansion.current_data
