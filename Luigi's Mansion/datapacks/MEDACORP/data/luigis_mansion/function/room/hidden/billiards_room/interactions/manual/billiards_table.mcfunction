...
execute if entity @s[x=679.0,y=11,z=-65.0,dx=4,dy=0,dz=5,tag=!sound,tag=!check] run scoreboard players operation #billiards_room_billiards_table SearcherID = #temp ID
