...
execute if data storage luigis_mansion:data current_state.current_data.rooms.roof{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/hidden/roof/set_seen
