...
execute if predicate luigis_mansion:gold_mouse/appear_chance unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["kitchen_gold_mouse"]} run data modify storage luigis_mansion:data entity set value {room:27,spawn:1b,loot:{capture:{name:"kitchen_gold_mouse"}},paths:[{force_move:1b,steps:[{wait:20,position:[702.5d,11.0d,-74.5d]},{position:[702.5d,11.0d,-70.5d]},{position:[708.5d,11.0d,-65.5d]},{position:[702.5d,11.0d,-60.5d]},{position:[708.5d,11.0d,-55.5d]},{position:[702.5d,11.0d,-51.5d]},{position:[699.5d,11.0d,-51.5d]}]}]}
execute if data storage luigis_mansion:data entity.loot run data modify storage luigis_mansion:data entity.loot.capture.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.gold_mouse.silver_diamond
