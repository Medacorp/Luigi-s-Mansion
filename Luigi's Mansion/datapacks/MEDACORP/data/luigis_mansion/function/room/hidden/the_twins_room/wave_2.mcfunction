data modify storage luigis_mansion:data entity set value {room:49,tags:["initial_dialog"],scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.orville.scan"}'}}
execute positioned 741 20 -25 run function luigis_mansion:spawn_entities/portrait_ghost/henry_and_orville/orville
data modify storage luigis_mansion:data entity set value {room:49,tags:["initial_dialog"],scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.henry.scan"}'}}
