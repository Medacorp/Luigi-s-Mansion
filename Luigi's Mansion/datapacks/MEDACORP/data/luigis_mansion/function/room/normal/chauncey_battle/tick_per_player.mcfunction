execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.chauncey{health:0} unless data storage luigis_mansion:data dialogs[{name:{namespace:"luigis_mansion",id:"normal/chauncey_opening"}}] run function luigis_mansion:other/music/set/chauncey_battle_skip_intro
