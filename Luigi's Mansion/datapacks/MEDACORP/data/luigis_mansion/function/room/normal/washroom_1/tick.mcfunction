...
execute as @e[tag=player,x=660,y=10,z=34,dx=8,dy=7,dz=14] unless entity @s[scores={Room=19}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=660,y=10,z=34,dx=8,dy=7,dz=14] Room 19
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=19},limit=1] run function luigis_mansion:room/normal/washroom_1/ghosts