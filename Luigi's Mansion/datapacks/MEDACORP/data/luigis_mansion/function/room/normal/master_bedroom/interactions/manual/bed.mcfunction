...
execute if entity @s[x=689.0,y=111,z=51.0,dx=3,dy=1,dz=4,tag=!sound,tag=!check] run function luigis_mansion:room/normal/master_bedroom/search/boo_check/bed