...
execute unless score #parlor_lamp Searched matches 1 as @a if score #parlor_lamp SearcherID = @s ID run tag @s add searcher
...
execute unless score #parlor_lamp Searched matches 1 run tag @a remove searcher
