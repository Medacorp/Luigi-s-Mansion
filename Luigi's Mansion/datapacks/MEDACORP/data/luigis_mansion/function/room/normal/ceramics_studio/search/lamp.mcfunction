...
execute unless score #ceramics_studio_lamp Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["ceramics_studio_long_hook_suspended_encased_lamp"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"ceramics_studio_long_hook_suspended_encased_lamp"}
...
execute unless score #ceramics_studio_lamp Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
