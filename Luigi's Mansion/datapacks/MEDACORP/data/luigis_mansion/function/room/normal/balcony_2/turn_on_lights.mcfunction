...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} run function #luigis_mansion:room/normal/balcony_2/turn_lights/on
