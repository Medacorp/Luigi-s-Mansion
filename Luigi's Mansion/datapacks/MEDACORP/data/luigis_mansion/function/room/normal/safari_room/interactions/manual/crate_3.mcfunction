...
execute if entity @s[x=736.0,y=29,z=-54.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/safari_room/search/boo_check/crate_3