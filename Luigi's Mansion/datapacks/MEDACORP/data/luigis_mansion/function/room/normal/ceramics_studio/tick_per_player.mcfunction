...
execute if data storage luigis_mansion:data current_state.current_data.rooms.ceramics_studio{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/normal/ceramics_studio/set_seen
