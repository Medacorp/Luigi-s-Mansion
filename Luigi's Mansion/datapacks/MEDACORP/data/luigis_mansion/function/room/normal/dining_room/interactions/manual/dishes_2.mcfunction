...
execute if entity @s[x=706.0,y=11,z=48.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/dining_room/search/boo_check/dishes_2