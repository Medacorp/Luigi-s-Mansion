...
teleport @s[scores={PositionIntY=28,PositionIntX=738..742,PositionIntZ=29..33}] ~-14 ~-2 ~14
teleport @s[scores={PositionIntY=28,PositionIntX=743..744,PositionIntZ=29..33}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=745..755,PositionIntZ=29..33}] ~-7 ~-2 ~2
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=27..28}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=9..26}] ~-1 ~-2 ~-9
teleport @s[scores={PositionIntY=28,PositionIntX=738..755,PositionIntZ=7..8}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=738..742,PositionIntZ=2..6}] ~-24 ~-2 ~-23
teleport @s[scores={PositionIntY=28,PositionIntX=743..744,PositionIntZ=2..6}] ~ ~1 ~
teleport @s[scores={PositionIntY=28,PositionIntX=745..755,PositionIntZ=2..6}] ~-9 ~-2 ~-27
