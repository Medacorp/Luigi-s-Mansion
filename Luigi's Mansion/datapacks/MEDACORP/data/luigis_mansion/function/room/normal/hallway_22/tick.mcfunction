...
execute as @e[tag=player,x=653,y=1,z=-24,dx=33,dy=7,dz=12] unless entity @s[scores={Room=61}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=653,y=1,z=-24,dx=33,dy=7,dz=12] Room 61
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/normal/hallway_22/ghosts
