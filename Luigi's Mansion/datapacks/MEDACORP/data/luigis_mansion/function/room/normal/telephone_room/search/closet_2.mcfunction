...
execute unless score #telephone_room_closet_2 Searched matches 1 as @a if score #telephone_room_closet_2 SearcherID = @s ID run tag @s add searcher
execute unless score #telephone_room_closet_2 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
execute unless score #telephone_room_closet_2 Searched matches 1 run tag @a remove searcher
