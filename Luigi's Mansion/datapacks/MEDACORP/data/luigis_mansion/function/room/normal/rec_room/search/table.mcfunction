...
execute unless score #rec_room_table Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["rec_room_workout_cabinet"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"rec_room_workout_cabinet"}
execute unless score #rec_room_table Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["rec_room_workout_cabinet"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.10_gold_coins_and_bills
...
execute unless score #rec_room_table Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
