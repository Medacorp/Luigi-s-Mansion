...
execute unless score #anteroom_lamp_2 Searched matches 1 as @a if score #anteroom_lamp_2 SearcherID = @s ID run tag @s add searcher
...
execute unless score #anteroom_lamp_2 Searched matches 1 run tag @a remove searcher
