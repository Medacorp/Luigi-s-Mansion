...
execute if entity @s[x=734.0,y=30,z=-46.0,dx=0,dy=0,dz=4,tag=!sound,tag=!check] run function luigis_mansion:room/normal/safari_room/search/boo_check/shelf_2