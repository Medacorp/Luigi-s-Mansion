...
function luigis_mansion:room/normal/graveyard/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=29}] run function luigis_mansion:other/music/set/force/exterior
