...
execute as @e[tag=player,x=679,y=19,z=-30,dx=6,dy=7,dz=42] unless entity @s[scores={Room=35}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=679,y=19,z=-30,dx=6,dy=7,dz=42] Room 35
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/normal/hallway_9/ghosts
