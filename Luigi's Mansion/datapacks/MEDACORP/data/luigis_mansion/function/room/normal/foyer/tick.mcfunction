...
scoreboard players set @a[x=743,y=10,z=-2,dx=15,dy=16,dz=21] Room 1
...
execute if entity @a[tag=!pause_dialog,scores={Room=1},tag=!spectator,limit=1] run function luigis_mansion:room/normal/foyer/ghosts