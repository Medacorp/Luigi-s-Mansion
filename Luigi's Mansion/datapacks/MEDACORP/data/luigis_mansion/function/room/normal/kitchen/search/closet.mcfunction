...
execute unless score #kitchen_closet Searched matches 1 as @a if score #kitchen_closet SearcherID = @s ID run tag @s add searcher
...
execute unless score #kitchen_closet Searched matches 1 run tag @a remove searcher
