...
execute if entity @s[x=657.0,y=11,z=-15.0,dx=0,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/normal/conservatory/search/boo_check/drum_2