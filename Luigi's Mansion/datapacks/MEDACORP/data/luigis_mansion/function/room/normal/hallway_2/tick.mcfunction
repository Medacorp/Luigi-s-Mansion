...
execute as @e[tag=player,x=722,y=19,z=42,dx=8,dy=7,dz=38] unless entity @s[scores={Room=7}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=722,y=19,z=42,dx=8,dy=7,dz=38] Room 7
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/normal/hallway_2/ghosts
