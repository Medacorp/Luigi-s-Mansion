...
execute unless score #the_artists_studio_painting_9 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #the_artists_studio_painting_9 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #the_artists_studio_painting_9 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","small_heart"],Duration:1}
execute unless score #the_artists_studio_painting_9 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] run data modify storage luigis_mansion:data entity set value {room:71}
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 699.0 30 -75.0 run function luigis_mansion:spawn_entities/item/room_search/small_heart
