...
execute if block 759 33 68 minecraft:andesite as @e[tag=luigi,x=760.5,y=29,z=67.5,distance=..1] positioned 760.0 29 68.0 run function luigis_mansion:entities/luigi/damage
