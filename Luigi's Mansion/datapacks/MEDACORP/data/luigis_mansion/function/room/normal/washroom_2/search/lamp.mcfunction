execute unless score #washroom_2_lamp Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:19,tags:["drop_loot"]}
...
execute unless score #washroom_2_lamp Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
