...
execute unless score #cellar_shelf_6 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_trophies_plate_and_vase_2"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_trophies_plate_and_vase_2"}
execute unless score #cellar_shelf_6 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_trophies_plate_and_vase_2"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.5_bills
...
execute unless score #cellar_shelf_6 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
