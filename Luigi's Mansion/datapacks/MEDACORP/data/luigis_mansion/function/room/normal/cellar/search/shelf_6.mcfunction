...
execute unless score #cellar_shelf_6 Searched matches 1 as @a if score #cellar_shelf_6 SearcherID = @s ID run tag @s add searcher
...
execute unless score #cellar_shelf_6 Searched matches 1 run tag @a remove searcher
