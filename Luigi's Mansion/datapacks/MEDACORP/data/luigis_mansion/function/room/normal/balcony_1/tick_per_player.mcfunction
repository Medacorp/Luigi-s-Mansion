...
execute if data storage luigis_mansion:data current_state.current_data.rooms.balcony_1{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/normal/balcony_1/set_seen
