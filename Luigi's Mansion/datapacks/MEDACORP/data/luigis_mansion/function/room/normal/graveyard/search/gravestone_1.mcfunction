execute unless score #graveyard_gravestone_1 Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:29,tags:["drop_loot"],loot_chances:{namespace:"luigis_mansion",id:"big_heart"}}
