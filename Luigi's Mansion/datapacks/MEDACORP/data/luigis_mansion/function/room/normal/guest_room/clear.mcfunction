...
function luigis_mansion:room/normal/guest_room/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=70}] run function luigis_mansion:other/music/set/force/light
