data modify storage luigis_mansion:data entity set value {room:7,paths:"luigis_mansion:room/normal/hallway_2/blue_mouse_path"}
...
data modify storage luigis_mansion:data entity set value {room:7,paths:"luigis_mansion:room/normal/hallway_2/purple_mouse_path"}
