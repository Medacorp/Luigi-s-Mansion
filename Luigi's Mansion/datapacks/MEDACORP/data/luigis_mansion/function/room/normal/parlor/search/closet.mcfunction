...
execute unless score #parlor_closet Searched matches 1 as @a if score #parlor_closet SearcherID = @s ID run tag @s add searcher
...
execute unless score #parlor_closet Searched matches 1 run tag @a remove searcher
