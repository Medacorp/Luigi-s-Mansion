...
execute unless score #tea_room_drawer_1 Searched matches 1 as @e[tag=luigi] if score #tea_room_drawer_1 SearcherID = @s ID run tag @s add searcher
execute unless score #tea_room_drawer_1 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/m50
execute unless score #tea_room_drawer_1 Searched matches 1 run tag @e[tag=searcher] remove searcher
