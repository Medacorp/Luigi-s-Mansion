...
execute if data storage luigis_mansion:data current_state.current_data.rooms.cold_storage{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/normal/cold_storage/set_seen
