...
execute if block 761 33 56 minecraft:andesite as @a[x=761.5,y=29,z=58.5,distance=..1,tag=!spectator] positioned 761 29 58.0 run function luigis_mansion:entities/player/damage
