...
execute unless score #foyer_lamp Searched matches 1 as @a if score #foyer_lamp SearcherID = @s ID run tag @s add searcher
execute unless score #foyer_lamp Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
execute unless score #foyer_lamp Searched matches 1 run tag @a remove searcher
