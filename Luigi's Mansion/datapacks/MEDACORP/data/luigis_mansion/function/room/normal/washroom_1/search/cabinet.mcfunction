...
execute unless score #washroom_1_cabinet Searched matches 1 as @a if score #washroom_1_cabinet SearcherID = @s ID run tag @s add searcher
...
execute unless score #washroom_1_cabinet Searched matches 1 run tag @a remove searcher
