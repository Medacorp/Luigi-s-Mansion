...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["conservatory_speedy_spirit"]} positioned 660 11 -24 run function luigis_mansion:spawn_entities/ghost/speedy_spirit
