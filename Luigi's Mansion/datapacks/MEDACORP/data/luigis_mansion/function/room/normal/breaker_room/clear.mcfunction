...
function luigis_mansion:room/normal/breaker_room/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=57}] run function luigis_mansion:other/music/set/force/light
