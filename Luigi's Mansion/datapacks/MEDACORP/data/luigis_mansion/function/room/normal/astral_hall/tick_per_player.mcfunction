...
execute if data storage luigis_mansion:data current_state.current_data.rooms.astral_hall{seen:0b} unless entity @s[tag=spectator] run function luigis_mansion:room/normal/astral_hall/set_seen
