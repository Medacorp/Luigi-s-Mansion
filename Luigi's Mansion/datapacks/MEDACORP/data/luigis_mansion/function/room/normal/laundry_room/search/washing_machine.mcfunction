...
execute unless data storage luigis_mansion:data furniture.loot positioned 715 11 73 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 715 13 73 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
