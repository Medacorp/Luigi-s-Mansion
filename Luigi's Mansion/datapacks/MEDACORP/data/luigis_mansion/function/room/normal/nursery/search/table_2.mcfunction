execute unless score #nursery_table_2 Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:10,tags:["drop_loot"],loot_chances:{namespace:"luigis_mansion",id:"big_heart"}}
