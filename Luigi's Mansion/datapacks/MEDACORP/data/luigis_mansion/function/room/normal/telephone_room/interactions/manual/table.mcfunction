...
execute if entity @s[x=744.0,y=29,z=29.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/telephone_room/search/boo_check/table