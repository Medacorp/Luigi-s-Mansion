...
execute if data storage luigis_mansion:data current_state.current_data{mansion_id:{namespace:"luigis_mansion",id:"normal"},area:-1} run data remove storage luigis_mansion:data current_state.current_data
