...
execute if block 757 33 73 minecraft:andesite as @e[tag=luigi,x=758.5,y=29,z=72.5,distance=..1] positioned 758.0 29 73.0 run function luigis_mansion:entities/player/damage
