...
execute as @e[tag=player,x=686,y=10,z=-23,dx=26,dy=7,dz=8] unless entity @s[scores={Room=12}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=686,y=10,z=-23,dx=26,dy=7,dz=8] Room 12
...
execute if entity @e[tag=luigi,tag=same_room,limit=1] run function luigis_mansion:room/normal/hallway_4/ghosts
