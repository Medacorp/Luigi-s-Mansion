...
execute if entity @s[x=690.5,y=111,z=41.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion:room/normal/master_bedroom/search/boo_check/chair