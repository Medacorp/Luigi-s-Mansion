execute unless score #cellar_shelf_contents_vases_1 Searched matches 1 run data modify storage luigis_mansion:data furniture.loot set value {room:58,tags:["drop_loot"],loot_chances:{namespace:"luigis_mansion",id:"big_heart"}}
...
execute unless score #cellar_shelf_1 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_three_boxes_1"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_three_boxes_1"}
execute unless score #cellar_shelf_1 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_three_boxes_1"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.5_bills
...
execute unless score #cellar_shelf_1 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/health_dependent_1
