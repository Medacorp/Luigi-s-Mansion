...
execute unless score #cellar_shelf_1 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cellar_three_boxes_1"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_three_boxes_1",contents:{luigis_mansion:{bill:5}}}
