...
execute as @e[tag=player,x=648,y=10,z=15,dx=12,dy=7,dz=14] unless entity @s[scores={Room=16}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=648,y=10,z=15,dx=12,dy=7,dz=14] Room 16
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=16},limit=1] run function luigis_mansion:room/normal/bathroom_1/ghosts