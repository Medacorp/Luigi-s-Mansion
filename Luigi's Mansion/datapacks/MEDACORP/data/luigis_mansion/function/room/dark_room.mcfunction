...
execute if entity @s[scores={Room=1..}] run function luigis_mansion:room/dark_room_mansion with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
