...
execute if entity @s[scores={PositionIntY=84,PositionIntX=788..789,PositionIntZ=21..22}] run function luigis_mansion:room/default_position_in_mansion with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id if entity @s[scores={PositionIntY=84,PositionIntX=788..789,PositionIntZ=21..22}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~-1 ~"}
