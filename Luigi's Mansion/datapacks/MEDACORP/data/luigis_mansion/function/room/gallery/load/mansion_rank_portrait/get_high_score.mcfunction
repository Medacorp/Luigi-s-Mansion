...
execute if score #temp Time matches 1.. run data modify block 17 3 25 front_text.messages[0] set value {type:"translatable",translate:"luigis_mansion:sign.gallery.record",with:[{type:"score",score:{objective:"Time",name:"#temp"}}]}
execute if score #temp Time matches 0 run data modify block 17 3 25 front_text.messages[0] set value {type:"translatable",translate:"luigis_mansion:sign.gallery.record.no_money"}
