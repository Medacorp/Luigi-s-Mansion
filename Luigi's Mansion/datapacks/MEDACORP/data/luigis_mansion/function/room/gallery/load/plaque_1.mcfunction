...
execute if data storage luigis_mansion:data current_state.luigis_mansion.high_scores[-1] run function luigis_mansion:room/gallery/load/mansion_rank_portrait/get_high_score
