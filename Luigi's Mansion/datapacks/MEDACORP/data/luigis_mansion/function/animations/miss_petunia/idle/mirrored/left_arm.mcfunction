...
scoreboard players remove @s[scores={AnimationProgress=1..5}] AnimationRotationY 100
scoreboard players add @s[scores={AnimationProgress=6..15}] AnimationRotationY 100
scoreboard players remove @s[scores={AnimationProgress=16..20}] AnimationRotationY 100
