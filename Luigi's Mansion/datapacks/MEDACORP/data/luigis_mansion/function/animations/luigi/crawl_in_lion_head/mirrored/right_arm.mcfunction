...
scoreboard players remove @s[scores={AnimationProgress=21..30}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=31..40}] AnimationRotationY 30
scoreboard players remove @s[scores={AnimationProgress=61..70}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=71..80}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=71..80}] AnimationRotationZ 10
