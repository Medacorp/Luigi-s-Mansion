...
execute if entity @s[scores={AnimationProgress=1..}] run execute if entity @s[scores={AnimationProgress=16..20}] run scoreboard players add @s AnimationRotationY 20
