data modify entity @s ArmorItems[3] set value {id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/luigi","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;0b,0b],floats:[0f],strings:["hat"]},"minecraft:dyed_color":{rgb:37129}}}
data modify entity @s ArmorItems[3].components."minecraft:dyed_color".rgb set from storage luigis_mansion:data luigi.animation.hat_model.color
execute if data storage luigis_mansion:data luigi.animation.hat_model{variant:1b} run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".flags[1] set value 1b
data modify entity @s[scores={AnimationProgress=20..}] ArmorItems[3] set value {}
