...
execute if entity @s[scores={AnimationProgress=1..6}] positioned ^ ^0.67 ^ rotated ~-180 ~ positioned ^ ^ ^0.67 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[scores={AnimationProgress=7}] positioned ^ ^0.67 ^ rotated ~-135 ~45 positioned ^ ^ ^0.67 run teleport @s ~ ~ ~ ~ ~-45
