...
execute if score #mirrored Selected matches 1 positioned ^0.6 ^0.56 ^0.3 run teleport @s[tag=held_item,tag=!shrunk,tag=flipped_gravity] ~ ~ ~ ~-90 ~
execute if score #mirrored Selected matches 1 positioned ^0.4 ^0.28 ^0.15 run teleport @s[tag=held_item,tag=shrunk,tag=flipped_gravity] ~ ~ ~ ~-90 ~
execute if entity @s[scores={AnimationProgress=1}] unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationX 200
...
execute if entity @s[scores={AnimationProgress=1}] unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationZ 40
