...
scoreboard players remove @s[scores={AnimationProgress=6..7}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=8..9}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=10}] AnimationRotationY 20
