...
scoreboard players add @s[scores={AnimationProgress=31..32}] AnimationRotationY 100
scoreboard players remove @s[scores={AnimationProgress=34..37}] AnimationRotationY 100
scoreboard players add @s[scores={AnimationProgress=39..40}] AnimationRotationY 100
