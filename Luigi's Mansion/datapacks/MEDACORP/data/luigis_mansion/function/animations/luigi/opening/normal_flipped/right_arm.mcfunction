...
scoreboard players remove @s[scores={AnimationProgress=261..265}] AnimationRotationY 60
scoreboard players add @s[scores={AnimationProgress=326..335}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=859..878}] AnimationRotationY 40