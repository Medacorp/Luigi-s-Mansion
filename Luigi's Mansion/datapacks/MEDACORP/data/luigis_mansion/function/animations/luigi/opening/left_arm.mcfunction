...
data modify entity @s[tag=held_item,scores={AnimationProgress=230..354}] ArmorItems[3] set value {id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:attribute_modifiers":{modifiers:[]},"minecraft:item_model":"luigis_mansion:contest_reward_map","minecraft:item_name":'{"type":"translatable","translate":"luigis_mansion:item.contest_reward_map"}',"minecraft:custom_data":{namespace:"luigis_mansion",id:"contest_reward_map"}}}
data modify entity @s[tag=held_item,scores={AnimationProgress=858..}] ArmorItems[3] set from storage luigis_mansion:data luigi.flashlight
data modify entity @s[tag=held_item,scores={AnimationProgress=858..926}] ArmorItems[3] merge from storage luigis_mansion:data luigi.flashlight.components."minecraft:custom_data".model_data.off
data modify entity @s[tag=held_item,scores={AnimationProgress=927..}] ArmorItems[3] merge from storage luigis_mansion:data luigi.flashlight.components."minecraft:custom_data".model_data.on
