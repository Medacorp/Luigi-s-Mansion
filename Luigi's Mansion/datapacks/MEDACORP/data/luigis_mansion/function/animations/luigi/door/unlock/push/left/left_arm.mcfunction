...
scoreboard players add @s[scores={AnimationProgress=141}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=142}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=143}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=144}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=145}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=146}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=147}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=148}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=149}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=150}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=151}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=152}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=153}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=154}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=155}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=156}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=157}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=158}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=159}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=160}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=161}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=162}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=163}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=164}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=165}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=166}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=167}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=168}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=169}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=170}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=171}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=172}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=173}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=174}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=175}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=176}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=177}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=178}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=179}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=180}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=201..220}] AnimationRotationY 6
scoreboard players remove @s[scores={AnimationProgress=80..84}] AnimationRotationZ 40
scoreboard players add @s[scores={AnimationProgress=88..92}] AnimationRotationZ 40
scoreboard players remove @s[scores={AnimationProgress=201..220}] AnimationRotationZ 10
