...
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 1 run teleport @s[tag=flipped_gravity] ^-0.018 ^-0.007 ^
execute unless score #mirrored Selected matches 1 run scoreboard players remove @s[scores={DeathTime=11..50}] AnimationRotationZ 20
execute if score #mirrored Selected matches 1 run scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationZ 12
execute unless score #mirrored Selected matches 1 run scoreboard players remove @s[scores={DeathTime=11..50}] AnimationRotationX 5
execute if score #mirrored Selected matches 1 run scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationX 10
