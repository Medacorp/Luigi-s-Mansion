...
data merge entity @s[scores={AnimationProgress=21}] {Pose:{Head:[-150.0f,-10.0f,0.01f]}}
data merge entity @s[scores={AnimationProgress=21},tag=flipped_gravity] {Pose:{Head:[-150.0f,-10.0f,-180.0f]}}
...
execute if entity @s[scores={AnimationProgress=6..10}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 14
execute if entity @s[scores={AnimationProgress=15..19}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 16
