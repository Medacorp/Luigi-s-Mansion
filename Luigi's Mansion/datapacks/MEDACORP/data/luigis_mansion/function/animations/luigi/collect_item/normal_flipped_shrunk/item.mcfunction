...
execute at @s[scores={AnimationProgress=..47}] positioned ^ ^-0.37 ^ run teleport @s ~ ~0.25 ~ ~ ~
execute at @s[scores={AnimationProgress=48..}] positioned ^ ^-0.2 ^ run teleport @s ~ ~0.25 ~ ~ ~
