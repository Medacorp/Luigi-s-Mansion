...
execute unless data storage luigis_mansion:data luigi{tags:["moved"]} run data merge entity @s[scores={AnimationProgress=30..}] {Pose:{Head:[0.0f,0.0f,0.01f]}}
execute unless data storage luigis_mansion:data luigi{tags:["moved"]} run data merge entity @s[scores={AnimationProgress=30..},tag=flipped_gravity] {Pose:{Head:[0.0f,0.0f,-180.0f]}}
...
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=1..2}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=3..6}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=7..8}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=1..2}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=3..6}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=7..8}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
