...
scoreboard players add @s[scores={AnimationProgress=18..19}] AnimationRotationZ 2
scoreboard players remove @s[scores={AnimationProgress=20}] AnimationRotationZ 2
