...
execute if entity @s[scores={AnimationProgress=18..19}] run scoreboard players add @s AnimationRotationZ 2
execute if entity @s[scores={AnimationProgress=20}] run scoreboard players remove @s AnimationRotationZ 2
