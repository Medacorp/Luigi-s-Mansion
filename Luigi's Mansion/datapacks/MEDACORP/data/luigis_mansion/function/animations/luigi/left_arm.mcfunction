# Move with
teleport @s[tag=!low_health,tag=!shrunk,tag=!flipped_gravity] ^0.375 ^-1.7 ^ ~ ~
teleport @s[tag=low_health,tag=!shrunk,tag=!flipped_gravity] ^0.375 ^-1.76 ^ ~ ~
teleport @s[tag=!low_health,tag=shrunk,tag=!flipped_gravity] ^0.1825 ^-0.9 ^ ~ ~
teleport @s[tag=low_health,tag=shrunk,tag=!flipped_gravity] ^0.1825 ^-0.96 ^ ~ ~
teleport @s[tag=!low_health,tag=!shrunk,tag=flipped_gravity] ^-0.375 ^-0.4 ^ ~ ~
teleport @s[tag=low_health,tag=!shrunk,tag=flipped_gravity] ^-0.375 ^-0.34 ^ ~ ~
...
execute if entity @s[tag=poltergust_grabbed] if score #mirrored Selected matches 1 if data storage luigis_mansion:data luigi.selected_item.components."minecraft:custom_data".is_nozzle run data modify entity @s[tag=held_item] equipment.head set from storage luigis_mansion:data luigi.selected_item
