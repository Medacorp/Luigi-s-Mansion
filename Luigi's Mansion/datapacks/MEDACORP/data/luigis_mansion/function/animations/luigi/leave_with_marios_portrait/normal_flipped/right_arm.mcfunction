...
scoreboard players set @s[scores={AnimationProgress=1},tag=held_item] AnimationRotationZ -800
...
teleport @s[tag=held_item,tag=shrunk] ^-0.3 ^0.28 ^0.15 ~-90 ~
scoreboard players add @s[scores={AnimationProgress=1..4},tag=!held_item] AnimationRotationX 20
scoreboard players remove @s[scores={AnimationProgress=5..12},tag=!held_item] AnimationRotationX 20
scoreboard players add @s[scores={AnimationProgress=13..16},tag=!held_item] AnimationRotationX 20
