...
execute if entity @s[scores={AnimationProgress=21..30}] run scoreboard players add @s AnimationRotationX 180
...
execute if entity @s[scores={AnimationProgress=31..32}] unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=33..36}] unless score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=37..38}] unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=31..32}] if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=33..36}] if score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=37..38}] if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationX 40
execute unless score #mirrored Selected matches 1 if entity @s[tag=held_item,tag=!shrunk,tag=!flipped_gravity] positioned ^0.375 ^0.03 ^ run function luigis_mansion:animations/luigi/scare/bash/item
execute unless score #mirrored Selected matches 1 if entity @s[tag=held_item,tag=shrunk,tag=!flipped_gravity] positioned ^0.1825 ^0.02 ^ run function luigis_mansion:animations/luigi/scare/bash/item
execute unless score #mirrored Selected matches 1 if entity @s[tag=held_item,tag=!shrunk,tag=flipped_gravity] positioned ^-0.375 ^-0.03 ^ run function luigis_mansion:animations/luigi/scare/bash/item
execute unless score #mirrored Selected matches 1 if entity @s[tag=held_item,tag=shrunk,tag=flipped_gravity] positioned ^-0.1825 ^-0.02 ^ run function luigis_mansion:animations/luigi/scare/bash/item
