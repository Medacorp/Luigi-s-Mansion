...
scoreboard players set @s[tag=!riding_poltergust,scores={Time=1},tag=!low_health] AnimationRotationX 0
scoreboard players set @s[tag=!riding_poltergust,scores={Time=1},tag=low_health] AnimationRotationX 200
