...
execute unless score #mirrored Selected matches 1 unless score #temp AnimationProgress matches 1..2 run scoreboard players add @s AnimationRotationX 2
execute unless score #mirrored Selected matches 1 if score #temp AnimationProgress matches 1..2 run scoreboard players remove @s AnimationRotationX 2
