...
scoreboard players add @s[scores={AnimationProgress=41..60}] AnimationRotationX 40
scoreboard players remove @s[scores={AnimationProgress=91..100}] AnimationRotationX 40
...
scoreboard players add @s[scores={AnimationProgress=91..100}] AnimationRotationY 30
