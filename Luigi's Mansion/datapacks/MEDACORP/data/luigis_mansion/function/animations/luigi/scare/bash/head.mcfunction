...
execute if entity @s[scores={AnimationProgress=31..32}] unless data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationY 30
execute if entity @s[scores={AnimationProgress=33..36}] unless data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationY 30
execute if entity @s[scores={AnimationProgress=37..38}] unless data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationY 30
execute if entity @s[scores={AnimationProgress=31..32}] if data storage luigis_mansion:data luigi{tags:["moved"]} unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationY 50
execute if entity @s[scores={AnimationProgress=33..36}] if data storage luigis_mansion:data luigi{tags:["moved"]} unless score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationY 50
execute if entity @s[scores={AnimationProgress=37..38}] if data storage luigis_mansion:data luigi{tags:["moved"]} unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationY 50
execute if entity @s[scores={AnimationProgress=31..32}] if data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationY 50
execute if entity @s[scores={AnimationProgress=33..36}] if data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationY 50
execute if entity @s[scores={AnimationProgress=37..38}] if data storage luigis_mansion:data luigi{tags:["moved"]} if score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationY 50
