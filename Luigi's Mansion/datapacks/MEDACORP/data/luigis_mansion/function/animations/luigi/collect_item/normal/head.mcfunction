...
execute if entity @s[tag=!shrunk,scores={AnimationProgress=1..6}] positioned ^ ^-0.67 ^ rotated ~180 ~ positioned ^ ^ ^0.67 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[tag=shrunk,scores={AnimationProgress=1..6}] positioned ^ ^-0.34 ^ rotated ~180 ~ positioned ^ ^ ^0.34 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[tag=!shrunk,scores={AnimationProgress=7}] positioned ^ ^-0.67 ^ rotated ~135 ~-45 positioned ^ ^ ^0.67 run teleport @s ~ ~ ~ ~ ~45
execute if entity @s[tag=shrunk,scores={AnimationProgress=7}] positioned ^ ^-0.34 ^ rotated ~135 ~-45 positioned ^ ^ ^0.34 run teleport @s ~ ~ ~ ~ ~45
