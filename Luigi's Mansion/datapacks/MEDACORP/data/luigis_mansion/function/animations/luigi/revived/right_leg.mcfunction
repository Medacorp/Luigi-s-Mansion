...
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 1 run teleport @s[tag=flipped_gravity] ^-0.0125 ^-0.0125 ^
execute if entity @s[scores={DeathTime=11..50}] unless score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationZ 12
...
execute if entity @s[scores={DeathTime=11..50}] unless score #mirrored Selected matches 1 run scoreboard players add @s AnimationRotationX 10
execute if entity @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 1 run scoreboard players remove @s AnimationRotationX 5
