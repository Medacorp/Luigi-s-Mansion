...
scoreboard players set @s[scores={AnimationProgress=80}] AnimationRotationX 1125
...
execute if entity @s[scores={AnimationProgress=111..120}] run scoreboard players remove @s AnimationRotationX 112
