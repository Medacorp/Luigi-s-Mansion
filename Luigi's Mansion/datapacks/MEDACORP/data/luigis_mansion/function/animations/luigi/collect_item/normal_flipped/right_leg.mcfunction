...
execute if entity @s[scores={AnimationProgress=1..6}] positioned ^-0.125 ^ ^ rotated ~180 ~ positioned ^0.125 ^ ^ run teleport @s ~ ~ ~ ~ ~
execute if entity @s[scores={AnimationProgress=7}] positioned ^-0.125 ^ ^ rotated ~135 ~ positioned ^0.125 ^ ^ run teleport @s ~ ~ ~ ~ ~
