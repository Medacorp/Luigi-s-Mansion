...
data modify entity @s[scores={AnimationProgress=15..109},tag=held_item] equipment.head.id set value "minecraft:stone_button"
...
execute if entity @s[scores={AnimationProgress=6..15}] store result entity @s Pose.Head[1] float 0.01 run scoreboard players remove #temp Time 400
execute if entity @s[scores={AnimationProgress=111..120}] store result entity @s Pose.Head[1] float 0.01 run scoreboard players remove #temp Time 450
