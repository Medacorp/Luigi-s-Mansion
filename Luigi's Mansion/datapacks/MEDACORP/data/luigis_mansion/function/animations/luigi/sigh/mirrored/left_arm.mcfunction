...
scoreboard players add @s[scores={AnimationProgress=1..5}] AnimationRotationY 140
scoreboard players remove @s[scores={AnimationProgress=16..20}] AnimationRotationY 140
