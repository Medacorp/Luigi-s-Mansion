...
scoreboard players remove @s[scores={AnimationProgress=1..10}] AnimationRotationY 70
scoreboard players add @s[scores={AnimationProgress=11..20}] AnimationRotationY 70
