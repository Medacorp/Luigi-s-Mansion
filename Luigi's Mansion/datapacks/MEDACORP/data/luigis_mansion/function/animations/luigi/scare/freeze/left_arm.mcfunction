...
scoreboard players add @s[scores={AnimationProgress=1..30}] AnimationRotationZ 3
scoreboard players remove @s[scores={AnimationProgress=91..100}] AnimationRotationZ 9
