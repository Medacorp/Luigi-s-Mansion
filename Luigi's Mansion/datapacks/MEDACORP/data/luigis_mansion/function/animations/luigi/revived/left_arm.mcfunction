...
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 1 run teleport @s[tag=flipped_gravity] ^-0.03875 ^-0.015 ^
execute unless score #mirrored Selected matches 1 run scoreboard players remove @s[scores={DeathTime=11..50}] AnimationRotationZ 22
execute if score #mirrored Selected matches 1 run scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationZ 10
execute unless score #mirrored Selected matches 1 run scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationX 12
execute if score #mirrored Selected matches 1 run scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationX 7
