...
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=1..4}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=5..8}] unless score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=1..4}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
execute if data storage luigis_mansion:data luigi{tags:["moved"]} if entity @s[scores={AnimationProgress=30..,ActionTime=5..8}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
