...
execute if entity @s[scores={AnimationProgress=1..13}] run scoreboard players add @s AnimationRotationX 30
execute if entity @s[scores={AnimationProgress=14..39}] run scoreboard players remove @s AnimationRotationX 30
