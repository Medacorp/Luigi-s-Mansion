...
execute if score #mirrored Selected matches 1 if data storage luigis_mansion:data luigi.offhand.id run data modify entity @s[tag=held_item] equipment.head set from storage luigis_mansion:data luigi.offhand
execute if entity @s[tag=!poltergust_grabbed] unless score #mirrored Selected matches 1 unless data storage luigis_mansion:data luigi.mainhand.components."minecraft:custom_data".is_nozzle if data storage luigis_mansion:data luigi.mainhand.id run data modify entity @s[tag=held_item] equipment.head set from storage luigis_mansion:data luigi.mainhand
