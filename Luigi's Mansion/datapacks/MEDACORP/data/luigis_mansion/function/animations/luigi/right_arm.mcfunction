...
execute if entity @s[tag=poltergust_grabbed] unless score #mirrored Selected matches 1 if data storage luigis_mansion:data luigi.selected_item.components."minecraft:custom_data".is_nozzle run data modify entity @s[tag=held_item] item set from storage luigis_mansion:data luigi.selected_item
