...
teleport @s[scores={AnimationProgress=1}] ~ ~-0.2 ~ ~ ~
teleport @s[scores={AnimationProgress=2}] ~ ~-0.4 ~ ~ ~
teleport @s[scores={AnimationProgress=3}] ~ ~-0.6 ~ ~ ~
teleport @s[scores={AnimationProgress=4}] ~ ~-0.8 ~ ~ ~
teleport @s[scores={AnimationProgress=5..15}] ~ ~-1 ~ ~ ~
teleport @s[scores={AnimationProgress=16}] ~ ~-0.8 ~ ~ ~
teleport @s[scores={AnimationProgress=17}] ~ ~-0.6 ~ ~ ~
teleport @s[scores={AnimationProgress=18}] ~ ~-0.4 ~ ~ ~
