...
execute if entity @s[scores={AnimationProgress=6..10}] run scoreboard players remove @s AnimationRotationY 140
execute if entity @s[scores={AnimationProgress=15..19}] run scoreboard players add @s AnimationRotationY 160
