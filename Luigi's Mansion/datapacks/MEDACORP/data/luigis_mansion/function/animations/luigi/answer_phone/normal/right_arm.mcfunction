...
scoreboard players remove @s[scores={AnimationProgress=6..10}] AnimationRotationY 140
scoreboard players add @s[scores={AnimationProgress=15..19}] AnimationRotationY 160
