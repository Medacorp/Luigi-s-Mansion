...
scoreboard players remove @s[scores={AnimationProgress=1..10}] AnimationRotationZ 15
...
scoreboard players add @s[scores={AnimationProgress=51..60}] AnimationRotationZ 15
