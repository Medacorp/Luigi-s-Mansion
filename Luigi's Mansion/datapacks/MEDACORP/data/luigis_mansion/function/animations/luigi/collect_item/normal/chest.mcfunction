...
execute if entity @s[scores={AnimationProgress=1..6}] positioned ^ ^-0.64 ^ rotated ~180 ~ positioned ^ ^ ^0.64 run teleport @s ~ ~ ~ ~ ~
execute if entity @s[scores={AnimationProgress=7}] positioned ^ ^-0.64 ^ rotated ~135 ~-45 positioned ^ ^ ^0.64 run teleport @s ~ ~ ~ ~ ~45
...
execute if entity @s[scores={AnimationProgress=47..63}] rotated ~45 ~ run teleport @s ~ ~ ~ ~ ~
