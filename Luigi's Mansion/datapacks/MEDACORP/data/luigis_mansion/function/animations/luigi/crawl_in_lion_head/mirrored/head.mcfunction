...
scoreboard players remove @s[scores={AnimationProgress=81..92}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=115..136}] AnimationRotationY 30
scoreboard players remove @s[scores={AnimationProgress=149..160}] AnimationRotationY 30
