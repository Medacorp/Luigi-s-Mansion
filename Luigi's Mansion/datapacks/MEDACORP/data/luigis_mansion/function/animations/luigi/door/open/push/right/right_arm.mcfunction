...
execute if entity @s[scores={AnimationProgress=6..15}] run scoreboard players remove @s AnimationRotationY 80
execute if entity @s[scores={AnimationProgress=16..25}] run scoreboard players add @s AnimationRotationY 80
