...
scoreboard players remove @s[scores={AnimationProgress=6..15}] AnimationRotationY 80
scoreboard players add @s[scores={AnimationProgress=16..25}] AnimationRotationY 80
