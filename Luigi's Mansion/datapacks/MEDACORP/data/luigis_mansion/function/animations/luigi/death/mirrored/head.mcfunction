...
execute at @s[scores={DeathTime=31..40}] run teleport @s[tag=!flipped_gravity] ^-0.125 ^-0.1 ^
scoreboard players remove @s[scores={DeathTime=31..40}] AnimationRotationZ 110