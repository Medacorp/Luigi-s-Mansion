...
teleport @s[scores={AnimationProgress=13},tag=!shrunk] ^ ^0.06 ^-0.2
teleport @s[scores={AnimationProgress=14},tag=!shrunk] ^ ^0.33 ^-0.1
...
teleport @s[scores={AnimationProgress=13},tag=shrunk] ^ ^0.03 ^-0.1
teleport @s[scores={AnimationProgress=14},tag=shrunk] ^ ^0.165 ^-0.05
