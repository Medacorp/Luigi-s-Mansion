...
scoreboard players remove @s[scores={AnimationProgress=41..60}] AnimationRotationY 50
scoreboard players add @s[scores={AnimationProgress=91..100}] AnimationRotationY 50
