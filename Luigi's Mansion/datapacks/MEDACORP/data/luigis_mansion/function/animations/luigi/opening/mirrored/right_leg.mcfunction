...
scoreboard players remove @s[scores={Time=1..20}] AnimationRotationX 40
scoreboard players add @s[scores={Time=21..60}] AnimationRotationX 40
scoreboard players remove @s[scores={Time=61..80}] AnimationRotationX 40
