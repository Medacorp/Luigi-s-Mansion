...
execute if entity @s[scores={AnimationProgress=14..39}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProgress=40..52}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 3
