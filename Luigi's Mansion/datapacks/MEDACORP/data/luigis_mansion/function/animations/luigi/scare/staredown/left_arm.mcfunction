...
scoreboard players remove @s[scores={AnimationProgress=1..10}] AnimationRotationZ 8
scoreboard players add @s[scores={AnimationProgress=11..20}] AnimationRotationZ 8
