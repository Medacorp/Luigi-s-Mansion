...
execute if score #mirrored Selected matches 1 run data modify entity @s[tag=held_item,scores={AnimationProgress=56..}] equipment.head set value {}
...
execute unless score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=41..45}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 30
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=41..43}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 20
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=44..46}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 10
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=47..49}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 10
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=50..52}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 10
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=53..55}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 20
execute if score #mirrored Selected matches 1 if entity @s[scores={AnimationProgress=56..}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 30
