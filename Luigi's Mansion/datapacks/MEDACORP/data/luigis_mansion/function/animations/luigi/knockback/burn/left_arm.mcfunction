...
execute if score #mirrored Selected matches 1 run data modify entity @s[tag=held_item,scores={AnimationProgress=40..55}] ArmorItems[3] set value {id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/luigi","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;0b,0b],floats:[0f],strings:["hat"]},"minecraft:dyed_color":{rgb:37129}}}
execute if score #mirrored Selected matches 1 run data modify entity @s[tag=held_item,scores={AnimationProgress=40..55}] ArmorItems[3].components."minecraft:dyed_color".rgb set from storage luigis_mansion:data luigi.animation.hat_model.color
