...
data modify entity @s[scores={AnimationProgress=120..},tag=held_item] equipment.head.components."minecraft:item_model" set value "luigis_mansion:empty"
...
execute if entity @s[scores={AnimationProgress=80..84},tag=!held_item] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 24
execute if entity @s[scores={AnimationProgress=88..92},tag=!held_item] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 24
execute if entity @s[scores={AnimationProgress=141}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=142}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=143}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=144}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=145}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=146}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=147}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=148}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=149}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=150}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=151}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=152}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=153}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=154}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=155}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=156}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=157}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=158}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=159}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=160}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=161}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=162}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=163}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=164}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=165}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=166}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=167}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=168}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=169}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=170}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=171}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=172}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=173}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=174}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=175}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=176}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=177}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=178}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=179}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=180}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=201..220}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 6
execute store result score #temp Time run data get entity @s Pose.Head[2]
execute if entity @s[scores={AnimationProgress=80..84}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={AnimationProgress=88..92}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={AnimationProgress=201..220}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 1
