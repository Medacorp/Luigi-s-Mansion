...
execute if entity @s[tag=held_item,tag=!shrunk] positioned ^0.375 ^-0.03 ^ run function luigis_mansion:animations/luigi/scare/bash/normal_flipped/item
execute if entity @s[tag=held_item,tag=shrunk] positioned ^0.1825 ^-0.02 ^ run function luigis_mansion:animations/luigi/scare/bash/normal_flipped/item
