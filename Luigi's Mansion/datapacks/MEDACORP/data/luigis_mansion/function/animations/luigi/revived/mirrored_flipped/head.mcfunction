...
scoreboard players add @s[scores={DeathTime=1..15}] AnimationRotationY 40
scoreboard players remove @s[scores={DeathTime=26..40}] AnimationRotationY 40
scoreboard players add @s[scores={DeathTime=11..50}] AnimationRotationZ 27
