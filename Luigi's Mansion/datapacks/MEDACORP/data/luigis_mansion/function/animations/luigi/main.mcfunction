...
#/todelete
execute if entity @s[tag=was_walking,tag=!riding_poltergust] if data storage luigis_mansion:data luigi{alive:1b} unless entity @s[scores={AnimationProgress=1..}] unless data storage luigis_mansion:data luigi{tags:["walking"]} run function luigis_mansion:animations/luigi/reset_pose
