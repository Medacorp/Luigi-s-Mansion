...
execute if entity @s[scores={AnimationProgress=21..40}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProgress=101..120}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
