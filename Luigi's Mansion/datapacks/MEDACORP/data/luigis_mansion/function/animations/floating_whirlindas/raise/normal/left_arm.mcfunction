...
scoreboard players remove @s[scores={AnimationProgress=21..40}] AnimationRotationY 30
scoreboard players add @s[scores={AnimationProgress=101..120}] AnimationRotationY 30
