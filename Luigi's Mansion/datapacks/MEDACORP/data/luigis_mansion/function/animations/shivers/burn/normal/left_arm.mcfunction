...
scoreboard players add @s[scores={AnimationProgress=6..10}] AnimationRotationZ 10
scoreboard players remove @s[scores={AnimationProgress=11..15}] AnimationRotationZ 10
