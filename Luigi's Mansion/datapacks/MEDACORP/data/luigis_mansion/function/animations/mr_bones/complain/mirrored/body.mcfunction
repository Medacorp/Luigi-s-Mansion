...
execute if entity @s[scores={AnimationProgress=15..20}] run scoreboard players remove @s AnimationRotationZ 130
execute if entity @s[scores={AnimationProgress=21..25}] run scoreboard players add @s AnimationRotationZ 130
