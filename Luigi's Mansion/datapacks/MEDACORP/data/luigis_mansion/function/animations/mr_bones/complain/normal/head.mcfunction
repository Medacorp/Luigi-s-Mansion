...
execute if entity @s[scores={AnimationProgress=10..15}] run scoreboard players remove @s AnimationRotationZ 100
execute if entity @s[scores={AnimationProgress=26..30}] run scoreboard players add @s AnimationRotationZ 100
