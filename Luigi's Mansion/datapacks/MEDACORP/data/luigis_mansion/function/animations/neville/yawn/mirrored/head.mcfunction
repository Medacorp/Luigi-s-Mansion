...
execute if entity @s[scores={AnimationProgress=1..30}] run scoreboard players remove @s AnimationRotationZ 10
execute if entity @s[scores={AnimationProgress=31..60}] run scoreboard players add @s AnimationRotationZ 10
