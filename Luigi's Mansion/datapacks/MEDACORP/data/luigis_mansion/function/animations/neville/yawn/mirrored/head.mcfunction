...
scoreboard players remove @s[scores={AnimationProgress=1..30}] AnimationRotationZ 10
scoreboard players add @s[scores={AnimationProgress=31..60}] AnimationRotationZ 10
