...
execute if score @s AnimationRotationX matches -720..-680 unless score @s AnimationRotationY matches -1760..1760 run tag @e[tag=this_entity,limit=1] add can_reattach