...
scoreboard players add @s[scores={AnimationProgress=1..2}] AnimationRotationX 60
scoreboard players remove @s[scores={AnimationProgress=3..6}] AnimationRotationX 60
scoreboard players add @s[scores={AnimationProgress=7..8}] AnimationRotationX 60
