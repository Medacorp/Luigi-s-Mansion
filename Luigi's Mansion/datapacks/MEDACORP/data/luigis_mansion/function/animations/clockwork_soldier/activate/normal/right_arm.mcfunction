...
execute if entity @s[scores={AnimationProgress=31..40}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 8
execute if entity @s[scores={AnimationProgress=61..70}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 8
