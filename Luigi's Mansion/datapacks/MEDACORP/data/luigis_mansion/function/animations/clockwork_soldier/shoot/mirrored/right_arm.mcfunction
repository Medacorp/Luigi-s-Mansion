...
scoreboard players remove @s[scores={AnimationProgress=1..15}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=26..40}] AnimationRotationY 20
