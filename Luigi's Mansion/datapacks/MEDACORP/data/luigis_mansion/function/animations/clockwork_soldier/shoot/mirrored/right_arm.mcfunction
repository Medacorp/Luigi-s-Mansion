...
execute if entity @s[scores={AnimationProgress=1..15}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProgress=26..40}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 2
