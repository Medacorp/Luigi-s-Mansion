...
execute if entity @s[scores={AnimationProgress=11..12}] run scoreboard players remove @s AnimationRotationY 200
execute if entity @s[scores={AnimationProgress=14..15}] run scoreboard players add @s AnimationRotationY 200
