...
execute if entity @s[scores={AnimationProgress=16..17}] run scoreboard players remove @s AnimationRotationY 200
execute if entity @s[scores={AnimationProgress=19..20}] run scoreboard players add @s AnimationRotationY 200
