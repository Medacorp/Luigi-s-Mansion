...
execute if entity @s[scores={AnimationProgress=1..8}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProgress=9..24}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProgress=25..32}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 5
