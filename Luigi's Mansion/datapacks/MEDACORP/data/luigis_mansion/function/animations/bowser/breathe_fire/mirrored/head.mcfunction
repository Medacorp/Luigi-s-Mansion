...
execute if entity @s[scores={AnimationProgress=21..40}] run scoreboard players add @s AnimationRotationY 15
execute if entity @s[scores={AnimationProgress=41..80}] run scoreboard players remove @s AnimationRotationY 15
execute if entity @s[scores={AnimationProgress=81..120}] run scoreboard players add @s AnimationRotationY 15
execute if entity @s[scores={AnimationProgress=121..140}] run scoreboard players remove @s AnimationRotationY 15
