...
scoreboard players remove @s[scores={AnimationProgress=41..50}] AnimationRotationX 40
scoreboard players remove @s[scores={AnimationProgress=51..60}] AnimationRotationX 10
scoreboard players add @s[scores={AnimationProgress=91..100}] AnimationRotationX 30
scoreboard players remove @s[scores={AnimationProgress=1..10}] AnimationRotationY 14
scoreboard players add @s[scores={AnimationProgress=91..100}] AnimationRotationY 14