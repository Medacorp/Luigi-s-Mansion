...
scoreboard players add @s[scores={AnimationProgress=1..8}] AnimationRotationZ 5
scoreboard players remove @s[scores={AnimationProgress=9..24}] AnimationRotationZ 5
scoreboard players add @s[scores={AnimationProgress=25..32}] AnimationRotationZ 5
