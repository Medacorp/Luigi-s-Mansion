...
execute if entity @s[scores={AnimationProgress=1..8}] run scoreboard players add @s AnimationRotationZ 5
execute if entity @s[scores={AnimationProgress=9..24}] run scoreboard players remove @s AnimationRotationZ 5
execute if entity @s[scores={AnimationProgress=25..32}] run scoreboard players add @s AnimationRotationZ 5
