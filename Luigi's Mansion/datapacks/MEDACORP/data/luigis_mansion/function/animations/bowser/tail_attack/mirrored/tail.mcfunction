...
scoreboard players add @s[scores={AnimationProgress=11..20}] AnimationRotationY 100
scoreboard players remove @s[scores={AnimationProgress=21..30}] AnimationRotationY 100
