...
scoreboard players add @s[scores={AnimationProgress=1..4}] AnimationRotationX 70
scoreboard players remove @s[scores={AnimationProgress=8..17}] AnimationRotationX 130
