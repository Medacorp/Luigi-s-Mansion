...
scoreboard players remove @s[scores={AnimationProgress=3..6}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=7..8}] AnimationRotationX 50
