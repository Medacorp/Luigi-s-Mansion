...
execute if entity @s[scores={AnimationProgress=1..4}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=17..20}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 10
