...
scoreboard players remove @s[scores={AnimationProgress=20..25}] AnimationRotationY 140
scoreboard players add @s[scores={AnimationProgress=30..35}] AnimationRotationY 140
