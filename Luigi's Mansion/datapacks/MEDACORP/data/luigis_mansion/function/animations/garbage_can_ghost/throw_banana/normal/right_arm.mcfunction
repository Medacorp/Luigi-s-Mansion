...
execute if entity @s[scores={AnimationProgress=20..25}] run scoreboard players remove @s AnimationRotationY 140
execute if entity @s[scores={AnimationProgress=30..35}] run scoreboard players add @s AnimationRotationY 140
