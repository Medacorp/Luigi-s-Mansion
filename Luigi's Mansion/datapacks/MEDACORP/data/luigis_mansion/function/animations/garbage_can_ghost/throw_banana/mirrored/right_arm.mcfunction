...
execute if entity @s[scores={AnimationProgress=1..19}] run scoreboard players remove @s AnimationRotationY 10
execute if entity @s[scores={AnimationProgress=20..29}] run scoreboard players add @s AnimationRotationY 20
execute if entity @s[scores={AnimationProgress=20..29}] run scoreboard players add @s AnimationRotationZ 60
