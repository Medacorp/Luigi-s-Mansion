...
scoreboard players remove @s[scores={AnimationProgress=1..19}] AnimationRotationY 10
scoreboard players add @s[scores={AnimationProgress=20..29}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=20..29}] AnimationRotationZ 60
