...
execute if entity @s[tag=!using_selection_menu,nbt={Inventory:[{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"flashlight"}}}]}] run data modify storage luigis_mansion:data luigi.flashlight set from entity @s Inventory[{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"flashlight"}}}]
execute if entity @s[tag=using_selection_menu] run data modify storage luigis_mansion:data luigi.flashlight set from storage luigis_mansion:data my_memory.selection_menu.inventory[{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"flashlight"}}}]
...
execute if entity @s[tag=!source_only] unless score #temp Time matches 10 run tag @e[tag=this_luigi] add dead
