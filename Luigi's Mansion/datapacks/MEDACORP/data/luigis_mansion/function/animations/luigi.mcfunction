...
execute if entity @s[scores={Shrunk=1..}] run data modify storage luigis_mansion:data luigi.offhand set from storage luigis_mansion:data my_memory.inventory[{components:{"minecraft:custom_data":{namespace:"luigis_mansion",id:"game_boy_horror"}}}]
