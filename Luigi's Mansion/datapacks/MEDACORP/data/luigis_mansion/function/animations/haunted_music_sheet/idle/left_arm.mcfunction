...
scoreboard players remove @s[scores={AnimationProgress=1}] AnimationRotationZ 180
scoreboard players add @s[scores={AnimationProgress=2..3}] AnimationRotationZ 180
scoreboard players remove @s[scores={AnimationProgress=4}] AnimationRotationZ 180
