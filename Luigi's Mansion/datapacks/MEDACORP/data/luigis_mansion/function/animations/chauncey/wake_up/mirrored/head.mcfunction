...
scoreboard players remove @s[scores={AnimationProgress=1..5}] AnimationRotationZ 30
scoreboard players add @s[scores={AnimationProgress=6..15}] AnimationRotationZ 30
scoreboard players remove @s[scores={AnimationProgress=16..20}] AnimationRotationZ 30
