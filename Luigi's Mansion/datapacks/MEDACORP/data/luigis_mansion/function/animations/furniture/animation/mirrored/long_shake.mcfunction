...
execute if entity @s[scores={AnimationProgress=13..15},tag=!no_visual_shake_animation] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 1
