...
execute if entity @s[scores={ActionTime=1..3}] store result entity @s equipment.head.components."minecraft:custom_model_data".floats[0] float 1 run scoreboard players add @s AnimationModelModifier 1
execute if entity @s[scores={ActionTime=4..6}] store result entity @s equipment.head.components."minecraft:custom_model_data".floats[0] float 1 run scoreboard players remove @s AnimationModelModifier 1
...
execute if entity @s[scores={FurnitureNoteTime=1}] run summon minecraft:marker ^-0.125 ^1.75 ^0.125 {Tags:["random_note"]}
execute if entity @s[scores={FurnitureNoteTime=1}] run summon minecraft:marker ^0.125 ^1.75 ^-0.125 {Tags:["random_note"]}
execute if entity @s[scores={FurnitureNoteTime=1}] positioned as @e[tag=random_note,sort=random,limit=1] run particle minecraft:note ~ ~ ~ 0.167 0 0 1 0 normal @a[tag=same_room]
