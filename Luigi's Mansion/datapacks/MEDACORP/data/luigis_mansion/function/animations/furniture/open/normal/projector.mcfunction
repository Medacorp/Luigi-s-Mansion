...
execute if entity @s[scores={ActionTime=2..3}] run scoreboard players add @s AnimationRotationZ 40
execute if entity @s[scores={ActionTime=4..7}] run scoreboard players remove @s AnimationRotationZ 40
execute if entity @s[scores={ActionTime=8..11}] run scoreboard players add @s AnimationRotationZ 40
execute if entity @s[scores={ActionTime=12..15}] run scoreboard players remove @s AnimationRotationZ 40
execute if entity @s[scores={ActionTime=16..17}] run scoreboard players add @s AnimationRotationZ 40
...
data modify entity @s[tag=!dark_room] equipment.head merge from entity @s equipment.head.components."minecraft:custom_data".model_data.default
