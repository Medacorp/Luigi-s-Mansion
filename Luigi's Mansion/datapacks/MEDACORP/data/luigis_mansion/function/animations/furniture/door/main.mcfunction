...
execute if data storage luigis_mansion:data passive{tags:["barricade"]} run data modify entity @s equipment.head.components."minecraft:custom_model_data".strings[0] set value "barricade"
execute if data storage luigis_mansion:data passive{tags:["barricade_double"]} run data modify entity @s equipment.head.components."minecraft:custom_model_data".strings[0] set value "barricade_double"
