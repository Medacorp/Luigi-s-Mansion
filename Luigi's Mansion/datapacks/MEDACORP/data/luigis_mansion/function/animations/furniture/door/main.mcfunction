...
execute if data storage luigis_mansion:data passive{tags:["area_blockade"]} run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "blockade_area"
