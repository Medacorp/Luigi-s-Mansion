...
execute if entity @s[scores={AnimationProgress=1..3}] run scoreboard players add @s AnimationRotationX 250
execute if entity @s[scores={AnimationProgress=4..6}] run scoreboard players remove @s AnimationRotationX 250
