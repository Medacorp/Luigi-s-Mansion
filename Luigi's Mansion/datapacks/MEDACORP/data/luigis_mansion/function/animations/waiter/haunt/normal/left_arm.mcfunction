...
execute if entity @s[scores={AnimationProgress=1..4}] run scoreboard players remove @s AnimationRotationX 10
execute if entity @s[scores={AnimationProgress=5..12}] run scoreboard players add @s AnimationRotationX 10
