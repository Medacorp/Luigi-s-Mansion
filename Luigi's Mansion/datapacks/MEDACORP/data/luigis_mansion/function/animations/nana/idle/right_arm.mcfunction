...
execute if entity @s[scores={AnimationProgress=1..20}] run scoreboard players remove @s AnimationRotationY 5
execute if entity @s[scores={AnimationProgress=21..60}] run scoreboard players add @s AnimationRotationY 5
execute if entity @s[scores={AnimationProgress=61..80}] run scoreboard players remove @s AnimationRotationY 5
