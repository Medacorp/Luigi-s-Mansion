...
scoreboard players add @s[scores={AnimationProgress=1..20}] AnimationRotationY 5
scoreboard players remove @s[scores={AnimationProgress=21..60}] AnimationRotationY 5
scoreboard players add @s[scores={AnimationProgress=61..80}] AnimationRotationY 5
