...
teleport @s[scores={AnimationProgress=3}] ~ ~-0.0167 ~
teleport @s[scores={AnimationProgress=4}] ~ ~-0.0333 ~
teleport @s[scores={AnimationProgress=5}] ~ ~-0.05 ~
teleport @s[scores={AnimationProgress=6}] ~ ~-0.0333 ~
teleport @s[scores={AnimationProgress=7}] ~ ~-0.0167 ~
