...
data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[-80.0f,-32.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProgress=11..15}] store result entity @s Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 5
