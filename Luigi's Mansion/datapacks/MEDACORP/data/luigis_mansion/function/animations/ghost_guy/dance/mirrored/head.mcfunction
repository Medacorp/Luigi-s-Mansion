...
scoreboard players add @s[scores={AnimationProgress=4..7}] AnimationRotationZ 20
scoreboard players remove @s[scores={AnimationProgress=9..10}] AnimationRotationZ 20
