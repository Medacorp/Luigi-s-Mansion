...
execute if entity @s[scores={AnimationProgress=20..24}] run scoreboard players add @s AnimationRotationY 90
execute if entity @s[scores={AnimationProgress=25..29}] run scoreboard players remove @s AnimationRotationY 90
