...
scoreboard players remove @s[scores={AnimationProgress=20..24}] AnimationRotationY 50
scoreboard players add @s[scores={AnimationProgress=25..29}] AnimationRotationY 50
