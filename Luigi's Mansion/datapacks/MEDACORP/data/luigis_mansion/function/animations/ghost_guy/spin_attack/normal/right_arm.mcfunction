...
execute if entity @s[scores={AnimationProgress=1..10}] run scoreboard players add @s AnimationRotationY 180
execute if entity @s[scores={AnimationProgress=20..30}] run scoreboard players remove @s AnimationRotationY 180
