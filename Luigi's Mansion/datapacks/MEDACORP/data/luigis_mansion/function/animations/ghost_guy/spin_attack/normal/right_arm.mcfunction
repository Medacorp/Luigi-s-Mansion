...
scoreboard players add @s[scores={AnimationProgress=1..10}] AnimationRotationY 180
scoreboard players remove @s[scores={AnimationProgress=20..30}] AnimationRotationY 180
