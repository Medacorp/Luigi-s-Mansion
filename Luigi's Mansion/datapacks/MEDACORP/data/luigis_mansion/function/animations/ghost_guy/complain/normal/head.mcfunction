...
scoreboard players remove @s[scores={AnimationProgress=3..6}] AnimationRotationY 60
scoreboard players add @s[scores={AnimationProgress=7..8}] AnimationRotationY 60
