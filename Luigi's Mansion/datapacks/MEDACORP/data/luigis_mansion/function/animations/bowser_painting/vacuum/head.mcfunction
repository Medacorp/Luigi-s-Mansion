...
execute at @s run teleport @s[tag=!flipped_gravity,scores={AnimationProgress=..10}] ^ ^0.1 ^-0.1
execute at @s run teleport @s[tag=!flipped_gravity,scores={AnimationProgress=11..35}] ^ ^0.05 ^-0.05
execute at @s run teleport @s[tag=flipped_gravity,scores={AnimationProgress=..10}] ^ ^-0.1 ^-0.1
execute at @s run teleport @s[tag=flipped_gravity,scores={AnimationProgress=11..35}] ^ ^-0.05 ^-0.05
