...
scoreboard players add @s[scores={AnimationProgress=23..26}] AnimationRotationY 30
scoreboard players remove @s[scores={AnimationProgress=27..30}] AnimationRotationY 60
scoreboard players add @s[scores={AnimationProgress=31..34}] AnimationRotationY 60
scoreboard players remove @s[scores={AnimationProgress=35..38}] AnimationRotationY 30
