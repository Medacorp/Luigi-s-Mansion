...
execute if entity @s[scores={AnimationProgress=23..26}] run scoreboard players remove @s AnimationRotationY 30
execute if entity @s[scores={AnimationProgress=27..30}] run scoreboard players add @s AnimationRotationY 60
execute if entity @s[scores={AnimationProgress=31..34}] run scoreboard players remove @s AnimationRotationY 60
execute if entity @s[scores={AnimationProgress=35..38}] run scoreboard players add @s AnimationRotationY 30
