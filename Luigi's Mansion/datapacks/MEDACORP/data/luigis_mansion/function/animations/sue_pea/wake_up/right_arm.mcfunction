...
execute if entity @s[scores={AnimationProgress=1..20}] run scoreboard players remove @s AnimationRotationY 40
execute if entity @s[scores={AnimationProgress=121..140}] run scoreboard players add @s AnimationRotationY 40
