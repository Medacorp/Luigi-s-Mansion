...
execute if entity @s[scores={AnimationProgress=41..45}] run scoreboard players remove @s AnimationRotationZ 20
execute if entity @s[scores={AnimationProgress=46..50}] run scoreboard players add @s AnimationRotationZ 20
