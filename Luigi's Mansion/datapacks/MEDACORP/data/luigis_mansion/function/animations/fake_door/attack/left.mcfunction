...
execute if entity @s[scores={AnimationProgress=6..15}] run scoreboard players remove @s AnimationRotationY 180
execute if entity @s[scores={AnimationProgress=45..74}] run scoreboard players add @s AnimationRotationY 60
