...
scoreboard players add @s[scores={AnimationProgress=61..80}] AnimationRotationY 10
scoreboard players remove @s[scores={AnimationProgress=81..100}] AnimationRotationY 10
