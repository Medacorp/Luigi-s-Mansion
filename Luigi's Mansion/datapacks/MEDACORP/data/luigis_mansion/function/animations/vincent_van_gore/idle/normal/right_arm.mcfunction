...
execute if entity @s[scores={AnimationProgress=61..80}] run scoreboard players remove @s AnimationRotationY 10
execute if entity @s[scores={AnimationProgress=81..100}] run scoreboard players add @s AnimationRotationY 10
