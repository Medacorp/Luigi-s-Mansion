...
execute if entity @s[scores={AnimationProgress=1..6}] run scoreboard players remove @s AnimationRotationZ 100
execute if entity @s[scores={AnimationProgress=35..40}] run scoreboard players add @s AnimationRotationZ 100
