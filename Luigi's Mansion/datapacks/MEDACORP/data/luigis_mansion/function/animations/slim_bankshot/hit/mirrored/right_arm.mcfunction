...
execute if entity @s[scores={AnimationProgress=1..4}] run scoreboard players remove @s AnimationRotationZ 120
...
execute if entity @s[scores={AnimationProgress=15..18}] run scoreboard players add @s AnimationRotationZ 120
