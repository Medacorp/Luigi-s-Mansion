...
scoreboard players add @s[scores={AnimationProgress=1..4}] AnimationRotationZ 120
...
scoreboard players remove @s[scores={AnimationProgress=15..18}] AnimationRotationZ 120
