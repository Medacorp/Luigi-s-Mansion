...
execute if entity @s[scores={AnimationProgress=1..8}] run scoreboard players remove @s AnimationRotationZ 20
execute if entity @s[scores={AnimationProgress=11..18}] run scoreboard players add @s AnimationRotationZ 20
