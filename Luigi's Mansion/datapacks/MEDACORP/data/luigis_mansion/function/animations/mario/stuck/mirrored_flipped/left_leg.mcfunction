...
execute if entity @s[scores={AnimationProgress=127}] rotated ~ -31.5 positioned ^ ^ ^0.55 run teleport @s ~ ~.05 ~
execute if entity @s[scores={AnimationProgress=128}] rotated ~ -36 positioned ^ ^ ^0.55 run teleport @s ~ ~.15 ~
execute if entity @s[scores={AnimationProgress=129}] rotated ~ -40.5 positioned ^ ^ ^0.55 run teleport @s ~ ~.25 ~
execute if entity @s[scores={AnimationProgress=130}] rotated ~ -45 positioned ^ ^ ^0.55 run teleport @s ~ ~.35 ~
execute if entity @s[scores={AnimationProgress=132}] rotated ~ -49.5 positioned ^ ^ ^0.55 run teleport @s ~ ~.25 ~
execute if entity @s[scores={AnimationProgress=133}] rotated ~ -54 positioned ^ ^ ^0.55 run teleport @s ~ ~.2 ~
