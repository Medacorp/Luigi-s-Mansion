...
scoreboard players add @s[scores={AnimationProgress=1..5}] AnimationRotationZ 6
scoreboard players remove @s[scores={AnimationProgress=6..15}] AnimationRotationZ 6
scoreboard players add @s[scores={AnimationProgress=16..20}] AnimationRotationZ 6
