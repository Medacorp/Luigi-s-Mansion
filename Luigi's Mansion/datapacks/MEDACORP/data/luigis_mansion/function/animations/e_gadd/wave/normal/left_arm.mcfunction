...
scoreboard players remove @s[scores={AnimationProgress=1..6}] AnimationRotationZ 2
scoreboard players add @s[scores={AnimationProgress=7..12}] AnimationRotationZ 2
scoreboard players remove @s[scores={AnimationProgress=13..18}] AnimationRotationZ 2
scoreboard players add @s[scores={AnimationProgress=19..24}] AnimationRotationZ 2
