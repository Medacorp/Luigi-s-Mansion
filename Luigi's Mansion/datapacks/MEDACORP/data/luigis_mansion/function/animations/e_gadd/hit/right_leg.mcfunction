...
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=25}] ^ ^0.35 ^
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=26}] ^ ^0.2 ^-0.1
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=27}] ^ ^0.05 ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=28}] ^ ^ ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=29}] ^ ^-0.15 ^-0.1
