...
execute if entity @s[scores={AnimationProgress=1..10},tag=!held_item] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProgress=11..20},tag=!held_item] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 3
