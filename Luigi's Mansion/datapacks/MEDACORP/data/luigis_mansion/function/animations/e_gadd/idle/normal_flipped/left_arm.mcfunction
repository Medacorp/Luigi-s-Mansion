...
scoreboard players remove @s[scores={AnimationProgress=11..22}] AnimationRotationZ 5
scoreboard players add @s[scores={AnimationProgress=23..24}] AnimationRotationZ 5
