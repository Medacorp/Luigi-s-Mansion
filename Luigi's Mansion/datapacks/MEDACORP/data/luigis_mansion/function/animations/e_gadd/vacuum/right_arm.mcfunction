...
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[0.0f,0.0f,15.01f]}}
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=1},tag=held_item] {Pose:{Head:[-35.0f,-20.0f,15.01f]}}
execute if score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[-45.0f,-65.0f,0.01f]}}
execute if score #mirrored Selected matches 1 run teleport @s ^ ^ ^0.2
execute unless score #mirrored Selected matches 1 run teleport @s[tag=held_item] ^ ^0.2 ^-0.1
