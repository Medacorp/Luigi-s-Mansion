...
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=6},tag=held_item] {Pose:{Head:[-35.0f,-20.0f,15.01f]}}
teleport @s[scores={AnimationProgress=5..}] ^ ^-0.1 ^0.2
teleport @s[scores={AnimationProgress=1..4},tag=held_item] ^ ^0.05 ^-0.25
execute unless score #mirrored Selected matches 1 at @s run teleport @s[tag=held_item] ^0.3 ^0.2 ^-0.1
