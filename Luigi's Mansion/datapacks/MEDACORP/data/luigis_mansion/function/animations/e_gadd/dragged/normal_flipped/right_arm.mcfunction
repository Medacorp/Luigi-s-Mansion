...
scoreboard players set @s[scores={AnimationProgress=1},tag=held_item] AnimationRotationZ -1650
scoreboard players set @s[scores={AnimationProgress=6}] AnimationRotationX -200
scoreboard players set @s[scores={AnimationProgress=6}] AnimationRotationZ 1400
...
scoreboard players set @s[scores={AnimationProgress=6},tag=held_item] AnimationRotationZ -1650
