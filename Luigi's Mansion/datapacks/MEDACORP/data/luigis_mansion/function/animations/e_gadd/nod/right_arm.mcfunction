...
execute if entity @s[scores={AnimationProgress=11..22}] run scoreboard players add @s AnimationRotationZ 10
execute if entity @s[scores={AnimationProgress=23..24}] run scoreboard players remove @s AnimationRotationZ 10
