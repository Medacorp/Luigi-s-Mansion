...
scoreboard players remove @s[scores={AnimationProgress=11..22}] AnimationRotationX 10
scoreboard players add @s[scores={AnimationProgress=23..24}] AnimationRotationX 10
