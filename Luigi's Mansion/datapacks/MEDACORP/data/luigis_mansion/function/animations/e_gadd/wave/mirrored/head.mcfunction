...
execute if entity @s[scores={AnimationProgress=3..10}] run scoreboard players remove @s AnimationRotationX 2
execute if entity @s[scores={AnimationProgress=11..18}] run scoreboard players add @s AnimationRotationX 2
execute if entity @s[scores={AnimationProgress=20..21}] run scoreboard players remove @s AnimationRotationX 2
