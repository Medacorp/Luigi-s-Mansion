...
scoreboard players remove @s[scores={AnimationProgress=1..3}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=4..9}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=10..12}] AnimationRotationY 20
