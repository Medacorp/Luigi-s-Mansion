...
execute if entity @s[scores={AnimationProgress=1..10}] run scoreboard players add @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=11..20}] run scoreboard players remove @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=21..30}] run scoreboard players add @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=31..40}] run scoreboard players remove @s AnimationRotationX 40
execute if entity @s[scores={AnimationProgress=1..10}] run scoreboard players add @s AnimationRotationZ 30
execute if entity @s[scores={AnimationProgress=11..20}] run scoreboard players remove @s AnimationRotationZ 30
execute if entity @s[scores={AnimationProgress=21..30}] run scoreboard players add @s AnimationRotationZ 30
execute if entity @s[scores={AnimationProgress=31..40}] run scoreboard players remove @s AnimationRotationZ 30
