...
scoreboard players remove @s[scores={AnimationProgress=1..6}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=7..12}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=13..18}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=19..24}] AnimationRotationY 20
