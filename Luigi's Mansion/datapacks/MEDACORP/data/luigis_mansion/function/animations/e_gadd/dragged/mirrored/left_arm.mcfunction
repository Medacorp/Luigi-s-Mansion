...
data merge entity @s[scores={AnimationProgress=1},tag=held_item,tag=flipped_gravity] {Pose:{Head:[-35.0f,20.0f,165.01f]}}
data merge entity @s[scores={AnimationProgress=6}] {Pose:{Head:[-20.0f,0.0f,40.01f]}}
data merge entity @s[scores={AnimationProgress=6},tag=flipped_gravity] {Pose:{Head:[-20.0f,0.0f,-140.0f]}}
data merge entity @s[scores={AnimationProgress=6},tag=held_item] {Pose:{Head:[-35.0f,20.0f,-15.01f]}}
data merge entity @s[scores={AnimationProgress=6},tag=held_item,tag=flipped_gravity] {Pose:{Head:[-35.0f,20.0f,165.01f]}}
