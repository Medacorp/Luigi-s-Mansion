...
scoreboard players remove @s[scores={AnimationProgress=1..3}] AnimationRotationZ 2
scoreboard players add @s[scores={AnimationProgress=4..6}] AnimationRotationZ 2
