...
execute if entity @s[scores={AnimationProgress=31..40}] run scoreboard players remove @s AnimationRotationZ 90
execute if entity @s[scores={AnimationProgress=121..130}] run scoreboard players add @s AnimationRotationZ 90
