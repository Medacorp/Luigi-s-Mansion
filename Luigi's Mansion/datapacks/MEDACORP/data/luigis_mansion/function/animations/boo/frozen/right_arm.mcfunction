...
scoreboard players add @s[scores={AnimationProgress=1..4}] AnimationRotationZ 25
scoreboard players remove @s[scores={AnimationProgress=5..12}] AnimationRotationZ 25
scoreboard players add @s[scores={AnimationProgress=13..16}] AnimationRotationZ 25
