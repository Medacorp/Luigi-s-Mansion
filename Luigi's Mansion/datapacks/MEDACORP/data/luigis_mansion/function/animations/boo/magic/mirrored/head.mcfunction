...
scoreboard players add @s[scores={AnimationProgress=21..39}] AnimationRotationZ 40
scoreboard players add @s[scores={AnimationProgress=40..101}] AnimationRotationZ 45
