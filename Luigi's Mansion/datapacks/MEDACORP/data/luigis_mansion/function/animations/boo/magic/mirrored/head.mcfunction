...
execute if entity @s[scores={AnimationProgress=21..39}] run scoreboard players add @s AnimationRotationZ 40
execute if entity @s[scores={AnimationProgress=40..101}] run scoreboard players add @s AnimationRotationZ 45
