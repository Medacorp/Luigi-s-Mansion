...
scoreboard players remove @s[scores={AnimationProgress=1}] AnimationRotationZ 100
scoreboard players add @s[scores={AnimationProgress=2..3}] AnimationRotationZ 100
scoreboard players remove @s[scores={AnimationProgress=4}] AnimationRotationZ 100
