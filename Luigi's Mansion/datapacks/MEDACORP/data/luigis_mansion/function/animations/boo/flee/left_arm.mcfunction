...
execute if entity @s[scores={AnimationProgress=1}] run scoreboard players remove @s AnimationRotationZ 100
execute if entity @s[scores={AnimationProgress=2..3}] run scoreboard players add @s AnimationRotationZ 100
execute if entity @s[scores={AnimationProgress=4}] run scoreboard players remove @s AnimationRotationZ 100
