...
execute if entity @s[scores={AnimationProgress=21..39}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 40
execute if entity @s[scores={AnimationProgress=40..101}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 45
