...
scoreboard players add @s[scores={AnimationProgress=1..2}] AnimationRotationX 100
scoreboard players remove @s[scores={AnimationProgress=4..7}] AnimationRotationX 100
scoreboard players add @s[scores={AnimationProgress=9..10}] AnimationRotationX 100
