...
function luigis_mansion:selection_menu/game_boy_horror/show_caught_portrait_ghosts/list with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
