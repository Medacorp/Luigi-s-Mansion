...
function luigis_mansion:selection_menu/game_boy_horror/show_inventory/list with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
