...
execute if entity @s[tag=!furniture] as @e[tag=!furniture,tag=same_room,tag=!scanning_player] run function luigis_mansion:selection_menu/game_boy_horror/show_settings/debug/target_entity
