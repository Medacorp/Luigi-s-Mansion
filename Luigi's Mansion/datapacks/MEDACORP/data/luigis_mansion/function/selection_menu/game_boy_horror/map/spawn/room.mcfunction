...
execute if data storage luigis_mansion:data furniture.color run data modify entity @e[tag=this_entity,limit=1] item.components."minecraft:custom_model_data".colors[0] set from storage luigis_mansion:data furniture.color
