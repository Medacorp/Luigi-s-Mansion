...
execute as @e[tag=!furniture,tag=same_room,tag=!player] if data entity @s ArmorItems[3].components."minecraft:custom_data".scan_result run function luigis_mansion:selection_menu/game_boy_horror/scan/target_entity/root
...
execute as @e[tag=player,tag=same_room,tag=!scanning_player] run function luigis_mansion:selection_menu/game_boy_horror/scan/target_entity/root
...
execute at @s[tag=!entity_scanned] as @e[tag=furniture,tag=same_room] if data entity @s ArmorItems[3].components."minecraft:custom_data".scan_result run function luigis_mansion:selection_menu/game_boy_horror/scan/target_furniture/root
