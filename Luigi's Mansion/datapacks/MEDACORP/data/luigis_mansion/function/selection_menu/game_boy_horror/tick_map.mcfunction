...
execute unless entity @s[scores={MapZoomTime=1..}] unless entity @s[scores={Walk=0..1,Run=0..1,Sneak=0},tag=!zoom_in] unless entity @s[scores={Walk=0,Run=0,Sneak=0},tag=zoom_in] run playsound luigis_mansion:item.game_boy_horror.map.move player @s[scores={MapSound=0}] ~ ~ ~ 1
execute unless entity @s[scores={MapZoomTime=1..}] unless entity @s[scores={Walk=0..1,Run=0..1,Sneak=0},tag=!zoom_in] unless entity @s[scores={Walk=0,Run=0,Sneak=0},tag=zoom_in] run scoreboard players set @s[scores={MapSound=0}] MapSound 7
