function luigis_mansion:selection_menu/game_boy_horror/map/move_up_floor_mansion with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
