...
execute unless entity @s[scores={WarpTime=1..}] run function luigis_mansion:entities/player/run_command_as_model {command:"execute unless entity @s[nbt={data:{animation:{namespace:\"luigis_mansion\",id:\"scanning\"}}}] run function luigis_mansion:entities/luigi/animation/set/scanning"}
