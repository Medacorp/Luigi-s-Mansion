...
data modify storage luigis_mansion:data menu_options set value {no_exit:1b,options:[{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:menu/dialog/choice/luigi","minecraft:unbreakable":{show_in_tooltip:0b},"!minecraft:equippable":{},"minecraft:attribute_modifiers":{modifiers:[]},"minecraft:item_name":'{"type":"translatable","translate":"luigis_mansion:item.menu.dialog.toad_5.yes","with":[{"type":"translatable","translate":"luigis_mansion:entity.luigi"}]}',"minecraft:dyed_color":{rgb:37129,show_in_tooltip:0b},"minecraft:custom_data":{option:{id:"reload",action:"select_branch",value:"yes"}}}},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:menu/dialog/choice/bowser","minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:attribute_modifiers":{modifiers:[]},"minecraft:item_name":'{"type":"translatable","translate":"luigis_mansion:item.menu.dialog.toad_5.no"}',"minecraft:custom_data":{option:{id:"reload",action:"select_branch",value:"no"}}}}]}
data modify storage luigis_mansion:data menu_options.options[0].components."minecraft:dyed_color".rgb set from storage luigis_mansion:data my_memory.model.color
tag @s add me
