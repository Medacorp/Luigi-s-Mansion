...
function luigis_mansion:selection_menu/dialog/choice/underground_lab/save_data
function luigis_mansion:selection_menu/dialog/choice/underground_lab/back_to_title
