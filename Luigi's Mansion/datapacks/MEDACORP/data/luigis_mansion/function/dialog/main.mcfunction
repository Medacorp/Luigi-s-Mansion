...
execute if data storage luigis_mansion:data dialogs[0].room if data storage luigis_mansion:data dialogs[0].door as @e[tag=!model_piece,tag=!reflection,tag=!in_dialog,tag=!captured,tag=!capturing_ghost] run function luigis_mansion:main/get_same_room
execute unless data storage luigis_mansion:data dialogs[0].room if data storage luigis_mansion:data dialogs[0].door run tag @e[tag=!model_piece,tag=!reflection,tag=!in_dialog,tag=!captured,tag=!capturing_ghost] add same_room
execute if data storage luigis_mansion:data dialogs[0].room unless data storage luigis_mansion:data dialogs[0].door as @e[tag=!model_piece,tag=!reflection,tag=!in_dialog,tag=!captured,tag=!capturing_ghost,tag=!door_animation] run function luigis_mansion:main/get_same_room
