...
execute if score #dialog Dialog matches 52..59 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
...
execute if score #dialog Dialog matches 81 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/reset
