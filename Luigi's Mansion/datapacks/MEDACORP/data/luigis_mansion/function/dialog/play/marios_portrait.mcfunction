...
execute if score #dialog Dialog matches 1 as @a[tag=same_room] run function luigis_mansion:other/music/set/marios_portrait
execute if score #dialog Dialog matches 290 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.mario",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.marios_portrait.1"}]}
execute if score #dialog Dialog matches 420 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"nbt",source:"entity",entity:"@e[tag=observing_player,limit=1]",nbt:"data.player_name",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.marios_portrait.2"}]}
...
execute if score #dialog Dialog matches 480 run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data merge value {saw_mario:1b,saw_mario_again:1b}
