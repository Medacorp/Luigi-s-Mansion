...
execute if score #dialog Dialog matches 76 store result score #temp Time run data get storage luigis_mansion:data current_state.current_data.area
execute if score #dialog Dialog matches 76 if score #temp Time matches ..2 run data modify storage luigis_mansion:data current_state.current_data.area set value 3
