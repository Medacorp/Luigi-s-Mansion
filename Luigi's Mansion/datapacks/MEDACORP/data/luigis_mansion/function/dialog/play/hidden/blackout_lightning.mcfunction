...
execute if score #dialog Dialog matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"653.8 120.7 60 -155 -7"}
...
execute if score #dialog Dialog matches 30 run summon minecraft:lightning_bolt 695 131 28
