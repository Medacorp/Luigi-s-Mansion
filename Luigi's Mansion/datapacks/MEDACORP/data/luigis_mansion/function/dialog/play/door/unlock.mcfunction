...
execute if score #dialog Dialog matches 259 run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.used_keys append from entity @e[tag=this_door,scores={AnimationProgress=1..80},limit=1] data.key
