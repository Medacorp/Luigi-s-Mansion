...
execute if score #dialog Dialog matches 1..160 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/crawl_in_lion_head
execute if score #dialog Dialog matches 161..252 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/reach_from_lion_head
