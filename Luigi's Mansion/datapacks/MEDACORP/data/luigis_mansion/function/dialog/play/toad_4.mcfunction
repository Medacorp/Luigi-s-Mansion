...
execute if score #dialog Dialog matches 28..32 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
...
execute if score #dialog Dialog matches 54 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
