...
execute if score #dialog Dialog matches 22..299 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {execute:"at @e[tag=observatory_facing,tag=same_room]",teleport:"~ ~ ~ ~ ~-0.6"}
