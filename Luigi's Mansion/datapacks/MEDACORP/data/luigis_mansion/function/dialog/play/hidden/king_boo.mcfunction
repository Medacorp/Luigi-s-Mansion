...
execute if score #dialog Dialog matches 431..470 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s facing 635 94 33",teleport:"^ ^ ^0.3"}
