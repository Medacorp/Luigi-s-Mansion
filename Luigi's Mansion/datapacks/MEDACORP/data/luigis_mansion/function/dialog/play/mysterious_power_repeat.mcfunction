execute if score #dialog Dialog matches 78..157 run scoreboard players add #dialog Dialog 1
execute if score #dialog Dialog matches 76..77 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players add #dialog Dialog 1
execute if score #dialog Dialog matches ..75 run scoreboard players add #dialog Dialog 1
execute if score #dialog Dialog matches ..157 if entity @a[tag=same_room,tag=skip_dialog,limit=1] run scoreboard players set #dialog Dialog 158
execute if score #dialog Dialog matches 52..77 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu,tag=!using_selection_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 78.. as @a[tag=same_room,tag=dialog_menu] run function luigis_mansion:selection_menu/dialog/exit
...
execute if score #dialog Dialog matches 1..147 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
...
execute if score #dialog Dialog matches 76..78 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"~ ~ ~ facing entity @e[tag=same_room,tag=mysterious_power,limit=1] feet"}
execute if score #dialog Dialog matches 79..98 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated as @e[tag=same_room,tag=mysterious_power,limit=1] rotated ~ 0",teleport:"^0.075 ^ ^-0.05 facing entity @e[tag=same_room,tag=mysterious_power,limit=1] feet"}
execute if score #dialog Dialog matches 79..98 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated as @e[tag=same_room,tag=mysterious_power,limit=1] rotated ~ 0",teleport:"^-0.075 ^ ^-0.05 facing entity @e[tag=same_room,tag=mysterious_power,limit=1] feet"}
execute if score #dialog Dialog matches 99..158 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated as @e[tag=same_room,tag=mysterious_power,limit=1] rotated ~ 0",teleport:"^ ^ ^0.5 ~-180 0"}
...
execute if score #dialog Dialog matches 78 as @a[tag=same_room] run function luigis_mansion:other/music/set/warped_by_boos
execute if score #dialog Dialog matches 98 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.mysterious_power","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.mysterious_power.repeat.3"}]}
execute if score #dialog Dialog matches 98 at @e[tag=same_room,tag=mysterious_power,limit=1] run playsound luigis_mansion:entity.boo.complain hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 78..158 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s rotated as @e[tag=same_room,tag=mysterious_power,limit=1] unless block ^ ^ ^1 minecraft:black_concrete",teleport:"^ ^ ^1"}
execute if score #dialog Dialog matches 158 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/none
execute if score #dialog Dialog matches 158 as @a[tag=same_room] run function luigis_mansion:other/music/set/silence
execute if score #dialog Dialog matches 158 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/reset
execute if score #dialog Dialog matches 158 as @e[tag=luigi,tag=same_room] run function luigis_mansion:room/default_position_in_mansion with storage luigis_mansion:data current_state.current_data.mansion_id
execute if score #dialog Dialog matches 158 run tag @e[tag=same_room,tag=mysterious_power,limit=1] add remove_from_existence
execute if score #dialog Dialog matches 158 run scoreboard players set #dialog Dialog -1
...
execute if score #dialog Dialog matches 98.. run data modify entity @e[tag=same_room,tag=mysterious_power,limit=1] data.animation set value {namespace:"luigis_mansion",id:"hurt"}