...
execute if score #dialog Dialog matches 2..100 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s positioned ^ ^ ^15 rotated ~1 0 positioned ^ ^ ^-15",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 2..100 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s positioned ^ ^ ^15 rotated ~-1 0 positioned ^ ^ ^-15",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 101..180 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s positioned ^ ^ ^15 rotated ~1 0 positioned ^ ^ ^-15",teleport:"^0.25 ^0.05 ^-0.25 ~ ~"}
execute if score #dialog Dialog matches 101..180 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s positioned ^ ^ ^15 rotated ~-1 0 positioned ^ ^ ^-15",teleport:"^-0.25 ^0.05 ^-0.25 ~ ~"}
