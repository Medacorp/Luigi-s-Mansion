...
execute if score #dialog Dialog matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @e[tag=ghost,tag=same_room,limit=1] rotated ~ 0",teleport:"^ ^6.75 ^11 ~ -45"}
execute if score #dialog Dialog matches 1..20 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^-0.0125 ^-0.0125 rotated as @s",teleport:"^ ^ ^ ~ ~2.25"}
execute if score #dialog Dialog matches 21..40 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^ ^-0.2 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 41..60 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^-0.025 ^-0.2 rotated as @s",teleport:"^ ^ ^ ~ ~-1"}
execute if score #dialog Dialog matches 61..90 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^0.025 ^0.2 rotated as @s",teleport:"^ ^ ^ ~ ~0.5"}
execute if score #dialog Dialog matches 91..120 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 121 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @e[tag=ghost,tag=same_room,limit=1] rotated ~ 0",teleport:"^ ^12 ^6 ~ 45"}
execute if score #dialog Dialog matches 121..140 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^-0.1 ^0.04 rotated as @s",teleport:"^ ^ ^ ~ ~-0.9"}
execute if score #dialog Dialog matches 141..170 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^0.02 ^-0.1 ^0.04 rotated as @s",teleport:"^ ^ ^ ~0.33 ~-0.9"}
execute if score #dialog Dialog matches 171..180 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-0.06 ^-0.05 ^ rotated as @s",teleport:"^ ^ ^ ~-1.333 ~"}
execute if score #dialog Dialog matches 181..310 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-0.06 ^ ^ rotated as @s",teleport:"^ ^ ^ ~-1.333 ~"}
execute if score #dialog Dialog matches 311..320 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-0.06 ^ ^ rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 141..170 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-0.02 ^-0.1 ^0.04 rotated as @s",teleport:"^ ^ ^ ~-0.33 ~-0.9"}
execute if score #dialog Dialog matches 171..180 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^0.06 ^-0.05 ^ rotated as @s",teleport:"^ ^ ^ ~1.333 ~"}
execute if score #dialog Dialog matches 181..310 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^0.06 ^ ^ rotated as @s",teleport:"^ ^ ^ ~1.333 ~"}
execute if score #dialog Dialog matches 311..320 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^0.06 ^ ^ rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 331..380 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^ ^0.1 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 381..390 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^ ^0.1 rotated as @s",teleport:"^ ^ ^ ~-0.33 ~"}
execute if score #dialog Dialog matches 391..440 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^0.01528 ^0.06 ^0.06 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 381..390 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^ ^0.1 rotated as @s",teleport:"^ ^ ^ ~0.33 ~"}
execute if score #dialog Dialog matches 391..440 if score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-0.01528 ^0.06 ^0.06 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 441..470 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^ ^-0.11 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 471..480 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^-0.1 ^-0.11 rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 481..490 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^ ^-0.1 ^ rotated as @s",teleport:"^ ^ ^ ~ ~"}
execute if score #dialog Dialog matches 491..689 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"^ ^ ^ ~ ~"}
...
execute if score #dialog Dialog matches 690 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/reset
