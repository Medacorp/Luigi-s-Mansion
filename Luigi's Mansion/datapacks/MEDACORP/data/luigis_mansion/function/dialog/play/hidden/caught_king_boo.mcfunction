...
execute if score #dialog Dialog matches 29..61 as @a[tag=same_room] run function luigis_mansion:other/music/set/game_boy_horror
execute if score #dialog Dialog matches 29..32 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/game_boy_horror
...
execute if score #dialog Dialog matches 34..37 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/think
...
execute if score #dialog Dialog matches 38 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 38..57 run tag @a[tag=painting_grabbing_player,limit=1,x=636.5,y=93,z=33.5,distance=0.2..] add walking
execute if score #dialog Dialog matches 38..57 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 33 run teleport @s[x=636.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.1 ~ ~

execute if score #dialog Dialog matches 58..62 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/think
...
execute if score #dialog Dialog matches 83 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/nod

execute if score #dialog Dialog matches 103 as @a[tag=same_room] at @s run playsound luigis_mansion:music.recover_marios_painting music @s ~ ~ ~ 1000
execute if score #dialog Dialog matches 103 run scoreboard players set @a[tag=same_room] Music 260
execute if score #dialog Dialog matches 103..182 run tag @a[tag=same_room,x=636.5,y=93,z=33.5,distance=0.2..] add walking
execute if score #dialog Dialog matches 103..182 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 33 run teleport @s[x=636.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.05 ~ ~
execute if score #dialog Dialog matches 182..183 as @a[tag=painting_grabbing_player,limit=1] at @s run teleport @s 636 93 33 90 0
execute if score #dialog Dialog matches 183 as @a[tag=painting_grabbing_player,limit=1] run function luigis_mansion:entities/player/animation/set/grab_marios_painting
execute if score #dialog Dialog matches 183 run tag @e[tag=same_room,tag=mario,tag=calm,limit=1] add remove_from_existence
execute if score #dialog Dialog matches 303..362 as @a[tag=same_room] at @s facing 653 93 33 run teleport @s ~ ~ ~ ~ ~
execute if score #dialog Dialog matches 304 as @a[tag=painting_grabbing_player,limit=1] run function luigis_mansion:entities/player/animation/set/leave_with_marios_painting
execute if score #dialog Dialog matches 304..362 run tag @a[tag=same_room,tag=!painting_grabbing_player,x=653.5,y=93,z=33.5,distance=0.2..] add walking
execute if score #dialog Dialog matches 304..362 as @a[tag=same_room,tag=!painting_grabbing_player] at @s facing 653 93 33 run teleport @s[x=653.5,y=93,z=33.5,distance=0.2..] ^ ^ ^0.1 ~ ~
execute if score #dialog Dialog matches 363 run function luigis_mansion:room/hidden/end
