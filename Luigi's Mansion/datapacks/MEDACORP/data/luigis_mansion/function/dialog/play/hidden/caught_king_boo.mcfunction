...
execute if score #dialog Dialog matches 38..57 as @e[tag=painting_grabbing_player,limit=1] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s[x=636.5,y=93,z=33.5,distance=0.2..] facing 636 93 33",teleport:"^ ^ ^0.1 ~ ~"}
...
execute if score #dialog Dialog matches 103..182 as @e[tag=painting_grabbing_player,limit=1] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s[x=636.5,y=93,z=33.5,distance=0.2..] facing 636 93 33",teleport:"^ ^ ^0.05 ~ ~"}
execute if score #dialog Dialog matches 183 as @e[tag=painting_grabbing_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"@s 636 93 33 90 0"}
...
execute if score #dialog Dialog matches 303..362 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s facing 653 93 33",teleport:"~ ~ ~ ~ ~"}
...
execute if score #dialog Dialog matches 304..362 as @e[tag=luigi,tag=same_room,tag=!painting_grabbing_player] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s[x=653.5,y=93,z=33.5,distance=0.2..] facing 653 93 33",teleport:"^ ^ ^0.1 ~ ~"}
