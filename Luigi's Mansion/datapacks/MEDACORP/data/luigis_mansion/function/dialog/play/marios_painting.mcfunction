...
execute if score #dialog Dialog matches 1..400 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/crawl_in_lion_head
execute if score #dialog Dialog matches 401..479 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/reach_from_lion_head
