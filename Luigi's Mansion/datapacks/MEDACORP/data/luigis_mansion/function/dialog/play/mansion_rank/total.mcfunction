...
data merge entity @e[tag=mansion_rank_end,limit=1] {text:{type:"translatable",translate:"luigis_mansion:dialog.mansion_rank.total.no_money"},background:-1728053248,transformation:{scale:[0.25f,0.25f,0.25f]}}
