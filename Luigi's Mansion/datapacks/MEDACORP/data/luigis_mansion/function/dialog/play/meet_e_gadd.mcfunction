...
execute if score #dialog Dialog matches 72 positioned 725 20 34.9 run function luigis_mansion:spawn_entities/ghost/gold_ghost
...
execute if score #dialog Dialog matches 150 run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.poltergust set value {id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:damage":1,"minecraft:custom_model_data":0,"minecraft:item_name":'{"type":"translatable","translate":"luigis_mansion:item.poltergust_3000"}',"minecraft:lore":['{"italic":false,"color":"gray","type":"translatable","translate":"luigis_mansion:item.poltergust_3000.element","with":[{"type":"translatable","translate":"luigis_mansion:item.poltergust_3000.element.none","color":"gray"}]}'],"minecraft:custom_data":{namespace:"luigis_mansion",id:"poltergust_3000",is_poltergust:1b,is_nozzle:1b,model:{body_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":0,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":1}}}}},body_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":1,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":0}}}}},sat_on_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":2,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":3}}}}},sat_on_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":3,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":2}}}}},idle_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":4,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":5}}}}},idle_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":5,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":4}}}}}},sync_element:1b,kill:1b}}}
...
execute if score #dialog Dialog matches 220 as @e[tag=ghost,tag=same_room,limit=1] at @s run playsound luigis_mansion:entity.gold_ghost.cutscene_flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 431 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.attack hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 451 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.laugh hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 491 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.disappear hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 580 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.1"}]}
...
execute if score #dialog Dialog matches 649 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.2"}]}
...
execute if score #dialog Dialog matches 765 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.3"}]}
...
execute if score #dialog Dialog matches 860 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.4"}]}
execute if score #dialog Dialog matches 860 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.4.more"}]}
...
execute if score #dialog Dialog matches 946 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.5"}]}
...
execute if score #dialog Dialog matches 1199 positioned 718 20 26 run function luigis_mansion:spawn_entities/ghost/gold_ghost
execute if score #dialog Dialog matches 1199 run playsound luigis_mansion:entity.gold_ghost.spawn_beta hostile @a[tag=same_room] 718 20 26 1
...
execute if score #dialog Dialog matches 1212 positioned 720 20 27 run function luigis_mansion:spawn_entities/ghost/gold_ghost
execute if score #dialog Dialog matches 1212 run playsound luigis_mansion:entity.gold_ghost.spawn_beta hostile @a[tag=same_room] 720 20 27 1
...
execute if score #dialog Dialog matches 1252 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1272 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1312 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1332 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1262 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.7"}]}
...
execute if score #dialog Dialog matches 1319 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.8"}]}
execute if score #dialog Dialog matches 1319 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.meet_e_gadd.8.more"}]}
