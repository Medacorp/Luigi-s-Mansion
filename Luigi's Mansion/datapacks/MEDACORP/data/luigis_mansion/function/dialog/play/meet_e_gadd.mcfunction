...
execute if score #dialog Dialog matches 1 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"724 20 28.0 -85 0"}
execute if score #dialog Dialog matches 2..80 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"724.65 20 ~0.00625 ~0.25 0"}
execute if score #dialog Dialog matches 81..105 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"724.65 20 28 -65 0"}
...
execute if score #dialog Dialog matches 106 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"726.8 19.4 26.8 12 -12"}
execute if score #dialog Dialog matches 106..150 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~0.0066 19.4 ~-0.0266 ~-0.188 ~0.222"}
execute if score #dialog Dialog matches 151..160 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.1 19.4 25.6 3.5 -2"}
execute if score #dialog Dialog matches 161..180 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.1 19.4 25.6 ~0.825 ~-1"}
execute if score #dialog Dialog matches 181..185 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.1 19.4 25.6 20 -22"}
execute if score #dialog Dialog matches 196..220 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.1 19.4 25.6 ~1.36 ~0.72"}
execute if score #dialog Dialog matches 221..239 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.1 19.4 25.6 54 -4"}
execute if score #dialog Dialog matches 240 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"720 21 22 -22 5"}
execute if score #dialog Dialog matches 241..280 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.025 ~0.00125 22 ~0.4 ~0.75"}
execute if score #dialog Dialog matches 281..284 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"719 21.5 22 -6 35"}
execute if score #dialog Dialog matches 285 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"722 22 30.0 80 15"}
execute if score #dialog Dialog matches 286..360 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"722 22 30.0 ~-0.714 ~0.0571"}
execute if score #dialog Dialog matches 361 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 31.7 50 -5"}
execute if score #dialog Dialog matches 361..380 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 ~-0.025 50 ~0.25"}
execute if score #dialog Dialog matches 381 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 31.3 50 0"}
execute if score #dialog Dialog matches 381..420 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 ~-0.0875 ~1.375 ~-0.075"}
execute if score #dialog Dialog matches 421..440 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 27.8 105 -3"}
execute if score #dialog Dialog matches 441..479 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727 19.3 27.8 ~0.975 ~0.05"}
execute if score #dialog Dialog matches 480..539 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"723.0 19.5 26 90 -10"}
execute if score #dialog Dialog matches 540..545 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"723.0 20 21 -28.5 5"}
execute if score #dialog Dialog matches 546..560 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~0.033 ~ 21 ~-0.22 ~0.33"}
execute if score #dialog Dialog matches 561..620 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~0.025 ~ ~0.066 ~-0.22 ~0.33"}
...
execute if score #dialog Dialog matches 546..620 if score #dialog2 Dialog matches 0..2 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~ ~0.025 ~"}
execute if score #dialog Dialog matches 546..620 if score #dialog2 Dialog matches 3..4 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~ ~-0.025 ~"}
execute if score #dialog Dialog matches 546..620 run scoreboard players reset #dialog2 Dialog
execute if score #dialog Dialog matches 621..740 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"725.0 20 25 -45 30"}
execute if score #dialog Dialog matches 741..960 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"723.0 20 26.0 -100 7"}
execute if score #dialog Dialog matches 961 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"724.0 20 30.0 13 -7"}
execute if score #dialog Dialog matches 961..1160 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.0175 20 ~-0.0175 ~0.335 ~-0.015"}
execute if score #dialog Dialog matches 1161..1300 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"720 20 26 80 -10"}
execute if score #dialog Dialog matches 1301.. as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"727.75 20 25.5 80 10"}
...
execute if score #dialog Dialog matches 240 as @e[tag=ghost,tag=same_room,limit=1] at @s run playsound luigis_mansion:entity.gold_ghost.cutscene_flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 260 as @e[tag=ghost,tag=same_room,limit=1] at @s run playsound luigis_mansion:entity.gold_ghost.cutscene_flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 330 as @e[tag=ghost,tag=same_room,limit=1] at @s run playsound luigis_mansion:entity.gold_ghost.cutscene_pull hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 350 as @e[tag=ghost,tag=same_room,limit=1] at @s run playsound luigis_mansion:entity.gold_ghost.cutscene_pull hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 440 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.attack hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 460 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.laugh hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 500 at @e[tag=ghost,tag=same_room,limit=1] run playsound luigis_mansion:entity.gold_ghost.disappear hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 620 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.1"}]}
...
execute if score #dialog Dialog matches 650 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.2"}]}
...
execute if score #dialog Dialog matches 750 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.3"}]}
...
execute if score #dialog Dialog matches 855 if score #players Totals matches 1 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.4"}]}
execute if score #dialog Dialog matches 855 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.4.more"}]}
...
execute if score #dialog Dialog matches 955 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.5"}]}
...
execute if score #dialog Dialog matches 1055 if score #players Totals matches 1 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.6"}]}
execute if score #dialog Dialog matches 1055 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.6.more"}]}
...
execute if score #dialog Dialog matches 1260 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1270 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1 1.1
execute if score #dialog Dialog matches 1300 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1325 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 1335 as @e[tag=ghost,tag=same_room] at @s run playsound luigis_mansion:entity.gold_ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1 1.1
execute if score #dialog Dialog matches 1260 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.7"}]}
...
execute if score #dialog Dialog matches 1320 if score #players Totals matches 1 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.8"}]}
execute if score #dialog Dialog matches 1320 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.meet_e_gadd.8.more"}]}
...
execute if score #dialog Dialog matches 1341..1360 run scoreboard players set @a[tag=walking_player,limit=1] Walk 1
