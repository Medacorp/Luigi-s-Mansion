...
execute if score #dialog Dialog matches 96 if data storage luigis_mansion:data current_state.luigis_mansion.rooms.ghost_portrificationizer_room{cleared:1b} run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"ghost_portrificationizer_room/return"},room:-3,progress:-1}
execute if score #dialog Dialog matches 96 if data storage luigis_mansion:data current_state.luigis_mansion.rooms.ghost_portrificationizer_room{cleared:0b} run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"ghost_portrificationizer_room/talk"},room:-3,progress:-1}
