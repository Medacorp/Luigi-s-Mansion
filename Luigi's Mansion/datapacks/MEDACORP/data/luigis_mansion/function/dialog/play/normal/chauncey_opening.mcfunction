...
execute if score #dialog Dialog matches 400 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/move/teleport {teleport:"805.0 18 64.0 135 0"}
