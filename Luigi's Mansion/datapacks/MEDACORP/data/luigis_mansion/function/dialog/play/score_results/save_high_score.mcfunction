...
execute if data storage luigis_mansion:data current_state.luigis_mansion.high_scores[0] run function luigis_mansion:dialog/play/score_results/get_high_score with storage luigis_mansion:data current_state.luigis_mansion.current_data
data modify storage luigis_mansion:data current_high_score.data_index set from storage luigis_mansion:data current_state.luigis_mansion.current_data.data_index
...
data modify storage luigis_mansion:data current_state.luigis_mansion.high_scores append from storage luigis_mansion:data current_high_score
