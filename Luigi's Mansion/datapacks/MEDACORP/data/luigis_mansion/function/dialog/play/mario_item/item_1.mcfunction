...
execute if score #dialog Dialog matches ..74 unless score #dialog Dialog matches 27..46 unless score #dialog Dialog matches 51..70 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu,tag=!using_selection_menu] run function luigis_mansion:selection_menu/dialog/original_menu
...
execute if score #dialog Dialog matches 21..46 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
...
execute if score #dialog Dialog matches 26 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run playsound luigis_mansion:entity.madame_clairvoya.spirits hostile @a[tag=same_room] ~ ~ ~ 1000
...
execute if score #dialog Dialog matches 47..50 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/high_health_idle_no_sound
...
execute if score #dialog Dialog matches 51..70 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
...
execute if score #dialog Dialog matches 71..74 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/think
...
execute if score #dialog Dialog matches 75 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/reset
