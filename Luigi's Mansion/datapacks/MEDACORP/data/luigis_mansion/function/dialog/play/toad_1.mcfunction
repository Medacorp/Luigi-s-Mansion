...
execute if score #dialog Dialog matches 1..4 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
...
execute if score #dialog Dialog matches 24..27 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
...
#Branch: Yes
execute if score #dialog Dialog matches 29 as @a[tag=same_room] run function luigis_mansion:entities/luigi/animation/set/enthusiastic
...
execute if score #dialog Dialog matches 97 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
