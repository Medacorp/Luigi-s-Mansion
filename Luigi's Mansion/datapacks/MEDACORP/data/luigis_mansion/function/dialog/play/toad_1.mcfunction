...
execute if score #dialog Dialog matches 1..4 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 4 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches 24..27 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 28 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/think

#Branch: Yes
execute if score #dialog Dialog matches 29 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/enthusiastic
...
execute if score #dialog Dialog matches 49 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 77 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches 97 as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/idle
