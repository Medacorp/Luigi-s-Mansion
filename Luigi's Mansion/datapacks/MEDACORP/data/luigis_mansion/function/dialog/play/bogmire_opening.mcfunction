...
execute if score #dialog Dialog matches 1 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/scare/bash_no_move
execute if score #dialog Dialog matches 1..40 run scoreboard players set @e[tag=luigi_model,tag=same_room] AnimationProgress 29
...
execute if score #dialog Dialog matches 219 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/none
...
execute if score #dialog Dialog matches 240..379 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/scare/staredown
...
execute if score #dialog Dialog matches 140 run summon minecraft:lightning_bolt ~ ~ ~
