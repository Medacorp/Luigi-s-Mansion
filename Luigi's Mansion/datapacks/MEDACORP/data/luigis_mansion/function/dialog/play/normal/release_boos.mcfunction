...
execute if score #dialog Dialog matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -50.0 0 0"}
...
execute if score #dialog Dialog matches 81..100 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -48 0 25"}
...
execute if score #dialog Dialog matches 121..160 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -50.0 0 -10"}
execute if score #dialog Dialog matches 161 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"686.6 11 -41.8 160 14"}
...
execute if score #dialog Dialog matches 201 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"688.3 10.5 -48.7 44 0"}
...
execute if score #dialog Dialog matches 261 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 11.3 -60.7 -2 0"}
execute if score #dialog Dialog matches 261..320 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 ~0.0133 -60.7 -2 0"}
execute if score #dialog Dialog matches 321 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"687.0 11.5 -54.2 10 0"}
