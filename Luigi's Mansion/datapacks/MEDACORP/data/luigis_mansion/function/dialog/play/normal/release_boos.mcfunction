...
execute if score #dialog Dialog matches 1 as @e[tag=luigi,tag=same_room] at @s facing 685 11 -46 rotated ~ 0 run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~ ~ ~"}
...
execute if score #dialog Dialog matches 1 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -50.0 0 0"}
...
execute if score #dialog Dialog matches 81..100 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -48 0 25"}
...
execute if score #dialog Dialog matches 121..160 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 -50.0 0 -10"}
execute if score #dialog Dialog matches 161 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"686.6 11 -41.8 160 14"}
...
execute if score #dialog Dialog matches 201 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"688.3 10.5 -48.7 44 0"}
...
execute if score #dialog Dialog matches 261 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 11.3 -60.7 -2 0"}
execute if score #dialog Dialog matches 261..320 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 ~0.0133 -60.7 -2 0"}
execute if score #dialog Dialog matches 321 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"687.0 11.5 -54.2 10 0"}
...
execute if score #dialog Dialog matches 100.. positioned 685 10 -46 rotated -180 -90 run function luigis_mansion:dialog/play/release_boos_spawn
...
execute if score #dialog Dialog matches 100 as @e[tag=luigi,tag=same_room] positioned 685 11 -46 run function luigis_mansion:entities/luigi/animation/set/scare/bash_no_move
