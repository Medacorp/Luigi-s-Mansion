...
execute if score #dialog Dialog matches 3 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{released_boos:1b} as @a[tag=same_room,tag=dialog_menu] run function luigis_mansion:selection_menu/dialog/exit
...
execute if score #dialog Dialog matches 3 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{released_boos:1b} run scoreboard players set #dialog Dialog -1
