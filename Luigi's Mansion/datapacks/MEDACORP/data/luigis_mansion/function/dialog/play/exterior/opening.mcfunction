...
execute if score #dialog Dialog matches 1 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"870 89.9375 -4 160 0"}
...
execute if score #dialog Dialog matches 1..230 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.1"}
...
execute if score #dialog Dialog matches 231 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"829.8 89.9375 10 90 0"}
...
execute if score #dialog Dialog matches 459 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"767 89.9375 8.0 90 0"}
execute if score #dialog Dialog matches 459..672 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
...
execute if score #dialog Dialog matches 673 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"727 101 8.0 90 0"}
execute if score #dialog Dialog matches 673..729 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
execute if score #dialog Dialog matches 679 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 699 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
...
execute if score #dialog Dialog matches 730 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"727 101 8.0 90 0"}
...
execute if score #dialog Dialog matches 844 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"721 102 8 135 0"}
...
execute if score #dialog Dialog matches 864..883 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~-0.025"}
