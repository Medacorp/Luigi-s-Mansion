...
execute if score #dialog Dialog matches 1..3 as @e[tag=luigi,tag=scanning_player,limit=1] run function luigis_mansion:entities/luigi/animation/set/scanning
