...
execute if score #dialog Dialog matches 1 as @e[tag=scanned_entity,scores={Dialog=..50},limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@s",color:"green"},{type:"translatable",translate:"luigis_mansion:message.chauncey.scan.1"}]}
execute if score #dialog Dialog matches 1 as @e[tag=scanned_entity,scores={Dialog=51..},limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@s",color:"green"},{type:"translatable",translate:"luigis_mansion:message.chauncey.scan.2"}]}
