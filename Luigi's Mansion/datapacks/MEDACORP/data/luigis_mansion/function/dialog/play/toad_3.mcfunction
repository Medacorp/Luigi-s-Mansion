...
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.washroom_1{cleared:1b} run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"toad_1_repeat"},room:0,progress:0}
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.washroom_1{cleared:1b} run data modify storage luigis_mansion:data dialogs[-1].room set from storage luigis_mansion:data dialogs[0].room
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.washroom_1{cleared:1b} run scoreboard players set #dialog Dialog -1
...
#Branch: Yes
execute if score #dialog Dialog matches 4 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/enthusiastic
...
execute if score #dialog Dialog matches 24..46 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
...
execute if score #dialog Dialog matches 27 as @e[tag=toad,tag=same_room,limit=1] run function luigis_mansion:room/clear_room_mansion with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
execute if score #dialog Dialog matches 67 run scoreboard players set #dialog Dialog -1

#Branch: No
execute if score #dialog Dialog matches 68 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/nod
...
execute if score #dialog Dialog matches 88 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle_no_poltergust
