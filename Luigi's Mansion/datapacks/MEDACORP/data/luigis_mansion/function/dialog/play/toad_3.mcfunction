...
execute if score #dialog Dialog matches 24..46 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
...
execute if score #dialog Dialog matches 88 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
