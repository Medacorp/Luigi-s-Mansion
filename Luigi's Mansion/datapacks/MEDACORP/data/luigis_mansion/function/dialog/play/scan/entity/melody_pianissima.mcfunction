...
execute if score #dialog Dialog matches 1..2 as @e[tag=luigi,tag=scanning_player,limit=1] run function luigis_mansion:entities/luigi/animation/set/scanning
...
execute if score #dialog Dialog matches 1 if score #conservatory Wave matches ..3 if score #players Totals matches 1 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@e[tag=scanned_entity,limit=1]",color:"green"},{type:"translatable",translate:"luigis_mansion:message.melody_pianissima.scan.1"}]}
execute if score #dialog Dialog matches 1 if score #conservatory Wave matches ..3 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@e[tag=scanned_entity,limit=1]",color:"green"},{type:"translatable",translate:"luigis_mansion:message.melody_pianissima.scan.1.more"}]}
execute if score #dialog Dialog matches 1 unless score #conservatory Wave matches ..3 if score #players Totals matches 1 run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@e[tag=scanned_entity,limit=1]",color:"green"},{type:"translatable",translate:"luigis_mansion:message.melody_pianissima.scan.2"}]}
execute if score #dialog Dialog matches 1 unless score #conservatory Wave matches ..3 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@e[tag=scanned_entity,limit=1]",color:"green"},{type:"translatable",translate:"luigis_mansion:message.melody_pianissima.scan.2.more"}]}
