...
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.obtained_items{marios_glove:1b} unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_glove:1b} run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"mario_item/glove"},progress:0,variant:1,clairvoya:1b}
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.obtained_items{marios_shoe:1b} unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_shoe:1b} unless data storage luigis_mansion:data dialogs[-1].clairvoya run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"mario_item/shoe"},progress:0,variant:1,clairvoya:1b}
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.obtained_items{marios_letter:1b} unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_letter:1b} unless data storage luigis_mansion:data dialogs[-1].clairvoya run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"mario_item/letter"},progress:0,variant:1,clairvoya:1b}
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.obtained_items{marios_star:1b} unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_star:1b} unless data storage luigis_mansion:data dialogs[-1].clairvoya run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"mario_item/star"},progress:0,variant:1,clairvoya:1b}
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.obtained_items{marios_hat:1b} unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_hat:1b} unless data storage luigis_mansion:data dialogs[-1].clairvoya run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"mario_item/hat"},progress:0,variant:1,clairvoya:1b}
execute if score #dialog Dialog matches 1 run scoreboard players set #temp Time 1
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_glove:1b} run scoreboard players add #temp Time 1
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_shoe:1b} run scoreboard players add #temp Time 1
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_letter:1b} run scoreboard players add #temp Time 1
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_star:1b} run scoreboard players add #temp Time 1
execute if score #dialog Dialog matches 1 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shown_marios_hat:1b} run scoreboard players add #temp Time 1
