...
execute if score #dialog Dialog matches 1 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"781 89.9375 8.0 90 0"}
...
execute if score #dialog Dialog matches 1..124 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
