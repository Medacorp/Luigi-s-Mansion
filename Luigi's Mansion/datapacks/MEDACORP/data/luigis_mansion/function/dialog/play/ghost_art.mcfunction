...
execute if score #dialog Dialog matches 1..99 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s facing entity @e[tag=scanned_entity,limit=1] feet rotated ~ 0 positioned as @e[tag=scanned_entity,limit=1]",teleport:"^ ^ ^-3.5 ~ ~"}
