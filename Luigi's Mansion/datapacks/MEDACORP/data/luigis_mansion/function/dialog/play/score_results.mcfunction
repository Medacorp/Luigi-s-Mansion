...
execute if score #dialog Dialog matches 251 if data storage luigis_mansion:data dialogs[0].ending as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] unless entity @s[tag=using_selection_menu,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/choice/save_ending
execute if score #dialog Dialog matches 251 unless data storage luigis_mansion:data dialogs[0].ending as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] unless entity @s[tag=using_selection_menu,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/choice/save
