...
execute as @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"item"}}},tag=!model_piece,tag=same_room] run function luigis_mansion:dialog/play/collect_item_freeze/not_frozen_item with entity @s data.item
