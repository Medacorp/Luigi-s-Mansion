...
execute if score #dialog Dialog matches 140 as @e[tag=luigi,tag=same_room] positioned 685 10 61 run function luigis_mansion:entities/luigi/animation/set/scare/bash_no_move
