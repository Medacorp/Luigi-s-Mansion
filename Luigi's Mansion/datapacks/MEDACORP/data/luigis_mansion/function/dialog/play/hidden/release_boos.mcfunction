...
execute if score #dialog Dialog matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 66.0 -180 0"}
execute if score #dialog Dialog matches 1..40 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 ~-0.0125 -180 0"}
execute if score #dialog Dialog matches 41..80 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 ~-0.025 -180 ~0.625"}
execute if score #dialog Dialog matches 81..100 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 63 -180 25"}
execute if score #dialog Dialog matches 101..120 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 ~0.075 -180 ~-1.75"}
execute if score #dialog Dialog matches 121..160 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"685 11 66.0 -180 -10"}
execute if score #dialog Dialog matches 161 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"686.6 11 57.8 20 14"}
...
execute if score #dialog Dialog matches 201 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"688.3 10.5 64.7 136 0"}
execute if score #dialog Dialog matches 201..260 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"~0.0133 10.5 ~-0.0216 136 0"}
execute if score #dialog Dialog matches 261 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 11.3 76.7 -178 0"}
execute if score #dialog Dialog matches 261..320 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"689.2 ~0.0133 76.7 -178 0"}
execute if score #dialog Dialog matches 321 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"687.0 11.5 70.2 170 0"}
execute if score #dialog Dialog matches 321..440 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.00416 11.5 ~0.01166 170 0"}
