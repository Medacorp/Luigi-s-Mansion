...
summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.haunted_music_sheet"},Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/haunted_music_sheet"}}},Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","haunted_music_sheet_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
