...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.spark"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:custom_model_data":105,"minecraft:custom_data":{invisible:"minecraft:stone_button",visible:"minecraft:diamond_pickaxe",model_data:{default:{components:{"minecraft:custom_model_data":105}},danger:{components:{"minecraft:custom_model_data":106}}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","spark_model","found_owner","this_entity"],DisabledSlots:2039583}
