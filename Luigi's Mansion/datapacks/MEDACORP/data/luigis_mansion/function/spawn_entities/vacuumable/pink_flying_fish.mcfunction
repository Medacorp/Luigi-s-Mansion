...
summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.pink_flying_fish"},item:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/flying_fish","minecraft:custom_model_data":{flags:[1b],colors:[16740863]}}},item_display:"head",Tags:["model_piece","flying_fish_model","found_owner","this_entity"],brightness:{block:15,sky:15}}
