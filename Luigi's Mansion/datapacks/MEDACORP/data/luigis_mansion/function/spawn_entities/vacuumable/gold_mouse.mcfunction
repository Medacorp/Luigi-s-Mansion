...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.gold_mouse"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:custom_model_data":13,"minecraft:custom_data":{invisible:"minecraft:stone_button",visible:"minecraft:leather_chestplate"},"minecraft:dyed_color":{rgb:16759040}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","mouse_model","found_owner","this_entity"],DisabledSlots:2039583}
