...
summon minecraft:item_display ~ ~0.3 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.haunted_vase"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/haunted_vase","minecraft:custom_model_data":{strings:["gray"]}}},item_display:"head",Tags:["model_piece","haunted_object_model","found_owner","this_entity"]}
...
execute as @e[tag=this_entity,limit=1] store result score @s Move run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.haunted_vase.speed
data modify entity @e[tag=this_entity,limit=1] data.loot_storage set from storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.haunted_vase.loot
data modify entity @e[tag=this_entity,limit=1] data.damage set from storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.haunted_vase.damage
