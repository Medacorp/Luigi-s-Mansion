summon minecraft:marker ~ ~0.3 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.haunted_jar"}',Tags:["affected_by_vacuum","affected_by_dust","affected_by_fire","affected_by_water","affected_by_ice","pulled_by_vacuum","hurt_by_fire","hurt_by_water","hurt_by_ice","ghost","vacuumable","haunted_jar","optional_ghost","no_remove_on_non_ticking","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"haunted_object"},flying_animation:{namespace:"luigis_mansion",id:"spin_pitch"},shake_sound:{namespace:"luigis_mansion",id:"ceramic"}}}
summon minecraft:armor_stand ~ ~0.3 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.haunted_jar"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/haunted_jar","minecraft:unbreakable":{},"minecraft:custom_model_data":1}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","haunted_object_model","found_owner","this_entity"],DisabledSlots:2039583}
