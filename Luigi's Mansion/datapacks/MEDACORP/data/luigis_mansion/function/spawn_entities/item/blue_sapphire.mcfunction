summon minecraft:item_display ~ ~0.35 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:item.blue_sapphire"},data:{entity:{namespace:"luigis_mansion",id:"item"},physics:{namespace:"luigis_mansion",id:"generic"},item:{namespace:"luigis_mansion",id:"blue_sapphire"},physics_offset:0.35d,pick_up_range:0.7f,particle:{chance:1,name:"minecraft:crit"}},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/blue_sapphire","minecraft:custom_model_data":{flags:[0b]}}},Tags:["item","affected_by_vacuum","same_room_players_only","this_entity"]}
