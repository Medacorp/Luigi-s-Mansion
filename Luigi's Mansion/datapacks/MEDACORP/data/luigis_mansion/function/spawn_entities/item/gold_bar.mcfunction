summon minecraft:armor_stand ~ ~-1.1 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.gold_bar"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"item"},physics:{namespace:"luigis_mansion",id:"generic"},item:{namespace:"luigis_mansion",id:"gold_bar"},physics_offset:1.1d,pick_up_range:0.7f,particle:{chance:1,name:"minecraft:crit"}},"minecraft:unbreakable":{},"minecraft:item_model":"luigis_mansion:entity/gold_bar","minecraft:custom_model_data":{flags:[B;0b]}}}],Tags:["item","affected_by_vacuum","same_room_players_only","this_entity"],DisabledSlots:2039583}
