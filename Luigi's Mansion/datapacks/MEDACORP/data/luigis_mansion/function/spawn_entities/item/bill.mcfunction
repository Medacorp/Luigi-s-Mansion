summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.bill"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"item"},physics:{namespace:"luigis_mansion",id:"paper"},item:{namespace:"luigis_mansion",id:"bill"},physics_offset:1.3d,pick_up_range:0.7f},"minecraft:unbreakable":{},"minecraft:damage":5,"minecraft:custom_model_data":10}}],Tags:["item","no_capture_sound","affected_by_vacuum","same_room_players_only","this_entity"],DisabledSlots:2039583}
execute if predicate luigis_mansion:50_50 run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data" set value 11
...
execute if data storage luigis_mansion:data entity{variant:0b} run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data" set value 10
execute if data storage luigis_mansion:data entity{variant:1b} run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data" set value 11
