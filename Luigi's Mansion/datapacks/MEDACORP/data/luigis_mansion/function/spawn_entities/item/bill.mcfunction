...
execute if predicate luigis_mansion:item/gold_bill_chance run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "gold"
...
execute if data storage luigis_mansion:data entity{variant:0b} run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "green"
execute if data storage luigis_mansion:data entity{variant:1b} run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "gold"
