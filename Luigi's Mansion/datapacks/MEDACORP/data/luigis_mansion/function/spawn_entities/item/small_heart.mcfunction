execute unless data storage luigis_mansion:data entity.type run function luigis_mansion:items/money/get_count/select with storage luigis_mansion:data current_state.luigis_mansion.current_data.drop_item_on_damage
