...
execute as @e[tag=head,tag=model_piece] if score #temp ID = @s ID run data modify entity @e[tag=this_entity,limit=1] equipment.head.components."minecraft:custom_model_data".colors[0] set from entity @s equipment.head.components."minecraft:custom_model_data".colors[0]
execute as @e[tag=head,tag=model_piece] if score #temp ID = @s ID run data modify entity @e[tag=this_entity,limit=1] equipment.head.components."minecraft:custom_model_data".flags[1] set from entity @s equipment.head.components."minecraft:custom_model_data".flags[1]
