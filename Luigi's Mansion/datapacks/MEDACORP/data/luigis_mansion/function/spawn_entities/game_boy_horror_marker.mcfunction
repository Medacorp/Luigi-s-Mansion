summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.luigi"},Tags:["game_boy_horror_marker","no_reflection","same_room_players_only","this_entity"],CustomNameVisible:1b,data:{entity:{namespace:"luigis_mansion",id:"game_boy_horror_marker"}},item:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/luigi","minecraft:custom_model_data":{flags:[0b,0b],floats:[0f],strings:["default"],colors:[37129]}}},item_display:"head"}
