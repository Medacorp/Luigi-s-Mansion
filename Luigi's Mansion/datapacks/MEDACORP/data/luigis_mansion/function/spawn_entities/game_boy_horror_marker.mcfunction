summon minecraft:armor_stand ~ ~ ~ {NoGravity:1b,Marker:0b,Invisible:1b,CustomName:'{"type":"translatable","translate":"entity.minecraft.player"}',Tags:["game_boy_horror_marker","no_reflection","same_room_players_only","new"],CustomNameVisible:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/luigi","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":7,"minecraft:custom_model_data":0,"minecraft:dyed_color":{rgb:37129},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"game_boy_horror_marker"}}}}],DisabledSlots:2039583}
