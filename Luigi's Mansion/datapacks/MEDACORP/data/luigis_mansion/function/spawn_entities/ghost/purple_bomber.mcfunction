...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.purple_bomber"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":4,"minecraft:custom_data":{visible:"luigis_mansion:entity/ceiling_ghost",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ceiling_ghost"}}},"minecraft:dyed_color":{rgb:12255436}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ceiling_ghost_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.purple_bomber"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":2,"minecraft:max_damage":4,"minecraft:custom_data":{visible:"luigis_mansion:entity/ceiling_ghost",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ceiling_ghost","minecraft:damage":3}}},"minecraft:dyed_color":{rgb:12255436}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ceiling_ghost_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.purple_bomber"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":3,"minecraft:max_damage":4,"minecraft:custom_data":{visible:"luigis_mansion:entity/ceiling_ghost",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ceiling_ghost","minecraft:damage":2}}},"minecraft:dyed_color":{rgb:12255436}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ceiling_ghost_model","found_owner","left_arm","this_entity"],DisabledSlots:2039583}
...
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.purple_bomber{flee_task:"circle"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 2
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.purple_bomber{flee_task:"random_in_range"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 3
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.purple_bomber{flee_task:"loops"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 4
