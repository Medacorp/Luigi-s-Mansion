...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shining_ghost"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/shining_ghost","minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16771072}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","shining_ghost_model","found_owner","vacuumable","this_entity"],DisabledSlots:2039583}
