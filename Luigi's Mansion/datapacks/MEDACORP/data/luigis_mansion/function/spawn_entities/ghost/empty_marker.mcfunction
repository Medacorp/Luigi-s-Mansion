summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.unknown"}',Tags:["hidden","new_ghost","ghost","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"empty_ghost_marker"}}}
