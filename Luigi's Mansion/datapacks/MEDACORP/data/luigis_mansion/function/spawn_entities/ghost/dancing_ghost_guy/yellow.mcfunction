...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ghost_guy"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{visible:"luigis_mansion:entity/ghost_guy",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ghost_guy"}},model_data:{default:{components:{"minecraft:custom_model_data":0}},equipment:{components:{"minecraft:custom_model_data":2}}}},"minecraft:dyed_color":{rgb:16769024}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ghost_guy_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ghost_guy"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":2,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{visible:"luigis_mansion:entity/ghost_guy",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ghost_guy","minecraft:damage":3}},model_data:{default:{components:{"minecraft:custom_model_data":0}},equipment:{components:{"minecraft:custom_model_data":1}}}},"minecraft:dyed_color":{rgb:16769024}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ghost_guy_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.ghost_guy"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":3,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{visible:"luigis_mansion:entity/ghost_guy",mirror:{components:{"minecraft:item_model":"luigis_mansion:entity/ghost_guy","minecraft:damage":2}},model_data:{default:{components:{"minecraft:custom_model_data":0}},equipment:{components:{"minecraft:custom_model_data":1}}}},"minecraft:dyed_color":{rgb:16769024}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","ghost_guy_model","found_owner","left_arm","this_entity"],DisabledSlots:2039583}
...
execute as @e[tag=this_entity,limit=1] store result score @s PullStrength run data get storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.pull.strength
execute as @e[tag=this_entity,limit=1] store result score @s PullAngle run data get storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.pull.angle
data modify entity @e[tag=this_entity,limit=1] data.loot set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.loot
data modify entity @e[tag=this_entity,limit=1] data.damage set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy.damage
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy{flee_task:"random"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 0
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy{flee_task:"alternate"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 1
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy{flee_task:"circle"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 2
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy{flee_task:"random_in_range"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 3
execute if data storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.dancing_ghost_guy{flee_task:"loops"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 4
