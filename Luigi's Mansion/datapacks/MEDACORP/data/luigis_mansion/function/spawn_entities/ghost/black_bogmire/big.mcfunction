summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.black_bogmire"}',Tags:["affected_by_vacuum","ghost","big","ground_bound","visible","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"black_bogmire"}}}
