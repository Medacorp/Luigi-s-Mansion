summon minecraft:marker ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.boo"},Tags:["hidden_boo","same_room_select_furniture","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"hidden_boo"},boo:{namespace:"luigis_mansion",id:"null"}}}
