summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',Tags:["cannot_be_removed","affected_by_vacuum","affected_by_ice","ghost","appear","show_health","boo","visible","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"boo"},boo:{namespace:"luigis_mansion",id:"null"}}}
