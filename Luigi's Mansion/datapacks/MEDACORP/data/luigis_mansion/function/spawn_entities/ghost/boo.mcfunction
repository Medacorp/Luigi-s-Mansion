...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boo","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{model_data:{default:{components:{"minecraft:custom_model_data":0}},attacking:{components:{"minecraft:custom_model_data":1}},invisible:{components:{"minecraft:custom_model_data":2}}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boo","minecraft:unbreakable":{},"minecraft:damage":2,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{mirror:{components:{"minecraft:damage":3}},model_data:{default:{components:{"minecraft:custom_model_data":0}},attacking:{components:{"minecraft:custom_model_data":1}},invisible:{components:{"minecraft:custom_model_data":2}}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boo","minecraft:unbreakable":{},"minecraft:damage":3,"minecraft:max_damage":4,"minecraft:custom_model_data":0,"minecraft:custom_data":{mirror:{components:{"minecraft:damage":2}},model_data:{default:{components:{"minecraft:custom_model_data":0}},attacking:{components:{"minecraft:custom_model_data":1}},invisible:{components:{"minecraft:custom_model_data":2}}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","left_arm","this_entity"],DisabledSlots:2039583}
