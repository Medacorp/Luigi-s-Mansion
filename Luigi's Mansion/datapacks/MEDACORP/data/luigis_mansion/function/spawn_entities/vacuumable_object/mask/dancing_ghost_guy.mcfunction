summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.ghost_guy_mask"},Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,data:{entity:{namespace:"luigis_mansion",id:"vacuumable_object"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/ghost_guy_mask","minecraft:custom_model_data":{strings:["dancing"]}}}},Pose:{Head:[0.0f,0.01f,0.0f]},Tags:["ghost_guy_mask","affected_by_vacuum","vacuumable_object","same_room_players_only","this_entity"],DisabledSlots:2039583}
