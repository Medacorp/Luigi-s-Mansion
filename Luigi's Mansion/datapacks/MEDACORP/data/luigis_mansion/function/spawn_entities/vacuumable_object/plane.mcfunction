summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.plane"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/plane","minecraft:unbreakable":{},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"vacuumable_object"}}}}],Pose:{Head:[0.0f,0.0f,1.01f]},Tags:["plane","affected_by_vacuum","vacuumable_object","same_room_players_only","this_entity"],DisabledSlots:2039583}
