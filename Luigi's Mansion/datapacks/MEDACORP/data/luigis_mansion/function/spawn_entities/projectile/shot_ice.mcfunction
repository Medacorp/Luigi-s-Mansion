summon minecraft:item_display ~ ~1.45 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.shot_ice"},Tags:["shot_ice","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"shot_ice"}},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/shot_ice"}},brightness:{sky:15,block:15}}
