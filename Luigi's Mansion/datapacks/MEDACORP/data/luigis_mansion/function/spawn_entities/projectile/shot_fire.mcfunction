summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.shot_fire"},Pose:{Head:[0.0f,0.0f,0.01f]},HasVisualFire:1b,Marker:1b,Invulnerable:1b,Tags:["shot_fire","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"shot_fire"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/shot_fire"}}},Invisible:1b,DisabledSlots:2039583,Small:1b}
