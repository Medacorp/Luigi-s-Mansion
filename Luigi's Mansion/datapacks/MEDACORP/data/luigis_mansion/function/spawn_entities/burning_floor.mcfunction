summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.burning_floor"}',Invisible:1b,NoGravity:1b,Marker:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/burning_floor","minecraft:unbreakable":{},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"burning_floor"},damage:{attack:10}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["burning_floor","affected_by_water","static","same_room_players_only","this_entity"],DisabledSlots:2039583}
