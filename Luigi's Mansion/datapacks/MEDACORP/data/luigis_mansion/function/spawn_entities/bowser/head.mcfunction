summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.bowser"}',Tags:["ghost","visible","portrait_ghost","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"bowser_head"},damage:{spit_ice:5}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.bowser"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:custom_model_data":88,"minecraft:custom_data":{model_data:{default:{id:"minecraft:diamond_pickaxe",components:{"minecraft:custom_model_data":88}},open_mouth:{id:"minecraft:diamond_pickaxe",components:{"minecraft:custom_model_data":91}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","bowser_model","found_owner","this_entity"],DisabledSlots:2039583}
