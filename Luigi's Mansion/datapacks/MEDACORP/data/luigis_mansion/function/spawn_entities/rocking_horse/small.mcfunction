summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.rocking_horse"},Tags:["rocking_horse","battle","same_room_players_only","this_entity"],Pose:{Head:[0.0f,0.0f,0.01f]},NoGravity:1b,Marker:1b,data:{entity:{namespace:"luigis_mansion",id:"rocking_horse"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/rocking_horse","minecraft:custom_model_data":{strings:["default"]}}}},Invisible:1b,DisabledSlots:2039583}
