summon minecraft:armor_stand ~ ~0.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.bone"}',NoGravity:1b,Marker:1b,HasVisualFire:1b,Tags:["bone","same_room_players_only","this_entity"],Pose:{Head:[0.0f,0.0f,0.01f]},ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/bone","minecraft:unbreakable":{},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"bone"}}}}],Invisible:1b,DisabledSlots:2039583}
