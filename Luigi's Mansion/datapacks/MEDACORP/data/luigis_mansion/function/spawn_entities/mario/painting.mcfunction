summon minecraft:item_frame ~1 ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.mario"}',Facing:5b,Invulnerable:1b,Item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"mario"},mansion:{namespace:"luigis_mansion",id:"empty"}},"minecraft:unbreakable":{},"minecraft:damage":5,"minecraft:custom_model_data":32}},NoGravity:1b,Marker:1b,Silent:1b,Invisible:1b,Tags:["mario","calm","same_room_players_only","this_entity"]}
