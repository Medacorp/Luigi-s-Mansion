...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.sir_weston"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:custom_data":{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button"},"minecraft:unbreakable":{},"minecraft:damage":4,"minecraft:custom_model_data":42}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","sir_weston_model","found_owner","ice","this_entity"],DisabledSlots:2039583}
