summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.sue_pea"}',Tags:["portrait_ghost","portrait_ghost_pop","pearl_dropper","affected_by_vacuum","ghost","ceiling_ghost","same_room_players_only","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"sue_pea"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.sue_pea"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":5,"minecraft:custom_model_data":0,"minecraft:custom_data":{visible:"luigis_mansion:entity/sue_pea",model_data:{default:{components:{"minecraft:custom_model_data":0}},waking:{components:{"minecraft:custom_model_data":1}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","sue_pea_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.sue_pea"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:damage":2,"minecraft:max_damage":5,"minecraft:custom_data":{visible:"luigis_mansion:entity/sue_pea",mirror:{components:{"minecraft:damage":3}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","sue_pea_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
...
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.sue_pea{flee_task:"random_in_range"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 3
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.sue_pea{flee_task:"loops"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 4
