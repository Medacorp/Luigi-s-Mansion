summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.nana"}',Tags:["portrait_ghost","portrait_ghost_pop","pearl_dropper","affected_by_vacuum","ghost","same_room_players_only","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"nana"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.nana"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:custom_model_data":35,"minecraft:custom_data":{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button"}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","nana_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.nana"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:custom_model_data":37,"minecraft:custom_data":{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",model_data:{default:{components:{"minecraft:custom_model_data":37}},equipment:{components:{"minecraft:custom_model_data":36}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","nana_model","found_owner","body","this_entity"],DisabledSlots:2039583}
...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.rocking_chair"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":19,"minecraft:custom_model_data":104,"minecraft:custom_data":{model_data:{default:{id:"minecraft:diamond_pickaxe"},hidden:{id:"minecraft:stone_button"}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","nana_model","found_owner","rocking_chair","this_entity"],DisabledSlots:2039583}
