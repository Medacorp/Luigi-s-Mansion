...
summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.vincent_van_gore"},Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/vincent_van_gore","minecraft:custom_model_data":{flags:[1b],floats:[0f]}}}},Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","vincent_van_gore_model","found_owner","head","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.vincent_van_gore"},Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/vincent_van_gore","minecraft:custom_model_data":{flags:[1b],floats:[1f],strings:["default"]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[2f]}}},model_data:{default:{components:{"minecraft:custom_model_data":{strings:["default"]}}},equipment:{components:{"minecraft:custom_model_data":{strings:["equipment"]}}}}}}}},Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","vincent_van_gore_model","found_owner","right_arm","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.vincent_van_gore"},Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/vincent_van_gore","minecraft:custom_model_data":{flags:[1b],floats:[2f],strings:["default"]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[1f]}}},model_data:{default:{components:{"minecraft:custom_model_data":{strings:["default"]}}},equipment:{components:{"minecraft:custom_model_data":{strings:["equipment"]}}}}}}}},Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","vincent_van_gore_model","found_owner","left_arm","this_entity"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:entity.vincent_van_gore"},Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/vincent_van_gore","minecraft:custom_model_data":{flags:[1b],floats:[3f]}}}},Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","vincent_van_gore_model","found_owner","body","this_entity"],DisabledSlots:2039583}
...
data modify entity @e[tag=this_entity,limit=1] data.loot_storage set from storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.vincent_van_gore.loot
...
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.vincent_van_gore{flee_task:"random_in_range"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 3
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.vincent_van_gore{flee_task:"loops"} run scoreboard players set @e[tag=this_entity,limit=1] FleeTask 4
