...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.jarvis"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:unbreakable":{},"minecraft:custom_model_data":0,"minecraft:custom_data":{visible:"luigis_mansion:entity/jarvis",model_data:{default:{components:{"minecraft:custom_model_data":0}},frozen:{components:{"minecraft:custom_model_data":1}}}}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","jarvis_model","found_owner","this_entity"],DisabledSlots:2039583}
