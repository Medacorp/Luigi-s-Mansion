...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.madame_clairvoya"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/madame_clairvoya","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;1b],floats:[0f]}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","madame_clairvoya_model","found_owner","head","this_entity"],DisabledSlots:2039583}
...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.madame_clairvoya"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/madame_clairvoya","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;1b],floats:[3f]}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","madame_clairvoya_model","found_owner","body","this_entity"],DisabledSlots:2039583}
