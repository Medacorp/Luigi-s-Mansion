...
execute if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.madame_clairvoya{always_pull:1b} run tag @e[tag=this_entity,limit=1] add always_pull_players
