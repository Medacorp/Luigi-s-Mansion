...
execute as @e[tag=this_entity,limit=1] store result score @s Health run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_ghosts[{name:{namespace:"luigis_mansion",id:"boolossus"}}].health
...
execute as @e[tag=this_entity,limit=1] store result score @s Move run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_ghosts[{name:{namespace:"luigis_mansion",id:"boolossus"}}].merged_speed
...
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=6}] EntitySizeRadius 16
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=7}] EntitySizeRadius 18
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=8}] EntitySizeRadius 19
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=9}] EntitySizeRadius 21
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=10}] EntitySizeRadius 22
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=11}] EntitySizeRadius 24
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=12}] EntitySizeRadius 25
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=13}] EntitySizeRadius 27
scoreboard players set @e[tag=this_entity,limit=1,scores={Health=14}] EntitySizeRadius 28
