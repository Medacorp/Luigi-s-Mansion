...
execute if entity @e[tag=this_entity,limit=1,scores={Health=1}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "1"
execute if entity @e[tag=this_entity,limit=1,scores={Health=2}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "2"
execute if entity @e[tag=this_entity,limit=1,scores={Health=3}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "3"
execute if entity @e[tag=this_entity,limit=1,scores={Health=4}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "4"
execute if entity @e[tag=this_entity,limit=1,scores={Health=5}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "5"
execute if entity @e[tag=this_entity,limit=1,scores={Health=6}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "6"
execute if entity @e[tag=this_entity,limit=1,scores={Health=7}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "7"
execute if entity @e[tag=this_entity,limit=1,scores={Health=8}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "8"
execute if entity @e[tag=this_entity,limit=1,scores={Health=9}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "9"
execute if entity @e[tag=this_entity,limit=1,scores={Health=10}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "10"
execute if entity @e[tag=this_entity,limit=1,scores={Health=11}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "11"
execute if entity @e[tag=this_entity,limit=1,scores={Health=12}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "12"
execute if entity @e[tag=this_entity,limit=1,scores={Health=13}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "13"
execute if entity @e[tag=this_entity,limit=1,scores={Health=14}] as @e[tag=this_model] run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "14"
