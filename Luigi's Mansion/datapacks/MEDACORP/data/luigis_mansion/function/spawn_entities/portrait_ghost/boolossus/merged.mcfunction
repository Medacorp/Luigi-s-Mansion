...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boolossus"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boolossus","minecraft:unbreakable":{},"minecraft:damage":1,"minecraft:max_damage":4,"minecraft:custom_model_data":15}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","head","this_entity","this_model"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boolossus"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boolossus","minecraft:unbreakable":{},"minecraft:damage":2,"minecraft:max_damage":4,"minecraft:custom_model_data":15,"minecraft:custom_data":{mirror:{components:{"minecraft:damage":3}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","right_arm","this_entity","this_model"],DisabledSlots:2039583}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boolossus"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boolossus","minecraft:unbreakable":{},"minecraft:damage":3,"minecraft:max_damage":4,"minecraft:custom_model_data":15,"minecraft:custom_data":{mirror:{components:{"minecraft:damage":2}}}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","left_arm","this_entity","this_model"],DisabledSlots:2039583}
...
execute if entity @e[tag=this_entity,limit=1,scores={Health=1}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 1
execute if entity @e[tag=this_entity,limit=1,scores={Health=2}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 2
execute if entity @e[tag=this_entity,limit=1,scores={Health=3}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 3
execute if entity @e[tag=this_entity,limit=1,scores={Health=4}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 4
execute if entity @e[tag=this_entity,limit=1,scores={Health=5}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 5
execute if entity @e[tag=this_entity,limit=1,scores={Health=6}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 6
execute if entity @e[tag=this_entity,limit=1,scores={Health=7}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 7
execute if entity @e[tag=this_entity,limit=1,scores={Health=8}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 8
execute if entity @e[tag=this_entity,limit=1,scores={Health=9}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 9
execute if entity @e[tag=this_entity,limit=1,scores={Health=10}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 10
execute if entity @e[tag=this_entity,limit=1,scores={Health=11}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 11
execute if entity @e[tag=this_entity,limit=1,scores={Health=12}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 12
execute if entity @e[tag=this_entity,limit=1,scores={Health=13}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 13
execute if entity @e[tag=this_entity,limit=1,scores={Health=14}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 14
