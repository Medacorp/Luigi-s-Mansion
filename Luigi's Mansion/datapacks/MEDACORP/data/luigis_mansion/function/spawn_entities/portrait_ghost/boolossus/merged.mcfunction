...
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.boolossus"}',Invisible:1b,NoGravity:1b,Marker:1b,HasVisualFire:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:entity/boolossus","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;0b],floats:[0f],strings:["15"]}}}],Pose:{Head:[0.0f,0.0f,0.0f]},Tags:["model_piece","boo_model","found_owner","head","this_entity","this_model"],DisabledSlots:2039583}
...
execute if entity @e[tag=this_entity,limit=1,scores={Health=1}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "1"
execute if entity @e[tag=this_entity,limit=1,scores={Health=2}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "2"
execute if entity @e[tag=this_entity,limit=1,scores={Health=3}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "3"
execute if entity @e[tag=this_entity,limit=1,scores={Health=4}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "4"
execute if entity @e[tag=this_entity,limit=1,scores={Health=5}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "5"
execute if entity @e[tag=this_entity,limit=1,scores={Health=6}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "6"
execute if entity @e[tag=this_entity,limit=1,scores={Health=7}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "7"
execute if entity @e[tag=this_entity,limit=1,scores={Health=8}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "8"
execute if entity @e[tag=this_entity,limit=1,scores={Health=9}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "9"
execute if entity @e[tag=this_entity,limit=1,scores={Health=10}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "10"
execute if entity @e[tag=this_entity,limit=1,scores={Health=11}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "11"
execute if entity @e[tag=this_entity,limit=1,scores={Health=12}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "12"
execute if entity @e[tag=this_entity,limit=1,scores={Health=13}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "13"
execute if entity @e[tag=this_entity,limit=1,scores={Health=14}] as @e[tag=this_model] run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data".strings[0] set value "14"
