data modify storage luigis_mansion:data portrait_ghosts set from storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_ghosts
