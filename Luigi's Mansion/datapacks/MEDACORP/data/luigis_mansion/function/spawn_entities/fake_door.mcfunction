...
execute if data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:item_display ^ ^ ^0.44 {CustomName:{type:"translatable",translate:"luigis_mansion:entity.fake_door"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/door_frame/none"}},Tags:["model_piece","fake_door_model","found_owner","frame","left_hinge","this_entity"]}
execute if data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:item_display ^ ^ ^0.44 {CustomName:{type:"translatable",translate:"luigis_mansion:entity.fake_door"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:custom_model_data":{strings:["normal"]}}},Tags:["model_piece","fake_door_model","found_owner","left","dead","this_entity"]}
execute unless data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:item_display ^ ^ ^0.44 {CustomName:{type:"translatable",translate:"luigis_mansion:entity.fake_door"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/door_frame/none"}},Tags:["model_piece","fake_door_model","found_owner","frame","this_entity"]}
execute unless data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:item_display ^ ^ ^0.44 {CustomName:{type:"translatable",translate:"luigis_mansion:entity.fake_door"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty","minecraft:custom_model_data":{strings:["normal"]}}},Tags:["model_piece","fake_door_model","found_owner","right","dead","this_entity"]}
...
execute as @e[tag=this_entity,limit=1] store result score @s Health store result score @s LastHealth run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.fake_door.health
data modify entity @e[tag=this_entity,limit=1] data.loot_storage set from storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.fake_door.loot
data modify entity @e[tag=this_entity,limit=1] data.damage set from storage luigis_mansion:data current_state.luigis_mansion.current_data.ghosts.luigis_mansion.fake_door.damage
