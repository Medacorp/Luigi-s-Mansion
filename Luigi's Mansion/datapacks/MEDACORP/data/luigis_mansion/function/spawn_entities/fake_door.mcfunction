summon minecraft:marker ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fake_door"}',Tags:["door","affected_by_interact","affected_by_fire","affected_by_water","hurt_by_fire","ghost","optional_ghost","no_delete_on_room_clear","no_dialog_freeze","same_room_players_only","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"fake_door"}}}
execute if data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fake_door"}',Pose:{Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/door_frame/none"}}],Tags:["model_piece","fake_door_model","found_owner","frame","left_hinge","this_entity"],DisabledSlots:2039583}
execute if data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fake_door"}',Pose:{Head:[0.0f,-90.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty"}}],Tags:["model_piece","fake_door_model","found_owner","left","dead","this_entity"],DisabledSlots:2039583}
execute unless data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fake_door"}',Pose:{Head:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/door_frame/none"}}],Tags:["model_piece","fake_door_model","found_owner","frame","this_entity"],DisabledSlots:2039583}
execute unless data storage luigis_mansion:data entity.door{left_hinge:1b} run summon minecraft:armor_stand ^ ^ ^0.44 {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.fake_door"}',Pose:{Head:[0.0f,90.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:empty"}}],Tags:["model_piece","fake_door_model","found_owner","right","dead","this_entity"],DisabledSlots:2039583}
