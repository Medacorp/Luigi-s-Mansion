...
scoreboard objectives add AnimationModelModifier dummy
scoreboard objectives add AnimationOldRotationX dummy
scoreboard objectives add AnimationOldRotationY dummy
scoreboard objectives add AnimationOldRotationZ dummy
scoreboard objectives add AnimationRotationCosX dummy
scoreboard objectives add AnimationRotationCosY dummy
scoreboard objectives add AnimationRotationCosZ dummy
scoreboard objectives add AnimationRotationSinX dummy
scoreboard objectives add AnimationRotationSinY dummy
scoreboard objectives add AnimationRotationSinZ dummy
scoreboard objectives add AnimationRotationX dummy
scoreboard objectives add AnimationRotationY dummy
scoreboard objectives add AnimationRotationZ dummy
...
scoreboard objectives add FurnitureDustUp dummy
scoreboard objectives add FurnitureElementForward dummy
scoreboard objectives add FurnitureElementLeft dummy
scoreboard objectives add FurnitureElementTimer dummy
scoreboard objectives add FurnitureElementUp dummy
scoreboard objectives add FurnitureFire dummy
scoreboard objectives add FurnitureGhostForward dummy
scoreboard objectives add FurnitureGhostLeft dummy
scoreboard objectives add FurnitureGhostUp dummy
...
scoreboard objectives add FurniturePoseX dummy
scoreboard objectives add FurniturePoseY dummy
scoreboard objectives add FurniturePoseZ dummy
...
scoreboard objectives add FurnitureSizeRadius dummy
...
scoreboard objectives add HomeRotation dummy
scoreboard objectives add HomeRotationX dummy
scoreboard objectives add HomeRotationY dummy
...
scoreboard objectives add PulledStrength dummy
...
execute unless score #heart_money_count Selected matches 0.. run scoreboard players set #heart_money_count Selected 200
