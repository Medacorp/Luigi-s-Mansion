...
execute unless entity @s[tag=!debug_entity,tag=!debug_furniture,tag=freeze_animation] as @e[tag=player,tag=!model_piece,tag=!reflection] run function luigis_mansion:main/get_same_room
