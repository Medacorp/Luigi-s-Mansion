...
execute at @s[tag=!reflection,tag=!model_piece,tag=!map_entity,tag=!solid_furniture_collision] run function luigis_mansion:main/entity
...
execute if entity @s[tag=solid_furniture_collision] run function luigis_mansion:main/solid_furniture_collision