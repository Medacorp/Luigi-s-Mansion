...
execute if score #temp Room matches 1.. run function luigis_mansion:main/get_same_room/viewpoints with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id