...
execute if entity @s[tag=flashlight,scores={Shrunk=0}] positioned ~ ~1 ~ if block ^ ^ ^0.8 #luigis_mansion:flashlight_path run summon minecraft:marker ~ ~ ~ {Tags:["flashlight","new"],data:{entity:{namespace:"luigis_mansion",id:"flashlight"}}}
...
execute if entity @s[tag=flashlight,scores={Shrunk=1..}] positioned ~ ~0.5 ~ if block ^ ^ ^0.4 #luigis_mansion:flashlight_path run summon minecraft:marker ~ ~ ~ {Tags:["flashlight","new"],data:{entity:{namespace:"luigis_mansion",id:"flashlight"}}}
