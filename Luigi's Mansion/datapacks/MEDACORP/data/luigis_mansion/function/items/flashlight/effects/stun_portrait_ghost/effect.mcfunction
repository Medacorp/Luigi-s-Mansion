...
execute if score #global_difficulty Selected matches 3 run scoreboard players operation @s VulnerableTime -= #temp VulnerableTime
execute if score #global_difficulty Selected matches 3 run scoreboard players set @s[scores={VulnerableTime=..0}] VulnerableTime 2
execute if score #global_difficulty Selected matches 3 run scoreboard players operation @s StunTime = @s VulnerableTime
