...
data modify storage luigis_mansion:data macro.uuid set from entity @s
execute if entity @s[scores={VulnerableTime=1..}] run function luigis_mansion:items/poltergust_3000/effect_on_entity/vacuum_latch with storage luigis_mansion:data macro