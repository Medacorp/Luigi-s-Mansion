...
tag @s add me
execute as @e[tag=ghost,tag=hurt,tag=being_vacuumed] positioned ~ ~0.5 ~ facing entity @s feet run function luigis_mansion:items/poltergust_3000/vacuuming/break_free
tag @s remove me