...
execute if entity @s[scores={UseItem=1..},tag=game_boy_horror_selected,tag=!disable_game_boy_horror] run function luigis_mansion:entities/luigi/run_command_as_owner {command:"function luigis_mansion:items/game_boy_horror/use_item"}
