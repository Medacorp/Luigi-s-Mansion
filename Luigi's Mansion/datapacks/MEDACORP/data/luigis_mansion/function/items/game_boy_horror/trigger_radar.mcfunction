...
execute if entity @s[scores={GBHRadar=40..}] unless score #freeze_timer Selected matches 1 run function luigis_mansion:entities/luigi/run_command_as_owner {command:"execute at @s run playsound luigis_mansion:item.game_boy_horror.radar player @s ~ ~ ~ 0.5"}
