execute store result entity @s Pos[0] double 0.1 run scoreboard players get #temp FurnitureSizeLeft
execute store result entity @s Pos[1] double 0.1 run scoreboard players get #temp FurnitureSizeUp
...
execute if score #temp FurnitureZTarget matches 900.. run scoreboard players set #temp FurnitureZTarget 900
execute store result entity @s Pos[2] double 0.1 run scoreboard players get #temp FurnitureSizeForward
execute store result entity @s Pos[1] double 0.1 run scoreboard players get #temp FurnitureSizeUp
