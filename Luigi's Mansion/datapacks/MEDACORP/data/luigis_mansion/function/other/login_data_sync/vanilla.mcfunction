...
execute if data storage luigis_mansion:data current_state.luigis_mansion.high_scores[{data_index:0}] run advancement grant @a only luigis_mansion:vanilla/unlock_hidden_mansion
