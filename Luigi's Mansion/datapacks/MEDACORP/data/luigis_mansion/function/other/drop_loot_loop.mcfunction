...
execute if data storage luigis_mansion:data drop_loot.contents[-1].count if score #loot_count Time matches ..0 run data remove storage luigis_mansion:data drop_loot.contents[-1]
