...
execute if data storage luigis_mansion:data drop_loot.name if entity @s[scores={Room=1..}] run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.money_spawned append from storage luigis_mansion:data drop_loot.name
