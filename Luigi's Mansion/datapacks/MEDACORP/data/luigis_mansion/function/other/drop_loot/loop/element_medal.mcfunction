data modify storage luigis_mansion:data entity set from storage luigis_mansion:data drop_loot.contents.luigis_mansion.element_medal[0]
...
execute if data storage luigis_mansion:data {element_medal:"fire"} run function luigis_mansion:spawn_entities/item/fire_element_medal
execute if data storage luigis_mansion:data {element_medal:"water"} run function luigis_mansion:spawn_entities/item/water_element_medal
execute if data storage luigis_mansion:data {element_medal:"ice"} run function luigis_mansion:spawn_entities/item/ice_element_medal
