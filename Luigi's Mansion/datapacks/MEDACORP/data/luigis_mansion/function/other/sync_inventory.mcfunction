...
data remove storage luigis_mansion:data inventory[{Slot:7b}]
data remove storage luigis_mansion:data inventory[{Slot:8b}]
execute if data storage luigis_mansion:data inventory[{Slot:100b}] run data modify storage luigis_mansion:data inventory[{Slot:100b}] merge value {Slot:0b}
execute if data storage luigis_mansion:data inventory[{Slot:101b}] run data modify storage luigis_mansion:data inventory[{Slot:101b}] merge value {Slot:1b}
execute if data storage luigis_mansion:data inventory[{Slot:102b}] run data modify storage luigis_mansion:data inventory[{Slot:102b}] merge value {Slot:2b}
execute if data storage luigis_mansion:data inventory[{Slot:103b}] run data modify storage luigis_mansion:data inventory[{Slot:103b}] merge value {Slot:3b}
...
data remove storage luigis_mansion:data inventory[{Slot:2b}]
data remove storage luigis_mansion:data inventory[{Slot:3b}]
execute if data storage luigis_mansion:data inventory[{Slot:-106b}] run data modify storage luigis_mansion:data inventory[{Slot:-106b}] merge value {Slot:0b}
