advancement grant @s only luigis_mansion:jukebox/boolossus_warp
execute unless entity @s[scores={MusicType=-27,MusicGroup=0}] run function luigis_mansion:other/music/reset_progress
