advancement grant @s only luigis_mansion:jukebox/gallery
execute unless entity @s[scores={MusicType=4,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
