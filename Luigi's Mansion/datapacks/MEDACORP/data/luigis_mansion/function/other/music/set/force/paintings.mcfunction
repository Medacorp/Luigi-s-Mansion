advancement grant @s only luigis_mansion:jukebox/paintings
execute unless entity @s[scores={MusicType=-9,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
