advancement grant @s only luigis_mansion:jukebox/ghost_portrificationizer_room
execute unless entity @s[scores={MusicType=5,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
