advancement grant @s only luigis_mansion:jukebox/minigame_failure
execute unless entity @s[scores={MusicType=-7,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
