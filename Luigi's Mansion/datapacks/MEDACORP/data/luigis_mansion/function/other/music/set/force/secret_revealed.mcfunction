...
execute unless entity @s[scores={MusicType=-22,MusicGroup=0}] if entity @s[scores={GradualMusic=0,HealthMusic=0}] run function luigis_mansion:other/music/set_no_transition
