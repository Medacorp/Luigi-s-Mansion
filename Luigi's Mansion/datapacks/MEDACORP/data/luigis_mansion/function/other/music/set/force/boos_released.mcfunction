advancement grant @s only luigis_mansion:jukebox/boos_released
execute unless entity @s[scores={MusicType=-8,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
