advancement grant @s only luigis_mansion:jukebox/closing_pipe
execute unless entity @s[scores={MusicType=-6,MusicGroup=0}] run function luigis_mansion:other/music/set_no_transition
