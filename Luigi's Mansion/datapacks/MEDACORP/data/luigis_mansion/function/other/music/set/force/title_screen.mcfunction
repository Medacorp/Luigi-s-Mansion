advancement grant @s only luigis_mansion:jukebox/title_screen
execute unless entity @s[scores={MusicType=-32,MusicGroup=0}] run function luigis_mansion:other/music/reset_progress
