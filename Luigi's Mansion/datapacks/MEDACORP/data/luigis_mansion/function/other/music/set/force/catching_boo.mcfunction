advancement grant @s only luigis_mansion:jukebox/catching_boo
execute unless entity @s[scores={MusicType=30,MusicGroup=0}] run function luigis_mansion:other/music/reset_progress
