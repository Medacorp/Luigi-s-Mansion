advancement grant @s only luigis_mansion:jukebox/sue_pea
execute unless entity @s[scores={MusicType=-14,MusicGroup=0}] run function luigis_mansion:other/music/reset_progress
