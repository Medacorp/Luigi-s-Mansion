advancement grant @s only luigis_mansion:jukebox/unportrificationizing
execute unless entity @s[scores={MusicType=-19,MusicGroup=0}] run function luigis_mansion:other/music/reset_progress
