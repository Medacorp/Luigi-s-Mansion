...
execute at @s facing entity @e[tag=me,limit=1] feet run teleport @s ~ ~ ~ ~ ~
execute at @s positioned ^ ^ ^0.1 if block ~ ~ ~ #luigis_mansion:flashlight_path run function luigis_mansion:other/cast_shadow/create/step
kill @s