summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.helicopter_mobile"}',Marker:1b,NoGravity:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":21,"minecraft:custom_model_data":1,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"swirling",mirror:{components:{"minecraft:damage":20}}}}}],Tags:["furniture","hanging_furniture","this_entity"],DisabledSlots:2039583}
