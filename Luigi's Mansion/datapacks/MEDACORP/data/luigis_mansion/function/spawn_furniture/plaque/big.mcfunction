...
execute rotated ~ 0 run summon minecraft:text_display ^ ^-0.13 ^0.19 {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.plaque"},Tags:["plaque_text","no_reflection","this_entity"],background:0,text:{type:"text",text:""}}
execute rotated ~ 0 run teleport @e[tag=plaque_text,tag=this_entity,limit=1] ^ ^-0.13 ^0.19 ~ 0
