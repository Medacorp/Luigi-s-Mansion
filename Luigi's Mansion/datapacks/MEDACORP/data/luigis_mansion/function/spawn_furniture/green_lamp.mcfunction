summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.green_lamp"}',Tags:["furniture","standing_furniture","lamp","was_dark_room","dark_room","immobile","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/green_lamp","minecraft:unbreakable":{},"minecraft:custom_model_data":{flags:[B;0b]},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",model_data:{off:{components:{"minecraft:custom_model_data":{flags:[B;0b]}}},on:{components:{"minecraft:custom_model_data":{flags:[B;1b]}}}}}}}],Invisible:1b,DisabledSlots:2039583}
