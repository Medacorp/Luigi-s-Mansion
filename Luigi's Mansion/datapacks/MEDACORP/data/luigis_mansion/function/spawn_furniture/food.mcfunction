summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.food"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/food","minecraft:unbreakable":{},"minecraft:custom_model_data":0,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"food",model_data:{default:{components:{"minecraft:custom_model_data":0}},slightly_descreased:{components:{"minecraft:custom_model_data":1}},decreased:{components:{"minecraft:custom_model_data":2}},largely_decreased:{components:{"minecraft:custom_model_data":3}},empty:{components:{"minecraft:custom_model_data":4}}}}}}],Tags:["furniture","immobile","standing_furniture","this_entity"],DisabledSlots:2039583}
