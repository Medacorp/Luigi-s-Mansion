summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.hide_and_seek_box"}',Tags:["furniture","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/hide_and_seek_box/variant_4","minecraft:unbreakable":{},"minecraft:custom_model_data":0,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",open_animation:{namespace:"luigis_mansion",id:"hide_and_seek_box"},model_data:{default:{components:{"minecraft:custom_model_data":0}},open:{components:{"minecraft:custom_model_data":4}}}}}}],Invisible:1b,DisabledSlots:2039583}
