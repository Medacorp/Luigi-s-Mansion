...
$execute unless data storage luigis_mansion:data current_state.current_data.technical_data{$(burning):1b} run data modify entity @s data.burning_flag set value "$(burning)"