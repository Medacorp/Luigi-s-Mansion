summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.torch"},Marker:1b,NoGravity:1b,Invisible:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic"},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/torch/gray","minecraft:custom_model_data":{flags:[B;1b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[B;0b]}}}}}}},Tags:["furniture","immobile","standing_furniture","can_be_fire_elemental_source","this_entity"],DisabledSlots:2039583}
