execute summon minecraft:item_display run data merge entity @s {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.cloth"},Marker:1b,NoGravity:1b,Invisible:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"cloth"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/cloth/toilet_paper","minecraft:custom_model_data":{flags:[0b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b]}}}}}},Tags:["furniture","cloth","front","requires_hitbox","this_entity"]}
