execute if entity @e[tag=this_entity,limit=1] run function luigis_mansion:spawn_furniture/setup/transformation
...
data modify entity @e[tag=temp,limit=1] Rotation[0] set from entity @e[tag=this_entity,limit=1] Rotation[1]
