...
execute unless data storage luigis_mansion:data candle_flame{type:"incense"} if entity @e[tag=this_entity,tag=candle_flame,limit=1,tag=lit] run function luigis_mansion:entities/furntiure/type/candle_flame/light
execute unless data storage luigis_mansion:data candle_flame{type:"incense"} if entity @e[tag=this_entity,tag=candle_flame,limit=1,tag=!lit] run function luigis_mansion:entities/furntiure/type/candle_flame/extinguish
