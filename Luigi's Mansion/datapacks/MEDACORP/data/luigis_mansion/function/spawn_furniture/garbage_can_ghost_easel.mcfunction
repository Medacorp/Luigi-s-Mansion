execute unless score #mirrored Selected matches 1 run summon minecraft:armor_stand ~ ~-1.43875 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.garbage_can_ghost_easel"},Tags:["furniture","immobile","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"ghost_art",open_animation:{namespace:"luigis_mansion",id:"ghost_art"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/portrait/garbage_can_ghost","minecraft:custom_model_data":{flags:[0b,0b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b,0b]}}},model_data:{default:{components:{"minecraft:custom_model_data":{flags:[0b,0b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b,0b]}}}}}},open:{components:{"minecraft:custom_model_data":{flags:[0b,1b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b,1b]}}}}}}}}}}},Invisible:1b,DisabledSlots:2039583}
