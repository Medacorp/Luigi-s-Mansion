execute positioned ^ ^ ^0.01 summon minecraft:item_display run data merge entity @s {transformation:{scale:[2.0f,3.0f,0.0f]},CustomName:{type:"translatable",translate:"luigis_mansion:furniture.poster"},Marker:1b,NoGravity:1b,Invisible:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"poster"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/poster/cloth","minecraft:custom_model_data":{flags:[0b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b]}}}}}},Tags:["furniture","poster","immobile","this_entity"]}
