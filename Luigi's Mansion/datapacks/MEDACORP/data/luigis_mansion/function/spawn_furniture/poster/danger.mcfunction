summon minecraft:item_display ^ ^ ^0.01 {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.poster"},data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"poster"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/poster/danger","minecraft:custom_model_data":{flags:[0b]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{flags:[1b]}}}}}},Tags:["furniture","poster","requires_hitbox","immobile","this_entity"]}
