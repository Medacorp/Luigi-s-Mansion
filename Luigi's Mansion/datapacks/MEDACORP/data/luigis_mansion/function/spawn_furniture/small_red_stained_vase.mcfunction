summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.small_red_stained_vase"},data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"rolling"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/small_red_stained_vase"}},Tags:["furniture","immobile","standing_furniture","this_entity"]}
