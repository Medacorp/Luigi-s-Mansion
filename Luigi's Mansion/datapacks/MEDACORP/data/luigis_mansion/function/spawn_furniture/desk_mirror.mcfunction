summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.desk_mirror"},Tags:["furniture","immobile","mirror","standing_furniture","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",mirror_surface:-0.03f},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/desk_mirror","minecraft:custom_model_data":{flags:[0b]},"minecraft:custom_data":{model_data:{solid:{components:{"minecraft:custom_model_data":{flags:[0b]}}},reflects:{components:{"minecraft:custom_model_data":{flags:[1b]}}}}}}}}
