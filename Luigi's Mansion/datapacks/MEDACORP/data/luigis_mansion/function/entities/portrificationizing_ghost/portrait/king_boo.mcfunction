...
data modify entity @s ArmorItems[3].components."minecraft:damage" set value 5
execute if score #temp ActionTime matches -1..0 run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 33
execute if score #temp ActionTime matches 1 run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 34
execute if score #temp ActionTime matches 2.. run data modify entity @s ArmorItems[3].components."minecraft:custom_model_data" set value 35
