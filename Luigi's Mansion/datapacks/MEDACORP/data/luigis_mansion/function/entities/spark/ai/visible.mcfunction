...
execute if entity @e[tag=same_room,tag=luigi,distance=..0.7,limit=1] if entity @s[tag=!dead,tag=!removed_from_existence,tag=!normal_death] run function luigis_mansion:entities/spark/collide with entity @s data.entity
...
data modify entity @s[scores={SpawnTime=140}] data.animation set value {namespace:"luigis_mansion",id:"danger"}
