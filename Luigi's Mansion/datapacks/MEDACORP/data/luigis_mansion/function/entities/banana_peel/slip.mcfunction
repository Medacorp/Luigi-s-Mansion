...
execute if data entity @s data.damage.attack run data modify storage luigis_mansion:data damage.during_knockback_amount set from entity @s data.damage.attack
