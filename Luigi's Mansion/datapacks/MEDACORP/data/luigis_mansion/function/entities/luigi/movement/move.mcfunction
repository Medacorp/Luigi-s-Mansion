...
execute at @s[tag=flipped_gravity,scores={Shrunk=0}] unless score #debug_phase_through_walls Selected matches 1 run function luigis_mansion:entities/luigi/movement/collision_flipped
execute at @s[tag=flipped_gravity,scores={Shrunk=1..}] unless score #debug_phase_through_walls Selected matches 1 run function luigis_mansion:entities/luigi/movement/collision_flipped_shrunk