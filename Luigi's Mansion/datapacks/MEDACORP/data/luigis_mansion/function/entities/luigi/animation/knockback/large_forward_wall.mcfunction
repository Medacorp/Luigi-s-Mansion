...
execute if entity @s[scores={AnimationProgress=1}] run function luigis_mansion:entities/luigi/make_sound/force {high:"luigis_mansion:entity.player.hurt_flip.front",medium:"luigis_mansion:entity.player.hurt_flip.front",low:"luigis_mansion:entity.player.hurt_flip.front",duration:20}
