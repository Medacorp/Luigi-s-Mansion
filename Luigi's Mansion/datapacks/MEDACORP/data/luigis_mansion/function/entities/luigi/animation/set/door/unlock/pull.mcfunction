...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/unlock/pull/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/unlock/pull/left"} run function luigis_mansion:entities/luigi/animation/set/none
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/unlock/pull/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/unlock/pull/left"} run function luigis_mansion:entities/luigi/animation/shared/set_home_rotation
