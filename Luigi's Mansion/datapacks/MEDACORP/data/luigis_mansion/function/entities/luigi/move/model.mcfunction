...
$execute as @a[tag=this_player,tag=!separated_camera,limit=1] $(execute) run teleport @s $(teleport)
execute as @a[tag=this_player,tag=!separated_camera,limit=1] at @s run function luigis_mansion:main/update_last_position
