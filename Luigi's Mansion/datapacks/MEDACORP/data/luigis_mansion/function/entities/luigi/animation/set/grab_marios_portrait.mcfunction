...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"grab_marios_portrait"} run function luigis_mansion:entities/luigi/animation/set/none
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"grab_marios_portrait"} run function luigis_mansion:entities/luigi/animation/shared/set_home_rotation
data modify storage luigis_mansion:data my_memory.animation set value {namespace:"luigis_mansion",id:"grab_marios_portrait"}
