...
execute if score #temp PositionX matches ..-20 run data modify storage luigis_mansion:data luigi.movement.x set value -0.2f
execute if entity @s[tag=debug_phase_through_walls] if predicate luigis_mansion:luigi/movement/jump run data modify storage luigis_mansion:data luigi.movement.y set value "positive"
execute if entity @s[tag=debug_phase_through_walls] if predicate luigis_mansion:luigi/movement/sneak run data modify storage luigis_mansion:data luigi.movement.y set value "negative"
