...
execute positioned as @s unless block ~ ~0.5 ~-0.3 #luigis_mansion:all_ignore unless block ~ ~0.5 ~-0.3 #minecraft:slabs[type=bottom] unless block ~ ~0.5 ~-0.3 #minecraft:stairs[facing=north,half=bottom] run teleport @s ~ ~ ~0.2
execute positioned as @s if block ~0.3 ~0.5 ~ #minecraft:slabs[type=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~-0.3 ~0.5 ~ #minecraft:slabs[type=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~ ~0.5 ~0.3 #minecraft:slabs[type=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~ ~0.5 ~-0.3 #minecraft:slabs[type=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~0.3 ~0.5 ~ #minecraft:stairs run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~-0.3 ~0.5 ~ #minecraft:stairs run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~ ~0.5 ~0.3 #minecraft:stairs run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~ ~0.5 ~-0.3 #minecraft:stairs run teleport @s ~ ~0.5 ~
execute positioned as @s if block ~ ~ ~ #minecraft:stairs[half=top] run teleport @s ~ ~1 ~
...
execute positioned as @s if score #posy Time matches 50.. unless block ~0.3 ~ ~ #luigis_mansion:all_ignore unless block ~0.3 ~ ~ #minecraft:slabs[type=bottom] unless block ~0.3 ~ ~ #minecraft:stairs[half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posy Time matches 50.. unless block ~-0.3 ~ ~ #luigis_mansion:all_ignore unless block ~-0.3 ~ ~ #minecraft:slabs[type=bottom] unless block ~-0.3 ~ ~ #minecraft:stairs[half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posy Time matches 50.. unless block ~ ~ ~0.3 #luigis_mansion:all_ignore unless block ~ ~ ~0.3 #minecraft:slabs[type=bottom] unless block ~ ~ ~0.3 #minecraft:stairs[half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posy Time matches 50.. unless block ~ ~ ~-0.3 #luigis_mansion:all_ignore unless block ~ ~ ~-0.3 #minecraft:slabs[type=bottom] unless block ~ ~ ~-0.3 #minecraft:stairs[half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posx Time matches 20..69 if block ~ ~ ~ #minecraft:stairs[facing=east,half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posx Time matches 30..79 if block ~ ~ ~ #minecraft:stairs[facing=west,half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posz Time matches 20..69 if block ~ ~ ~ #minecraft:stairs[facing=south,half=bottom] run teleport @s ~ ~0.5 ~
execute positioned as @s if score #posz Time matches 30..79 if block ~ ~ ~ #minecraft:stairs[facing=north,half=bottom] run teleport @s ~ ~0.5 ~