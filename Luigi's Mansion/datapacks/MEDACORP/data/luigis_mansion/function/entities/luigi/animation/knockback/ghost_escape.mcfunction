...
execute if entity @s[scores={AnimationProgress=1}] run function luigis_mansion:entities/luigi/make_sound/force {high:"luigis_mansion:entity.player.ghost_escape.high_health",medium:"luigis_mansion:entity.player.ghost_escape.high_health",low:"luigis_mansion:entity.player.ghost_escape.low_health",duration:20}
execute if entity @s[scores={AnimationProgress=21}] run function luigis_mansion:entities/luigi/make_sound/force {high:"luigis_mansion:entity.player.hurt_flip.back",medium:"luigis_mansion:entity.player.hurt_flip.back",low:"luigis_mansion:entity.player.hurt_flip.back",duration:20}
