...
execute if entity @s[scores={AnimationProgress=14}] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~"}
...
execute if entity @s[scores={AnimationProgress=7..26}] run function luigis_mansion:entities/luigi/move/teleport {execute:"at @s rotated ~ 0",teleport:"^ ^ ^0.1 ~ ~"}
