...
execute if entity @s[scores={AnimationProgress=5,InteractionTime=1..}] run function luigis_mansion:entities/luigi/make_sound/simple {sound:"luigis_mansion:entity.player.punch"}
