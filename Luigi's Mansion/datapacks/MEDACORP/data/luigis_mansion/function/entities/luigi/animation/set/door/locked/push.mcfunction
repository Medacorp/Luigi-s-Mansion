...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/locked/push/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/locked/push/left"} run function luigis_mansion:entities/luigi/animation/set/none
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/locked/push/right"} unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"door/locked/push/left"} run function luigis_mansion:entities/luigi/animation/shared/set_home_rotation
