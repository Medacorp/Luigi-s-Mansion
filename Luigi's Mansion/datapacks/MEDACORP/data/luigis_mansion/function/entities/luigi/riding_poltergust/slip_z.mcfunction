...
execute if entity @s[scores={SlipZ=1..},tag=can_move_positive] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~0.008"}
execute if entity @s[scores={SlipZ=..-1},tag=can_move_negative] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~-0.008"}
...
execute unless score @s SlipZ matches 0 at @s run function luigis_mansion:entities/luigi/riding_poltergust/slip_z