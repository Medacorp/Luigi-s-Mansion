...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"opening"} run function luigis_mansion:entities/luigi/animation/set/none
