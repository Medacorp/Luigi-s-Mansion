...
execute if entity @s[scores={Health=..0},tag=!death_animation,tag=!revived_animation] unless entity @s[nbt={data:{animation:{}}},tag=!idle] run function luigis_mansion:entities/luigi/death
...
execute if entity @s[tag=!death_animation,tag=!revived_animation] unless entity @s[nbt={data:{animation:{}}},tag=!idle] run function luigis_mansion:blocks/gravity_swap
...
execute if entity @s[tag=!death_animation,tag=!revived_animation] run function luigis_mansion:entities/luigi/idle
...
execute unless entity @s[tag=!walking,tag=!running,tag=!sneaking] run function luigis_mansion:entities/luigi/walk_dust
