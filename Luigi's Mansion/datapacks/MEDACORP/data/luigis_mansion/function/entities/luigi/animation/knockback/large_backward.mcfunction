...
execute if entity @s[scores={AnimationProgress=..35}] run function luigis_mansion:entities/luigi/move/execute {execute:"at @s facing entity @e[type=minecraft:marker,tag=temp,limit=1] feet rotated ~ 0",teleport:"^ ^ ^-0.16 ~ ~"}
tag @s[scores={AnimationProgress=10}] add poltergust_floor_sound
...
execute if entity @s[tag=hit_wall_back] run function luigis_mansion:entities/luigi/animation/set/knockback/large_backward_wall
