...
execute unless data storage luigis_mansion:data entity.loot.drop_at_0 run data modify storage luigis_mansion:data entity.loot.drop_at_0.contents set from storage luigis_mansion:data current_state.current_data.ghosts.luigis_mansion.speedy_spirit.loot.drop_at_0.contents
...
execute store result storage luigis_mansion:data entity.loot.drop_at_0.contents.luigis_mansion.bill int 1 run scoreboard players add #temp Time 5
...
execute store result storage luigis_mansion:data entity.loot.drop_at_0.contents.luigis_mansion.gold_bar int 1 run scoreboard players add #temp Time 2
scoreboard players reset #temp Time