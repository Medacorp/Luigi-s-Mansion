...
execute store result score #temp Time run data get storage luigis_mansion:data entity.loot.contents.luigis_mansion.gold_coin
execute store result storage luigis_mansion:data entity.loot.contents.luigis_mansion.gold_coin int 1 run scoreboard players add #temp Time 10
...
execute store result storage luigis_mansion:data entity.loot.contents.luigis_mansion.bill int 1 run scoreboard players add #temp Time 15
scoreboard players reset #temp Time
