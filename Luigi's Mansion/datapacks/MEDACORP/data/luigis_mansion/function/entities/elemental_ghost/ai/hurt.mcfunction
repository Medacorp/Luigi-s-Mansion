...
execute at @s if block ~ ~-0.7 ~ #luigis_mansion:item_pull_ignore unless block ~ ~-0.7 ~ #minecraft:slabs[type=bottom] run tag @s remove bounce
execute at @s if block ~ ~-0.7 ~ #minecraft:slabs[type=bottom] if block ~ ~-1.1 ~ #minecraft:slabs[type=bottom] run tag @s remove bounce
execute at @s[tag=fire,tag=!bounce] unless block ~ ~-0.1 ~ #luigis_mansion:item_pull_ignore unless block ~ ~-0.1 ~ #minecraft:slabs run playsound luigis_mansion:entity.fire_elemental_ghost.bounce hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s[tag=water,tag=!bounce] unless block ~ ~-0.1 ~ #luigis_mansion:item_pull_ignore unless block ~ ~-0.1 ~ #minecraft:slabs run playsound luigis_mansion:entity.water_elemental_ghost.bounce hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s[tag=ice,tag=!bounce] unless block ~ ~-0.1 ~ #luigis_mansion:item_pull_ignore unless block ~ ~-0.1 ~ #minecraft:slabs run playsound luigis_mansion:entity.ice_elemental_ghost.bounce hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s unless block ~ ~-0.1 ~ #luigis_mansion:item_pull_ignore unless block ~ ~-0.1 ~ #minecraft:slabs run tag @s add bounce
