...
execute if data entity @s data.target_pos at @s facing entity @e[tag=target_pos,limit=1] feet run function luigis_mansion:entities/wool/move_forward
...
execute if entity @s[scores={TargetTime=0}] unless data entity @s data.target_pos run function luigis_mansion:entities/wool/go_to_next_path_step
