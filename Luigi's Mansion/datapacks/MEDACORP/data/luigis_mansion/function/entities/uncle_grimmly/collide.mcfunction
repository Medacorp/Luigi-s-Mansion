execute as @e[tag=luigi,scores={Invulnerable=0},distance=..1.6] run function luigis_mansion:entities/luigi/grant_advancement {id:"luigis_mansion:vanilla/waluigi_pinball/uncle_grimmly"}
