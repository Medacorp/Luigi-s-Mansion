...
execute if score #the_artists_studio Wave matches 9 if entity @e[tag=same_room,tag=luigi,distance=..5,limit=1] run scoreboard players add @s[scores={Dialog=4}] Dialog 1
...
execute if entity @s[scores={Dialog=3}] run function luigis_mansion:room/normal/the_artists_studio/wave_2 
execute if entity @s[scores={Dialog=3..4}] as @a[tag=same_room] run function luigis_mansion:other/music/set/mini_game
