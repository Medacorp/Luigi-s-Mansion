...
execute at @s[scores={AnimationProgress=5..14}] positioned ^ ^ ^-0.1 run function luigis_mansion:entities/player/set_position
execute at @s[scores={AnimationProgress=15..34}] positioned ^ ^ ^0.1 run function luigis_mansion:entities/player/set_position
