...
execute at @s[scores={Shrunk=0}] rotated ~ 0 if block ^0.5 ^1 ^ #luigis_mansion:all_ignore run tag @s add can_move_left
execute at @s rotated ~ 0 if block ^-0.5 ^0.2 ^ #luigis_mansion:all_ignore run tag @s add can_move_right
execute at @s[scores={Shrunk=0}] rotated ~ 0 if block ^-0.5 ^1 ^ #luigis_mansion:all_ignore run tag @s add can_move_right
