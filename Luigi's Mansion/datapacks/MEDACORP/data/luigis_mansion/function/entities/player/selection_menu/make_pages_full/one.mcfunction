...
data modify storage luigis_mansion:data inventory append value {Slot:1b,id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:menu/previous_page","minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:attribute_modifiers":{modifiers:[]},"minecraft:item_name":'{"type":"translatable","translate":"luigis_mansion:item.menu.previous_page"}',"minecraft:custom_data":{namespace:"luigis_mansion",id:"menu_option",option:{id:"previous_page"},kill:1b}}}