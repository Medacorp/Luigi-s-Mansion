...
execute unless data storage luigis_mansion:data my_memory.animation run scoreboard players add @s[tag=!warp,tag=!scanning,tag=!poltergust_selected,tag=!riding_poltergust,tag=!walking] IdleTime 1
execute unless data storage luigis_mansion:data my_memory.animation unless entity @s[tag=!warp,tag=!scanning,tag=!poltergust_selected,tag=!riding_poltergust,tag=!walking] run scoreboard players set @s IdleTime 0
