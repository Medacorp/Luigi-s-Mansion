...
execute at @e[tag=ghost,tag=same_room,tag=!vacuumable,tag=!visible,tag=!vanish,tag=!hidden] run particle minecraft:dust{color:[1f,0f,0f],scale:1f} ~ ~1.6 ~ 0.3 0.3 0.3 0 5 normal @s
tag @s add me
