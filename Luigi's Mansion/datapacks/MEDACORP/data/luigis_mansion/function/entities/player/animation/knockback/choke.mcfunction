...
execute if entity @s[scores={AnimationProgress=2..120,Invulnerable=0}] run function luigis_mansion:entities/player/damage
...
execute if entity @s[scores={AnimationProgress=121..}] run function luigis_mansion:entities/player/animation/set/choke_recover