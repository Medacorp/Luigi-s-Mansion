...
execute if entity @s[scores={Walk=1..},tag=!looking_at_map] at @e[type=minecraft:marker,tag=temp,limit=1] run particle minecraft:dust{color:8355711,scale:1.2f} ~ ~0.2 ~ 0 0 0 0 1
execute if entity @s[scores={Run=1..},tag=!looking_at_map] at @e[type=minecraft:marker,tag=temp,limit=1] run particle minecraft:dust{color:8355711,scale:2f} ~ ~0.2 ~ 0 0 0 0 1
execute if entity @s[scores={Sneak=1..},tag=!looking_at_map] at @e[type=minecraft:marker,tag=temp,limit=1] run particle minecraft:dust{color:8355711,scale:0.7f} ~ ~0.2 ~ 0 0 0 0 1
