...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"idle"} run function luigis_mansion:entities/player/animation/set/none
