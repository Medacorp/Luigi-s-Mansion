...
execute if entity @s[tag=stop_model] store result entity @e[tag=model_positon,limit=1] Pos[0] double 0.01 run scoreboard players get @s ModelPositionX
execute if entity @s[tag=stop_model] store result entity @e[tag=model_positon,limit=1] Pos[1] double 0.01 run scoreboard players get @s ModelPositionY
execute if entity @s[tag=stop_model] store result entity @e[tag=model_positon,limit=1] Pos[2] double 0.01 run scoreboard players get @s ModelPositionZ
execute if entity @s[tag=stop_model] store result entity @e[tag=model_positon,limit=1] Rotation[1] float 1 run scoreboard players get @s ModelRotationX
execute if entity @s[tag=stop_model] store result entity @e[tag=model_positon,limit=1] Rotation[0] float 1 run scoreboard players get @s ModelRotationY
execute if entity @s[tag=stop_model] at @e[tag=model_positon,limit=1] run teleport @s ~ ~ ~ ~ ~
kill @e[tag=model_positon,limit=1]
$execute at @s rotated $(rotated) run teleport @s $(teleport)
