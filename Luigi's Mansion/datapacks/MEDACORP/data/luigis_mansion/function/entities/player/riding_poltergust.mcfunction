...
tag @s[scores={AnimationProgress=1..},tag=!idle,tag=!animation_may_move] remove riding_poltergust

execute unless score @s SlipX matches 0 at @s[tag=riding_poltergust,scores={TeleportDelayTimer=0}] run function luigis_mansion:entities/player/riding_poltergust/slip_x
execute unless score @s SlipZ matches 0 at @s[tag=riding_poltergust,scores={TeleportDelayTimer=0}] run function luigis_mansion:entities/player/riding_poltergust/slip_z
