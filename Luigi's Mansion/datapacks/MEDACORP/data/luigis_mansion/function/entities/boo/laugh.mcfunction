...
execute if entity @s[scores={ActionTime=20}] unless entity @a[tag=!spectator,distance=..7] if predicate luigis_mansion:boo/laugh_turn_to_taunt_chance run tag @s add taunt
