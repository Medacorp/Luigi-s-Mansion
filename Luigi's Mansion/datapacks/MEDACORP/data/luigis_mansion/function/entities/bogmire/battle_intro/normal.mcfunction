...
execute if entity @s[scores={Dialog=200..239}] as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if entity @s[scores={Dialog=240}] as @a[tag=same_room] run function luigis_mansion:entities/player/animation/set/scare/normal
execute if entity @s[scores={Dialog=260..459}] as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
