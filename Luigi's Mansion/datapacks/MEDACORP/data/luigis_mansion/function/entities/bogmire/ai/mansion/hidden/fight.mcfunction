...
execute if entity @s[scores={Dialog=310,VulnerableTime=0}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/warp
...
execute if entity @s[scores={Dialog=382}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=402}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
tag @s[scores={Dialog=412}] remove visible
execute if entity @s[scores={Dialog=422}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=442}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=462}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
