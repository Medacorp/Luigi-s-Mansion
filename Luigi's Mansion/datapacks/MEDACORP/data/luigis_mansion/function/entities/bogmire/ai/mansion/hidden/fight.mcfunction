...
execute if entity @s[scores={Dialog=110,VulnerableTime=0}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/warp
...
execute if entity @s[scores={Dialog=182}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=202}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
tag @s[scores={Dialog=212}] remove visible
execute if entity @s[scores={Dialog=222}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=242}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=262}] run function luigis_mansion:entities/bogmire/ai/mansion/hidden/instant_spawn
execute if entity @s[scores={Dialog=281}] run scoreboard players set @s Dialog 109
