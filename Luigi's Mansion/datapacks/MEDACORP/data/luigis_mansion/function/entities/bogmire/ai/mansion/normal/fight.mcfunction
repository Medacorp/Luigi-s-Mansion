...
scoreboard players add @s[scores={VulnerableTime=0,Dialog=..379}] Dialog 1
...
tag @s[scores={Dialog=180}] remove visible

data remove entity @s[scores={Dialog=200}] data.animation
tag @s[scores={Dialog=340,VulnerableTime=0}] remove visible
execute if entity @s[scores={Dialog=380,VulnerableTime=0}] run function luigis_mansion:entities/bogmire/ai/mansion/normal/warp
...
execute if entity @s[scores={Dialog=481}] run scoreboard players set @s Dialog 379
...
scoreboard players set @s[scores={VulnerableTime=1}] Dialog 339
