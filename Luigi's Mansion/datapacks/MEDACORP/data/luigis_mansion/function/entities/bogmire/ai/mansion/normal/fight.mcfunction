...
tag @s[scores={Dialog=140,VulnerableTime=0}] remove visible
execute if entity @s[scores={Dialog=180,VulnerableTime=0}] run function luigis_mansion:entities/bogmire/ai/mansion/normal/warp
