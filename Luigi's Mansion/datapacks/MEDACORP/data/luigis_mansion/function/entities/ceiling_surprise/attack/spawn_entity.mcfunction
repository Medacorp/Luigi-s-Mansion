...
data modify entity @s[scores={ActionTime=1},tag=successful_spawn] data.loot set from entity @s data.loot_storage.spawn_attack
execute if data entity @s[scores={ActionTime=1},tag=successful_spawn] data.loot run data modify entity @s data.loot.owner set from entity @s UUID
