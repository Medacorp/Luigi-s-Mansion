...
execute as @a[tag=same_room] if score #temp ID = @s ID at @s positioned ~ ~0.5 ~ positioned ^ ^ ^0.5 run particle minecraft:dust{color:11730943,scale:1f} ~ ~ ~ 0.2 0.2 0.2 1 10
