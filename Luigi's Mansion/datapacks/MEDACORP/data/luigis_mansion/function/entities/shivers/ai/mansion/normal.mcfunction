scoreboard players set @s[x=713,y=8,z=-35,dx=7,dy=9,dz=60] Room 11
scoreboard players set @s[x=686,y=8,z=-23,dx=26,dy=9,dz=8] Room 12
scoreboard players set @s[x=679,y=8,z=-30,dx=6,dy=9,dz=42] Room 13
scoreboard players set @s[x=712,y=8,z=57,dx=8,dy=9,dz=20] Room 22
scoreboard players set @s[x=737,y=8,z=53,dx=14,dy=9,dz=20] Room 23
...
execute if entity @s[scores={ActionTime=1}] unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{shivers_spoke:1b} run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.shivers",color:"green"},{type:"translatable",translate:"luigis_mansion:message.shivers.fire"}]}
execute if entity @s[scores={ActionTime=1}] run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data merge value {shivers_spoke:1b}
...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:1b} run tag @s add remove_from_existence
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.butlers_room{cleared:1b} run tag @s add remove_from_existence
