...
tag @s[scores={ElementHurtTime=0},tag=!element_hurt_now] remove element_hurt
tag @s[scores={ElementHurtTime=0},tag=!element_hurt_now,tag=elemental_freeze_animation] remove freeze_animation
tag @s[scores={ElementHurtTime=0},tag=!element_hurt_now] remove freeze
tag @s[scores={ElementHurtTime=0},tag=!element_hurt_now] remove elemental_freeze_animation
scoreboard players set @s[scores={ElementHurtTime=0},tag=element_hurt_now] ElementHurtTime -1
tag @s remove element_hurt_now