...
execute at @s[tag=!no_height_change,tag=!new_ghost,tag=!ceiling_ghost] unless block ~ ~ ~ #luigis_mansion:all_ignore if block ~ ~1 ~ #luigis_mansion:all_ignore if block ~ ~2 ~ #luigis_mansion:all_ignore run teleport @s ~ ~1 ~
execute at @s[tag=!no_height_change,tag=!new_ghost,tag=!ceiling_ghost] if block ~ ~ ~ #minecraft:slabs if block ~ ~1 ~ #luigis_mansion:all_ignore if block ~ ~2 ~ #luigis_mansion:all_ignore run teleport @s ~ ~1 ~
execute at @s[tag=!no_height_change,tag=!new_ghost,tag=!ceiling_ghost] if block ~ ~ ~ #minecraft:stairs if block ~ ~1 ~ #luigis_mansion:all_ignore if block ~ ~2 ~ #luigis_mansion:all_ignore run teleport @s ~ ~1 ~
