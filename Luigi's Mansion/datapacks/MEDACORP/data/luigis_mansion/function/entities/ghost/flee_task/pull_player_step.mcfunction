...
execute if score #temp Move matches 1.. positioned as @s unless entity @e[tag=me,distance=..3] run function luigis_mansion:entities/ghost/flee_task/pull_player_step