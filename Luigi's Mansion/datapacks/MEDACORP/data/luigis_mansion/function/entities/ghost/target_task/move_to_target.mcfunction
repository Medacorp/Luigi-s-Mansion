...
execute if score #temp Move matches -1 at @s if block ~ ~2 ~ #luigis_mansion:ghosts_ignore run teleport @s[tag=!flipped_gravity] ~ ~0.1 ~
execute if score #temp Move matches -1 at @s if block ~ ~2 ~ #luigis_mansion:ghosts_ignore run teleport @s[tag=flipped_gravity] ~ ~-0.1 ~
execute if score #temp Move matches -1 at @s if block ~ ~1 ~ #luigis_mansion:ghosts_ignore run teleport @s[tag=vacuumable,tag=!flipped_gravity] ~ ~0.1 ~
execute if score #temp Move matches -1 at @s if block ~ ~1 ~ #luigis_mansion:ghosts_ignore run teleport @s[tag=vacuumable,tag=flipped_gravity] ~ ~-0.1 ~
