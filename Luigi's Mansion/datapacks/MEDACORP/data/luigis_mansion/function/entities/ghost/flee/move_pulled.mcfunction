...
execute if score #temp Move matches ..-1 positioned as @s unless entity @a[tag=vacuuming_me,distance=..3,limit=1] run function luigis_mansion:entities/ghost/flee/move_pulled