...
execute if score #temp Move matches 1.. positioned as @s unless entity @e[tag=target_pos,distance=..0.1] run function luigis_mansion:entities/ghost/move_backward