...
execute if data entity @s data.pearl_assign_rank run data modify storage luigis_mansion:data entity.assign_rank.namespace set from entity @s data.pearl_assign_rank.namespace
execute if data entity @s data.pearl_assign_rank run data modify storage luigis_mansion:data entity.assign_rank.id set from entity @s data.pearl_assign_rank.id
