...
execute if score #temp MoveFlee matches 1.. positioned as @s if entity @a[tag=vacuuming_me,distance=..2.99,limit=1] run function luigis_mansion:entities/ghost/flee_task/move_in_range_ground_bound