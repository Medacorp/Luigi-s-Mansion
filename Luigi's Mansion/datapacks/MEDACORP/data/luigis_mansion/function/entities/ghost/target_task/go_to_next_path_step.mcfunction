...
execute if data entity @s data.path.steps[0] store result score @s TargetTime run data get entity @s data.step.wait
execute if data entity @s data.path.steps[0] if data entity @s data.path{loop:1b} run data modify entity @s data.path.steps append from entity @s data.step
execute if data entity @s data.path.steps[0] run data remove entity @s data.path.steps[0]
data remove entity @s data.step