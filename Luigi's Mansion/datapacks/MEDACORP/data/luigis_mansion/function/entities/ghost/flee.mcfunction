...
execute if entity @s[tag=is_pulled,tag=!always_pull_players] unless entity @a[tag=!spectator,distance=..3,tag=vacuuming_me,limit=1] run function luigis_mansion:entities/ghost/flee_task/pulled
