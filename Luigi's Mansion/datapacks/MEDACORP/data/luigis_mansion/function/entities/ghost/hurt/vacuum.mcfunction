...
execute if entity @s[tag=portrait_ghost,tag=!no_timer_loot] run function luigis_mansion:room/loot_timer with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
