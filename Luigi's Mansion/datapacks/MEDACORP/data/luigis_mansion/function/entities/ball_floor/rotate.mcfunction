...
execute if entity @s[tag=left] as @e[distance=..4.999999,tag=luigi,scores={TeleportDelayTimer=0}] run function luigis_mansion:entities/ball_floor/rotate_left
execute if entity @s[tag=!left] as @e[distance=..4.999999,tag=luigi,scores={TeleportDelayTimer=0}] run function luigis_mansion:entities/ball_floor/rotate_right
