...
execute if entity @s[tag=in_vacuum] facing entity @a[tag=vacuuming_me,sort=nearest,limit=1] feet run function luigis_mansion:entities/vacuumable_object/pull
