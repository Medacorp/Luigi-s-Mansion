execute if block ~ ~-0.35 ~ #luigis_mansion:items_ignore run teleport @s ~ ~-0.2 ~
execute unless block ~ ~-0.35 ~ #luigis_mansion:items_ignore align y run teleport @s ~ ~0.625 ~
