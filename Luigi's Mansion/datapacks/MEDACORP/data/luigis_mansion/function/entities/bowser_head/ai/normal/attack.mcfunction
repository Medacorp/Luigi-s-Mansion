...
execute at @e[tag=luigi,tag=target,limit=1] unless entity @s[distance=..5] positioned ~ ~6.01 ~ unless entity @s[distance=..5] at @s rotated ~ 0 run function luigis_mansion:entities/ghost/move_forward_force
