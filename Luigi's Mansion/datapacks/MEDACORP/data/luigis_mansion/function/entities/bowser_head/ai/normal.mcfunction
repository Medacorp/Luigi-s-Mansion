...
execute if score #temp Time matches 1.. if entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] run function luigis_mansion:entities/bowser_head/ai/normal/attack
