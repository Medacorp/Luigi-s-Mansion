...
execute if entity @s[scores={ActionTime=1},tag=visible,tag=!disappear] run playsound luigis_mansion:entity.slim_bankshot.disappear hostile @a[tag=same_room] ~ ~ ~ 1
