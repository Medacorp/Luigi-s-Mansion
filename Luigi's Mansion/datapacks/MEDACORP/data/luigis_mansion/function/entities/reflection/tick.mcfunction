...
execute unless entity @s[tag=static,tag=!force_sync] if entity @s[type=minecraft:item_frame] if data storage luigis_mansion:data mirror run function luigis_mansion:entities/reflection/sync/item_frame
#/todelete
