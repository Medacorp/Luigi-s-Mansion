...
execute if entity @s[tag=!reached_target,scores={TargetTask=0}] if entity @e[tag=exact_same_room,tag=!spectator,tag=player,distance=..10,limit=1] run function luigis_mansion:entities/purple_bat/attack with entity @s data.entity
