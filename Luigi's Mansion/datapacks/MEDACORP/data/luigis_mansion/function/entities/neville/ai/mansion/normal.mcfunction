...
execute positioned ~ ~-0.2 ~ store result entity @s data.initial_animation_progress int 1 run scoreboard players get @e[tag=rocking_chair,distance=..1,limit=1] AnimationProgress
...
execute positioned ~ ~-0.2 ~ if entity @e[tag=rocking_chair,distance=..1,scores={AnimationProgress=1..20},limit=1] at @s run teleport @s ^ ^ ^0.01
execute positioned ~ ~-0.2 ~ if entity @e[tag=rocking_chair,distance=..1,scores={AnimationProgress=21..60},limit=1] at @s run teleport @s ^ ^ ^-0.01
execute positioned ~ ~-0.2 ~ if entity @e[tag=rocking_chair,distance=..1,scores={AnimationProgress=61..80},limit=1] at @s run teleport @s ^ ^ ^0.01
