...
execute if entity @s[tag=!lit,tag=!dark_room] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.on
execute if entity @s[tag=!lit,tag=!dark_room] run tag @s add lit
execute if entity @s[tag=lit,tag=dark_room] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.off
