...
$execute at @s[scores={TeleportDelayTimer=0}] facing $(facing_x) $(facing_y) $(facing_z) positioned $(facing_x) $(facing_y) $(facing_z) run function luigis_mansion:entities/furniture/type/poster/teleport with storage luigis_mansion:data macro
