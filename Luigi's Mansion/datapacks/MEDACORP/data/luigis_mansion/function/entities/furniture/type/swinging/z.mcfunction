...
execute if score @s FurnitureVacuum matches ..-1 run scoreboard players operation @s FurnitureVacuum < @s FurnitureZTarget
execute if score @s FurnitureVacuum matches 1.. if score @s FurnitureZTarget matches ..-1 run scoreboard players operation @s FurnitureVacuum *= #-1 Constants
execute if score @s FurnitureVacuum matches 1.. run scoreboard players operation @s FurnitureVacuum > @s FurnitureZTarget
execute if score @s FurnitureVacuum matches 0 run scoreboard players operation @s FurnitureVacuum = @s FurnitureZTarget
