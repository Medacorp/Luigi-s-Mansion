...
tag @s add me
execute as @e[tag=collision_direction,limit=1] facing entity @s feet run function luigis_mansion:entities/furniture/type/swinging/harm
tag @e[tag=hit_by_swing] remove hit_by_swing
tag @s remove me
...
scoreboard players reset @e[tag=collision_direction,limit=1]
kill @e[tag=collision_direction,limit=1]