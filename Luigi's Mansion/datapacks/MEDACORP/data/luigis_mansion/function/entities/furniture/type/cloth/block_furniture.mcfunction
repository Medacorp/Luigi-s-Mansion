scoreboard operation #temp PositionX = @s PositionX
scoreboard operation #temp PositionY = @s PositionY
execute store result score #temp Time run data get entity @s data.default_transformation[5] 10
execute if entity @s[tag=hanging_furniture] run scoreboard operation #temp PositionY -= #temp Time
execute if entity @s[tag=standing_furniture] run scoreboard operation #temp PositionY += #temp Time
scoreboard operation #temp PositionZ = @s PositionZ
...
scoreboard reset #temp PositionX
scoreboard reset #temp PositionY
scoreboard reset #temp PositionZ
scoreboard reset #temp Time
