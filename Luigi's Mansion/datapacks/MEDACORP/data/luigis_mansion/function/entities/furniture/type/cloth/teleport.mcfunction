...
execute if entity @s[tag=potential_pull,scores={TeleportDelay=0..}] run function luigis_mansion:entities/furniture/type/cloth/teleport with storage luigis_mansion:data macro