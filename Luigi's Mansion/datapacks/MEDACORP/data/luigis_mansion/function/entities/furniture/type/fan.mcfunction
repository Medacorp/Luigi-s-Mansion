...
tag @s[tag=in_vacuum,tag=shaken_by_vacuum] add increase_speed
tag @s[tag=in_dust,tag=shaken_by_dust] add increase_speed
tag @s[tag=in_fire,tag=shaken_by_fire] add increase_speed
tag @s[tag=in_water,tag=shaken_by_water] add increase_speed
tag @s[tag=in_ice,tag=shaken_by_ice] add increase_speed
