summon minecraft:marker ~ ~1.43875 ~ {Tags:["collision_check","x","remove_from_existence"]}
teleport @e[tag=collision_check,tag=x,limit=1] ~ ~1.43875 ~ ~ ~
...
execute as @e[tag=collision_check,tag=x,limit=1] at @s unless score #forward Steps matches 0 run function luigis_mansion:entities/furniture/type/swinging/hit_pos/move_forward
...
execute as @e[tag=collision_check,tag=x,limit=1] run function luigis_mansion:entities/furniture/type/swinging/hit_pos/make_pos_relative