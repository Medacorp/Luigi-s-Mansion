...
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 unless entity @e[tag=luigi,dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^1 unless entity @e[tag=luigi,dx=0,dy=0,dz=0,limit=1] run scoreboard players set @s FurnitureSearch 0
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 if entity @e[tag=luigi,tag=can_trigger_treadmill,dx=0,dy=0,dz=0,limit=1] run scoreboard players add @s FurnitureSearch 1
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 unless entity @e[tag=luigi,tag=can_trigger_treadmill,dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^1 if entity @e[tag=luigi,tag=can_trigger_treadmill,dx=0,dy=0,dz=0,limit=1] run scoreboard players add @s FurnitureSearch 1
...
execute unless score @s FurnitureShake = @s FurnitureSearch store result score #temp Time run data get entity @s item.components."minecraft:custom_model_data".floats[0]
execute unless score @s FurnitureShake = @s FurnitureSearch store result entity @s item.components."minecraft:custom_model_data".floats[0] float 1 run scoreboard players add #temp Time 1
execute unless score @s FurnitureShake = @s FurnitureSearch if score #temp Time matches 9.. store result entity @s item.components."minecraft:custom_model_data".floats[0] float 1 run scoreboard players set #temp Time 0
...
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 as @e[tag=luigi,scores={TeleportDelayTimer=0},dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^-0.9 as @s[dx=0,dy=0,dz=0] positioned as @s run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ^ ^ ^0.6",teleport:"~ ~ ~"}
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 as @e[tag=luigi,scores={TeleportDelayTimer=0},dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^-0.8 as @s[dx=0,dy=0,dz=0] positioned as @s run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ^ ^ ^0.5",teleport:"~ ~ ~"}
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 as @e[tag=luigi,scores={TeleportDelayTimer=0},dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^-0.7 as @s[dx=0,dy=0,dz=0] positioned as @s run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ^ ^ ^0.4",teleport:"~ ~ ~"}
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 as @e[tag=luigi,scores={TeleportDelayTimer=0},dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^-0.6 as @s[dx=0,dy=0,dz=0] positioned as @s run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ^ ^ ^0.3",teleport:"~ ~ ~"}
execute positioned ~-0.5 ~0.38875 ~-0.5 positioned ^ ^ ^-0.5 as @e[tag=luigi,scores={TeleportDelayTimer=0},dx=0,dy=0,dz=0,limit=1] positioned ^ ^ ^-0.5 as @s[dx=0,dy=0,dz=0] positioned as @s run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ^ ^ ^0.2",teleport:"~ ~ ~"}
