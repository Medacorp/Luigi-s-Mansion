...
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_dust] FurnitureSearch = @s FurnitureDust run scoreboard players operation @s SearcherID = @e[tag=same_room,tag=dusting_me,sort=nearest,limit=1] ID
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_dust] FurnitureSearch = @s FurnitureDust run function luigis_mansion:entities/furniture/search/generic
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_fire] FurnitureSearch = @s FurnitureFire run scoreboard players operation @s SearcherID = @e[tag=same_room,tag=burning_me,sort=nearest,limit=1] ID
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_fire] FurnitureSearch = @s FurnitureFire run function luigis_mansion:entities/furniture/search/generic
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_water] FurnitureSearch = @s FurnitureWater run scoreboard players operation @s SearcherID = @e[tag=same_room,tag=watering_me,sort=nearest,limit=1] ID
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_water] FurnitureSearch = @s FurnitureWater run function luigis_mansion:entities/furniture/search/generic
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_ice] FurnitureSearch = @s FurnitureIce run scoreboard players operation @s SearcherID = @e[tag=same_room,tag=freezing_me,sort=nearest,limit=1] ID
execute unless entity @s[tag=searchable_by_vacuum,scores={ActionTime=0},tag=!open] if score @s[tag=searchable_by_ice] FurnitureSearch = @s FurnitureIce run function luigis_mansion:entities/furniture/search/generic
tag @s[tag=!in_vacuum,tag=!in_dust,tag=!in_fire,tag=!in_water,tag=!in_ice,tag=!shake] add idle_furniture