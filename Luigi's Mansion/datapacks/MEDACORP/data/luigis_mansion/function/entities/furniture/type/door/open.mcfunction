execute if data entity @s data.key run function luigis_mansion:entities/furniture/type/door/check_lock with entity @s data
...
execute if entity @s[tag=unlock,tag=push] as @e[tag=luigi,tag=try_opening_door,limit=1,sort=nearest] run function luigis_mansion:entities/luigi/animation/set/door/unlock/push with entity @e[tag=me,limit=1] data
execute if entity @s[tag=unlock,tag=!push] as @e[tag=luigi,tag=try_opening_door,limit=1,sort=nearest] run function luigis_mansion:entities/luigi/animation/set/door/unlock/pull with entity @e[tag=me,limit=1] data
tag @s remove me
