...
execute if entity @s[scores={ActionTime=21}] align xz run playsound luigis_mansion:furniture.chandelier.spin hostile @a[tag=same_room] ~ ~ ~ 2
execute if entity @s[scores={ActionTime=31}] align xz run playsound luigis_mansion:furniture.chandelier.spin hostile @a[tag=same_room] ~ ~ ~ 2
execute if entity @s[scores={ActionTime=41}] align xz run playsound luigis_mansion:furniture.chandelier.spin hostile @a[tag=same_room] ~ ~ ~ 2
execute if entity @s[scores={ActionTime=51}] align xz run playsound luigis_mansion:furniture.chandelier.spin hostile @a[tag=same_room] ~ ~ ~ 2
execute if entity @s[scores={ActionTime=61}] align xz run playsound luigis_mansion:furniture.chandelier.spin hostile @a[tag=same_room] ~ ~ ~ 2
execute if entity @s[scores={ActionTime=71,Sound=0}] align xz run playsound luigis_mansion:furniture.chandelier.fall hostile @a[tag=same_room] ~ ~ ~ 2
