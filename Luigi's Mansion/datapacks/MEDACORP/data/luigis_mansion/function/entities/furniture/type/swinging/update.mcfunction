...
execute store result entity @e[tag=temp,limit=1] Rotation[0] float 0.005 run scoreboard players get #temp AnimationRotationCosX
execute as @e[tag=temp,limit=1] at @s positioned 0.0 0.0 0.0 run teleport @s ^ ^ ^1
execute store result score #temp AnimationRotationCosX run data get entity @e[tag=temp,limit=1] Pos[2] 1000
...
execute store result entity @e[tag=temp,limit=1] Rotation[0] float 0.005 run scoreboard players get #temp AnimationRotationCosZ
execute as @e[tag=temp,limit=1] at @s positioned 0.0 0.0 0.0 run teleport @s ^ ^ ^1
execute store result score #temp AnimationRotationCosZ run data get entity @e[tag=temp,limit=1] Pos[2] 1000
execute as @e[tag=temp,limit=1] at @s positioned 0.001 0.0 0.0 run teleport @s ^ ^ ^-1
...
execute if entity @s[scores={FurnitureXProgress=0,FurnitureXTarget=0,FurnitureXOrigin=0}] run scoreboard players reset @s FurnitureXOrigin
execute unless entity @s[scores={FurnitureXProgress=0,FurnitureXTarget=0}] unless entity @s[scores={FurnitureXOrigin=-1800..1800}] run scoreboard players set @s FurnitureXOrigin 0
execute unless entity @s[scores={FurnitureXOrigin=-1800..1800}] run scoreboard players reset @s FurnitureXTarget
#z=sin(1/2roll)*cos(1/2pitch)
...
execute if entity @s[scores={FurnitureZProgress=0,FurnitureZTarget=0,FurnitureZOrigin=0}] run scoreboard players reset @s FurnitureZOrigin
execute unless entity @s[scores={FurnitureZProgress=0,FurnitureZTarget=0}] unless entity @s[scores={FurnitureZOrigin=-1800..1800}] run scoreboard players set @s FurnitureZOrigin 0
execute unless entity @s[scores={FurnitureZOrigin=-1800..1800}] run scoreboard players reset @s FurnitureZTarget
#w=sqrt(1-x^2-z^2)
