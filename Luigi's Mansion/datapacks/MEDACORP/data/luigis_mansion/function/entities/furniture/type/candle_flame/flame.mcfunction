...
execute if entity @s[tag=lit,tag=!purple,tag=!large_flame] unless entity @s[tag=was_lit,tag=!was_purple] run data modify entity @s equipment.head.components."minecraft:custom_model_data".floats[0] set value 1f
execute if entity @s[tag=lit,tag=purple,tag=!large_flame] unless entity @s[tag=was_lit,tag=was_purple] run data modify entity @s equipment.head.components."minecraft:custom_model_data".floats[0] set value 2f
