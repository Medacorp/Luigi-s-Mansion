...
data modify entity @s[tag=push] data.animation set value {namespace:"luigis_mansion",id:"unlock/push"}
data modify entity @s[tag=!push] data.animation set value {namespace:"luigis_mansion",id:"unlock/pull"}

data remove entity @s[scores={AnimationProgress=260}] data.animation
