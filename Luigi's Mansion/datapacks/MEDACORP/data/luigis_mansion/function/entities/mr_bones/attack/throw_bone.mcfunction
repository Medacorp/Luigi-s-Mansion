...
data modify entity @s[scores={ActionTime=40}] data.loot set from entity @s data.loot_storage.attack
execute if data entity @s[scores={ActionTime=40}] data.loot run data modify entity @s data.loot.contents[].variables.owner set from entity @s UUID
execute if data entity @s[scores={ActionTime=40}] data.loot run function luigis_mansion:other/drop_loot
