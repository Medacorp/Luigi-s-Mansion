...
execute if entity @s[tag=appear] run function luigis_mansion:entities/henry/appear
execute if entity @s[tag=laugh] run function luigis_mansion:entities/henry/laugh
