...
scoreboard players set @s[scores={WaitTime=61..80}] TargetTask 0

execute if entity @s[scores={WaitTime=1}] run data modify entity @s data.target_pos set from entity @e[tag=target,sort=nearest,limit=1] Pos
data modify entity @s[scores={WaitTime=1}] data.target_pos[1] set from entity @s Pos[1]
execute if entity @s[scores={WaitTime=81}] run data modify entity @s data.target_pos set from entity @e[tag=target,sort=nearest,limit=1] Pos
data modify entity @s[scores={WaitTime=81}] data.target_pos[1] set from entity @s Pos[1]
execute at @s[scores={WaitTime=61..80}] run function luigis_mansion:entities/henry/ai/mansion/normal/drift
