execute positioned ~-1 ~ ~-1 run tag @e[type=minecraft:item_display,tag=wool,tag=spit,dx=1,dy=3,dz=1] add hit_me
tag @e[type=minecraft:item_display,tag=wool,tag=hit_me,limit=1] add remove_from_existence
scoreboard players add @s[scores={Dialog=25..}] Dialog 1
scoreboard players add @s[scores={Dialog=23}] Dialog 1
execute if entity @e[type=minecraft:item_display,tag=wool,tag=hit_me,limit=1] run scoreboard players set @s[scores={Dialog=13..22}] Dialog 23
scoreboard players add @s[scores={Dialog=13..21}] Dialog 1
execute if entity @e[type=minecraft:item_display,tag=wool,tag=hit_me,limit=1] run scoreboard players set @s[scores={Dialog=3..12}] Dialog 13
scoreboard players add @s[scores={Dialog=3..11}] Dialog 1
execute if entity @e[type=minecraft:item_display,tag=wool,tag=hit_me,limit=1] run scoreboard players set @s[scores={Dialog=2}] Dialog 3
...
execute if entity @s[scores={Dialog=2}] if entity @e[tag=wool,tag=can_spit,limit=1] run scoreboard players set @s TargetTask 5
execute if entity @s[scores={Dialog=3}] run playsound luigis_mansion:entity.nana.scream hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=12}] if entity @e[tag=wool,tag=can_spit,limit=1] run scoreboard players set @s TargetTask 5
execute if entity @s[scores={Dialog=12}] if entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:entities/nana/ai/mansion/normal/try_shoot
execute if entity @s[scores={Dialog=13}] run playsound luigis_mansion:entity.nana.scream hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=22}] if entity @e[tag=wool,tag=can_spit,limit=1] run scoreboard players set @s TargetTask 5
execute if entity @s[scores={Dialog=22}] if entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion:entities/nana/ai/mansion/normal/try_shoot
...
execute if entity @s[scores={Dialog=25}] run tag @e[tag=wool] add remove_from_existence
