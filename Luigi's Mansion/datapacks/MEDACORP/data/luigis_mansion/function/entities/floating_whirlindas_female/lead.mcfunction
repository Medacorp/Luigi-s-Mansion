...
execute if entity @s[scores={Dialog=300},nbt={data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,nbt={data:{entity:{namespace:"luigis_mansion",id:"floating_whirlindas_male"}}},limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.bow hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=400},nbt={data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,nbt={data:{entity:{namespace:"luigis_mansion",id:"floating_whirlindas_male"}}},limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.bow hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=400},nbt=!{data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] at @e[tag=partner,nbt={data:{entity:{namespace:"luigis_mansion",id:"floating_whirlindas_male"}}},limit=1] run playsound luigis_mansion:entity.floating_whirlindas.male.dance hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=400},nbt=!{data:{animation:{namespace:"luigis_mansion",id:"bow"}}}] run playsound luigis_mansion:entity.floating_whirlindas.female.dance hostile @a[tag=same_room] ~ ~ ~ 1
data remove entity @s[scores={Dialog=420}] data.animation
scoreboard players set @s[scores={Dialog=420}] Dialog 0

execute if entity @s[tag=!visible] run particle minecraft:dust{color:17429928,scale:1f} ~ ~0.6 ~ 0.3 0.3 0.3 0 5