...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{sue_pea_spoke:1b} run scoreboard players set @s[scores={Dialog=1}] Dialog 2
...
execute if entity @s[scores={Dialog=125}] unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{sue_pea_snored:1b} run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.sue_pea",color:"green"},{type:"translatable",translate:"luigis_mansion:dialog.sue_pea.3"}]}
execute if entity @s[scores={Dialog=125}] run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data merge value {sue_pea_snored:1b}
