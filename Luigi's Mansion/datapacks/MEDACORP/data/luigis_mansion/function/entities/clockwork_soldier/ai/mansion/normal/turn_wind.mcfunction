execute if entity @s[tag=!in_vacuum] unless score #mirrored Selected matches 1 run scoreboard players add @e[tag=this_wind,limit=1] AnimationRotationZ 100
execute if entity @s[tag=!in_vacuum] if score #mirrored Selected matches 1 run scoreboard players remove @e[tag=this_wind,limit=1] AnimationRotationZ 100
execute if entity @s[tag=in_vacuum] unless score #mirrored Selected matches 1 run scoreboard players remove @e[tag=this_wind,limit=1] AnimationRotationZ 400
execute if entity @s[tag=in_vacuum] if score #mirrored Selected matches 1 run scoreboard players add @e[tag=this_wind,limit=1] AnimationRotationZ 400
...
execute store result entity @e[tag=temp,limit=1] Rotation[0] float -0.05 run scoreboard players get @e[tag=this_wind,limit=1] AnimationRotationZ
