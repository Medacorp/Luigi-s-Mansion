...
execute if entity @a[tag=same_room,tag=!spectator,limit=1] run tag @s[scores={SpawnTime=..-1}] add spawn
execute if entity @s[tag=spawn,tag=!remove_from_existence] run function luigis_mansion:entities/hidden_boo/spawn
execute if entity @s[scores={SpawnTime=0},tag=!spawn] run function luigis_mansion:entities/hidden_boo/swap_spot with entity @s data.mansion
execute if entity @s[scores={SpawnTime=-2}] run function luigis_mansion:entities/hidden_boo/warp with entity @s data.mansion
