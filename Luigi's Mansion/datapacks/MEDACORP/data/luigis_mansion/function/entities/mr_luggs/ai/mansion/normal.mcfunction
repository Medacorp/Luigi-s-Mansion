...
execute unless entity @s[scores={Dialog=2..}] if entity @s[tag=visible] run data modify entity @e[tag=mr_luggs_food,limit=1] item.components."minecraft:item_model" set value "luigis_mansion:furniture/food"
execute if entity @s[tag=!visible] run data modify entity @e[tag=mr_luggs_food,limit=1] item.components."minecraft:item_model" set value "luigis_mansion:empty"
...
execute if entity @s[scores={Dialog=0..9}] as @e[tag=mr_luggs_food,limit=1] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.default
execute if entity @s[scores={Dialog=10..54}] as @e[tag=mr_luggs_food,limit=1] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.slightly_decreased
execute if entity @s[scores={Dialog=55..99}] as @e[tag=mr_luggs_food,limit=1] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.largely_decreased
...
execute if entity @s[scores={Dialog=100}] as @e[tag=mr_luggs_food,limit=1] run data modify entity @s item merge from entity @s item.components."minecraft:custom_data".model_data.open
