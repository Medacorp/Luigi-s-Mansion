...
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".owner if entity @a[distance=..0.7,tag=!spectator,limit=1] run function luigis_mansion:entities/ghost/owner_laugh with entity @s ArmorItems[3].components."minecraft:custom_data"
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".owner unless entity @a[distance=..0.7,tag=!spectator,limit=1] run function luigis_mansion:entities/ghost/owner_complain with entity @s ArmorItems[3].components."minecraft:custom_data"