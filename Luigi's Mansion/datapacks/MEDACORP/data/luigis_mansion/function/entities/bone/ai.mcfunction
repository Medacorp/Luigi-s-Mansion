...
execute positioned ~ ~-1.45 ~ if entity @e[distance=..0.7,tag=luigi] run tag @s[tag=!spooky_bone] add dead
execute if entity @s[tag=dead] positioned ~ ~-1.45 ~ run function luigis_mansion:entities/bone/hit
