...
execute if entity @e[distance=..10,tag=luigi,limit=1] run tag @s remove walk
execute if entity @e[distance=..10,tag=luigi,limit=1] run data remove entity @s data.animation
execute if entity @e[distance=..10,tag=luigi,limit=1] run scoreboard players reset @s ActionTime
