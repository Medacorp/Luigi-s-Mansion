...
execute if entity @s[scores={ActionTime=141}] store result storage luigis_mansion:data dialogs[0].bowser int 1 run scoreboard players get @s GhostNr
execute if entity @s[scores={ActionTime=141}] store result storage luigis_mansion:data dialogs[0].room int 1 run scoreboard players get @s Room
