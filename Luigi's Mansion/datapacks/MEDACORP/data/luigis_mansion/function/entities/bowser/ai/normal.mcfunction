...
execute if entity @s[tag=intro_done,tag=!decapitate,tag=!grabbing_head,tag=!headless_run] unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"bowser_head"}}},limit=1] run function luigis_mansion:entities/bowser/ai/normal/choice
