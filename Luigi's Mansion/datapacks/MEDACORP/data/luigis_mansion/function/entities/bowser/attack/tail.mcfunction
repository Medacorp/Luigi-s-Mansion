...
execute if entity @s[scores={ActionTime=11..30}] run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"tail"},amount:0,animation:{namespace:"luigis_mansion",id:"knockback/fall"},no_delete:1b}
