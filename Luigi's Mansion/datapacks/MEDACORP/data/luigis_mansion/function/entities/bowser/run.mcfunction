...
execute if entity @e[distance=..6,tag=luigi] run tag @s remove run
execute if entity @e[distance=..6,tag=luigi] run data remove entity @s data.animation
execute if entity @e[distance=..6,tag=luigi] run scoreboard players reset @s ActionTime
