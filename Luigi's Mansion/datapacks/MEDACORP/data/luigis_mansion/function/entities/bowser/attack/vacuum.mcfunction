...
execute if entity @s[scores={ActionTime=21..30}] positioned ^ ^0.9 ^4.667 run function luigis_mansion:entities/bowser/attack/vacuum/suck
scoreboard players reset #temp Time
execute if entity @s[scores={ActionTime=21..30}] at @e[tag=luigi,tag=got_sucked,distance=..6,sort=nearest,limit=1] run function luigis_mansion:entities/ghost/set_target
execute if entity @s[scores={ActionTime=21..30}] run tag @e[tag=luigi,tag=got_sucked,distance=..6,sort=nearest,limit=1] add vacuumed
...
execute if entity @s[scores={ActionTime=32..89}] as @e[tag=luigi,tag=target,limit=1] run function luigis_mansion:entities/luigi/move/execute {execute:"positioned ~ ~ ~",teleport:"^ ^3 ^-1"}
...
execute if entity @s[scores={ActionTime=90}] unless score #mirrored Selected matches 1 as @e[tag=luigi,tag=target,limit=1] rotated ~-45 0 run function luigis_mansion:entities/luigi/move/execute {execute:"positioned as @s",teleport:"^ ^2 ^2 ~-180 ~"}
execute if entity @s[scores={ActionTime=90}] if score #mirrored Selected matches 1 as @e[tag=luigi,tag=target,limit=1] rotated ~45 0 run function luigis_mansion:entities/luigi/move/execute {execute:"positioned as @s",teleport:"^ ^2 ^2 ~-180 ~"}
