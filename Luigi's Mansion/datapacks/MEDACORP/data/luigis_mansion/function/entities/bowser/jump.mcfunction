...
execute if entity @s[scores={ActionTime=55}] at @e[tag=same_room,tag=luigi,sort=random,limit=1] run teleport @s ~ ~ ~ ~ 0
...
execute unless entity @s[scores={ActionTime=51..85}] positioned ^ ^ ^-1 if entity @e[distance=..3,tag=luigi,limit=1] run function luigis_mansion:entities/bowser/collide
execute unless entity @s[scores={ActionTime=51..85}] at @e[tag=this_head,limit=1] positioned ^ ^1.4 ^ if entity @e[distance=..3,tag=luigi,limit=1] run function luigis_mansion:entities/bowser/collide
execute if entity @s[scores={ActionTime=51..85}] positioned ^ ^ ^-1 if entity @e[distance=..3,tag=luigi,limit=1] run function luigis_mansion:entities/bowser/crush
execute if entity @s[scores={ActionTime=51..85}] at @e[tag=this_head,limit=1] positioned ^ ^1.4 ^ if entity @e[distance=..3,tag=luigi,limit=1] run function luigis_mansion:entities/bowser/crush