...
execute at @s[scores={ActionTime=55..95}] positioned ~ ~-25 ~ unless entity @e[tag=same_room,tag=luigi,distance=..2,limit=1] facing entity @e[tag=same_room,tag=luigi,sort=random,limit=1] feet rotated ~ 0 positioned as @s run teleport @s ^ ^ ^1.5 ~ 0
