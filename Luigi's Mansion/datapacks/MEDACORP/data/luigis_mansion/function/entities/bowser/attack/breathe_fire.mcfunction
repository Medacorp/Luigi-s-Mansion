...
execute if data entity @s[scores={ActionTime=21..121}] data.loot at @s positioned ^ ^ ^12 run function luigis_mansion:other/drop_loot
...
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-1 ^0.5 ^9 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^1 ^0.5 ^8 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.5 ^9 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-1 ^0.5 ^8 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^1 ^0.5 ^7 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.5 ^8 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-1 ^0.5 ^7 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^0.8 ^0.6 ^6 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.6 ^7 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-0.8 ^0.6 ^6 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^0.6 ^0.7 ^5 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.7 ^6 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-0.6 ^0.7 ^5 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^0.4 ^0.8 ^4 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.8 ^5 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-0.4 ^0.8 ^4 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^0.2 ^0.9 ^3 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^0.9 ^4 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^-0.2 ^0.9 ^3 0 0 0 0 1 normal @a[tag=same_room]
execute at @s[scores={ActionTime=21..121}] positioned ^ ^ ^2 run particle minecraft:block{block_state:{Name:"minecraft:fire"}} ^ ^1 ^3 0 0 0 0 1 normal @a[tag=same_room]
