...
execute if score #conservatory Wave matches 2 if entity @a[tag=!spectator,distance=..5] run function luigis_mansion:entities/melody_pianissima/ai/mansion/normal/play
