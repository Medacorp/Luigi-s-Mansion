...
execute if entity @s[tag=!attack,tag=!collided,tag=!vanish,tag=!appear,tag=!laugh,tag=!complain,tag=!grab_ball,tag=grabbed_ball] run function luigis_mansion:entities/bowling_ghost/haunt with entity @s data.entity
...
execute if entity @s[tag=collided] run function luigis_mansion:entities/bowling_ghost/collided with entity @s data.entity
