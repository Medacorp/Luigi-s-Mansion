...
data modify entity @s[scores={ActionTime=1}] item merge from entity @s item.components."minecraft:custom_data".model_data.broken
data modify entity @s[scores={ActionTime=3}] item merge from entity @s item.components."minecraft:custom_data".model_data.invisible
...
data modify entity @s[scores={ActionTime=7}] item merge from entity @s item.components."minecraft:custom_data".model_data.default
