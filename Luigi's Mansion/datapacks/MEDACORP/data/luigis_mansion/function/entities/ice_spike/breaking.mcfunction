...
data modify entity @s[scores={ActionTime=1}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.breaking
data modify entity @s[scores={ActionTime=3}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.invisible
...
data modify entity @s[scores={ActionTime=7}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.default
