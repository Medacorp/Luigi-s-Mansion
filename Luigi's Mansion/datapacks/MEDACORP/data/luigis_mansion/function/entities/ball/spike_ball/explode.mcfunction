tag @s add me
execute as @e[tag=can_decapitate,nbt={data:{entity:{namespace:"luigis_mansion",id:"bowser"}}}] run function luigis_mansion:entities/ball/spike_ball/decapitate_bowser
execute positioned ~ ~-1.4 ~ as @e[tag=can_decapitate,nbt={data:{entity:{namespace:"luigis_mansion",id:"bowser_head"}}},distance=..3] run function luigis_mansion:entities/ball/spike_ball/decapitate_bowser_head
tag @s remove me
...
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".damage.attack run data modify storage luigis_mansion:data entity.damage set from entity @s ArmorItems[3].components."minecraft:custom_data".damage
execute if data entity @s ArmorItems[3].components."minecraft:custom_data".owner run data modify storage luigis_mansion:data entity.owner set from entity @s ArmorItems[3].components."minecraft:custom_data".owner
