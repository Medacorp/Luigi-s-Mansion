...
execute at @e[tag=this_model,limit=1] if entity @e[tag=me,limit=1,distance=..5] run tag @s add decapitate
execute at @e[tag=this_model,limit=1] if entity @e[tag=me,limit=1,distance=..5] run scoreboard players set @s Dialog 0
