...
execute if entity @s[scores={Room=1..}] at @e[tag=this_luigi,limit=1] run function luigis_mansion:entities/game_boy_horror_marker/teleport_mansion with storage luigis_mansion:data current_state.luigis_mansion.current_data.mansion_id
