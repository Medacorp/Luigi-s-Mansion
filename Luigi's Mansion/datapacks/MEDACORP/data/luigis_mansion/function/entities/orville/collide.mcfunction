...
data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"plane"},amount:0,animation:{namespace:"luigis_mansion",id:"knockback/fall"},no_delete:1b}
