...
execute if entity @s[scores={VulnerableTime=0},tag=!grab_vehicle] if entity @e[tag=same_room,tag=luigi,distance=..0.7,limit=1] run function luigis_mansion:entities/orville/collide
...
execute at @s[tag=!no_vehicle] rotated ~ 0 run teleport @e[tag=this_vehicle,limit=1] ^ ^0.25 ^0.4 ~ ~
