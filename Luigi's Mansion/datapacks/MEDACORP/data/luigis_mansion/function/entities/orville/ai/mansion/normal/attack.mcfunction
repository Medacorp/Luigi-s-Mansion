...
execute if entity @s[tag=!no_vehicle] run function luigis_mansion:entities/orville/ai/mansion/normal/in_vacuum
tag @s[tag=no_vehicle,scores={VulnerableTime=1}] add vanish

tag @s[tag=!visible] add grab_vehicle
execute at @s[tag=grab_vehicle] run function luigis_mansion:entities/orville/ai/mansion/normal/grab_vehicle
...
execute at @s unless entity @s[tag=!grab_vehicle,tag=!laugh] facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~

execute if entity @s[scores={VulnerableTime=0},tag=!grab_vehicle] if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] run function luigis_mansion:entities/orville/collide

scoreboard players set @s TargetTask 0
execute if entity @s[tag=!laugh,tag=!no_vehicle,tag=!grab_vehicle] run function luigis_mansion:entities/orville/ai/mansion/normal/attack_pattern
