...
teleport @s[scores={Dialog=1}] 796.0 20 -48.0
...
execute if entity @s[scores={Dialog=20,Health=..5000}] positioned ~-6.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/big
execute if entity @s[scores={Dialog=20,Health=5001..}] positioned ~-6.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/big
...
execute if entity @s[scores={Dialog=80,Health=..5000}] positioned ~-6.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/big
execute if entity @s[scores={Dialog=80,Health=5001..}] positioned ~-6.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/big
...
teleport @s[scores={Dialog=946}] 796.0 20 -48.0
