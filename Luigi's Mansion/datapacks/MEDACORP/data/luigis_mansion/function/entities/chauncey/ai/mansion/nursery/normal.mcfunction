...
execute if entity @e[tag=rocking_horse,tag=exact_same_room,tag=was_shaking,limit=1] run scoreboard players add @s[scores={Dialog=1..49}] Dialog 1
execute unless entity @e[tag=rocking_horse,tag=exact_same_room,tag=was_shaking,limit=1] run scoreboard players remove @s[scores={Dialog=2..49}] Dialog 3
