...
execute at @e[tag=rocking_horse,tag=same_room,tag=can_attack] positioned ~ ~-3 ~-1 if entity @e[tag=same_room,tag=luigi,limit=1,dx=20,dy=3,dz=1] run scoreboard players add @s[scores={Dialog=81}] Dialog 1
...
execute at @e[tag=rocking_horse,tag=same_room,tag=can_attack] positioned ~ ~-3 ~-1 if entity @e[tag=same_room,tag=luigi,limit=1,dx=20,dy=3,dz=1] run scoreboard players add @s[scores={Dialog=21}] Dialog 1
...
execute if entity @s[scores={Dialog=20,Health=..5000}] positioned ~-2.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=20,Health=5001..}] positioned ~-2.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
...
execute if entity @s[scores={Dialog=80,Health=..5000}] positioned ~-2.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=80,Health=5001..}] positioned ~-2.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
...
execute if entity @s[scores={Dialog=140}] positioned ~-2.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity set value {owner:0,tags:["fast"]}
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity.owner set from entity @s UUID
execute if entity @s[scores={Dialog=140}] positioned ~-2.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
