...
execute at @e[tag=rocking_horse,tag=same_room,tag=can_attack] positioned ~ ~-3 ~-1 if entity @e[tag=same_room,tag=!spectator,tag=player,limit=1,dx=20,dy=3,dz=1] run scoreboard players add @s[scores={Dialog=81}] Dialog 1
...
execute at @e[tag=rocking_horse,tag=same_room,tag=can_attack] positioned ~ ~-3 ~-1 if entity @e[tag=same_room,tag=!spectator,tag=player,limit=1,dx=20,dy=3,dz=1] run scoreboard players add @s[scores={Dialog=21}] Dialog 1
...
execute if entity @s[scores={Dialog=280},tag=!laugh] positioned ~2 ~3 ~6.5 facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=300},tag=!laugh] positioned ~2 ~3 ~-6.5 facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=340},tag=!laugh] positioned ~2 ~3 ~6.5 facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=360},tag=!laugh] positioned ~2 ~3 ~-6.5 facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute at @s[scores={Dialog=945,PathStep=20}] as @e[distance=..1,tag=game_boy_horror_location] run function luigis_mansion:entities/game_boy_horror_location/bring_player_back
...
execute at @s[scores={Dialog=945,PathStep=20}] run advancement grant @a[distance=..1,tag=!spectator] only luigis_mansion:vanilla/waluigi_pinball/chauncey
execute at @s[scores={Dialog=945,PathStep=20}] as @a[distance=..1,tag=!spectator] run function luigis_mansion:entities/player/damage
