...
execute as @e[tag=rocking_horse,tag=same_room] at @s positioned ~-0.5 ~-0.5 ~-0.5 run tag @s[z=57,dz=13] add can_attack
...
teleport @s[scores={Dialog=1}] 796.0 20 64.0
...
teleport @s[scores={Dialog=2..20,Health=..5000}] ~ ~ ~ -180 0
teleport @s[scores={Dialog=2..20,Health=5001..}] ~ ~ ~ 0 0
execute if entity @s[scores={Dialog=20}] run data modify storage luigis_mansion:data entity set value {owner:0}
execute if entity @s[scores={Dialog=20}] run data modify storage luigis_mansion:data entity.owner set from entity @s UUID
execute if entity @s[scores={Dialog=20,Health=..5000}] run data modify storage luigis_mansion:data entity.tags set value ["fast"]
execute if entity @s[scores={Dialog=20,Health=..5000}] positioned ~-6.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=20,Health=5001..}] positioned ~-6.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=21}] facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
...
execute if entity @s[scores={Dialog=22}] rotated -90 10 as @e[tag=rocking_horse,tag=same_room,limit=1] run function luigis_mansion:entities/rocking_horse/trigger_attack
teleport @s[scores={Dialog=61..80,Health=..5000}] ~ ~ ~ 0 0
teleport @s[scores={Dialog=61..80,Health=5001..}] ~ ~ ~ -180 0
execute if entity @s[scores={Dialog=80}] run data modify storage luigis_mansion:data entity set value {owner:0}
execute if entity @s[scores={Dialog=80}] run data modify storage luigis_mansion:data entity.owner set from entity @s UUID
execute if entity @s[scores={Dialog=80,Health=..5000}] run data modify storage luigis_mansion:data entity.tags set value ["fast"]
execute if entity @s[scores={Dialog=80,Health=..5000}] positioned ~-6.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=80,Health=5001..}] positioned ~-6.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=81}] facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
...
execute if entity @s[scores={Dialog=82}] rotated -90 10 as @e[tag=rocking_horse,tag=same_room,limit=1] run function luigis_mansion:entities/rocking_horse/trigger_attack
teleport @s[scores={Dialog=121..140}] ~ ~ ~ -90 0
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity set value {owner:0,tags:["fast"]}
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity.owner set from entity @s UUID
execute if entity @s[scores={Dialog=140}] positioned ~-6.5 ~1 ~-11.5 rotated 0 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity set value {owner:0,tags:["fast"]}
execute if entity @s[scores={Dialog=140}] run data modify storage luigis_mansion:data entity.owner set from entity @s UUID
execute if entity @s[scores={Dialog=140}] positioned ~-6.5 ~1 ~11.5 rotated -180 0 run function luigis_mansion:spawn_entities/rocking_horse/small
execute if entity @s[scores={Dialog=141..381}] facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
...
execute if entity @s[scores={Dialog=182}] rotated -90 10 as @e[tag=rocking_horse,tag=same_room,limit=2] run function luigis_mansion:entities/rocking_horse/trigger_attack
...
execute if entity @s[scores={Dialog=280},tag=!laugh] positioned ~-2 ~3 ~6.5 facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=300},tag=!laugh] positioned ~-2 ~3 ~-6.5 facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=320},tag=!laugh] positioned ~-2 ~3 ~ facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/real
...
execute if entity @s[scores={Dialog=340},tag=!laugh] positioned ~-2 ~3 ~6.5 facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=360},tag=!laugh] positioned ~-2 ~3 ~-6.5 facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
tag @s[scores={Dialog=380..539}] add laugh
scoreboard players set @s[scores={Dialog=381..539}] ActionTime 1
data modify entity @s[scores={Dialog=381..539},tag=laugh] data.animation set value {namespace:"luigis_mansion",id:"laugh"}
...
teleport @s[scores={Dialog=822}] 796.0 20 64.0
...
execute if entity @s[scores={Dialog=884..943}] facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
...
execute at @s[scores={Dialog=945,PathStep=20}] run data remove storage luigis_mansion:data damage
...
execute at @s[y_rotation=-135..-45,scores={Dialog=945},tag=left] unless block ^ ^1 ^2 #luigis_mansion:all_ignore run teleport @s ~ ~ ~ ~-90 0
execute at @s[y_rotation=-45..45,scores={Dialog=945},tag=left] unless block ^ ^1 ^2 #luigis_mansion:all_ignore run teleport @s ~ ~ ~ ~-90 0
execute at @s positioned ~ ~-0.5 ~-0.5 if entity @s[y_rotation=45..135,scores={Dialog=945},x=795.5,dx=1] run scoreboard players add @s Dialog 1
scoreboard players set @s[scores={Dialog=945,PathStep=20}] PathStep 0
scoreboard players reset @s[scores={Dialog=946}] PathStep
teleport @s[scores={Dialog=946}] 796.0 20 64.0
execute if entity @s[scores={Dialog=947..}] facing entity @e[tag=same_room,tag=luigi,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
