...
execute if entity @s[tag=increase] if score #temp Time matches 170..246 store result entity @s Item.components."minecraft:map_id" int 1 run scoreboard players add #temp Time 153
...
execute if entity @s[tag=!increase] if score #temp Time matches 323..399 store result entity @s Item.components."minecraft:map_id" int 1 run scoreboard players remove #temp Time 153
