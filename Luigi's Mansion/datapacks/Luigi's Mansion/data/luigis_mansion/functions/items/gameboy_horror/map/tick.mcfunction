...
execute unless entity @s[scores={OpenMapFocus=1..}] unless entity @s[scores={Walk=0..2,Run=0..2,Sneak=0}] run playsound luigis_mansion:item.gameboy_horror.map.move player @s[scores={MapSound=0}] ~ ~ ~ 1
