execute unless data storage luigis_mansion:data current_state.current_data.used_keys{dining_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3693 60 -3 clockwise_90
execute if data storage luigis_mansion:data current_state.current_data.used_keys{dining_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3693 60 -3 clockwise_90
