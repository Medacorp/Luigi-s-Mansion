...
execute as @e[tag=collision_check,limit=1] run function luigis_mansion:items/gameboy_horror/scan/target_furniture/move
scoreboard players operation #x Steps = @s FurnitureSizeX
...
tag @s add me
execute as @e[tag=this_interact,limit=1] at @e[tag=collision_check,limit=1] run function luigis_mansion:items/gameboy_horror/scan/target_furniture/hardcoded_bounding_box
tag @s remove me
