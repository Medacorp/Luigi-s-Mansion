execute unless data storage luigis_mansion:data current_state.current_data.used_keys{rec_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3653 60 -39
execute if data storage luigis_mansion:data current_state.current_data.used_keys{rec_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3653 60 -39
