execute unless data storage luigis_mansion:data current_state.current_data.used_keys{cellar:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3705 10 -27
execute if data storage luigis_mansion:data current_state.current_data.used_keys{cellar:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3705 10 -27
