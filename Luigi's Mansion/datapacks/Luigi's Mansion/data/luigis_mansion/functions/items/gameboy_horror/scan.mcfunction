...
execute as @e[tag=target,limit=1,scores={Room=1..}] run function #luigis_mansion:items/gameboy_horror/scan/entity_mansion
execute as @e[tag=target,limit=1,scores={Room=..-1}] run function #luigis_mansion:items/gameboy_horror/scan/entity
