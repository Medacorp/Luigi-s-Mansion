...
scoreboard players operation #temp3 PosX = #temp FurnitureSizeLeft
scoreboard players operation #temp3 PosX < #temp PosX
scoreboard players operation #temp3 PosX > #temp2 PosX
scoreboard players operation #temp3 PosY = #temp FurnitureSizeUp
scoreboard players operation #temp3 PosY < #temp PosY
scoreboard players operation #temp3 PosY > #temp2 PosY
scoreboard players operation #temp3 PosZ = #temp FurnitureSizeForward
scoreboard players operation #temp3 PosZ < #temp PosZ
scoreboard players operation #temp3 PosZ > #temp2 PosZ

scoreboard players operation #temp PosX = #temp FurnitureSizeLeft
scoreboard players operation #temp PosY = #temp FurnitureSizeUp
scoreboard players operation #temp PosZ = #temp FurnitureSizeForward
