...
tag @s add me
execute as @e[tag=interact,limit=1] at @e[tag=collision_check,limit=1] run function luigis_mansion:items/poltergust_3000/effect_on_furniture/hardcoded_bounding_box
tag @s remove me
