...
execute if entity @s[tag=hanging_furniture] run scoreboard players operation #temp PosY -= #temp FurnitureSizeRadius
execute if entity @s[tag=standing_furniture] run scoreboard players operation #temp PosY += #temp FurnitureSizeRadius
...
execute if score #temp2 PosX <= #temp FurnitureSizeRadius run tag @s add hit_by_poltergust
