...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["cellar"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["cellar"]} positioned 3705 10 -27 run function luigis_mansion:items/game_boy_horror/map/spawn_key/variant_0/single
