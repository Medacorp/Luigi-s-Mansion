...
execute if data storage luigis_mansion:data current_state.current_data.money_grabbed[0] run function luigis_mansion:items/game_boy_horror/show_items/check_money/get_money_loop/small_pearl
...
execute store result score #temp2 Money run data get storage luigis_mansion:data current_state.my_money.money.luigis_mansion.small_pearl
