...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["balcony_2"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["balcony_2"]} positioned 3682 160 27 run function luigis_mansion:items/game_boy_horror/map/spawn_key/variant_0/single
