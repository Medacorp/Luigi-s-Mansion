...
execute if data storage luigis_mansion:data current_state.current_data{obtained_keys:["anteroom"]} unless data storage luigis_mansion:data current_state.current_data{used_keys:["anteroom"]} positioned 3682 110 13 run function luigis_mansion:items/game_boy_horror/map/spawn_key/variant_0/single
