...
execute as @a[tag=collector,scores={Health=41..99,Shrunk=0},limit=1] unless score @s Health = @s MaxHealth run playsound luigis_mansion:entity.player.healed.high_health player @a[tag=same_room] ~ ~ ~ 1
execute as @a[tag=collector,scores={Health=41..99,Shrunk=1..},limit=1] unless score @s Health = @s MaxHealth run playsound luigis_mansion:entity.player.healed.high_health player @a[tag=same_room] ~ ~ ~ 1 2
...
execute as @a[tag=collector,tag=looking_at_map,scores={Health=41..99,Shrunk=0},limit=1] unless score @s Health = @s MaxHealth at @s run playsound luigis_mansion:entity.player.healed.high_health player @s ~ ~ ~ 1
execute as @a[tag=collector,tag=looking_at_map,scores={Health=41..99,Shrunk=1..},limit=1] unless score @s Health = @s MaxHealth at @s run playsound luigis_mansion:entity.player.healed.high_health player @s ~ ~ ~ 1 2
