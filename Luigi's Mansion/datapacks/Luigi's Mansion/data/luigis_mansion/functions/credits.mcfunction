...
tellraw @s[scores={CreditsTime=800}] {"type":"translatable","translate":"luigis_mansion:credits.discord.chat","clickEvent":{"action":"open_url","value":"https://discord.gg/Nn6wScEc88"},"color":"green"}
...
tellraw @s[scores={CreditsTime=900}] {"type":"translatable","translate":"luigis_mansion:credits.patreon.chat","clickEvent":{"action":"open_url","value":"https://www.patreon.com/dhranios"},"color":"green"}
...
tellraw @s[scores={CreditsTime=1000}] {"type":"translatable","translate":"luigis_mansion:credits.github.chat","clickEvent":{"action":"open_url","value":"https://github.com/Medacorp/Luigi-s-Mansion"},"color":"green"}
...
tellraw @s[scores={CreditsTime=1100}] {"type":"translatable","translate":"luigis_mansion:credits.crowdin.chat","clickEvent":{"action":"open_url","value":"https://crowdin.com/project/medacorp-projects"},"color":"green"}
