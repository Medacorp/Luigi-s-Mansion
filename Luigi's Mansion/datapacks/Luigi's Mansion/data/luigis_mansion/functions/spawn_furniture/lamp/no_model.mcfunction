summon minecraft:marker ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.lamp"}',Tags:["furniture","no_reflection","lamp","was_dark_room","dark_room","scan_ignore","this_entity"]}
