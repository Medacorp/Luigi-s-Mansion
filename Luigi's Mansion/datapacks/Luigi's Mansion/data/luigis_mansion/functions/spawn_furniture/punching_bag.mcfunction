summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.punching_bag"}',Tags:["furniture","swinging","immobile","swinging_harms","hanging_furniture","this_entity"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:7}}],Pose:{Head:[0.0f,0.001f,0.0f]},NoGravity:1b,Marker:1b,Marker:1b,Invisible:1b,DisabledSlots:2039583}
...
scoreboard players set @e[tag=this_entity,limit=1] InteractionTime 7
