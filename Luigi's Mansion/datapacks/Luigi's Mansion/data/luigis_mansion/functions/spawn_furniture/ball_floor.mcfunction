summon minecraft:armor_stand ~ ~0.01 ~ {CustomName:'{"translate":"luigis_mansion:entity.ball_floor"}',Pose:{RightArm:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,HandItems:[{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:17}},{}],Tags:["ball_floor","this_entity","no_poltergust_interaction","scan_ignore"],DisabledSlots:2039583}
