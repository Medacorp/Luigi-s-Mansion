...
execute if score #temp2 Time = #temp Time rotated ~ 0 positioned ^ ^ ^0.444 rotated as @e[tag=candle_flame_rotation,limit=1] rotated ~90 ~ positioned ^ ^0.351 ^-0.383 rotated ~-90 0 run function luigis_mansion:spawn_furniture/setup/candle_flame
execute unless score #temp2 Time = #temp Time rotated ~ 0 positioned ^ ^ ^0.444 rotated as @e[tag=candle_flame_rotation,limit=1] rotated ~-90 ~ positioned ^ ^-0.351 ^0.383 rotated ~90 0 run function luigis_mansion:spawn_furniture/setup/candle_flame
