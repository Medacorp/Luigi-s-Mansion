summon minecraft:armor_stand ~ ~-0.94 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.cobweb"}',Pose:{Head:[0.01f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:0}}],Tags:["cobweb","this_entity","scan_ignore"],DisabledSlots:2039583}
