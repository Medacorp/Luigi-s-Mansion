summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:furniture.ringed_vase"}',Pose:{Head:[0.0f,0.01f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:4}}],Tags:["furniture","affected_by_interact","affected_by_vacuum","rolling","immobile","standing_furniture","this_entity"],DisabledSlots:2039583}
