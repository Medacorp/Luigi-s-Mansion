summon minecraft:armor_stand ~ ~-1.25 ~ {CustomName:'{"translate":"luigis_mansion:entity.rocking_chair"}',Tags:["furniture","rocking_chair","standing_furniture","searchable_by_hand","searchable_by_vacuum","scan_ignore","this_entity"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:34}}],Pose:{Head:[-10.0f,0.01f,0.0f]},NoGravity:1b,Invisible:1b,DisabledSlots:2039583}
