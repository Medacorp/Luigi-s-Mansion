...
execute if entity @s[scores={AnimationProg=31..50}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 4
...
execute if entity @s[scores={AnimationProg=21..35}] store result entity @e[tag=this_model,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 18
execute if entity @s[scores={AnimationProg=36..50}] store result entity @e[tag=this_model,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 18
