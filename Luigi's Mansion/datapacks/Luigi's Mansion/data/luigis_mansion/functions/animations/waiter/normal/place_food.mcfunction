...
data modify entity @s[scores={AnimationProg=3}] HandItems[0] merge from entity @s HandItems[0].tag.variants.no_food
data modify entity @s[scores={AnimationProg=5}] HandItems[1] merge from entity @s HandItems[1].tag.variants.no_food
