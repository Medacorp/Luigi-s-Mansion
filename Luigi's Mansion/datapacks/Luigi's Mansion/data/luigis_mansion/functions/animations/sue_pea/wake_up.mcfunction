...
data modify entity @s[scores={AnimationProg=1..121},tag=visible] ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.waking
data modify entity @s[scores={AnimationProg=122..140},tag=visible] ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.default
