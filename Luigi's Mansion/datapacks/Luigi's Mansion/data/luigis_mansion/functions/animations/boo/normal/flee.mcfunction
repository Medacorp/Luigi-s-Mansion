...
execute if entity @s[scores={AnimationProgress=1}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProgress=2..3}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProgress=4}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players remove #temp Time 10
