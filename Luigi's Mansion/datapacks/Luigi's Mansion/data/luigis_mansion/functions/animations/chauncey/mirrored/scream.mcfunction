...
execute if entity @s[scores={AnimationProg=1..3}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=8..13}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProg=18..20}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
...
data modify entity @s[scores={AnimationProg=3},tag=!big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.screaming
data modify entity @s[scores={AnimationProg=13},tag=!big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.default
data modify entity @s[scores={AnimationProg=3},tag=big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.big_screaming
data modify entity @s[scores={AnimationProg=13},tag=big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.big