...
data modify entity @s[scores={AnimationProg=1},tag=!big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.default
data modify entity @s[scores={AnimationProg=1},tag=big] ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.big