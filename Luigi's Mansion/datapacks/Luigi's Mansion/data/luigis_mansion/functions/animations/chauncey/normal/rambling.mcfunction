...
execute if entity @s[scores={AnimationProgress=1..5}] store result entity @s Pose.RightArm[0] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProgress=6..15}] store result entity @s Pose.RightArm[0] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProgress=16..20}] store result entity @s Pose.RightArm[0] float 1 run scoreboard players add #temp Time 3
...
execute if entity @s[tag=rattle,scores={AnimationProgress=5}] run playsound luigis_mansion:entity.chauncey.rattle hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=rattle,scores={AnimationProgress=15}] run playsound luigis_mansion:entity.chauncey.rattle hostile @a[tag=same_room] ~ ~ ~ 1
tag @s remove rattle