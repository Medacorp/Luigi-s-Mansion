...
execute if entity @s[scores={AnimationProg=21..22}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProg=24..27}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProg=29..30}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 5
