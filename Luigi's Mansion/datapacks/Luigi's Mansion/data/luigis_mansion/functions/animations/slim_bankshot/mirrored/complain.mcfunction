...
execute if entity @s[scores={AnimationProg=51..59}] store result entity @e[tag=this_model,tag=left_arm_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 5
...
execute if entity @s[scores={AnimationProg=51..57}] store result entity @e[tag=this_model,tag=right_arm,limit=1] Pose.Head[2] float 1 run scoreboard players add #temp Time 5
