...
execute unless entity @s[scores={AnimationProg=11..30}] run teleport @e[tag=this_model,tag=tail,limit=1] ^ ^-2.1 ^-1.8 ~ ~
execute if entity @s[scores={AnimationProg=11..30}] run teleport @e[tag=this_model,tag=tail,limit=1] ^ ^-2.6 ^-1.8 ~ ~
...
execute if entity @s[scores={AnimationProg=1..10}] store result entity @e[tag=this_model,tag=right_arm,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 1
...
execute if entity @s[scores={AnimationProg=31..40}] store result entity @e[tag=this_model,tag=left_arm,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 1
execute store result score #temp Time run data get entity @e[tag=this_model,tag=tail,limit=1] Pose.Head[1]
execute if entity @s[scores={AnimationProg=1..10}] store result entity @e[tag=this_model,tag=tail,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=tail,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProg=21..30}] store result entity @e[tag=this_model,tag=tail,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProg=31..40}] store result entity @e[tag=this_model,tag=tail,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 5
