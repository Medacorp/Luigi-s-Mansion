...
teleport @s[scores={AnimationProgress=35..37}] ^ ^ ^0.1 ~ ~
execute at @s run teleport @e[tag=this_model,tag=body,limit=1] ^ ^-0.25 ^-0.25 ~ ~
execute at @s run teleport @e[tag=this_model,tag=right_arm,limit=1] ^-0.45 ^-0.3 ^-0.2 ~ ~
execute at @s run teleport @e[tag=this_model,tag=left_arm,limit=1] ^0.45 ^-0.3 ^-0.2 ~ ~
