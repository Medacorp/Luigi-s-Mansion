...
execute if entity @s[scores={AnimationProgress=1..8}] store result entity @e[tag=this_model,tag=body,limit=1] Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProgress=9..24}] store result entity @e[tag=this_model,tag=body,limit=1] Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProgress=25..32}] store result entity @e[tag=this_model,tag=body,limit=1] Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
execute store result score #temp Time run data get entity @e[tag=this_model,tag=right_leg,limit=1] Pose.Head[0] 10
execute if entity @s[scores={AnimationProgress=1..8}] store result entity @e[tag=this_model,tag=right_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 25
execute if entity @s[scores={AnimationProgress=9..24}] store result entity @e[tag=this_model,tag=right_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 25
execute if entity @s[scores={AnimationProgress=25..32}] store result entity @e[tag=this_model,tag=right_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 25
execute store result score #temp Time run data get entity @e[tag=this_model,tag=left_leg,limit=1] Pose.Head[0] 10
execute if entity @s[scores={AnimationProgress=1..8}] store result entity @e[tag=this_model,tag=left_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 25
execute if entity @s[scores={AnimationProgress=9..24}] store result entity @e[tag=this_model,tag=left_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 25
execute if entity @s[scores={AnimationProgress=25..32}] store result entity @e[tag=this_model,tag=left_leg,limit=1] Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 25
