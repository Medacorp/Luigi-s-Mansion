...
execute if entity @s[scores={AnimationProg=1..2}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players add #temp Time 7
execute if entity @s[scores={AnimationProg=3..6}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players remove #temp Time 7
execute if entity @s[scores={AnimationProg=7..8}] store result entity @s Pose.LeftArm[2] float 1 run scoreboard players add #temp Time 7
