...
execute at @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 run teleport @s[tag=!flipped_gravity] ^0.155 ^-0.06 ^
execute at @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 run teleport @s[tag=flipped_gravity] ^-0.155 ^0.06 ^
...
execute if entity @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
...
execute if entity @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 3
