...
execute if entity @s[scores={RotationDifference=..-50001}] run scoreboard players operation @s PlayerRotation += @s Range
execute if entity @s[scores={RotationDifference=50001..}] as @a[tag=this_luigi,tag=idle,limit=1] run function luigis_mansion:entities/player/animation/set/none
execute if entity @s[scores={RotationDifference=..-50001}] as @a[tag=this_luigi,tag=idle,limit=1] run function luigis_mansion:entities/player/animation/set/none
