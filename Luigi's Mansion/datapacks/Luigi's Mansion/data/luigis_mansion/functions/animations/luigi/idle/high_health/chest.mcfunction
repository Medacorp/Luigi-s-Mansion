...
execute if entity @s[scores={AnimationProg=45}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players set #temp Time -10
execute if entity @s[scores={AnimationProg=45}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[1] float 1 run scoreboard players set #temp Time 10
