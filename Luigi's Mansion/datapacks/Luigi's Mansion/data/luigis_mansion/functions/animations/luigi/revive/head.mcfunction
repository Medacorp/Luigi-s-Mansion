...
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 run teleport @s[tag=!flipped_gravity] ^-0.03125 ^0.025 ^
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 run teleport @s[tag=flipped_gravity] ^0.03125 ^-0.025 ^
...
execute if entity @s[scores={DeathTime=1..15}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={DeathTime=26..40}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 4
...
execute if entity @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 0.01 run scoreboard players remove #temp Time 275
