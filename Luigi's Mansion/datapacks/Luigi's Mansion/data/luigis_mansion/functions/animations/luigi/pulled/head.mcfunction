...
data merge entity @s[scores={AnimationProg=11}] {Pose:{Head:[-20.0f,0.0f,0.01f]}}
data merge entity @s[scores={AnimationProg=11},tag=flipped_gravity] {Pose:{Head:[-20.0f,0.0f,-180.0f]}}
...
execute if entity @s[scores={AnimationProg=21}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -19
execute if entity @s[scores={AnimationProg=22}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -18
execute if entity @s[scores={AnimationProg=23}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -17
execute if entity @s[scores={AnimationProg=24}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -16
execute if entity @s[scores={AnimationProg=25}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -17
execute if entity @s[scores={AnimationProg=26}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -18
execute if entity @s[scores={AnimationProg=27}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -19
execute if entity @s[scores={AnimationProg=28..30}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -20
scoreboard players reset #temp Time
data merge entity @s[scores={AnimationProg=30}] {Pose:{Head:[-20.0f,0.0f,0.01f]}}
data merge entity @s[scores={AnimationProg=30},tag=flipped_gravity] {Pose:{Head:[-20.0f,0.0f,-180.0f]}}
