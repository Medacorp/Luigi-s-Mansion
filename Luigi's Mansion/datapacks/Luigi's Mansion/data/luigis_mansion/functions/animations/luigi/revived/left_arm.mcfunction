...
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 run teleport @s[tag=!flipped_gravity] ^-0.0225 ^0.0325 ^
execute at @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 run teleport @s[tag=flipped_gravity] ^0.0225 ^-0.0325 ^
...
execute if entity @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 0.01 run scoreboard players remove #temp Time 225
...
execute if entity @s[scores={DeathTime=11..50}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 0.01 run scoreboard players add #temp Time 125
