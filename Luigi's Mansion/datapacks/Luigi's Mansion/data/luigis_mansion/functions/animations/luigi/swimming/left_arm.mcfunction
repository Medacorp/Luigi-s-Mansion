...
execute if entity @s[scores={AnimationProg=19..27}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProg=28..36}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 10
