...
execute if entity @s[scores={AnimationProg=6..15}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 8
execute if entity @s[scores={AnimationProg=16..25}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 8
