...
execute if entity @s[scores={AnimationProg=1..5}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-0.9 ~ ~ ~
teleport @s[scores={AnimationProg=6}] ~ ~-0.4 ~ ~ ~
execute if entity @s[scores={AnimationProg=6}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-0.95 ~ ~ ~
teleport @s[scores={AnimationProg=7}] ~ ~-0.45 ~ ~ ~
execute if entity @s[scores={AnimationProg=7}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1 ~ ~ ~
teleport @s[scores={AnimationProg=8}] ~ ~-0.5 ~ ~ ~
execute if entity @s[scores={AnimationProg=8}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.05 ~ ~ ~
teleport @s[scores={AnimationProg=9}] ~ ~-0.55 ~ ~ ~
execute if entity @s[scores={AnimationProg=9}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.1 ~ ~ ~
teleport @s[scores={AnimationProg=10}] ~ ~-0.6 ~ ~ ~
execute if entity @s[scores={AnimationProg=10}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.15 ~ ~ ~
teleport @s[scores={AnimationProg=11..20}] ~ ~-0.65 ~ ~ ~
execute if entity @s[scores={AnimationProg=11..20}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.2 ~ ~ ~
