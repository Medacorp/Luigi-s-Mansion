...
execute unless block 742 21 67 minecraft:redstone_lamp if entity @s[x=747.0,y=23,z=74.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/hidden/guest_room/search/boo_check/painting_5