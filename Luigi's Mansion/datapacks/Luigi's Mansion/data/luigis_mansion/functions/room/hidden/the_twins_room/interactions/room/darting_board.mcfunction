...
execute if score #the_twins_room_darting_board Searching matches 20 run function luigis_mansion:room/hidden/the_twins_room/search/boo_check/darting_board
scoreboard players operation #temp Searching = #the_twins_room_darting_board Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 738 22 -26.0 run function luigis_mansion:blocks/search_sound/generic
