...
execute if data storage luigis_mansion:data current_state.current_data.rooms.astral_hall{seen:0b} run function luigis_mansion:room/hidden/astral_hall/set_seen