...
execute if block 759 33 -53 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:mace",amount:10,knockback:"large",no_delete:1b}
execute if block 759 33 -53 minecraft:andesite as @a[x=760.5,y=29,z=-51.5,distance=..1,gamemode=!spectator] positioned 760.0 29 -52.0 run function luigis_mansion:entities/player/take_damage
