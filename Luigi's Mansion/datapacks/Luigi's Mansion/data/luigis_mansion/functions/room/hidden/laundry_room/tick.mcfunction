...
execute as @e[tag=!spectator,x=712,y=8,z=-62,dx=8,dy=9,dz=20] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 22
