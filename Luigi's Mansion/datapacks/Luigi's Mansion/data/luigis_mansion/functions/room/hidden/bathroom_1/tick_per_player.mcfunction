...
execute if data storage luigis_mansion:data current_state.current_data.rooms.bathroom_1{seen:0b} run function luigis_mansion:room/hidden/bathroom_1/set_seen