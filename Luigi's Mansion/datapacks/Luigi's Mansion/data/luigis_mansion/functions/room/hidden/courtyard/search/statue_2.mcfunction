...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 649 105 36 run function luigis_mansion:room/hidden/courtyard/statue_2
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 648 104 36 run function luigis_mansion:blocks/dust
