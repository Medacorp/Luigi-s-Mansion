...
execute if score #the_artists_studio_painting_7 Searching matches 20 run function luigis_mansion:room/hidden/the_artists_studio/search/boo_check/painting_7
scoreboard players operation #temp Searching = #the_artists_studio_painting_7 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 693 29 85 run function luigis_mansion:blocks/search_sound/generic
