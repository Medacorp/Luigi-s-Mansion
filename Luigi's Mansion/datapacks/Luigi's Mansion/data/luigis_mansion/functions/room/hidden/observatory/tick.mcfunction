...
execute as @e[tag=!spectator,x=627,y=14,z=87,dx=24,dy=12,dz=72] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 46
