...
execute unless score #breaker_room Wave matches 1..99 run setblock 689 3 67 minecraft:lever[face=wall,facing=east,powered=false]
execute unless score #breaker_room Wave matches 1..99 run setblock 709 3 67 minecraft:lever[face=wall,facing=west,powered=false]
