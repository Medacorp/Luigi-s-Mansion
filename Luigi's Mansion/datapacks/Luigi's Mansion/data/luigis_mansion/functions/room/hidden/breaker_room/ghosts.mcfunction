execute unless data storage luigis_mansion:data current_state.current_data.rooms.breaker_room{cleared:1b} if data storage luigis_mansion:data current_state.current_data{blackout:0b} unless score #breaker_room Wave matches 1.. run function luigis_mansion:room/hidden/breaker_room/wave_1
