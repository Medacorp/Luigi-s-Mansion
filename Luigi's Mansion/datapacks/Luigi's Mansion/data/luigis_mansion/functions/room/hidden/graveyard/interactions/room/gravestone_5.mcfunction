...
execute if score #graveyard_gravestone_5 Searching matches 20 run function luigis_mansion:room/hidden/graveyard/search/gravestone_5
scoreboard players operation #temp Searching = #graveyard_gravestone_5 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 660.0 103 -29.0 run function luigis_mansion:blocks/search_sound/stone
