...
execute if score #secret_altar_candle_1 Searching matches 20 run function luigis_mansion:room/hidden/secret_altar/search/candle_1
scoreboard players operation #temp Searching = #secret_altar_candle_1 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 644 95 26 run function luigis_mansion:blocks/search_sound/generic
