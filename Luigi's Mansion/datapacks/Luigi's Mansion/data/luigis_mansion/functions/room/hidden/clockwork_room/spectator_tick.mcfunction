execute unless entity @s[scores={Room=62}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.clockwork_room"}
...
teleport @s[scores={HomeZ=24}] ~42 ~-91 ~2
teleport @s[scores={HomeZ=-9}] ~41 ~-91 ~-18

teleport @s[scores={HomeY=118,HomeZ=19..23}] ~14 ~-94 ~13
...
teleport @s[scores={HomeY=118,HomeZ=-8..-4}] ~18 ~-94 ~-25
