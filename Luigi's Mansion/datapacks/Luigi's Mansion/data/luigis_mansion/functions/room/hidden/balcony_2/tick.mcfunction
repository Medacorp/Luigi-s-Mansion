...
execute as @e[tag=!spectator,x=653,y=116,z=-23,dx=30,dy=25,dz=80] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 53
