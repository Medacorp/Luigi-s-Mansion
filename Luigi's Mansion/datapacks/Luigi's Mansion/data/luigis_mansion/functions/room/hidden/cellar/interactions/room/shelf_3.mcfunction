...
execute if score #cellar_shelf_content_trophies_1 Searching matches 20 run function luigis_mansion:room/hidden/cellar/search/boo_check/shelf_3
scoreboard players operation #temp Searching = #cellar_shelf_content_trophies_1 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 742 7 67 run function luigis_mansion:blocks/search_sound/metal
