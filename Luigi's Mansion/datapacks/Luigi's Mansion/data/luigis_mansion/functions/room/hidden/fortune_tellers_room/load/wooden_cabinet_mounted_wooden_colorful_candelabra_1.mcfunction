...
execute positioned 736 11 37.2 rotated -90 0 run function luigis_mansion:spawn_furniture/wooden_cabinet_mounted_wooden_colorful_candelabra/red_green_blue