...
execute if block 757 33 -58 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:mace",amount:10,knockback:"large",no_delete:1b}
execute if block 757 33 -58 minecraft:andesite as @a[x=758.5,y=29,z=-56.5,distance=..1,gamemode=!spectator] positioned 758.0 29 -57.0 run function luigis_mansion:entities/player/take_damage
