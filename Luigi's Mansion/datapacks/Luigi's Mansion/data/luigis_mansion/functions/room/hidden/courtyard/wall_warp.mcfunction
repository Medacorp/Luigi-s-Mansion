...
scoreboard players set @s[scores={PositionIntY=100,PositionIntZ=20..25,PositionIntX=648}] RoomNoise 1
stopsound @s[scores={PositionIntY=100,PositionIntZ=26..40}] neutral luigis_mansion:entity.mario.hey_whats_the_hold_up
scoreboard players set @s[scores={PositionIntY=100,PositionIntZ=26..40}] RoomNoise 1
