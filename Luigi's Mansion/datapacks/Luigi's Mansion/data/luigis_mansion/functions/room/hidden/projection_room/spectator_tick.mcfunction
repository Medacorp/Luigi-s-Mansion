execute unless entity @s[scores={Room=48}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.projection_room"}
...
teleport @s[scores={HomeZ=-16}] ~12 ~ ~48
teleport @s[scores={HomeZ=-30}] ~ ~ ~-21
