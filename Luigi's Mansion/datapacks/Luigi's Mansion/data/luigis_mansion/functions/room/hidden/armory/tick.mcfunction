...
execute as @e[tag=!spectator,x=744,y=26,z=-64,dx=22,dy=9,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 64
