...
execute as @a[gamemode=!spectator,x=740,y=26,z=-33,dx=23,dy=9,dz=8] unless entity @s[scores={Room=55}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[tag=!spectator,x=740,y=26,z=-33,dx=23,dy=9,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 55
