...
execute if score #fortune_tellers_room_candle_2 Searching matches 20 run function luigis_mansion:room/hidden/fortune_tellers_room/search/boo_check/candle_2
scoreboard players operation #temp Searching = #fortune_tellers_room_candle_2 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 746 11 52 run function luigis_mansion:blocks/search_sound/heavy_generic
