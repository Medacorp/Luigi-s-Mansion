...
execute if score #washroom_2_sink Searching matches 20 run function luigis_mansion:room/hidden/washroom_2/search/boo_check/sink
...
execute unless block 662 20 -25 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/washroom_2/search/boo_check/sink