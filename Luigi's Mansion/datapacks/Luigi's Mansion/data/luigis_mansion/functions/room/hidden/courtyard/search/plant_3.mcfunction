...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 646 104 8 run function luigis_mansion:room/hidden/courtyard/plant_3
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 646 102 8 run function luigis_mansion:blocks/dust
