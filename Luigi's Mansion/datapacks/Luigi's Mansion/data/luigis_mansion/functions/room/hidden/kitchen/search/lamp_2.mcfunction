...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 702 15 -64 run function luigis_mansion:room/hidden/kitchen/lamp_2
