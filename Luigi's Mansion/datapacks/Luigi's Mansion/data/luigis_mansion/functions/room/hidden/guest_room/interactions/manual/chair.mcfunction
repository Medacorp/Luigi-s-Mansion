...
execute unless block 742 21 67 minecraft:redstone_lamp if entity @s[x=738.5,y=20,z=60.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion:room/hidden/guest_room/search/boo_check/chair