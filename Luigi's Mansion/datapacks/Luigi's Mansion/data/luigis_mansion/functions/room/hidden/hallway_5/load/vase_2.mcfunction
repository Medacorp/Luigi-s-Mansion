data modify storage luigis_mansion:data furniture set value {searchable:["hand","vacuum"],sound:6,scan_message:'{"translate":"luigis_mansion:message.player.scan_furniture.75"}'}
...
execute positioned 680 12.5 34 rotated -90 0 run function luigis_mansion:spawn_furniture/vase