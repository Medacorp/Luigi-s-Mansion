...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 704 22 -68 run function luigis_mansion:room/normal/sealed_room/chest_3
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 684 21 -68 run function luigis_mansion:blocks/dust_no_sound
