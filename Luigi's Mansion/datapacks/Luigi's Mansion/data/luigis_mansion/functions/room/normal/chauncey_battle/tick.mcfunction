...
execute as @e[tag=!spectator,x=782,y=4,z=43,dx=41,dy=34,dz=41] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 73
...
execute if entity @a[tag=same_room,limit=1] run function luigis_mansion:room/normal/chauncey_battle/ghosts
