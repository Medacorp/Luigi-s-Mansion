...
tag @e[x=669.0,y=11,z=8.5,distance=..0.7,tag=door,tag=frame,limit=1] add hallway_6_courtyard
execute unless data storage luigis_mansion:data current_state.current_data.technical_data{cleared_area_3_blockade:1b} run tag @e[x=669.0,y=11,z=8.5,distance=..0.7,tag=door,tag=frame,limit=1] add area_blockade
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=673.5,y=11,z=6.0,distance=..0.7,tag=door,tag=frame,limit=1] add fake