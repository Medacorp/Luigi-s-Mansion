...
execute as @e[tag=!spectator,x=659,y=8,z=-62,dx=8,dy=18,dz=26] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 33
