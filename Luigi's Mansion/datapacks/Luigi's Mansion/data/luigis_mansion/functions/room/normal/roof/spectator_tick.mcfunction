execute unless entity @s[scores={Room=63}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.roof"}
...
teleport @s[scores={HomeY=129,HomeX=684..687,HomeZ=-29..-23}] ~5 ~-96 ~-39
teleport @s[scores={HomeY=129,HomeX=684..687,HomeZ=-22..-18}] ~ ~1 ~
teleport @s[scores={HomeY=129,HomeX=688..697,HomeZ=-29..-18}] ~5 ~-96 ~-39
...
teleport @s[scores={HomeY=129,HomeX=684..687,HomeZ=38..44}] ~14 ~-96 ~25
teleport @s[scores={HomeY=129,HomeX=684..687,HomeZ=33..37}] ~ ~1 ~
teleport @s[scores={HomeY=129,HomeX=688..697,HomeZ=33..44}] ~14 ~-96 ~25
