...
execute if block 742 21 -52 minecraft:redstone_lamp if score #guest_room_lamp Searching matches 20 run function luigis_mansion:room/normal/guest_room/search/lamp_flipped
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_lamp Searching matches 20 run function luigis_mansion:room/normal/guest_room/search/lamp
