...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 715 11 68 run function luigis_mansion:room/normal/laundry_room/closet
