...
execute if entity @s[x=750.0,y=29,z=3.0,dx=1,dy=0,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/normal/telephone_room/search/boo_check/chest_2