...
execute if data storage luigis_mansion:data current_state.current_data.rooms.courtyard{cleared:1b} if data storage luigis_mansion:data current_state.current_data{blackout:0b} positioned 650 102 -8 rotated -90 0 run function luigis_mansion:spawn_furniture/room_clear_chest/green
