...
execute positioned 708.0 20 -80 as @e[tag=speedy_spirit,distance=..0.1] run function luigis_mansion:entities/speedy_spirit/give_money/green_emerald
execute positioned 708.0 20 -80 as @e[tag=speedy_spirit,distance=..0.1] run data modify entity @s ArmorItems[3].tag.loot merge value {name:"sealed_room_speedy_spirit"}
