...
execute positioned 744.0 9.6 33 as @e[tag=speedy_spirit,distance=..0.1] run function luigis_mansion:entities/speedy_spirit/give_money/green_emerald
execute positioned 744.0 9.6 33 as @e[tag=speedy_spirit,distance=..0.1] run data modify entity @s ArmorItems[3].tag.loot merge value {name:"hidden_room_speedy_spirit"}
