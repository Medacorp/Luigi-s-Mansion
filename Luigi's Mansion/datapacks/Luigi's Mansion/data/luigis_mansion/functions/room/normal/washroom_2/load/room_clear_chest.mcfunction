...
execute if data storage luigis_mansion:data current_state.current_data.rooms.washroom_2{cleared:1b} if data storage luigis_mansion:data current_state.current_data{blackout:0b} positioned 665 20 38 rotated 0 0 run function luigis_mansion:spawn_furniture/room_clear_chest/small_green
execute if data storage luigis_mansion:data current_state.current_data.rooms.washroom_2{cleared:1b} if data storage luigis_mansion:data current_state.current_data{blackout:0b} run setblock 665 20 38 minecraft:light_gray_stained_glass
