...
execute as @e[tag=!spectator,x=679,y=17,z=-30,dx=6,dy=9,dz=42] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 35
