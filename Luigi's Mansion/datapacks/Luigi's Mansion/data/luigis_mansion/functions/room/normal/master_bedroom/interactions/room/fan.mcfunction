...
execute if score #temp Searching matches 1 if score #master_bedroom_fan Search matches 1 positioned 691.0 116 47.0 run function luigis_mansion:blocks/search_sound/heavy_generic
