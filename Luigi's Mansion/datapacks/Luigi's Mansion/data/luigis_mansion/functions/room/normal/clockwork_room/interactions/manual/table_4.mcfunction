...
execute if entity @s[x=684.0,y=120,z=-8.0,dx=0,dy=1,dz=2,tag=!sound,tag=!check] run function luigis_mansion:room/normal/clockwork_room/search/boo_check/table_4