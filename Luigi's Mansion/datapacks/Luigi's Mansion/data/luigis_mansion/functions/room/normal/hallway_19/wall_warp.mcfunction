...
scoreboard players set @a[scores={PositionIntZ=41,PositionIntX=741..758}] RoomNoise 0
stopsound @a[scores={PositionIntZ=47,PositionIntX=741..758}] ambient luigis_mansion:block.telephone.ring
scoreboard players set @a[scores={PositionIntZ=47,PositionIntX=741..758}] RoomNoise 0

stopsound @a[scores={PositionIntY=27,PositionIntX=741..745}] ambient luigis_mansion:block.telephone.ring
scoreboard players set @a[scores={PositionIntY=27,PositionIntX=741..745}] RoomNoise 0
stopsound @a[scores={PositionIntY=27,PositionIntX=748..758}] ambient luigis_mansion:block.telephone.ring
scoreboard players set @a[scores={PositionIntY=27,PositionIntX=748..758}] RoomNoise 0
stopsound @a[scores={PositionIntY=34,PositionIntX=740..752}] ambient luigis_mansion:block.telephone.ring
scoreboard players set @a[scores={PositionIntY=34,PositionIntX=740..752}] RoomNoise 0
