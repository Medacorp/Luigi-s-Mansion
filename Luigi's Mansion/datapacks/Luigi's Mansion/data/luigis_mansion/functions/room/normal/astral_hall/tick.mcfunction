...
execute as @e[tag=!spectator,x=660,y=17,z=-93,dx=12,dy=9,dz=22] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 45
