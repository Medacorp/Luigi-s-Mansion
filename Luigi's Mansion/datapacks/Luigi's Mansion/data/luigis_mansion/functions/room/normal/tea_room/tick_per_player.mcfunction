...
execute if data storage luigis_mansion:data current_state.current_data.rooms.tea_room{seen:0b} run function luigis_mansion:room/normal/tea_room/set_seen