...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 698 23 -58 run function luigis_mansion:room/normal/sealed_room/chest_1
