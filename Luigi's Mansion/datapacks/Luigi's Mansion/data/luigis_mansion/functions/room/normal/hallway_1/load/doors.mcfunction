...
tag @e[x=737.0,y=20,z=8.5,distance=..0.7,tag=door,tag=frame,limit=1] add hallway_1_parlor
...
tag @e[x=737.0,y=20,z=9.5,distance=..0.7,tag=door,tag=frame,limit=1] add hallway_1_parlor
