...
execute unless data storage luigis_mansion:data current_state.current_data.obtained_items{fire_element_medal:1b} run data modify storage luigis_mansion:data furniture.loot set value {contents:{luigis_mansion:{element_medal:[{variant:"fire",rotation:[-180.0f,0.0f]}]}}}
