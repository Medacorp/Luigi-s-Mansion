...
execute as @e[tag=!spectator,x=728,y=75,z=-41,dx=50,dy=10,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -4
