...
data modify entity @e[tag=vincent_van_gore,tag=this_entity,limit=1] ArmorItems[3].tag.scan_message set from storage luigis_mansion:data entity.scan_message
execute if data storage luigis_mansion:data entity{can_talk_to:1b} run tag @e[tag=vincent_van_gore,tag=this_entity,limit=1] add can_talk_to
execute if data storage luigis_mansion:data entity{drops_pearls:0b} run tag @e[tag=vincent_van_gore,tag=this_entity,limit=1] remove pearl_dropper
execute if data storage luigis_mansion:data entity{drops_poison_mushrooms:0b} run tag @e[tag=vincent_van_gore,tag=this_entity,limit=1] add no_poison_mushroom_dropping
execute if data storage luigis_mansion:data entity.health as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s Health store result score @s LastHealth store result score @s PrevHealth run data get storage luigis_mansion:data entity.health
execute if data storage luigis_mansion:data entity.max_health as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s MaxHealth run data get storage luigis_mansion:data entity.max_health
execute if data storage luigis_mansion:data entity.top_vacuum_damage as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s TopVacuumDamage run data get storage luigis_mansion:data entity.top_vacuum_damage
execute if data storage luigis_mansion:data entity.speed as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s Move run data get storage luigis_mansion:data entity.speed
execute if data storage luigis_mansion:data entity.flee_speed as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s MoveFlee run data get storage luigis_mansion:data entity.flee_speed
execute if data storage luigis_mansion:data entity.loot run data modify entity @e[tag=vincent_van_gore,tag=this_entity,limit=1] ArmorItems[3].tag.loot set from storage luigis_mansion:data entity.loot
execute if data storage luigis_mansion:data entity.second_flee_damage as @e[tag=vincent_van_gore,tag=this_entity,limit=1] store result score @s SecondFleeDamage run data get storage luigis_mansion:data entity.second_flee_damage
