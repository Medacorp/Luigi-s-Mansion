...
summon minecraft:armor_stand ~ ~-0.5 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.bogmire"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","found_owner","body","this_entity"],DisabledSlots:2039583}
