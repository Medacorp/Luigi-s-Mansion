summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.henry"}',Invisible:1b,NoGravity:1b,Marker:0b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["henry","portrait_ghost","portrait_ghost_pop","affected_by_vacuum","ghost","pearl_dropper","this_entity"],DisabledSlots:2039583}
