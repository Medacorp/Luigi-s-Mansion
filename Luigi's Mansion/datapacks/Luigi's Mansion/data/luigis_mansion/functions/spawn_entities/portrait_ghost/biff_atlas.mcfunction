...
execute as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s GhostNr run data get storage luigis_mansion:data unique_id.ghost
execute as @e[tag=biff_atlas,tag=this_entity,limit=1] store result storage luigis_mansion:data unique_id.ghost int 1 run scoreboard players add @s GhostNr 1
...
execute as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s HomeRotation run data get entity @s Rotation[0]
execute as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s PreviousHealth store result score @s LastHealth store result score @s Health run data get storage luigis_mansion:data current_state.current_data.portrait_ghosts.biff_atlas.health
...
execute as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s VanishTime run data get storage luigis_mansion:data current_state.current_data.portrait_ghosts.biff_atlas.vanish_time
...
data modify entity @e[tag=biff_atlas,tag=this_entity,limit=1] ArmorItems[3].tag.damage set from storage luigis_mansion:data current_state.current_data.portrait_ghosts.biff_atlas.damage
...
scoreboard players set @e[tag=biff_atlas,tag=this_entity,limit=1] EntitySizeWidth 10
scoreboard players set @e[tag=biff_atlas,tag=this_entity,limit=1] EntitySizeHeight 25
...
execute if data storage luigis_mansion:data entity.health as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s Health store result score @s LastHealth store result score @s PreviousHealth run data get storage luigis_mansion:data entity.health
...
execute if data storage luigis_mansion:data entity.damage run data modify entity @e[tag=biff_atlas,tag=this_entity,limit=1] ArmorItems[3].tag.damage set from storage luigis_mansion:data entity.damage
...
execute if data storage luigis_mansion:data entity.vanish_time as @e[tag=biff_atlas,tag=this_entity,limit=1] store result score @s VanishTime run data get storage luigis_mansion:data entity.vanish_time
