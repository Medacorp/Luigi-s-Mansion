execute if score #mirrored Selected matches 0 run summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.ghost_guy"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:1,CustomModelData:5,display:{color:21247}}}],HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:2,CustomModelData:5,display:{color:21247}}},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:3,CustomModelData:4,display:{color:21247}}}],Pose:{RightArm:[-90.0f,90.0f,0.0f],LeftArm:[-90.0f,-90.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Tags:["ghost_guy","normal_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","stop_dancing","hidden","new_ghost","this_entity"],DisabledSlots:2039583}
execute if score #mirrored Selected matches 1 run summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.ghost_guy"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:1,CustomModelData:5,display:{color:21247}}}],HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:2,CustomModelData:4,display:{color:21247}}},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:3,CustomModelData:5,display:{color:21247}}}],Pose:{RightArm:[-90.0f,90.0f,0.0f],LeftArm:[-90.0f,-90.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Tags:["ghost_guy","normal_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","stop_dancing","hidden","new_ghost","this_entity"],DisabledSlots:2039583}
