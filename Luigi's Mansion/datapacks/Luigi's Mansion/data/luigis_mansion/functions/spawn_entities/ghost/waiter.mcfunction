summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.waiter"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:1,CustomModelData:94}}],HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:2,CustomModelData:95}},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:diamond_pickaxe",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:3,CustomModelData:95}}],Pose:{RightArm:[-180.0f,0.0f,0.0f],LeftArm:[-180.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Tags:["waiter","optional_ghost","stunnable","normal_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","hidden","new_ghost","no_hidden_move","only_forced_spawn","no_height_change","this_entity"],DisabledSlots:2039583}
