data modify storage luigis_mansion:data entity{id:"boo_b_hatch",name:'{"translate":"luigis_mansion:entity.boo_b_hatch"}',can_attack:1b,health:1,room:0,speed:0,loot:{}}
