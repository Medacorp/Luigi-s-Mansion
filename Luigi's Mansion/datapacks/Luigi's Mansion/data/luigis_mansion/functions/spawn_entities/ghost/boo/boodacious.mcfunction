data modify storage luigis_mansion:data entity{id:"boodacious",name:'{"translate":"luigis_mansion:entity.boodacious"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
