...
execute unless entity @e[tag=ghost_guy,distance=..2,tag=!this_entity,limit=1] store result score @e[tag=this_entity,limit=1] GhostGuyCouple run data get storage luigis_mansion:data unique_id.dancing_ghost_guy_couple
execute unless entity @e[tag=ghost_guy,distance=..2,tag=!this_entity,limit=1] store result storage luigis_mansion:data unique_id.dancing_ghost_guy_couple int 1 run scoreboard players add @e[tag=this_entity,limit=1] GhostGuyCouple 1
