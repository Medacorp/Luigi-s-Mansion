summon minecraft:armor_stand ~ ~-1.1875 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.wool"}',Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["ball","wool","scan_ignore","this_entity"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:41}}],NoGravity:1b,Marker:1b,Invisible:1b,DisabledSlots:2039583}
