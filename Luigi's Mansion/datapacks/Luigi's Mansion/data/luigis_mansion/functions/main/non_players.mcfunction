...
execute unless entity @s[tag=furniture] store result score @s PosX run data get entity @s Pos[0] 10
execute unless entity @s[tag=furniture] store result score @s PosY run data get entity @s Pos[1] 10
execute unless entity @s[tag=furniture] store result score @s PosZ run data get entity @s Pos[2] 10
execute unless entity @s[tag=furniture] run scoreboard players operation @s PosY += @s EntityYOffset
