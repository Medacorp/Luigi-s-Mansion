...
execute if data storage luigis_mansion:data drop_loot.contents.luigis_mansion.big_heart[0].rotation run tag @e[tag=this_entity,limit=1] add rotated
execute if data storage luigis_mansion:data drop_loot.contents.luigis_mansion.big_heart[0].rotation run data modify entity @e[tag=this_entity,limit=1] Rotation set from storage luigis_mansion:data drop_loot.contents.luigis_mansion.big_heart[0].rotation
