...
execute at @s[tag=in_vacuum,tag=!big] unless entity @a[distance=..1.5,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet if block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ^ ^ ^0.3 ~ ~
execute at @s[tag=in_vacuum,tag=!big] unless entity @a[distance=..1.5,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet unless block ^ ^ ^0.3 #luigis_mansion:all_ignore rotated ~ 0 if block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ^ ^ ^0.3 ~ ~
execute at @s[tag=in_vacuum,tag=!big] unless entity @a[distance=..1.5,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet unless block ^ ^ ^0.3 #luigis_mansion:all_ignore rotated ~ 0 unless block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ~ ~ ~ ~ ~
execute at @s[tag=in_vacuum,tag=!big] at @p[distance=..1.5,tag=!spectator,tag=vacuuming] positioned ~ ~0.5 ~ run teleport @s ^ ^ ^0.2 ~ ~
execute at @s[tag=in_vacuum,tag=big] unless entity @a[distance=..3,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet if block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ^ ^ ^0.3 ~ ~
execute at @s[tag=in_vacuum,tag=big] unless entity @a[distance=..3,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet unless block ^ ^ ^0.3 #luigis_mansion:all_ignore rotated ~ 0 if block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ^ ^ ^0.3 ~ ~
execute at @s[tag=in_vacuum,tag=big] unless entity @a[distance=..3,tag=!spectator,tag=vacuuming] facing entity @p[tag=!spectator,tag=vacuuming] feet unless block ^ ^ ^0.3 #luigis_mansion:all_ignore rotated ~ 0 unless block ^ ^ ^0.3 #luigis_mansion:all_ignore run teleport @s ~ ~ ~ ~ ~
execute at @s[tag=in_vacuum,tag=big] at @p[distance=..3,tag=!spectator,tag=vacuuming] positioned ~ ~0.5 ~ run teleport @s ^ ^ ^0.2 ~ ~
...
execute at @p[distance=..3,tag=!spectator,tag=vacuuming] if block ^ ^ ^1 #luigis_mansion:all_ignore run teleport @s[tag=big,tag=can_spit] ^ ^ ^1 ~ ~
execute at @p[distance=..3,tag=!spectator,tag=vacuuming] if block ^ ^ ^2 #luigis_mansion:all_ignore run teleport @s[tag=big,tag=can_spit] ^ ^ ^2 ~ ~
...
execute at @s if entity @p[distance=..1.5,tag=!spectator,tag=vacuuming] run tag @s[tag=in_vacuum,tag=!big] add can_spit
execute at @s if entity @p[distance=..1.5,tag=!spectator,tag=vacuuming] run tag @s[tag=in_vacuum,tag=!big] add can_spit_2
execute at @s if entity @p[distance=..3,tag=!spectator,tag=vacuuming] run tag @s[tag=in_vacuum,tag=big] add can_spit
execute at @s if entity @p[distance=..3,tag=!spectator,tag=vacuuming] run tag @s[tag=in_vacuum,tag=big] add can_spit_2
