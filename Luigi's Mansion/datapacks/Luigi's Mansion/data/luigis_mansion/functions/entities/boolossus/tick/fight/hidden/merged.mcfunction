...
execute if entity @s[tag=!intro_done] run function luigis_mansion:entities/boolossus/battle_intro/hidden
execute if entity @s[x=586.5,y=31,z=20.5,distance=..4] run function luigis_mansion:entities/boolossus/split_up
execute if entity @s[x=586.5,y=31,z=49.5,distance=..4] run function luigis_mansion:entities/boolossus/split_up
...
execute if entity @e[tag=same_room,tag=!spectator,distance=..3,limit=1] run function luigis_mansion:entities/boolossus/collide_merged
