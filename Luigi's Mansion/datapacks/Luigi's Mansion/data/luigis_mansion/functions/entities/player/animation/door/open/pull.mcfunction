...
execute if entity @s[scores={AnimationProg=29..32}] if entity @e[tag=door,tag=frame,tag=!open_door,tag=!forced_animation,distance=..0.7] run function luigis_mansion:entities/door/force_animation
