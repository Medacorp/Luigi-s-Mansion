...
tag @s[scores={IdleTime=20..,Health=..30},tag=!high_health_idle,tag=!low_health_idle,tag=!cold_room_idle] add idle
...
tag @s[scores={IdleTime=20..,Health=31..},tag=cold_room,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] add idle
...
tag @s[scores={IdleTime=200..,Health=31..},tag=!cold_room,tag=!high_health_idle,tag=!low_health_idle,tag=!cold_room_idle] add idle
...
execute if entity @s[tag=push_open_door] run function luigis_mansion:entities/player/animation/door/open/push
execute if entity @s[tag=pull_open_door] run function luigis_mansion:entities/player/animation/door/open/pull
execute if entity @s[tag=push_locked_door] run function luigis_mansion:entities/player/animation/door/locked/push
