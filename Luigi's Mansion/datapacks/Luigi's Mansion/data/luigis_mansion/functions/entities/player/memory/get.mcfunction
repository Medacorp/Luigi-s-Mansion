...
data modify storage luigis_mansion:data my_memory set value {uuid:[I;],inventory:{},model:{color:0,variant:0b},hurt_by:{method:"",attacker:-1,self:0b},poltergust_element:"none"}
