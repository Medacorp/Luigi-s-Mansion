...
execute if entity @s[tag=collision] run playsound luigis_mansion:entity.haunted_frying_pan.hit hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={WaitTime=60..,Sound=0},tag=!moving] run playsound luigis_mansion:entity.haunted_frying_pan.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={WaitTime=100},tag=moving] run playsound luigis_mansion:entity.haunted_frying_pan.flying_start hostile @a[tag=same_room] ~ ~ ~ 1
