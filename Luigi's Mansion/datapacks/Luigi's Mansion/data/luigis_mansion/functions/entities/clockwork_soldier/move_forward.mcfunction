...
execute unless block ^ ^1 ^0.6 #luigis_mansion:all_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:all_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:entities/clockwork_soldier/move_forward
