...
execute if entity @s[scores={Dialog=1..101},tag=!vanish] run function luigis_mansion:entities/ghost/turn_visible
execute if entity @s[scores={Dialog=1},tag=!vanish] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:entities/ghost/turn_invisible
...
execute if entity @s[scores={Dialog=60},tag=!vanish] run function luigis_mansion:entities/ghost/turn_visible_no_equipment
...
execute if entity @s[scores={Dialog=100},tag=!vanish] run teleport @s ~ ~ ~ facing 689 111.6 42
execute if entity @s[scores={Dialog=110},tag=!vanish] run teleport @s ~ ~ ~ facing 685 111.6 42
execute if entity @s[scores={Dialog=136},tag=!vanish] run teleport @s ~ ~ ~ facing 685 111.6 45
execute if entity @s[scores={Dialog=136..163},tag=!vanish] run fill 684 112 42 684 115 ~ minecraft:white_wool
