...
execute if entity @s[scores={Dialog=333}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:entities/vincent_van_gore/turn_invisible
