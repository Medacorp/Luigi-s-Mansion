execute if entity @s[tag=dead] run function luigis_mansion:entities/haunted_plate/drop_loot
execute if entity @s[tag=collision] run playsound luigis_mansion:entity.haunted_plate.hit hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={WaitTime=60..,Sound=0},tag=!moving] run playsound luigis_mansion:entity.haunted_plate.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={WaitTime=100},tag=moving] run playsound luigis_mansion:entity.haunted_plate.flying_start hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={WaitTime=100},tag=moving] Sound 14
execute if entity @s[scores={WaitTime=101..,Sound=0},tag=moving] run playsound luigis_mansion:entity.haunted_plate.flying hostile @a[tag=same_room] ~ ~ ~ 1
