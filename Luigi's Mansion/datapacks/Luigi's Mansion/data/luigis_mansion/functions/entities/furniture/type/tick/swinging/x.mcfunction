scoreboard players add @s FurnitureXProg 12
...
execute if entity @s[scores={FurnitureXProg=0}] run function luigis_mansion:entities/furniture/type/tick/swinging/reached/x
