...
execute as @e[tag=collision_check,tag=x,limit=1] at @s unless score #forward Steps matches 0 run function luigis_mansion:entities/furniture/type/tick/swinging/hit_pos/move_forward
