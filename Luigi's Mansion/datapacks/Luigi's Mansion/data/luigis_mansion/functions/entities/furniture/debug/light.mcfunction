...
scoreboard players operation #temp2 FurnitureSizeLeft = @s FurnitureLampLeft
...
execute at @e[tag=temp] run function luigis_mansion:entities/furniture/debug/highlight_light
kill @e[tag=temp]
