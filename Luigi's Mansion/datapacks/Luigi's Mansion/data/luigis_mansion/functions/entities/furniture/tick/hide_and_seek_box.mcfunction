...
execute unless entity @s[tag=!in_vacuum] run function luigis_mansion:entities/furniture/tick/shake
execute if entity @s[tag=!in_vacuum,tag=was_shaking] run function luigis_mansion:entities/furniture/tick/revert_to_default_orientation
...
execute if entity @s[tag=open,scores={ActionTime=0..}] run function luigis_mansion:entities/furniture/open/hide_and_seek_box