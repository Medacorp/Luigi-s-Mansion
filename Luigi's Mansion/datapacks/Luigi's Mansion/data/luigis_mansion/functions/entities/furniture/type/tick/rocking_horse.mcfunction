...
execute if entity @s[tag=in_vacuum] run function luigis_mansion:animations/furniture/rocking_horse
execute unless entity @s[tag=!shake,tag=!long_shake] run function luigis_mansion:entities/furniture/shake
execute if entity @s[tag=!in_vacuum,tag=!shake,tag=!long_shake] unless entity @s[tag=!was_shaking,tag=!was_in_vacuum] run function luigis_mansion:entities/furniture/revert_to_default_orientation
