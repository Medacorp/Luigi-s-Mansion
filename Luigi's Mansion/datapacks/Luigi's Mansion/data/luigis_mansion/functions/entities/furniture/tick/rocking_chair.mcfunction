...
execute if entity @s[tag=!in_vacuum,tag=!shake,tag=!long_shake,tag=!rock] unless entity @s[tag=!was_shaking,tag=!was_rocking] run function luigis_mansion:entities/furniture/tick/revert_to_default_orientation
tag @s remove rock
