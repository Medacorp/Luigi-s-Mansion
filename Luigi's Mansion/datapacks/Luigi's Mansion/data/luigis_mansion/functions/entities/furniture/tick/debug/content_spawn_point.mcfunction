...
execute as @e[tag=temp,limit=1] positioned as @s run function luigis_mansion:entities/furniture/tick/debug/move_content_spawn_point

execute at @e[tag=temp] run function luigis_mansion:entities/furniture/tick/debug/highlight_content_spawn_point
kill @e[tag=temp]
