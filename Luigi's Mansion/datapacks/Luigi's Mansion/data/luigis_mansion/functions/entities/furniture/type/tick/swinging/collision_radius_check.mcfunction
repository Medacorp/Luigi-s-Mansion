...
scoreboard players operation #temp2 PositionX = #swinging PositionX
scoreboard players operation #temp2 PositionY = #swinging PositionY
scoreboard players operation #temp2 PositionZ = #swinging PositionZ
