...
execute if entity @s[scores={Dialog=0}] positioned ~ ~-1.85 ~ if entity @e[tag=rocking_chair,distance=..1,limit=1] at @s unless score @s ActionTime = @s AnimationProgress run function luigis_mansion:animations/neville/get_idle_position
