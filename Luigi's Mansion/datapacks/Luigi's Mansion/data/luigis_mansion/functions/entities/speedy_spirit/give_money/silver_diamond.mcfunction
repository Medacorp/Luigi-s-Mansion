execute store result score #temp Time run data get entity @s ArmorItems[3].tag.loot.contents.luigis_mansion.gold_coin
execute store result entity @s ArmorItems[3].tag.loot.contents.luigis_mansion.gold_coin int 1 run scoreboard players add #temp Time 10
scoreboard players reset #temp Time
execute store result score #temp Time run data get entity @s ArmorItems[3].tag.loot.contents.luigis_mansion.bill
execute store result entity @s ArmorItems[3].tag.loot.contents.luigis_mansion.bill int 1 run scoreboard players add #temp Time 15
scoreboard players reset #temp Time
