...
execute if entity @s[scores={ActionTime=41}] run playsound luigis_mansion:entity.grabbing_ghost.spawn_basher hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=81}] run playsound luigis_mansion:entity.grabbing_ghost.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
