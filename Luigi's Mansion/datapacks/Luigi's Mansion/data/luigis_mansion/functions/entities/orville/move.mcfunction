...
execute unless entity @s[scores={WaitTime=120..159}] run function luigis_mansion:entities/orville/hover
execute if entity @s[scores={WaitTime=120..159}] run function luigis_mansion:entities/orville/attack
