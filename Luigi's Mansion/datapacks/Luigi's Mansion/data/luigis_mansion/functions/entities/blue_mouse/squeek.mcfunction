...
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:entity.blue_mouse.ambient hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=20}] run playsound luigis_mansion:entity.blue_mouse.ambient_stop hostile @a[tag=same_room] ~ ~ ~ 1
