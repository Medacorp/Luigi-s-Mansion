...
execute as @e[tag=furniture,tag=same_room,tag=can_hide_boo] at @s unless entity @e[distance=..0.1,tag=hidden_boo,tag=caught_by_boo_radar,limit=1] if score @s Room = #temp Room run tag @s add hide_option
# todelete
