...
execute if entity @s[tag=intro_done,tag=!grabbing_head,tag=!decapitate,tag=!king_boo_dead,tag=!reattach_head,tag=!reattach_head_backwards] unless entity @e[tag=king_boo,limit=1] run function luigis_mansion:entities/bowser/tick/normal/headed_tick
execute if entity @s[tag=intro_done,tag=!grabbing_head,tag=!decapitate,tag=!king_boo_dead,tag=reattach_head] unless entity @e[tag=king_boo,limit=1] run function luigis_mansion:entities/bowser/tick/normal/reattach_head
execute if entity @s[tag=intro_done,tag=!grabbing_head,tag=!decapitate,tag=!king_boo_dead,tag=reattach_head_backwards] unless entity @e[tag=king_boo,limit=1] run function luigis_mansion:entities/bowser/tick/normal/reattach_head_backwards
