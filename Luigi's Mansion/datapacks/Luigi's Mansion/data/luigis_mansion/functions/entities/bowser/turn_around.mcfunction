...
execute if score #temp Time matches -3..3 run teleport @s[tag=!turn_left] ~ ~ ~ ~5 ~
execute if score #temp Time matches -3..3 store result score #temp2 Time run data get entity @s Rotation[0]
execute if score #temp Time matches -3..3 run scoreboard players operation #temp Time -= #temp2 Time
