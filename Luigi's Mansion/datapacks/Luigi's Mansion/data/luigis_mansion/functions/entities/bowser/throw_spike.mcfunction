summon minecraft:armor_stand ~ ~-0.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.spike_ball"}',Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["spike_ball","this_entity","ball","big","vacuumable"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:8}}],Invisible:1b,DisabledSlots:2039583}
