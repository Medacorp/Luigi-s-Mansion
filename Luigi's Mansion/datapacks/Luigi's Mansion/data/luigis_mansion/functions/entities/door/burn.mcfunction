...
execute if entity @s[tag=fake,scores={ElementHurtTime=60}] run setblock ^ ^ ^0.5 minecraft:air
execute if entity @s[tag=fake,scores={Health=..0}] run setblock ^ ^ ^0.5 minecraft:air
