...
#extra gallery
execute if entity @s[tag=extra_gallery_leave,tag=door,tag=frame] run tag @e[x=772.5,y=77,z=-40.0,distance=..0.7,tag=door,tag=frame,limit=1] add forced_animation
