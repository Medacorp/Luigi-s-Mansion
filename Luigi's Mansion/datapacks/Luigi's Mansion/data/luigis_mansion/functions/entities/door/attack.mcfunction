...
execute if entity @s[scores={AnimationProg=5}] run playsound luigis_mansion:block.door.fake_open block @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={AnimationProg=45}] run playsound luigis_mansion:block.door.fake_closing block @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={AnimationProg=70}] run playsound luigis_mansion:block.door.fake_close block @a[tag=same_room] ~ ~ ~ 1
