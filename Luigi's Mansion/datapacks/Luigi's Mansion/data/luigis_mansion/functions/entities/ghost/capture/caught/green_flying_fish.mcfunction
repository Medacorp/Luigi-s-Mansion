...
execute unless score #temp ActionTime matches 2147483647 store result storage luigis_mansion:data current_state.ghost_caught.caught.green_flying_fish int 1 run scoreboard players add #temp ActionTime 1
