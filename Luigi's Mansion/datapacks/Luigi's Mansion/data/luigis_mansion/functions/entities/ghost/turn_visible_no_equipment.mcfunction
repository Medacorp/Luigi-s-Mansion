...
data modify entity @s ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.no_equipment
data modify entity @s ArmorItems[0].tag.CustomModelData set from entity @s HandItems[0].tag.variants.no_equipment
data modify entity @s ArmorItems[1].tag.CustomModelData set from entity @s HandItems[1].tag.variants.no_equipment
execute as @e[tag=change_this_model] run data modify entity @s ArmorItems[3].tag.CustomModelData set from entity @s ArmorItems[3].tag.variants.no_equipment
execute as @e[tag=change_this_model] run data modify entity @s ArmorItems[0].tag.CustomModelData set from entity @s HandItems[0].tag.variants.no_equipment
execute as @e[tag=change_this_model] run data modify entity @s ArmorItems[1].tag.CustomModelData set from entity @s HandItems[1].tag.variants.no_equipment
