...
data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.invisible
data modify entity @s HandItems[0] merge from entity @s HandItems[0].tag.variants.invisible
data modify entity @s HandItems[1] merge from entity @s HandItems[1].tag.variants.invisible
execute as @e[tag=change_this_model] run data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.invisible
execute as @e[tag=change_this_model] run data modify entity @s HandItems[0] merge from entity @s HandItems[0].tag.variants.invisible
execute as @e[tag=change_this_model] run data modify entity @s HandItems[1] merge from entity @s HandItems[1].tag.variants.invisible
