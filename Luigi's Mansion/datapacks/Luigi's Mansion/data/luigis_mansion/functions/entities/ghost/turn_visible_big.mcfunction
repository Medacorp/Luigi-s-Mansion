...
data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.big
data modify entity @s HandItems[0] merge from entity @s HandItems[0].tag.variants.big
data modify entity @s HandItems[1] merge from entity @s HandItems[1].tag.variants.big
execute as @e[tag=change_this_model] run data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].tag.variants.big
execute as @e[tag=change_this_model] run data modify entity @s HandItems[0] merge from entity @s HandItems[0].tag.variants.big
execute as @e[tag=change_this_model] run data modify entity @s HandItems[1] merge from entity @s HandItems[1].tag.variants.big
