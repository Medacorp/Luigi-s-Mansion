...
execute unless score #temp ActionTime matches 2147483647 if entity @s[tag=dancing] store result storage luigis_mansion:data current_state.ghost_caught.caught.dancing_ghost_guy int 1 run scoreboard players add #temp ActionTime 1
...
execute unless score #temp ActionTime matches 2147483647 if entity @s[tag=!dancing] store result storage luigis_mansion:data current_state.ghost_caught.caught.ghost_guy int 1 run scoreboard players add #temp ActionTime 1
