summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"text","text":"","color":"light_purple"}',Marker:1b,Invisible:1b,NoGravity:1b,CustomNameVisible:1b,Fire:32767s,Tags:["health_display","this_entity"]}
