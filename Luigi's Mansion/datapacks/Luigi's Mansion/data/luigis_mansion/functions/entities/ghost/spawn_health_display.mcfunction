...
execute in minecraft:overworld run setblock 27 0 0 minecraft:oak_sign{front_text:{messages:['{"score":{"objective":"Health","name":"#temp"},"color":"light_purple"}','{"text":""}','{"text":""}','{"text":""}']}}
