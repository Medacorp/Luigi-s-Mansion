...
execute if entity @s[scores={ActionTime=1..40}] run function luigis_mansion:animations/grabbing_ghost/basher_stun
scoreboard players set @s[scores={ActionTime=41}] AnimationProg 0
execute if entity @s[scores={ActionTime=41..60}] run function luigis_mansion:animations/grabbing_ghost/basher_appear
scoreboard players set @s[scores={ActionTime=61}] AnimationProg 0
execute if entity @s[scores={ActionTime=61..90}] run function luigis_mansion:animations/grabbing_ghost/basher_complain
...
execute if entity @s[scores={ActionTime=41}] run playsound luigis_mansion:entity.red_grabbing_ghost.spawn_basher hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=41}] run data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:scare",amount:0,limit_health:70,knockback:"scare",attacker:-1,no_delete:1b}
...
execute if entity @s[scores={ActionTime=41}] run data modify storage luigis_mansion:data damage merge value {limit_health:50,knockback:"bash_scare"}
...
execute if entity @s[scores={ActionTime=81}] run playsound luigis_mansion:entity.red_grabbing_ghost.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
