...
execute if entity @s[scores={ActionTime=40}] positioned ~ ~0.4 ~ as @e[distance=..0.1,tag=bone] unless entity @s[scores={Owner=1..}] positioned ~ ~-0.4 ~ run scoreboard players operation @s Owner = @e[tag=mr_bones,distance=..0.1] GhostNr
