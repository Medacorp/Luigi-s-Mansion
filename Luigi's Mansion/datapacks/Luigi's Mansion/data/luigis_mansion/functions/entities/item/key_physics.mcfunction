...
execute at @s positioned ~ ~0.3 ~ if entity @e[tag=same_room,tag=!spectator,distance=..0.7,limit=1] run tag @s add picked_up
execute at @s positioned ~ ~0.3 ~ run tag @a[tag=same_room,tag=!spectator,distance=..0.7,limit=1] add collector
execute at @s positioned ~ ~0.3 ~ unless entity @a[tag=collector,limit=1] as @e[tag=same_room,tag=game_boy_horror_location,tag=!spectator,distance=..0.7,limit=1] run function luigis_mansion:entities/game_boy_horror_location/tag_for_collecting