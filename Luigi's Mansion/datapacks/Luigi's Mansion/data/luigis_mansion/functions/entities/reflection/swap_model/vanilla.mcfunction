...
execute if data storage luigis_mansion:data mirror.data.ArmorItems[{id:"minecraft:diamond_pickaxe",tag:{Damage:20}}] run data modify entity @s ArmorItems[3].tag.Damage set value 21
execute if data storage luigis_mansion:data mirror.data.ArmorItems[{id:"minecraft:diamond_pickaxe",tag:{Damage:21}}] run data modify entity @s ArmorItems[3].tag.Damage set value 20
execute if data storage luigis_mansion:data mirror.data{Tags:["left_arm"]} unless data storage luigis_mansion:data mirror.data{Tags:["held_item"]} run data modify entity @s ArmorItems[3].tag.Damage set value 2
execute if data storage luigis_mansion:data mirror.data{Tags:["right_arm"]} unless data storage luigis_mansion:data mirror.data{Tags:["held_item"]} run data modify entity @s ArmorItems[3].tag.Damage set value 3
execute if data storage luigis_mansion:data mirror.data{Tags:["left_leg"]} run data modify entity @s ArmorItems[3].tag.Damage set value 2
execute if data storage luigis_mansion:data mirror.data{Tags:["right_leg"]} run data modify entity @s ArmorItems[3].tag.Damage set value 3
execute if data storage luigis_mansion:data mirror.data{Tags:["poltergust_body"]} as @s run function luigis_mansion:entities/reflection/swap_model/poltergust_body