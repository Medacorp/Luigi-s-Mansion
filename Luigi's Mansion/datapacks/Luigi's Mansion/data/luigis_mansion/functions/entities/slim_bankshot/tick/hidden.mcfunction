...
execute if entity @s[scores={Dialog=1}] run function luigis_mansion:entities/slim_bankshot/tick/hidden/path
...
execute if entity @s[scores={Dialog=21}] run function luigis_mansion:entities/slim_bankshot/tick/hidden/path
...
execute if entity @s[scores={Dialog=41}] run function luigis_mansion:entities/slim_bankshot/tick/hidden/path
