...
execute if score #hallway_1 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_1/turn_lights/off
...
execute if score #hallway_2 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_2/turn_lights/off
...
execute if score #hallway_3 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_3/turn_lights/off
execute if score #hallway_4 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_4/turn_lights/off
execute if score #hallway_5 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_5/turn_lights/off
execute if score #hallway_6 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_6/turn_lights/off
...
execute if score #hallway_8 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_8/turn_lights/off
execute if score #tea_room Ticking matches 1 run function #luigis_mansion:room/hidden/tea_room/turn_lights/off
execute if score #hallway_9 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_9/turn_lights/off
execute if score #hallway_10 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_10/turn_lights/off
execute if score #hallway_11 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_11/turn_lights/off
execute if score #hallway_12 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_12/turn_lights/off
execute if score #hallway_13 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_13/turn_lights/off
execute if score #hallway_14 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_14/turn_lights/off
execute if score #hallway_15 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_15/turn_lights/off
...
execute if score #hallway_18 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_18/turn_lights/off
...
execute if score #breaker_room Ticking matches 1 unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run teleport @a[scores={Room=57},tag=!looking_at_map] 714 2 62
...
execute if score #breaker_room Ticking matches 1 unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run scoreboard players set @a[scores={Room=57},tag=!looking_at_map] PosZ 6250
...
execute if score #breaker_room Ticking matches 1 unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} run scoreboard players set @a[scores={Room=57},tag=looking_at_map] HomeZ 6250
execute unless data storage luigis_mansion:data current_state.current_data{used_keys:["breaker_room"]} if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/game_boy_horror/map/display/hidden/generate
...
execute if score #hallway_20 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_20/turn_lights/off
execute if score #hallway_21 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_21/turn_lights/off
execute if score #hallway_22 Ticking matches 1 run function #luigis_mansion:room/hidden/hallway_22/turn_lights/off
...
tag @e[x=755.0,y=11,z=7.5,distance=..0.7,tag=door,tag=frame,limit=1] add unopenable
tag @e[x=755.0,y=11,z=6.5,distance=..0.7,tag=door,tag=frame,limit=1] add unopenable