...
execute if entity @s[scores={GBHDialog=1..1119}] as @a[gamemode=!spectator,tag=!game_boy_horror,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/game_boy_horror
