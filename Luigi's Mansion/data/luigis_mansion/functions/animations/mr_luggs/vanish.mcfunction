...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_mr_luggs_body,limit=1] {Pose:{RightArm:[0.0f,0.0f,90.0f],LeftArm:[0.0f,0.0f,-90.0f],Head:[0.0f,0.0f,0.0f]}}
