...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=e_gadd_body,limit=1] {Pose:{RightArm:[-90.0f,5.0f,0.01f],LeftArm:[-90.0f,-5.0f,0.01f],Head:[0.0f,0.0f,0.01f]}}
teleport @s[scores={AnimationProg=1..10}] ~ ~-0.65 ~ ~ ~
execute if entity @s[scores={AnimationProg=1..10}] run teleport @e[tag=this_model,tag=e_gadd_body,limit=1] ~ ~-1.2 ~ ~ ~
teleport @s[scores={AnimationProg=11}] ~ ~-0.6 ~ ~ ~
execute if entity @s[scores={AnimationProg=11}] run teleport @e[tag=this_model,tag=e_gadd_body,limit=1] ~ ~-1.15 ~ ~ ~
teleport @s[scores={AnimationProg=12}] ~ ~-0.55 ~ ~ ~
execute if entity @s[scores={AnimationProg=12}] run teleport @e[tag=this_model,tag=e_gadd_body,limit=1] ~ ~-1.1 ~ ~ ~
teleport @s[scores={AnimationProg=13}] ~ ~-0.5 ~ ~ ~
execute if entity @s[scores={AnimationProg=13}] run teleport @e[tag=this_model,tag=e_gadd_body,limit=1] ~ ~-1.05 ~ ~ ~
teleport @s[scores={AnimationProg=14}] ~ ~-0.45 ~ ~ ~
execute if entity @s[scores={AnimationProg=14}] run teleport @e[tag=this_model,tag=e_gadd_body,limit=1] ~ ~-1 ~ ~ ~
...
execute store result score #temp Time run data get entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.RightArm[0]
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.RightArm[0] float 1 run scoreboard players add #temp Time 9
execute store result score #temp Time run data get entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.RightArm[1] 10
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.RightArm[1] float 0.1 run scoreboard players add #temp Time 5
execute store result score #temp Time run data get entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.LeftArm[0]
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.LeftArm[0] float 1 run scoreboard players add #temp Time 9
execute store result score #temp Time run data get entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.LeftArm[1] 10
execute if entity @s[scores={AnimationProg=11..20}] store result entity @e[tag=this_model,tag=e_gadd_body,limit=1] Pose.LeftArm[1] float 0.1 run scoreboard players add #temp Time 5
