teleport @e[tag=this_lydia_body,limit=1] ~ ~ ~ ~ ~
...
execute store result score #temp Time run data get entity @e[tag=this_lydia_body,limit=1] Pose.Head[0] 10
execute if entity @s[scores={AnimationProg=1..8}] store result entity @e[tag=this_lydia_body,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProg=9..16}] store result entity @e[tag=this_lydia_body,limit=1] Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 5
