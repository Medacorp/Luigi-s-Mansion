...
execute if entity @s[scores={AnimationProg=1..5}] store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={AnimationProg=6..10}] store result entity @s Pose.Head[2] float 1 run scoreboard players remove #temp Time 4
