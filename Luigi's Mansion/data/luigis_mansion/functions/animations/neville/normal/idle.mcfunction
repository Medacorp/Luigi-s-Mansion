...
data merge entity @s[scores={AnimationProg=1}] {Pose:{RightArm:[-10.0f,20.0f,0.01f],LeftArm:[-50.0f,0.0f,0.01f],Head:[10.0f,0.01f,20.0f]}}
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,limit=1] {Pose:{Head:[-40.0f,0.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProg=1..20}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProg=21..60}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProg=61..80}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 0.1 run scoreboard players add #temp Time 5
