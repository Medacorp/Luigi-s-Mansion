...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_mario_body,limit=1] {Pose:{RightArm:[-90.0f,5.0f,0.01f],LeftArm:[-90.0f,-5.0f,0.01f],Head:[0.0f,0.0f,0.01f]}}
