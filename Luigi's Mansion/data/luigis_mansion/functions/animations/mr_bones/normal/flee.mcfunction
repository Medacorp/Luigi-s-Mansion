...
execute if entity @s[scores={AnimationProg=1..3}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[0] float 1 run scoreboard players add #temp Time 20
execute if entity @s[scores={AnimationProg=4..9}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[0] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProg=10..12}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[0] float 1 run scoreboard players add #temp Time 20
execute store result score #temp Time run data get entity @e[tag=this_mr_bones_body,limit=1] Pose.LeftArm[0]
execute if entity @s[scores={AnimationProg=1..3}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProg=4..9}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.LeftArm[0] float 1 run scoreboard players add #temp Time 20
execute if entity @s[scores={AnimationProg=10..12}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 20
