...
execute if entity @s[scores={AnimationProg=15..20}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.Head[2] float 1 run scoreboard players remove #temp Time 13
execute if entity @s[scores={AnimationProg=21..25}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.Head[2] float 1 run scoreboard players add #temp Time 13
execute store result score #temp Time run data get entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[2]
execute if entity @s[scores={AnimationProg=7..15}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[2] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=26..33}] store result entity @e[tag=this_mr_bones_body,limit=1] Pose.RightArm[2] float 1 run scoreboard players add #temp Time 3
