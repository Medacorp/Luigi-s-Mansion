...
execute if entity @s[scores={AnimationProg=1..30}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=31..40}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[0] float 1 run scoreboard players add #temp Time 9
execute store result score #temp Time run data get entity @e[tag=this_model,limit=1] Pose.LeftArm[1]
execute if entity @s[scores={AnimationProg=1..30}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[1] float 1 run scoreboard players remove #temp Time 1
execute if entity @s[scores={AnimationProg=31..40}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[1] float 1 run scoreboard players add #temp Time 3
