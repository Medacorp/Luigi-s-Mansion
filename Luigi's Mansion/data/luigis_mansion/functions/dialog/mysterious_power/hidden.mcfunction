...
execute if entity @s[scores={Dialog=1398}] run teleport @a[scores={Room=51..52},gamemode=!spectator] 751.0 11 7.0
...
execute if entity @s[scores={Dialog=1782}] run teleport @a[scores={Room=51..52},gamemode=!spectator] 751.0 11 7.0
...
execute if entity @s[scores={Dialog=1996}] run teleport @a[scores={Room=51..52},gamemode=!spectator] 751.0 11 7.0
