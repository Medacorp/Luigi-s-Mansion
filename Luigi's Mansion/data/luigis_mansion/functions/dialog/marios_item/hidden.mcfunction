execute if entity @s[scores={ClairvoyaSpoke=0}] run function luigis_mansion:dialog/marios_item/hidden/item_1
execute if entity @s[scores={ClairvoyaSpoke=1}] run function luigis_mansion:dialog/marios_item/hidden/item_2
execute if entity @s[scores={ClairvoyaSpoke=2}] run function luigis_mansion:dialog/marios_item/hidden/item_3
execute if entity @s[scores={ClairvoyaSpoke=3}] run function luigis_mansion:dialog/marios_item/hidden/item_4
execute if entity @s[scores={ClairvoyaSpoke=4}] run function luigis_mansion:dialog/marios_item/hidden/item_5
