...
execute if entity @s[scores={Dialog=1050},tag=ending] unless score #temp2 Money >= #temp Money if score #temp2 Money matches 1.. run scoreboard players operation #temp2 Money = #temp Money
