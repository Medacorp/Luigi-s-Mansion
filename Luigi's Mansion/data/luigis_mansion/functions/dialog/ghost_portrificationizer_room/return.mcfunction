...
execute unless entity @a[tag=same_room,distance=..7] run tag @s remove return_dialog
scoreboard players set @s[tag=!return_dialog] Dialog 0
tag @s[tag=!return_dialog] remove nod
execute if entity @s[tag=!return_dialog] run scoreboard players set @e[tag=this_model,tag=e_gadd_head,limit=1] AnimationProg 0