summon minecraft:area_effect_cloud ~ ~ ~ {Duration:1000000,Tags:["this_entity","ghost_marker","ghost","waiter","optional_ghost","only_forced_spawn","no_height_change"],Rotation:[0.0f,90.0f]}
