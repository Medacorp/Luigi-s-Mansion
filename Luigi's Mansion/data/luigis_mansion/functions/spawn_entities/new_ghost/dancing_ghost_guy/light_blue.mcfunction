summon minecraft:area_effect_cloud ~ ~ ~ {Duration:1000000,Tags:["this_entity","ghost_marker","ghost","ghost_guy","dancing","light_blue","no_height_change"],Rotation:[0.0f,90.0f]}
