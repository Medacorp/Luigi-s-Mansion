...
execute store result score @e[tag=this_entity,tag=mr_bones,limit=1] Health run data get storage luigis_mansion:data current_state.current_data.ghost_health.mr_bones
