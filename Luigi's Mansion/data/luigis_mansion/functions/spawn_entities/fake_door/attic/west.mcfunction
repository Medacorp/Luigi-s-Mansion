summon minecraft:area_effect_cloud ~ ~ ~ {Rotation:[0.0f,90.0f],CustomName:'{"translate":"luigis_mansion:entity.fake_door"}',Tags:["fake_door","west","attic"],Duration:2147483647}
