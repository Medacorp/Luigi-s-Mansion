summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.rocking_horse"}',Rotation:[90.0f,0.0f],Tags:["rocking_horse","battle"],Pose:{Head:[0.0f,0.0f,0.01f]},NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:9}}],Invisible:1b,DisabledSlots:2039583}
