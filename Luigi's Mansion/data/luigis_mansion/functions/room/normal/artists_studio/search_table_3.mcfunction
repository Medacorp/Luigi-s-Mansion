...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 695 30.5 -75 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 695 30.5 -75 run function luigis_mansion:blocks/dust
scoreboard players set #artists_studio_table_3 Searched 1
tag @e[x=695.5,y=30,z=-74.5,distance=..0.7,tag=ghost_marker] add spawn
