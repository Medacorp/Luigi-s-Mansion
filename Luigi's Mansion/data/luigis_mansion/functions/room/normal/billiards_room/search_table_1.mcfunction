...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 679 12 88 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 679 11 88 run function luigis_mansion:blocks/dust
...
tag @e[x=679.5,y=11,z=88.5,distance=..0.7,tag=ghost_marker] add spawn