...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 683 12 88 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 683 11 88 run function luigis_mansion:blocks/dust
...
tag @e[x=683.5,y=11,z=88.5,distance=..0.7,tag=ghost_marker] add spawn