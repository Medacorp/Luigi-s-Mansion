...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 685 12 67 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 685 11 67 run function luigis_mansion:blocks/dust
...
tag @e[x=685.5,y=11,z=67.5,distance=..0.7,tag=ghost_marker] add spawn