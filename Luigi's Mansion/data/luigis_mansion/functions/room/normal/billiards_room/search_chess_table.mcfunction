...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 683 103 15 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 683 102 15 run function luigis_mansion:blocks/dust
scoreboard players set #billiards_room_chess_table Searched 1
tag @e[x=683.5,y=102,z=15.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=683.5,y=102,z=15.5,distance=..0.7,tag=ghost_marker] add spawn