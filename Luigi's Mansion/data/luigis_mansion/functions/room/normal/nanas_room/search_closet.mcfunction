...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/nanas_room/closet
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 661 20 -27 run function luigis_mansion:blocks/dust
...
tag @e[x=661.5,y=20,z=-26.5,distance=..0.7,tag=ghost_marker] add spawn