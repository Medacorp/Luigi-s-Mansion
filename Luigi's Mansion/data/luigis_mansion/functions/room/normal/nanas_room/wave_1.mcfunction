execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{nanas_room_speedy_spirit:1b} positioned 658 20 -23 run function luigis_mansion:spawn_entities/new_ghost/speedy_spirit
