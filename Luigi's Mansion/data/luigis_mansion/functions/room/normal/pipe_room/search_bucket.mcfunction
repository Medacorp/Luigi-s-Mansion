...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 698 3 -4 run function luigis_mansion:room/normal/pipe_room/bucket
