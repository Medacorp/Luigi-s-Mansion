...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.dining_room{cleared:1b} if entity @s[tag=!blackout] at @s run function luigis_mansion:room/normal/kitchen/dining_room_noise