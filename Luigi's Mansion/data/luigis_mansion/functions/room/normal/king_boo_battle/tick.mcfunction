...
execute if score #king_boo_battle ReturnTimer matches 100.. run function luigis_mansion:room/normal/king_boo_battle/clear_secret_altar

execute as @a[gamemode=!spectator,scores={Room=75}] run function luigis_mansion:room/normal/king_boo_battle/tick_per_player
