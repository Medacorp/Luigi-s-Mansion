...
execute as @a[x=676,y=20,z=55,dx=12,dy=6,dz=21] unless entity @s[scores={Room=4}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=676,y=20,z=55,dx=12,dy=6,dz=21] run scoreboard players set @s Room 4

scoreboard players set @e[scores={Room=4},type=!minecraft:area_effect_cloud] MirrorX 677

execute as @a[gamemode=!spectator,x=676,y=20,z=55,dx=12,dy=6,dz=21] run function luigis_mansion:room/normal/wardrobe_room/tick_per_player
