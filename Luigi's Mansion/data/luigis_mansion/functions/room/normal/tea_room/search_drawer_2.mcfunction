...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 659 111 -40 run function luigis_mansion:blocks/dust
...
tag @e[x=659.5,y=111,z=-39.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=659.5,y=111,z=-39.5,distance=..0.7,tag=ghost_marker] add spawn
teleport @e[x=659.5,y=111,z=-39.5,distance=..0.7,tag=spawn] 659 111 -39