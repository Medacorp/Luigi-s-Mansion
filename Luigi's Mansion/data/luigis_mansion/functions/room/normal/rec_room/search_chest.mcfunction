...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] unless score #rec_room_chest Searched matches 1 run function luigis_mansion:room/normal/rec_room/chest
