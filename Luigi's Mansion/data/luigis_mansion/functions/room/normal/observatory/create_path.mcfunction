...
execute unless data storage luigis_mansion:data current_state.current_data.technical_data{has_marios_star:1b} positioned 642.0 20 -139.0 run function luigis_mansion:spawn_entities/item/marios_star
