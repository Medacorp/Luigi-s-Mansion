...
execute as @a[x=737,y=20,z=53,dx=14,dy=6,dz=20] unless entity @s[scores={Room=9}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=737,y=20,z=53,dx=14,dy=6,dz=20] run scoreboard players set @s Room 9

execute as @a[gamemode=!spectator,x=737,y=20,z=53,dx=14,dy=6,dz=20] run function luigis_mansion:room/normal/nursery/tick_per_player
