...
tag @s[x=685,y=135,z=-22,dx=2,dy=0,dz=2] remove seen_room_name
tag @s[x=685,y=135,z=-22,dx=2,dy=0,dz=2] remove seen_room_name_2
execute at @s[x=685,y=135,z=-22,dx=2,dy=0,dz=2] run teleport @s 684 111 ~4