...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 714 11 61 run function luigis_mansion:blocks/dust
...
tag @e[x=714.5,y=11,z=61.5,distance=..0.7,tag=ghost_marker] add spawn