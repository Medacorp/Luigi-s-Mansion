function luigis_mansion:room/normal/basement_stairs/turn_on_lights
execute if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/display/normal/basement_stairs
