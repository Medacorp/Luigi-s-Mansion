...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 696 23 -85 run function luigis_mansion:blocks/dust
scoreboard players set #sealed_room_trophy_2 Searched 1
tag @e[x=696.5,y=23,z=-84.5,distance=..0.7,tag=ghost_marker] add spawn