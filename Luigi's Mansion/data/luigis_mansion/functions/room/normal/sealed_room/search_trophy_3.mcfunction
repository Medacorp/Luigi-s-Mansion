...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/sealed_room/trophy_3
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 704 23 -85 run function luigis_mansion:blocks/dust
