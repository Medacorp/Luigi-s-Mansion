...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/sealed_room/chest_9
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 706 23 -85 run function luigis_mansion:blocks/dust
