...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 706 23 -85 run function luigis_mansion:blocks/dust
scoreboard players set #sealed_room_chest_9 Searched 1
data merge block 706 23 -85 {LootTable:"luigis_mansion:search"}
tag @e[x=706.5,y=23,z=-84.5,distance=..0.7,tag=ghost_marker] add spawn