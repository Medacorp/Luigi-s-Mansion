...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 704 21 -68 run function luigis_mansion:blocks/dust
scoreboard players set #sealed_room_chest_3 Searched 1
data merge block 704 21 -68 {LootTable:"luigis_mansion:search"}
tag @e[x=704.5,y=21,z=-67.5,distance=..0.7,tag=ghost_marker] add spawn