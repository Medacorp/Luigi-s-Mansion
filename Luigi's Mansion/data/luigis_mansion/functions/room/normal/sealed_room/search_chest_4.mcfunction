...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 695 21 -71.0 run function luigis_mansion:blocks/dust
...
tag @e[x=695.5,y=21,z=-70.5,distance=..0.7,tag=ghost_marker] add spawn