...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 687 114 -39 run function luigis_mansion:blocks/dust
scoreboard players set #sealed_room_chest_8 Searched 1
data merge block 687 114 -39 {LootTable:"luigis_mansion:search"}
tag @e[x=687.5,y=114,z=-38.5,distance=..0.7,tag=ghost_marker] add spawn