...
execute as @a[gamemode=!spectator,x=742,y=28,z=-17,dx=22,dy=8,dz=8] unless entity @s[scores={Room=51}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=742,y=28,z=-17,dx=22,dy=8,dz=8] run scoreboard players set @s Room 51
