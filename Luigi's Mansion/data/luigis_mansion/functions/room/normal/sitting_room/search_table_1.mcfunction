...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 717 112 -5 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 717 112 -4 run function luigis_mansion:blocks/dust
...
tag @e[x=717.5,y=111,z=-3.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=717.5,y=111,z=-3.5,distance=..0.7,tag=hidden_boo] add spawn