...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 746 21 -22 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 746 21 -21 run function luigis_mansion:blocks/dust
...
tag @e[x=746.5,y=20,z=-20.5,distance=..0.7,tag=ghost_marker] add spawn
