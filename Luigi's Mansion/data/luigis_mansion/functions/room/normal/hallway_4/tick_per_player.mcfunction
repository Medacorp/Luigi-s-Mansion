...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.dining_room{cleared:1b} at @s[tag=!blackout] run function luigis_mansion:room/normal/hallway_4/dining_room_noise
