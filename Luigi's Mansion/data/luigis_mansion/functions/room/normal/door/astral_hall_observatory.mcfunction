...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=35}] 666 20 -92.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=36}] 645 20 -72.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=35}] 666 20 -92.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=36}] 645 20 -72.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=666.0,y=20,z=-92.0,dx=0,dy=1,dz=0] at @s unless data storage luigis_mansion:data current_state.current_data.rooms.astral_hall{cleared:1b} at @s run function luigis_mansion:room/normal/astral_hall/trick_door
execute if score #temp Searched matches 1..2 as @a[x=666.0,y=20,z=-92.0,dx=0,dy=1,dz=0] at @s run teleport @s 645 20 -74
execute if score #temp Searched matches 1..2 as @a[x=645.0,y=20,z=-73.0,dx=0,dy=1,dz=0] at @s run teleport @s 666 20 -91
