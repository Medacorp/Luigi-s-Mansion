...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=46}] 741 2 -42.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=47}] 726 2 -21.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=46}] 741 2 -42.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=47}] 726 2 -21.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=2,z=-43.0,dx=0,dy=1,dz=0] at @s run teleport @s 726 2 -20
execute if score #temp Searched matches 1..2 as @a[x=726.0,y=2,z=-21.0,dx=0,dy=1,dz=0] at @s run teleport @s 741 2 -44
