...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=50}] 738 29 -34.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=51}] 753 29 -16.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=50}] 738 29 -34.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=51}] 753 29 -16.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=29,z=-35.0,dx=0,dy=1,dz=0] run teleport @s 753 29 -15
execute if score #temp Searched matches 1..2 as @a[x=753.0,y=29,z=-16.0,dx=0,dy=1,dz=0] run teleport @s 738 29 -36
