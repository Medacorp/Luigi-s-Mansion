...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=41}] 736 29 -16.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=58}] 699 29 -55.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=41}] 736 29 -16.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=58}] 699 29 -55.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=736.0,y=29,z=-16.0,dx=0,dy=1,dz=0] at @s run teleport @s 699 29 -57
execute if score #temp Searched matches 1..2 as @a[x=699.0,y=29,z=-56.0,dx=0,dy=1,dz=0] at @s run teleport @s 736 29 -15
