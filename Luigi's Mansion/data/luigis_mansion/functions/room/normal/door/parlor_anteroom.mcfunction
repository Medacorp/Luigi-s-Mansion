...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=2}] 713.0 20 21 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=3}] 695.0 20 26 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=2}] 713.0 20 21 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=3}] 695.0 20 26 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=713.0,y=20,z=21.0,dx=0,dy=1,dz=0] at @s run teleport @s 693 20 26
execute if score #temp Searched matches 1..2 as @a[x=694.0,y=20,z=26.0,dx=0,dy=1,dz=0] at @s run teleport @s 714 20 21
