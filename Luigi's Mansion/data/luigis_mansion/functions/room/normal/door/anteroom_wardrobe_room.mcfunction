...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=3}] 689 20 42.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=4}] 682 20 56.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=3}] 689 20 42.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=4}] 682 20 56.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=689.0,y=20,z=42.0,dx=0,dy=1,dz=0] at @s run teleport @s 682 20 57
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=20,z=56.0,dx=0,dy=1,dz=0] at @s run teleport @s 689 20 41
