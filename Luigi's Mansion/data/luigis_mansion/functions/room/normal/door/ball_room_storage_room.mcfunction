...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=13}] 696.0 11 -64 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=14}] 691.0 11 -64 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=13}] 696.0 11 -64 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=14}] 691.0 11 -64 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=696.0,y=11,z=-64.0,dx=0,dy=1,dz=0] at @s run teleport @s 689 11 -64
execute if score #temp Searched matches 1..2 as @a[x=690.0,y=11,z=-64.0,dx=0,dy=1,dz=0] at @s run teleport @s 697 11 -64
