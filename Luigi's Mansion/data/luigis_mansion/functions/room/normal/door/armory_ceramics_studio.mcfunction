...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=64}] 745.0 29 58 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=65}] 713.0 29 60 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=64}] 745.0 29 58 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=65}] 713.0 29 60 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=745.0,y=29,z=58.0,dx=0,dy=1,dz=0] run teleport @s 711 29 60
execute if score #temp Searched matches 1..2 as @a[x=712.0,y=29,z=60.0,dx=0,dy=1,dz=0] run teleport @s 746 29 58
