...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=683.0,y=120,z=-12.5] if data storage luigis_mansion:data current_state.current_data.obtained_keys{balcony_2:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{balcony_2:1b} run function luigis_mansion:room/normal/balcony_2/unlock_door
execute if block 683 120 -13 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{balcony_2:1b} positioned 683 120 -13 run function luigis_mansion:blocks/closed_door
...
execute if score #temp Searched matches 1 run setblock 683 120 -13 minecraft:oak_door[open=true,facing=west,half=lower,hinge=right,powered=false]
execute if score #temp Searched matches 1 run setblock 683 121 -13 minecraft:oak_door[open=true,facing=west,half=upper,hinge=right,powered=false]
...
execute if score #temp Searched matches -1..0 run setblock 683 120 -13 minecraft:oak_door[open=false,facing=west,half=lower,hinge=right,powered=false]
execute if score #temp Searched matches -1..0 run setblock 683 121 -13 minecraft:oak_door[open=false,facing=west,half=upper,hinge=right,powered=false]
