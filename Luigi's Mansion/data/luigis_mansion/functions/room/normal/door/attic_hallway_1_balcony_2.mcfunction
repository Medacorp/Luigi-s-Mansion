...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=41}] 725.0 29 -13 1 1
...
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=41}] 725.0 29 -13 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=725.0,y=29,z=-13.0,dx=0,dy=1,dz=0] at @s run teleport @s 681 120 -13
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=120,z=-13.0,dx=0,dy=1,dz=0] at @s run teleport @s 726 29 -13
