...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a 660.0 11 -44 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a 649.0 11 -44 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a 660.0 11 -44 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=648.0,y=11,z=-44.0,dx=0,dy=1,dz=0] at @s run teleport @s 661 11 -44
execute if score #temp Searched matches 1..2 as @a[x=660.0,y=11,z=-44.0,dx=0,dy=1,dz=0] at @s run teleport @s 647 11 -44
