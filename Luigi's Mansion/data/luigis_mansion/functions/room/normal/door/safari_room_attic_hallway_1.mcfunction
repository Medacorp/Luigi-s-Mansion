...
execute if score #temp Searched matches 1 run fill 711 120 -17 711 121 -16 minecraft:air replace #minecraft:doors
...
execute if score #temp Searched matches -1..0 run fill 711 120 -17 711 121 -16 minecraft:air replace #minecraft:doors
