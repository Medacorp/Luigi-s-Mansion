...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=31}] 673 20 5.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=34}] 658 20 -1.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=31}] 673 20 5.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=34}] 658 20 -1.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=673.0,y=20,z=5.0,dx=0,dy=1,dz=0] at @s run teleport @s 658 20 -3
execute if score #temp Searched matches 1..2 as @a[x=658.0,y=20,z=-2.0,dx=0,dy=1,dz=0] at @s run teleport @s 673 20 6
