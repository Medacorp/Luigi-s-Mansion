...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=739.5,y=20,z=19.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{small_hallway:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{small_hallway:1b} positioned 739 20 18 run function luigis_mansion:room/normal/small_hallway/unlock_door
execute if block 739 20 18 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{small_hallway:1b} positioned 739 20 18 run function luigis_mansion:blocks/closed_door
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=1}] 739 20 19.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=6}] 726 20 42.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=1}] 739 20 19.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=6}] 726 20 42.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=739.0,y=20,z=18.0,dx=0,dy=1,dz=0] at @s run teleport @s 726 20 43
execute if score #temp Searched matches 1..2 as @a[x=726.0,y=20,z=42.0,dx=0,dy=1,dz=0] at @s run teleport @s 739 20 17
