...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=10}] 673 11 12.0 1 1
...
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=10}] 673 11 12.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=673.0,y=11,z=11.0,dx=0,dy=1,dz=0] at @s run teleport @s 654 11 17
execute if score #temp Searched matches 1..2 as @a[x=654.0,y=11,z=16.0,dx=0,dy=1,dz=0] at @s run teleport @s 673 11 10
