...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=6}] 723.0 20 47 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=7}] 716.0 20 48 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=6}] 723.0 20 47 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=7}] 716.0 20 48 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=723.0,y=20,z=47.0,dx=0,dy=1,dz=0] at @s run teleport @s 715 20 48
execute if score #temp Searched matches 1..2 as @a[x=716.0,y=20,z=48.0,dx=0,dy=1,dz=0] at @s run teleport @s 724 20 47
