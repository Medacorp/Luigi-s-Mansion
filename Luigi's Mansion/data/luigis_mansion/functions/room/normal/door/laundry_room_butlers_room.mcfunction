...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a 720.0 11 65 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a 738.0 11 61 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a 720.0 11 65 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a 738.0 11 61 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=11,z=65.0,dx=0,dy=1,dz=0] at @s run teleport @s 739 11 61
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=11,z=61.0,dx=0,dy=1,dz=0] at @s run teleport @s 718 11 65
