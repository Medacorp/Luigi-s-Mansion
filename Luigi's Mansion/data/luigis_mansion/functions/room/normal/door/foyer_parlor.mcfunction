...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=1}] 736.0 20 9.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=2}] 729.0 20 28.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=1}] 736.0 20 9.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=2}] 729.0 20 28.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=736.0,y=20,z=8.0,dx=0,dy=1,dz=1] at @s run teleport @s 727 20 28.0
execute if score #temp Searched matches 1..2 as @a[x=728.0,y=20,z=27.0,dx=0,dy=1,dz=1] at @s run teleport @s 737 20 9.0
