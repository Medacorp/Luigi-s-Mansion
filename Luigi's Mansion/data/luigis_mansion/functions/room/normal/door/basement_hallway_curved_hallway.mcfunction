...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=47}] 700.0 2 -18 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=48}] 686.0 2 -18 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=47}] 700.0 2 -18 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=48}] 686.0 2 -18 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=700.0,y=2,z=-18.0,dx=0,dy=1,dz=0] at @s run teleport @s 684 2 -18
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=2,z=-18.0,dx=0,dy=1,dz=0] at @s run teleport @s 701 2 -18
