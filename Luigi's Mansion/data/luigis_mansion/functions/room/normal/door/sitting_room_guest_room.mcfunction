...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=56}] 741 20 -38.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=57}] 741 20 -42.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=56}] 741 20 -38.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=57}] 741 20 -42.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=20,z=-38.0,dx=0,dy=1,dz=0] at @s run teleport @s 741 20 -44
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=20,z=-43.0,dx=0,dy=1,dz=0] at @s run teleport @s 741 20 -37
