...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=6}] 723.0 20 75 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=8}] 699.0 111 51 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=6}] 723.0 20 75 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=8}] 699.0 111 51 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=723.0,y=20,z=75.0,dx=0,dy=1,dz=0] at @s run teleport @s 697 111 51
execute if score #temp Searched matches 1..2 as @a[x=698.0,y=111,z=51.0,dx=0,dy=1,dz=0] at @s run teleport @s 724 20 75
