...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=699.0,y=120,z=-3.5] if data storage luigis_mansion:data current_state.current_data.obtained_keys{clockwork_room:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{clockwork_room:1b} run function luigis_mansion:room/normal/clockwork_room/unlock_door
