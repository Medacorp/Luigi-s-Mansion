...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=10}] 706 11 -22.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=13}] 705 11 -37.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=10}] 706 11 -22.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=13}] 705 11 -37.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=-22.0,dx=0,dy=1,dz=0] run scoreboard players set @s HallwayNoise 0
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=-22.0,dx=0,dy=1,dz=0] at @s run teleport @s 705 11 -39
execute if score #temp Searched matches 1..2 as @a[x=705.0,y=11,z=-38.0,dx=0,dy=1,dz=0] at @s run teleport @s 706 11 -21
