...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=48}] 654.0 2 -18 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=59}] 654.0 93 -18 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=48}] 654.0 2 -18 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=59}] 654.0 93 -18 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=654.0,y=2,z=-18.0,dx=0,dy=1,dz=0] at @s run teleport @s 652 93 -18
...
execute if score #temp Searched matches 1..2 as @a[x=653.0,y=93,z=-18.0,dx=0,dy=1,dz=0,tag=!return_mario] at @s run teleport @s 655 2 -18
