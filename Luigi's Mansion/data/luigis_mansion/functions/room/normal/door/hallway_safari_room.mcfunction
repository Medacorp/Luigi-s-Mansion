...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=31}] 720.0 29 -34 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=40}] 733.0 29 -39 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=31}] 720.0 29 -34 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=40}] 733.0 29 -39 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=29,z=-34.0,dx=0,dy=1,dz=0] at @s run teleport @s 734 29 -39
execute if score #temp Searched matches 1..2 as @a[x=733.0,y=29,z=-39.0,dx=0,dy=1,dz=0] at @s run teleport @s 718 29 -34
