...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=10}] 706 11 -15.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=22}] 704 11 29.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=10}] 706 11 -15.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=22}] 704 11 29.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=-16.0,dx=0,dy=1,dz=0] run scoreboard players set @s HallwayNoise 0
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=-16.0,dx=0,dy=1,dz=0] at @s run teleport @s 704 11 30
execute if score #temp Searched matches 1..2 as @a[x=704.0,y=11,z=29.0,dx=0,dy=1,dz=0] at @s run teleport @s 706 11 -17
