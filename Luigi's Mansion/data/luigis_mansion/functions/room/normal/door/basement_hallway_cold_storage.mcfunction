...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=712.5,y=93,z=-14.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{cold_storage:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{cold_storage:1b} run function luigis_mansion:room/normal/cold_storage/unlock_door
