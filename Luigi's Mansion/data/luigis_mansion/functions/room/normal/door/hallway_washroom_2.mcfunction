...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=31}] 682 20 12.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=32}] 664 20 35.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=31}] 682 20 12.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=32}] 664 20 35.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=20,z=11.0,dx=0,dy=1,dz=0] at @s run teleport @s 664 20 36
execute if score #temp Searched matches 1..2 as @a[x=664.0,y=20,z=35.0,dx=0,dy=1,dz=0] at @s run teleport @s 682 20 10
