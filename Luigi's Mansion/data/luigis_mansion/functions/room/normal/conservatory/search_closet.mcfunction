...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 655 12 -26 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 654 12 -26.0 run function luigis_mansion:blocks/dust
...
tag @e[x=654.5,y=12,z=-25.5,distance=..0.7,tag=ghost_marker] add spawn