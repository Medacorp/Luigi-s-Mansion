...
execute as @a[x=735,y=11,z=-2,dx=21,dy=15,dz=21] unless entity @s[scores={Room=1}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=735,y=11,z=-2,dx=21,dy=15,dz=21] run scoreboard players set @s Room 1
