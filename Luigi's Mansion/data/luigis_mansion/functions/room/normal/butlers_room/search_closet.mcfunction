...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/butlers_room/closet
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 739 12 66 run function luigis_mansion:blocks/dust
...
tag @e[x=739.5,y=11,z=66.5,distance=..0.7,tag=ghost_marker] add spawn