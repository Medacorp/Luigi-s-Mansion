...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 741 32 32 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 741 32 33 run function luigis_mansion:blocks/dust
scoreboard players set #telephone_room_shelf_1 Searched 1
tag @e[x=741.5,y=32,z=33.5,distance=..0.7,tag=ghost_marker] add spawn
