...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 663 21 -89 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 662 20 -89 run function luigis_mansion:blocks/dust
...
tag @e[x=662.5,y=20,z=-88.5,distance=..0.7,tag=ghost_marker] add spawn