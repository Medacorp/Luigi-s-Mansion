...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 666 23 -82 run function luigis_mansion:room/normal/astral_hall/lamp
