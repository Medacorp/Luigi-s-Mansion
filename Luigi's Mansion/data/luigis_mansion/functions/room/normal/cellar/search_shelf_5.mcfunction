...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 743 5 -60 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 743 5 -61 run function luigis_mansion:blocks/dust
scoreboard players set #cellar_shelf_5 Searched 1
tag @e[x=743.5,y=4,z=-60.5,distance=..0.7,tag=ghost_marker] add spawn
