...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/cellar/shelf_3
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 742 7 -52 run function luigis_mansion:blocks/dust
