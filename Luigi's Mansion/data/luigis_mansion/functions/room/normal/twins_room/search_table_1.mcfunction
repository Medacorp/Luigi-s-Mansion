...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 738 21 48.0 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 738 20 48.0 run function luigis_mansion:blocks/dust
...
tag @e[x=738.5,y=20,z=48.5,distance=..0.7,tag=ghost_marker] add spawn