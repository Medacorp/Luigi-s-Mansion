...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 746 29 63.0 run function luigis_mansion:blocks/dust
...
tag @e[x=746.5,y=29,z=63.5,distance=..0.7,tag=ghost_marker] add spawn
