...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/armory/chest_5
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 700 120 40.0 run function luigis_mansion:blocks/dust
...
tag @e[x=700.5,y=120,z=40.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=700.5,y=120,z=40.5,distance=..0.7,tag=hidden_boo] add spawn