...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 750.0 29 74 run function luigis_mansion:blocks/dust
...
tag @e[x=750.5,y=29,z=74.5,distance=..0.7,tag=ghost_marker] add spawn
