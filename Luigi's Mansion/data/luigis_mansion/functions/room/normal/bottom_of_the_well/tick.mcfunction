...
execute as @a[x=645,y=93,z=-10,dx=6,dy=8,dz=11] unless entity @s[scores={Room=27}] run scoreboard players operation @s LastRoom = @s Room
...
execute as @a[gamemode=!spectator,x=647,y=93,z=-8,dx=2,dy=6,dz=8] run function luigis_mansion:room/normal/bottom_of_the_well/tick_per_player
