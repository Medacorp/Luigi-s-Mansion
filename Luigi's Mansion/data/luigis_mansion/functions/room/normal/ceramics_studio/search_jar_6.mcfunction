...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 696 120 42 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 697 120 42 run function luigis_mansion:blocks/dust
...
tag @e[x=697.5,y=120,z=42.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=697.5,y=120,z=42.5,distance=..0.7,tag=hidden_boo] add spawn