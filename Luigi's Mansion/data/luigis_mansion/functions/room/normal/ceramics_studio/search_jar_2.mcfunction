...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/ceramics_studio/jar_2
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 709 29 73 run function luigis_mansion:blocks/dust
...
tag @e[x=709.5,y=29,z=73.5,distance=..0.7,tag=ghost_marker] add spawn
