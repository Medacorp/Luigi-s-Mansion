...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/ceramics_studio/jar_5
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 701 29 67 run function luigis_mansion:blocks/dust
