...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/normal/ceramics_studio/jar_5
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 687 120 42 run function luigis_mansion:blocks/dust
...
tag @e[x=687.5,y=120,z=42.5,distance=..0.7,tag=ghost_marker] add spawn
tag @e[x=687.5,y=120,z=42.5,distance=..0.7,tag=hidden_boo] add spawn