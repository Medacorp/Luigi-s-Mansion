...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 701 29 67 run function luigis_mansion:blocks/dust
...
tag @e[x=701.5,y=29,z=67.5,distance=..0.7,tag=ghost_marker] add spawn
