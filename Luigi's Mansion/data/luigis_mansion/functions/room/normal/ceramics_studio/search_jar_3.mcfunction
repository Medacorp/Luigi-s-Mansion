...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 702 29 70 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 701 29 70 run function luigis_mansion:blocks/dust
...
tag @e[x=701.5,y=29,z=70.5,distance=..0.7,tag=ghost_marker] add spawn
