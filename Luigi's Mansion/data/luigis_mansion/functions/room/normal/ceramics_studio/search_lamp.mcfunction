...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 691 124 41 run function luigis_mansion:spawn_entities/item/poison_mushroom
