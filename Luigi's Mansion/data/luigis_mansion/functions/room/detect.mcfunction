...
execute as @a[gamemode=spectator,x=778,y=77,z=4,dx=20,dy=11,dz=21] at @s run function luigis_mansion:room/underground_lab/spectator_tick
...
execute as @a[gamemode=spectator,x=781,y=77,z=-23,dx=19,dy=6,dz=27] at @s run function luigis_mansion:room/training_room/spectator_tick
...
execute as @a[gamemode=spectator,x=764,y=77,z=-15,dx=15,dy=6,dz=40] at @s run function luigis_mansion:room/ghost_portrificationizer_room/spectator_tick
...
execute as @a[gamemode=spectator,x=727,y=77,z=-42,dx=52,dy=9,dz=27] at @s run function luigis_mansion:room/gallery/spectator_tick
