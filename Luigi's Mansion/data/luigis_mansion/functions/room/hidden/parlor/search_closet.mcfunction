...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=poison_mushroom] positioned 715 22 -19 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 714 21 -19 run function luigis_mansion:blocks/dust
...
tag @e[x=714.5,y=20,z=-18.5,distance=..0.7,tag=ghost_marker] add spawn