...
execute unless block 733 32 61 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/safari_room/search_deer_head_3