execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{twins_room_speedy_spirit:1b} positioned 708 113 -7 run function luigis_mansion:spawn_entities/ghost/speedy_spirit
...
execute positioned 713 111 -14 run function luigis_mansion:spawn_entities/ghost/empty_marker
execute positioned 713 111 -14 run function luigis_mansion:spawn_entities/ghost/empty_marker
