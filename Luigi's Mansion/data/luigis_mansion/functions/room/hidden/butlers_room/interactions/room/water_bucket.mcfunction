...
execute unless block 747 11 -40 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/butlers_room/search_water_bucket