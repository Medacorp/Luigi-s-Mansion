...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 712 103 -31 run function luigis_mansion:spawn_entities/item/poison_mushroom
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 712.0 102 -31.0 run function luigis_mansion:blocks/dust
...
tag @e[x=713.5,y=102,z=-31.5,distance=..0.7,tag=ghost,tag=hidden] add spawn