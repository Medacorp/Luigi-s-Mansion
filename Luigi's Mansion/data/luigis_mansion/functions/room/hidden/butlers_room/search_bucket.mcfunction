...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 717 102 -40 run function luigis_mansion:blocks/dust
...
tag @e[x=717.5,y=102,z=-39.5,distance=..0.7,tag=ghost,tag=hidden] add spawn