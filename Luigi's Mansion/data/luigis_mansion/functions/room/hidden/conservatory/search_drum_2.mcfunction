...
execute positioned 658 102 11 run function luigis_mansion:blocks/dust
scoreboard players set #conservatory_drum_2 Searched 1
tag @e[x=658.5,y=102,z=11.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=658.5,y=102,z=11.5,distance=..0.7,tag=ghost,tag=hidden] add spawn