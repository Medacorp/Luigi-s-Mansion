...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 668 102 -19 run function luigis_mansion:blocks/dust
...
tag @e[x=668.5,y=102,z=-18.5,distance=..0.7,tag=ghost,tag=hidden] add spawn