...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/hidden/balcony_2/plant_10
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] 655 120 31 run function luigis_mansion:blocks/dust
