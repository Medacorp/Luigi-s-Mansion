...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 659 113 47 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 659 112 47 run function luigis_mansion:blocks/dust
...
tag @e[x=659.5,y=112,z=47.5,distance=..0.7,tag=ghost,tag=hidden] add spawn