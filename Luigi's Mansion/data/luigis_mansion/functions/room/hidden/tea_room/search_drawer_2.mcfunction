...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 659 111 55 run function luigis_mansion:blocks/dust
...
tag @e[x=659.5,y=111,z=-39.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
