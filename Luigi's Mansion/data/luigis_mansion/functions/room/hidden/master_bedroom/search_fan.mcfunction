...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 691.0 115 -31.0 run function luigis_mansion:room/hidden/master_bedroom/fan
