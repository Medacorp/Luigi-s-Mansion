...
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=small_heart] positioned 696.0 112 -24 run function luigis_mansion:spawn_entities/item/small_heart
execute if entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/hidden/master_bedroom/table_2
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 696.0 111 -24 run function luigis_mansion:blocks/dust
...
tag @e[x=695.5,y=111,z=-23.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=695.5,y=111,z=-23.5,distance=..0.7,tag=ghost_marker] add spawn