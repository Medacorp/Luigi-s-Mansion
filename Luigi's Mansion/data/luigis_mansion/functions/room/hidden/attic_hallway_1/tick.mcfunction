...
execute as @a[gamemode=!spectator,x=724,y=28,z=24,dx=40,dy=8,dz=8] unless entity @s[scores={Room=41}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=724,y=28,z=24,dx=40,dy=8,dz=8] run scoreboard players set @s Room 41
tag @e[tag=ghost,scores={Room=41}] add no_hidden_move

execute as @a[gamemode=!spectator,x=724,y=28,z=24,dx=40,dy=8,dz=8] run function luigis_mansion:room/hidden/attic_hallway_1/tick_per_player
