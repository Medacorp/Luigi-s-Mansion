...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/hidden/anteroom/table_2
...
tag @e[x=685.5,y=21,z=-17.5,distance=..0.7,tag=ghost,tag=hidden] add spawn