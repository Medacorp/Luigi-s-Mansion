...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=chance,tag=selected,tag=!nothing] positioned 685 21 -17.0 run function luigis_mansion:blocks/dust
...
tag @e[x=685.5,y=21,z=-17.5,distance=..0.7,tag=hidden_boo] add spawn
tag @e[x=685.5,y=21,z=-17.5,distance=..0.7,tag=ghost_marker] add spawn