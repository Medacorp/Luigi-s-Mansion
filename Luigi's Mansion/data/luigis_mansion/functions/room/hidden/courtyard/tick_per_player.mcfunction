...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.secret_altar{cleared:1b} run playsound luigis_mansion:entity.mario.hey_whats_the_hold_up neutral @s[scores={HallwayNoise=0}] 648 101 18 1
