...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=51}] 745.0 29 -43 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=52}] 713.0 29 -45 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=51}] 745.0 29 -43 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=52}] 713.0 29 -45 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=745.0,y=29,z=-43.0,dx=0,dy=1,dz=0] at @s run teleport @s 712 29 -45
execute if score #temp Searched matches 1..2 as @a[x=712.0,y=29,z=-45.0,dx=0,dy=1,dz=0] at @s run teleport @s 746 29 -43
