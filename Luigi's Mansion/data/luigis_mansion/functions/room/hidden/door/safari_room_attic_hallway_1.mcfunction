...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=40}] 738 29 50.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=41}] 753 29 32.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=40}] 738 29 50.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=41}] 753 29 32.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=29,z=50.0,dx=0,dy=1,dz=0] at @s run teleport @s 753 29 31
execute if score #temp Searched matches 1..2 as @a[x=753.0,y=29,z=-27.0,dx=0,dy=1,dz=0] at @s run teleport @s 738 29 51
