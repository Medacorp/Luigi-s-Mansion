...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=47}] 681 11 -49.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=48}] 681 11 -30.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=47}] 681 11 -49.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=48}] 681 11 -30.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=681.0,y=11,z=-50.0,dx=0,dy=1,dz=0] run teleport @s 681 11 -29
execute if score #temp Searched matches 1..2 as @a[x=681.0,y=11,z=-30.0,dx=0,dy=1,dz=0] run teleport @s 681 11 -51
