...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=706.0,y=111,z=32.5] if data storage luigis_mansion:data current_state.current_data.obtained_keys{sitting_room:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{sitting_room:1b} run function luigis_mansion:room/hidden/sitting_room/unlock_door
