...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=31}] 691 20 38.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=35}] 666 20 87.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=31}] 691 20 38.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=35}] 666 20 87.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=691.0,y=20,z=37.0,dx=0,dy=1,dz=0] at @s run teleport @s 666 20 88
execute if score #temp Searched matches 1..2 as @a[x=666.0,y=20,z=87.0,dx=0,dy=1,dz=0] at @s run teleport @s 691 20 36
