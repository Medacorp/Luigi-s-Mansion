...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=41}] 720.0 29 49 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=50}] 733.0 29 54 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=41}] 720.0 29 49 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=50}] 733.0 29 54 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=29,z=49.0,dx=0,dy=1,dz=0] run teleport @s 734 29 54
execute if score #temp Searched matches 1..2 as @a[x=733.0,y=29,z=54.0,dx=0,dy=1,dz=0] run teleport @s 718 29 49
