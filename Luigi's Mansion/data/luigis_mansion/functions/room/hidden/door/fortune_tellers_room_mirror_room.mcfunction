...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=16}] 741 11 54.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=17}] 741 11 58.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=16}] 741 11 54.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=17}] 741 11 58.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=11,z=53.0,dx=0,dy=1,dz=0] at @s run teleport @s 741 11 59
execute if score #temp Searched matches 1..2 as @a[x=741.0,y=11,z=58.0,dx=0,dy=1,dz=0] at @s run teleport @s 741 11 52
