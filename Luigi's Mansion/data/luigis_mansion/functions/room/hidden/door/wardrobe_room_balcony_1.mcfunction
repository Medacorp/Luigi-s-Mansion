...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=5}] 682 20 -60.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=6}] 677 111 -22.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=5}] 682 20 -60.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=6}] 677 111 -22.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=20,z=-60.0,dx=0,dy=1,dz=0] run teleport @s 677 111 -24
execute if score #temp Searched matches 1..2 as @a[x=677.0,y=111,z=-23.0,dx=0,dy=1,dz=0] run teleport @s 682 20 -59
