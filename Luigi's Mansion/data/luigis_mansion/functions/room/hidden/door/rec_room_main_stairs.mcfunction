...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=28}] 649.0 11 59 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=29}] 660.0 11 59 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=28}] 649.0 11 59 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=29}] 660.0 11 59 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=648.0,y=11,z=59.0,dx=0,dy=1,dz=0] at @s run teleport @s 661 11 59
execute if score #temp Searched matches 1..2 as @a[x=660.0,y=11,z=59.0,dx=0,dy=1,dz=0] at @s run teleport @s 647 11 59
