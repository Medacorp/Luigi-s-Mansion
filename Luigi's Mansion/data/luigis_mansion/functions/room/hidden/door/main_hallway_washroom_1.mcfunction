...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=10}] 682 11 4.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=15}] 664 11 -19.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=10}] 682 11 4.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=15}] 664 11 -19.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=4.0,dx=0,dy=1,dz=0] run stopsound @s[scores={HallwayNoise=1..}] ambient luigis_mansion:music.mansion.melody
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=4.0,dx=0,dy=1,dz=0] run scoreboard players set @s HallwayNoise 0
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=4.0,dx=0,dy=1,dz=0] at @s run teleport @s 664 11 -21
execute if score #temp Searched matches 1..2 as @a[x=664.0,y=11,z=-20.0,dx=0,dy=1,dz=0] at @s run teleport @s 682 11 5
