...
execute in luigis_mansion:hidden if block 755 11 7 #minecraft:doors[open=true] if entity @a[tag=blackout,limit=1] positioned 755 11 7 run function luigis_mansion:blocks/closed_door
execute in luigis_mansion:hidden if block 755 11 6 #minecraft:doors[open=true] if entity @a[tag=blackout,limit=1] positioned 755 11 6 run function luigis_mansion:blocks/closed_door
