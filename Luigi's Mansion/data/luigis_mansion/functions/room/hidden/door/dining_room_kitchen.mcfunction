...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=26}] 705.0 11 -42.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=27}] 705.0 11 -46.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=26}] 705.0 11 -42.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=27}] 705.0 11 -46.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=704.0,y=11,z=-42.0,dx=1,dy=1,dz=0] run teleport @s 705.0 11 -48
execute if score #temp Searched matches 1..2 as @a[x=704.0,y=11,z=-47.0,dx=1,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=704.0,y=11,z=-47.0,dx=1,dy=1,dz=0] run teleport @s 705.0 11 -41
