...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/hidden/armory/chest_5
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 700 120 -24.0 run function luigis_mansion:blocks/dust
...
tag @e[x=700.5,y=120,z=-24.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
