...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 704.0 120 -36 run function luigis_mansion:blocks/dust
...
tag @e[x=704.5,y=120,z=-35.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
