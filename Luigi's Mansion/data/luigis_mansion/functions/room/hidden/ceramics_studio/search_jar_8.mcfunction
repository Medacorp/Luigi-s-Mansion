...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 696 120 -24 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 697 120 -24 run function luigis_mansion:blocks/dust
...
tag @e[x=697.5,y=120,z=-23.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
