...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 696 120 -30 run function luigis_mansion:blocks/dust
...
tag @e[x=696.5,y=120,z=-29.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
