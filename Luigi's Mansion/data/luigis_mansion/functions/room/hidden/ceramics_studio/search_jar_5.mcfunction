...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 687 120 -27 run function luigis_mansion:blocks/dust
...
tag @e[x=687.5,y=120,z=-26.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
