...
execute unless entity @s[scores={LastFloor=2}] run title @s[y=29,dy=6] subtitle {"translate":"luigis_mansion:location.floor.3f"}
execute unless entity @s[scores={LastFloor=3}] run title @s[y=129,dy=6] subtitle ""
execute unless entity @s[scores={LastFloor=3}] run title @s[y=38,dy=6] subtitle ""
...
execute unless entity @s[scores={LastFloor=2}] run title @s[y=120,dy=6,tag=seen_room_name] title ""
execute unless entity @s[scores={LastFloor=2}] run title @s[y=29,dy=6,tag=seen_room_name] title ""
...
execute unless entity @s[scores={LastFloor=2}] run scoreboard players set @s[y=29,dy=6] LastFloor 2
execute unless entity @s[scores={LastFloor=3}] run scoreboard players set @s[y=129,dy=6] LastFloor 3
execute unless entity @s[scores={LastFloor=3}] run scoreboard players set @s[y=38,dy=6] LastFloor 3