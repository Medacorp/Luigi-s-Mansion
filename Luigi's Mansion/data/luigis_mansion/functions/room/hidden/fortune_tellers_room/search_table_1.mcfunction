...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 736 12 37.0 run function luigis_mansion:room/hidden/fortune_tellers_room/table_1
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 736 11 37.0 run function luigis_mansion:blocks/dust
