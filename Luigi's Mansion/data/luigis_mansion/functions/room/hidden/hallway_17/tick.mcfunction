...
execute as @a[gamemode=!spectator,x=724,y=28,z=24,dx=18,dy=8,dz=8] unless entity @s[scores={Room=52}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=724,y=28,z=24,dx=18,dy=8,dz=8] run scoreboard players set @s Room 52
