...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 673 102 42 run function luigis_mansion:blocks/dust
...
tag @e[x=673.5,y=102,z=42.5,distance=..0.7,tag=ghost,tag=hidden] add spawn