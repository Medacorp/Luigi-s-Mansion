...
execute as @a[gamemode=!spectator,x=700,y=111,z=33,dx=4,dy=15,dz=22] run function luigis_mansion:room/hidden/hallway/tick_per_player
execute as @a[gamemode=!spectator,x=700,y=111,z=19,dx=4,dy=6,dz=36] unless entity @s[x=700,y=111,z=33,dx=4,dy=15,dz=22] run function luigis_mansion:room/hidden/hallway/tick_per_player
execute as @a[gamemode=!spectator,x=666,y=111,z=19,dx=38,dy=6,dz=4] unless entity @s[x=700,y=111,z=19,dx=4,dy=6,dz=36] unless entity @s[x=700,y=111,z=33,dx=4,dy=15,dz=22] run function luigis_mansion:room/hidden/hallway/tick_per_player
execute as @a[gamemode=!spectator,x=666,y=111,z=-8,dx=4,dy=6,dz=38] unless entity @s[x=666,y=111,z=19,dx=38,dy=6,dz=4] unless entity @s[x=700,y=111,z=19,dx=4,dy=6,dz=36] unless entity @s[x=700,y=111,z=33,dx=4,dy=15,dz=22] run function luigis_mansion:room/hidden/hallway/tick_per_player
execute as @a[gamemode=!spectator,x=655,y=111,z=-8,dx=15,dy=6,dz=4] unless entity @s[x=666,y=111,z=-8,dx=4,dy=6,dz=38] unless entity @s[x=666,y=111,z=19,dx=38,dy=6,dz=4] unless entity @s[x=700,y=111,z=19,dx=4,dy=6,dz=36] unless entity @s[x=700,y=111,z=33,dx=4,dy=15,dz=22] run function luigis_mansion:room/hidden/hallway/tick_per_player

function #luigis_mansion:room/hidden/hallway/interactions/room

function luigis_mansion:room/hidden/hallway/ghosts
