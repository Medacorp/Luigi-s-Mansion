...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=big_heart] positioned 742 4 67 run function luigis_mansion:spawn_entities/item/big_heart
