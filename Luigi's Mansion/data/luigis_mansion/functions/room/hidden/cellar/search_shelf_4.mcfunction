...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 743 3 75 run function luigis_mansion:spawn_entities/item/small_heart
...
tag @e[x=743.5,y=2,z=76.5,distance=..0.7,tag=hidden_boo] add spawn