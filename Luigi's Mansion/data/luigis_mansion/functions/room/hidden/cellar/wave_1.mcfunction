summon minecraft:marker 708 93 49 {Tags:["ghost_marker","ghost"],Rotation:[0.0f,90.0f]}
summon minecraft:marker 714 93 41 {Tags:["ghost_marker","ghost"],Rotation:[0.0f,90.0f]}
