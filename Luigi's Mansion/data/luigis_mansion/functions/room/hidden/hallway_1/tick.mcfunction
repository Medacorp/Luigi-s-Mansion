...
execute as @a[gamemode=!spectator,x=735,y=19,z=-4,dx=8,dy=8,dz=21] unless entity @s[scores={Room=2}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=735,y=19,z=-4,dx=8,dy=8,dz=21] run scoreboard players set @s Room 2
