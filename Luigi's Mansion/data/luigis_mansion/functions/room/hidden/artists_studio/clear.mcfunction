...
stopsound @a[scores={Room=71}] music
playsound luigis_mansion:music.cleared_room music @a[scores={Room=71}] ~ ~ ~ 10000
scoreboard players set @a[scores={Room=71}] Music 40
scoreboard players set @a[scores={Room=71}] MusicType 9