execute unless data storage luigis_mansion:data current_state.current_data.obtained_keys{secret_altar:1b} run summon minecraft:armor_stand 696 120.2 50 {CustomName:'{"translate":"luigis_mansion:item.key"}',Pose:{Head:[0.0f,-180.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:19}}],Small:1b,Tags:["item","key","secret_altar","rotated","vacuumable"],Rotation:[180.0f,0.0f],DisabledSlots:2039583}
