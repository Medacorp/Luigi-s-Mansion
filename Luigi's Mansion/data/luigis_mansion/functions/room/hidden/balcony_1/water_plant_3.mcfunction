...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 674 112 -26 run function luigis_mansion:room/hidden/balcony_1/plant_3
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 674 111 -26 run function luigis_mansion:blocks/dust
