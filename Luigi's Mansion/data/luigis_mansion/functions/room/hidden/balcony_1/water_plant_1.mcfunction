...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 675 112 -27 run function luigis_mansion:room/hidden/balcony_1/plant_1
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 675 111 -27 run function luigis_mansion:blocks/dust
