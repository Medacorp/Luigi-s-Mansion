...
execute unless score #cold_storage_fire_3 Searched matches 1 positioned 715 93.5 25 run function luigis_mansion:spawn_entities/ghost/fire_elemental_ghost