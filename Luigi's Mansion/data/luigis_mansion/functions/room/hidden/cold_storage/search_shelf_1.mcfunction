...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 712 95 15 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 712 95 14 run function luigis_mansion:blocks/dust
...
tag @e[x=712.5,y=95,z=14.5,distance=..0.7,tag=ghost,tag=hidden] add spawn