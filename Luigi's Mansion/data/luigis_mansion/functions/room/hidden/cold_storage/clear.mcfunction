...
stopsound @a[scores={Room=68}] music
playsound luigis_mansion:music.cleared_room music @a[scores={Room=68}] ~ ~ ~ 10000
scoreboard players set @a[scores={Room=68}] Music 40
scoreboard players set @a[scores={Room=68}] MusicType 9