...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 680 13.5 25 run function luigis_mansion:room/hidden/hallway_5/jar_1
