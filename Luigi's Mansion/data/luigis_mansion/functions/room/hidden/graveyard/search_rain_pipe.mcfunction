...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 669 103 -26 run function luigis_mansion:room/hidden/graveyard/rain_pipe
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 669 103 -25 run function luigis_mansion:blocks/dust
