...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 693 112 37 run function luigis_mansion:blocks/dust
kill @e[type=minecraft:marker,tag=chance]
scoreboard players set #sealed_room_chest_3 Searched 1
data merge block 693 112 37 {LootTable:"luigis_mansion:search"}
tag @e[x=693.5,y=113,z=37.5,distance=..0.7,tag=ghost,tag=hidden] add spawn