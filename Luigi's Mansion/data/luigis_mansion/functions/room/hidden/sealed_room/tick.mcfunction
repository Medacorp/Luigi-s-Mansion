...
execute as @a[gamemode=!spectator,x=693,y=19,z=70,dx=17,dy=8,dz=33] unless entity @s[scores={Room=53}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=693,y=19,z=70,dx=17,dy=8,dz=33] run scoreboard players set @s Room 53

scoreboard players set @e[scores={Room=53},type=!minecraft:marker] MirrorX 694

execute as @a[gamemode=!spectator,x=693,y=19,z=70,dx=17,dy=8,dz=33] run function luigis_mansion:room/hidden/sealed_room/tick_per_player
