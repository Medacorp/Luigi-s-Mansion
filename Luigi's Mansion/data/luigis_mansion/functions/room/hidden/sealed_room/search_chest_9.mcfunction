...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 695 114 54 run function luigis_mansion:blocks/dust
kill @e[type=minecraft:marker,tag=chance]
scoreboard players set #sealed_room_chest_9 Searched 1
data merge block 695 114 54 {LootTable:"luigis_mansion:search"}
tag @e[x=695.5,y=114,z=54.5,distance=..0.7,tag=ghost,tag=hidden] add spawn