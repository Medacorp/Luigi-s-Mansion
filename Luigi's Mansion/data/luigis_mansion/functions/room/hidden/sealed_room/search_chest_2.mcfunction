...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 696 113 27 run function luigis_mansion:blocks/dust
kill @e[type=minecraft:marker,tag=chance]
scoreboard players set #sealed_room_chest_2 Searched 1
data merge block 696 113 27 {LootTable:"luigis_mansion:search"}
tag @e[x=696.5,y=113,z=27.5,distance=..0.7,tag=ghost,tag=hidden] add spawn