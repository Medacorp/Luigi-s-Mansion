...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 744 24 -48 run function luigis_mansion:spawn_entities/item/poison_mushroom
