...
execute as @e[type=!minecraft:item_frame,x=734,y=10,z=57,dx=14,dy=8,dz=21] run scoreboard players set @s Room 21

scoreboard players set @e[scores={Room=21},type=!minecraft:marker] MirrorX 735
