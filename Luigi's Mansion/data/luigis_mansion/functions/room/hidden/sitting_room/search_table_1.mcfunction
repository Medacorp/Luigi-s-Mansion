...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 717 112 20 run function luigis_mansion:spawn_entities/item/small_heart
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 717 112 19 run function luigis_mansion:blocks/dust
...
tag @e[x=717.5,y=111,z=19.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
