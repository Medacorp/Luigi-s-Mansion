...
execute if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/display/hidden/telephone_room
playsound luigis_mansion:block.chest.spawn block @a 704 120 14 2
