...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 716.0 120 21 run function luigis_mansion:blocks/dust
...
tag @e[x=715.5,y=120,z=21.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
