...
execute as @a[gamemode=!spectator,x=698,y=120,z=-10,dx=24,dy=6,dz=35] unless entity @s[scores={Room=44}] run scoreboard players operation @s LastRoom = @s Room
