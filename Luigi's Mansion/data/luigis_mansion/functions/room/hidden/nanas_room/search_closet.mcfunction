...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 662 111 23 run function luigis_mansion:blocks/dust
...
tag @e[x=662.5,y=111,z=23.5,distance=..0.7,tag=ghost,tag=hidden] add spawn