execute unless entity @a[scores={LastRoom=34},limit=1] run function #luigis_mansion:room/hidden/nanas_room/reset
...
execute if score #nanas_room Wave matches -1 run tag @e[scores={Room=34},tag=ghost] add remove_from_existence
