...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] run function luigis_mansion:room/hidden/hidden_room/trophy_1
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 715 104 -20 run function luigis_mansion:blocks/dust
...
tag @e[x=715.5,y=104,z=-19.5,distance=..0.7,tag=ghost,tag=hidden] add spawn