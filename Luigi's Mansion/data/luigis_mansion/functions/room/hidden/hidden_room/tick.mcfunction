...
execute as @e[type=!minecraft:item_frame,x=736,y=10,z=-35,dx=14,dy=8,dz=21] run scoreboard players set @s Room 24

scoreboard players set @e[scores={Room=24},type=!minecraft:marker] MirrorX 749
