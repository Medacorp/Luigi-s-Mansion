...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 715 104 -5 run function luigis_mansion:blocks/dust
...
tag @e[x=715.5,y=104,z=-4.5,distance=..0.7,tag=ghost,tag=hidden] add spawn