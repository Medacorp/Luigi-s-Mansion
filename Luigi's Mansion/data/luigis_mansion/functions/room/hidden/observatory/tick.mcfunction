...
execute as @a[gamemode=!spectator,x=635,y=19,z=87,dx=16,dy=8,dz=72] unless entity @s[scores={Room=46}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=635,y=19,z=87,dx=16,dy=8,dz=72] run scoreboard players set @s Room 46
