execute unless data storage luigis_mansion:data current_state.current_data.obtained_items{marios_star:1b} positioned 674.0 111 113.0 run function luigis_mansion:spawn_entities/item/marios_star
