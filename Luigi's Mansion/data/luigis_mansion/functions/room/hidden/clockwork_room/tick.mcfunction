...
execute as @a[gamemode=!spectator,x=682,y=119,z=-10,dx=17,dy=8,dz=35] unless entity @s[scores={Room=49}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[type=!minecraft:item_frame,x=682,y=119,z=-10,dx=17,dy=8,dz=35] run scoreboard players set @s Room 49

execute as @a[gamemode=!spectator,x=684,y=119,z=-8,dx=13,dy=8,dz=31] run function luigis_mansion:room/hidden/clockwork_room/tick_per_player
