execute unless data storage luigis_mansion:data current_state.current_data.rooms.breaker_room{cleared:1b} if entity @a[tag=!blackout] unless score #breaker_room Wave matches 1.. run function luigis_mansion:room/hidden/breaker_room/wave_1
