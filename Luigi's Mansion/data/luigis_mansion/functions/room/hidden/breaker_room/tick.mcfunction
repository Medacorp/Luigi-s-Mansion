...
execute as @e[type=!minecraft:item_frame,x=686,y=1,z=57,dx=14,dy=8,dz=21] run scoreboard players set @s Room 57

scoreboard players set @e[scores={Room=57},type=!minecraft:marker] MirrorX 699
