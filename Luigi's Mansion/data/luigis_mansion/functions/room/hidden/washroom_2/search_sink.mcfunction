...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 666 111 -15 run function luigis_mansion:blocks/dust
...
tag @e[x=666.5,y=111,z=-14.5,distance=..0.7,tag=ghost,tag=hidden] add spawn