...
execute as @e[type=!minecraft:item_frame,x=660,y=19,z=-33,dx=8,dy=8,dz=14] run scoreboard players set @s Room 42

scoreboard players set @e[scores={Room=42},type=!minecraft:marker] MirrorX 661
