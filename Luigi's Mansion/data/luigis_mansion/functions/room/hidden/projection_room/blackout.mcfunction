execute positioned 675 102 6 run function luigis_mansion:spawn_entities/ghost/cinema_ghost
execute positioned 680 102 6 run function luigis_mansion:spawn_entities/ghost/cinema_ghost
execute positioned 675 102 14 run function luigis_mansion:spawn_entities/ghost/cinema_ghost
