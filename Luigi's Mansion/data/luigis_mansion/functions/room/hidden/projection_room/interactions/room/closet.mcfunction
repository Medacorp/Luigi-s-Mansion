...
execute unless block 682 102 16 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/projection_room/search_closet
execute unless block 681 102 16 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/projection_room/search_closet