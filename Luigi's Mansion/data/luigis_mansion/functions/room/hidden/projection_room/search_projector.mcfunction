...
tag @e[x=685.5,y=12,z=-22.5,distance=..0.7,tag=hidden_boo] add spawn
...
execute if entity @a[tag=blackout] run setblock 686 12 -23 minecraft:light[level=15,waterlogged=false]