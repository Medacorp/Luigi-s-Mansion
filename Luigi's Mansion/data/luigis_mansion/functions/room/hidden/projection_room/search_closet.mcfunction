...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 682.0 102.3 15 run function luigis_mansion:spawn_entities/item/small_heart
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 682.0 102 16 run function luigis_mansion:blocks/dust
