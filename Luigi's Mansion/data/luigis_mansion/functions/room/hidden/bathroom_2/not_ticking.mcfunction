execute unless entity @a[scores={LastRoom=33},limit=1] run function #luigis_mansion:room/hidden/bathroom_2/reset
...
scoreboard players set @e[scores={Room=33},tag=miss_petunia] Dialog 0