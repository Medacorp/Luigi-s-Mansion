...
execute as @e[type=!minecraft:item_frame,x=648,y=19,z=-14,dx=12,dy=8,dz=14] run scoreboard players set @s Room 43

scoreboard players set @e[scores={Room=43},type=!minecraft:marker] MirrorX 649
