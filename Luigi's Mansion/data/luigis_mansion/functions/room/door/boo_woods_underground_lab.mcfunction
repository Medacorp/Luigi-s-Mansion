...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a 789 90 16 1 1
execute if score #temp Searched matches 1 unless score #lab_door Searched matches 1 run playsound luigis_mansion:block.door.open block @a 789 90 16 1 1
