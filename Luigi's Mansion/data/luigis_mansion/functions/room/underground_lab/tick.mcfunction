...
execute as @a[gamemode=!spectator,x=780,y=77,z=6,dx=16,dy=11,dz=17] unless entity @s[scores={Room=-1}] run scoreboard players set @s LastRoom -1
...
execute as @a[gamemode=!spectator,x=788,y=89,z=21,dx=1,dy=2,dz=0] unless entity @s[scores={MusicType=0}] run function luigis_mansion:other/music/set/silence
