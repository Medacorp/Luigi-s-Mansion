...
execute at @s if block ~ 15 ~ minecraft:lime_wool run summon minecraft:lightning_bolt ~ 40 ~
execute at @s if block ~ 15 ~ minecraft:lime_wool run teleport @s ~ 18 ~ 0 0
execute at @s if block ~ 15 ~ minecraft:lime_wool run scoreboard players set @s Dialog 0
execute at @s if block ~ 15 ~ minecraft:lime_wool run function luigis_mansion:entities/bogmire/turn_visible
...
kill @e[distance=..0.7,type=minecraft:item,nbt={Item:{id:"minecraft:carved_pumpkin"}}]
execute at @s if block ~ 15 ~ minecraft:lime_wool run function luigis_mansion:entities/bogmire/spawn_shadow
