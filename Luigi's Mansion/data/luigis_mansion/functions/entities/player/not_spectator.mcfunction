...
execute as @e[distance=..7,tag=ghost_marker,tag=can_spawn,tag=!ceiling_ghost] positioned ^ ^ ^4 unless entity @s[distance=..4] at @s if block ~ ~ ~ #luigis_mansion:ghosts_ignore unless entity @e[type=minecraft:item_frame,distance=..0.7] run tag @s[tag=!only_forced_spawn] add spawn
execute positioned ~ ~5 ~ as @e[distance=..7,tag=ghost_marker,tag=can_spawn,tag=ceiling_ghost] positioned ~ ~-5 ~ positioned ^ ^ ^4 unless entity @s[distance=..4] at @s if block ~ ~ ~ #luigis_mansion:ghosts_ignore unless entity @e[type=minecraft:item_frame,distance=..0.7] run tag @s[tag=!only_forced_spawn] add spawn
...
execute if score #temp ActionTime matches 0 store result score #temp ActionTime run clear @s minecraft:filled_map{luigis_mansion:{id:"luigis_mansion:gameboy_horror"}} 0
