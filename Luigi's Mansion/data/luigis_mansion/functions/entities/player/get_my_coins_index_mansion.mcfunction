...
execute if score #temp ActionTime matches 1 run data modify storage luigis_mansion:data current_state.my_money_data set from storage luigis_mansion:data current_state.current_data.money_grabbed[-1]
...
execute unless score #temp ActionTime matches 1 if data storage luigis_mansion:data current_state.current_data.money_grabbed[-1] run function luigis_mansion:entities/player/get_my_coins_index_mansion