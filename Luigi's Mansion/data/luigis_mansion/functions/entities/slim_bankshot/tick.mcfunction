...
execute if entity @s[tag=dead] run function luigis_mansion:entities/slim_bankshot/drop_loot
...
execute if entity @s[scores={HurtTime=1},tag=hurt] run playsound luigis_mansion:entity.slim_bankshot.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[tag=!fleeing,tag=!hurt,tag=!vanish,scores={StunTime=0}] run function luigis_mansion:entities/slim_bankshot/pool
