execute if entity @p[tag=this_room,gamemode=!spectator] store result score @s TargetX run data get entity @p[tag=this_room,gamemode=!spectator] Pos[0] 100
execute if entity @p[tag=this_room,gamemode=!spectator] store result score @s TargetY run data get entity @p[tag=this_room,gamemode=!spectator] Pos[1] 100
execute if entity @p[tag=this_room,gamemode=!spectator] store result score @s TargetZ run data get entity @p[tag=this_room,gamemode=!spectator] Pos[2] 100
