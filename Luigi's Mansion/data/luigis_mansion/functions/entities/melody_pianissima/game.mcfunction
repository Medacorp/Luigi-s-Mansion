...
execute if entity @s[scores={Dialog=473}] run scoreboard players set @a[tag=same_room,gamemode=!spectator] Music 220
...
execute if entity @s[scores={Dialog=960}] run scoreboard players enable @a[tag=same_room,gamemode=!spectator] MelodyChoice