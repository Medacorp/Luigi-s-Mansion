...
execute at @e[tag=rocking_horse] positioned ~-1.5 ~-3 ~-20 if entity @e[tag=same_room,tag=!spectator,limit=1,dx=2,dy=3,dz=20] run scoreboard players add @s[scores={Dialog=81},tag=intro_done] Dialog 1
scoreboard players add @s[scores={Dialog=22..80},tag=intro_done] Dialog 1
execute at @e[tag=rocking_horse] positioned ~-1.5 ~-3 ~-20 if entity @e[tag=same_room,tag=!spectator,limit=1,dx=2,dy=3,dz=20] run scoreboard players add @s[scores={Dialog=21},tag=intro_done] Dialog 1
...
execute if entity @s[scores={Dialog=21},tag=intro_done] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet run teleport @s 720.0 43 -19940.0 ~ 0
...
execute if entity @s[scores={Dialog=81},tag=intro_done] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet run teleport @s 720.0 43 -19940.0 ~ 0
...
execute if entity @s[scores={Dialog=141..381},tag=intro_done] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet run teleport @s 720.0 43 -19940.0 ~ 0
...
execute if entity @s[scores={Dialog=280},tag=intro_done] positioned 726 45 -19940 facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
execute if entity @s[scores={Dialog=300},tag=intro_done] positioned 713 45 -19940 facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=320},tag=intro_done] positioned 720 45 -19940 facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/real
execute if entity @s[scores={Dialog=340},tag=intro_done] positioned 726 45 -19940 facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
execute if entity @s[scores={Dialog=360},tag=intro_done] positioned 713 45 -19940 facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet rotated ~ 0 run function luigis_mansion:spawn_entities/ball/chauncey/big
...
execute if entity @s[scores={Dialog=1502..1581}] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet run teleport @s ~ ~ ~ ~ 0
...
execute at @s[scores={Dialog=1583,PathStep=20}] as @e[distance=..1,tag=gameboy_horror_location] run function luigis_mansion:gameboy_horror_location/bring_player_back
...
execute if entity @s[scores={Dialog=1585..}] facing entity @e[tag=same_room,tag=!spectator,sort=nearest,limit=1] feet run teleport @s 720.0 43 -19940.0 ~ 0
