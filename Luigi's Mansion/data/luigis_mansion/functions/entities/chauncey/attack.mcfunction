...
execute at @s[scores={ActionTime=11},tag=!fight] positioned ~ ~1 ~ as @e[distance=..0.7,tag=gameboy_horror_location] run function luigis_mansion:gameboy_horror_location/bring_player_back
