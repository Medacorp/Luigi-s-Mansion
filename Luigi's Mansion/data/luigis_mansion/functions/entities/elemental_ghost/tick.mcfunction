...
data merge entity @s[tag=fire,tag=hurt_elemental_ghost,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:90}}]}
data merge entity @s[tag=water,tag=hurt_elemental_ghost,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:92}}]}
data merge entity @s[tag=ice,tag=hurt_elemental_ghost,tag=!was_hurt] {ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:94}}]}
