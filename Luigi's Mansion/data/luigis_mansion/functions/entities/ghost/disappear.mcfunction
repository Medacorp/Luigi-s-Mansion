...
data modify entity @s HandItems[0].id set value "minecraft:stone_button"
data modify entity @s HandItems[1].id set value "minecraft:stone_button"
data modify entity @s CustomNameVisible set value 0b
execute as @e[tag=this_model] run data modify entity @s ArmorItems[3].id set value "minecraft:stone_button"
execute as @e[tag=this_model] run data modify entity @s HandItems[0].id set value "minecraft:stone_button"
execute as @e[tag=this_model] run data modify entity @s HandItems[1].id set value "minecraft:stone_button"
