execute at @s unless block ~0.6 ~ ~ #luigis_mansion:all_ignore unless block ~-0.6 ~ ~ #luigis_mansion:all_ignore unless block ~0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~-0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~0.6 ~ ~ #minecraft:stairs[half=bottom] unless block ~-0.6 ~ ~ #minecraft:stairs[half=bottom] run tag @s add stuck
execute at @s unless block ~ ~ ~0.6 #luigis_mansion:all_ignore unless block ~ ~ ~-0.6 #luigis_mansion:all_ignore unless block ~ ~ ~0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~-0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~0.6 #minecraft:stairs[half=bottom] unless block ~ ~ ~-0.6 #minecraft:stairs[half=bottom] run tag @s add stuck
...
execute at @s unless block ~0.6 ~ ~ #luigis_mansion:all_ignore unless block ~-0.6 ~ ~ #luigis_mansion:all_ignore unless block ~0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~-0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~0.6 ~ ~ #minecraft:stairs[half=bottom] unless block ~-0.6 ~ ~ #minecraft:stairs[half=bottom] unless block ~ ~ ~-0.6 #luigis_mansion:all_ignore unless block ~ ~ ~-0.6 #luigis_mansion:all_ignore unless block ~ ~ ~0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~-0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~0.6 #minecraft:stairs[half=bottom] unless block ~ ~ ~-0.6 #minecraft:stairs[half=bottom] run teleport @s ~ ~1 ~
...
execute at @s[tag=!stuck,y_rotation=-180..0] unless block ~0.6 ~ ~ #luigis_mansion:all_ignore unless block ~0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~0.6 ~ ~ #minecraft:stairs[half=bottom] run tag @s add collision
execute at @s[tag=!stuck,y_rotation=0..-180] unless block ~-0.6 ~ ~ #luigis_mansion:all_ignore unless block ~-0.6 ~ ~ #minecraft:slabs[type=bottom] unless block ~-0.6 ~ ~ #minecraft:stairs[half=bottom] run tag @s add collision
execute at @s[tag=!stuck,y_rotation=-90..90] unless block ~ ~ ~0.6 #luigis_mansion:all_ignore unless block ~ ~ ~0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~0.6 #minecraft:stairs[half=bottom] run tag @s add collision
execute at @s[tag=!stuck,y_rotation=90..-90] unless block ~ ~ ~-0.6 #luigis_mansion:all_ignore unless block ~ ~ ~-0.6 #minecraft:slabs[type=bottom] unless block ~ ~ ~-0.6 #minecraft:stairs[half=bottom] run tag @s add collision
execute at @s[tag=!stuck,y_rotation=-180..0] unless block ~0.6 ~1 ~ #luigis_mansion:all_ignore run tag @s add collision
execute at @s[tag=!stuck,y_rotation=0..-180] unless block ~-0.6 ~1 ~ #luigis_mansion:all_ignore run tag @s add collision
execute at @s[tag=!stuck,y_rotation=-90..90] unless block ~ ~1 ~0.6 #luigis_mansion:all_ignore run tag @s add collision
execute at @s[tag=!stuck,y_rotation=90..-90] unless block ~ ~1 ~-0.6 #luigis_mansion:all_ignore run tag @s add collision
...
execute at @s[tag=collision] run function luigis_mansion:entities/ghost/hidden/move
