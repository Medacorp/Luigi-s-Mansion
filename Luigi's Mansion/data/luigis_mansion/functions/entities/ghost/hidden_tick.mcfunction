...
execute if block ~ ~ ~ #luigis_mansion:all_ignore if entity @e[tag=same_room,distance=..7,tag=!spectator,limit=1] unless entity @s[tag=!burning_heart,tag=!fozen_heart,tag=!watery_heart] run tag @s[tag=can_spawn] add try_spawn
tag @s add me
