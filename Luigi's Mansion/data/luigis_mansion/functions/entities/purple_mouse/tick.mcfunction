execute if entity @s[tag=dead,tag=normal_death] run playsound luigis_mansion:entity.purple_mouse.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead,tag=element_death] run playsound luigis_mansion:entity.purple_mouse.element_death hostile @a[tag=same_room] ~ ~ ~ 1
