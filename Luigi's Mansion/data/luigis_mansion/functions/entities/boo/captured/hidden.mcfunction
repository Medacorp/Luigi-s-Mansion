...
execute if data storage luigis_mansion:data current_state.current_data{boo_counter:4} if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/display/hidden/door/main_hallway_washroom_1
