...
teleport @s[scores={Room=6}] 726 20 61
teleport @s[scores={Room=7}] 709.0 20 53.0
teleport @s[scores={Room=8}] 691.0 111 47.0
teleport @s[scores={Room=9}] 744 20 63
teleport @s[scores={Room=10,HallwaySection=1}] 716 11 -5
teleport @s[scores={Room=10,HallwaySection=2}] 699 11 -19
teleport @s[scores={Room=10,HallwaySection=3}] 682 11 -9
teleport @s[scores={Room=10,HallwaySection=4}] 674 11 8
teleport @s[scores={Room=12}] 654 11 22
teleport @s[scores={Room=13}] 704.0 11 -53.0
teleport @s[scores={Room=14}] 685 11 -53.0
teleport @s[scores={Room=15}] 664 11 41
teleport @s[scores={Room=16}] 741 11 -29
teleport @s[scores={Room=17}] 741 11 -52.0
teleport @s[scores={Room=18}] 716 11 67
teleport @s[scores={Room=19}] 744 11 63
teleport @s[scores={Room=20}] 743 11 40.0
teleport @s[scores={Room=21}] 658 11 -15
