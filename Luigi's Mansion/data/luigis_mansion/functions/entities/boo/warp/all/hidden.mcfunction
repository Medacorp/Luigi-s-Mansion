...
teleport @s[scores={Room=7}] 709.0 20 -37.0
teleport @s[scores={Room=8}] 691.0 111 -31.0
teleport @s[scores={Room=9}] 744 20 -48
teleport @s[scores={Room=10,HallwaySection=1}] 716 11 21
...
teleport @s[scores={Room=17}] 741 11 68.0
teleport @s[scores={Room=18}] 716 11 -52
teleport @s[scores={Room=19}] 744 11 -48
teleport @s[scores={Room=20}] 743 11 -24.0
teleport @s[scores={Room=21}] 658 11 30
teleport @s[scores={Room=22}] 704 11 -28
teleport @s[scores={Room=23}] 704 11 -61.0
teleport @s[scores={Room=28}] 643 11 61.0
teleport @s[scores={Room=30}] 643 20 61.0
teleport @s[scores={Room=31,HallwaySection=1}] 716 20 50
teleport @s[scores={Room=31,HallwaySection=2}] 699 20 34
teleport @s[scores={Room=31,HallwaySection=3}] 682 20 24
teleport @s[scores={Room=31,HallwaySection=4}] 674 20 7
teleport @s[scores={Room=32}] 664 20 -26
teleport @s[scores={Room=33}] 654 20 -7
teleport @s[scores={Room=34}] 658 20 30
teleport @s[scores={Room=35}] 666 20 97
teleport @s[scores={Room=37}] 681.0 11 -62.0
teleport @s[scores={Room=38}] 681.0 11 -23
teleport @s[scores={Room=39}] 743 20 -25
teleport @s[scores={Room=40}] 739 29 61.0
teleport @s[scores={Room=41}] 744 29 28
teleport @s[scores={Room=43}] 743 29 -29
teleport @s[scores={Room=44}] 746 29 -2.0
teleport @s[scores={Room=45}] 693 2 67
teleport @s[scores={Room=46}] 741 2 67
teleport @s[scores={Room=47}] 716 2 33
teleport @s[scores={Room=49}] 691 120 8.0
teleport @s[scores={Room=51}] 754 29 -50.0
teleport @s[scores={Room=52}] 705 29 -52.0
teleport @s[scores={Room=54}] 693 2 12
teleport @s[scores={Room=55}] 732 2 12
teleport @s[scores={Room=56}] 741 20 44
teleport @s[scores={Room=57}] 741 20 68.0
teleport @s[scores={Room=58}] 696 29 82.0
