...
tag @s[scores={Room=2},tag=area_3] add north
...
tag @s[scores={Room=21},tag=area_3] add north
...
tag @s[scores={Room=33}] add north
...
tag @s[scores={Room=51}] add north
tag @s[scores={Room=52}] add east
tag @s[scores={Room=52}] add north
tag @s[scores={Room=54}] add east
tag @s[scores={Room=54}] add north
tag @s[scores={Room=55}] add west
tag @s[scores={Room=55}] add north
tag @s[scores={Room=56}] add west
execute if data storage luigis_mansion:data current_state.current_data.rooms.guest_room{cleared:1b} run tag @s[scores={Room=56}] add north
