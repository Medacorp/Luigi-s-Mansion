...
execute unless entity @e[tag=boolossus,tag=!dead,limit=1] run setblock 687 39 -19966 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_mansion:boss_area/boolossus/create/1_normal"}
execute unless entity @e[tag=boolossus,tag=!dead,limit=1] run setblock 687 40 -19966 minecraft:redstone_block
execute unless entity @e[tag=boolossus,tag=!dead,limit=1] run setblock 735 39 -19966 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_mansion:boss_area/boolossus/create/2_normal"}
