execute if entity @s[scores={Room=8}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=11..14}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=20}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=26}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=27}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=34},tag=!cheese] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=35..41}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=50}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
...
execute if entity @s[scores={Room=66}] run function luigis_mansion:entities/gold_mouse/spawn_money/blue_diamond
