...
execute if entity @s[scores={PathStep=1}] run summon minecraft:marker 694 102 46 {Tags:["target"]}
execute if entity @s[scores={PathStep=2}] run summon minecraft:marker 687 102 46 {Tags:["target"]}
execute if entity @s[scores={PathStep=3}] run summon minecraft:marker 687 102 51 {Tags:["target"]}
execute if entity @s[scores={PathStep=4}] run summon minecraft:marker 687 102 46 {Tags:["target"]}
execute if entity @s[scores={PathStep=5}] run summon minecraft:marker 694 102 46 {Tags:["target"]}
execute if entity @s[scores={PathStep=6}] run summon minecraft:marker 694 102 51 {Tags:["target"]}
