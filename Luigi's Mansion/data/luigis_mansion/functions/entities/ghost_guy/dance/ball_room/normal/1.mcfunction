...
execute if entity @s[scores={PathStep=1}] run summon minecraft:area_effect_cloud 700 11 -47 {Tags:["target"],Duration:1}
execute if entity @s[scores={PathStep=2}] run summon minecraft:area_effect_cloud 707 11 -47 {Tags:["target"],Duration:1}
execute if entity @s[scores={PathStep=3}] run summon minecraft:area_effect_cloud 707 11 -42 {Tags:["target"],Duration:1}
execute if entity @s[scores={PathStep=4}] run summon minecraft:area_effect_cloud 707 11 -47 {Tags:["target"],Duration:1}
execute if entity @s[scores={PathStep=5}] run summon minecraft:area_effect_cloud 700 11 -47 {Tags:["target"],Duration:1}
execute if entity @s[scores={PathStep=6}] run summon minecraft:area_effect_cloud 700 11 -42 {Tags:["target"],Duration:1}
