...
execute if entity @s[x=707.5,y=11,z=-55.5,distance=..0.7,scores={PathStep=1}] run scoreboard players set @s PathStep 2
execute if entity @s[x=707.5,y=11,z=-50.5,distance=..0.7,scores={PathStep=2}] run scoreboard players set @s PathStep 3
execute if entity @s[x=700.5,y=11,z=-50.5,distance=..0.7,scores={PathStep=3}] run scoreboard players set @s PathStep 4
