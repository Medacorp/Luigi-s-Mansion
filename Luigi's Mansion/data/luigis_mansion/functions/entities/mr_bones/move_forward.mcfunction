...
execute if entity @s[tag=!in_furniture] unless block ^ ^ ^0.6 #minecraft:slabs[type=bottom] unless block ^ ^ ^0.6 #luigis_mansion:all_ignore run scoreboard players set @s Time 80
execute if entity @s[tag=!in_furniture] unless block ^ ^1 ^0.6 #luigis_mansion:all_ignore run scoreboard players set @s Time 80
...
execute if entity @s[tag=in_furniture] unless block ^ ^ ^1 #minecraft:slabs[type=bottom] unless block ^ ^ ^1 #luigis_mansion:all_ignore run scoreboard players set @s Time 80
execute if entity @s[tag=in_furniture] unless block ^ ^1 ^1 #luigis_mansion:all_ignore run scoreboard players set @s Time 80
execute if entity @s[tag=in_furniture] if block ^ ^1 ^1 #luigis_mansion:all_ignore run scoreboard players add @s Time 1
