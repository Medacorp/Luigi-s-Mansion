...
advancement grant @a[gamemode=!spectator,distance=..0.7] only luigis_mansion:challenges/waluigi_pinball temper_terror
...
tag @s remove attack
tag @s[tag=!appear,tag=!smug] add collided