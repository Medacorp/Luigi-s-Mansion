execute store result score @s TargetX run data get entity @p[tag=same_room,gamemode=!spectator] Pos[0] 100
execute store result score @s TargetY run data get entity @p[tag=same_room,gamemode=!spectator] Pos[1] 100
execute store result score @s TargetZ run data get entity @p[tag=same_room,gamemode=!spectator] Pos[2] 100
