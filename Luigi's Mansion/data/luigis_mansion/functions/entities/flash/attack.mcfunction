...
execute if entity @s[scores={ActionTime=41}] run playsound luigis_mansion:entity.flash.attack hostile @a[tag=same_room] ~ ~ ~ 1
...
execute at @s[scores={ActionTime=41..60}] as @e[distance=..1,tag=gameboy_horror_location] run function luigis_mansion:gameboy_horror_location/bring_player_back
