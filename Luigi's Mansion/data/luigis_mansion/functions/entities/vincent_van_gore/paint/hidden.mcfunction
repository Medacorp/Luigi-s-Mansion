...
execute if entity @a[tag=same_room,gamemode=!spectator] unless entity @s[scores={Dialog=1..}] run scoreboard players add @s Dialog 1
execute if entity @s[scores={Dialog=333}] at @a[tag=same_room,gamemode=!spectator] positioned ^ ^ ^8 run effect give @s[distance=..8] minecraft:invisibility 1 0 true
...
execute unless entity @s[scores={Dialog=332..333}] unless entity @s[scores={Dialog=646}] as @a[tag=same_room,gamemode=!spectator] unless entity @s[scores={MusicType=23}] run scoreboard players set @s Music 0
execute unless entity @s[scores={Dialog=332..333}] unless entity @s[scores={Dialog=646}] as @a[tag=same_room,gamemode=!spectator] unless entity @s[scores={MusicType=23}] run scoreboard players set @s MusicType 23
...
execute if entity @s[scores={Dialog=140..332}] facing entity @p[tag=same_room,gamemode=!spectator] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
...
execute if entity @s[scores={Dialog=332}] run function luigis_mansion:room/hidden/artists_studio/wave_2 
...
execute if entity @s[scores={Dialog=334..}] facing entity @p[tag=same_room,gamemode=!spectator] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
...
execute if entity @s[scores={Dialog=646}] as @a[tag=same_room,gamemode=!spectator] unless entity @s[scores={MusicType=36}] run function luigis_mansion:other/music/set/danger
