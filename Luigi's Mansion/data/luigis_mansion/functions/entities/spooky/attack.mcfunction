...
execute at @s[scores={PathStep=1..19}] positioned ^ ^ ^0.3 if entity @a[gamemode=!spectator,distance=..0.7,tag=!grabbed,limit=1] run scoreboard players set @s PathStep 30
