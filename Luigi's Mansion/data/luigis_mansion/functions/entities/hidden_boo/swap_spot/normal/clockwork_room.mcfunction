summon minecraft:area_effect_cloud 693 120 19 {Tags:["choice"]}
summon minecraft:area_effect_cloud 696 120 18 {Tags:["choice"]}
summon minecraft:area_effect_cloud 694 120 16 {Tags:["choice"]}
summon minecraft:area_effect_cloud 694 120 -1 {Tags:["choice"]}
summon minecraft:area_effect_cloud 692 120 -3 {Tags:["choice"]}
