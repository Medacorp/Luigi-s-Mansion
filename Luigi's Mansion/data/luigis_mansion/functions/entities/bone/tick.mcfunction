...
execute if entity @s[tag=!spooky_bone] as @e[distance=..0.7,tag=gameboy_horror_location] run function luigis_mansion:gameboy_horror_location/bring_player_back
