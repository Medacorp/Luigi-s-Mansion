...
execute if entity @s[tag=flashlight] positioned ~ ~1 ~ positioned ^ ^ ^1 if block ~ ~ ~ #luigis_mansion:flashlight_path run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["flashlight","new"],Duration:3}
execute if entity @s[tag=flashlight] positioned ~ ~1 ~ run teleport @e[tag=flashlight,tag=new,limit=1] ~ ~ ~ ~ ~
execute if entity @s[tag=flashlight] as @e[tag=flashlight,tag=new,limit=1] store result score @s HomeRotX run data get entity @s Rotation[0] 100
execute if entity @s[tag=flashlight] as @e[tag=flashlight,tag=new,limit=1] store result score @s HomeRotY run data get entity @s Rotation[1] 100
execute if entity @s[tag=flashlight] as @e[tag=flashlight,tag=new,limit=1] store result score @s HomeX run data get entity @s Pos[0] 100
execute if entity @s[tag=flashlight] as @e[tag=flashlight,tag=new,limit=1] store result score @s HomeY run data get entity @s Pos[1] 100
execute if entity @s[tag=flashlight] as @e[tag=flashlight,tag=new,limit=1] store result score @s HomeZ run data get entity @s Pos[2] 100
