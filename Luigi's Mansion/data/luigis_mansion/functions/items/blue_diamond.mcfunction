...
execute store result storage luigis_mansion:data current_state.my_money.money.blue_diamond int 1 run scoreboard players add #temp Time 1
execute store result score #temp Time run data get storage luigis_mansion:data current_state.my_money.total
execute store result storage luigis_mansion:data current_state.my_money.total int 1 run scoreboard players add #temp Time 2000
...
execute store result storage luigis_mansion:data current_state.my_money_data.money.blue_diamond int 1 run scoreboard players add #temp Time 1
execute store result score #temp Time run data get storage luigis_mansion:data current_state.my_money_data.total
execute store result storage luigis_mansion:data current_state.my_money_data.total int 1 run scoreboard players add #temp Time 2000
