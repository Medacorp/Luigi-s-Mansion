...
execute as @e[distance=..1,tag=!item,tag=!billiards_ball,tag=!wool,tag=!ball,tag=!hidden] run function luigis_mansion:items/poltergust_3000/effect_on_entity/vacuum
