...
summon minecraft:armor_stand ^ ^ ^1 {Pose:{Head:[0.0f,0.0f,0.01f]},Fire:32767s,Marker:1b,Invulnerable:1b,Tags:["shot_water","player_shot","interact","poltergust","water","new"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:4,CustomModelData:13}}],Invisible:1b,DisabledSlots:2039583,Small:1b}
