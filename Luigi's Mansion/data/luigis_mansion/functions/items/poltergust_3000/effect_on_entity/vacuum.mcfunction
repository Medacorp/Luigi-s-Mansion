...
execute if entity @s[tag=vacuumable,tag=!boolossus,tag=!shining_ghost] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] unless entity @s[tag=haunted_music_sheet,scores={WaitTime=..0}] positioned as @s if block ^ ^ ^0.3 #luigis_mansion:ghosts_ignore unless entity @a[tag=me,distance=..1.2,limit=1] run teleport @s ^ ^ ^0.1
...
tag @s[tag=vacuumable] add fleeing
...
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] unless entity @s[tag=haunted_music_sheet,scores={WaitTime=..0}] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run tag @s add normal_death
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus,tag=!ghost] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] unless entity @s[tag=haunted_music_sheet,scores={WaitTime=..0}] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run tag @s add dead
execute if entity @s[tag=vacuumable,tag=!spark,tag=!boolossus] unless entity @s[tag=haunted_object,tag=!moving,tag=!haunted_music_sheet] unless entity @s[tag=haunted_music_sheet,scores={WaitTime=..0}] positioned as @s if entity @a[tag=me,distance=..1.2,limit=1] run function luigis_mansion:items/poltergust_3000/latch_onto_ghost
...
execute if entity @s[tag=boo,tag=!dying,scores={HurtTime=1..,Health=1..},tag=!already_hurt] run function luigis_mansion:entities/boo/harm
tag @s[tag=king_boo,tag=battle,tag=!dead] add boo_hurt
tag @s[tag=king_boo,tag=battle,tag=!dead] add in_vacuum
execute if entity @s[tag=king_boo,tag=!dying,scores={HurtTime=1..,Health=1..},tag=!already_hurt] run function luigis_mansion:entities/boo/harm
execute if entity @s[tag=ghost,scores={VulnerableTime=1..},tag=!vanish,tag=!being_vacuumed] if score @s Room = #temp Room run function luigis_mansion:items/poltergust_3000/latch_onto_ghost
execute if entity @s[tag=boo,scores={Health=..0}] if score @s Room = #temp Room run function luigis_mansion:items/poltergust_3000/latch_onto_ghost
execute if entity @s[tag=king_boo,tag=battle,scores={Health=..0}] if score @s Room = #temp Room run function luigis_mansion:items/poltergust_3000/latch_onto_ghost