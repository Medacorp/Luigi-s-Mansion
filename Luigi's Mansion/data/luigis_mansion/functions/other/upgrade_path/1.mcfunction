data merge storage luigis_mansion:data {data_version:1,rooms:{underground_lab:{seen:0b,cleared:0b},training_room:{seen:0b,cleared:0b},ghost_portrificationizer_room:{seen:0b,cleared:0b},gallery:{seen:0b,cleared:0b}}}
