...
execute as @e[tag=!spectator,x=672,y=118,z=38,dx=10,dy=9,dz=7] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 54
