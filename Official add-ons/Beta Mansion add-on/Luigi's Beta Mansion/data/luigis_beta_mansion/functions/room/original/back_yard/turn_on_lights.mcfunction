data modify storage luigis_mansion:data current_state.current_data.rooms.back_yard merge value {cleared:1b}
function #luigis_beta_mansion:room/original/back_yard/turn_lights/on
...
scoreboard players reset #back_yard Wave