...
execute as @e[x=648,y=8,z=15,dx=12,dy=9,dz=14] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 12
...
execute as @a[scores={Room=12}] run function luigis_beta_mansion:room/original/bath_room/tick_per_player
