...
execute as @e[tag=!spectator,x=697,y=17,z=-23,dx=15,dy=9,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 24
