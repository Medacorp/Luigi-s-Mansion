...
execute as @e[tag=!spectator,x=696,y=26,z=56,dx=17,dy=9,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 66
