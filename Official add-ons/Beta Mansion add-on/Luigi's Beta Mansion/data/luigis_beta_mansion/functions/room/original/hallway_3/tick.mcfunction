...
execute as @e[tag=!spectator,x=713,y=8,z=-35,dx=7,dy=9,dz=60] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 8
