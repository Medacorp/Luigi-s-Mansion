...
teleport @s[scores={PositionIntY=129,PositionIntX=684..697,PositionIntZ=-29..-18}] ~5 ~-96 ~-39
...
teleport @s[scores={PositionIntY=129,PositionIntX=684..697,PositionIntZ=33..44}] ~14 ~-96 ~25
