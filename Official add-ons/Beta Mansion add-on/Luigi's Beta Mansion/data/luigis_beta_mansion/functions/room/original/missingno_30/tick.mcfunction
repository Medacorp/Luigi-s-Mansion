...
execute as @e[tag=!spectator,x=640,y=14,z=-83,dx=10,dy=12,dz=10] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 46
