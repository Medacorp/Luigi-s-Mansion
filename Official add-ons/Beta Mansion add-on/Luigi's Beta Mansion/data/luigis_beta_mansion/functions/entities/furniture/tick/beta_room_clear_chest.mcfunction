...
execute unless entity @s[tag=!shake] run function luigis_mansion:entities/furniture/tick/shake_room_clear_chest
execute if entity @s[tag=!shake,tag=was_shaking] run function luigis_mansion:entities/furniture/tick/revert_to_default_orientation
