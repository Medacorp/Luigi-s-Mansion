...
execute if entity @s[tag=visible] run function luigis_mansion:entities/ghost/turn_invisible
execute if entity @s[tag=scanned] run function luigis_beta_mansion:room/gallery/clear_task/task_8
