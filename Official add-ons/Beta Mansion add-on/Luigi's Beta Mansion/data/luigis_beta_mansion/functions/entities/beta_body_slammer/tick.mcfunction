...
execute if entity @a[tag=!spectator,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,tag=!basher,tag=!hurt,tag=!fleeing,tag=!element_hurt] unless entity @s[tag=attack,scores={AttackType=2}] run function luigis_beta_mansion:entities/beta_body_slammer/collide
execute if entity @s[scores={AttackType=0}] run function luigis_beta_mansion:entities/beta_body_slammer/select_attack/punch
execute if entity @s[scores={AttackType=1}] run function luigis_beta_mansion:entities/beta_body_slammer/select_attack/basher
execute if entity @s[scores={AttackType=2}] run function luigis_beta_mansion:entities/beta_body_slammer/select_attack/body_slam
execute if entity @s[scores={AttackType=3}] run function luigis_beta_mansion:entities/beta_body_slammer/select_attack/earthquake
