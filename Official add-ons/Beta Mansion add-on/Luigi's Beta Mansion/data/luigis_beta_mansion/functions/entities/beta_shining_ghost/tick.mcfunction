...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=visible] run function luigis_beta_mansion:entities/beta_shining_ghost/collide
