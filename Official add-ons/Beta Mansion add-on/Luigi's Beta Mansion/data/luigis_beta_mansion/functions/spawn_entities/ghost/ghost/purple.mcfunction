summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_beta_mansion:entity.ghost"}',Invisible:1b,NoGravity:1b,CustomNameVisible:0b,Marker:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:1,CustomModelData:26,display:{color:6881535}}}],HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:2,CustomModelData:26,display:{color:6881535}}},{id:"minecraft:stone_button",Count:1b,tag:{visible:"minecraft:leather_chestplate",invisible:"minecraft:stone_button",Unbreakable:1b,Damage:3,CustomModelData:26,display:{color:6881535}}}],Pose:{RightArm:[-90.0f,0.0f,0.0f],LeftArm:[-90.0f,0.0f,0.0f],Head:[0.0f,0.0f,0.0f]},Tags:["beta_ghost","normal_ghost","stunnable","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","hidden","beta_appear","new_ghost","this_entity"],DisabledSlots:2039583}
