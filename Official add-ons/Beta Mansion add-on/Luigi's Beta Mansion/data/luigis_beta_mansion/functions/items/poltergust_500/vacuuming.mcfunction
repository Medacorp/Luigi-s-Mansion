...
execute unless score #temp GhostCount matches 1.. unless entity @e[tag=ball,distance=..1.5,tag=can_spit,limit=1] unless entity @e[tag=ball,tag=big,distance=..3,tag=can_spit,limit=1] run function luigis_beta_mansion:items/poltergust_500/vacuuming/default
execute unless score #temp GhostCount matches 1.. if entity @e[tag=ball,tag=!big,distance=..1.5,tag=can_spit,sort=nearest,limit=1] run function luigis_beta_mansion:items/poltergust_500/vacuuming/get_clogged
execute unless score #temp GhostCount matches 1.. if entity @e[tag=ball,tag=big,distance=..3,tag=can_spit,sort=nearest,limit=1] run function luigis_beta_mansion:items/poltergust_500/vacuuming/get_clogged
