...
execute unless score #temp ID = #temp2 ID if data storage luigis_mansion:data ghost_list[0] run function luigis_beta_mansion:items/poltergust_500/search_id