...
execute if data storage luigis_mansion:data ghost_list[-1] run function luigis_beta_mansion:items/poltergust_500/search_my_id
...
execute if entity @s[tag=!already_included] unless data entity @s ArmorItems[3].tag run data merge entity @s {ArmorItems:[{},{},{},{id:"minecraft:stone_button",Count:1b,tag:{attacked_by:[]}}]}
