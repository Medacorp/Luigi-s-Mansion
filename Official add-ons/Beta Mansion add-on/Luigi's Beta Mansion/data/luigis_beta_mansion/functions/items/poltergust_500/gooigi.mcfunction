...
data modify entity @e[tag=inventory,limit=1] ArmorItems[3].tag.luigis_mansion.items[{tag:{luigis_mansion:{id:"luigis_beta_mansion:poltergust_500"}}}].tag merge value {CustomModelData:7,luigis_mansion:{gooigi_variant:1b,poltergust_model_data:12}}
