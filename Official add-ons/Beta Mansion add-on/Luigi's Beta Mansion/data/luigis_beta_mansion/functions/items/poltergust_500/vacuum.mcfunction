...
execute as @e[tag=same_room,tag=!model_piece,tag=!hidden,tag=!item_is_pulled,tag=affected_by_vacuum,tag=!hit_by_poltergust] run function luigis_mansion:items/poltergust_3000/effect_on_entity/vacuum