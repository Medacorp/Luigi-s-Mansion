...
execute if score #temp FurnitureXTarget matches 1.. if score #temp Time matches 1.. if entity @s[scores={FurnitureXTarget=1..,FurnitureXProgress=0..18}] run function luigis_beta_mansion:items/poltergust_500/effect_on_furniture/change_swing_x
execute if score #temp FurnitureXTarget matches 1.. if score #temp Time matches 1.. if entity @s[scores={FurnitureXTarget=1..,FurnitureXProgress=168}] run function luigis_beta_mansion:items/poltergust_500/effect_on_furniture/change_swing_x
