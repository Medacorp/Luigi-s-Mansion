...
execute unless entity @s[scores={Animation=1..},tag=!idle] run tag @s[tag=!poltergust_malfunction,nbt={SelectedItem:{tag:{luigis_mansion:{id:"luigis_beta_mansion:poltergust_500"}}}}] add poltergust_selected
...
execute if entity @s[tag=!expelling,tag=poltergust_selected,tag=poltergust_grabbed] positioned ~ ~0.5 ~ run function luigis_beta_mansion:items/poltergust_500/vacuuming
execute if entity @s[tag=expelling,tag=poltergust_selected,tag=poltergust_grabbed] positioned ~ ~0.5 ~ run function luigis_beta_mansion:items/poltergust_500/expelling
