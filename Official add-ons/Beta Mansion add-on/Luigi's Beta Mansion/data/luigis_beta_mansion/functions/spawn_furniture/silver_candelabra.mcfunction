summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_beta_mansion:furniture.silver_candelabra"}',Pose:{Head:[0.0f,0.01f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:-12}}],Tags:["furniture","generic","standing_furniture","candelabra","immobile","this_entity"],DisabledSlots:2039583}
