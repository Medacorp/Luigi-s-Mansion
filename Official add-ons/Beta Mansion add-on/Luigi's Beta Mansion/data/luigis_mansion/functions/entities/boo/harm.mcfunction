...
execute unless score #temp LastHealth = #temp Health at @s if score #poltergust_500 Selected matches 0 run playsound luigis_mansion:entity.boo.lose_health hostile @a[tag=same_room] ~ ~ ~ 1
execute unless score #temp LastHealth = #temp Health at @s if score #poltergust_500 Selected matches 1 run playsound luigis_beta_mansion:entity.boo.lose_health hostile @a[tag=same_room] ~ ~ ~ 1
