...
execute if entity @s[scores={AnimationProgress=11..12}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
...
execute if entity @s[scores={AnimationProgress=17..18}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
...
execute if entity @s[scores={AnimationProgress=1..10}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
