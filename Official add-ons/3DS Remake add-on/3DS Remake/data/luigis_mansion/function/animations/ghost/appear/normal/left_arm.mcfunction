...
execute if entity @s[scores={AnimationProgress=11..12}] run scoreboard players remove @s AnimationRotationX 20
execute if entity @s[scores={AnimationProgress=13..16}] run scoreboard players add @s AnimationRotationX 20
execute if entity @s[scores={AnimationProgress=17..18}] run scoreboard players remove @s AnimationRotationX 20
