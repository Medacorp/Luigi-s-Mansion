...
scoreboard players add @s[scores={AnimationProgress=11..12}] AnimationRotationZ 20
scoreboard players remove @s[scores={AnimationProgress=13..16}] AnimationRotationZ 20
scoreboard players add @s[scores={AnimationProgress=17..18}] AnimationRotationZ 20
