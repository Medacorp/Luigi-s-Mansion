...
execute if entity @s[tag=approach_triggered] positioned ^ ^ ^0.5 run function luigis_mansion:entities/furniture/type/approach/detect with storage luigis_mansion:data macro