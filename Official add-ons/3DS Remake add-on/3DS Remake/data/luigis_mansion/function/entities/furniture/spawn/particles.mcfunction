...
execute positioned as @e[tag=temp,limit=1] if data entity @s data{particles:"shooting_water"} run function 3ds_remake:entities/furniture/spawn/particles/shooting_water
