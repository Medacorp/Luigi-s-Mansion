...
execute if data entity @s data{particles:"shooting_water"} positioned as @e[tag=temp,limit=1] rotated as @s run function 3ds_remake:entities/furniture/spawn/particles/shooting_water
