...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_battle run data remove storage luigis_mansion:data furniture.loot
