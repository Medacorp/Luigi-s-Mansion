...
execute at @s[tag=!no_ai,tag=!switch_dimension,tag=!gooigi] run function luigis_mansion:entities/luigi/ai
execute at @s[tag=!no_ai,tag=!switch_dimension,tag=gooigi] run function 3ds_remake:entities/gooigi/ai
