...
execute if entity @s[scores={DeathTime=120},tag=!revived_by_polterpup] as @a[tag=this_player,tag=!dead_player,limit=1] run function luigis_mansion:entities/player/turn_into_spectator
