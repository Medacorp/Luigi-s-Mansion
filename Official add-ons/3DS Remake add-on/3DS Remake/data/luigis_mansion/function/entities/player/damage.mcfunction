...
execute if data storage luigis_mansion:data damage{animation:"knockback/burn"} if entity @s[scores={Invulnerable=0},tag=gooigi] run data modify storage luigis_mansion:data my_memory.hurt_by.method set value {namespace:"3ds_remake",id:"melt"}
...
execute if data storage luigis_mansion:data my_memory.hurt_by{method:{namespace:"3ds_remake",id:"melt"}} run scoreboard players set @s Health 0
