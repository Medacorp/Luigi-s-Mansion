...
execute if data storage luigis_mansion:data current_state.luigis_mansion.rooms.gallery{seen:0b} if entity @s[tag=!spectator,tag=!fully_separated_camera] run function luigis_mansion:room/gallery_hallway_1/set_seen
