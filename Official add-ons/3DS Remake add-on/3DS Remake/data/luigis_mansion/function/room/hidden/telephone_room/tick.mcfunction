...
execute as @a[x=736,y=28,z=-20,dx=24,dy=7,dz=35] unless entity @s[scores={Room=56}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @a[x=736,y=28,z=-20,dx=24,dy=7,dz=35] Room 56
...
execute if entity @a[tag=!pause_dialog,scores={Room=56},tag=!spectator,limit=1] run function luigis_mansion:room/hidden/telephone_room/ghosts