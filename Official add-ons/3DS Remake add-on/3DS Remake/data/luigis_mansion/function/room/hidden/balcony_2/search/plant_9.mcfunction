...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 655 121 28 run function luigis_mansion:room/hidden/balcony_2/plant_9
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 655 120 28 run function luigis_mansion:blocks/dust
