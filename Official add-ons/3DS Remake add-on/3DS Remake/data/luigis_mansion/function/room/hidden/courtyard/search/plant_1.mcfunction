...
execute unless data storage luigis_mansion:data furniture.loot positioned 646 102 0 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 646 104 0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
