...
execute unless score #balcony_2_plant_6 Searched matches 1 as @a if score #balcony_2_plant_6 SearcherID = @s ID run tag @s add searcher
execute unless score #balcony_2_plant_6 Searched matches 1 run function luigis_mansion:entities/furniture/loot_chance/m50
execute unless score #balcony_2_plant_6 Searched matches 1 run tag @a remove searcher
