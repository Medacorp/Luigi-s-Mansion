...
execute if score #global_3ds_remake_gallery Selected matches 0 if entity @s[scores={PositionIntZ=-15}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~ ~-2"}
execute if score #global_3ds_remake_gallery Selected matches 1 if entity @s[scores={PositionIntZ=-15}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~-75 ~-2"}
