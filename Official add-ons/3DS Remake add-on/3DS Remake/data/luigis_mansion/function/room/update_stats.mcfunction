...
execute unless data storage luigis_mansion:data current_state.current_data.portrait_battle store result storage luigis_mansion:data current_state.current_data.lowest_difficulty int 1 run scoreboard players operation #temp Time < #global_difficulty Selected
