...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.rec_room{cleared:1b} if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} unless score #rec_room Wave matches 1..99 run function luigis_mansion:room/normal/rec_room/wave_1
...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:1b} unless score #rec_room Wave matches 1.. run function luigis_mansion:room/normal/rec_room/blackout_1
