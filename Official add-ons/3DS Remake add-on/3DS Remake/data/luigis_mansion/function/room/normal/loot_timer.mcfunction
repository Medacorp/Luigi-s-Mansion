...
execute at @s[scores={LootTimer=300}] unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_battle run function luigis_mansion:spawn_entities/item/small_heart
...
execute at @s[scores={LootTimer=700}] unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.portrait_battle run function luigis_mansion:spawn_entities/item/small_heart
