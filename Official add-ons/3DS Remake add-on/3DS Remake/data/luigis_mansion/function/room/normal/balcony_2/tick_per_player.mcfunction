...
function luigis_mansion:entities/player/run_command_as_model {command:'execute if entity @s[x=681.5,y=120,z=28.0,distance=..4] if data storage luigis_mansion:data current_state.current_data{obtained_keys:["hallway_18"]} run function luigis_mansion:room/normal/balcony_2/clear_blockade'}
