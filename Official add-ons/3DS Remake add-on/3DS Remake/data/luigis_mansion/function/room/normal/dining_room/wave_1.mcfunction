...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["dining_room_speedy_spirit"]} positioned 699 11 52 run function luigis_mansion:spawn_entities/ghost/speedy_spirit
