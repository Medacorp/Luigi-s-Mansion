...
execute unless score #balcony_2_plant_9 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["balcony_2_potted_dying_blue_flower_4"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"balcony_2_potted_dying_blue_flower_4"}
execute unless score #balcony_2_plant_9 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["balcony_2_potted_dying_blue_flower_4"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.10_bills
