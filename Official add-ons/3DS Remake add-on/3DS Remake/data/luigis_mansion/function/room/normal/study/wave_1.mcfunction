...
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["study_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:8,loot:{name:"study_speedy_spirit"},spawn:3b}
...
data modify storage luigis_mansion:data entity set value {room:8,scan_message:{sender:"me",message:'{"type":"translatable","translate":"3ds_remake:message.neville.scan"}',plural_message:'{"type":"translatable","translate":"3ds_remake:message.neville.scan.more"}'}}
