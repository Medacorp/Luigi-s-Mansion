...
execute if score #dialog Dialog matches 4 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
execute if score #dialog Dialog matches 5 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 1 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.2"}]}
execute if score #dialog Dialog matches 5 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.2.more"}]}
execute if score #dialog Dialog matches 5 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.oomahkah_oui_soy_soh_ooh_ck_ck neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 5 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.2.alt"}]}
execute if score #dialog Dialog matches 5 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.yahmum_baahh neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 6 if entity @a[tag=next_dialog_line,limit=1] run stopsound @a[tag=same_room] neutral luigis_mansion:entity.e_gadd.talk.yahmum_baahh
execute if score #dialog Dialog matches 6 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 1 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.3"}]}
execute if score #dialog Dialog matches 6 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.3.more"}]}
execute if score #dialog Dialog matches 6 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.hmmm_nohjeebeedoggy_ohmoogah neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 6 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 1 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.3.alt"}]}
execute if score #dialog Dialog matches 6 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.3.alt.more"}]}
execute if score #dialog Dialog matches 6 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.mah_mah_mah_luigi_oui neutral @a[tag=same_room] ~ ~ ~ 1

execute if score #dialog Dialog matches 7 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"explain"}
...
execute if score #dialog Dialog matches 7 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.4"}]}
execute if score #dialog Dialog matches 7 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.mee_oomahkah_suku_suku_yahboh_yahboh neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 7 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 1 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.4.alt","with":[{"type":"selector","selector":"@a[tag=!spectator]"}]}]}
execute if score #dialog Dialog matches 7 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.where.4.alt.more"}]}
execute if score #dialog Dialog matches 7 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.hey_hey_suu_dehkooroo_hah neutral @a[tag=same_room] ~ ~ ~ 1

execute if score #dialog Dialog matches 8 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"shame"}
...
execute if score #dialog Dialog matches 8 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run scoreboard players set #dialog Dialog 89
execute if score #dialog Dialog matches 8 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.5"}]}
execute if score #dialog Dialog matches 8 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.orohroh_odoh_pahn_pahn neutral @a[tag=same_room] ~ ~ ~ 1

execute if score #dialog Dialog matches 9 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"3ds_remake",id:"shame_shake"}
...
execute if score #dialog Dialog matches 9 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.6"}]}
execute if score #dialog Dialog matches 9 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.soy_soh_ooh_suku_suku_oydohroh_odoh neutral @a[tag=same_room] ~ ~ ~ 1

execute if score #dialog Dialog matches 10 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.animation set value {namespace:"luigis_mansion",id:"nod"}
execute if score #dialog Dialog matches 10 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 10 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.gallery.where.7"}]}
execute if score #dialog Dialog matches 10 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.yahmum_baah neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 83 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.hey_hey_suu_tahmentahkeh_oydohroh neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 83 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.doors.2.alt"}]}
execute if score #dialog Dialog matches 83 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.gay_roon_ehdeedee_odoh neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 84 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.doors.3.more"}]}
execute if score #dialog Dialog matches 84 unless data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.ohmoogah_luigi_odoh neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 84 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.doors.3.alt.more"}]}
execute if score #dialog Dialog matches 84 if data storage luigis_mansion:data current_state.high_scores[{data_index:0}] if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.mah_mah_mah_luigi_oui neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 86 unless data storage 3ds_remake:data current_state.trophy.master{done:1b} if entity @a[tag=select_dialog_branch_stand,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.hap_poh_oomahkah_tatta_tatta neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 86 if data storage 3ds_remake:data current_state.trophy.master{done:1b} if score #players Totals matches 1 if entity @a[tag=select_dialog_branch_stand,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.stand.1.alt","with":[{"type":"selector","selector":"@a[tag=!spectator]"}]}]}
execute if score #dialog Dialog matches 86 if data storage 3ds_remake:data current_state.trophy.master{done:1b} if score #players Totals matches 2.. if entity @a[tag=select_dialog_branch_stand,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.gallery.stand.1.alt.more"}]}
...
execute if score #dialog Dialog matches 87 unless data storage 3ds_remake:data current_state.trophy.master{done:1b} if entity @a[tag=next_dialog_line,limit=1] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.hey_hey_suu_tahmentahkeh_oydohroh neutral @a[tag=same_room] ~ ~ ~ 1
