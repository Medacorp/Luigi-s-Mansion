...
execute if score #dialog Dialog matches 42..43 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:items/game_boy_horror/turn_screen_to_forced_value {value:"call",flags:[],floats:[9f,0f,0f,0f],tracker:[]}
execute if score #dialog Dialog matches 44..102 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:items/game_boy_horror/turn_screen_to_forced_value {value:"call",flags:[],floats:[8f,0f,0f,0f],tracker:[]}
