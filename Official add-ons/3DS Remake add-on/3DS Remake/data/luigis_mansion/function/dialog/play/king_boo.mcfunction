...
execute if score #dialog Dialog matches 82..123 unless score #dialog Dialog matches 87..117 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu,tag=!using_selection_menu] run function luigis_mansion:selection_menu/dialog/original_menu_skip
...
execute if score #dialog Dialog matches 451 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-1.5 ^-1.3 ^1 facing entity @e[tag=same_room,nbt={data:{entity:{namespace:'luigis_mansion',id:'bowser_painting'}}},limit=1] feet positioned as @s",teleport:"^-1.5 ^-0.5 ^-1 ~ ~"}
...
execute if score #dialog Dialog matches 194 as @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] at @s positioned ^ ^0.2 ^ run function luigis_mansion:spawn_entities/bowser/painting
...
execute if score #dialog Dialog matches 284 as @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] at @s positioned ~ ~-4 ~ facing entity @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] feet positioned ~ ~4 ~ run teleport @s ^ ^ ^0.3 ~ ~
execute if score #dialog Dialog matches 285..304 as @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] at @s run teleport @s ^ ^ ^0.3
