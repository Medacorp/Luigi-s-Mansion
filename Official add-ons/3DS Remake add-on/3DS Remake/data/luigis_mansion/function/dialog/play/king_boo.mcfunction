...
execute if score #dialog Dialog matches 451 unless score #mirrored Selected matches 1 as @a[tag=same_room] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated ~ 0 positioned ^-1.5 ^-2.5 ^1 facing entity @e[tag=same_room,nbt={data:{entity:{namespace:'luigis_mansion',id:'bowser'}}},limit=1] feet positioned as @s",teleport:"^-1.5 ^-0.5 ^-1 ~ ~"}
