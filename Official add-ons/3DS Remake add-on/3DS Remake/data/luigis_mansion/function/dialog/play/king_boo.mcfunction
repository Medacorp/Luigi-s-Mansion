...
execute if score #dialog Dialog matches 62..103 unless score #dialog Dialog matches 67..97 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu,tag=!using_selection_menu] run function luigis_mansion:selection_menu/dialog/original_menu_skip
...
execute if score #dialog Dialog matches 214 run tag @e[tag=same_room,tag=mario_model,limit=1] add remove_from_existence
...
execute if score #dialog Dialog matches 264..284 as @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] at @s facing entity @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] feet run teleport @s ^ ^ ^0.3 ~ ~
...
execute if score #dialog Dialog matches 371.. at @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] positioned ^ ^1 ^3 run particle minecraft:dust{color:16777215,scale:1f} ~ ~ ~ 0 0 0 0 10
execute if score #dialog Dialog matches 371.. at @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] positioned ^ ^1 ^4 run particle minecraft:dust{color:16777215,scale:1f} ~ ~ ~ 0 0 0 0 10
execute if score #dialog Dialog matches 371.. at @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"mario"}}},limit=1] positioned ^ ^1 ^5 run particle minecraft:dust{color:16777215,scale:1f} ~ ~ ~ 0 0 0 0 10
...
execute if score #dialog Dialog matches 431..470 as @e[tag=same_room,tag=luigi] run function luigis_mansion:entities/luigi/move/execute {execute:"at @e[tag=same_room,nbt={data:{entity:{namespace:'luigis_mansion',id:'mario'}}},limit=1] positioned ^ ^ ^2 facing entity @s feet positioned as @s",teleport:"^ ^ ^-0.3"}
execute if score #dialog Dialog matches 471..590 as @e[tag=same_room,tag=luigi] run function luigis_mansion:entities/luigi/move/execute {execute:"at @e[tag=same_room,nbt={data:{entity:{namespace:'luigis_mansion',id:'mario'}}},limit=1] positioned ^ ^ ^2 facing entity @s feet positioned as @s",teleport:"^ ^ ^-0.5"}
execute if score #dialog Dialog matches 491.. as @e[tag=same_room,tag=luigi] at @s run function luigis_mansion:entities/luigi/move/execute {teleport:"^ ^ ^20"}
...
execute if score #dialog Dialog matches 531 run scoreboard players add #secret_altar Wave 1
