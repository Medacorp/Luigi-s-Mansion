...
execute if score #dialog Dialog matches 313..330 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 331
execute if score #dialog Dialog matches 273..310 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 311
execute if score #dialog Dialog matches 232..269 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 270
...
execute if score #dialog Dialog matches 209..228 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 228
execute if score #dialog Dialog matches 189..207 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 208
execute if score #dialog Dialog matches 169..187 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 188
execute if score #dialog Dialog matches 149..167 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 168
...
execute if score #dialog Dialog matches 143 run tag @e[tag=portrificationized_portrait_text,tag=!shown,limit=1] add ghost_fade
...
execute if score #dialog Dialog matches 148 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run scoreboard players add #dialog Dialog 230
...
execute if score #dialog Dialog matches 148..311 store result score #area Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.area
execute if score #dialog Dialog matches 148..311 store result score #areas Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized
execute if score #dialog Dialog matches 168 store result score #temp Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.in_mansion_time
execute if score #dialog Dialog matches 168 store result score #temp2 Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.time
execute if score #dialog Dialog matches 168 unless score #area Time = #areas Time run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.time set from storage luigis_mansion:data current_state.luigis_mansion.current_data.in_mansion_time
...
execute if score #dialog Dialog matches 188 store result score #temp2 Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.ghosts
execute if score #dialog Dialog matches 188 unless score #area Time = #areas Time store result storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.ghosts int 1 run scoreboard players get #temp Time
...
execute if score #dialog Dialog matches 208 store result score #temp2 Time run data get storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.money
execute if score #dialog Dialog matches 208 unless score #area Time = #areas Time store result storage luigis_mansion:data current_state.luigis_mansion.current_data.previous_area_score.money int 1 run scoreboard players get #temp Time
execute if score #dialog Dialog matches 208 run scoreboard players operation #temp Time -= #temp2 Time
execute if score #dialog Dialog matches 148..311 run data modify storage luigis_mansion:data macro set value {area:0,data_index:0}
execute if score #dialog Dialog matches 148..311 run data modify storage luigis_mansion:data macro.data_index set from storage luigis_mansion:data current_state.luigis_mansion.current_data.data_index
execute if score #dialog Dialog matches 148..311 run scoreboard players remove #area Time 1
execute if score #dialog Dialog matches 148..311 run scoreboard players operation #area Time > #areas Time
execute if score #dialog Dialog matches 148..311 store result storage luigis_mansion:data macro.area int 1 run scoreboard players remove #area Time 1
execute if score #dialog Dialog matches 148..311 run scoreboard players add #area Time 1
...
execute if score #dialog Dialog matches 208 if score #temp Time matches 0 run summon minecraft:text_display 756 81.8 -7 {Tags:["results_treasures","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.no_treasures"},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
execute if score #dialog Dialog matches 208 if score #temp Time matches 1.. run summon minecraft:text_display 756 81.8 -7 {Tags:["results_treasures","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.treasures",with:[{type:"score",score:{name:"#temp",objective:"Time"}}]},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
...
execute if score #dialog Dialog matches 208 if score #area Time matches 1.. run summon minecraft:text_display 756 80.6 -7 {Tags:["area_best","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score.value",with:[{type:"score",score:{name:"#only",objective:"Time"}}]},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
execute if score #dialog Dialog matches 208 if score #area Time matches 1.. if score #only Time matches 0 run data modify entity @e[tag=area_best,limit=1] text set value {type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score.no_money"}
...
execute if score #dialog Dialog matches 208 if score #area Time matches 1.. run function 3ds_remake:dialog/play/score_results/save_only_score with storage luigis_mansion:data macro
execute if score #dialog Dialog matches 208 run scoreboard players reset #total Time
scoreboard players reset #temp Time
scoreboard players reset #temp2 Time
#228
execute if score #dialog Dialog matches 229.. store result score #temp Time run data get storage luigis_mansion:data dialogs[0].counter 10
execute if score #dialog Dialog matches 229 run tag @e[type=minecraft:text_display,scores={Room=-3}] add fade_out
...
execute if score #dialog Dialog matches 270 if score #temp Time matches ..-50 as @e[tag=money_counter] at @s run teleport @s ~ ~0.4 ~
execute if score #dialog Dialog matches 270 unless score #temp Time matches ..-50 store result storage luigis_mansion:data dialogs[0].counter double 0.1 run scoreboard players remove #temp Time 4
...
execute if score #dialog Dialog matches 311 if score #temp Time matches ..-50 as @e[tag=money_counter] at @s run teleport @s ~ ~0.4 ~
execute if score #dialog Dialog matches 311 unless score #temp Time matches ..-50 store result storage luigis_mansion:data dialogs[0].counter double 0.1 run scoreboard players remove #temp Time 4
execute if score #dialog Dialog matches 311 unless data storage luigis_mansion:data dialogs[0].ending if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function luigis_mansion:dialog/play/score_results/display_total_score
execute if score #dialog Dialog matches 311 unless data storage luigis_mansion:data dialogs[0].ending unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function luigis_mansion:dialog/play/score_results/get_total_score
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data dialogs[0].ending if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function luigis_mansion:dialog/play/score_results/get_total_score
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data dialogs[0].ending unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function luigis_mansion:dialog/play/score_results/save_high_score
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function 3ds_remake:dialog/play/score_results/get_area_records with storage luigis_mansion:data macro
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run summon minecraft:text_display 756 81.2 -7 {Tags:["results_footer","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score"},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run scoreboard players set @e[tag=results_footer,limit=1] Room -3
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized if score #area Time matches 1.. run summon minecraft:text_display 756 80.9 -7 {Tags:["area_footer","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score.up_to",with:[{type:"score",score:{name:"#area",objective:"Time"}}]},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized if score #area Time matches 1.. run scoreboard players set @e[tag=area_footer,limit=1] Room -3
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run scoreboard players operation #total Time > #temp Money
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run scoreboard players reset #temp Money
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run summon minecraft:text_display 756 80.6 -7 {Tags:["area_best","fade_in"],text:{type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score.value",with:[{type:"score",score:{name:"#total",objective:"Time"}}]},billboard:"fixed",line_width:160,background:0,alignment:"left",brightness:{block:15,sky:0},text_opacity:0b,Rotation:[-90.0f,0.0f]}
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized if score #only Time matches 0 run data modify entity @e[tag=area_best,limit=1] text set value {type:"translatable",translate:"3ds_remake:dialog.ghost_portrificationizer_room.results.high_score.no_money"}
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run scoreboard players set @e[tag=area_best,limit=1] Room -3
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run function 3ds_remake:dialog/play/score_results/save_total_score with storage luigis_mansion:data macro
execute if score #dialog Dialog matches 311 if data storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized run data modify storage luigis_mansion:data current_state.luigis_mansion.current_data.last_area_portrificationized set from storage luigis_mansion:data current_state.luigis_mansion.current_data.area
