...
execute if score #dialog Dialog matches 3 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] unless entity @s[tag=using_selection_menu,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/choice/lydias_child_care_diary
...
execute if score #dialog Dialog matches 4 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.mansion","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.lydias_child_care_diary.3"}]}
execute if score #dialog Dialog matches 5 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.mansion","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.lydias_child_care_diary.4"}]}
execute if score #dialog Dialog matches 6 if entity @a[tag=next_dialog_line,limit=1] run data modify storage 3ds_remake:data current_state.trophy.normal.read_books.lydias_child_care_diary set value 1b
