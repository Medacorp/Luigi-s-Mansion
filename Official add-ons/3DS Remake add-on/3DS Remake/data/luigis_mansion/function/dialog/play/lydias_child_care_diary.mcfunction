...
execute if score #dialog Dialog matches 6 if entity @a[tag=next_dialog_line,limit=1] run data modify storage luigis_mansion:data current_state.3ds_remake.trophy.normal.read_books.lydias_child_care_diary set value 1b
