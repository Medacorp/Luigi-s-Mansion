...
execute if score #dialog Dialog matches 1 as @e[tag=scanned_entity,scores={Dialog=..0},limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@s",color:"green"},{type:"translatable",translate:"luigis_mansion:message.mr_luggs.scan"}]}
execute if score #dialog Dialog matches 1 as @e[tag=scanned_entity,scores={Dialog=1..},limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"selector",selector:"@s",color:"green"},{type:"translatable",translate:"3ds_remake:message.mr_luggs.scan"}]}
