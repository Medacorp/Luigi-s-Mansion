summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.deer_head"}',Tags:["furniture","immobile","this_entity"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:furniture/deer_head","minecraft:unbreakable":{},"minecraft:custom_model_data":{floats:[0f]},"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"swinging",open_animation:{namespace:"3ds_remake",id:"deer_head"},model_data:{default:{components:{"minecraft:custom_model_data":{floats:[0f]}}},open:{components:{"minecraft:custom_model_data":{floats:[1f]}}},lit:{components:{"minecraft:custom_model_data":{floats:[2f]}}}}}}}],NoGravity:1b,Marker:1b,Invisible:1b,DisabledSlots:2039583}
