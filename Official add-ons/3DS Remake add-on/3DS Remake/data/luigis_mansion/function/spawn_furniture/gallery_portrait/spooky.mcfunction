execute if score #global_3ds_remake_gallery Selected matches 1 run summon minecraft:armor_stand ~ ~-1.43875 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.gallery_portrait"},Tags:["furniture","immobile","this_entity"],NoGravity:1b,Marker:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",portrait_ghost:{namespace:"luigis_mansion",id:"spooky"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:furniture/gallery_portrait/spooky","minecraft:custom_model_data":{strings:["platinum"]},"minecraft:custom_data":{model_data:{empty:{components:{"minecraft:custom_model_data":{strings:["none"]}}},bronze:{components:{"minecraft:custom_model_data":{strings:["bronze"]}}},silver:{components:{"minecraft:custom_model_data":{strings:["silver"]}}},gold:{components:{"minecraft:custom_model_data":{strings:["gold"]}}},platinum:{components:{"minecraft:custom_model_data":{strings:["platinum"]}}}}}}}},Invisible:1b,DisabledSlots:2039583}
execute unless score #global_3ds_remake_gallery Selected matches 1 run summon minecraft:armor_stand ~ ~-1.43875 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.gallery_portrait"},Tags:["furniture","immobile","this_entity"],NoGravity:1b,Marker:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",portrait_ghost:{namespace:"luigis_mansion",id:"spooky"}},equipment:{head:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/gallery_portrait/spooky","minecraft:custom_model_data":{strings:["gold"]},"minecraft:custom_data":{model_data:{empty:{components:{"minecraft:custom_model_data":{strings:["none"]}}},bronze:{components:{"minecraft:custom_model_data":{strings:["bronze"]}}},silver:{components:{"minecraft:custom_model_data":{strings:["silver"]}}},gold:{components:{"minecraft:custom_model_data":{strings:["gold"]}}},platinum:{components:{"minecraft:custom_model_data":{strings:["gold"]}}}}}}}},Invisible:1b,DisabledSlots:2039583}
teleport @e[tag=this_entity,limit=1] ~ ~-1.43875 ~ ~ 0
execute if data storage 3ds_remake:data current_state.selected_portraits{spooky:-1b} as @e[tag=this_entity,limit=1] run data modify entity @s equipment.head merge from entity @s equipment.head.components."minecraft:custom_data".model_data.empty
