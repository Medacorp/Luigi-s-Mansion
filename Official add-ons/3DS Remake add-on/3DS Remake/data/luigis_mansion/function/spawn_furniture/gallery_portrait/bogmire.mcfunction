...
execute if data storage 3ds_remake:data current_state.selected_portraits{bogmire:2b} as @e[tag=this_entity,limit=1] run data modify entity @s equipment.head merge from entity @s equipment.head.components."minecraft:custom_data".model_data.gold
