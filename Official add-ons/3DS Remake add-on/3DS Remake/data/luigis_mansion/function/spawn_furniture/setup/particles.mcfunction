...
execute if data storage luigis_mansion:data furniture{particles:"dripping_water"} run tag @e[tag=this_entity,limit=1] add store_home_y
...
execute if data storage luigis_mansion:data furniture{particles:"spraying_water"} run tag @e[tag=this_entity,limit=1] add store_home_y
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run tag @e[tag=this_entity,limit=1] add moist
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run tag @e[tag=this_entity,limit=1] add affected_by_ice
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run tag @e[tag=this_entity,limit=1] add affected_by_fire
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run tag @e[tag=this_entity,limit=1] add affected_by_vacuum
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run scoreboard players set @e[tag=this_entity,limit=1] HomeRotationX -90
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} run tag @e[tag=this_entity,limit=1] add store_home_y
...
execute if data storage luigis_mansion:data furniture{particles:"leaking_water"} run tag @e[tag=this_entity,limit=1] add store_home_y
