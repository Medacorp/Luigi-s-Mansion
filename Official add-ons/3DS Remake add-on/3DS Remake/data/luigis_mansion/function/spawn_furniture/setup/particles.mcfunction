...
execute if data storage luigis_mansion:data furniture{particles:"shooting_water"} as @e[tag=this_entity,limit=1] store result score @s HomeRotationY run data get entity @s Rotation[0]
