...
data modify storage luigis_mansion:data entity set value {room:8,mansion:{namespace:"luigis_mansion",id:"normal"},scan_message:{sender:"me",message:'{"type":"translatable","translate":"3ds_remake:message.neville.scan"}',plural_message:'{"type":"translatable","translate":"3ds_remake:message.neville.scan.more"}'}}
