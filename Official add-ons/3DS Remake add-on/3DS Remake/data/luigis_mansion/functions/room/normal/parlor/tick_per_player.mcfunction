...
execute unless data storage luigis_mansion:data {found_e_gadd:1b} if entity @s[tag=!spectator] unless data storage luigis_mansion:data dialogs[{room:3}] run function luigis_mansion:room/normal/parlor/meet_e_gadd