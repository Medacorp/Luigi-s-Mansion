...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 658 121 -21 run function luigis_mansion:room/hidden/balcony_2/plant_2
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 658 120 -21 run function luigis_mansion:blocks/dust
