...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 655 121 53 run function luigis_mansion:room/hidden/balcony_2/plant_13
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 655 120 53 run function luigis_mansion:blocks/dust
