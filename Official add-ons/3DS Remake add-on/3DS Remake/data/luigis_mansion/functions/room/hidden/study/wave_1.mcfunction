...
data modify storage luigis_mansion:data entity set value {scan_message:{sender:"me",message:'{"translate":"3ds_remake:message.neville.scan"}',plural_message:'{"translate":"3ds_remake:message.neville.scan.more"}'}}
