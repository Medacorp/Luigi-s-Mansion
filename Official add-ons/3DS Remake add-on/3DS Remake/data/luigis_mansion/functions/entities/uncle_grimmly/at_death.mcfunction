...
execute store result storage luigis_mansion:data current_state.current_data.portrait_ghosts.uncle_grimmly.top_vacuum_damage int 1 run scoreboard players get @s TopVacuumDamage
