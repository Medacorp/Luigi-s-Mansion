data modify storage luigis_mansion:data entity merge value {id:{namespace:"luigis_mansion",id:"null"},name:'{"type":"translatable","translate":"luigis_mansion:entity.boo"}',say_message:0b,can_attack:0b,damage:{},health:1,loot:{},speed:0}
data modify storage luigis_mansion:data entity.id set from entity @s data.boo
data modify storage luigis_mansion:data entity.name set from entity @s CustomName
execute if entity @s[scores={HideTime=1..}] run data modify storage luigis_mansion:data entity.say_message set value 1b
