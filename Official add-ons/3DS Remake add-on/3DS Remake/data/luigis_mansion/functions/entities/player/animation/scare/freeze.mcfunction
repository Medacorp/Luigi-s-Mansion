execute if entity @s[scores={IdleTime=-100,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-100,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={IdleTime=-100,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-100,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={IdleTime=-100},tag=!gooigi] Sound 60
