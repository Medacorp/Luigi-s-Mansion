...
execute at @s[scores={KnockbackTime=125,KnockbackType=14,Sound=0,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_little player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={KnockbackTime=125,KnockbackType=14,Sound=0,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_little player @a[tag=same_room] ~ ~ ~ 1 2
...
execute at @s unless entity @s[scores={KnockbackType=14}] unless block ~ ~ ~ #luigis_mansion:players_ignore if block ~ ~0.3 ~ #luigis_mansion:players_ignore run teleport @s ~ ~0.16 ~
