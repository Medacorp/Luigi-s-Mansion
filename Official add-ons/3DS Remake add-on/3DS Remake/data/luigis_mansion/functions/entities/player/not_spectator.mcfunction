...
execute if entity @s[scores={Health=..0},tag=!death_animation,tag=!revive_animation] unless entity @s[scores={Animation=27..41}] run function luigis_mansion:entities/player/death
...
execute if entity @s[scores={OpenMapTime=0}] unless entity @s[scores={Animation=27..41}] run function luigis_mansion:selection_menu/game_boy_horror/map/open
...
execute if entity @s[tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={Animation=28..38}] unless entity @s[scores={Animation=40..41}] run function luigis_mansion:blocks/gravity_swap
execute if entity @s[tag=riding_poltergust,tag=!looking_at_map,tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={Animation=27..38}] run function luigis_mansion:entities/player/riding_poltergust
execute unless entity @s[tag=riding_poltergust,tag=!looking_at_map,tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={Animation=27..38}] run scoreboard players set @s SlipX 0
execute unless entity @s[tag=riding_poltergust,tag=!looking_at_map,tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={Animation=27..38}] run scoreboard players set @s SlipZ 0
...
execute if entity @s[scores={Animation=1..},tag=idle,tag=!gooigi] unless entity @s[scores={Walk=0,Run=0,Sneak=0,Jump=0},tag=!sneak_pos,tag=!spectator,tag=player,tag=!warp,tag=!scanning,tag=!poltergust_selected,tag=!riding_poltergust] run function luigis_mansion:entities/player/animation/set/none
...
execute if entity @s[scores={Animation=1..},tag=!idle,tag=!animation_may_move,tag=!looking_at_map,tag=!gooigi] run function luigis_mansion:entities/player/animation/freeze_player
