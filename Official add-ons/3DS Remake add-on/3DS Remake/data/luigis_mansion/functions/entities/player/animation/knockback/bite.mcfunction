...
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_bitten.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_bitten.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_bitten.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={IdleTime=-10,Sound=0,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_bitten.low_health player @a[tag=same_room] ~ ~ ~ 1 2
...
execute if entity @s[scores={IdleTime=..-2},tag=struggle] run scoreboard players add @s GrabbedShake 1
execute if entity @s[scores={IdleTime=..-2},tag=struggle] run scoreboard players set @e[tag=this_ghost,limit=1] ActionTime 31
execute if entity @s[scores={IdleTime=..-2,GrabbedShake=10..}] run scoreboard players reset @e[tag=this_ghost,limit=1] GrabbedID
execute if entity @s[scores={IdleTime=..-2}] run tag @s remove struggle
scoreboard players set @s[scores={IdleTime=..-2,Invulnerable=6..}] Invulnerable 5
execute if entity @s[scores={IdleTime=-9..-2,Invulnerable=0}] run function luigis_mansion:entities/player/memory/get with entity @s
execute if entity @s[scores={IdleTime=-9..-2,Invulnerable=0}] run data modify storage luigis_mansion:data damage set value {amount:1,attacker:-1}
execute if entity @s[scores={IdleTime=-9..-2,Invulnerable=0}] run data modify storage luigis_mansion:data damage.attacker set from storage luigis_mansion:data my_memory.hurt_by.attacker
execute if entity @s[scores={IdleTime=-9..-2,Invulnerable=0}] run function luigis_mansion:entities/player/damage
...
scoreboard players set @s[scores={IdleTime=-1}] Invulnerable 60
