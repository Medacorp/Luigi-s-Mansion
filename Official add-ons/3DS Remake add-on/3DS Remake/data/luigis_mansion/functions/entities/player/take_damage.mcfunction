...
execute if data storage luigis_mansion:data damage{knockback:"burn"} if entity @s[scores={Damage=1..,Invulnerable=0},tag=gooigi] run data modify storage luigis_mansion:data my_memory.hurt_by.method set value "3ds_remake:melt"
execute if data storage luigis_mansion:data damage{knockback:"burn"} if entity @s[scores={KnockbackDamage=1..,Invulnerable=0},tag=gooigi] run data modify storage luigis_mansion:data my_memory.hurt_by.method set value "3ds_remake:melt"
...
execute if data storage luigis_mansion:data my_memory.hurt_by{method:"3ds_remake:melt"} run scoreboard players set @s Health 0
