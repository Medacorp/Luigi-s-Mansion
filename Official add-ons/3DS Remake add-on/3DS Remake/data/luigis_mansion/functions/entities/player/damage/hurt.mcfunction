...
execute unless score #global_difficulty Selected matches 0 if entity @s[scores={Room=1..},tag=!gooigi] run function #luigis_mansion:entities/player/damage/drop_item
