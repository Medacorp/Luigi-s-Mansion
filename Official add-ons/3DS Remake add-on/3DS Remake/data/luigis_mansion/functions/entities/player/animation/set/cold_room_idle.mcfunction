...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"cold_room_idle"} if entity @s[scores={Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.shiver player @a[tag=same_room] ~ ~ ~ 1
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"luigis_mansion",id:"cold_room_idle"} if entity @s[scores={Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.shiver player @a[tag=same_room] ~ ~ ~ 1 2
