...
execute if score #temp ActionTime matches 1.. if data storage 3ds_remake:data current_state.trophy.easy{task_5:0b} run function 3ds_remake:room/gallery/clear_task/easy/task_5
execute if score #temp ActionTime matches 20.. if data storage 3ds_remake:data current_state.trophy.hard{task_7:0b} run function 3ds_remake:room/gallery/clear_task/hard/task_7
