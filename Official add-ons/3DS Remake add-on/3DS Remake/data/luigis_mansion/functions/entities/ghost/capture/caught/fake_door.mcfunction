...
execute if score #temp ActionTime matches 1.. if data storage 3ds_remake:data current_state.trophy.beginner{task_8:0b} run function 3ds_remake:room/gallery/clear_task/beginner/task_8
