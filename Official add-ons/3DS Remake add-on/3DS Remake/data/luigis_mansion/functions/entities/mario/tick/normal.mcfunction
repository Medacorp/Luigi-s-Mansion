...
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 130000.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"3ds_remake:message.the_end.s_rank"}]}
