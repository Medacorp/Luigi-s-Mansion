...
execute if data storage luigis_mansion:data current_state.current_data{boo_counter:4} at @s if entity @a[tag=looking_at_map,limit=1] if score #mansion_data_index Selected matches 1 run function luigis_mansion:items/game_boy_horror/map/display/normal/door/hallway_5_washroom_1
execute if data storage luigis_mansion:data current_state.current_data{boo_counter:4} at @s if entity @a[tag=looking_at_map,limit=1] if score #mansion_data_index Selected matches 0 run function luigis_mansion:items/game_boy_horror/map/display/hidden/door/hallway_5_washroom_1
