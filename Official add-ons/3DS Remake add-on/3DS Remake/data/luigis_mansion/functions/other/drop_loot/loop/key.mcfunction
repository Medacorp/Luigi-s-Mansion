$execute unless data storage luigis_mansion:data current_state.current_data{obtained_keys:[$(door)]} unless entity @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"key",variant:$(door)}}]},limit=1] run summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:item.key"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"luigis_mansion",id:"key",variant:$(door),Unbreakable:1b,Damage:5,CustomModelData:15}}],Small:1b,NoGravity:1b,Tags:["item","key","no_gooigi","eternal","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
