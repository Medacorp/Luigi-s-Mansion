...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run data remove entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] data.animation
