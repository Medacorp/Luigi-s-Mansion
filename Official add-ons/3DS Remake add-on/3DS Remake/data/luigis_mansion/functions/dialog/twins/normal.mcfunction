...
execute if entity @s[scores={Dialog=1}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] add appear
...
execute if entity @s[scores={Dialog=61}] if score #players Totals matches 1 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.orville","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.twins.1"}]}
execute if entity @s[scores={Dialog=61}] if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.orville","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.twins.1.more"}]}
tag @s[scores={Dialog=148}] remove nod
scoreboard players set @s[scores={Dialog=148}] AnimationProgress 0
execute if entity @s[scores={Dialog=148}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] add nod
execute if entity @s[scores={Dialog=148}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=228}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] remove nod
execute if entity @s[scores={Dialog=228}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=268}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=270}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=270}] if entity @a[scores={TwinsChoice=1}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] add nod
...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] remove nod
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=270}] if entity @a[scores={TwinsChoice=2}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},limit=1] add shake
...
execute if entity @s[tag=remove_from_existence] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},tag=no_ai,limit=1] add remove_from_existence
execute if entity @s[tag=remove_from_existence] run teleport @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"henry"}}}}]},tag=no_ai,limit=1] ~ ~-100 ~
