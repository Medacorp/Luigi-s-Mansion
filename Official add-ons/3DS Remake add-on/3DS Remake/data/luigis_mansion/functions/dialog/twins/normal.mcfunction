...
execute if entity @s[scores={Dialog=148}] run scoreboard players set @e[tag=henry,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=228}] run scoreboard players set @e[tag=henry,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=268}] run scoreboard players set @e[tag=henry,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=270}] run scoreboard players set @e[tag=henry,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run scoreboard players set @e[tag=henry,limit=1] AnimationProgress 0
