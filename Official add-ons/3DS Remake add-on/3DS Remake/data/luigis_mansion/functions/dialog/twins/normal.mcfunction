...
execute if entity @s[scores={Dialog=1}] run tag @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] add appear
...
execute if entity @s[scores={Dialog=61}] if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"3ds_remake:dialog.twins.1"}]}
execute if entity @s[scores={Dialog=61}] if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"3ds_remake:dialog.twins.1.more"}]}
tag @s[scores={Dialog=148}] remove nod
scoreboard players set @s[scores={Dialog=148}] AnimationProgress 0
execute if entity @s[scores={Dialog=148}] run tag @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] add nod
execute if entity @s[scores={Dialog=148}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=228}] run tag @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] remove nod
execute if entity @s[scores={Dialog=228}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run tag @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] remove nod
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"henry"}}]},limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.orville","color":"green"},{"translate":"luigis_mansion:dialog.twins.yes.2"}]}
