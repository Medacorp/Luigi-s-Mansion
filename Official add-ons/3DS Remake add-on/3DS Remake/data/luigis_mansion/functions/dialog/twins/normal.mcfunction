...
execute if entity @s[scores={Dialog=268}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{luigis_mansion:{namespace:"luigis_mansion",id:"henry"}}}]},limit=1] AnimationProgress 0
