...
execute if entity @s[scores={Dialog=1}] run tag @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] add appear
...
data modify entity @s[scores={Dialog=61}] data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
data remove entity @s[scores={Dialog=148}] data.animation
execute if entity @s[scores={Dialog=148}] run data modify entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
execute if entity @s[scores={Dialog=228}] run data remove entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] data.animation
data modify entity @s[scores={Dialog=228}] data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
data remove entity @s[scores={Dialog=268}] data.animation
...
execute if entity @s[scores={Dialog=270}] if entity @a[scores={TwinsChoice=1}] run data modify entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run data remove entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] data.animation set value {namespace:"luigis_mansion",id:"nod"}
execute if entity @s[scores={Dialog=278}] if entity @a[scores={TwinsChoice=1}] run data modify entity @s data.animation set value {namespace:"luigis_mansion",id:"nod"}
...
execute if entity @s[tag=remove_from_existence] run tag @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},tag=no_ai,limit=1] add remove_from_existence