...
execute if entity @s[scores={Dialog=1050}] run function 3ds_remake:dialog/portrificationizing/convert_time
execute if entity @s[scores={Dialog=1050}] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"3ds_remake:message.time_spent_in_mansion","with":[{"score":{"name":"#temp6","objective":"Time"}},{"score":{"name":"#temp5","objective":"Time"}},{"score":{"name":"#temp4","objective":"Time"}},{"score":{"name":"#temp3","objective":"Time"}},{"score":{"name":"#temp2","objective":"Time"}},{"score":{"name":"#temp","objective":"Time"}}]}]}
