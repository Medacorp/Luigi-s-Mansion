...
execute store result score #temp Time run data get storage luigis_mansion:data current_high_score.health
execute if score #temp Time matches 50.. if score #mansion_data_index Selected matches 0..1 if data storage 3ds_remake:data current_state.trophy.hard{task_6:0b} run function 3ds_remake:room/gallery/clear_task/hard/task_6
execute if score #temp Time matches 80.. if score #mansion_data_index Selected matches 0..1 if data storage 3ds_remake:data current_state.trophy.master{task_6:0b} run function 3ds_remake:room/gallery/clear_task/master/task_6
execute store result score #temp Time run data get storage luigis_mansion:data current_high_score.speed
execute if score #temp Time matches ..216000 if score #mansion_data_index Selected matches 0..1 if data storage 3ds_remake:data current_state.trophy.master{task_7:0b} run function 3ds_remake:room/gallery/clear_task/master/task_7
