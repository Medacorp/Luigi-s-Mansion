...
execute if entity @s[scores={Dialog=472}] run scoreboard players add @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}] ActionTime 1
execute if entity @s[scores={Dialog=574..}] as @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}] at @s run teleport @s ~ ~1 ~
...
execute if entity @s[scores={Dialog=595}] run tag @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"boolossus"}}},tag=!merged] add remove_from_existence
