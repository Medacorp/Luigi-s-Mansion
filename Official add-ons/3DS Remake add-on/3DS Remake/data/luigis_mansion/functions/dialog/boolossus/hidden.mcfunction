...
execute if entity @s[scores={Dialog=1..433}] as @a[tag=same_room,gamemode=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if entity @s[scores={Dialog=304}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]}] add dialog_animation
...
execute if entity @s[scores={Dialog=334}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=338}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=342}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=346}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=350}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=354}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=358}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=362}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=366}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=370}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=374}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=378}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=382}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=386}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
execute if entity @s[scores={Dialog=390}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},sort=random,tag=!dialog_animation_start,limit=1] add dialog_animation_start
...
execute if entity @s[scores={Dialog=472}] run scoreboard players add @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]}] ActionTime 1
execute if entity @s[scores={Dialog=574..}] as @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]}] at @s run teleport @s ~ ~1 ~
...
execute if entity @s[scores={Dialog=595}] run tag @e[nbt={ArmorItems:[{tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"boolossus"}}}}]},tag=!merged] add remove_from_existence
...
execute if entity @s[scores={Dialog=595}] if score #mansion_data_index Selected matches 1 as @a run function 3ds_remake:room/hidden/boolossus_battle/warp_to
