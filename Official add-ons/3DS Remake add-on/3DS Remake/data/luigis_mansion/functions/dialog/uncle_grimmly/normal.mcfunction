...
execute if entity @s[scores={Dialog=904}] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"3ds_remake:dialog.uncle_grimmly.8"}]}
...
execute if entity @s[scores={Dialog=1264}] run function luigis_mansion:room/normal/telephone_room/blackout
