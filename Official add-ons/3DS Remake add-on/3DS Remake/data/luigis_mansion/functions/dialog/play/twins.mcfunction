...
execute if score #dialog Dialog matches 61..67 unless score #dialog Dialog matches 65 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 65 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/twins
...
tag @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"henry"}}},limit=1] remove add visible
tag @e[tag=same_room,nbt={data:{entity:{namespace:"luigis_mansion",id:"orville"}}},limit=1] remove add visible
...
execute if score #dialog Dialog matches 1..67 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
...
#Branch: No
execute if score #dialog Dialog matches 69..128 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
