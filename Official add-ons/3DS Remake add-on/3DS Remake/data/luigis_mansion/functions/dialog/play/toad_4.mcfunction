...
execute if score #dialog Dialog matches ..54 unless score #dialog Dialog matches 7..27 unless score #dialog Dialog matches 32..33 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 7 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/toad_4
execute if score #dialog Dialog matches 32 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/save
...
execute if score #dialog Dialog matches 3..6 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/high_health_idle_no_sound
...
execute if score #dialog Dialog matches 7 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/think

#Branch: Yes
execute if score #dialog Dialog matches 8 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/enthusiiastic
...
execute if score #dialog Dialog matches 28..32 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 31 at @e[tag=toad,tag=same_room,limit=1] run playsound luigis_mansion:entity.toad.yahoo neutral @a[tag=same_room] ~ ~ ~ 1
...
#Branch: No
execute if score #dialog Dialog matches 34 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/nod
...
execute if score #dialog Dialog matches 54 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:entities/player/animation/set/idle
