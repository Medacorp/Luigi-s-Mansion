summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion:item.water_element_medal"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{luigis_mansion:{namespace:"luigis_mansion",id:"element_medal",physics_offset:1.1d,pick_up_range:0.7f,variant:"water",particle:{chance:1,name:"minecraft:rain"}},Unbreakable:1b,Damage:5,CustomModelData:22}}],Tags:["item","generic","no_gooigi","affected_by_vacuum","eternal","this_entity"],DisabledSlots:2039583}
