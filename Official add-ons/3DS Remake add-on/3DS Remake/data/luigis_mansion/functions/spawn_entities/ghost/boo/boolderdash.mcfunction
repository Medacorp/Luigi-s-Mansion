data modify storage luigis_mansion:data entity merge value {id:"boolderdash",name:'{"translate":"3ds_remake:entity.boolderdash"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
