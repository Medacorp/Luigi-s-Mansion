...
execute unless entity @a[tag=looking_at_map,scores={Room=-5..-1}] if entity @s[tag=!cancel] run function luigis_mansion:selection_menu/game_boy_horror/map/display/lab/generate
