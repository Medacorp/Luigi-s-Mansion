summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.room_clear_chest"}',Tags:["furniture","chest","room_clear_chest","immobile","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:7,luigis_mansion:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"delayed"},luigis_mansion:{interact_animation:{namespace:"3ds_remake",id:"search/chest"}}}}],Invisible:1b,DisabledSlots:2039583}
