...
execute unless entity @s[scores={ErrorTime=1..}] unless entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:entities/ghost/damage/weak
execute unless entity @s[scores={ErrorTime=1..}] if entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:entities/ghost/damage/strong
execute if entity @s[scores={ErrorTime=1..}] run function luigis_mansion:entities/ghost/damage/strong
