...
execute unless entity @s[scores={ErrorTime=1..}] unless entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:old_entities/ghost/hurt_pull
execute unless entity @s[scores={ErrorTime=1..}] if entity @a[tag=me,limit=1,scores={ErrorTime=1..}] run function luigis_mansion:old_entities/ghost/hurt_pull_strong
execute if entity @s[scores={ErrorTime=1..}] run function luigis_mansion:old_entities/ghost/hurt_pull_strong
