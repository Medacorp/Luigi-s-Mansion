...
execute if entity @e[tag=interacting_with_me,tag=!death_location,limit=1] if entity @s[tag=!gooigi] run function luigis_mansion:entities/player/animation/set/talk
execute if entity @e[tag=interacting_with_me,tag=!death_location,limit=1] run tag @s[tag=!gooigi] add talk
