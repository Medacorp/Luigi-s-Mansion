...
execute unless score #difficulty Selected matches 3 run scoreboard players set @s VulnerableTime 80
execute if score #difficulty Selected matches 3 run scoreboard players set @s VulnerableTime 20
