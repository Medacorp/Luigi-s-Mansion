...
execute unless score #difficulty Selected matches 3 run scoreboard players set @s StunTime 200
execute if score #difficulty Selected matches 3 run scoreboard players set #temp VulnerableTime 16
