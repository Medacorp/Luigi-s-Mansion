...
execute if entity @s[scores={DeathTime=1}] as @a run function luigis_mansion:old_entities/ghost/find_vacuumers
...
execute if entity @s[scores={DeathTime=1}] unless entity @a[tag=killer,limit=1] run function luigis_mansion:old_entities/ghost/cancel_death
...
execute at @s[scores={DeathTime=1,Room=1..},tag=!dead,tag=!remove_from_existence] unless entity @s[scores={Health=-2147483648..}] run function luigis_mansion:old_entities/ghost/capture with entity @a[tag=killer,limit=1]
execute at @s[scores={DeathTime=2..,Room=1..,Health=-2147483648..},tag=!dead,tag=!remove_from_existence] if entity @a[tag=killer,distance=..0.7] run function luigis_mansion:old_entities/ghost/capture with entity @a[tag=killer,limit=1]
