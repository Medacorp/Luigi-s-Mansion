...
execute in minecraft:overworld run data modify entity @e[tag=portrificationizing_ghost,nbt={equipment:{head:{components:{"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"king_boo"}}}}}},limit=1] equipment.head.components."minecraft:custom_data" merge value {entity:{namespace:"luigis_mansion",id:"portrificationizing_ghost"},ghost:{namespace:"luigis_mansion",id:"king_boo"}}
