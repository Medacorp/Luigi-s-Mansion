...
scoreboard players reset #temp Time
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_1_potted_dying_blue_flower"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_1_potted_dying_brown_flowers"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_1_potted_fern"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_1_potted_stem"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_duo_potted_dying_pink_and_brown_flowers"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_dying_blue_flower_1"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_dying_blue_flower_3"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_dying_blue_flower_4"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_dying_blue_flower_5"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_dying_blue_flower_6"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_fern_1"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_fern_2"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_potted_stem_2"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_stone_bowl_potted_fern_1"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_stone_bowl_potted_fern_2"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_stone_bowl_potted_fern_3"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["balcony_2_stone_bowl_potted_fern_4"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["courtyard_stone_bowl_potted_fern_1"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["courtyard_stone_bowl_potted_fern_2"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["courtyard_stone_bowl_potted_fern_3"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["guest_room_column_mounted_blue_potted_fern"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["master_bedroom_column_mounted_brown_potted_fern"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,money_spawned:["sitting_room_column_mounted_blue_potted_fern"]} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,technical_data:{watered_boneyard_plant_1:1b}} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_5 set value 1b
...
scoreboard players reset #temp Time
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,obtained_items:{fire_element_medal:1b}} run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.fire set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,obtained_items:{water_element_medal:1b}} run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.water set value 1b
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,obtained_items:{ice_element_medal:1b}} run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.ice set value 1b
execute if data storage luigis_mansion:data current_state.mansion_data[{data_index:0,obtained_items:{fire_element_medal:1b}}] run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.fire set value 1b
execute if data storage luigis_mansion:data current_state.mansion_data[{data_index:0,obtained_items:{water_element_medal:1b}}] run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.water set value 1b
execute if data storage luigis_mansion:data current_state.mansion_data[{data_index:0,obtained_items:{ice_element_medal:1b}}] run data modify storage 3ds_remake:data current_state.trophy.easy.has_element_medal.ice set value 1b
...
execute if data storage luigis_mansion:data current_state.current_data{data_index:0,can_clear_hidden:0b,boos:[{name:{namespace:"luigis_mansion",id:"booligan"}}]} run data modify storage luigis_mansion:data current_state.current_data.boos[{name:{namespace:"luigis_mansion",id:"booligan"}}].name set value {namespace:"3ds_remake",id:"boolldog"}
