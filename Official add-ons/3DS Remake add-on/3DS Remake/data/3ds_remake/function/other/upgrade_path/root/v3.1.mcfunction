...
data remove storage 3ds_remake:data portrait_ghost
data modify storage luigis_mansion:data current_state.portrait_ghosts_defeated_in set from storage 3ds_remake:data current_state.portrait_ghosts_defeated_in
...
data modify storage luigis_mansion:data current_state.portrait_ghosts_defeated_in set from storage 3ds_remake:data current_state.portrait_ghosts_defeated_in
data modify storage luigis_mansion:data saved_state.ghosts_caught.boos set from storage 3ds_remake:data saved_state.boos_caught
data remove storage 3ds_remake:data current_state.portrait_ghosts_defeated_in
