...
execute if entity @s[tag=dark_room] positioned ~ ~1 ~ if block ^ ^ ^0.8 #luigis_mansion:flashlight_path run summon minecraft:marker ~ ~ ~ {Tags:["weak_flashlight","new"],data:{entity:{namespace:"3ds_remake",id:"weak_flashlight"}}}
