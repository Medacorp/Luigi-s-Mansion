...
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] store result score @s HomeRotationY run data get entity @s Rotation[1]
