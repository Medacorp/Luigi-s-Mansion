tag @s add me
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{no_collect_animation:["3ds_remake:super_mushroom"]} as @e[tag=collector,limit=1] run function luigis_mansion:entities/luigi/animation/set/collect_item with entity @e[tag=me,limit=1] equipment.head
tag @s remove me
