tag @s add me
execute unless data storage luigis_mansion:data current_state.current_data{no_collect_animation:["3ds_remake:game_boy_horror_part"]} as @e[tag=collector,limit=1] run function luigis_mansion:entities/luigi/animation/set/collect_item with entity @e[tag=me,limit=1] ArmorItems[3]
tag @s remove me
