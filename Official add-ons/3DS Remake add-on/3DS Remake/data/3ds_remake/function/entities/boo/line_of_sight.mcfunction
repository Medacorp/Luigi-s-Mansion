execute if entity @s[distance=..1] run scoreboard players set #temp Time 1
...
execute if score #temp Steps matches ..30 if score #temp Time matches 0 positioned ^ ^ ^1 run function 3ds_remake:entities/boo/line_of_sight
