...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"3ds_remake",id:"search/chest"} run function luigis_mansion:entities/luigi/animation/set/none
