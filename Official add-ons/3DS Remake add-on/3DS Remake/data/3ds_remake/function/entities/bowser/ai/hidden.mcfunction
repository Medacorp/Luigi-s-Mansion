...
execute if entity @s[tag=intro_done,tag=!decapitate,tag=!grabbing_head,tag=!headless_run,tag=can_decapitate] run function luigis_mansion:entities/bowser/ai/hidden/choice
