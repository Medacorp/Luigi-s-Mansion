...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=20..,Health=..15}] run function luigis_mansion:entities/luigi/animation/set/low_health_idle
...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=20..,Health=16..},tag=cold_room] run function luigis_mansion:entities/luigi/animation/set/cold_room_idle
...
execute unless data storage luigis_mansion:data my_memory.animation if entity @s[scores={IdleTime=200..,Health=16..},tag=!cold_room] run function luigis_mansion:entities/luigi/animation/set/high_health_idle
