...
summon minecraft:text_display ~ ~ ~ {Tags:["source","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},billboard:"center"}
summon minecraft:item_display ~ ~ ~ {Tags:["head","gooigi_model","model_piece","this_entity","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[0b],floats:[0f]}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["right_arm","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[0b],floats:[1f]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[2f]}}}}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["right_arm","held_item","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["left_arm","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[0b],floats:[2f]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[1f]}}}}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["left_arm","held_item","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["chest","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[0b],floats:[3f]}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["right_leg","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[0b],floats:[4f]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[5f]}}}}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["left_leg","gooigi_model","this_entity","model_piece","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"},item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"3ds_remake:entity/gooigi","minecraft:custom_model_data":{flags:[B;0b],floats:[5f]},"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":{floats:[4f]}}}}}},item_display:"head"}
summon minecraft:item_display ~ ~ ~ {Tags:["poltergust_body","gooigi_model","model_piece","this_entity","found_owner"],CustomName:{type:"translatable",translate:"3ds_remake:entity.gooigi"}}
...
data modify entity @e[tag=model_piece,tag=source,tag=this_entity,limit=1] text set from entity @e[tag=!model_piece,tag=this_entity,limit=1] data.player_name
