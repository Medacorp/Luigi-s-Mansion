...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 715 11 68 run function 3ds_remake:room/hidden/laundry_room/closet
