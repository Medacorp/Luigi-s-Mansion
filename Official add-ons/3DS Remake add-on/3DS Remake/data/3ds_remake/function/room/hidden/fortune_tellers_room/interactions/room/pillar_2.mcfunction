...
execute if score #fortune_tellers_room_pillar_2 Searching matches 20 run function 3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/pillar_2
