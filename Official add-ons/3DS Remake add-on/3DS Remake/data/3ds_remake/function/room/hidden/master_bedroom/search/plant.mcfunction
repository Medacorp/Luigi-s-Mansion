...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 687 114 54 run function 3ds_remake:room/hidden/master_bedroom/plant
