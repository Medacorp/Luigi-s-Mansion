...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} run function #3ds_remake:room/hidden/hallway_14/turn_lights/on
