...
execute if data storage luigis_mansion:data current_state.current_data.technical_data{red_grabbing_ghost_easel:1b} run function 3ds_remake:room/hidden/the_artists_studio/wave_5