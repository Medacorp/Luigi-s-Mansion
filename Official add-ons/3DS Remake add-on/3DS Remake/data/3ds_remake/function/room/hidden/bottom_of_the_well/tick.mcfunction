...
execute as @e[tag=player,x=645,y=92,z=-9,dx=6,dy=7,dz=10] unless entity @s[x=648.5,y=93,z=-9.5,distance=..0.7] unless entity @s[scores={Room=31}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=645,y=92,z=-9,dx=6,dy=7,dz=10] unless entity @s[x=648.5,y=93,z=-9.5,distance=..0.7] run scoreboard players set @s[tag=!separated_camera] Room 31
...
execute if entity @e[tag=luigi,tag=!door_animation,scores={Room=31},limit=1] run function 3ds_remake:room/hidden/bottom_of_the_well/ghosts