...
execute unless data storage luigis_mansion:data furniture.loot positioned 650 102 15 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 650 104 15 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
