...
execute if block 753 33 62 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:{namespace:"luigis_mansion",id:"mace"},amount:10,animation:"knockback/large",no_delete:1b}
execute if block 753 33 62 minecraft:andesite as @a[x=754.5,y=29,z=61.5,distance=..1,tag=!spectator] positioned 754.0 29 62.0 run function luigis_mansion:entities/player/damage
...
execute unless entity @e[x=753.5,y=29,z=61.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function 3ds_remake:room/hidden/armory/search/armor_5
