...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} run function #3ds_remake:room/hidden/balcony_2/turn_lights/on
