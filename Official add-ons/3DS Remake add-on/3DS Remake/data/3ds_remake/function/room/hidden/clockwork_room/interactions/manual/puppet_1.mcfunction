...
execute if entity @s[x=688.0,y=122,z=22.0,dx=1,dy=2,dz=1,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/clockwork_room/search/boo_check/puppet_1