...
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["bathroom_1_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:16,loot:{name:"bathroom_1_speedy_spirit"},spawn:3b}
