...
execute if score #hidden_room_hole Searched matches 1 as @e[tag=luigi,x=741.5,y=11,z=46.5,distance=..0.7] run function 3ds_remake:room/hidden/hidden_room/go_through_hole