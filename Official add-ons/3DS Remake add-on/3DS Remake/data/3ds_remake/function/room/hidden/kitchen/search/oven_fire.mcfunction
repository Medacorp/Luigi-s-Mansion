...
execute if score #kitchen_oven Searched matches 1.. unless data storage luigis_mansion:data furniture.loot positioned 700 11 -75.0 run function luigis_mansion:blocks/dust
execute if score #kitchen_oven Searched matches 1.. if data storage luigis_mansion:data furniture.loot positioned 701 11 75.0 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
