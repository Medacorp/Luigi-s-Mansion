...
execute positioned 664.9 20 45.05 run function luigis_mansion:spawn_entities/ghost/empty_marker
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["washroom_2_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:42,no_hidden_move:1b,disappear_on_vanish:"washroom_2_speedy_spirit",loot:{drop_at_0:{name:"washroom_2_speedy_spirit"}},spawn:3b}
