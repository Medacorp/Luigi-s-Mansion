...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 740 13 66 run function 3ds_remake:room/hidden/butlers_room/closet
