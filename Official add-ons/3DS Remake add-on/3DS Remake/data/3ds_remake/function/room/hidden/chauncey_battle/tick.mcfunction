...
scoreboard players set @a[x=782,y=5,z=43,dx=41,dy=34,dz=41] Room 73
...
execute if entity @a[tag=!pause_dialog,scores={Room=73},tag=!spectator,limit=1] run function 3ds_remake:room/hidden/chauncey_battle/ghosts
