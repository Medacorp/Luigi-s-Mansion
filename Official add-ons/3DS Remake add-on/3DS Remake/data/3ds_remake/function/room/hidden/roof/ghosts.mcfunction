...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.roof{cleared:1b} if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:0b} unless score #roof Wave matches 1..99 run function 3ds_remake:room/hidden/roof/wave_1
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data{blackout:1b} unless score #roof Wave matches 1.. run function 3ds_remake:room/hidden/roof/blackout
