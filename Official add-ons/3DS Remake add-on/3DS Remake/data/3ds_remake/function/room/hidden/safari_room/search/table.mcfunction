execute unless score #safari_room_table Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:50,tags:["drop_loot"],loot:{contents:{luigis_mansion:{poison_mushroom:1}}}}
