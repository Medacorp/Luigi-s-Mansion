execute unless score #safari_room_table Searched matches 1 run data modify storage luigis_mansion:data furniture set value {room:50,tags:["drop_loot"],loot_chances:{namespace:"luigis_mansion",id:"poison_mushroom"}}
