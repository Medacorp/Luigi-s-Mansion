...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 643 21 -59 run function 3ds_remake:room/hidden/tea_room/drawer_2
