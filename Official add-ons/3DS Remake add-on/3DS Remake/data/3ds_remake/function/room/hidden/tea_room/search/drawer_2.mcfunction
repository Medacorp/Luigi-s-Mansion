...
execute unless score #tea_room_drawer_2 Searched matches 1 as @a if score #tea_room_drawer_2 SearcherID = @s ID run tag @s add searcher
...
execute unless score #tea_room_drawer_2 Searched matches 1 run tag @a remove searcher
