...
execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.clockwork_soldiers.green{health:0} positioned 687 120 -2 rotated -90 0 run function luigis_mansion:spawn_entities/portrait_ghost/clockwork_soldiers/green
...
execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.luigis_mansion.clockwork_soldiers.pink{health:0} positioned 687 120 17 rotated -90 0 run function luigis_mansion:spawn_entities/portrait_ghost/clockwork_soldiers/pink
