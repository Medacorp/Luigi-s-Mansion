data modify storage luigis_mansion:data entity set value {room:35,paths:"3ds_remake:room/hidden/hallway_9/purple_mouse_path"}
...
data modify storage luigis_mansion:data entity set value {room:35,paths:"3ds_remake:room/hidden/hallway_9/blue_mouse_path"}
