...
execute at @s[scores={LootTimer=300}] run function luigis_mansion:spawn_entities/item/poison_mushroom
...
execute at @s[scores={LootTimer=700}] run function luigis_mansion:spawn_entities/item/poison_mushroom
