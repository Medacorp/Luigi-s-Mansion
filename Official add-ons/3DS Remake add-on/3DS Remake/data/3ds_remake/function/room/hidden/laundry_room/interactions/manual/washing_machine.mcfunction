...
execute if entity @s[x=714.0,y=11,z=72.0,dx=1,dy=1,dz=2,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/laundry_room/search/boo_check/washing_machine