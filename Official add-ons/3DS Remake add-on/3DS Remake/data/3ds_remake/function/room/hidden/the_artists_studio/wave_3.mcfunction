...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.technical_data{blue_twirler_easel:1b} run function 3ds_remake:room/hidden/the_artists_studio/wave_4