...
execute unless block 742 21 -52 minecraft:redstone_lamp if data storage luigis_mansion:data current_state.current_data{boos:[{}],obtained_items:{boo_radar:1b}} run function 3ds_remake:room/hidden/guest_room/load_boos
