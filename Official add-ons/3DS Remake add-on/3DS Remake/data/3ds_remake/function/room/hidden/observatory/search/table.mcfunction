...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 641 21 -75.0 run function 3ds_remake:room/hidden/observatory/table
