...
execute if entity @s[scores={PositionIntX=692,PositionIntZ=-61..-57}] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~1 ~ ~"}
...
execute if entity @s[scores={PositionIntZ=-61,PositionIntX=689..692}] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~-1"}
