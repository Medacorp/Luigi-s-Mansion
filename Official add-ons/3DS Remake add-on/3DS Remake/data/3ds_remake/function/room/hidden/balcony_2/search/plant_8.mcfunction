...
execute unless score #balcony_2_plant_8 Searched matches 1 as @a if score #balcony_2_plant_8 SearcherID = @s ID run tag @s add searcher
execute unless score #balcony_2_plant_8 Searched matches 1 run function 3ds_remake:entities/furniture/loot_chance/p50
execute unless score #balcony_2_plant_8 Searched matches 1 run tag @a remove searcher
