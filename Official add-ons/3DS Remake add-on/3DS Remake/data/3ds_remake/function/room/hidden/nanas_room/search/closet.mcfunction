...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 661 20 -26 run function 3ds_remake:room/hidden/nanas_room/closet
