...
execute if data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.the_artists_studio{seen:0b} unless entity @s[tag=spectator] run function 3ds_remake:room/hidden/the_artists_studio/set_seen
