...
execute if data storage luigis_mansion:data current_state.current_data.rooms.observatory{seen:0b} unless entity @s[tag=spectator] run function 3ds_remake:room/hidden/observatory/set_seen
