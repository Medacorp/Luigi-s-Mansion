...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 751.0 20 9.0 run function 3ds_remake:room/hidden/foyer/chandelier
