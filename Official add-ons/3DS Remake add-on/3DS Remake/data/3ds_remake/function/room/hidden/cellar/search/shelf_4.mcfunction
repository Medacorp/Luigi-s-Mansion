...
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_vases_and_bags_2"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_vases_and_bags_2"}
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 unless data storage luigis_mansion:data current_state.luigis_mansion.current_data{money_spawned:["cellar_vases_and_bags_2"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.luigis_mansion.current_data.loot_collections.furniture.gold_bar
...
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 run function 3ds_remake:entities/furniture/loot_chance/health_dependent_1
...
execute unless score #cellar_shelf_4 Searched matches 1 run function 3ds_remake:entities/furniture/loot_chance/p50
