...
execute unless score #cellar_shelf_4 Searched matches 1 as @a if score #cellar_shelf_4 SearcherID = @s ID run tag @s add searcher
execute unless score #cellar_shelf_4 Searched matches 1 run function 3ds_remake:entities/furniture/loot_chance/p50
execute unless score #cellar_shelf_4 Searched matches 1 run tag @a remove searcher
execute unless data storage luigis_mansion:data furniture.loot positioned 743 3 -61 run function luigis_mansion:blocks/dust
execute if data storage luigis_mansion:data furniture.loot positioned 743 3 -60 run function luigis_mansion:spawn_furniture/room_clear_loot_dropper
