...
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cellar_vases_and_bags_2"]} run data modify storage luigis_mansion:data furniture.loot set value {name:"cellar_vases_and_bags_2"}
execute unless score #cellar_shelf_contents_vases_2 Searched matches 1 unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cellar_vases_and_bags_2"]} run data modify storage luigis_mansion:data furniture.loot.contents set from storage luigis_mansion:data current_state.current_data.loot_collections.furniture.gold_bar
