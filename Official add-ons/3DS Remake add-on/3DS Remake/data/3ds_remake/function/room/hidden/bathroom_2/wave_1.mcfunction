data modify storage luigis_mansion:data entity set value {room:43,room_search:{non_players:1b},scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.miss_petunia.scan"}'},affected_by:["ice"]}
