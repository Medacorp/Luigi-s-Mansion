function 3ds_remake:room/hidden/anteroom/turn_on_lights
...
execute unless entity @s[tag=toad] as @a[scores={Room=4}] run function luigis_mansion:other/music/set/force/lit_room
