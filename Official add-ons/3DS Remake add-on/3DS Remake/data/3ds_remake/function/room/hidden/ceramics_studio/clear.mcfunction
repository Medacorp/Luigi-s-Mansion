...
function 3ds_remake:room/hidden/ceramics_studio/load/room_clear_chest
execute unless entity @s[tag=toad] as @a[scores={Room=65}] run function luigis_mansion:other/music/set/force/light
