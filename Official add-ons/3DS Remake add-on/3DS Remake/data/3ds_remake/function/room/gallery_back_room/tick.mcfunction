...
execute as @e[tag=player,x=733,y=-1,z=-36,dx=11,dy=27,dz=15] unless entity @s[scores={Room=-11}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=733,y=-1,z=-36,dx=11,dy=27,dz=15] Room -11
