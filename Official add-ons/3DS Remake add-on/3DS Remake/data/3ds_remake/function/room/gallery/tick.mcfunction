...
execute if data storage luigis_mansion:data rooms.gallery{cleared:0b} unless data storage luigis_mansion:data dialogs[{room:-8}] run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"gallery/talk"},room:-8,progress:0}
execute if entity @e[tag=e_gadd,scores={Room=-8},tag=talk_this_tick] unless data storage luigis_mansion:data dialogs[{room:-8}] run data modify storage luigis_mansion:data dialogs append value {name:{namespace:"luigis_mansion",id:"gallery/repeat"},room:-8,progress:0}
