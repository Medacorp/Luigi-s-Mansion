...
execute as @a[x=744,y=-1,z=-41,dx=32,dy=29,dz=25] unless entity @s[x=746,y=-1,z=-31,dx=17,dy=5,dz=5] unless entity @s[x=733,y=-1,z=-36,dx=11,dy=27,dz=15] unless entity @s[scores={Room=-8}] run scoreboard players operation @s LastRoom = @s Room
execute as @a[x=744,y=-1,z=-41,dx=32,dy=29,dz=25] unless entity @s[x=746,y=-1,z=-31,dx=17,dy=5,dz=5] unless entity @s[x=733,y=-1,z=-36,dx=11,dy=27,dz=15] run scoreboard players set @s Room -8
