...
execute as @e[tag=player,x=746,y=-1,z=-31,dx=17,dy=5,dz=5] unless entity @s[scores={Room=-10}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=746,y=-1,z=-31,dx=17,dy=5,dz=5] Room -10
