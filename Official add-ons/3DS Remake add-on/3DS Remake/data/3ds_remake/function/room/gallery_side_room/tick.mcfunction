...
execute as @e[tag=player,x=765,y=-1,z=-60,dx=11,dy=16,dz=18] unless entity @s[scores={Room=-9}] run scoreboard players operation @s LastRoom = @s Room
scoreboard players set @e[tag=player,x=765,y=-1,z=-60,dx=11,dy=16,dz=18] Room -9
