...
execute if data storage luigis_mansion:data current_state.luigis_mansion.rooms.gallery{seen:0b} unless entity @s[tag=spectator] run function 3ds_remake:room/gallery_side_room/set_seen
