...
$execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.$(namespace).$(id){rank:-1b} run data modify storage 3ds_remake:data portrait_ghost set from storage 3ds_remake:data current_state.portrait_ghosts_defeated_in.$(namespace).$(id)
...
$execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.$(namespace).$(id){rank:-1b} run data modify storage 3ds_remake:data current_state.portrait_ghosts_defeated_in.$(namespace).$(id) set from storage 3ds_remake:data new_portrait_ghost
