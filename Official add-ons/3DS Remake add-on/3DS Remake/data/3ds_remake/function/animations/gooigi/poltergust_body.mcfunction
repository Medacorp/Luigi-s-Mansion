...
scoreboard players remove @s[tag=!riding_poltergust,tag=was_low_health,tag=!low_health] AnimationRotationZ 200
scoreboard players add @s[tag=!riding_poltergust,tag=!was_low_health,tag=low_health] AnimationRotationZ 200
