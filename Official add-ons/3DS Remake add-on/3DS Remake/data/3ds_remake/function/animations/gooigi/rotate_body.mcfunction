...
execute as @e[tag=gooigi,tag=idle,limit=1] run function luigis_mansion:entities/luigi/animation/set/none
scoreboard players set @e[tag=gooigi,scores={IdleTime=1..},limit=1] IdleTime 0
