...
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[-70.0f,-20.0f,0.01f]}}
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=1},tag=flipped_gravity] {Pose:{Head:[-70.0f,-20.0f,-180.0f]}}
...
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=15}] {Pose:{Head:[-70.0f,-20.0f,0.01f]}}
execute unless score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=15},tag=flipped_gravity] {Pose:{Head:[-70.0f,-20.0f,-180.0f]}}
execute if score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=15}] {Pose:{Head:[0.0f,0.0f,0.01f]}}
execute if score #mirrored Selected matches 1 run data merge entity @s[scores={AnimationProgress=15},tag=flipped_gravity] {Pose:{Head:[0.0f,0.0f,-180.0f]}}
