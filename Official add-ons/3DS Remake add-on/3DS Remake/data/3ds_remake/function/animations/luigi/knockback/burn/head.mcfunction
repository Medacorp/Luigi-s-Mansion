...
data modify entity @s[scores={AnimationProgress=41}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.hatless
data modify entity @s[scores={AnimationProgress=55}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.scared
