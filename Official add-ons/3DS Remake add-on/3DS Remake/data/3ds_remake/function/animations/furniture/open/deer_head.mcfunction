...
data modify entity @s[tag=dark_room,tag=!lit,nbt={ArmorItems:[{components:{"minecraft:custom_model_data":123}}]}] ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.open
