...
data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[-70.0f,0.0f,-15.01f]}}
execute store result score #temp Time run data get entity @s Pose.Head[0]
execute if entity @s[scores={AnimationProgress=3..10}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 1
execute if entity @s[scores={AnimationProgress=11..18}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 1
