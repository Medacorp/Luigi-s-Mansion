...
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=1..2}] ^ ^-0.01 ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=3..6}] ^ ^-0.01 ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=7..14}] ^ ^-0.02 ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=15..18}] ^ ^-0.01 ^-0.2
teleport @s[tag=!flipped_gravity,scores={AnimationProgress=19..24}] ^ ^-0.01 ^-0.2
teleport @s[tag=flipped_gravity,scores={AnimationProgress=1..2}] ^ ^0.01 ^-0.2
teleport @s[tag=flipped_gravity,scores={AnimationProgress=3..6}] ^ ^0.01 ^-0.2
teleport @s[tag=flipped_gravity,scores={AnimationProgress=7..14}] ^ ^0.02 ^-0.2
teleport @s[tag=flipped_gravity,scores={AnimationProgress=15..18}] ^ ^0.01 ^-0.2
