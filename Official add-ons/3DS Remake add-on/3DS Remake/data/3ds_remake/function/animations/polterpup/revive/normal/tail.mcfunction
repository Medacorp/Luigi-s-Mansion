...
scoreboard players add @s[scores={AnimationProgress=71..80}] AnimationRotationX 20
scoreboard players add @s[scores={AnimationProgress=331..340}] AnimationRotationX 90
scoreboard players remove @s[scores={AnimationProgress=81..85}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=86..95}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=96..105}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=106..115}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=116..125}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=126..135}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=136..145}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=146..155}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=156..165}] AnimationRotationY 20
scoreboard players add @s[scores={AnimationProgress=166..175}] AnimationRotationY 20
scoreboard players remove @s[scores={AnimationProgress=176..180}] AnimationRotationY 20
