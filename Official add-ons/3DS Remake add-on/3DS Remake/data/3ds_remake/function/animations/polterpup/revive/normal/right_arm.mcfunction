...
scoreboard players add @s[scores={AnimationProgress=6..10}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=81..85}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=86..95}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=96..105}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=106..115}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=116..125}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=126..135}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=136..140}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=186..190}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=191..195}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=196..200}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=251..255}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=256..260}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=261..265}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=301..305}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=306..315}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=316..325}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=326..335}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=336..340}] AnimationRotationX 50
