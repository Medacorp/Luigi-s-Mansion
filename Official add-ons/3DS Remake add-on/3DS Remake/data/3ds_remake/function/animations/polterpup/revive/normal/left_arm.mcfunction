...
scoreboard players add @s[scores={AnimationProgress=81..85}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=86..95}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=96..105}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=106..115}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=116..125}] AnimationRotationX 50
scoreboard players remove @s[scores={AnimationProgress=126..135}] AnimationRotationX 50
scoreboard players add @s[scores={AnimationProgress=136..140}] AnimationRotationX 50
