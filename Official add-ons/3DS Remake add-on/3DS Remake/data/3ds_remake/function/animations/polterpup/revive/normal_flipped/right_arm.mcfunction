...
execute if entity @s[scores={AnimationProgress=1..5}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=6..10}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=81..85}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=86..95}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=96..105}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=106..115}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=116..125}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=126..135}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=136..140}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=186..190}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=191..195}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=196..200}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=251..255}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=256..260}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=261..265}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=301..305}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=306..315}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=316..325}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=326..335}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=336..340}] run scoreboard players remove @s AnimationRotationX 50
