...
execute if entity @s[scores={AnimationProgress=81..85}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=86..95}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=96..105}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=106..115}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=116..125}] run scoreboard players add @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=126..135}] run scoreboard players remove @s AnimationRotationX 50
execute if entity @s[scores={AnimationProgress=136..140}] run scoreboard players add @s AnimationRotationX 50
