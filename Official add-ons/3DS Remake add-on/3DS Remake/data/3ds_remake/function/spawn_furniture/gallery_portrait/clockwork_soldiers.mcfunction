...
execute if data storage 3ds_remake:data current_state.selected_portraits{clockwork_soldiers:3b} as @e[tag=this_entity,limit=1] run data modify entity @s ArmorItems[3] merge from entity @s ArmorItems[3].components."minecraft:custom_data".model_data.platinum
