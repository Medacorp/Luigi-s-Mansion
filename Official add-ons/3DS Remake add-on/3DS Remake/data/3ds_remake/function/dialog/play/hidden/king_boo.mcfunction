...
execute if score #dialog Dialog matches 62..103 unless score #dialog Dialog matches 67..97 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] unless entity @s[tag=using_selection_menu,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu_skip
...
execute if score #dialog Dialog matches 371.. positioned 636 95 -18 run particle minecraft:dust{color:[1f,1f,1f],scale:1f} ~ ~ ~ 0 0 0 0 10
execute if score #dialog Dialog matches 371.. positioned 637 95 -18 run particle minecraft:dust{color:[1f,1f,1f],scale:1f} ~ ~ ~ 0 0 0 0 10
execute if score #dialog Dialog matches 371.. positioned 638 95 -18 run particle minecraft:dust{color:[1f,1f,1f],scale:1f} ~ ~ ~ 0 0 0 0 10
...
execute if score #dialog Dialog matches 431..470 as @a[tag=same_room,tag=!spectator] at @s facing 635 94 -18 positioned ^ ^ ^0.3 rotated as @s run function luigis_mansion:entities/player/set_position
execute if score #dialog Dialog matches 471..590 as @a[tag=same_room,tag=!spectator] at @s facing 635 94 -18 positioned ^ ^ ^0.5 rotated as @s run function luigis_mansion:entities/player/set_position
...
execute if score #dialog Dialog matches 531 as @a[tag=same_room] run function 3ds_remake:room/hidden/king_boo_battle/warp_to
