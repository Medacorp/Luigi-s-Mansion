...
execute if score #dialog Dialog matches 38..57 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 -18 run teleport @s[x=636.5,y=93,z=-17.5,distance=0.2..] ^ ^ ^0.1 ~ ~
...
execute if score #dialog Dialog matches 103..182 as @a[tag=painting_grabbing_player,limit=1] at @s facing 636 93 -18 run teleport @s[x=636.5,y=93,z=-17.5,distance=0.2..] ^ ^ ^0.05 ~ ~
execute if score #dialog Dialog matches 182..183 as @a[tag=painting_grabbing_player,limit=1] at @s run teleport @s 636 93 -18 90 0
...
execute if score #dialog Dialog matches 303..362 as @a[tag=same_room] at @s facing 653 93 -18 run teleport @s ~ ~ ~ ~ ~
...
execute if score #dialog Dialog matches 304..362 as @a[tag=same_room,tag=!painting_grabbing_player] at @s facing 653 93 -18 run teleport @s[x=653.5,y=93,z=-17.5,distance=0.2..] ^ ^ ^0.1 ~ ~
execute if score #dialog Dialog matches 363 run function 3ds_remake:room/hidden/end
