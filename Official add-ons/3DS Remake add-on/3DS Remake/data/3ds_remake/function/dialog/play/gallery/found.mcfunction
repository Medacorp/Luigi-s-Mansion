...
execute if score #dialog Dialog matches ..124 unless score #dialog Dialog matches 3..123 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu,tag=!using_selection_menu] run function luigis_mansion:selection_menu/dialog/original_menu
