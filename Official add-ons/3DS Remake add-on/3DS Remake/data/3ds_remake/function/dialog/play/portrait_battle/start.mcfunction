...
execute if score #dialog Dialog matches 1 if score #global_difficulty Selected matches 0 if data storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.peaceful.speed store result bossbar 3ds_remake:portrait_battle max run data get storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.peaceful.speed
execute if score #dialog Dialog matches 1 if score #global_difficulty Selected matches 1 if data storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.easy.speed store result bossbar 3ds_remake:portrait_battle max run data get storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.easy.speed
execute if score #dialog Dialog matches 1 if score #global_difficulty Selected matches 2 if data storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.normal.speed store result bossbar 3ds_remake:portrait_battle max run data get storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.normal.speed
execute if score #dialog Dialog matches 1 if score #global_difficulty Selected matches 3 if data storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.hard.speed store result bossbar 3ds_remake:portrait_battle max run data get storage luigis_mansion:data current_state.3ds_remake.loaded_mansion.high_scores.hard.speed
