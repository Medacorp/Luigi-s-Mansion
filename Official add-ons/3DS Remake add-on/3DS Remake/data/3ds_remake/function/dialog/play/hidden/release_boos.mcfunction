...
execute if score #dialog Dialog matches 140 as @e[tag=luigi,tag=same_room] positioned 685 10 -46 run function luigis_mansion:entities/luigi/animation/set/scare/bash_no_move
execute if score #dialog Dialog matches 140..440 run scoreboard players set @e[tag=luigi,tag=same_room,scores={AnimationProgress=30..}] AnimationProgress 29
