...
execute store result score #temp2 Money run data get storage luigis_mansion:data current_state.current_data.data_index
execute if score #temp Money matches 50.. if score #temp2 Money matches 0..1 if data storage 3ds_remake:data current_state.trophy.hard{task_6:0b} run function 3ds_remake:selection_menu/gallery_trophy/complete/hard/task_6
execute if score #temp Money matches 80.. if score #temp2 Money matches 0..1 if data storage 3ds_remake:data current_state.trophy.master{task_6:0b} run function 3ds_remake:selection_menu/gallery_trophy/complete/master/task_6
execute store result score #temp Money run data get storage luigis_mansion:data current_high_score.speed
execute if score #temp Money matches ..216000 if score #temp2 Money matches 0..1 if data storage 3ds_remake:data current_state.trophy.master{task_7:0b} run function 3ds_remake:selection_menu/gallery_trophy/complete/master/task_7
