...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[2] in minecraft:overworld run function 3ds_remake:items/game_boy_horror/map/find_room_for_boo
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[2] run function 3ds_remake:items/game_boy_horror/map/display/hidden/show_boo
...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[1] in minecraft:overworld run function 3ds_remake:items/game_boy_horror/map/find_room_for_boo
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[1] run function 3ds_remake:items/game_boy_horror/map/display/hidden/show_boo
...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[0] in minecraft:overworld run function 3ds_remake:items/game_boy_horror/map/find_room_for_boo
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[0] run function 3ds_remake:items/game_boy_horror/map/display/hidden/show_boo
