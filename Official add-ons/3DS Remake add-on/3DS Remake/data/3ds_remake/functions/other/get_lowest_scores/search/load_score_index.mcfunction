...
execute unless score #temp Money = #temp2 Money if data storage luigis_mansion:data current_state.high_scores[-1] run function 3ds_remake:other/get_lowest_scores/search/load_score_index