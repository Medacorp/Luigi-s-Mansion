...
data remove storage luigis_mansion:data update_data.new_ghosts
execute if data storage luigis_mansion:data update_data.boos[-1] run data modify storage luigis_mansion:data update_data.boos[] merge value {damage:{collision:5,attack:10}}
...
execute if data storage luigis_mansion:data money_spawned{anteroom_table_1:1b} run data modify storage luigis_mansion:data update_data.money_spawned append value "anteroom_nightstand_mounted_blue_vase_1"
execute if data storage luigis_mansion:data money_spawned{anteroom_table_2:1b} run data modify storage luigis_mansion:data update_data.money_spawned append value "anteroom_nightstand_mounted_blue_vase_2"
