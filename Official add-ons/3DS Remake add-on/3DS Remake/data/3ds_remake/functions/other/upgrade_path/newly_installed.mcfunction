...
execute if data storage luigis_mansion:data current_state.current_data{data_index:0} if data storage luigis_mansion:data current_state.current_data.portrait_ghosts.chauncey{health:0} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_3 set value 1b
execute if data storage luigis_mansion:data current_state.mansion_data[{data_index:0}] if data storage luigis_mansion:data current_state.mansion_data[{data_index:0}].portrait_ghosts.chauncey{health:0} run data modify storage 3ds_remake:data current_state.trophy.beginner.task_3 set value 1b
execute if data storage luigis_mansion:data current_state.ghosts_caught[0] run function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/gold_ghost
execute if data storage luigis_mansion:data current_state.new_ghosts_caught run data modify storage luigis_mansion:data current_state.ghosts_caught set from storage luigis_mansion:data current_state.new_ghosts_caught
data remove storage luigis_mansion:data current_state.new_ghosts_caught
...
execute if data storage luigis_mansion:data current_state.ghosts_caught[0] run function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/fake_door
execute if data storage luigis_mansion:data current_state.new_ghosts_caught run data modify storage luigis_mansion:data current_state.ghosts_caught set from storage luigis_mansion:data current_state.new_ghosts_caught
data remove storage luigis_mansion:data current_state.new_ghosts_caught
...
scoreboard players reset #temp Time
scoreboard players reset #temp Money
execute if data storage luigis_mansion:data current_state.ghosts_caught[0] run function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/speedy_spirit
execute if data storage luigis_mansion:data current_state.new_ghosts_caught run data modify storage luigis_mansion:data current_state.ghosts_caught set from storage luigis_mansion:data current_state.new_ghosts_caught
data remove storage luigis_mansion:data current_state.new_ghosts_caught
...
execute if data storage luigis_mansion:data saved_state.mansion_data[{data_index:0}] run data modify storage luigis_mansion:data saved_state.mansion_data[{data_index:0}].no_collect_animation append value "3ds_remake:super_mushroom"
execute if data storage luigis_mansion:data current_state.mansion_data[{data_index:0}] run data modify storage luigis_mansion:data current_state.mansion_data[{data_index:0}].no_collect_animation append value "3ds_remake:super_mushroom"
execute if data storage luigis_mansion:data current_state.current_data{data_index:0} run data modify storage luigis_mansion:data current_state.current_data.no_collect_animation append value "3ds_remake:super_mushroom"