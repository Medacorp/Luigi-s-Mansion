...
execute unless score #temp Time matches 1 run data modify storage 3ds_remake:data portrait_ghost append value {data_index:-1,mansion_type:-1,peaceful:{health:-1,speed:-1},easy:{health:-1,speed:-1},normal:{health:-1,speed:-1},hard:{health:-1,speed:-1}}
