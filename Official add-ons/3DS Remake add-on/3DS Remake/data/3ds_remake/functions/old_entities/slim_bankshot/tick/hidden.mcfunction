...
execute if entity @s[scores={Dialog=1}] run function 3ds_remake:old_entities/slim_bankshot/tick/hidden/path
...
execute if entity @s[scores={Dialog=21}] run function 3ds_remake:old_entities/slim_bankshot/tick/hidden/path
...
execute if entity @s[scores={Dialog=41}] run function 3ds_remake:old_entities/slim_bankshot/tick/hidden/path
