execute at @s[scores={Room=29},tag=!vanish] run function 3ds_remake:old_entities/bogmire/tick/intro/hidden
execute at @s[scores={Room=74},tag=!vanish] run function 3ds_remake:old_entities/bogmire/tick/fight/hidden
