execute if entity @s[type=minecraft:player] run function luigis_mansion:entities/player/memory/get with entity @s
...
#/to remove
execute store result storage luigis_mansion:data luigi.alive byte 1 unless entity @s[scores={Health=0},type=minecraft:player]
...
execute if entity @s[tag=using_selection_menu] if data storage luigis_mansion:data my_memory.selection_menu.inventory[{Inventory:[{tag:{luigis_mansion:{is_poltergust:1b}}}]}] run data modify storage luigis_mansion:data luigi.poltergust set from storage luigis_mansion:data my_memory.selection_menu.inventory[{tag:{luigis_mansion:{is_poltergust:1b}}}]
...
execute if entity @s[type=minecraft:player] run data modify storage luigis_mansion:data memory append from storage luigis_mansion:data my_memory
execute if entity @s[type=minecraft:player] run data remove storage luigis_mansion:data my_memory
...
execute if entity @s[tag=!freeze_animation,tag=!source_only] as @e[type=minecraft:armor_stand,tag=gooigi_model,tag=!source] at @e[tag=this_gooigi,tag=source,limit=1] run function 3ds_remake:animations/gooigi/main
