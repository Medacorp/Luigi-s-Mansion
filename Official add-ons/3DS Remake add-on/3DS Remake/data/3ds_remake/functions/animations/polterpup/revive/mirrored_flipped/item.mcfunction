...
data modify entity @s[scores={AnimationProgress=181..230}] Pos set from entity @s ArmorItems[3].tag.luigis_mansion.old_position.Pos
data modify entity @s[scores={AnimationProgress=181..230}] Rotation set from entity @s ArmorItems[3].tag.luigis_mansion.old_position.Rotation
...
data modify entity @s[scores={AnimationProgress=180..230}] ArmorItems[3].tag.luigis_mansion.old_position.Pos set from entity @s Pos
