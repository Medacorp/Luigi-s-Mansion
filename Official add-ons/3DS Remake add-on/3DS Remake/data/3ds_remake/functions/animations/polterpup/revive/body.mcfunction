execute if entity @s[tag=!flipped_gravity] if score #mirrored Selected matches 0 run function 3ds_remake:animations/polterpup/revive/normal/body
execute if entity @s[tag=flipped_gravity] if score #mirrored Selected matches 0 run function 3ds_remake:animations/polterpup/revive/normal_flipped/body
