execute if entity @s[tag=was_sneaking,tag=!was_swimming,tag=!riding_poltergust] unless entity @s[scores={Animation=-4}] unless entity @s[scores={Animation=-1},tag=!right_leg,tag=!left_leg] unless data storage luigis_mansion:data luigi{tags:["sneaking"]} run function 3ds_remake:animations/gooigi/reset_pose
execute if entity @s[tag=was_walking,tag=!was_swimming,tag=!riding_poltergust] unless entity @s[scores={Animation=-4}] unless entity @s[scores={Animation=-1},tag=!right_leg,tag=!left_leg] unless data storage luigis_mansion:data luigi{tags:["walking"]} run function 3ds_remake:animations/gooigi/reset_pose
execute if entity @s[tag=was_running,tag=!was_swimming,tag=!riding_poltergust] unless entity @s[scores={Animation=-4}] unless entity @s[scores={Animation=-1},tag=!right_leg,tag=!left_leg] unless data storage luigis_mansion:data luigi{tags:["running"]} run function 3ds_remake:animations/gooigi/reset_pose
execute if entity @s[tag=was_swimming] unless data storage luigis_mansion:data luigi{tags:["swimming"]} run function 3ds_remake:animations/gooigi/reset_pose
...
execute if entity @s[tag=!was_swimming] if data storage luigis_mansion:data luigi{tags:["swimming"]} run function 3ds_remake:animations/gooigi/reset_pose
execute if entity @s[tag=!was_riding_poltergust] if data storage luigis_mansion:data luigi{tags:["riding_poltergust"]} run function 3ds_remake:animations/gooigi/reset_pose
execute if entity @s[tag=was_riding_poltergust] unless data storage luigis_mansion:data luigi{tags:["riding_poltergust"]} run function 3ds_remake:animations/gooigi/reset_pose
execute store result score @s Animation run data get storage luigis_mansion:data luigi.animation
execute unless score @s PreviousAnimation = @s Animation run function 3ds_remake:animations/gooigi/reset_pose
...
execute if entity @s[scores={Animation=..-4}] run function 3ds_remake:animations/gooigi/in_knockback
execute if entity @s[scores={Animation=5..}] run function 3ds_remake:animations/gooigi/in_knockback
