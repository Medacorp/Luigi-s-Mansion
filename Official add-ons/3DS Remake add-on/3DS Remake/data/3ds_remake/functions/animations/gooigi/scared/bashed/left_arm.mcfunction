...
execute if entity @s[scores={IdleTime=-22,AnimationProgress=1..2},tag=moved] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
execute if entity @s[scores={IdleTime=-22,AnimationProgress=3..6},tag=moved] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={IdleTime=-22,AnimationProgress=7..8},tag=moved] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 4
