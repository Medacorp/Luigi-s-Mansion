...
data merge entity @s[scores={AnimationProgress=20}] {Pose:{Head:[70.0f,0.0f,0.01f]}}
data merge entity @s[scores={AnimationProgress=20},tag=flipped_gravity] {Pose:{Head:[70.0f,0.0f,-180.0f]}}
