...
teleport @s[scores={AnimationProgress=11},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.05 ~ ~ ~
teleport @s[scores={AnimationProgress=12},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.1 ~ ~ ~
teleport @s[scores={AnimationProgress=13},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.15 ~ ~ ~
teleport @s[scores={AnimationProgress=14},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.2 ~ ~ ~
teleport @s[scores={AnimationProgress=15},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.25 ~ ~ ~
teleport @s[scores={AnimationProgress=16},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.3 ~ ~ ~
teleport @s[scores={AnimationProgress=17},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.35 ~ ~ ~
teleport @s[scores={AnimationProgress=18},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.4 ~ ~ ~
teleport @s[scores={AnimationProgress=19},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.45 ~ ~ ~
teleport @s[scores={AnimationProgress=20..50},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.5 ~ ~ ~
...
teleport @s[scores={AnimationProgress=58},tag=flipped_gravity,nbt=!{Small:1b}] ~ ~0.1 ~ ~ ~
teleport @s[scores={AnimationProgress=59},tag=flipped_gravity,nbt=!{Small:1b}] ~ ~0.05 ~ ~ ~
teleport @s[scores={AnimationProgress=11},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.025 ~ ~ ~
teleport @s[scores={AnimationProgress=12},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.05 ~ ~ ~
teleport @s[scores={AnimationProgress=13},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.075 ~ ~ ~
teleport @s[scores={AnimationProgress=14},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.1 ~ ~ ~
teleport @s[scores={AnimationProgress=15},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.125 ~ ~ ~
teleport @s[scores={AnimationProgress=16},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.15 ~ ~ ~
teleport @s[scores={AnimationProgress=17},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.175 ~ ~ ~
teleport @s[scores={AnimationProgress=18},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.2 ~ ~ ~
teleport @s[scores={AnimationProgress=19},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.225 ~ ~ ~
teleport @s[scores={AnimationProgress=20..50},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.25 ~ ~ ~
...
execute if entity @s[scores={AnimationProgress=41..45}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 5
execute if entity @s[scores={AnimationProgress=46..55}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProgress=56..60}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 5
