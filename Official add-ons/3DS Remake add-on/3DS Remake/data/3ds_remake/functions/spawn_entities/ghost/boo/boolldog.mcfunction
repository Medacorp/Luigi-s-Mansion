data modify storage luigis_mansion:data entity merge value {id:"boolldog",name:'{"translate":"3ds_remake:entity.boolldog"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
