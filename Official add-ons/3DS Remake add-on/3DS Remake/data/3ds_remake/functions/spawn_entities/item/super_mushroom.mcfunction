summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"3ds_remake:item.super_mushroom"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"3ds_remake",id:"super_mushroom",particle_trail:"minecraft:dust 0.9 0.2 0.2 1",Unbreakable:1b,Damage:5,CustomModelData:32}}],Tags:["item","heart","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
