summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.heart"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{luigis_mansion:{entity:{namespace:"luigis_mansion",id:"item"},item:{namespace:"luigis_mansion",id:"heart"},physics_offset:1.4d,pick_up_range:0.7f,variant:100},Unbreakable:1b,Damage:5,CustomModelData:14}}],Tags:["item","generic","wall_bounce","keep_bouncing","random_turn_on_bounce","affected_by_vacuum","this_entity"],DisabledSlots:2039583}
