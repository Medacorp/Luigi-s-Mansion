summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.mansion_rank_portrait"}',Tags:["furniture","immobile","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":19,"minecraft:custom_model_data":-25,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"generic",model_data:{empty:{components:{"minecraft:custom_model_data":-25}},s_rank:{components:{"minecraft:custom_model_data":-24}},a_rank:{components:{"minecraft:custom_model_data":-23}},b_rank:{components:{"minecraft:custom_model_data":-22}},c_rank:{components:{"minecraft:custom_model_data":-21}},d_rank:{components:{"minecraft:custom_model_data":-20}},e_rank:{components:{"minecraft:custom_model_data":-19}},f_rank:{components:{"minecraft:custom_model_data":-18}},g_rank:{components:{"minecraft:custom_model_data":-17}},h_rank:{components:{"minecraft:custom_model_data":-16}}}}}}],Invisible:1b,DisabledSlots:2039583}
