summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"3ds_remake:furniture.gallery_chest"}',Tags:["furniture","generic","immobile","chest","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:-11}}],Invisible:1b,DisabledSlots:2039583}
