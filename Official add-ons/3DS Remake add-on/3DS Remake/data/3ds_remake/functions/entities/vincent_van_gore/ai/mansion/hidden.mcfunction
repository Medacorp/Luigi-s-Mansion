...
execute if entity @s[scores={Dialog=333}] at @e[tag=same_room,tag=!spectator,tag=player] positioned ^ ^ ^8 run tag @s[distance=..8] remove visible
...
execute if entity @s[scores={Dialog=332}] run function 3ds_remake:room/hidden/the_artists_studio/wave_2 
...
execute if entity @s[scores={Dialog=334..}] facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
...
data modify entity @s[scores={Dialog=140..271}] data.animation set value {namespace:"luigis_mansion",id:"talk"}
data modify entity @s[scores={Dialog=272..331}] data.animation set value {namespace:"luigis_mansion",id:"magic"}
data modify entity @s[scores={Dialog=334..645}] data.animation set value {namespace:"luigis_mansion",id:"talk"}
data modify entity @s[scores={Dialog=645..646}] data.animation set value {namespace:"luigis_mansion",id:"complain"}