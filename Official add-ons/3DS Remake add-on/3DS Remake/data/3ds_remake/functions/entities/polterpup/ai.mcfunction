...
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=81..90},tag=!flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~2 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=81..90},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~-2 ~
...
execute if score #mirrored Selected matches 1 at @s[scores={AnimationProgress=81..90},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~2 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=91..130},tag=!flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~-6 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=91..130},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~6 ~
...
execute if score #mirrored Selected matches 1 at @s[scores={AnimationProgress=91..130},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.1 ~-6 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=131..140},tag=!flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.05 ~-5 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=131..140},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.05 ~5 ~
...
execute if score #mirrored Selected matches 1 at @s[scores={AnimationProgress=131..140},tag=flipped_gravity] rotated ~ 0 run teleport @s ^ ^ ^0.05 ~-5 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=181..185},tag=!flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~18 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=181..185},tag=flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~-18 ~
...
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=191..195},tag=!flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~-36 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=191..195},tag=flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~36 ~
...
execute if score #mirrored Selected matches 1 at @s[scores={AnimationProgress=191..195},tag=flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~-36 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=255},tag=!flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~10 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=255},tag=flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~-10 ~
...
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=266},tag=!flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~-10 ~
execute if score #mirrored Selected matches 0 at @s[scores={AnimationProgress=266},tag=flipped_gravity] rotated ~ 0 run teleport @s ~ ~ ~ ~10 ~
