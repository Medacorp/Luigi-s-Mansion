execute if entity @s[scores={Room=8}] run function 3ds_remake:entities/gold_mouse/hidden/study
execute if entity @s[scores={Room=11..14}] run function 3ds_remake:entities/gold_mouse/hidden/hallway_3_hallway_6
