...
data modify storage luigis_mansion:data entity set value {mansion:{namespace:"3ds_remake",id:"hidden"},affected_by:["fire","ice"]}
...
execute if score @s Health matches 1.. run function 3ds_remake:entities/boolossus/ai/mansion/hidden/split_boo