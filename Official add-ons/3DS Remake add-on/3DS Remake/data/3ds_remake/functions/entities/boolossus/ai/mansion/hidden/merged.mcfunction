...
execute if entity @s[x=586.5,y=31,z=-4.5,distance=..4] run function 3ds_remake:entities/boolossus/ai/mansion/hidden/split_up
execute if entity @s[x=586.5,y=31,z=-33.5,distance=..4] run function 3ds_remake:entities/boolossus/ai/mansion/hidden/split_up
