...
execute if entity @s[scores={Dialog=1}] unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"bowser_head"}}},limit=1] run data modify storage luigis_mansion:data entity set value {damage:{},owner:0,mansion:{namespace:"3ds_remake",id:"hidden"},tags:["decapitate"]}
...
execute if entity @s[scores={Dialog=20}] unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},limit=1] run data modify storage luigis_mansion:data entity set value {mansion:{namespace:"3ds_remake",id:"hidden"}}
