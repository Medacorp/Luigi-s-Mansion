execute if data storage 3ds_remake:data current_state.trophy.master{task_1:0b} if data storage luigis_mansion:data current_state.ghosts_caught[0] run function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/total
...
function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/gold_ghost
...
scoreboard players reset #temp Time
function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/speedy_spirit
...
scoreboard players reset #temp Time
function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/gold_mouse
...
scoreboard players reset #temp Time
function 3ds_remake:selection_menu/gallery_trophy/get_count/ghost/fake_door
execute if score #temp Time matches 1.. if data storage 3ds_remake:data current_state.trophy.beginner{task_8:0b} run function 3ds_remake:selection_menu/gallery_trophy/complete/beginner/task_8
scoreboard players reset #temp Time