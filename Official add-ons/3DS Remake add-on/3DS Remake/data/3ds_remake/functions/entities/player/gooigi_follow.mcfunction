...
execute unless entity @s[scores={OpenMapTime=1..}] at @a[tag=follow_me,limit=1] unless entity @a[tag=follow_me,scores={Animation=13..16},limit=1] unless entity @a[tag=follow_me,scores={Animation=27..38},limit=1] run function 3ds_remake:entities/player/gooigi_follow_player
