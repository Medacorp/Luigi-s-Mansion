...
execute if entity @s[scores={Dialog=420}] run function luigis_mansion:entities/player/memory/get with entity @s
...
tag @s[scores={Dialog=420}] add revive_animation
