execute if entity @s[scores={Room=3}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/parlor
execute if entity @s[scores={Room=4}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/anteroom
execute if entity @s[scores={Room=5}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/wardrobe_room
...
execute if entity @s[scores={Room=32}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/rec_room
execute if entity @s[scores={Room=34}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/tea_room
execute if entity @s[scores={Room=42}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/washroom_2
execute if entity @s[scores={Room=43}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/bathroom_2
execute if entity @s[scores={Room=44}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/nanas_room
execute if entity @s[scores={Room=45}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/astral_hall
execute if entity @s[scores={Room=47}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/billiards_room
execute if entity @s[scores={Room=48}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/projection_room
execute if entity @s[scores={Room=49}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/the_twins_room
execute if entity @s[scores={Room=50}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/safari_room
execute if entity @s[scores={Room=56}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/telephone_room
execute if entity @s[scores={Room=57}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/breaker_room
...
execute if entity @s[scores={Room=70}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/guest_room
execute if entity @s[scores={Room=71}] run function 3ds_remake:entities/hidden_boo/swap_spot/hidden/the_artists_studio