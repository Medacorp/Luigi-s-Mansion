...
execute if score #dialog Dialog matches 70..90 run function 3ds_remake:dialog/play/hidden/blackout_lightning/particles
execute if score #dialog Dialog matches 110..130 run function 3ds_remake:dialog/play/hidden/blackout_lightning/particles
execute if score #dialog Dialog matches 150..180 run function 3ds_remake:dialog/play/hidden/blackout_lightning/particles
execute if score #dialog Dialog matches 70 run function 3ds_remake:dialog/play/hidden/blackout_lightning/sound
execute if score #dialog Dialog matches 110 run function 3ds_remake:dialog/play/hidden/blackout_lightning/sound
