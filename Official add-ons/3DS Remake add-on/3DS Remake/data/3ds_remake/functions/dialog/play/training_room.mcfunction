execute if score #dialog Dialog matches 395 run scoreboard players add #dialog Dialog 1
...
execute if score #dialog Dialog matches 118..119 unless entity @e[tag=ghost,tag=same_room,limit=1] run scoreboard players add #dialog Dialog 1
...
execute if score #dialog Dialog matches 396 if entity @a[tag=same_room,tag=next_dialog_line,limit=1] run scoreboard players set #dialog Dialog 109
...
tag @e[tag=same_room,limit=1] remove no_ai
scoreboard players set @a[tag=same_room] ForceScreen 1
execute if score #dialog Dialog matches 1..3 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/game_boy_horror
...
execute if score #dialog Dialog matches 4 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 104..112 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 113 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
...
execute if score #dialog Dialog matches 115..116 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
execute if score #dialog Dialog matches 115 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.training_room.11"}]}
...
execute if score #dialog Dialog matches 117 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 117..118 unless entity @e[tag=ghost,tag=same_room,limit=1] unless score #training_room TrainingRoomScore matches 1 run function luigis_mansion:room/training_room/spawn_1_ghost
#118: ghosts

execute if score #dialog Dialog matches 119..121 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 122 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 122 run function luigis_mansion:room/training_room/spawn_1_ghost

#123: ghosts

execute if score #dialog Dialog matches 124..125 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 126 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 126 run function luigis_mansion:room/training_room/spawn_2_ghosts

#127: ghosts

execute if score #dialog Dialog matches 128..129 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 130 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 130 run function luigis_mansion:room/training_room/spawn_2_ghosts

#131: ghosts

execute if score #dialog Dialog matches 132..133 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 132 if score #training_room TrainingRoomScore matches ..2 f score #players Totals matches 2.. run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"3ds_remake:dialog.training_room.16.bad.more"}]}
...
execute if score #dialog Dialog matches 134 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
execute if score #dialog Dialog matches 134 run function luigis_mansion:room/training_room/spawn_5_ghosts

#135: ghosts

execute if score #dialog Dialog matches ..136 if score #training_room TrainingRoomScore matches 3.. run function 3ds_remake:room/gallery/clear_task/beginner/task_7
execute if score #dialog Dialog matches ..136 if score #training_room TrainingRoomScore matches 10 run function 3ds_remake:room/gallery/clear_task/easy/task_7
execute if score #dialog Dialog matches 136..160 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 160 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
...
execute if score #dialog Dialog matches 160 if score #training_room TrainingRoomScore matches 1.. run summon minecraft:firework_rocket 788 80 -8 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 165 if score #training_room TrainingRoomScore matches 1.. run summon minecraft:firework_rocket 788 80 -4 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 170 if score #training_room TrainingRoomScore matches 1.. run summon minecraft:firework_rocket 788 80 -12 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 175 if score #training_room TrainingRoomScore matches 5.. run summon minecraft:firework_rocket 788 81 -10 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14853494],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 180 if score #training_room TrainingRoomScore matches 5.. run summon minecraft:firework_rocket 788 81 -6 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14853494],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 185 if score #training_room TrainingRoomScore matches 9.. run summon minecraft:firework_rocket 788 80 -8 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 190 if score #training_room TrainingRoomScore matches 9.. run summon minecraft:firework_rocket 788 80 -4 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 195 if score #training_room TrainingRoomScore matches 9.. run summon minecraft:firework_rocket 788 80 -12 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 200 if score #training_room TrainingRoomScore matches 9.. run summon minecraft:firework_rocket 788 81 -10 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 205 if score #training_room TrainingRoomScore matches 9.. run summon minecraft:firework_rocket 788 81 -6 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
...
execute if score #dialog Dialog matches 390..392 if data storage luigis_mansion:data rooms.training_room{cleared:0b} as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/idle
...
execute if score #dialog Dialog matches 393 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
...
execute if score #dialog Dialog matches 394.. as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/game_boy_horror
