...
execute if score #dialog Dialog matches 1..139 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/high_health_idle_no_sound
...
execute if score #dialog Dialog matches 1 run function 3ds_remake:room/hidden/storage_room/open_hatch
execute if score #dialog Dialog matches 140.. positioned 685 10 -46 rotated -180 -90 run function 3ds_remake:dialog/play/hidden/release_boos_spawn
execute if score #dialog Dialog matches 140 as @a[tag=same_room] positioned 685 10 -46 run function luigis_mansion:entities/player/animation/set/scare/bash_no_move
execute if score #dialog Dialog matches 140..440 run scoreboard players set @a[tag=same_room,scores={AnimationProgress=31..}] AnimationProgress 30
...
execute if score #dialog Dialog matches 460 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/sigh
execute if score #dialog Dialog matches 480 as @a[tag=same_room,tag=!spectator,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/none
