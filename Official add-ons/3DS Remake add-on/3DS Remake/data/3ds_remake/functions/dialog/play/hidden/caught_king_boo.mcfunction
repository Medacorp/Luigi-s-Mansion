...
execute if score #dialog Dialog matches 97..176 run tag @a[tag=same_room,x=636.5,y=93,z=-17.5,distance=0.2..] add walking
...
execute if score #dialog Dialog matches 357 run function 3ds_remake:room/hidden/end
