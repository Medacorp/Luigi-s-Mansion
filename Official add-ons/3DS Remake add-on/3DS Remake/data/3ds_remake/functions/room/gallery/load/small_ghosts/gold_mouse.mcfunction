...
execute if score #temp Time matches 1.. run summon minecraft:armor_stand 764 2.2 -45.0 {Marker:1b,Rotation:[-45.0f,0.0f],Small:1b,CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.gold_mouse"}',Invisible:1b,NoGravity:1b,CustomNameVisible:0b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:13,display:{color:16759040}}}],Pose:{Head:[0.01f,0.0f,0.0f]},DisabledSlots:2039583}
