...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 669 103 41 run function 3ds_remake:room/hidden/graveyard/rain_pipe
