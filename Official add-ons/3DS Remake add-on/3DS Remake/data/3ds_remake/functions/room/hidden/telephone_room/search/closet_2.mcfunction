...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 742.0 29 3 run function 3ds_remake:room/hidden/telephone_room/closet_2
