...
execute if entity @s[x=655.0,y=2,z=-21.0,dx=4,dy=7,dz=7,tag=!spectator] unless score #temp Boos matches 40.. unless entity @e[nbt={data:{entity:{namespace:"luigis_mansion",id:"king_boo"}}},scores={Room=61},limit=1] run data modify storage luigis_mansion:data entity set value {room:61,mansion:{namespace:"3ds_remake",id:"hidden"},show_health:0b}
