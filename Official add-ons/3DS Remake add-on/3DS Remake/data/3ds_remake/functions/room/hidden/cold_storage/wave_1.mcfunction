...
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["cold_storage_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:68,loot:{name:"cold_Storage_speedy_spirit"},spawn:3b}
