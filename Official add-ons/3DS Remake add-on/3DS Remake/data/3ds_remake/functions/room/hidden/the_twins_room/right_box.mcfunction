...
execute unless entity @e[tag=orville,limit=1] run data modify storage luigis_mansion:data entity set value {scan_message:{sender:"me",message:'{"translate":"3ds_remake:message.orville.scan"}'}}
