...
execute if score #storage_room_bucket Searching matches 20 run function 3ds_remake:room/hidden/storage_room/search/boo_check/bucket
...
execute unless block 681 11 -55 minecraft:hopper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/storage_room/search/boo_check/bucket