...
execute if score #butlers_room_bucket Searching matches 20 run function 3ds_remake:room/hidden/butlers_room/search/boo_check/bucket
...
execute unless block 749 11 71 minecraft:hopper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/butlers_room/search/boo_check/bucket