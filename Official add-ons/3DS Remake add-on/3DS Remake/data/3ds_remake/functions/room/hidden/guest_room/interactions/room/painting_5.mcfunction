...
execute if block 742 21 -52 minecraft:redstone_lamp if score #guest_room_painting_5 Searching matches 20 run function 3ds_remake:room/hidden/guest_room/search/painting_5_flipped
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_painting_5 Searching matches 20 run function 3ds_remake:room/hidden/guest_room/search/boo_check/painting_5
