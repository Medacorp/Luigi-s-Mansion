data modify storage luigis_mansion:data entity set value {room:42}
execute positioned 664 20 44 run function luigis_mansion:spawn_entities/ghost/empty_marker
execute unless data storage luigis_mansion:data current_state.current_data{money_spawned:["washroom_2_speedy_spirit"]} run data modify storage luigis_mansion:data entity set value {room:42,loot:{name:"washroom_2_speedy_spirit"},tags:["hiding_in_furniture"]}
