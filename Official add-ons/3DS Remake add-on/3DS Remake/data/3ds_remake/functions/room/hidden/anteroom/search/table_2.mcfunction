...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 685 22 33.0 run function 3ds_remake:room/hidden/anteroom/table_2
