data modify storage luigis_mansion:data entity set value {room:10,mansion:{namespace:"3ds_remake",id:"hidden"},scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.chauncey.scan.1"}'}}
