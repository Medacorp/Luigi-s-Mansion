...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 702 29 67 run function 3ds_remake:room/hidden/ceramics_studio/jar_5
