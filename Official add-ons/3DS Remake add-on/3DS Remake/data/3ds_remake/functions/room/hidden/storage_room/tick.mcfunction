...
execute as @e[x=679,y=8,z=-70,dx=12,dy=9,dz=33] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 18
...
function #3ds_remake:room/hidden/storage_room/interactions/room
...
execute if entity @a[tag=exact_same_room,limit=1] run function 3ds_remake:room/hidden/storage_room/ghosts
