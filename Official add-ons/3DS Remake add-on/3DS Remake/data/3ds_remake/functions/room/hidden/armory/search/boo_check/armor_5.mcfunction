...
execute if block 753 33 62 minecraft:andesite as @a[x=754.5,y=29,z=61.5,distance=..1,gamemode=!spectator] positioned 754.0 29 62.0 run function luigis_mansion:entities/player/take_damage
