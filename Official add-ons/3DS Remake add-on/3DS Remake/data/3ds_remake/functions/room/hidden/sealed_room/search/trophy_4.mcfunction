...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 708 24 -85 run function 3ds_remake:room/hidden/sealed_room/trophy_4
