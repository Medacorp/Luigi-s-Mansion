data modify storage luigis_mansion:data furniture set value {searchable:["interact","vacuum"],shake_animation:["interact","vacuum"],sound:{namespace:"luigis_mansion",id:"metal"},scan_message:'{"translate":"luigis_mansion:message.player.scan_furniture.78"}'}
...
execute positioned 698 2 -4 rotated -135 0 run function luigis_mansion:spawn_furniture/metal_bucket