...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 709 29 70 run function 3ds_remake:room/hidden/ceramics_studio/jar_4
