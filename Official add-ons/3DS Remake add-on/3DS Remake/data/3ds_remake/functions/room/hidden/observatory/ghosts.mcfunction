execute if score #observatory Wave matches 2.. unless entity @e[tag=ghost,tag=!optional_ghost,scores={Room=46}] run function 3ds_remake:room/hidden/observatory/wave_2
