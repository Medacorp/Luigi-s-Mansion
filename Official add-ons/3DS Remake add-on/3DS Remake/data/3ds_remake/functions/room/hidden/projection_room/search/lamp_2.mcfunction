...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 681 15 35 run function 3ds_remake:room/hidden/projection_room/lamp_2
