...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 646 104 7 run function 3ds_remake:room/hidden/courtyard/plant_3
