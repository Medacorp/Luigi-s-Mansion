...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 744 21 -61 run function 3ds_remake:room/hidden/guest_room/table_2
