...
execute if data storage luigis_mansion:data current_state.current_data.rooms.conservatory{seen:0b} unless entity @s[tag=spectator] run function 3ds_remake:room/hidden/conservatory/set_seen

execute unless entity @s[tag=!wall_warp,tag=!spectator] if entity @s[tag=!already_ticked] run function 3ds_remake:room/hidden/conservatory/wall_warp
