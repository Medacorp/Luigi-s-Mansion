...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 649 105 -21 run function 3ds_remake:room/hidden/courtyard/statue_2
