...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 663 20 -75 run function 3ds_remake:room/hidden/astral_hall/table_1
