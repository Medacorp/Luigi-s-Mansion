...
execute if entity @s[x=744.0,y=11,z=70.0,dx=2,dy=1,dz=1,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/butlers_room/search/boo_check/ironing_table