...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 708 29 73 run function 3ds_remake:room/hidden/ceramics_studio/jar_2
