...
execute if score #graveyard Wave matches 4 if entity @a[gamemode=!spectator,x=651.5,y=103,z=47.5,distance=..4] run function 3ds_remake:room/hidden/graveyard/wave_5
