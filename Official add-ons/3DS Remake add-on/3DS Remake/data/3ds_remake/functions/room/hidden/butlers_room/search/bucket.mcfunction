...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 749 12 71 run function 3ds_remake:room/hidden/butlers_room/bucket
