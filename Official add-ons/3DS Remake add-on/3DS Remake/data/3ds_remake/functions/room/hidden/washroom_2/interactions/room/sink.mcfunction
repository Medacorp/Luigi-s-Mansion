...
execute if score #washroom_2_sink Searching matches 20 run function 3ds_remake:room/hidden/washroom_2/search/boo_check/sink
...
execute unless block 662 20 40 minecraft:dropper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/washroom_2/search/boo_check/sink