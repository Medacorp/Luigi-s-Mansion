...
execute if score #sitting_room_table_1 Searching matches 20 run function 3ds_remake:room/hidden/sitting_room/search/boo_check/table_1
...
execute unless block 746 21 -21 minecraft:hopper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/sitting_room/search/boo_check/table_1