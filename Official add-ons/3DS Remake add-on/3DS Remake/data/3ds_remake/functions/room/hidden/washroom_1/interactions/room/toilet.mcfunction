...
execute if score #washroom_1_toilet Searching matches 20 run function 3ds_remake:room/hidden/washroom_1/search/boo_check/toilet
...
execute unless block 664 11 44 minecraft:dropper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/washroom_1/search/boo_check/toilet