...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 747.0 21.5 48.0 run function 3ds_remake:room/hidden/the_twins_room/table_2
