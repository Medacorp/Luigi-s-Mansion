...
execute if entity @s[x=696.5,y=114,z=38.5,distance=..0.7,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/master_bedroom/search/boo_check/painting_5