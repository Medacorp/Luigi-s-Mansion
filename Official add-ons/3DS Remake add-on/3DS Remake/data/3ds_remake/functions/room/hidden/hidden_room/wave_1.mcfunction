data modify storage luigis_mansion:data entity set value {room:24,attack_type:"spin",spawn:3b}
execute positioned 744.0 11 46 run function luigis_mansion:spawn_entities/ghost/ghost_guy/green
data modify storage luigis_mansion:data entity set value {room:24,spawn:3b}
