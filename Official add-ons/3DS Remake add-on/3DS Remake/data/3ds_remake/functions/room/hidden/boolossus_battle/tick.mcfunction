...
execute as @e[x=562,y=14,z=-63,dx=48,dy=78,dz=87] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 75
...
execute if entity @a[tag=!pause_dialog,scores={Room=75},tag=!spectator,limit=1] run function 3ds_remake:room/hidden/boolossus_battle/ghosts