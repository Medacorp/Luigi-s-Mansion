...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 704 29 73 run function 3ds_remake:room/hidden/ceramics_studio/jar_1
