...
execute as @a[x=712,y=-1,z=-63,dx=8,dy=18,dz=21] unless entity @s[scores={Room=15}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=712,y=-1,z=-63,dx=8,dy=18,dz=21] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 15
...
execute if entity @a[tag=same_room,limit=1] run function 3ds_remake:room/hidden/hallway_7/ghosts
