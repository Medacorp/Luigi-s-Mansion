...
execute as @a[x=679,y=17,z=-30,dx=6,dy=9,dz=42] unless entity @s[scores={Room=35}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=679,y=17,z=-30,dx=6,dy=9,dz=42] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 35
