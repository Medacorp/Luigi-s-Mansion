...
execute if score #kitchen_oven Searched matches 1.. if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 701 11 75.0 run function 3ds_remake:room/hidden/kitchen/oven
