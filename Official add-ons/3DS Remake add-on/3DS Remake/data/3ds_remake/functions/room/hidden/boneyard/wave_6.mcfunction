data modify storage luigis_mansion:data entity set value {room:28,spawn:1b}
execute positioned 674 102 44 run function luigis_mansion:spawn_entities/ghost/mr_bones
