...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 702 29 64 run function 3ds_remake:room/hidden/ceramics_studio/jar_7
