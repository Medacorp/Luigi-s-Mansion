...
execute if score #butlers_room_hole Searched matches 1 as @a[x=742.5,y=11,z=55.5,distance=..0.7] run function 3ds_remake:room/hidden/butlers_room/go_through_hole