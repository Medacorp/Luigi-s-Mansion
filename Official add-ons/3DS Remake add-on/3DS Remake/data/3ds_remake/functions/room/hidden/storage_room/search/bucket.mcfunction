...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 681 12 -55 run function 3ds_remake:room/hidden/storage_room/bucket
