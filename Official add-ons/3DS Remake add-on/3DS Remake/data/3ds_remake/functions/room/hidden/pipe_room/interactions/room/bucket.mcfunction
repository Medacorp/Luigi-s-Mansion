...
execute if score #pipe_room_bucket Searching matches 20 run function 3ds_remake:room/hidden/pipe_room/search/boo_check/bucket
...
execute unless block 698 2 -4 minecraft:hopper{LootTable:"luigis_mansion:search"} run function 3ds_remake:room/hidden/pipe_room/search/boo_check/bucket