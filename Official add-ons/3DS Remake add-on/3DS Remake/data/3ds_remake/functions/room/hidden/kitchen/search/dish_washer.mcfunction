...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 701 11 85.0 run function 3ds_remake:room/hidden/kitchen/dish_washer
