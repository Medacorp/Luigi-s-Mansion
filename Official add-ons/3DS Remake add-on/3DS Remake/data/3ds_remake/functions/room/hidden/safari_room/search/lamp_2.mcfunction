...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 739 33 -48 run function 3ds_remake:room/hidden/safari_room/lamp_2
