...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 643 12 -33 run function 3ds_remake:room/hidden/rec_room/threadmill
