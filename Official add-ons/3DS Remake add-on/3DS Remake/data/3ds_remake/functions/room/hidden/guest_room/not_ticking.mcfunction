...
execute as @e[scores={Room=70},tag=ghost,tag=!portrait_ghost,nbt=!{ArmorItems:[{tag:{namespace:"luigis_mansion",id:"boo"}}]}] run function luigis_mansion:entities/ghost/non_ticking_room
...
scoreboard players set @e[scores={Room=70},nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"sue_pea"}}]}] Dialog 176