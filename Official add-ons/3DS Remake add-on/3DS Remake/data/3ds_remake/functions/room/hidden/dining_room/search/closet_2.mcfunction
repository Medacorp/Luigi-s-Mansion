...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 700 12 34 run function 3ds_remake:room/hidden/dining_room/closet_2
