...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 714 12 61 run function 3ds_remake:room/hidden/laundry_room/bucket
