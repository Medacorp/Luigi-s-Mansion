...
execute if block 742 21 -52 minecraft:redstone_lamp if entity @s[x=744.5,y=26,z=-60.5,distance=..0.7,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/guest_room/search/table_2_flipped
...
execute unless block 742 21 -52 minecraft:redstone_lamp if entity @s[x=744.5,y=20,z=-60.5,distance=..0.7,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/guest_room/search/boo_check/table_2