...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 746 14 47 run function 3ds_remake:room/hidden/hidden_room/trophy_1
