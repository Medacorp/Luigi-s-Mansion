...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 683 12 88 run function 3ds_remake:room/hidden/billiards_room/table_2
