...
scoreboard players set @e[x=736,y=28,z=0,dx=24,dy=7,dz=35] Room 56
...
execute if entity @a[tag=!pause_dialog,scores={Room=56},tag=!spectator,limit=1] run function 3ds_remake:room/hidden/telephone_room/ghosts