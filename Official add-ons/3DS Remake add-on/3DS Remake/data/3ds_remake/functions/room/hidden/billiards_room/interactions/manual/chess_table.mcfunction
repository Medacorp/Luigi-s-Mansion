...
execute if entity @s[x=685.5,y=11,z=67.5,distance=..0.7,tag=!sound,tag=!check] run function 3ds_remake:room/hidden/billiards_room/search/boo_check/chess_table