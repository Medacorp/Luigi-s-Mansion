...
execute if block 757 33 73 minecraft:andesite run data modify storage luigis_mansion:data damage set value {method:"luigis_mansion:mace",amount:10,knockback:"large",no_delete:1b}
execute if block 757 33 73 minecraft:andesite as @a[x=758.5,y=29,z=72.5,distance=..1,gamemode=!spectator] positioned 758.0 29 73.0 run function luigis_mansion:entities/player/take_damage
...
execute unless entity @e[x=757.5,y=29,z=72.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function 3ds_remake:room/hidden/armory/search/armor_1
