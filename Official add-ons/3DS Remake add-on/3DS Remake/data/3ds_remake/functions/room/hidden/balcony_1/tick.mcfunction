...
execute if entity @a[gamemode=!spectator,tag=!pull_open_door,tag=!push_open_door,scores={Room=6},limit=1] run function 3ds_remake:room/hidden/balcony_1/ghosts