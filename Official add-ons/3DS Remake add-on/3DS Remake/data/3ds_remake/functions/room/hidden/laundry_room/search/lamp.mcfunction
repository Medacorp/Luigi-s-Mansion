...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 716 15 67 run function 3ds_remake:room/hidden/laundry_room/lamp
