execute unless data storage luigis_mansion:data current_state.current_data{data_version:2} run function luigis_mansion_3ds_remake:other/upgrade_path/current_data/v1.4
data modify storage luigis_mansion:data current_state.current_data merge value {ghosts:{fake_door:{health:750,loot:{}}}}
