...
tag @s[scores={IdleTime=20..,Health=..15},tag=!high_health_idle,tag=!low_health_idle,tag=!cold_room_idle] add trigger_idle
...
tag @s[scores={IdleTime=20..,Health=16..},tag=cold_room,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] add trigger_idle
...
tag @s[scores={IdleTime=200..,Health=16..},tag=!cold_room,tag=!high_health_idle,tag=!low_health_idle,tag=!cold_room_idle] add trigger_idle
