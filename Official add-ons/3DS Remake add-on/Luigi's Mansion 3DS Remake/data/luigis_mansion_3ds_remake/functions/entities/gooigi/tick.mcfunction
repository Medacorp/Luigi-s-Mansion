...
execute if entity @s[tag=spawn_animation,scores={PositionX=1..}] run function luigis_mansion_3ds_remake:entities/gooigi/spawn_animation

execute if entity @s[scores={PositionX=1..}] run function luigis_mansion_3ds_remake:animations/gooigi
