...
tag @s remove me
execute if entity @s[scores={Time=1},tag=!ignore,tag=!reflected] run function luigis_mansion_3ds_remake:entities/weak_flashlight/set_light
execute if entity @s[scores={Time=1},tag=!ignore,tag=reflected] run function luigis_mansion_3ds_remake:entities/weak_flashlight/set_light_reflected
execute if entity @s[scores={Time=2},tag=!ignore,tag=!reflected] run function luigis_mansion_3ds_remake:entities/weak_flashlight/remove_light
execute if entity @s[scores={Time=2},tag=!ignore,tag=reflected] run function luigis_mansion_3ds_remake:entities/weak_flashlight/remove_light_reflected
tag @s remove ignore
