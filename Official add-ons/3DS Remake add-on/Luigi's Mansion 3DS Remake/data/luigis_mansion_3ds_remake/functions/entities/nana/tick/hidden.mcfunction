...
execute if entity @s[scores={Dialog=12}] if entity @e[tag=wool,tag=can_spit,limit=1] unless entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion_3ds_remake:entities/nana/tick/hidden/move
...
execute if entity @s[scores={Dialog=22}] if entity @e[tag=wool,tag=can_spit,limit=1] unless entity @e[tag=wool,tag=can_spit,limit=1,distance=..6] run function luigis_mansion_3ds_remake:entities/nana/tick/hidden/move
