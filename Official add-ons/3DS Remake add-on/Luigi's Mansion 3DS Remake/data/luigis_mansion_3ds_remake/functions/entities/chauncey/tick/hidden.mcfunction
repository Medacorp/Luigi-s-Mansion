execute if entity @s[tag=!fight,tag=!vanish] positioned ~ ~1 ~ run function luigis_mansion_3ds_remake:entities/chauncey/tick/nursery/hidden
execute if entity @s[tag=fight,tag=!vanish] run function luigis_mansion_3ds_remake:entities/chauncey/tick/fight/hidden
