...
execute if entity @e[tag=orville,tag=dialog,scores={Dialog=333}] run teleport @a 739 20 -29 -90 0
...
execute if entity @e[tag=orville,tag=dialog,scores={Dialog=333}] run function luigis_mansion:room/hidden/the_twins_room/wave_5