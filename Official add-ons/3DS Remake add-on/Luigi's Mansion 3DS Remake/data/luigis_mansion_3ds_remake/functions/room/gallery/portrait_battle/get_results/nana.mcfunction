...
execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.nana{rank:-1b} run data modify storage luigis_mansion_3ds_remake:data portrait_ghost set from storage luigis_mansion_3ds_remake:data current_state.portrait_ghosts_defeated_in.nana
...
execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.nana{rank:-1b} run data modify storage luigis_mansion_3ds_remake:data current_state.portrait_ghosts_defeated_in.nana set from storage luigis_mansion_3ds_remake:data new_portrait_ghost
