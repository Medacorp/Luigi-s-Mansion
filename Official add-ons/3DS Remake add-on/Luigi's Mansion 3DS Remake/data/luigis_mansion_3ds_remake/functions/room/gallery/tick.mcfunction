...
execute as @e[tag=!spectator,x=733,y=-1,z=-60,dx=43,dy=27,dz=44] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -5
