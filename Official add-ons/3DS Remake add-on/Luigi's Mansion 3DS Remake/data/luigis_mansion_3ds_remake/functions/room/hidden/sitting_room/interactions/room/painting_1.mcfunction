...
execute if score #sitting_room_painting_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/sitting_room/search/boo_check/painting_1
