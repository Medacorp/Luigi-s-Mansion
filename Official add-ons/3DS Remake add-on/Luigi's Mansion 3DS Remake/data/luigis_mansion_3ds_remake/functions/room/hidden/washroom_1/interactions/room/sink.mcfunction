...
execute if score #washroom_1_sink Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/washroom_1/search/boo_check/sink
...
execute unless block 662 11 40 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/washroom_1/search/boo_check/sink