...
execute if entity @s[x=710.5,y=14,z=79.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/kitchen/search/boo_check/painting_2