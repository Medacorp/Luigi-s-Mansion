execute if block 738 20 40 minecraft:chest unless block 738 20 40 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/box_3
