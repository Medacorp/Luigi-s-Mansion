...
execute if score #master_bedroom_painting_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/search/boo_check/painting_2
