...
tag @e[x=663.5,y=11,z=-37.0,distance=..0.7,tag=door,tag=frame,limit=1] add hallway_5_hallway_8
...
execute unless data storage luigis_mansion:data current_state.current_data.technical_data{extinguished_hallway_8_fire:1b} run tag @e[x=661.0,y=20,z=-43.5,distance=..0.7,tag=door,tag=frame,limit=1] add burning
