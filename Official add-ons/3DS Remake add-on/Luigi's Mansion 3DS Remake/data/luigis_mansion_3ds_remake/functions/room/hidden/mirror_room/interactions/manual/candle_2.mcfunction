...
execute if entity @s[x=736.0,y=11,z=-61.0,dx=0,dy=2,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/mirror_room/search/boo_check/candle_2