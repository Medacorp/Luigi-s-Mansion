...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 691 124 16 run function luigis_mansion_3ds_remake:room/hidden/clockwork_room/lamp_1
