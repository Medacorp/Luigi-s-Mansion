...
execute if score #cellar_shelf_content_trophies_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/cellar/search/boo_check/shelf_3
