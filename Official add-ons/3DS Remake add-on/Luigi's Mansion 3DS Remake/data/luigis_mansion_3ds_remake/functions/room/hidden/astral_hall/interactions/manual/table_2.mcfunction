...
execute if entity @s[x=662.0,y=20,z=-90.0,dx=1,dy=2,dz=2,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/boo_check/table_2