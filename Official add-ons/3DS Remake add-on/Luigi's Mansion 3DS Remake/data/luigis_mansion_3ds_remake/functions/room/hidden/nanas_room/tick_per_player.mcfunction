...
execute if data storage luigis_mansion:data current_state.current_data.rooms.nanas_room{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/nanas_room/set_seen