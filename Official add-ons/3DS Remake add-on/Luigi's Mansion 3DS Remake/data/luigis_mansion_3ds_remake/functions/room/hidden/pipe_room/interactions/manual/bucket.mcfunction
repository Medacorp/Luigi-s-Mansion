...
execute if entity @s[x=698.5,y=2,z=-3.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/pipe_room/search/boo_check/bucket