...
execute if score #laundry_room_bucket Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/bucket
...
execute unless block 714 11 61 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/bucket