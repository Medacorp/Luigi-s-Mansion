...
execute if entity @s[x=644.0,y=13,z=-31.0,dx=2,dy=2,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/rec_room/search/boo_check/sword_2