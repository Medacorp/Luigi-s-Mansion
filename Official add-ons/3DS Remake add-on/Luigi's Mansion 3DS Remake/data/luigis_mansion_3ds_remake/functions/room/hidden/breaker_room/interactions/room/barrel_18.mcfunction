...
execute if score #breaker_room_barrel_18 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/breaker_room/search/boo_check/barrel_18
