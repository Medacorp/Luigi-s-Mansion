...
execute if entity @s[x=693.5,y=120,z=19.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/clockwork_room/search/boo_check/chair_1