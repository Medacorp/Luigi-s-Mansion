...
execute if entity @s[x=741.0,y=6,z=-61.0,dx=4,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/cellar/search/boo_check/shelf_6