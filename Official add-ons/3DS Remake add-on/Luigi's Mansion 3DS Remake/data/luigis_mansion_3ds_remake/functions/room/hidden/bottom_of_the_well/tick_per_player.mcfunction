...
execute if data storage luigis_mansion:data current_state.current_data.rooms.bottom_of_the_well{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/bottom_of_the_well/set_seen