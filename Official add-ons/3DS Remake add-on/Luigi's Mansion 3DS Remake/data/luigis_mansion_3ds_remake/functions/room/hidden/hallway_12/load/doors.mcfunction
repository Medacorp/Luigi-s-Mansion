...
tag @e[x=706.5,y=20,z=-21.0,distance=..0.7,tag=door,tag=frame,limit=1] add barricade
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=706.5,y=20,z=-16.0,distance=..0.7,tag=door,tag=frame,limit=1] add fake