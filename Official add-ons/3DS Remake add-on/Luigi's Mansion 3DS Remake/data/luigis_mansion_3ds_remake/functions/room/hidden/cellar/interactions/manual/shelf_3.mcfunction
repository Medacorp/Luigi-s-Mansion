...
execute if entity @s[x=742.0,y=6,z=-54.0,dx=0,dy=1,dz=4,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/cellar/search/boo_check/shelf_3