...
execute if entity @s[x=703.0,y=12,z=50.0,dx=2,dy=0,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/dining_room/search/boo_check/dishes_1