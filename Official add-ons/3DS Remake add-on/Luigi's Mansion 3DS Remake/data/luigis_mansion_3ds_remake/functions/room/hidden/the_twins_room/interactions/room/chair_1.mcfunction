...
execute if score #the_twins_room_chair_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/boo_check/chair_1
