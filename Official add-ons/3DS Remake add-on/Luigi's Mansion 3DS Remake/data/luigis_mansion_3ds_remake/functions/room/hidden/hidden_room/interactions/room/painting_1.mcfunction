...
execute if score #hidden_room_painting_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/hidden_room/search/boo_check/painting_1
