...
execute if data storage luigis_mansion:data current_state.current_data{blackout:0b} run execute if data storage luigis_mansion:data current_state.current_data{blackout:0b} run function #luigis_mansion_3ds_remake:room/hidden/observatory/turn_lights/on
