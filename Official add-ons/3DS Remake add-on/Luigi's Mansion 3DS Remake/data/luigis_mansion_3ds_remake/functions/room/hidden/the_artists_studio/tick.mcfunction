...
execute as @a[scores={Room=71}] run function luigis_mansion_3ds_remake:room/hidden/the_artists_studio/tick_per_player
...
execute as @e[x=697.0,y=26,z=-78.0,dx=5,dy=9,dz=21,tag=ghost,tag=hidden,y_rotation=-180..0] at @s run function luigis_mansion_3ds_remake:room/hidden/the_artists_studio/stay_near_painting
