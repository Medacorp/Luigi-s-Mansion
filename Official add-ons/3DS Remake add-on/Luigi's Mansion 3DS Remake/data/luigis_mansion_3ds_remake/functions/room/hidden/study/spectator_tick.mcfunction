execute unless entity @s[scores={Room=8}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.study"}
...
teleport @s[scores={HomeY=25,HomeZ=58..61,HomeX=702..705}] ~ ~-1 ~
teleport @s[scores={HomeY=25,HomeZ=58..61,HomeX=706..715}] ~-4 ~3 ~
