...
execute if entity @s[x=745.0,y=30,z=-46.0,dx=0,dy=3,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/safari_room/search/boo_check/mirror