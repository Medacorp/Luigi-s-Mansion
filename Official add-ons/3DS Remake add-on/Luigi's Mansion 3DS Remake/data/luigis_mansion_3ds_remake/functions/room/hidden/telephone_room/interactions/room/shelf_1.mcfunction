...
execute if score #telephone_room_shelf_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/telephone_room/search/boo_check/shelf_1
