...
execute if entity @s[x=699.0,y=11,z=68.0,dx=2,dy=3,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/kitchen/search/boo_check/fridge