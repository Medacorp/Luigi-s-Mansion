...
execute if entity @s[x=738.0,y=20,z=-31.0,dx=0,dy=0,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/sitting_room/search/boo_check/couch