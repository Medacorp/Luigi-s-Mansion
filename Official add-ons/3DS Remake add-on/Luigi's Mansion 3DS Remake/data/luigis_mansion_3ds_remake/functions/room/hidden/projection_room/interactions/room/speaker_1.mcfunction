...
execute if score #projection_room_speaker_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/projection_room/search/boo_check/speaker_1
