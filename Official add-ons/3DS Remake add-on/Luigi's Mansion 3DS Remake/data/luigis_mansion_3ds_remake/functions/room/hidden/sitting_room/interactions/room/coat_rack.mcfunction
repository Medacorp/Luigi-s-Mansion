...
execute if score #sitting_room_coat_rack Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/sitting_room/search/boo_check/coat_rack
