...
execute if data storage luigis_mansion:data current_state.current_data.rooms.cold_storage{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/cold_storage/set_seen