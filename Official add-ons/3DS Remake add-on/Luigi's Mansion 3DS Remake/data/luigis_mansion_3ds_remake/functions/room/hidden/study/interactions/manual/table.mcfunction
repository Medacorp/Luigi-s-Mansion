...
execute if entity @s[x=707.0,y=20,z=47.0,dx=1,dy=0,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/study/search/boo_check/table