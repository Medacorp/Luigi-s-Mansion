...
execute if score #billiards_room_chess_table Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/billiards_room/search/boo_check/chess_table
