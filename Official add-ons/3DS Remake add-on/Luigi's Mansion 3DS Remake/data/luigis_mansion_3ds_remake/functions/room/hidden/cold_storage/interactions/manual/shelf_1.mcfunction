...
execute if entity @s[x=734.0,y=4,z=10.0,dx=2,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/cold_storage/search/boo_check/shelf_1