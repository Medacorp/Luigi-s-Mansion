execute unless entity @s[scores={Room=47}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.billiards_room"}
scoreboard players set @s Room 47
scoreboard players set @s PrevRoom 47
