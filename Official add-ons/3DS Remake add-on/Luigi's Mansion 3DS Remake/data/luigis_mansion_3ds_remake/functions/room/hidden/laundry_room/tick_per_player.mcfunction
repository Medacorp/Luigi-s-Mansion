...
execute if data storage luigis_mansion:data current_state.current_data.rooms.laundry_room{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/laundry_room/set_seen