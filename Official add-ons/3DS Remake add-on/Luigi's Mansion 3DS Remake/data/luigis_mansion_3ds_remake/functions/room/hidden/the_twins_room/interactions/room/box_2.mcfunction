execute if block 747 20 43 minecraft:chest unless block 747 20 43 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/box_2
