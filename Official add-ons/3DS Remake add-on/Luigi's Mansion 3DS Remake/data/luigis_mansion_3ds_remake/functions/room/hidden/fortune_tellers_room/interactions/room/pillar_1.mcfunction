...
execute if score #fortune_tellers_room_pillar_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/pillar_1
