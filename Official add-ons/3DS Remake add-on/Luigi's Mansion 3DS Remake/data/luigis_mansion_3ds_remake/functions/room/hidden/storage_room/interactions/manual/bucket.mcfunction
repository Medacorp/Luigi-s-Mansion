...
execute if entity @s[x=681.5,y=11,z=-54.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/storage_room/search/boo_check/bucket