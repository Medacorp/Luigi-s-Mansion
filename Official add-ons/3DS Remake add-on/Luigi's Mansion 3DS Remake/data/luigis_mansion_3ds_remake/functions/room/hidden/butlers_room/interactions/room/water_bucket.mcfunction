...
execute if score #butlers_room_water_bucket Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/butlers_room/search/boo_check/water_bucket
...
execute unless block 747 11 55 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/butlers_room/search/boo_check/water_bucket