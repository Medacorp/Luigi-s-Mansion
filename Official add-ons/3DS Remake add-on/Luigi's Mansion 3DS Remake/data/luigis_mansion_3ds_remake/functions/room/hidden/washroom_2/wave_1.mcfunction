...
execute positioned 739 22 37 as @e[tag=speedy_spirit,distance=..0.7] run function luigis_mansion:entities/speedy_spirit/give_money/bills
execute positioned 739 22 37 as @e[tag=speedy_spirit,distance=..0.7] run data modify entity @s ArmorItems[3].tag.loot merge value {name:"washroom_2_speedy_spirit"}
