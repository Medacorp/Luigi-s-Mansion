...
execute if score #cold_storage_campfire_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/cold_storage/search/boo_check/campfire_1
