...
execute if entity @s[x=662.0,y=13,z=36.0,dx=1,dy=2,dz=2,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/washroom_1/search/boo_check/cabinet