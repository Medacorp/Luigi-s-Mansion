...
execute if entity @s[x=720.5,y=21,z=23.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/parlor/search/boo_check/candle_3