data modify storage luigis_mansion:data furniture set value {searchable:["hand"],loot:{contents:{luigis_mansion:{key:[{door:"hallway_18",variant:3b,rotation:[-180.0f,0.0f]}]}}}}
