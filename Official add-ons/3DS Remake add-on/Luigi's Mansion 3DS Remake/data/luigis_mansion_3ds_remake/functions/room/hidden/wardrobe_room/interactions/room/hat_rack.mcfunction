...
execute if score #wardrobe_room_hat_rack Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/wardrobe_room/search/boo_check/hat_rack
