...
execute if entity @s[x=749.0,y=11,z=60.0,dx=0,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/butlers_room/search/boo_check/sewing_machine