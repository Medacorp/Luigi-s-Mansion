...
execute if score #fortune_tellers_room_candle_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/candle_1
