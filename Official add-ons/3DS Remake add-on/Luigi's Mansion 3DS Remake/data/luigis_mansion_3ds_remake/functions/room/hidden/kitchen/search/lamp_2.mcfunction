...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 702 15 79 run function luigis_mansion_3ds_remake:room/hidden/kitchen/lamp_2
