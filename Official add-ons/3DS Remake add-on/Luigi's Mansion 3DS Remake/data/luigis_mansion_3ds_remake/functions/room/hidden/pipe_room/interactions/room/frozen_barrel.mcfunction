...
execute if score #pipe_room_frozen_barrel Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/pipe_room/search/boo_check/frozen_barrel
