...
execute if entity @s[x=708.0,y=20,z=56.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/study/search/boo_check/rocking_chair