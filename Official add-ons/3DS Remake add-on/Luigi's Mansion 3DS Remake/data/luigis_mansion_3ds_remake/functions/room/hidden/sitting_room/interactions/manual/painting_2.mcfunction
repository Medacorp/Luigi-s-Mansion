...
execute if entity @s[x=735.5,y=22,z=-25.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/sitting_room/search/boo_check/painting_2