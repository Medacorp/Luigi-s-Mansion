execute unless entity @a[scores={LastRoom=43},limit=1] run function #luigis_mansion_3ds_remake:room/hidden/bathroom_2/reset
...
function luigis_mansion_3ds_remake:room/hidden/bathroom_2/reset/curtain
