...
execute if score #projection_room_screen Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/projection_room/search/boo_check/screen
