...
execute if score #conservatory_painting_3 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/conservatory/search/boo_check/painting_3
