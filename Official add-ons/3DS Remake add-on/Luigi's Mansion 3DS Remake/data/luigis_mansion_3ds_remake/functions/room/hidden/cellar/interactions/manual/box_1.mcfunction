...
execute if entity @s[x=737.0,y=2,z=-45.0,dx=1,dy=2,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/cellar/search/boo_check/box_1