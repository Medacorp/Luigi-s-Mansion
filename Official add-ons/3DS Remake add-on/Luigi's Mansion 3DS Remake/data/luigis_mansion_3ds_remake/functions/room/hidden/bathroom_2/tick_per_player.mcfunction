...
execute if data storage luigis_mansion:data current_state.current_data.rooms.bathroom_2{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/bathroom_2/set_seen