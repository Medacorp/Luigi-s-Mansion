...
execute if score #wardrobe_room_painting_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/wardrobe_room/search/boo_check/painting_1
