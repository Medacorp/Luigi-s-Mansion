...
execute if entity @s[x=744.0,y=11,z=-24.0,dx=0,dy=4,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/pillar_1