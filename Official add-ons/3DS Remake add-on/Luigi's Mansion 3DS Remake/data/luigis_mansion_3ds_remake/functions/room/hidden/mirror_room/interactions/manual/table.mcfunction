...
execute if entity @s[x=740.0,y=11,z=-61.0,dx=1,dy=0,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/mirror_room/search/boo_check/table