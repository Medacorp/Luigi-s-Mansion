...
execute if score #clockwork_room_chair_5 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/clockwork_room/search/boo_check/chair_5
