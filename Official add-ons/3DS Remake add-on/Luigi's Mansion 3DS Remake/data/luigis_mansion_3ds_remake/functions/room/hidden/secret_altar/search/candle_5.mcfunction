...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 650 93 -28 run function luigis_mansion:blocks/dust_no_sound
