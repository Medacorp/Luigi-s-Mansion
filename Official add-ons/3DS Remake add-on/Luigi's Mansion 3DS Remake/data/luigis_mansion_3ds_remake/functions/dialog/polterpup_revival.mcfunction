...
execute if entity @s[scores={AnimationProgress=120},tag=!flipped_gravity] if score #mirrored Selected matches 0 as @e[type=minecraft:armor_stand,tag=luigi_model,tag=head] if score @s ID = #temp ID at @s rotated ~ 0 positioned ^-2 ^-1 ^1 rotated ~-90 0 run function luigis_mansion_3ds_remake:spawn_entities/ghost/polterpup
execute if entity @s[scores={AnimationProgress=120},tag=flipped_gravity] if score #mirrored Selected matches 0 as @e[type=minecraft:armor_stand,tag=luigi_model,tag=head] if score @s ID = #temp ID at @s rotated ~ 0 positioned ^2 ^2.5 ^1 rotated ~90 0 run function luigis_mansion_3ds_remake:spawn_entities/ghost/polterpup
execute if entity @s[scores={AnimationProgress=120},tag=!flipped_gravity] if score #mirrored Selected matches 1 as @e[type=minecraft:armor_stand,tag=luigi_model,tag=head] if score @s ID = #temp ID at @s rotated ~ 0 positioned ^2 ^-1 ^1 rotated ~90 0 run function luigis_mansion_3ds_remake:spawn_entities/ghost/polterpup
execute if entity @s[scores={AnimationProgress=120},tag=flipped_gravity] if score #mirrored Selected matches 1 as @e[type=minecraft:armor_stand,tag=luigi_model,tag=head] if score @s ID = #temp ID at @s rotated ~ 0 positioned ^-2 ^2.5 ^1 rotated ~-90 0 run function luigis_mansion_3ds_remake:spawn_entities/ghost/polterpup
...
execute if entity @s[scores={AnimationProgress=140}] run playsound luigis_mansion_3ds_remake:music.polterpup music @a[tag=same_room] ~ ~ ~ 1000
