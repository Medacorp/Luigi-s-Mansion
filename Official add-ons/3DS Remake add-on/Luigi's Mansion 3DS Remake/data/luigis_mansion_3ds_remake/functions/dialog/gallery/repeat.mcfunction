...
execute if entity @s[scores={Dialog=80}] run tellraw @a[tag=same_room] {"translate":"luigis_mansion:dialog.gallery.leave","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 3"},"extra":[{"text":"\n"},{"translate":"luigis_mansion:dialog.gallery.where","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 1"}}]}
execute if entity @s[scores={Dialog=80}] if score #global_3ds_remake_gallery Selected matches 1 run tellraw @a[tag=same_room] {"translate":"luigis_mansion_3ds_remake:dialog.gallery.doors","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 5"}}
execute if entity @s[scores={Dialog=80}] run tellraw @a[tag=same_room] {"translate":"luigis_mansion:dialog.gallery.what","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 2"},"extra":[{"text":"\n"},{"translate":"luigis_mansion_3ds_remake:dialog.gallery.stand","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 6"}},{"text":"\n"},{"translate":"luigis_mansion:dialog.gallery.nothing","clickEvent":{"action":"run_command","value":"/trigger EGaddGallChoice set 4"}}]}
