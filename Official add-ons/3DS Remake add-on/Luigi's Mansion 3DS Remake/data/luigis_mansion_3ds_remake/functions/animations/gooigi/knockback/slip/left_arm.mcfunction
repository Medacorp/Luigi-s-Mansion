...
execute if entity @s[scores={AnimationProg=1..15}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=16..30}] store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 3
