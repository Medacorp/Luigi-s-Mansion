...
execute if entity @s[scores={AnimationProg=1..20}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProg=1..20}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 0.1 run scoreboard players add #temp Time 5
execute store result score #temp Time run data get entity @s Pose.Head[2] 100
execute if entity @s[scores={AnimationProg=1..20}] store result entity @s Pose.Head[2] float 0.01 run scoreboard players add #temp Time 25
