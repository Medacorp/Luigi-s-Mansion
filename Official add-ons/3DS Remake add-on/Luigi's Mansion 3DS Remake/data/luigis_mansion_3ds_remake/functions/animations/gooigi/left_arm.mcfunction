...
execute at @s[scores={PoltergustTime=1..10}] if score #mirrored Selected matches 1 run function luigis_mansion_3ds_remake:animations/gooigi/move_nozzle/left_arm
