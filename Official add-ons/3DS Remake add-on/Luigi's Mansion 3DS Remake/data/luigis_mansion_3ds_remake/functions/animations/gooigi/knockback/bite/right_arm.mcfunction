...
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=1}] {Pose:{Head:[-20.0f,0.0f,-40.0f]}}
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=1},tag=flipped_gravity] {Pose:{Head:[-20.0f,0.0f,140.0f]}}
...
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=16}] {Pose:{Head:[-20.0f,0.0f,-40.0f]}}
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=16},tag=flipped_gravity] {Pose:{Head:[-20.0f,0.0f,140.0f]}}
