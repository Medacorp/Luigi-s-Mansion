...
execute at @s[scores={PoltergustTime=1..10}] if score #mirrored Selected matches 0 run function luigis_mansion_3ds_remake:animations/gooigi/move_nozzle/right_arm
execute at @s[tag=revive] unless entity @s[tag=held_item,tag=holding_poltergust] run function luigis_mansion_3ds_remake:animations/gooigi/revive/chest
