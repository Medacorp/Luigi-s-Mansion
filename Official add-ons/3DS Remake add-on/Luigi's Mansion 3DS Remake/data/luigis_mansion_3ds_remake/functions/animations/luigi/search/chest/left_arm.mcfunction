...
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=15}] {Pose:{Head:[0.0f,0.0f,0.01f]}}
execute if score #mirrored Selected matches 0 run data merge entity @s[scores={AnimationProgress=15},tag=flipped_gravity] {Pose:{Head:[0.0f,0.0f,-180.0f]}}
