...
bossbar add luigis_mansion_3ds_remake:portrait_battle {"type":"translatable","translate":"luigis_mansion_3ds_remake:message.gallery.portrait_battle.time","color":"white","with":["0","0","0"]}
