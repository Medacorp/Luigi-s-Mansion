...
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] store result score @s HomeRotX run data get entity @s Rotation[0] 100
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] store result score @s HomeRotY run data get entity @s Rotation[1] 100
...
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] at @s run function luigis_mansion_3ds_remake:items/flashlight/effects/weak_light/path
...
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] at @s if score #temp MirrorX matches -2147483648.. run function luigis_mansion_3ds_remake:items/flashlight/effects/weak_light/mirror/x
execute if entity @s[tag=dark_room] as @e[type=minecraft:marker,tag=weak_flashlight,tag=new,limit=1] at @s if score #temp MirrorZ matches -2147483648.. run function luigis_mansion_3ds_remake:items/flashlight/effects/weak_light/mirror/z
