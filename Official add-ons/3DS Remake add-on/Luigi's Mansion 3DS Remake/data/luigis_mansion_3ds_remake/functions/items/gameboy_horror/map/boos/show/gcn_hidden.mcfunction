...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[2] run function luigis_mansion_3ds_remake:items/gameboy_horror/map/display/hidden/show_boo
...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[1] run function luigis_mansion_3ds_remake:items/gameboy_horror/map/display/hidden/show_boo
...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[0] run function luigis_mansion_3ds_remake:items/gameboy_horror/map/display/hidden/show_boo
