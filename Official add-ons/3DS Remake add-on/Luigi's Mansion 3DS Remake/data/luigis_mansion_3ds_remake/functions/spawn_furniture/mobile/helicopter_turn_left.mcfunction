execute if score #mirrored Selected matches 0 run summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:entity.helicopter_mobile"}',Pose:{Head:[0.0f,0.0f,0.0f],RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:20,CustomModelData:-1}}],Tags:["fan","furniture","this_entity","no_dust","turn_left","scan_ignore"],DisabledSlots:2039583}
execute if score #mirrored Selected matches 1 run summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"luigis_mansion:entity.helicopter_mobile"}',Pose:{Head:[0.0f,0.0f,0.0f],RightArm:[0.0f,0.0f,0.0f],LeftArm:[0.0f,0.0f,0.0f]},Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:21,CustomModelData:-1}}],Tags:["fan","furniture","this_entity","no_dust","turn_left","scan_ignore"],DisabledSlots:2039583}
...
scoreboard players set @e[tag=this_entity,limit=1] RotationSpeed 0
scoreboard players set @e[tag=this_entity,limit=1] RotationSpeedDef 0
scoreboard players set @e[tag=this_entity,limit=1] FurnitureSizeW 30
scoreboard players set @e[tag=this_entity,limit=1] FurnitureSizeH 40
