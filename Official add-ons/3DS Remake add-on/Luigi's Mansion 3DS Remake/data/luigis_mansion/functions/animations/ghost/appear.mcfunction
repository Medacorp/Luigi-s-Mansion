...
data merge entity @s[scores={AnimationProg=1}] {Pose:{RightArm:[-90.0f,-30.0f,-90.0f],LeftArm:[-90.0f,30.0f,90.0f],Head:[0.0f,0.0f,0.01f]}}
...
execute if entity @s[scores={AnimationProg=1..10}] store result entity @s Pose.RightArm[1] float 1 run scoreboard players add #temp Time 3
...
execute if entity @s[scores={AnimationProg=1..10}] store result entity @s Pose.LeftArm[1] float 1 run scoreboard players remove #temp Time 3
