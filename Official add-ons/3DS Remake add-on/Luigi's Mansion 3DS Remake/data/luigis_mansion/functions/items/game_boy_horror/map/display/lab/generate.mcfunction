...
execute if score #global_3ds_remake_gallery Selected matches 1 run function luigis_mansion_3ds_remake:items/game_boy_horror/map/display/lab/gallery
...
execute if score #global_3ds_remake_gallery Selected matches 1 run function luigis_mansion_3ds_remake:items/game_boy_horror/map/display/lab/door/gallery_1
execute if score #global_3ds_remake_gallery Selected matches 1 run function luigis_mansion_3ds_remake:items/game_boy_horror/map/display/lab/door/gallery_2
execute if score #global_3ds_remake_gallery Selected matches 1 run function luigis_mansion_3ds_remake:items/game_boy_horror/map/display/lab/door/gallery_3
execute if score #global_3ds_remake_gallery Selected matches 1 if score #extra_gallery Selected matches 1 run function luigis_mansion_3ds_remake:items/game_boy_horror/map/display/lab/door/extra_gallery
