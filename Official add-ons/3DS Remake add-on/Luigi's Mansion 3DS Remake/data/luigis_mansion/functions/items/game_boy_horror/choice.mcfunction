...
tellraw @s[tag=portrait_battle] {"translate":"luigis_mansion_3ds_remake:message.game_boy_horror.stop_portrait_battle","color":"green","clickEvent":{"action":"run_command","value":"/trigger GBHChoice set 5"}}
execute if data storage luigis_mansion_3ds_remake:data {shown_gameboy_horror_part:1b} run tellraw @s {"translate":"luigis_mansion:message.game_boy_horror.scan","color":"green","clickEvent":{"action":"run_command","value":"/trigger GBHChoice set 2"}}
