...
execute if entity @s[scores={Dialog=170}] if score #toad_amiibo Selected matches 1 at @e[tag=gameboy_horror_location] run function luigis_mansion_3ds_remake:spawn_entities/item/huge_heart
