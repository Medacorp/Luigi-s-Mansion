...
execute if entity @s[scores={Dialog=139}] if score #toad_amiibo Selected matches 1 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.toad","color":"green"},{"type":"translatable","translate":"luigis_mansion_3ds_remake:dialog.toad.heal.more"}]}
execute if entity @s[scores={Dialog=234}] if score #toad_amiibo Selected matches 1 at @a[gamemode=!spectator,tag=!looking_at_map] run function luigis_mansion_3ds_remake:spawn_entities/item/huge_heart
execute if entity @s[scores={Dialog=234}] if score #toad_amiibo Selected matches 1 at @e[tag=game_boy_horror_location] run function luigis_mansion_3ds_remake:spawn_entities/item/huge_heart
