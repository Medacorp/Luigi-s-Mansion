...
execute unless score #the_twins_room Time matches 1.. run tag @e[distance=..0.7,tag=henry] add next_wave
...
execute unless entity @e[tag=orville,limit=1] run data modify storage luigis_mansion:data entity set value {scan_message:{sender:"me",message:'{"translate":"luigis_mansion_3ds_remake:message.orville.scan"}'}}
