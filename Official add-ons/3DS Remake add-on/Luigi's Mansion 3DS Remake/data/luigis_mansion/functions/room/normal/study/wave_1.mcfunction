...
data modify storage luigis_mansion:data entity set value {scan_message:{sender:"me",message:'{"translate":"luigis_mansion_3ds_remake:message.neville.scan"}',plural_message:'{"translate":"luigis_mansion_3ds_remake:message.neville.scan.more"}'}}
