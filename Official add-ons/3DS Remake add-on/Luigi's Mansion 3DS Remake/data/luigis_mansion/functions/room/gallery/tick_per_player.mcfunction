...
execute unless entity @s[tag=!wall_warp,gamemode=!spectator] if entity @s[tag=!already_ticked] run function luigis_mansion:room/gallery/spectator_tick
...
execute if score #global_3ds_remake_gallery Selected matches 1 run function luigis_mansion_3ds_remake:room/gallery/warp_to