execute unless entity @s[scores={Room=-4}] run title @s title {"type":"translatable","translate":"luigis_mansion:location.gallery"}
...
execute if score #global_3ds_remake_gallery Selected matches 1 unless block 772 4 -16 minecraft:dirt run function luigis_mansion_3ds_remake:room/gallery/generate