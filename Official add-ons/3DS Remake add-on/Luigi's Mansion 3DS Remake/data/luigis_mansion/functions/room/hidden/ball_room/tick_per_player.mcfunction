...
execute if data storage luigis_mansion:data current_state.current_data.rooms.ball_room{seen:0b} run function luigis_mansion:room/hidden/ball_room/set_seen