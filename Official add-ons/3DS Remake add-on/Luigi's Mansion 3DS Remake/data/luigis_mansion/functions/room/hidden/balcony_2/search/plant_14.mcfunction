...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 656 121 54 run function luigis_mansion:room/hidden/balcony_2/plant_14
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 655 120 55 run function luigis_mansion:blocks/dust
