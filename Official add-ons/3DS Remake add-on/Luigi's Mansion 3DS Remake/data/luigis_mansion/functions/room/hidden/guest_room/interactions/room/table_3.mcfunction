...
execute if entity @a[tag=portrait_battle,limit=1] if score #temp Searching matches 1 positioned 746 26 59 run function luigis_mansion:blocks/search_sound/wood
