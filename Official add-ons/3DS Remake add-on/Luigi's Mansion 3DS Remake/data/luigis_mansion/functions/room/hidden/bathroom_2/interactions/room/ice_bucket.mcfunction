...
execute if entity @a[tag=portrait_battle,limit=1] if score #temp Searching matches 1 positioned 658 20 -1 run function luigis_mansion:blocks/search_sound/metal
