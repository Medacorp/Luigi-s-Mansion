data modify storage luigis_mansion:data entity{id:"boolderdash",name:'{"translate":"luigis_mansion_3ds_remake:entity.boolderdash"}',can_attack:0b,health:1,room:0,speed:0,loot:{}}
