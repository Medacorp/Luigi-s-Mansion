...
execute if entity @s[scores={Dialog=828}] run tellraw @a[tag=same_room] {"type":"translatable","translate":"luigis_mansion_3ds_remake:dialog.melody_pianissima.composer.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger MelodyChoice set 2"},"extra":[{"type":"text","text":"\n"},{"type":"translatable","translate":"luigis_mansion_3ds_remake:dialog.melody_pianissima.composer.no.1","clickEvent":{"action":"run_command","value":"/trigger MelodyChoice set 1"}},{"type":"text","text":"\n"},{"type":"translatable","translate":"luigis_mansion:dialog.melody_pianissima.composer.no.2","clickEvent":{"action":"run_command","value":"/trigger MelodyChoice set 1"}}]}
