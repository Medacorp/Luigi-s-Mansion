...
execute if entity @s[scores={Dialog=471}] if score #mansion_data_index Selected matches 1 run function luigis_mansion_3ds_remake:room/hidden/conservatory/stop_music
