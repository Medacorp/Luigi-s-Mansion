...
execute if entity @s[tag=!in_vacuum,tag=!shake,tag=!long_shake] if entity @s[scores={FurnitureSearch=20..39}] run function luigis_mansion:entities/furniture/shake
execute if entity @s[tag=!in_vacuum,tag=!shake,tag=!long_shake,tag=was_shaking] unless entity @s[scores={FurnitureSearch=20..39}] run function luigis_mansion:entities/furniture/revert_to_default_orientation
