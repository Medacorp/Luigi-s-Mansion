...
execute if entity @s[scores={Dialog=1..459}] as @a[tag=same_room,gamemode=!spectator,scores={IdleTime=0..},tag=!looking_at_map,tag=!portrait_battle] run function luigis_mansion:entities/player/animation/set/stand_still
execute if entity @s[scores={Dialog=1..40}] run scoreboard players set @a[tag=same_room,scores={ScareTime=20}] ScareTime 21
execute if entity @s[scores={Dialog=60..199}] as @a[tag=same_room,tag=!spectator,tag=!high_health_idle,tag=!looking_at_map,tag=!portrait_battle] run function luigis_mansion:entities/player/animation/set/high_health_idle_no_sound
execute if entity @s[scores={Dialog=200}] as @a[tag=same_room,tag=!spectator,tag=!stand_still,tag=!looking_at_map,tag=!portrait_battle] run function luigis_mansion:entities/player/animation/set/stand_still
...
execute if entity @s[scores={Dialog=240}] as @a[tag=same_room,tag=!portrait_battle] at @s facing entity @e[tag=bogmire,scores={Dialog=240},limit=1] feet rotated ~ 0 positioned ^ ^ ^1 run function luigis_mansion:entities/player/scare/normal
