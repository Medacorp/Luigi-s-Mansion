summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"e3_demo:entity.ghost"}',Tags:["normal_ghost","stunable","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","hurt_by_fire","hurt_by_water","hurt_by_ice","ghost","hidden","new_ghost","this_entity"],data:{entity:{namespace:"e3_demo",id:"ghost"}}}
...
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_data".loot set from storage luigis_mansion:data current_state.current_data.ghosts.e3_demo.ghost.loot
data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_data".damage set from storage luigis_mansion:data current_state.current_data.ghosts.e3_demo.ghost.damage
