...
function luigis_mansion:entities/luigi/make_sound/conditional {high:"luigis_mansion:entity.player.pull.high_health",medium:"luigis_mansion:entity.player.pull.high_health",low:"luigis_mansion:entity.player.pull.low_health",duration:10}