...
execute if entity @s[scores={OverheatMeter=300..}] if data storage luigis_mansion:data current_state.e3_demo.trophy{task_7:0b} run function e3_demo:selection_menu/gallery_trophy/complete/task_7
