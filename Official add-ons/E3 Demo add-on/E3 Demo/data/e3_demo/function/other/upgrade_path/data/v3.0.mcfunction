execute unless data storage luigis_mansion:data update_data{data_version:2} run function e3_demo:other/upgrade_path/data/v2.0
data modify storage luigis_mansion:data update_data merge value {mansion_id:{namespace:"e3_demo",id:"original"},data_version:3,no_collect_animation:["luigis_mansion:key","e3_demo:ghost_coin"],drop_item_on_damage:{namespace:"luigis_mansion",id:"null"},portrait_ghosts:{neville:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:10}}}},damage:{collision:0}},lydia:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:10}}}},damage:{}},miss_petunia:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:10}}}},damage:{}},spooky:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:10}}}},damage:{}}},ghosts:{beta_ghost:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:3}}}},vanish_time:120,damage:{collision:5,attack:10}},beta_puncher:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:3}}}},vanish_time:120,damage:{collision:5,attack:10}},beta_body_slammer:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:3}}}},vanish_time:180,damage:{collision:5,attack:10}},beta_basher:{loot:{drop_at_0:{contents:{e3_demo:{ghost_coin:2}}}},vanish_time:120,damage:{collision:5,attack:10}},beta_bat:{damage:{collision:5}},beta_mouse:{damage:{collision:5}},beta_shining_ghost:{damage:{collision:5}},beta_boo:{damage:{collision:5}},beta_flying_fish:{damage:{collision:5}},haunted_teddy_bear:{damage:{}},haunted_frying_pan:{damage:{}}}}
