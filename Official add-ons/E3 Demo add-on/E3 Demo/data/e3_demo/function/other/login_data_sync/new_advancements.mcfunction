...
execute if data storage luigis_mansion:data rooms.underground_lab{cleared:1b} run advancement grant @a only e3_demo:jukebox/first_key
execute if data storage luigis_mansion:data rooms.underground_lab{cleared:1b} run advancement grant @a only e3_demo:jukebox/meet_e_gadd