...
execute if data storage luigis_mansion:data current_state unless data storage e3_demo:data current_state run function e3_demo:other/upgrade_path/newly_installed