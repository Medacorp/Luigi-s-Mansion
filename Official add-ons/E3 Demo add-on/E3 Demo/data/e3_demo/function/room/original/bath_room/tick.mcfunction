...
scoreboard players set @a[x=648,y=10,z=15,dx=12,dy=7,dz=14] Room 12
#todelete - old furniture
scoreboard players set #temp Room 12
#/todelete

execute as @e[scores={Room=12}] unless entity @s[type=!minecraft:armor_stand,type=!minecraft:item_frame] if score #global_mirror_reflections Selected matches 1 run scoreboard players set @s MirrorX 649
