...
execute if entity @s[scores={PositionIntY=101,PositionIntZ=-10..-2,PositionIntX=645..646}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~1 ~"}
execute if entity @s[scores={PositionIntY=101,PositionIntZ=-10..-2,PositionIntX=650..652}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~1 ~"}
execute if entity @s[scores={PositionIntY=101,PositionIntZ=-10..-9,PositionIntX=647..649}] run function luigis_mansion:entities/luigi/move/wall_warp_teleport {teleport:"~ ~-2 ~"}
