...
execute if entity @s[scores={PositionIntX=759}] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~-1 ~ ~"}
...
execute if entity @s[scores={PositionIntY=36,PositionIntX=753..759}] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~-1 ~"}