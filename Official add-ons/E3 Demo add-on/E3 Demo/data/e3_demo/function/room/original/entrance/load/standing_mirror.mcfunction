data modify storage luigis_mansion:data furniture set value {room:1,shake_animation:["interact","vacuum"],no_dust:1b,sound:{namespace:"luigis_mansion",id:"heavy_generic"}}
