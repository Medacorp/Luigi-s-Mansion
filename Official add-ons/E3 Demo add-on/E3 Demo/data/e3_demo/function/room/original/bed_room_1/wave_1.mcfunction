data modify storage luigis_mansion:data entity set value {room:6,drop_pearls:0b,drop_timer_loot:0b,scan_result:{namespace:"luigis_mansion",id:"scan/entity/lydia"}}
