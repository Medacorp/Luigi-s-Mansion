...
execute unless data storage luigis_mansion:data current_state.luigis_mansion.current_data.rooms.kitchen{cleared:1b} unless score #kitchen Wave matches 1.. run function e3_demo:room/original/kitchen/wave_1
