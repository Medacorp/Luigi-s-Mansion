data modify storage luigis_mansion:data entity set value {room:16,drop_pearls:0b,drop_timer_loot:0b,scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.spooky.scan"}'}}
