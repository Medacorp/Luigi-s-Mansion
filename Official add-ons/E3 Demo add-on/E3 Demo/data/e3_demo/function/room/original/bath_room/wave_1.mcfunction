...
execute positioned 652 12 24 rotated 0 0 run function luigis_mansion:spawn_entities/portrait_ghost/miss_petunia
data modify storage luigis_mansion:data entity set value {room:12}
execute positioned 654.7 12 24 rotated 0 0 run function luigis_mansion:spawn_entities/showering_shadow
data modify storage luigis_mansion:data entity set value {room:12}
