...
execute unless score #temp Time matches 1 run fill 768 89 11 771 94 4 minecraft:air
execute unless score #temp Time matches 1 run place template luigis_mansion:gate/closed 768 89 4
