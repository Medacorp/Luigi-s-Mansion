...
execute if entity @s[scores={FurnitureNoteTime=1}] unless score #mirrored Selected matches 1 run particle minecraft:note ^0.35 ^0.05 ^0.1 0.417 0 0 1 0 normal @a[tag=same_room]
execute if entity @s[scores={FurnitureNoteTime=1}] if score #mirrored Selected matches 1 run particle minecraft:note ^-0.35 ^0.05 ^0.1 0.417 0 0 1 0 normal @a[tag=same_room]
