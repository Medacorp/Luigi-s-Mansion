...
execute if score #dialog Dialog matches 987 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=!can_talk_to] run tag @e[tag=e_gadd,tag=same_room,limit=1] remove cannot_be_removed
execute if score #dialog Dialog matches 987 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=!can_talk_to] run data modify storage luigis_mansion:data dialogs[0].room set value 0
execute if score #dialog Dialog matches 987 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=!can_talk_to] run tag @e[tag=luigi,tag=same_room] add dead
