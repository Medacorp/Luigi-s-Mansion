...
execute if score #dialog Dialog matches 5 run data modify storage luigis_mansion:data dialogs[-1].ending set from storage luigis_mansion:data current_state.luigis_mansion.current_data.ending_dialog
