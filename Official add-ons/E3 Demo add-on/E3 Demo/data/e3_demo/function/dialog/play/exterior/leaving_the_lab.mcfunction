...
execute if score #dialog Dialog matches 1 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"755 89.9375 8.0 90 0"}
...
execute if score #dialog Dialog matches 1..125 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
execute if score #dialog Dialog matches 126 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"741 94 8.0 90 0"}
...
execute if score #dialog Dialog matches 126..165 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
execute if score #dialog Dialog matches 131 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 151 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
...
execute if score #dialog Dialog matches 166 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"729 100 8.0 90 0"}
execute if score #dialog Dialog matches 166..235 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"^ ^ ^0.05"}
execute if score #dialog Dialog matches 171 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 191 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 211 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 231 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~0.5 ~"}
execute if score #dialog Dialog matches 236 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"721 102 8 135 0"}
...
execute if score #dialog Dialog matches 255..274 as @a[tag=this_player,limit=1] run function luigis_mansion:entities/luigi/move/teleport {teleport:"~ ~ ~-0.025"}
