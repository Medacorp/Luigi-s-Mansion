...
execute if score #dialog Dialog matches 150 run data modify entity @e[tag=e_gadd,tag=same_room,limit=1] data.poltergust set value {id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:damage":1,"minecraft:custom_model_data":6,"minecraft:item_name":'{"type":"translatable","translate":"e3_demo:item.poltergust_500"}',"minecraft:custom_data":{namespace:"e3_demo",id:"poltergust_500",is_poltergust:1b,is_nozzle:1b,model:{body_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":12,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":13}}}}},body_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":13,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":12}}}}},sat_on_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":14,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":15}}}}},sat_on_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":15,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":14}}}}},idle_right:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":16,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":17}}}}},idle_left:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:damage":6,"minecraft:unbreakable":{show_in_tooltip:0b},"minecraft:custom_model_data":17,"minecraft:custom_data":{mirror:{components:{"minecraft:custom_model_data":16}}}}}},kill:1b}}}
