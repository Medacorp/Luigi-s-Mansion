...
execute if score #dialog Dialog matches 469 at @e[tag=same_room,tag=key_model,limit=1] positioned ~-0.7 ~0.9 ~-0.7 run function luigis_mansion:spawn_entities/item/key {door:"living_room"}
