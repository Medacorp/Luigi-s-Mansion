...
execute if score #dialog Dialog matches 416..420 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"751.8 11.5 9.0 90 75"}
...
execute if score #dialog Dialog matches 481..500 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"751.3 10.3 9.0 90 75"}
