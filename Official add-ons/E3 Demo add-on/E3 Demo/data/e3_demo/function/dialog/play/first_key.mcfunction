...
execute if score #dialog Dialog matches 1 run summon minecraft:armor_stand 751.0 13 9.0 {CustomName:'{"type":"translatable","translate":"e3_demo:entity.ghost"}',Tags:["first_key","same_room"],ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:key"}}],NoGravity:1b,Invulnerable:1b,Silent:1b,Invisible:1b,DisabledSlots:2039583}
...
execute if score #dialog Dialog matches 1..120 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.0125 ~0.004 ~0.016 ~0.116 ~0.016"}
execute if score #dialog Dialog matches 121..160 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"752 12 9.0 90 -8"}
execute if score #dialog Dialog matches 161..180 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~0.135 ~-0.05 9.0 90 ~-0.1"}
execute if score #dialog Dialog matches 181..190 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"754.7 11 9.0 90 -10"}
execute if score #dialog Dialog matches 191 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"753.3 12 10.0 108 0"}
execute if score #dialog Dialog matches 191..220 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.03 ~-0.016 ~-0.01 ~0.3 ~-0.33"}
execute if score #dialog Dialog matches 221..230 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"752.3 11.5 9.7 117 -10"}
execute if score #dialog Dialog matches 231..250 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"752.3 ~-0.025 9.7 ~0.05 ~2.95"}
execute if score #dialog Dialog matches 251..270 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"752.3 ~-0.025 9.7 118 49"}
execute if score #dialog Dialog matches 271 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"753 13 15 130 24"}
execute if score #dialog Dialog matches 271..310 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"753 ~0.025 15 ~-1 ~-0.375"}
execute if score #dialog Dialog matches 311 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"750 21.5 3 40 10"}
execute if score #dialog Dialog matches 311..370 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"750 21.5 3 ~0.466 ~-0.016"}
execute if score #dialog Dialog matches 371..375 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"750 21.5 3 68 9"}
execute if score #dialog Dialog matches 376 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"750 21.5 3 68 9"}
execute if score #dialog Dialog matches 376..415 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/execute {execute:"at @s rotated 68 9",teleport:"^ ^ ^0.09 ~ ~"}
execute if score #dialog Dialog matches 416..420 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"751 11.5 9.0 90 75"}
execute if score #dialog Dialog matches 421..480 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"~-0.008 ~-0.02 9.0 90 75"}
execute if score #dialog Dialog matches 481..500 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/teleport {teleport:"751.0 10.3 9.0 90 75"}
execute if score #dialog Dialog matches 500 as @a[tag=same_room,limit=1] run function luigis_mansion:entities/player/camera/reset
...
execute if score #dialog Dialog matches 216 at @e[tag=same_room,tag=first_key] run summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:item.key"}',Pose:{Head:[0.0f,90.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:key"}}],Tags:["key_model","same_room"],Rotation:[-90.0f,0.0f],DisabledSlots:2039583}
...
execute if score #dialog Dialog matches 232 as @e[tag=same_room,tag=key_model,limit=1] at @s run teleport @s ~-0.4 ~0.2 ~-0.125
execute if score #dialog Dialog matches 232 run data merge entity @e[tag=same_room,tag=key_model,limit=1] {Pose:{Head:[-45.0f,45.0f,0.01f]},Rotation:[-80.0f,0.0f]}
execute if score #dialog Dialog matches 233 as @e[tag=same_room,tag=key_model,limit=1] at @s run teleport @s ~-0.4 ~-0.41 ~-0.125
execute if score #dialog Dialog matches 233 run data merge entity @e[tag=same_room,tag=key_model,limit=1] {Pose:{Head:[-90.0f,0.0f,0.01f]},Rotation:[-70.0f,0.0f]}
...
execute if score #dialog Dialog matches 252..272 at @e[tag=same_room,tag=first_key] positioned ~ ~-0.9 ~ run tag @e[tag=same_room,tag=candle_flame,distance=..1.5] add extinguish
...
execute if score #dialog Dialog matches 290..310 at @e[tag=same_room,tag=first_key] positioned ~ ~-0.9 ~ run tag @e[tag=same_room,tag=candle_flame,distance=..2.5] add extinguish
