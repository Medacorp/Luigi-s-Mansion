...
execute if entity @s[scores={OpenMapFocus=1..},tag=!regenerate_map] run function e3_demo:selection_menu/game_boy_horror/map/display/original/focus_point
execute unless entity @a[tag=looking_at_map] run function e3_demo:selection_menu/game_boy_horror/map/display/original/generate
