summon minecraft:item_display ~ ~-0.01 ~ {CustomName:{type:"translatable",translate:"luigis_mansion:item.game_boy_horror"},data:{entity:{namespace:"luigis_mansion",id:"game_boy_horror/door"}},view_range:32f,item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"e3_demo:menu/game_boy_horror/map/door","minecraft:custom_model_data":{strings:["unlocked"]}}},item_display:"head",Tags:["no_reflection","map_entity","this_entity"]}
