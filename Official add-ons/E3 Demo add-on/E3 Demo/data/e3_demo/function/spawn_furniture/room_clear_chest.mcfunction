summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.room_clear_chest"},Tags:["furniture","room_clear_chest","immobile","standing_furniture","this_entity"],data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"delayed",interact_animation:{namespace:"luigis_mansion",id:"search/hump"},open_animation:{namespace:"luigis_mansion",id:"room_clear_chest"}},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"e3_demo:furniture/room_clear_chest","minecraft:custom_model_data":{floats:[0f]},"minecraft:custom_data":{model_data:{default:{components:{"minecraft:custom_model_data":{floats:[0f]}}},open:{components:{"minecraft:custom_model_data":{floats:[8f]}}}}}}}}
teleport @e[tag=this_entity,limit=1] ~ ~ ~ ~ ~
execute if score #3ds_remake Loaded matches 1.. run data modify entity @e[tag=this_entity,limit=1] data.interact_animation set value {namespace:"3ds_remake",id:"search/chest"}
