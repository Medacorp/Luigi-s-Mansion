...
execute unless entity @e[tag=radar_detect,distance=..8,limit=1] if entity @s[nbt=!{Inventory:[{tag:{Damage:3,luigis_mansion:{namespace:"luigis_mansion",id:"game_boy_horror"}}}]}] run function luigis_mansion:items/game_boy_horror/turn_radar_on
