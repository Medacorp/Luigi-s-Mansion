playsound e3_demo:item.ghost_coin.obtain player @a[tag=same_room] ~ ~ ~ 1
function luigis_mansion:items/get_player_money/get
execute store result score #temp Time run data get storage luigis_mansion:data current_state.my_money.money.e3_demo.ghost_coin
execute unless score #temp ActionTime matches 2147483647 store result storage luigis_mansion:data current_state.my_money.money.e3_demo.ghost_coin int 1 run scoreboard players add #temp Time 1
...
execute store result score #temp Time run data get storage luigis_mansion:data current_state.my_money_data.money.e3_demo.ghost_coin
execute unless score #temp ActionTime matches 2147483647 store result storage luigis_mansion:data current_state.my_money_data.money.e3_demo.ghost_coin int 1 run scoreboard players add #temp Time 1
