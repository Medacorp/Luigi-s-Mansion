...
execute if entity @e[tag=e_gadd,tag=poltergust,limit=1,tag=!vacuuming] run playsound e3_demo:item.poltergust_500.vacuuming_start player @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @e[tag=e_gadd,tag=poltergust,limit=1,tag=!vacuuming] PoltergustSound 20
execute if entity @e[tag=e_gadd,tag=poltergust,limit=1,tag=vacuuming,scores={PoltergustSound=0}] run playsound e3_demo:item.poltergust_500.vacuuming player @a[tag=same_room] ~ ~ ~ 1
