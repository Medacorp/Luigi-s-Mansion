summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:furniture.room_clear_chest"}',Tags:["furniture","room_clear_chest","immobile","standing_furniture","this_entity"],NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:unbreakable":{},"minecraft:damage":19,"minecraft:custom_model_data":-6,"minecraft:custom_data":{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"delayed"},open_animation:{namespace:"luigis_mansion",id:"room_clear_chest"},model_data:{default:{components:{"minecraft:custom_model_data":-6}},open:{components:{"minecraft:custom_model_data":-2}}}}}],Invisible:1b,DisabledSlots:2039583}
teleport @e[tag=this_entity,limit=1] ~ ~-1.4 ~ ~ 0
execute if score #3ds_remake Loaded matches 1.. run data modify entity @e[tag=this_entity,limit=1] ArmorItems[3].components."minecraft:custom_data" merge value {interact_animation:{namespace:"3ds_remake",id:"search/chest"}}
