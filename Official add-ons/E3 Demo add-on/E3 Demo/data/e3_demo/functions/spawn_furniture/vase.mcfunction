summon minecraft:armor_stand ~ ~-1.4 ~ {CustomName:'{"translate":"e3_demo:furniture.vase"}',Marker:1b,NoGravity:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:19,CustomModelData:-1}}],Tags:["furniture","rolling","standing_furniture","this_entity"],DisabledSlots:2039583}
