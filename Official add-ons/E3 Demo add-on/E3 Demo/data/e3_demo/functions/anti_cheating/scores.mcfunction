...
execute unless data storage e3_demo:data current_state run function e3_demo:other/upgrade_path/newly_installed

advancement grant @a only e3_demo:lab/unlocked_original_mansion
execute if data storage luigis_mansion:data current_state.high_scores[{data_index:2}] run advancement grant @a only e3_demo:lab/cleared_original_mansion