summon minecraft:marker ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shining_ghost"}',Tags:["optional_ghost","affected_by_vacuum","affected_by_fire","affected_by_water","affected_by_ice","ghost","vacuumable","this_entity"],data:{entity:{namespace:"e3_demo",id:"shining_ghost"}}}
summon minecraft:armor_stand ~ ~ ~ {CustomName:'{"type":"translatable","translate":"luigis_mansion:entity.shining_ghost"}',Invisible:1b,NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Small:1b,ArmorItems:[{},{},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,Damage:1,CustomModelData:17,luigis_mansion:{invisible:"minecraft:stone_button",visible:"minecraft:leather_chestplate"},display:{color:16717824}}}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["model_piece","shining_ghost_model","found_owner","vacuumable"],DisabledSlots:2039583}
