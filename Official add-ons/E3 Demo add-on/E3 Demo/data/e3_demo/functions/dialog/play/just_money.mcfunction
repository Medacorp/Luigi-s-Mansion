...
execute if score #dialog Dialog matches ..146 unless score #dialog Dialog matches 5..84 as @a[tag=same_room,tag=!spectator,tag=!dialog_menu] run function luigis_mansion:selection_menu/dialog/original_menu
