...
execute if score #dialog Dialog matches 667..985 unless score #dialog Dialog matches 669..750 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 986 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/choice/save
...
execute if score #dialog Dialog matches 668 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=can_talk_to] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.ooh_ooh_yahboh_yahboh_hoo_hoo_hoo neutral @a[tag=same_room] ~ ~ ~ 1
execute if score #dialog Dialog matches 668 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=!can_talk_to] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"luigis_mansion:dialog.ghost_portrificationizer_room.ending.5"}]}
execute if score #dialog Dialog matches 668 if entity @e[tag=e_gadd,tag=same_room,limit=1,tag=!can_talk_to] at @e[tag=e_gadd,tag=same_room,limit=1] run playsound luigis_mansion:entity.e_gadd.talk.ohmoogah_luigi_odoh neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if score #dialog Dialog matches 749 unless data storage luigis_mansion:data dialogs[0].portraits.luigis_mansion.neville unless data storage luigis_mansion:data dialogs[0].portraits.luigis_mansion.lydia unless data storage luigis_mansion:data dialogs[0].portraits.luigis_mansion.miss_petunia unless data storage luigis_mansion:data dialogs[0].portraits.luigis_mansion.spooky run scoreboard players set #dialog Dialog 1559
