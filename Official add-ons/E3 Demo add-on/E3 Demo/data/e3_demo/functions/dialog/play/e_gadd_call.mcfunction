...
execute if score #dialog Dialog matches 210 unless entity @a[tag=portrait_battle,limit=1] unless score #loaded_exterior Selected matches -1 in minecraft:overworld run function luigis_mansion:room/load_exterior/empty
