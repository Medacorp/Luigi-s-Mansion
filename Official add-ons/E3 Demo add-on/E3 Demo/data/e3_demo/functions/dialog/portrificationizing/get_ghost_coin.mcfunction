...
execute if data storage luigis_mansion:data current_state.current_data.money_grabbed[0] run function e3_demo:dialog/portrificationizing/get_money_loop/ghost_coin
