...
scoreboard players set @s[scores={Dialog=201}] AnimationProgress 0
tag @s[scores={Dialog=280}] remove jump
scoreboard players set @s[scores={Dialog=280}] AnimationProgress 0
tag @s[scores={Dialog=300}] add walk
scoreboard players set @s[scores={Dialog=300}] AnimationProgress 0
teleport @s[scores={Dialog=300..335}] ~ ~ ~-0.2 -180 0
tag @s[scores={Dialog=335}] remove walk
scoreboard players set @s[scores={Dialog=335}] AnimationProgress 0
...
scoreboard players set @s[scores={Dialog=360}] AnimationProgress 0
teleport @s[scores={Dialog=360..395}] ~ ~ ~-0.115 -180 0
tag @s[scores={Dialog=395}] remove walk
scoreboard players set @s[scores={Dialog=395}] AnimationProgress 0
...
scoreboard players set @s[scores={Dialog=475}] AnimationProgress 0
...
scoreboard players set @s[scores={Dialog=520}] AnimationProgress 0
teleport @s[scores={Dialog=520..555}] ~ ~ ~-0.228 -180 0
tag @s[scores={Dialog=555}] remove walk
scoreboard players set @s[scores={Dialog=555}] AnimationProgress 0
...
scoreboard players set @s[scores={Dialog=666}] AnimationProgress 0
...
scoreboard players set @s[scores={Dialog=810}] AnimationProgress 0
...
execute if entity @s[scores={Dialog=830}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:0} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.peaceful"}]}
execute if entity @s[scores={Dialog=830}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:1} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.easy"}]}
execute if entity @s[scores={Dialog=830}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:2} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.normal"}]}
execute if entity @s[scores={Dialog=830}] if data storage luigis_mansion:data current_state.current_data{lowest_difficulty:3} run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.money.multiplier.hard"}]}
...
scoreboard players set @s[scores={Dialog=1069}] AnimationProgress 0
...
execute if entity @s[scores={Dialog=1070},tag=ending] unless score #3ds_remake Loaded matches 1.. run tellraw @a[tag=same_room] {"translate":"luigis_mansion:message.save.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddGhostPortrificationizerRoomChoice set 1"},"extra":[{"text":"\n"},{"translate":"luigis_mansion:message.save.no","clickEvent":{"action":"run_command","value":"/trigger EGaddGhostPortrificationizerRoomChoice set 2"}}]}
execute if entity @s[scores={Dialog=1070},tag=!ending] run tellraw @a[tag=same_room] {"translate":"luigis_mansion:message.save.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddGhostPortrificationizerRoomChoice set 1"},"extra":[{"text":"\n"},{"translate":"luigis_mansion:message.save.no","clickEvent":{"action":"run_command","value":"/trigger EGaddGhostPortrificationizerRoomChoice set 2"}}]}
