...
execute if entity @s[scores={Dialog=1070},tag=ending] run function e3_demo:room/original/cleared
execute if entity @s[scores={Dialog=1070},tag=ending] unless score #3ds_remake Loaded matches 1.. run function luigis_mansion:other/delete_current_mansion_data
