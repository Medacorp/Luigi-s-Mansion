...
execute if entity @s[scores={Dialog=150}] run scoreboard players set @e[tag=beta_ghost,tag=dialog,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=150}] at @e[tag=beta_ghost,tag=dialog,limit=1] run playsound e3_demo:entity.ghost.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=220}] as @e[tag=beta_ghost,tag=dialog,limit=1] at @s run playsound e3_demo:entity.ghost.cutscene_flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=240}] as @e[tag=beta_ghost,tag=dialog,limit=1] at @s run playsound e3_demo:entity.ghost.cutscene_flee hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=317}] run scoreboard players set @e[tag=beta_ghost,tag=dialog,limit=1] AnimationProgress 0
...
execute if entity @s[scores={Dialog=320}] as @e[tag=beta_ghost,tag=dialog,limit=1] at @s run playsound e3_demo:entity.ghost.cutscene_pull hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=340}] as @e[tag=beta_ghost,tag=dialog,limit=1] at @s run playsound e3_demo:entity.ghost.cutscene_pull hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=1252}] as @e[tag=beta_ghost,tag=dialog] at @s run playsound e3_demo:entity.ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=1272}] as @e[tag=beta_ghost,tag=dialog] at @s run playsound e3_demo:entity.ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=1312}] as @e[tag=beta_ghost,tag=dialog] at @s run playsound e3_demo:entity.ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=1332}] as @e[tag=beta_ghost,tag=dialog] at @s run playsound e3_demo:entity.ghost.ambient hostile @a[tag=same_room] ~ ~ ~ 1
