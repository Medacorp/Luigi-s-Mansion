...
execute if score #temp2 LastTotalDamage matches 0 if score #temp ActionTime matches 1.. positioned ~ ~2 ~ run function e3_demo:entities/player/damage/ghost_coin/drop/one
...
execute unless score #temp LastTotalDamage = #temp TotalDamage if score #temp ActionTime matches 1.. run function e3_demo:entities/player/damage/ghost_coin/drop/loop