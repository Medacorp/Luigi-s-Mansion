...
execute at @s[tag=!fleeing,tag=move_up] rotated ~ 0 run function e3_demo:entities/shining_ghost/move_up
execute at @s[tag=!fleeing,tag=!move_up] rotated ~ 0 run function e3_demo:entities/shining_ghost/move_down
execute at @s[tag=fleeing] rotated ~ 0 run function e3_demo:entities/shining_ghost/flee
