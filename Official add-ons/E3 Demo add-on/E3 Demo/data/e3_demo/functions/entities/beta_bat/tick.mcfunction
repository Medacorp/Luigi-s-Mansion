...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!dead,tag=!removed_from_existence] run function e3_demo:entities/beta_bat/collide
...
execute if entity @s[tag=!fleeing,tag=!attack,tag=!collided] if entity @e[tag=this_room,tag=!spectator,tag=player,distance=..10,limit=1] run tag @s add attack
execute if entity @s[tag=attack,tag=!targetted,tag=!turn_back] run function e3_demo:entities/beta_bat/target
execute if entity @s[tag=turn_back,tag=!dead] run function e3_demo:entities/beta_bat/return
execute if entity @s[tag=targetted,tag=!dead] run function e3_demo:entities/beta_bat/move
execute if entity @s[tag=returned,tag=!dead] run function e3_demo:entities/beta_bat/returned
execute at @s[tag=!attack,tag=!fleeing] facing entity @e[tag=same_room,tag=!spectator,tag=player,sort=nearest,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~-180 ~
