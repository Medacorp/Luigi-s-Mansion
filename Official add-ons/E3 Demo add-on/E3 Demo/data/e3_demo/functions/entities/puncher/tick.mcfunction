...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,tag=!basher,tag=!hurt,tag=!fleeing,tag=!element_hurt] unless entity @s[tag=attack,scores={AttackType=0,ActionTime=41..60}] run function e3_demo:entities/puncher/collide
execute if entity @s[scores={AttackType=0}] run function e3_demo:entities/puncher/select_attack/punch
execute if entity @s[scores={AttackType=1}] run function e3_demo:entities/puncher/select_attack/basher
...
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function e3_demo:entities/puncher/laugh
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function e3_demo:entities/puncher/complain
