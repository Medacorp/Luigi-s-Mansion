...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=visible] run function e3_demo:entities/beta_boo/collide

execute if entity @s[tag=!visible,tag=!turned] run function e3_demo:entities/beta_boo/initial_rotation
...
execute unless score #temp ActionTime matches 2.. unless entity @e[distance=..0.7,tag=same_room,tag=!spectator,tag=player,limit=1] unless entity @e[tag=beta_boo,tag=visible,distance=..0.7] run tag @s add visible
...
execute at @s[tag=visible] unless entity @s[tag=shy,tag=!fleeing] run function e3_demo:entities/beta_boo/move
...
execute at @s[scores={Turn=0},tag=visible,tag=!shy,tag=!fleeing] run function e3_demo:entities/beta_boo/turn
