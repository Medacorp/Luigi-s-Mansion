...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!fleeing,tag=!dying] run playsound e3_demo:entity.puncher.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Sound=0},tag=fleeing,tag=!dying] run playsound e3_demo:entity.puncher.flee hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Sound=0},tag=!vanish,tag=!fleeing,tag=!attack,tag=!laugh,tag=!complain,tag=!appear,tag=!basher] run playsound e3_demo:entity.puncher.ambient hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0}] Sound 40

execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,tag=!basher,tag=!hurt,tag=!fleeing,tag=!element_hurt] unless entity @s[tag=attack,scores={AttackType=0,ActionTime=41..60}] run function e3_demo:entities/beta_puncher/collide
execute if entity @s[scores={AttackType=0}] run function e3_demo:entities/beta_puncher/select_attack/punch
execute if entity @s[scores={AttackType=1}] run function e3_demo:entities/beta_puncher/select_attack/basher
...
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function e3_demo:entities/beta_puncher/laugh
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function e3_demo:entities/beta_puncher/complain
...
execute if entity @s[tag=vanish] run function e3_demo:entities/beta_puncher/vanish
execute if entity @s[tag=appear,tag=!beta_appear] run function e3_demo:entities/beta_puncher/appear
execute if entity @s[tag=appear,tag=beta_appear] run function e3_demo:entities/beta_puncher/beta_appear
...
execute at @s[tag=fleeing,tag=second_flee_state] run function luigis_mansion:entities/beta_puncher/second_flee_state
