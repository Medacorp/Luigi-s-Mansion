...
execute if entity @s[scores={ActionTime=21}] run playsound e3_demo:entity.puncher.attack hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=41}] run playsound luigis_mansion:entity.ghost.uppercut hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=41..60}] if score #mirrored Selected matches 0 rotated ~342 0 run function e3_demo:entities/beta_puncher/punch/normal
execute if entity @s[scores={ActionTime=41..60}] if score #mirrored Selected matches 1 rotated ~342 0 run function e3_demo:entities/beta_puncher/punch/mirrored
...
execute at @s[scores={ActionTime=41..60}] run data modify storage luigis_mansion:data damage.amount set from entity @s ArmorItems[3].tag.damage.attack
...
execute at @s[scores={ActionTime=41..60}] as @a[distance=..1,gamemode=!spectator] run function luigis_mansion:entities/player/take_damage
