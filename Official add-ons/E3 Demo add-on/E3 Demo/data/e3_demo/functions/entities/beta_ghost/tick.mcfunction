...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!dialog,tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!captured,tag=!removed_from_existence,scores={AttackType=0},tag=!hurt,tag=!fleeing,tag=!element_hurt] run function e3_demo:entities/beta_ghost/collide
execute if entity @s[scores={AttackType=0}] run function e3_demo:entities/beta_ghost/select_attack/punch
execute if entity @s[scores={AttackType=1}] run function e3_demo:entities/beta_ghost/select_attack/basher
execute if entity @s[scores={AttackType=2}] run function e3_demo:entities/beta_ghost/select_attack/laugh
...
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=laugh,scores={StunTime=0}] run function e3_demo:entities/beta_ghost/laugh
execute if entity @s[tag=!hurt,tag=!element_hurt,tag=!fleeing,tag=!attack,tag=!collided,tag=complain,scores={StunTime=0}] run function e3_demo:entities/beta_ghost/complain
...
execute if entity @s[tag=vanish] run function e3_demo:entities/beta_ghost/vanish
execute if entity @s[tag=appear,tag=!beta_appear] run function e3_demo:entities/beta_ghost/appear
execute if entity @s[tag=appear,tag=beta_appear] run function e3_demo:entities/beta_ghost/beta_appear
...
execute at @s[tag=fleeing,tag=second_flee_state] run function luigis_mansion:entities/beta_ghost/second_flee_state
