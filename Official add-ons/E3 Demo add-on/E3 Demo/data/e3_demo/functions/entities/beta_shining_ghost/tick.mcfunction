...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=visible] run function e3_demo:entities/beta_shining_ghost/collide
...
execute unless score #temp ActionTime matches 2.. unless entity @e[distance=..0.7,tag=same_room,tag=!spectator,tag=player,limit=1] unless entity @e[tag=beta_shining_ghost,tag=visible,distance=..0.7] run tag @s add visible
...
execute at @s[tag=!fleeing,tag=move_up] rotated ~ 0 run function e3_demo:entities/beta_shining_ghost/move_up
execute at @s[tag=!fleeing,tag=!move_up] rotated ~ 0 run function e3_demo:entities/beta_shining_ghost/move_down
execute at @s[tag=fleeing] rotated ~ 0 run function e3_demo:entities/beta_shining_ghost/flee
