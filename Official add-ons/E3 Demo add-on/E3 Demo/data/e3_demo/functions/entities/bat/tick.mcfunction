...
execute if entity @e[tag=same_room,tag=!spectator,tag=player,distance=..0.7,limit=1] if entity @s[tag=!dead,tag=!removed_from_existence] run function e3_demo:entities/bat/collide
...
execute if entity @s[tag=attack,tag=!targetted,tag=!turn_back] run function e3_demo:entities/bat/target
execute if entity @s[tag=turn_back,tag=!dead] run function e3_demo:entities/bat/return
execute if entity @s[tag=targetted,tag=!dead] run function e3_demo:entities/bat/move
execute if entity @s[tag=returned,tag=!dead] run function e3_demo:entities/bat/returned
