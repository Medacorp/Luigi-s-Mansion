...
execute unless block ^ ^2 ^0.6 #minecraft:slabs[type=bottom] unless block ^ ^2 ^0.6 #luigis_mansion:all_ignore rotated ~ 0 unless block ^ ^2 ^0.6 #minecraft:slabs[type=bottom] if block ^ ^ ^0.6 #luigis_mansion:all_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:old_entities/ghost/move_forward
execute if score #temp Move matches 1.. positioned as @s run function e3_demo:old_entities/shining_ghost/move_forward