...
execute if entity @s[scores={ActionTime=41}] run playsound e3_demo:entity.puncher.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=81}] run playsound e3_demo:entity.puncher.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
