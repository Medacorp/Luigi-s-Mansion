...
execute if entity @s[scores={ActionTime=1..40}] run function luigis_mansion:old_animations/twirler/basher_stun
scoreboard players set @s[scores={ActionTime=41}] AnimationProgress 0
execute if entity @s[scores={ActionTime=41..60}] run function luigis_mansion:old_animations/twirler/basher_appear
scoreboard players set @s[scores={ActionTime=61}] AnimationProgress 0
execute if entity @s[scores={ActionTime=61..90}] run function luigis_mansion:old_animations/twirler/basher_complain
...
execute if entity @s[scores={ActionTime=41}] run playsound e3_demo:entity.body_slammer.spawn hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=81}] run playsound e3_demo:entity.body_slammer.complain_basher hostile @a[tag=same_room] ~ ~ ~ 1
