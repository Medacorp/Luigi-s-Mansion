...
execute unless score #mirrored Selected matches 1 if entity @e[tag=target,limit=1,distance=0.5..0.7] facing entity @e[tag=target,limit=1] feet rotated ~88 ~ run teleport @s ~ ~ ~ ~ ~
...
execute at @s run function luigis_mansion:entities/ghost/move_forward_force
