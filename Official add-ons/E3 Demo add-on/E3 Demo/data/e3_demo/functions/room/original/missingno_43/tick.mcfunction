...
execute as @a[x=713,y=-1,z=-22,dx=22,dy=9,dz=8] unless entity @s[scores={Room=59}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=59},limit=1] run function e3_demo:room/original/missingno_43/ghosts
