...
execute as @a[x=736,y=26,z=0,dx=20,dy=9,dz=35] unless entity @s[scores={Room=57}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=57},limit=1] run function e3_demo:room/original/missingno_41/ghosts
