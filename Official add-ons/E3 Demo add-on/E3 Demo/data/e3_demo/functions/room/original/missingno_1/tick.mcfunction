...
execute as @a[x=683,y=17,z=22,dx=12,dy=9,dz=21] unless entity @s[scores={Room=17}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=17},limit=1] run function e3_demo:room/original/missingno_1/ghosts
