...
execute if score #lavatory_toilet Searching matches 20 run function e3_demo:room/original/lavatory/search/toilet
...
execute unless block 664 11 44 minecraft:dropper{LootTable:"luigis_mansion:search"} run function e3_demo:room/original/lavatory/search/toilet