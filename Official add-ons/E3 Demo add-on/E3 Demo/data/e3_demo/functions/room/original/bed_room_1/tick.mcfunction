...
execute as @a[x=682,y=108,z=37,dx=17,dy=9,dz=20] unless entity @s[scores={Room=6}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=6},limit=1] run function e3_demo:room/original/bed_room_1/ghosts
