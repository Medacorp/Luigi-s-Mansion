...
execute as @a[x=682,y=128,z=-31,dx=31,dy=16,dz=77] unless entity @s[scores={Room=64}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=64},limit=1] run function e3_demo:room/original/missingno_48/ghosts
