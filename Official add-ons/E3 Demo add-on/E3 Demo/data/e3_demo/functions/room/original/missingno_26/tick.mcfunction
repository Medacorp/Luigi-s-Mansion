...
execute if entity @a[gamemode=!spectator,tag=!pull_open_door,tag=!push_open_door,scores={Room=42},limit=1] run function e3_demo:room/original/missingno_26/ghosts
