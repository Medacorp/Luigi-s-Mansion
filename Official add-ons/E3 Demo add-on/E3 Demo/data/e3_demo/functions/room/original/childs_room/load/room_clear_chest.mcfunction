data modify storage luigis_mansion:data furniture set value {room:7,searchable:["time"],cannot_search_when_open:1b,use_medium_shake:1b,sound:{namespace:"luigis_mansion",id:"chest"},no_dust:1b}
