data modify storage luigis_mansion:data entity set value {room:6,drop_pearls:0b,drop_poison_mushrooms:0b,scan_message:{sender:"me",message:'{"type":"translatable","translate":"luigis_mansion:message.lydia.scan"}'}}
