...
execute as @a[x=652,y=8,z=-29,dx=12,dy=9,dz=28] unless entity @s[scores={Room=36}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=36},limit=1] run function e3_demo:room/original/missingno_20/ghosts
