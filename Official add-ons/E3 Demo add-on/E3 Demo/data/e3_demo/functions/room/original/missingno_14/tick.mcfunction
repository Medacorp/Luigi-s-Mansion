...
execute as @a[x=679,y=8,z=-88,dx=12,dy=9,dz=33] unless entity @s[scores={Room=30}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=30},limit=1] run function e3_demo:room/original/missingno_14/ghosts
