...
execute as @a[x=686,y=17,z=-23,dx=10,dy=9,dz=8] unless entity @s[scores={Room=23}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=23},limit=1] run function e3_demo:room/original/missingno_7/ghosts
