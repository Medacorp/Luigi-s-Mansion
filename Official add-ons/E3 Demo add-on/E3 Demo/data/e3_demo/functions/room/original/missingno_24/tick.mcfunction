...
execute as @a[x=645,y=90,z=-9,dx=6,dy=7,dz=10] unless entity @s[scores={Room=40}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=40},limit=1] run function e3_demo:room/original/missingno_24/ghosts
