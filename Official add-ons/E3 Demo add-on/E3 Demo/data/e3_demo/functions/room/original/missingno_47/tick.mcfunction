...
execute as @a[x=682,y=117,z=-10,dx=17,dy=8,dz=35] unless entity @s[scores={Room=63}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=63},limit=1] run function e3_demo:room/original/missingno_47/ghosts
