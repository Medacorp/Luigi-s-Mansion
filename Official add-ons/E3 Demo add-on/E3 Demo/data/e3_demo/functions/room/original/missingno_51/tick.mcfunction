...
execute as @a[x=693,y=17,z=-88,dx=17,dy=9,dz=33] unless entity @s[scores={Room=67}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=67},limit=1] run function e3_demo:room/original/missingno_51/ghosts
