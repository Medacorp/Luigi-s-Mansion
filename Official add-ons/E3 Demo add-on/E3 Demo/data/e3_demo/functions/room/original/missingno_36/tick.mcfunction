...
function #e3_demo:room/original/missingno_36/interactions/room

execute if entity @a[gamemode=!spectator,tag=!pull_open_door,tag=!push_open_door,scores={Room=52},limit=1] run function e3_demo:room/original/missingno_36/ghosts
