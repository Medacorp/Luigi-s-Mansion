...
execute if entity @a[gamemode=!spectator,tag=!pull_open_door,tag=!push_open_door,scores={Room=7},limit=1] run function e3_demo:room/original/childs_room/ghosts
