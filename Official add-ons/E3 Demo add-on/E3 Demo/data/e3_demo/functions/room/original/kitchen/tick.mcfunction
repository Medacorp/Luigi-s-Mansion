...
execute as @a[x=697,y=8,z=61,dx=14,dy=9,dz=31] unless entity @s[scores={Room=15}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=15},limit=1] run function e3_demo:room/original/kitchen/ghosts
