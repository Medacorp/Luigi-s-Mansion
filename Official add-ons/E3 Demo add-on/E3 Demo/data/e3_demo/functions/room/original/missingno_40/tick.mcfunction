...
execute as @a[x=740,y=26,z=40,dx=19,dy=9,dz=8] unless entity @s[scores={Room=56}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=56},limit=1] run function e3_demo:room/original/missingno_40/ghosts
