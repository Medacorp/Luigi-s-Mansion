...
execute as @e[x=697,y=17,z=-23,dx=15,dy=9,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 24
...
execute if entity @a[tag=exact_same_room,limit=1] run function e3_demo:room/original/missingno_8/ghosts
