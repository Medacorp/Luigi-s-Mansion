...
execute as @a[x=671,y=99,z=37,dx=14,dy=9,dz=19] unless entity @s[scores={Room=16}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=16},limit=1] run function e3_demo:room/original/back_yard/ghosts
