...
execute as @a[x=741,y=26,z=-17,dx=19,dy=9,dz=8] unless entity @s[scores={Room=51}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=51},limit=1] run function e3_demo:room/original/missingno_35/ghosts
