...
execute as @a[x=648,y=8,z=15,dx=12,dy=9,dz=14] unless entity @s[scores={Room=12}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=12},limit=1] run function e3_demo:room/original/bath_room/ghosts
