...
execute as @a[x=667,y=17,z=4,dx=11,dy=9,dz=8] unless entity @s[scores={Room=22}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=667,y=17,z=4,dx=11,dy=9,dz=8] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 22
...
execute if entity @a[tag=!pause_dialog,scores={Room=22},limit=1] run function e3_demo:room/original/missingno_6/ghosts
