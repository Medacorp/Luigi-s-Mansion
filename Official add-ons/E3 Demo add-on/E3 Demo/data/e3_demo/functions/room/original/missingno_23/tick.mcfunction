...
execute as @a[x=644,y=99,z=-41,dx=10,dy=9,dz=78] unless entity @s[scores={Room=39}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=39},limit=1] run function e3_demo:room/original/missingno_23/ghosts
