...
execute as @a[x=697,y=8,z=28,dx=14,dy=9,dz=30] unless entity @s[scores={Room=14}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=14},limit=1] run function e3_demo:room/original/dining_room/ghosts
