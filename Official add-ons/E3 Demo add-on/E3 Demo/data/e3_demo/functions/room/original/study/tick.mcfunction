...
execute as @a[x=700,y=17,z=42,dx=17,dy=9,dz=21] unless entity @s[scores={Room=5}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=5},limit=1] run function e3_demo:room/original/study/ghosts
