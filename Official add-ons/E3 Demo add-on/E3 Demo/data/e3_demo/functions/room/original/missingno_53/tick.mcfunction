...
execute as @a[x=721,y=-1,z=-6,dx=21,dy=9,dz=18] unless entity @s[scores={Room=69}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=69},limit=1] run function e3_demo:room/original/missingno_53/ghosts
