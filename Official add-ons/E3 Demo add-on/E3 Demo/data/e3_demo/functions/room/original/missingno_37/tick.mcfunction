...
execute as @a[x=653,y=117,z=-42,dx=30,dy=25,dz=78] unless entity @s[scores={Room=53}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=53},limit=1] run function e3_demo:room/original/missingno_37/ghosts
