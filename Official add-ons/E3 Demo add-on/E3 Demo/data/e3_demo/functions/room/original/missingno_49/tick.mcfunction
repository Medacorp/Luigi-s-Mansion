...
execute as @a[x=744,y=26,z=54,dx=22,dy=9,dz=25] unless entity @s[scores={Room=65}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=65},limit=1] run function e3_demo:room/original/missingno_49/ghosts
