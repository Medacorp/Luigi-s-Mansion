...
execute as @a[x=734,y=8,z=-39,dx=14,dy=9,dz=20] unless entity @s[scores={Room=31}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=31},limit=1] run function e3_demo:room/original/missingno_15/ghosts
