...
execute as @a[x=712,y=17,z=-55,dx=8,dy=18,dz=12] unless entity @s[scores={Room=26}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=26},limit=1] run function e3_demo:room/original/missingno_10/ghosts
