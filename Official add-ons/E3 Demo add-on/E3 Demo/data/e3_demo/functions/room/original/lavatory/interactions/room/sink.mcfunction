...
execute if score #lavatory_sink Searching matches 20 run function e3_demo:room/original/lavatory/search/sink
...
execute unless block 662 11 40 minecraft:dropper{LootTable:"luigis_mansion:search"} run function e3_demo:room/original/lavatory/search/sink