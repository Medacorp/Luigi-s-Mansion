...
execute as @a[x=678,y=8,z=-55,dx=8,dy=18,dz=25] unless entity @s[scores={Room=20}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=20},limit=1] run function e3_demo:room/original/missingno_4/ghosts
