...
execute as @e[x=678,y=8,z=-55,dx=8,dy=18,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 20
...
execute if entity @a[tag=exact_same_room,limit=1] run function e3_demo:room/original/missingno_4/ghosts
