...
execute as @a[x=640,y=14,z=-83,dx=10,dy=12,dz=10] unless entity @s[scores={Room=46}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=46},limit=1] run function e3_demo:room/original/missingno_30/ghosts
