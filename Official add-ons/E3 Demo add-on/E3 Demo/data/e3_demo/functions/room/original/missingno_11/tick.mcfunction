...
execute as @a[x=713,y=26,z=-42,dx=7,dy=9,dz=13] unless entity @s[scores={Room=27}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=713,y=26,z=-42,dx=7,dy=9,dz=13] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 27
...
execute if entity @a[tag=!pause_dialog,scores={Room=27},limit=1] run function e3_demo:room/original/missingno_11/ghosts
