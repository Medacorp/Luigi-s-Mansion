...
execute if data storage luigis_mansion:data current_state.current_data.rooms.kitchen{cleared:1b} positioned 705 12 79 rotated -90 0 run function e3_demo:spawn_furniture/room_clear_chest
