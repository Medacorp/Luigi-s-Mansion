...
execute unless entity @e[x=744.5,y=20,z=65.5,distance=..0.7,tag=ghost] positioned 748 20 57 run function e3_demo:spawn_entities/ghost/can_spawn_now/ghost/orange
