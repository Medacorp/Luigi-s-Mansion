...
execute as @a[x=734,y=-1,z=-63,dx=14,dy=9,dz=21] unless entity @s[scores={Room=58}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[x=734,y=-1,z=-63,dx=14,dy=9,dz=21] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 58
...
execute if entity @a[tag=!pause_dialog,scores={Room=58},limit=1] run function e3_demo:room/original/missingno_42/ghosts
