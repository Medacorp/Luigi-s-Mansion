...
execute as @a[x=734,y=8,z=-63,dx=14,dy=9,dz=21] unless entity @s[scores={Room=32}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=32},limit=1] run function e3_demo:room/original/missingno_16/ghosts
