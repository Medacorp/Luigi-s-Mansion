...
execute as @a[x=644,y=99,z=38,dx=27,dy=9,dz=18] unless entity @s[scores={Room=37}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=37},limit=1] run function e3_demo:room/original/missingno_21/ghosts
