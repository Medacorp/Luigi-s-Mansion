...
execute as @a[x=734,y=17,z=-63,dx=14,dy=9,dz=21] unless entity @s[scores={Room=71}] run scoreboard players operation @s LastRoom = @s Room
...
execute if entity @a[tag=!pause_dialog,scores={Room=71},limit=1] run function e3_demo:room/original/missingno_55/ghosts
