...
execute if data storage luigis_mansion:data current_state.money_grabbed[0] run function e3_demo:room/gallery/interact_with_trophy/get_money_count/ghost_coin