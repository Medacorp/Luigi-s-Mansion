...
execute if score #temp Time matches 2 if score #temp2 Time matches 2 run data modify storage 3ds_remake:data portrait_ghost[-1].mansion set value {namespace:"e3_demo",id:"original"}
