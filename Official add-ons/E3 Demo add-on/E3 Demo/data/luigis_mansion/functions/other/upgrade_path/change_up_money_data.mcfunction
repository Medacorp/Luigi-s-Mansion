...
data modify storage luigis_mansion:data new_money_grabbed[-1].money.e3_demo.ghost_coin set from storage luigis_mansion:data money_grabbed[0].money.ghost_coin
