...
execute unless score #temp LastHealth = #temp Health at @s if score #poltergust_500 Selected matches 1 run playsound e3_demo:entity.king_boo.lose_health hostile @a[tag=same_room] ~ ~ ~ 1
