...
execute if entity @s[scores={Dialog=1}] run playsound e3_demo:music.first_key music @a[tag=same_room] ~ ~ ~ 1000
...
execute if entity @s[scores={Dialog=216}] run summon minecraft:armor_stand ~ ~ ~ {Pose:{Head:[0.0f,90.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:brick",Count:1b,tag:{CustomModelData:1}}],Tags:["living_room_key"],Rotation:[-90.0f,0.0f],DisabledSlots:2039583}
item replace entity @s[scores={Dialog=216}] armor.head with minecraft:air
execute if entity @s[scores={Dialog=216..220}] as @e[tag=living_room_key,limit=1] at @s run teleport @s ~ ~0.1 ~
execute if entity @s[scores={Dialog=221..231}] as @e[tag=living_room_key,limit=1] at @s run teleport @s ~ ~-0.3 ~
execute if entity @s[scores={Dialog=232}] as @e[tag=living_room_key,limit=1] at @s run teleport @s ~0.35 ~0.2 ~0.35
execute if entity @s[scores={Dialog=232}] run data merge entity @e[tag=living_room_key,limit=1] {Pose:{Head:[45.0f,45.0f,0.01f]},Rotation:[-67.5f,0.0f]}
...
execute if entity @s[scores={Dialog=469}] at @e[tag=living_room_key,limit=1] run summon minecraft:armor_stand ~-0.7 ~0.9 ~-0.7 {CustomName:'{"translate":"luigis_mansion:item.key"}',Pose:{Head:[0.0f,-90.0f,0.01f]},Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{namespace:"luigis_mansion",id:"key",variant:"living_room",Unbreakable:1b,Damage:5,CustomModelData:15}}],Small:1b,NoGravity:1b,Tags:["item","key","eternal"],Rotation:[-90.0f,0.0f],DisabledSlots:2039583}
execute if entity @s[scores={Dialog=469}] run scoreboard players set @e[nbt={ArmorItems:[{tag:{namespace:"luigis_mansion",id:"key",variant:"living_room"}}]},limit=1] ActionTime 4
