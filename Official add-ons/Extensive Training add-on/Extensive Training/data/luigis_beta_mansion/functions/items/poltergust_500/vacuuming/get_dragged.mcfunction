...
execute if score #koopa_amiibo Selected matches 0 if entity @s[scores={Pull=20..},gamemode=!creative] run function luigis_beta_mansion:items/poltergust_500/vacuuming/dragged_damage
execute if score #koopa_amiibo Selected matches 1 if entity @s[scores={Pull=20..,Room=..0},gamemode=!creative] run function luigis_beta_mansion:items/poltergust_500/vacuuming/dragged_damage