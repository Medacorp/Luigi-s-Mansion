...
execute if entity @s[scores={Dialog=478}] run scoreboard players reset @a EGaddTrainChoice
...
execute if entity @s[scores={Dialog=602}] run tellraw @a[tag=same_room] {"type":"translatable","translate":"extensive_training:dialog.pvp.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger EGaddTrainChoice set 1"},"extra":[{"type":"text","text":"\n"},{"type":"translatable","translate":"extensive_training:dialog.pvp.no","clickEvent":{"action":"run_command","value":"/trigger EGaddTrainChoice set 2"}}]}
...
execute if entity @s[scores={Dialog=604}] if entity @a[scores={EGaddTrainChoice=1}] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"extensive_training:dialog.pvp.yes.1"}]}
...
execute if entity @s[scores={Dialog=628}] if entity @a[scores={EGaddTrainChoice=1}] run scoreboard players set @s Dialog 477
execute if entity @s[scores={Dialog=604}] if entity @a[scores={EGaddTrainChoice=2}] run tellraw @a[tag=same_room] {"type":"translatable","translate":"chat.type.text","with":[{"type":"translatable","translate":"luigis_mansion:entity.e_gadd","color":"green"},{"type":"translatable","translate":"extensive_training:dialog.pvp.no.1"}]}
