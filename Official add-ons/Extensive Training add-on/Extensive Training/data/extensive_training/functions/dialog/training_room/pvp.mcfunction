...
execute if score #dialog Dialog matches ..153 unless score #dialog Dialog matches 9..11 unless score #dialog Dialog matches 14..134 unless score #dialog Dialog matches 136 unless score #dialog Dialog matches 150 as @a[tag=same_room,tag=!spectator] unless entity @s[tag=dialog_menu,tag=!dialog_choice_menu] run function luigis_mansion:selection_menu/dialog/original_menu
execute if score #dialog Dialog matches 136 as @a[tag=same_room,tag=!spectator,tag=!dialog_choice_menu] run function extensive_training:selection_menu/dialog/choice/training_room_another_round
...
execute if score #dialog Dialog matches 10 if score #temp Time matches 1 run scoreboard players set #dialog Dialog 12
...
execute if score #dialog Dialog matches 11 run scoreboard players add @a[tag=same_room] TrainingRoomScore 0
...
execute if score #dialog Dialog matches 54 run summon minecraft:firework_rocket 788 80 -8 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 59 run summon minecraft:firework_rocket 788 80 -4 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 64 run summon minecraft:firework_rocket 788 80 -12 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14862336],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 69 if score #training_room TrainingRoomScore matches 50.. run summon minecraft:firework_rocket 788 81 -10 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14853494],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 74 if score #training_room TrainingRoomScore matches 50.. run summon minecraft:firework_rocket 788 81 -6 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;14853494],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 79 if score #training_room TrainingRoomScore matches 90.. run summon minecraft:firework_rocket 788 80 -8 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 84 if score #training_room TrainingRoomScore matches 90.. run summon minecraft:firework_rocket 788 80 -4 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 89 if score #training_room TrainingRoomScore matches 90.. run summon minecraft:firework_rocket 788 80 -12 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 94 if score #training_room TrainingRoomScore matches 90.. run summon minecraft:firework_rocket 788 81 -10 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
execute if score #dialog Dialog matches 99 if score #training_room TrainingRoomScore matches 90.. run summon minecraft:firework_rocket 788 81 -6 {LifeTime:0,Life:0,FireworksItem:{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:0b,Explosions:[{Colors:[I;2993378],Type:0b,Trail:0b,Flicker:0b}]}}}}
