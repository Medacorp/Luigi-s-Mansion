...
execute unless score #dialog Dialog matches 9..133 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:items/game_boy_horror/turn_screen_to_forced_value {value:"call",flags:[],floats:[0f,0f,0f,0f],tracker:[]}
execute if score #dialog Dialog matches 9..10 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:items/game_boy_horror/turn_screen_to_forced_value {value:"call",flags:[],floats:[1f,0f,0f,0f],tracker:[]}
execute if score #dialog Dialog matches 11..133 as @a[tag=same_room,tag=!spectator] run function luigis_mansion:items/game_boy_horror/turn_screen_to_forced_value {value:"call",flags:[],floats:[6f,0f,0f,0f],tracker:[]}
...
execute if score #dialog Dialog matches 1..8 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/game_boy_horror
...
execute if score #dialog Dialog matches 9 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/none
...
execute as @a[scores={Health=..0},tag=same_room] run function luigis_mansion:entities/player/run_command_as_model {command:"function luigis_mansion:entities/luigi/animation/set/low_health_idle"}
execute as @a[scores={Health=..0},tag=same_room] run function luigis_mansion:entities/player/run_command_as_model {command:"tag @s remove idle"}
...
execute if score #dialog Dialog matches 11 if score #temp Time matches 2.. as @a[tag=same_room,tag=!spectator,tag=!finalist] run function luigis_mansion:entities/player/run_command_as_model {command:"function luigis_mansion:entities/luigi/animation/set/low_health_idle"}
execute if score #dialog Dialog matches 11 if score #temp Time matches 2.. as @a[tag=!finalist] run function luigis_mansion:entities/player/run_command_as_model {command:"tag @s remove idle"}
...
execute if score #dialog Dialog matches 12 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/game_boy_horror
...
execute if score #dialog Dialog matches 134..135 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/idle
...
execute if score #dialog Dialog matches 136 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/think
...
execute if score #dialog Dialog matches 137 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/nod
...
execute if score #dialog Dialog matches 150 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/none
...
execute if score #dialog Dialog matches 154 as @e[tag=luigi,tag=same_room] run function luigis_mansion:entities/luigi/animation/set/none
