...
execute if score #dialog Dialog matches 4 store result score #temp Time run data get storage luigis_mansion:data current_state.extensive_training.speedrun_record
...
execute if score #dialog Dialog matches 4 unless data storage luigis_mansion:data current_state.extensive_training{speedrun_record:-1} if score #players Totals matches 1 if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"extensive_training:dialog.speedrun.3",with:[{type:"score",score:{name:"#temp6",objective:"Time"}},{type:"score",score:{name:"#temp5",objective:"Time"}},{type:"score",score:{name:"#temp4",objective:"Time"}},{type:"score",score:{name:"#temp3",objective:"Time"}},{type:"score",score:{name:"#temp2",objective:"Time"}},{type:"score",score:{name:"#temp",objective:"Time"}}]}]}
execute if score #dialog Dialog matches 4 unless data storage luigis_mansion:data current_state.extensive_training{speedrun_record:-1} if score #players Totals matches 2.. if entity @a[tag=next_dialog_line,limit=1] run tellraw @a[tag=same_room] {type:"translatable",translate:"chat.type.text",with:[{type:"translatable",translate:"luigis_mansion:entity.e_gadd",color:"green"},{type:"translatable",translate:"extensive_training:dialog.speedrun.3.more",with:[{type:"score",score:{name:"#temp6",objective:"Time"}},{type:"score",score:{name:"#temp5",objective:"Time"}},{type:"score",score:{name:"#temp4",objective:"Time"}},{type:"score",score:{name:"#temp3",objective:"Time"}},{type:"score",score:{name:"#temp2",objective:"Time"}},{type:"score",score:{name:"#temp",objective:"Time"}}]}]}
execute if score #dialog Dialog matches 4 unless data storage luigis_mansion:data current_state.extensive_training{speedrun_record:-1} if entity @a[tag=next_dialog_line,limit=1] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.yahmum_bah_poheh_hap_poh neutral @s ~ ~ ~ 1
...
execute if score #dialog Dialog matches 4 if data storage luigis_mansion:data current_state.extensive_training{speedrun_record:-1} if entity @a[tag=next_dialog_line,limit=1] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.gay_roon_ehdeedee_odoh_tahmentahkeh neutral @s ~ ~ ~ 1
...
execute if score #dialog Dialog matches 130 store result score #temp Time run data get storage luigis_mansion:data current_state.extensive_training.speedrun_record
...
execute if score #dialog Dialog matches 130 if data storage luigis_mansion:data dialogs[0].new_record store result storage luigis_mansion:data current_state.extensive_training.speedrun_record int 1 run scoreboard players get #training_room Time
