...
execute if score #temp ID matches 4.. run function luigis_mansion:other/generate_color
...
data modify storage luigis_mansion:data this_color set value {uuid:[I;],color:0}
