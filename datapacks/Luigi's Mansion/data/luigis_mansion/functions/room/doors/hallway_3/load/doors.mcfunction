execute positioned 719 11 -6 rotated 90 0 run function luigis_mansion:spawn_furniture/door/right/push/heart
...
execute positioned 719 11 -5 rotated 90 0 run function luigis_mansion:spawn_furniture/door/left/pull/heart
...
execute positioned 719 11 -28 rotated 90 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/1
...
execute positioned 716 11 24 rotated -180 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/1
