...
execute as @e[type=!minecraft:item_frame,x=780,y=76,z=6,dx=16,dy=12,dz=17] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room -1
