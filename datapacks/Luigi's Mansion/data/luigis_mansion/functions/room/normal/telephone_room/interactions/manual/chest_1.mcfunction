...
execute if entity @s[x=738.0,y=29,z=17.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/telephone_room/search/boo_check/chest_1