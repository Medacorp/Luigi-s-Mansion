...
execute if entity @s[x=661.0,y=11,z=-17.0,dx=0,dy=1,dz=2,tag=!sound,tag=!check] run function luigis_mansion:room/normal/conservatory/search/boo_check/xylophone