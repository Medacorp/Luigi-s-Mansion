...
execute unless block 654 12 -26 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/conservatory/search_closet
execute unless block 654 12 -27 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/conservatory/search_closet