...
execute in luigis_mansion:normal if block 755 11 9 #minecraft:doors[open=true] if data storage luigis_mansion:data current_state.current_data{blackout:1b} positioned 755 11 9 run function luigis_mansion:blocks/closed_door/no_animation
execute in luigis_mansion:normal if block 755 11 8 #minecraft:doors[open=true] if data storage luigis_mansion:data current_state.current_data{blackout:1b} positioned 755 11 8 run function luigis_mansion:blocks/closed_door/no_animation
...
execute in luigis_mansion:normal if score #temp Searched matches 1..2 as @a[x=755.0,y=11,z=8.0,dx=0,dy=1,dz=1] in minecraft:overworld run teleport @s 721 102 8.0
execute in minecraft:overworld if score #temp Searched matches 1..2 as @a[x=720.0,y=102,z=7.0,dx=0,dy=1,dz=1] in luigis_mansion:normal run teleport @s 754 11 9.0
