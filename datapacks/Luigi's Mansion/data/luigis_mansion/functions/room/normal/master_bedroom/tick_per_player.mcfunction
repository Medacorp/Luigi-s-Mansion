...
execute if data storage luigis_mansion:data current_state.current_data.rooms.master_bedroom{seen:0b} run function luigis_mansion:room/normal/master_bedroom/set_seen