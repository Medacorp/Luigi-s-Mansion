...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 691.0 115 47.0 run function luigis_mansion:room/normal/master_bedroom/fan
