...
execute if entity @s[x=698.5,y=113,z=44.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion:room/normal/master_bedroom/search/boo_check/painting_3