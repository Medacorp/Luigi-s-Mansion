...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 681.0 15 78.0 run function luigis_mansion:room/normal/billiards_room/fan
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 668.0 16 78.0 run function luigis_mansion:blocks/dust_no_sound
