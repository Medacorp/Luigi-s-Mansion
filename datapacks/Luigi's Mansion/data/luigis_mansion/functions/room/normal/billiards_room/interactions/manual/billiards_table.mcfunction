...
execute if entity @s[x=679.0,y=11,z=75.0,dx=4,dy=0,dz=5,tag=!sound,tag=!check] run function luigis_mansion:room/normal/billiards_room/search/boo_check/billiards_table