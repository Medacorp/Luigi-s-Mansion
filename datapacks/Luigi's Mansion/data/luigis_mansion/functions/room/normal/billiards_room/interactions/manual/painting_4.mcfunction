...
execute if entity @s[x=674.0,y=12,z=73.0,dx=0,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/normal/billiards_room/search/boo_check/painting_4