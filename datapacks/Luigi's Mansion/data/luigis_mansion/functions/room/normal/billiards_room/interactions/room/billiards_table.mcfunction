...
execute if score #billiards_room_billiards_table Searching matches 20 run function luigis_mansion:room/normal/billiards_room/search/boo_check/billiards_table
