...
execute if entity @s[x=687.0,y=13,z=70.0,dx=0,dy=0,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/billiards_room/search/boo_check/painting_5