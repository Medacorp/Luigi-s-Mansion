...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 739 33 -48 run function luigis_mansion:room/normal/safari_room/lamp_2
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 751 34 -48 run function luigis_mansion:blocks/dust_no_sound
