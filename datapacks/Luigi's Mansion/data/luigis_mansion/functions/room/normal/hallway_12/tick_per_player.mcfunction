...
execute if data storage luigis_mansion:data current_state.current_data.rooms.hallway_12{seen:0b} run function luigis_mansion:room/normal/hallway_12/set_seen
