...
tag @e[x=668.5,y=20,z=-74.5,distance=..0.7,tag=ghost_guy] add spin_attack
execute positioned 666 20 -80 run function luigis_mansion:spawn_entities/ghost/ghost_guy/green
tag @e[x=666.5,y=20,z=-79.5,distance=..0.7,tag=ghost_guy] add spin_attack
...
tag @e[x=664.5,y=20,z=-88.5,distance=..0.7,tag=ghost_guy] add spin_attack
