...
execute if score #the_artists_studio_painting_4 Searching matches 20 run function luigis_mansion:room/normal/the_artists_studio/search/boo_check/painting_4
