...
execute if entity @s[x=680.0,y=20,z=57.0,dx=0,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/normal/wardrobe_room/search/boo_check/hat_rack