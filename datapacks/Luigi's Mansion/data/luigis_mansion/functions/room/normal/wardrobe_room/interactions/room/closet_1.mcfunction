...
execute if score #wardrobe_room_closet_1 Searching matches 20 run function luigis_mansion:room/normal/wardrobe_room/search/boo_check/closet_1
...
execute unless block 679 21 73 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/wardrobe_room/search/boo_check/closet_1