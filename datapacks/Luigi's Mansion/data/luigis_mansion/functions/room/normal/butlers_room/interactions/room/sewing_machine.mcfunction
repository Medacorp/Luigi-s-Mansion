...
execute if score #butlers_room_sewing_machine Searching matches 20 run function luigis_mansion:room/normal/butlers_room/search/boo_check/sewing_machine
