...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 714 12 61 run function luigis_mansion:room/normal/laundry_room/bucket
