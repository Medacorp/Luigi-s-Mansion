...
execute if entity @s[x=685.0,y=11,z=37.0,dx=1,dy=1,dz=2,tag=!sound,tag=!check] run function luigis_mansion:room/normal/projection_room/search/boo_check/projector