...
execute if entity @s[x=693.0,y=120,z=-3.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/clockwork_room/search/boo_check/table_3