...
execute positioned 752 11 37.0 run function luigis_mansion:blocks/dust_no_sound
...
tag @e[x=746.5,y=11,z=37.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
