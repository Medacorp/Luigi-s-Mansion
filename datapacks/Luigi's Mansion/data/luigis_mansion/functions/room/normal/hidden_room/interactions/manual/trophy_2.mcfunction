...
execute if entity @s[x=746.5,y=13,z=32.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion:room/normal/hidden_room/search/boo_check/trophy_2