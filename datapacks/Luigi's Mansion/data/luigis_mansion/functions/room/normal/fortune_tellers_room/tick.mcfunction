...
execute as @e[x=734,y=10,z=-39,dx=14,dy=8,dz=20] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 20
...
function luigis_mansion:room/normal/fortune_tellers_room/ghosts
