...
execute if entity @s[x=736.0,y=11,z=-37.0,dx=0,dy=2,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/fortune_tellers_room/search/boo_check/table_3