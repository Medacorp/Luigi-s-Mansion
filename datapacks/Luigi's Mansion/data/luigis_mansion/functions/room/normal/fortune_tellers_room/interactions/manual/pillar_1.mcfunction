...
execute if entity @s[x=744.0,y=11,z=-24.0,dx=0,dy=4,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/normal/fortune_tellers_room/search/pillar_1