...
execute unless entity @e[x=700.5,y=11,z=85.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function luigis_mansion:room/normal/hidden_room/search/dish_washer
