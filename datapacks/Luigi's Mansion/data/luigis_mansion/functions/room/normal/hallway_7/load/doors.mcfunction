...
tag @e[x=714.0,y=2,z=-46.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_7_breaker_room
execute positioned 719 2 -47 rotated 90 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/wooden
execute positioned 719 2 -47 rotated 90 0 run function luigis_mansion:spawn_furniture/door_frame/exposed_bricks
tag @e[x=719.0,y=2,z=-46.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_7_cellar