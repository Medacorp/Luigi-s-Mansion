...
execute positioned 744 11 -48 run function luigis_mansion:spawn_entities/ghost/can_spawn_now/mirror_ghost
execute positioned 738 11 -57 run function luigis_mansion:spawn_entities/ghost/can_spawn_now/mirror_ghost
execute positioned 744 11 -57 run function luigis_mansion:spawn_entities/ghost/can_spawn_now/mirror_ghost
