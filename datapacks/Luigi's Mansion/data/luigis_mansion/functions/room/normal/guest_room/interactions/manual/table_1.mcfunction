...
execute unless block 742 21 -52 minecraft:redstone_lamp if entity @s[x=736.0,y=20,z=-46.0,dx=0,dy=2,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/normal/guest_room/search/boo_check/table_1