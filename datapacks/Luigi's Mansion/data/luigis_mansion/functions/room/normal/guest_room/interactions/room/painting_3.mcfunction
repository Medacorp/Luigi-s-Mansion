...
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_painting_3 Searching matches 20 run function luigis_mansion:room/normal/guest_room/search/boo_check/painting_3
