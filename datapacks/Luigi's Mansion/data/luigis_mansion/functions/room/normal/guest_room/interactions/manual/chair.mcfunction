...
execute unless block 742 21 -52 minecraft:redstone_lamp if entity @s[x=738.5,y=20,z=-44.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion:room/normal/guest_room/search/chair