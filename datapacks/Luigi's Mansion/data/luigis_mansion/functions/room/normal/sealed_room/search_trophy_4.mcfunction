...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 708 24 -85 run function luigis_mansion:room/normal/sealed_room/trophy_4
