...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 695 22 -71.0 run function luigis_mansion:room/normal/sealed_room/chest_4
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 693 21 -71.0 run function luigis_mansion:blocks/dust_no_sound
