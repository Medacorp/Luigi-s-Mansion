...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 703.0 22 -84 run function luigis_mansion:room/normal/sealed_room/chest_7
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 686.0 21 -84 run function luigis_mansion:blocks/dust_no_sound
