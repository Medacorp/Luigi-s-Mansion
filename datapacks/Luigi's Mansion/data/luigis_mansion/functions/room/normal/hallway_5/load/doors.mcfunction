...
tag @e[x=682.5,y=11,z=11.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_5_washroom_1
...
tag @e[x=680.0,y=11,z=0.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_5_conservatory
...
tag @e[x=682.5,y=11,z=-28.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_5_hallway_8
execute positioned 685 11 5 rotated 90 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/1
execute positioned 685 11 5 rotated 90 0 run function luigis_mansion:spawn_furniture/door_frame/normal
tag @e[x=685.0,y=11,z=5.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_5_billiards_room