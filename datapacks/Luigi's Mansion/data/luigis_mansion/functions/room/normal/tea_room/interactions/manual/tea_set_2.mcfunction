...
execute if entity @s[x=642.0,y=21,z=-55.0,dx=1,dy=0,dz=2,tag=!sound,tag=!check] run function luigis_mansion:room/normal/tea_room/search/boo_check/tea_set_2