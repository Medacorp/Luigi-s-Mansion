...
tag @e[x=643.5,y=22,z=-59.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
tag @e[x=643.5,y=22,z=-59.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
