...
execute if score #tea_room_ice_bucket Searching matches 20 run function luigis_mansion:room/normal/tea_room/search/ice_bucket
...
execute unless block 643 21 -48 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/normal/tea_room/search/ice_bucket