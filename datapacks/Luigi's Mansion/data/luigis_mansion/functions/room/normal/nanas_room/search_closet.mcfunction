...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 661 20 -26 run function luigis_mansion:room/normal/nanas_room/closet
