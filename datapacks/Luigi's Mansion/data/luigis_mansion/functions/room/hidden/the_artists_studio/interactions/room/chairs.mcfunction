...
execute if score #the_artists_studio_chairs Searching matches 20 run function luigis_mansion:room/hidden/the_artists_studio/search/boo_check/chairs
scoreboard players operation #temp Searching = #the_artists_studio_chairs Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 702 29 72 run function luigis_mansion:blocks/search_sound/generic
