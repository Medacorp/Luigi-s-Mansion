...
execute as @e[x=697.0,y=29,z=72.0,dx=5,dy=6,dz=21,tag=ghost,tag=hidden,y_rotation=-180..0] at @s run function luigis_mansion:room/hidden/the_artists_studio/stay_near_painting
...
function luigis_mansion:room/hidden/the_artists_studio/ghosts
