...
execute if score #the_artists_studio_painting_1 Searching matches 20 run function luigis_mansion:room/hidden/the_artists_studio/search/boo_check/painting_1
scoreboard players operation #temp Searching = #the_artists_studio_painting_1 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 695 29 73 run function luigis_mansion:blocks/search_sound/generic
