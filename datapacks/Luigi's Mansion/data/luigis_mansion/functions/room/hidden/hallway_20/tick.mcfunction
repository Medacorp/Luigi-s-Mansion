...
execute as @e[type=!minecraft:item_frame,x=713,y=1,z=29,dx=22,dy=8,dz=8] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 59
