...
execute unless block 679 21 -51 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/wardrobe_room/search/boo_check/closet_2
execute unless block 679 21 -50 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/wardrobe_room/search/boo_check/closet_2