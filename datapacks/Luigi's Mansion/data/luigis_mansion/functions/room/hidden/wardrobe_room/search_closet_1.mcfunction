...
tag @e[x=679.5,y=21,z=-57.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
tag @e[x=679.5,y=21,z=-57.5,distance=..0.7,tag=ghost,tag=hidden] add spawn