...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 709.0 24 -37.0 run function luigis_mansion:room/hidden/study/ceiling_lamp
