...
execute if entity @s[x=697.0,y=3,z=7.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion:room/hidden/pipe_room/search/boo_check/frozen_barrel