...
execute positioned 708 2 60 run function luigis_mansion:blocks/dust_no_sound
...
tag @e[x=690.5,y=2,z=60.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn