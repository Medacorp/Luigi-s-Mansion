...
execute as @e[type=!minecraft:item_frame,x=653,y=29,z=-23,dx=30,dy=24,dz=80] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 53
