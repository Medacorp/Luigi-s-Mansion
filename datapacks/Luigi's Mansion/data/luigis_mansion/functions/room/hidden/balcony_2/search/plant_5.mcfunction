...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 680 122 -21 run function luigis_mansion:room/hidden/balcony_2/plant_5
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 681 120 -21 run function luigis_mansion:blocks/dust
