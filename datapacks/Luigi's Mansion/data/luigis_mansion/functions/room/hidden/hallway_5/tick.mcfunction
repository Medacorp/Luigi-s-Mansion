...
execute as @e[type=!minecraft:item_frame,x=679,y=11,z=-3,dx=6,dy=6,dz=42] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 13
