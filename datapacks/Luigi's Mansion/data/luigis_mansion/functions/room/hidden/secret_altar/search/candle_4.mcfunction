...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 646 94 39 run function luigis_mansion:room/hidden/secret_altar/candle_4
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 646 93 43 run function luigis_mansion:blocks/dust_no_sound
