...
execute as @e[type=!minecraft:item_frame,x=634,y=92,z=24,dx=20,dy=7,dz=18] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 72
