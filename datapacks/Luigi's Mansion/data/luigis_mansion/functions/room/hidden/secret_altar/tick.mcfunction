...
execute as @e[type=!minecraft:item_frame,x=634,y=92,z=24,dx=20,dy=7,dz=18] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 72
