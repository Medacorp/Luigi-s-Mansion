...
execute as @e[type=!minecraft:item_frame,x=721,y=1,z=3,dx=21,dy=8,dz=18] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 68
