...
execute as @e[type=!minecraft:item_frame,x=667,y=10,z=3,dx=11,dy=8,dz=8] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 14
