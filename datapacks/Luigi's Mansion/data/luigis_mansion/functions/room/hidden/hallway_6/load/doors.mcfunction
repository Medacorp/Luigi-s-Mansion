...
execute unless data storage luigis_mansion:data current_state.current_data.technical_data{cleared_area_3_blockade:1b} run tag @e[x=669.0,y=11,z=7.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add area_blockade
