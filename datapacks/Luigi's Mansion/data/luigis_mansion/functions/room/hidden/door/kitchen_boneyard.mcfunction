...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=27}] 698.0 11 -73 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=28}] 686.0 102 -38 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=27}] 698.0 11 -73 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=28}] 686.0 102 -38 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=698.0,y=11,z=-73.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=698.0,y=11,z=-73.0,dx=0,dy=1,dz=0] run teleport @s 684 102 -38
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=102,z=-38.0,dx=0,dy=1,dz=0] run teleport @s 699 11 -73
