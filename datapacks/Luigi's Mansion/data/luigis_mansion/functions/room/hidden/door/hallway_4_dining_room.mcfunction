...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=12}] 706 11 31.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=26}] 704 11 -13.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=12}] 706 11 31.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=26}] 704 11 -13.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=31.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=11,z=31.0,dx=0,dy=1,dz=0] run teleport @s 704 11 -15
execute if score #temp Searched matches 1..2 as @a[x=704.0,y=11,z=-14.0,dx=0,dy=1,dz=0] run teleport @s 706 11 32
