...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=736.5,y=29,z=32.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{the_artists_studio:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{the_artists_studio:1b} positioned 736 29 31 run function luigis_mansion:room/hidden/the_artists_studio/unlock_door
execute if block 736 29 31 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{the_artists_studio:1b} positioned 736 29 31 run function luigis_mansion:blocks/closed_door
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=52}] 736 29 32.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=71}] 699 29 72.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=52}] 736 29 32.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=71}] 699 29 71.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=736.0,y=29,z=31.0,dx=0,dy=1,dz=0] run teleport @s 699 29 72
execute if score #temp Searched matches 1..2 as @a[x=699.0,y=29,z=71.0,dx=0,dy=1,dz=0] run teleport @s 736 29 30
