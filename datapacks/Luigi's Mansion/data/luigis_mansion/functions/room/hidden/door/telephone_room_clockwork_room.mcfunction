...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=56}] 737.0 29 9 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=62}] 699.0 120 19 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=56}] 737.0 29 9 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=62}] 699.0 120 19 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=752.0,y=29,z=9.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=737.0,y=29,z=9.0,dx=0,dy=1,dz=0] run teleport @s 697 120 19
execute if score #temp Searched matches 1..2 as @a[x=698.0,y=120,z=19.0,dx=0,dy=1,dz=0] run scoreboard players reset @s Time
execute if score #temp Searched matches 1..2 as @a[x=698.0,y=120,z=19.0,dx=0,dy=1,dz=0] run teleport @s 738 29 9
