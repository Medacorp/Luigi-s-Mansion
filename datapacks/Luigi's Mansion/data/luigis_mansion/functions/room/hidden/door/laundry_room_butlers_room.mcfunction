...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=22}] 720.0 11 -50 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=23}] 738.0 11 -46 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=22}] 720.0 11 -50 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=23}] 738.0 11 -46 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=11,z=-50.0,dx=0,dy=1,dz=0] run teleport @s 739 11 -46
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=11,z=-46.0,dx=0,dy=1,dz=0] run teleport @s 718 11 -50
