...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=7}] 730.0 20 -51 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=10}] 738.0 20 -43 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=7}] 730.0 20 -51 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=10}] 738.0 20 -43 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=729.0,y=20,z=-51.0,dx=0,dy=1,dz=0] run teleport @s 739 20 -43
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=20,z=-43.0,dx=0,dy=1,dz=0] run stopsound @s[scores={RoomNoise=1..}] ambient luigis_mansion:music.mansion.room.nursery
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=20,z=-43.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=738.0,y=20,z=-43.0,dx=0,dy=1,dz=0] run teleport @s 728 20 -51
