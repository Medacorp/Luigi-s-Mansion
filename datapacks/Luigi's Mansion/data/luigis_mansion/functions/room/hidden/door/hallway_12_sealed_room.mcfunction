execute if block 703 20 71 minecraft:warped_door[open=true] run scoreboard players set #temp Searched -1
execute if block 706 20 37 minecraft:warped_door[open=true] run scoreboard players set #temp Searched -1
execute if block 703 20 71 minecraft:warped_door[powered=false] run scoreboard players set #temp Searched -1
execute if block 706 20 37 minecraft:warped_door[powered=false] run scoreboard players set #temp Searched -1
execute if block 703 20 72 minecraft:acacia_trapdoor[open=false] run scoreboard players set #temp Searched -1
execute if block 703 21 72 minecraft:acacia_trapdoor[open=false] run scoreboard players set #temp Searched -1
...
execute if score #temp Searched matches -1 run fill 703 20 71 703 21 71 minecraft:air replace #minecraft:doors
execute if score #temp Searched matches -1 run fill 685 20 71 685 21 71 minecraft:air replace #minecraft:doors
execute if score #temp Searched matches -1 run fill 706 20 36 706 21 36 minecraft:air replace minecraft:acacia_trapdoor
execute if score #temp Searched matches -1 run fill 703 20 72 703 21 72 minecraft:air replace minecraft:acacia_trapdoor
execute if score #temp Searched matches -1 run fill 685 20 72 685 21 72 minecraft:air replace minecraft:acacia_trapdoor
...
execute if score #temp Searched matches -1 run setblock 703 20 71 minecraft:warped_door[open=false,facing=north,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches -1 run setblock 703 21 71 minecraft:warped_door[open=false,facing=north,half=upper,hinge=right,powered=true]
execute if score #temp Searched matches -1 run setblock 685 20 71 minecraft:warped_door[open=false,facing=north,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches -1 run setblock 685 21 71 minecraft:warped_door[open=false,facing=north,half=upper,hinge=left,powered=true]
