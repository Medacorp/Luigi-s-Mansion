...
execute unless block 736 11 37 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/fortune_tellers_room/search/boo_check/table_1
execute unless block 736 11 36 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/fortune_tellers_room/search/boo_check/table_1