...
execute as @a[gamemode=!spectator,x=724,y=26,z=24,dx=16,dy=10,dz=8] unless entity @s[scores={Room=52}] run scoreboard players operation @s LastRoom = @s Room
execute as @e[tag=!spectator,x=724,y=26,z=24,dx=16,dy=10,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 52
