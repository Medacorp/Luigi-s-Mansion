...
execute as @e[type=!minecraft:item_frame,x=777,y=5,z=-14,dx=51,dy=37,dz=55] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 74
