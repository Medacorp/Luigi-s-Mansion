...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 739 29.3 -14.0 run function luigis_mansion:spawn_entities/item/small_heart
...
data merge block 738 29 -14 {LootTable:"luigis_mansion:search"}
data merge block 738 29 -15 {LootTable:"luigis_mansion:search"}
tag @e[x=738.5,y=29,z=-13.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
tag @e[x=738.5,y=29,z=-13.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn