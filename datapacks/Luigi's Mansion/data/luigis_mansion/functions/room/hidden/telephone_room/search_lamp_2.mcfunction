...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 744 33 6 run function luigis_mansion:spawn_entities/item/small_heart
