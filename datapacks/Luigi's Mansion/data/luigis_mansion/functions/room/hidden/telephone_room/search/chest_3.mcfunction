...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 754.0 30 11 run function luigis_mansion:room/hidden/telephone_room/chest_3
...
tag @e[x=753.5,y=29,z=11.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn