...
execute unless block 741 29 13 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/telephone_room/search/boo_check/closet_2
execute unless block 742 29 13 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/telephone_room/search/boo_check/closet_2