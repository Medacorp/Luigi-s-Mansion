...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 707 23 73 run function luigis_mansion:room/hidden/sealed_room/chest_2
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 681 22 73 run function luigis_mansion:blocks/dust_no_sound
