...
execute as @e[type=!minecraft:item_frame,x=693,y=19,z=70,dx=17,dy=8,dz=33] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 66
