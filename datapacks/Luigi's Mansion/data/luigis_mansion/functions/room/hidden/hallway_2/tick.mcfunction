...
execute as @e[type=!minecraft:item_frame,x=722,y=19,z=-65,dx=8,dy=8,dz=38] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 7
...
function luigis_mansion:room/hidden/hallway_2/ghosts
