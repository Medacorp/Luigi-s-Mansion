...
execute as @e[type=!minecraft:item_frame,x=686,y=11,z=30,dx=26,dy=6,dz=8] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 12
