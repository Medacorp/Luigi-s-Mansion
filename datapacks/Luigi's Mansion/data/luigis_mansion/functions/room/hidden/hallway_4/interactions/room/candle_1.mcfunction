execute if score #hallway_4_candle_1 Searched matches 1 run setblock 697 13 32 minecraft:tripwire_hook[facing=south]
...
execute unless score #hallway_4_candle_1 Searched matches 1 run setblock 697 13 32 minecraft:redstone_wall_torch[facing=south,lit=true]
