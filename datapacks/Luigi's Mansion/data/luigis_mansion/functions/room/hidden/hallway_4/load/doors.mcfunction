...
tag @e[x=707.5,y=11,z=37.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_4_ball_room
...
tag @e[x=706.5,y=11,z=32.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_4_dining_room
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=691.5,y=11,z=37.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add fake
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=691.5,y=11,z=32.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add fake