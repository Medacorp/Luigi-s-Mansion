...
execute unless block 662 20 90 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/astral_hall/search/boo_check/table_1