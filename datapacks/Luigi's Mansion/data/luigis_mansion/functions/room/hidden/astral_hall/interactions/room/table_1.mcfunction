...
execute if score #astral_hall_table_1 Searching matches 20 run function luigis_mansion:room/hidden/astral_hall/search/table_1
...
execute unless block 662 20 90 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/astral_hall/search/table_1