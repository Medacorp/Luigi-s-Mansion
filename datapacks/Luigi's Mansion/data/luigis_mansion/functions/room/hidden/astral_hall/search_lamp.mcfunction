...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 666 23 97 run function luigis_mansion:room/hidden/astral_hall/lamp
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 666 24 97 run function luigis_mansion:blocks/dust
