...
execute if score #billiards_room_darting_board Searching matches 20 run function luigis_mansion:room/hidden/billiards_room/search/boo_check/darting_board
