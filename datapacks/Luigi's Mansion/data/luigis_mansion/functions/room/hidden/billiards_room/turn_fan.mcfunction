...
execute if score #billiards_room_fan HomeRot matches 90..179 run setblock 664 15 -59 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_mansion:fan",rotation:"COUNTERCLOCKWISE_90"}
...
execute if score #billiards_room_fan HomeRot matches 270..359 run setblock 671 15 -66 minecraft:structure_block[mode=load]{mode:"LOAD",name:"luigis_mansion:fan",rotation:"CLOCKWISE_90"}
