...
execute if score #billiards_room_painting_6 Searching matches 20 run function luigis_mansion:room/hidden/billiards_room/search/boo_check/painting_6
scoreboard players operation #temp Searching = #billiards_room_painting_6 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 677 13 -51 run function luigis_mansion:blocks/search_sound/generic
