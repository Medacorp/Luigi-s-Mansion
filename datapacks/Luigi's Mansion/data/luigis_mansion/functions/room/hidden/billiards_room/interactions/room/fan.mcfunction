...
execute if score #billiards_room_fan Searching matches 200 run function luigis_mansion:room/hidden/billiards_room/search/fan
scoreboard players operation #temp Searching = #billiards_room_fan Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 if score #billiards_room_fan Search matches 1 positioned 681.0 16 -62.0 run function luigis_mansion:blocks/search_sound/heavy_generic
scoreboard players reset #temp Searching
function luigis_mansion:room/hidden/billiards_room/turn_fan
