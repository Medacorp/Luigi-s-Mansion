...
execute unless entity @e[x=700.5,y=11,z=-69.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function luigis_mansion:room/hidden/kitchen/search/dish_washer
