...
execute unless data storage luigis_mansion:data current_state.current_data.technical_data{extinguished_kitchen_fire:1b} run tag @e[x=699.0,y=11,z=-72.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add burning