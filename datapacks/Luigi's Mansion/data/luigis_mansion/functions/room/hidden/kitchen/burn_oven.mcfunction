...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 701 11 -59.0 run function luigis_mansion:room/hidden/kitchen/oven
