...
execute as @e[type=!minecraft:item_frame,x=697,y=10,z=-77,dx=14,dy=8,dz=31] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 27
