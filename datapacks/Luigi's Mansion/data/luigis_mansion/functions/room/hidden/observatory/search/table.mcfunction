...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 641 21 91.0 run function luigis_mansion:room/hidden/observatory/table
