...
execute if score #observatory_telescope Searching matches 20 if block 645 24 93 minecraft:redstone_lamp run function luigis_mansion:room/hidden/observatory/search_telescope