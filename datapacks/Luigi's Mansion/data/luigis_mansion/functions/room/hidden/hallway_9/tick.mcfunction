...
execute as @e[type=!minecraft:item_frame,x=679,y=19,z=-3,dx=6,dy=8,dz=42] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 35
