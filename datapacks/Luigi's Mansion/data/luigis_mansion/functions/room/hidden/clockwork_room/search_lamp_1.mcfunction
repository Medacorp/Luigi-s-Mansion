...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 691 124 -1 run function luigis_mansion:room/hidden/clockwork_room/lamp_1
