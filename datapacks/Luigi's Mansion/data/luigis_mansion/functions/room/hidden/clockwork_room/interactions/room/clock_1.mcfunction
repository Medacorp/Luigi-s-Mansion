...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.clock.whistle_down block @a[scores={Room=62}] 684 121 -7 1
execute if score #temp Searched matches 25 run playsound luigis_mansion:block.clock.whistle_up block @a[scores={Room=62}] 684 121 -7 1
