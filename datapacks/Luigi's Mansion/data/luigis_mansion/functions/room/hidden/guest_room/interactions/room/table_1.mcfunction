...
execute unless block 742 21 67 minecraft:redstone_lamp if score #guest_room_table_1 Searching matches 20 run function luigis_mansion:room/hidden/guest_room/search/boo_check/table_1
execute unless block 742 21 67 minecraft:redstone_lamp unless block 736 20 61 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/guest_room/search/boo_check/table_1
execute unless block 742 21 67 minecraft:redstone_lamp unless block 736 20 60 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/guest_room/search/boo_check/table_1
...
execute if score #temp Searching matches 1 unless block 742 21 67 minecraft:redstone_lamp positioned 736 20 61.0 run function luigis_mansion:blocks/search_sound/generic
