...
execute unless score #temp Searching matches 1 if block 742 21 67 minecraft:redstone_lamp positioned 736 20 75 run function luigis_mansion:blocks/search_sound/heavy_generic
