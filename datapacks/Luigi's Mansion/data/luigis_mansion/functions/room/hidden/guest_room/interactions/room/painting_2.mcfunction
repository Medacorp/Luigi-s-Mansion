...
execute unless block 742 21 67 minecraft:redstone_lamp if score #guest_room_painting_2 Searching matches 20 run function luigis_mansion:room/hidden/guest_room/search/boo_check/painting_2
...
execute if score #temp Searching matches 1 unless block 742 21 67 minecraft:redstone_lamp positioned 736 23 67 run function luigis_mansion:blocks/search_sound/generic
