...
execute positioned 729.0 21 74.0 run function luigis_mansion:blocks/dust_no_sound
scoreboard players set #guest_room_bed Searched 1
tag @e[x=742.5,y=20,z=73.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
tag @e[x=742.5,y=20,z=73.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn