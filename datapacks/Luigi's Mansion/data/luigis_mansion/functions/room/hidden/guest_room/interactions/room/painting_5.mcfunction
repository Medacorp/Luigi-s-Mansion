...
execute if score #temp Searching matches 1 unless block 742 21 67 minecraft:redstone_lamp positioned 746 23 75.0 run function luigis_mansion:blocks/search_sound/generic
