...
execute unless block 742 21 67 minecraft:redstone_lamp if score #guest_room_painting_5 Searching matches 20 run function luigis_mansion:room/hidden/guest_room/search/painting_5
