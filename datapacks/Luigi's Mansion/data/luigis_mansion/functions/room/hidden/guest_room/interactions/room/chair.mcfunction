...
execute unless block 742 21 67 minecraft:redstone_lamp if score #guest_room_chair Searching matches 20 run function luigis_mansion:room/hidden/guest_room/search/chair
...
execute unless score #temp Searching matches 1 if block 742 21 67 minecraft:redstone_lamp positioned 738 20 60 run function luigis_mansion:blocks/search_sound/generic
