...
execute if block 742 21 67 minecraft:redstone_lamp if entity @s[x=744.5,y=26,z=76.5,distance=..0.7,tag=sound] run function luigis_mansion:blocks/search_sound/generic
...
execute unless block 742 21 67 minecraft:redstone_lamp if entity @s[x=744.5,y=20,z=76.5,distance=..0.7,tag=sound] run function luigis_mansion:blocks/search_sound/generic
