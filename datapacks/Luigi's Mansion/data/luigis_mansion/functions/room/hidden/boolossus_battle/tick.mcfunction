...
execute as @e[tag=!spectator,x=562,y=13,z=-9,dx=48,dy=78,dz=87] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 75
