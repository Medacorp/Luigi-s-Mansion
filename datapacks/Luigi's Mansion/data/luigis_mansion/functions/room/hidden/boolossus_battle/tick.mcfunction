...
execute as @e[type=!minecraft:item_frame,x=562,y=15,z=-9,dx=48,dy=76,dz=87] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 75
