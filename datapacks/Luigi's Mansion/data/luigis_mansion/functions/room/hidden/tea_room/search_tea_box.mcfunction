...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 643 22 67 run function luigis_mansion:spawn_entities/item/small_heart
...
tag @e[x=643.5,y=21,z=67.5,distance=..0.7,tag=hidden_boo] add spawn
