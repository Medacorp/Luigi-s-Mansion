...
execute as @e[type=!minecraft:item_frame,x=637,y=19,z=44,dx=12,dy=8,dz=33] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 34
