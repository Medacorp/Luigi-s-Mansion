...
execute as @e[type=!minecraft:item_frame,x=697,y=19,z=10,dx=15,dy=8,dz=8] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 38
