...
execute as @e[type=!minecraft:item_frame,x=697,y=19,z=30,dx=15,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 38
