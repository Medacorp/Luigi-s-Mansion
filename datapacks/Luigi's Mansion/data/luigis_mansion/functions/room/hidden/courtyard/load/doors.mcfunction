...
tag @e[x=653.0,y=102,z=-5.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_6_courtyard
...
tag @e[x=653.0,y=102,z=53.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add courtyard_rec_room
