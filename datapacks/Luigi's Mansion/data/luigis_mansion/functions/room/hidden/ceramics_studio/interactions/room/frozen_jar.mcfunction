...
execute if score #ceramics_studio_frozen_jar Searching matches 20 run function luigis_mansion:room/hidden/ceramics_studio/search/boo_check/frozen_jar
...
execute unless block 707 30 -46 minecraft:hopper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/ceramics_studio/search/boo_check/frozen_jar