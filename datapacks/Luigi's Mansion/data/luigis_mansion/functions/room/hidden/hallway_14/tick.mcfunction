...
execute as @e[type=!minecraft:item_frame,x=712,y=19,z=58,dx=8,dy=17,dz=12] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 40
