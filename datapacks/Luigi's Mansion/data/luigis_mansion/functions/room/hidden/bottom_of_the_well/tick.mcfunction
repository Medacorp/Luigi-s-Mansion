...
execute as @e[type=!minecraft:item_frame,x=645,y=92,z=14,dx=6,dy=6,dz=10] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 31
