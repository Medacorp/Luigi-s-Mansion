...
execute if score #graveyard_gravestone_6 Searching matches 20 run function luigis_mansion:room/hidden/graveyard/search/gravestone_6
scoreboard players operation #temp Searching = #graveyard_gravestone_6 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 667.0 103 -28.0 run function luigis_mansion:blocks/search_sound/stone
