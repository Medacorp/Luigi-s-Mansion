...
execute if score #graveyard_gravestone_4 Searching matches 20 run function luigis_mansion:room/hidden/graveyard/search/gravestone_4
scoreboard players operation #temp Searching = #graveyard_gravestone_4 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 649 104 -32 run function luigis_mansion:blocks/search_sound/stone
