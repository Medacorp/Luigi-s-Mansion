...
execute as @e[type=!minecraft:item_frame,x=671,y=101,z=-41,dx=14,dy=8,dz=19] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 28
