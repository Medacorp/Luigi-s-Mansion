...
teleport @s[scores={HomeY=107,HomeZ=-40..-28,HomeX=672..683}] ~ ~-1 ~
teleport @s[scores={HomeY=107,HomeX=684}] ~ ~3 ~
teleport @s[scores={HomeY=107,HomeZ=-27..-24,HomeX=672..673}] ~ ~-1 ~
teleport @s[scores={HomeY=107,HomeZ=-27..-24,HomeX=674..678}] ~ ~3 ~
teleport @s[scores={HomeY=107,HomeZ=-27..-24,HomeX=679..683}] ~ ~-1 ~
