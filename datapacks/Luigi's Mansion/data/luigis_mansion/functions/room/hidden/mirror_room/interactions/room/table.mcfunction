...
execute unless block 741 11 76 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/mirror_room/search/boo_check/table
execute unless block 740 11 76 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/mirror_room/search/boo_check/table