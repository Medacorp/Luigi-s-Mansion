...
execute as @e[type=!minecraft:item_frame,x=712,y=19,z=-23,dx=17,dy=8,dz=21] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 3
