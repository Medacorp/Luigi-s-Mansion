...
execute as @e[type=!minecraft:item_frame,x=660,y=10,z=-33,dx=8,dy=8,dz=14] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 19
