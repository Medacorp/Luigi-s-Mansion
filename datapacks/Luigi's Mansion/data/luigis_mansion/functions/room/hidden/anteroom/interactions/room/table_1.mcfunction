...
execute unless block 685 21 -26 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/anteroom/search/boo_check/table_1
execute unless block 685 21 -25 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/anteroom/search/boo_check/table_1