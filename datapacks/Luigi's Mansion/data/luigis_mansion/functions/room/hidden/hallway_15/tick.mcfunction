...
execute as @e[type=!minecraft:item_frame,x=712,y=28,z=44,dx=7,dy=8,dz=13] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 41
...
function luigis_mansion:room/hidden/hallway_15/ghosts
