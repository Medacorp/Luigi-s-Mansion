...
execute as @e[type=!minecraft:item_frame,x=712,y=10,z=-62,dx=8,dy=8,dz=20] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 22
