...
execute as @e[type=!minecraft:item_frame,x=712,y=10,z=-62,dx=8,dy=8,dz=20] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 22
