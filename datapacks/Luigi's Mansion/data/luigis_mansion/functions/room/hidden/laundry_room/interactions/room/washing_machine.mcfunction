...
execute unless block 714 12 -58 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/laundry_room/search/washing_machine