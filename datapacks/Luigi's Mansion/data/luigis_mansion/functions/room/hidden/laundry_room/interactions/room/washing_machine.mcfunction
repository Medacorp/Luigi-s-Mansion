...
execute if score #laundry_room_washing_machine Searching matches 20 run function luigis_mansion:room/hidden/laundry_room/search/boo_check/washing_machine
