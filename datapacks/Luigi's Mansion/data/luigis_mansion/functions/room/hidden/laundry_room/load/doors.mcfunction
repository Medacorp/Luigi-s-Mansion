...
tag @e[x=716.5,y=11,z=-43.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_3_laundry_room
...
execute positioned 713 11 -50 rotated -90 0 run function luigis_mansion:spawn_furniture/door/right/pull/mansion/1
execute positioned 713 11 -50 rotated -90 0 run function luigis_mansion:spawn_furniture/door_frame/blue_stones
tag @e[x=714.0,y=11,z=-49.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add fake