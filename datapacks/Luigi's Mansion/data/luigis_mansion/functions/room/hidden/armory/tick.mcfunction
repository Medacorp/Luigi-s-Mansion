...
execute as @e[type=!minecraft:item_frame,x=744,y=28,z=-64,dx=22,dy=8,dz=25] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 64
