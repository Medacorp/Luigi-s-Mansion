...
execute unless block 761 29 -59 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/armory/search/boo_check/chest_2
execute unless block 760 29 -59 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/armory/search/boo_check/chest_2