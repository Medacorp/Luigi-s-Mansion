...
execute as @e[type=!minecraft:item_frame,x=734,y=19,z=34,dx=14,dy=8,dz=20] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 69
