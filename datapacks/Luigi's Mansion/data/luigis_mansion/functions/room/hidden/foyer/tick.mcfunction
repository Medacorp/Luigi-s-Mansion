...
execute as @e[type=!minecraft:item_frame,x=743,y=10,z=-4,dx=15,dy=17,dz=21] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 1
