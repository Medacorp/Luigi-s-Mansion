execute if score #twins_room Wave matches 6 unless entity @e[tag=ghost,scores={Room=49},tag=!optional_ghost] run function luigis_mansion:room/hidden/twins_room/clear
