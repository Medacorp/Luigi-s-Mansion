...
execute as @e[type=!minecraft:item_frame,x=687,y=28,z=70,dx=16,dy=8,dz=25] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 71
