...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 661 20 41 run function luigis_mansion:room/hidden/nanas_room/closet
...
tag @e[x=661.5,y=20,z=42.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
