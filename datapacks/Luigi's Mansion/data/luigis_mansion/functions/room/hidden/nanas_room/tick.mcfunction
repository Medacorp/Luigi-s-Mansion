...
execute as @e[type=!minecraft:item_frame,x=652,y=19,z=16,dx=12,dy=8,dz=28] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 44
