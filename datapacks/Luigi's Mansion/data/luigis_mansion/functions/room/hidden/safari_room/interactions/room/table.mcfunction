...
execute if score #safari_room_table Searching matches 20 run function luigis_mansion:room/hidden/safari_room/search/boo_check/table
...
execute unless block 743 30 71 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion:room/hidden/safari_room/search/boo_check/table