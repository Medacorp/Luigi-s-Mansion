...
execute as @e[type=!minecraft:item_frame,x=713,y=10,z=-10,dx=7,dy=8,dz=60] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 11
