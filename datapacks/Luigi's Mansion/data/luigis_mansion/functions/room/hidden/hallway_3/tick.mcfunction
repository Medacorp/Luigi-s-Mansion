...
execute as @e[type=!minecraft:item_frame,x=713,y=10,z=-10,dx=7,dy=8,dz=60] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 11
