...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=small_heart] positioned 681 12 70 run function luigis_mansion:spawn_entities/item/small_heart
...
tag @e[x=681.5,y=11,z=70.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
