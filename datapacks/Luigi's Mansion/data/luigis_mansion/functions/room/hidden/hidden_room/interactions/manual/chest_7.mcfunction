...
execute if entity @s[x=743.0,y=11,z=-18.0,dx=1,dy=0,dz=0,tag=!sound,tag=!check] run function luigis_mansion:room/hidden/hidden_room/search/boo_check/chest_7