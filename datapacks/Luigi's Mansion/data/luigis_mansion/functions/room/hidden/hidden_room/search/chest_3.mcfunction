...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 746 12 -27.0 run function luigis_mansion:room/hidden/hidden_room/chest_3
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 752 11 -27.0 run function luigis_mansion:blocks/dust_no_sound
...
tag @e[x=746.5,y=11,z=-27.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
