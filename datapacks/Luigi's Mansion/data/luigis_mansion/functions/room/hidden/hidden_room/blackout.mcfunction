...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{hidden_room_speedy_spirit:1b} positioned 744 11 -18 run function luigis_mansion:spawn_entities/ghost/can_spawn_now/speedy_spirit
