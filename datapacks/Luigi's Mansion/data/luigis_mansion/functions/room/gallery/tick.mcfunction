...
execute as @e[type=!minecraft:item_frame,x=729,y=77,z=-40,dx=48,dy=9,dz=23] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room -4
