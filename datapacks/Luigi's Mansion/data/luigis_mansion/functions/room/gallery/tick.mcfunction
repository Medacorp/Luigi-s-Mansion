...
execute as @e[x=729,y=77,z=-40,dx=48,dy=9,dz=23] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -4
