...
execute as @a[gamemode=!spectator,x=729,y=77,z=-40,dx=48,dy=9,dz=23] unless entity @s[scores={Room=-4}] run scoreboard players set @s LastRoom -4
execute as @e[type=!minecraft:item_frame,x=729,y=77,z=-40,dx=48,dy=9,dz=23] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room -4
