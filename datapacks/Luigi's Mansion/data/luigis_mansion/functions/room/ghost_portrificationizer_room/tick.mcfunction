...
execute as @a[gamemode=!spectator,x=765,y=77,z=-14,dx=12,dy=6,dz=36] unless entity @s[scores={Room=-3}] run scoreboard players set @s LastRoom -3
execute as @e[type=!minecraft:painting,type=!minecraft:item_frame,x=765,y=77,z=-14,dx=12,dy=6,dz=36] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room -3
execute as @e[type=minecraft:item_frame,tag=portrait,x=765,y=77,z=-14,dx=12,dy=6,dz=36] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room -3
