...
execute as @e[type=!minecraft:painting,type=!minecraft:item_frame,x=765,y=77,z=-14,dx=12,dy=6,dz=36] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room -3
