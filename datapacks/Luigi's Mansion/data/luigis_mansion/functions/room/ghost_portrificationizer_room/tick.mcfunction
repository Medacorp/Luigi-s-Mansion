...
execute as @e[x=765,y=77,z=-14,dx=12,dy=6,dz=36] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -3
