...
tag @e[x=778.0,y=77,z=16.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add unopenable
execute positioned 772 77 -15 rotated 0 0 run function luigis_mansion:spawn_furniture/door/left/pull/lab
tag @e[x=772.5,y=77,z=-14.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add unopenable
