...
execute if predicate luigis_mansion:50_50 at @e[type=minecraft:marker,tag=choice,sort=random,limit=1] run function luigis_mansion:room/training_room/spawn_dummy_ghost
