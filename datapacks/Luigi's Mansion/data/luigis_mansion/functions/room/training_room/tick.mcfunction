...
execute as @e[x=783,y=75,z=-20,dx=15,dy=8,dz=23] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -2
