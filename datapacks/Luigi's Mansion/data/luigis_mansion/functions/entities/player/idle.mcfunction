...
execute if entity @s[scores={IdleTime=20..,Health=31..},tag=cold_room,tag=!high_health_idle,tag=!low_health_idle] run function luigis_mansion:entities/player/animation/cold_room_idle
