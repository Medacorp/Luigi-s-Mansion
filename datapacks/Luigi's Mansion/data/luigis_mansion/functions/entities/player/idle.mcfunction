...
execute if entity @s[scores={IdleTime=20..,Health=..30},tag=!high_health_idle,tag=!cold_room_idle] run function luigis_mansion:entities/player/animation/low_health_idle
execute if entity @s[scores={IdleTime=20..,Health=31..},tag=cold_room,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] run function luigis_mansion:entities/player/animation/cold_room_idle
execute if entity @s[scores={IdleTime=20..,Health=31..},tag=cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] run function luigis_mansion:entities/player/animation/cold_room_idle
execute if entity @s[scores={IdleTime=200..,Health=31..},tag=!cold_room,tag=!low_health_idle,tag=!cold_room_idle] run function luigis_mansion:entities/player/animation/high_health_idle
