...
execute at @s rotated ~ 0 if block ^0.5 ^0.2 ^ #luigis_mansion:ghosts_ignore run tag @s add can_move_left
execute at @s rotated ~ 0 if block ^-0.5 ^0.2 ^ #luigis_mansion:ghosts_ignore run tag @s add can_move_right
