...
execute unless entity @s[scores={KnockbackTime=1..}] unless entity @s[scores={ScareType=3..,ScareTime=22..}] run summon minecraft:marker ~ ~ ~ {Tags:["temp"]}
...
execute unless entity @s[scores={KnockbackTime=1..}] unless entity @s[scores={ScareType=3..,ScareTime=22..}] run scoreboard players set @s ScareType 3