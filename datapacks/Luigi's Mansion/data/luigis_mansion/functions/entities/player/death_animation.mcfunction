...
execute if entity @s[scores={DeathTime=60..},tag=!turn_spectator] if score #can_revive Selected matches 1 if score #mirrored Selected matches 0 unless entity @e[tag=detect_exists,limit=1] positioned ^0.9 ^ ^ run function luigis_mansion:spawn_entities/revive_detection
execute if entity @s[scores={DeathTime=60..},tag=!turn_spectator] if score #can_revive Selected matches 1 if score #mirrored Selected matches 1 unless entity @e[tag=detect_exists,limit=1] positioned ^-0.9 ^ ^ run function luigis_mansion:spawn_entities/revive_detection
