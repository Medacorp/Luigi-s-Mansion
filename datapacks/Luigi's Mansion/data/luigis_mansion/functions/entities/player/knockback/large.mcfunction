...
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={KnockbackType=1..7}] run scoreboard players set @s KnockbackTime 60
...
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={KnockbackType=1..7}] run scoreboard players set @s KnockbackType 4