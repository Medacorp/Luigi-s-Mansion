...
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={KnockbackType=1..6}] run scoreboard players set @s KnockbackTime 40
...
execute if entity @s[scores={Invulnerable=0}] unless entity @s[scores={KnockbackType=1..6}] run scoreboard players set @s KnockbackType 5