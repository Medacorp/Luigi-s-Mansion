execute store result storage luigis_mansion:data current_state.my_money_data.money.gold_diamond int 1 run scoreboard players get #temp ActionTime
scoreboard players operation #temp2 ActionTime += #temp ActionTime
execute store result storage luigis_mansion:data current_state.my_money.money.gold_diamond int 1 run scoreboard players get #temp2 ActionTime
