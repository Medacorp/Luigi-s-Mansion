...
execute if score #temp2 LastTotalDamage matches 0 if score #temp ActionTime matches 1.. positioned ~ ~2 ~ run function luigis_mansion:entities/player/damage/bill/drop/one
...
execute unless score #temp LastTotalDamage = #temp TotalDamage if score #temp ActionTime matches 1.. run function luigis_mansion:entities/player/damage/bill/drop/loop