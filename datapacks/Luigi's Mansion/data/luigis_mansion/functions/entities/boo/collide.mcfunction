...
execute if entity @s[tag=attack] run scoreboard players set @a[tag=!spectator,distance=..0.7] ForcedDamage 4
execute if entity @s[tag=!attack] run scoreboard players set @a[tag=!spectator,distance=..0.7] ForcedDamage -1
advancement grant @a[tag=!spectator,distance=..0.7] only luigis_mansion:challenges/waluigi_pinball boo
execute if entity @s[tag=attack] as @a[tag=!spectator,distance=..0.7] run function luigis_mansion:entities/player/knockback/large
execute if entity @s[tag=!attack] as @a[tag=!spectator,distance=..0.7] run function luigis_mansion:entities/player/knockback/medium
