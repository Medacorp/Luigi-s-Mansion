...
execute if entity @s[tag=captured] run function luigis_mansion:entities/vincent_van_gore/at_death
...
execute at @s[tag=fleeing] run function luigis_mansion:animations/vincent_van_gore/flee
