...
execute if entity @s[scores={Sound=0}] unless entity @s[tag=!long_shake,scores={AnimationProg=3}] unless entity @s[tag=!long_shake,scores={AnimationProg=0}] unless entity @s[tag=long_shake,scores={AnimationProg=2..10}] unless entity @s[tag=long_shake,scores={AnimationProg=12..16}] run function luigis_mansion:entities/furniture/tick/shake_sound
