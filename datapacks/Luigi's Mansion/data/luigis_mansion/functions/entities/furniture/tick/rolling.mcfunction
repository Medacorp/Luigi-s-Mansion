...
scoreboard players add @s[tag=in_vacuum,tag=searchable_by_vacuum,scores={FurnitureSearch=1..20}] FurnitureSearch 1
execute unless entity @s[scores={FurnitureSearch=1..}] run function luigis_mansion:entities/furniture/tick/roll
