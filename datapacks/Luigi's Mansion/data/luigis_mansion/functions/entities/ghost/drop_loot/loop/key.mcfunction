...
data modify entity @e[tag=this_entity,limit=1] Tags append from storage luigis_mansion:data drop_loot.key[0].door
execute if data storage luigis_mansion:data drop_loot.key[0].rotation run tag @e[tag=this_entity,limit=1] add rotated
execute if data storage luigis_mansion:data drop_loot.key[0].rotation run data modify entity @e[tag=this_entity,limit=1] Rotation set from storage luigis_mansion:data drop_loot.key[0].rotation
execute store result score #temp Time run data get storage luigis_mansion:data drop_loot.key[0].variant
...
data remove storage luigis_mansion:data drop_loot.key[0]
