...
execute if score #temp MoveFlee matches 1.. positioned as @s if entity @a[tag=vacuuming,distance=..6,limit=1] run function luigis_mansion:entities/ghost/move_flee