...
execute at @s[scores={DeathTime=1},tag=!dont_drop_heart] unless entity @s[scores={Room=..-1}] if entity @s[scores={Health=-2147483648..}] if entity @a[tag=killer,limit=1,scores={GhostCount=2..}] if score #heart_coin_count Selected matches 1.. run function luigis_mansion:spawn_entities/item/small_heart
