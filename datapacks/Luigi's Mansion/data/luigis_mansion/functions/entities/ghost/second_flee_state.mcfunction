...
execute at @s[scores={SecondFleeState=50}] as @a[tag=!spectator,tag=vacuuming_this_ghost] facing entity @s feet run function luigis_mansion:entities/player/knockback/large