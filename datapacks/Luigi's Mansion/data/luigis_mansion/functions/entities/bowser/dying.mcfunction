...
execute if entity @s[scores={Dialog=3}] run playsound luigis_mansion:entity.bowser.head_land hostile @a[tag=same_room] ~ ~ ~ 3
execute if entity @s[scores={Dialog=3..6}] run teleport @s ~ ~0.2 ~ ~ 0
execute if entity @s[scores={Dialog=7..10}] run teleport @s ~ ~-0.2 ~ ~ 0
execute if entity @s[scores={Dialog=11}] run playsound luigis_mansion:entity.bowser.head_land hostile @a[tag=same_room] ~ ~ ~ 3 0.8
