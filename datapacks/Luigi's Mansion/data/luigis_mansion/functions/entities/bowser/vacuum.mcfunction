...
execute if entity @s[scores={AnimationProg=1}] run playsound luigis_mansion:entity.bowser.vacuum_start hostile @a[tag=same_room] ~ ~ ~ 3
...
execute if entity @s[scores={AnimationProg=21..30,Sound=0}] run playsound luigis_mansion:entity.bowser.vacuum hostile @a[tag=same_room] ~ ~ ~ 3
scoreboard players set @s[scores={AnimationProg=21..30,Sound=0}] Sound 20
...
tag @s[scores={AnimationProg=40}] remove can_decapitate
...
execute if entity @s[scores={AnimationProg=86}] run playsound luigis_mansion:entity.bowser.vacuum_spit hostile @a[tag=same_room] ~ ~ ~ 3
...
tag @s[scores={AnimationProg=121}] remove can_decapitate
