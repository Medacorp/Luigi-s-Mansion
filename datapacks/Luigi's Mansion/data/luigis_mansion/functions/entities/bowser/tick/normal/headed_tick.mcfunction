...
execute if score #temp Time matches -3..3 if entity @s[tag=intro_done] unless entity @s[scores={ActionTime=1..}] if entity @a[distance=..12,gamemode=!spectator] run function luigis_mansion:entities/bowser/select_closeby
execute if score #temp Time matches -3..3 if entity @s[tag=intro_done] unless entity @s[scores={ActionTime=1..}] unless entity @a[distance=..12,gamemode=!spectator] if entity @a[distance=12..,gamemode=!spectator] run function luigis_mansion:entities/bowser/select_distant
...
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~ ~-3 ~2 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~1 ~-3 ~1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~-1 ~-3 ~1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~2 ~-3 ~ if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~-2 ~-3 ~ if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~1 ~-3 ~-1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~-1 ~-3 ~-1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~ ~-3 ~-2 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/normal/destroy_pillar