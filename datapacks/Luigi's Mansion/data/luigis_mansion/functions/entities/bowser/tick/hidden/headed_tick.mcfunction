...
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~ ~ ~2 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~1 ~ ~1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~-1 ~ ~1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~2 ~ ~ if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~-2 ~ ~ if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
execute unless entity @s[tag=!walk,tag=!run,tag=!headless_run] positioned ~1 ~ ~-1 if block ~ ~1 ~ minecraft:clay run function luigis_mansion:entities/bowser/tick/hidden/destroy_pillar
