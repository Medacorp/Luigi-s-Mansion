...
execute if entity @s[scores={AnimationProg=1}] run playsound luigis_mansion:entity.bowser.charge hostile @a[tag=same_room] ~ ~ ~ 3
...
execute if entity @s[scores={AnimationProg=30}] run playsound luigis_mansion:entity.bowser.jump hostile @a[tag=same_room] ~ ~ ~ 3
...
tag @s[scores={AnimationProg=80}] add can_decapitate
tag @s[scores={AnimationProg=100}] remove can_decapitate
execute if entity @s[scores={AnimationProg=80}] run playsound luigis_mansion:entity.bowser.land hostile @a[tag=same_room] ~ ~ ~ 3
