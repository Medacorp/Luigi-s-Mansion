execute at @s[tag=!fight,tag=!vanish] run function luigis_mansion:entities/bogmire/tick/intro/hidden
execute at @s[tag=fight,tag=!vanish] run function luigis_mansion:entities/bogmire/tick/fight/hidden
