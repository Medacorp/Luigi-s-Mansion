...
execute if entity @s[scores={ActionTime=41}] as @a[distance=..5,tag=!spectator] at @s run function luigis_mansion:entities/player/scare
execute if entity @s[scores={ActionTime=41}] as @a[distance=..3,tag=!spectator] at @s run function luigis_mansion:entities/player/scare_bashed
