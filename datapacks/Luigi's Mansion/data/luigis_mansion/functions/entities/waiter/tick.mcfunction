...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!fleeing] run playsound luigis_mansion:entity.waiter.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[tag=!vanish,tag=!fleeing,tag=!hurt,scores={StunTime=0}] run function #luigis_mansion:entities/waiter/path
