...
execute if entity @e[tag=mr_luggs,scores={Dialog=..100}] run tag @s[scores={Dialog=4}] add placing_food
execute if entity @e[tag=mr_luggs,scores={Dialog=101..}] run tag @s[scores={Dialog=4}] add complain
