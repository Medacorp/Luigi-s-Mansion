...
execute if entity @s[scores={Dialog=2034..}] run summon minecraft:marker 709 27.5 73 {Tags:["random_select"]}
execute if entity @s[scores={Dialog=2034..}] run summon minecraft:marker 710 27.5 70 {Tags:["random_select"]}
execute if entity @s[scores={Dialog=2034..}] run summon minecraft:marker 711 27.5 67 {Tags:["random_select"]}
execute if entity @s[scores={Dialog=2034..}] run summon minecraft:marker 711 27.5 64 {Tags:["random_select"]}
