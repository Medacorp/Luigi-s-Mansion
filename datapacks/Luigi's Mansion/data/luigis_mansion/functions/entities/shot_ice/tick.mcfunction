...
execute positioned ~-0.5 ~-1 ~-0.5 if entity @a[dx=0,dy=1,dz=0,tag=!spectator] run tag @s[tag=!player_shot] add hit
...
execute if entity @s[tag=hit] positioned ~-0.5 ~-1 ~-0.5 as @a[dx=0,dy=1,dz=0,tag=!spectator] positioned ~0.5 ~1 ~0.5 run function luigis_mansion:entities/player/knockback/freeze
...
execute at @s positioned ~-0.5 ~-1 ~-0.5 as @e[dx=0,dy=1,dz=0,tag=!shot_ice] run function luigis_mansion:items/poltergust_3000/effect_on_entity/ice
