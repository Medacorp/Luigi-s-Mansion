...
execute if entity @s[scores={ActionTime=1}] run playsound luigis_mansion:entity.purple_puncher.spawn_beta hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=1}] as @a[tag=!spectator,distance=..5] at @s run function luigis_mansion:entities/player/scare
