execute if entity @s[tag=dying,tag=normal_death,scores={DeathTime=1}] run playsound luigis_mansion:entity.purple_puncher.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dying,tag=element_death,scores={DeathTime=1}] run playsound luigis_mansion:entity.purple_puncher.element_death hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dying,scores={DeathTime=1}] if data storage luigis_mansion:data current_state.current_data.ghosts.purple_puncher{loot_at_0:1b} run function luigis_mansion:entities/purple_puncher/drop_loot
execute if entity @s[tag=dead] unless data storage luigis_mansion:data current_state.current_data.ghosts.purple_puncher{loot_at_0:1b} run function luigis_mansion:entities/purple_puncher/drop_loot
...
execute if entity @s[scores={HurtTime=1},tag=hurt,tag=!fleeing,tag=!dying] run playsound luigis_mansion:entity.purple_puncher.hurt hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Sound=0},tag=fleeing,tag=!dying] run playsound luigis_mansion:entity.purple_puncher.flee hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Sound=0},tag=!vanish,tag=!fleeing,tag=!attack,tag=!laugh,tag=!complain,tag=!appear,tag=!basher] run playsound luigis_mansion:entity.purple_puncher.ambient hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={Sound=0}] Sound 40

execute if entity @e[tag=same_room,tag=!spectator,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!removed_from_existence,tag=!basher,tag=!hurt,tag=!fleeing,tag=!element_hurt] unless entity @s[tag=attack,scores={ActionTime=41..60}] run function luigis_mansion:entities/purple_puncher/collide
execute if entity @s[tag=!basher] run function luigis_mansion:entities/purple_puncher/select_attack/punch
execute if entity @s[tag=basher] run function luigis_mansion:entities/purple_puncher/select_attack/basher
...
execute if entity @s[tag=appear,tag=!beta_appear] run function luigis_mansion:entities/purple_puncher/appear
execute if entity @s[tag=appear,tag=beta_appear] run function luigis_mansion:entities/purple_puncher/beta_appear
