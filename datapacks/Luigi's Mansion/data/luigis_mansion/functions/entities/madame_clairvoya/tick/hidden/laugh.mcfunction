...
tag @s add laugh
execute if entity @e[scores={Room=20},tag=door,type=minecraft:villager,tag=!blockade,limit=1] run tag @e[scores={Room=20},tag=door,type=minecraft:villager] add blockade