...
execute if entity @s[tag=!dead] if entity @a[distance=..1,gamemode=!spectator,limit=1] run tag @e[tag=chauncey] add laugh
execute if entity @s[tag=!dead] unless entity @a[distance=..1,gamemode=!spectator,limit=1] run tag @e[tag=chauncey] add complain
