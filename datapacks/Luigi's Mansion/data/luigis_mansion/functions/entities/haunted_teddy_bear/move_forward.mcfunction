...
execute unless block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:entities/haunted_teddy_bear/move_forward
execute unless block ^ ^1 ^0.6 #luigis_mansion:ghosts_ignore rotated ~ 0 if block ^ ^ ^0.6 #luigis_mansion:ghosts_ignore if score #temp Move matches 1.. positioned as @s run function luigis_mansion:entities/haunted_teddy_bear/move_forward
execute at @s[tag=collision] run function luigis_mansion:entities/haunted_teddy_bear/collision
execute unless entity @s[tag=collision] if score #temp Move matches 1.. positioned as @s run function luigis_mansion:entities/haunted_teddy_bear/move_forward