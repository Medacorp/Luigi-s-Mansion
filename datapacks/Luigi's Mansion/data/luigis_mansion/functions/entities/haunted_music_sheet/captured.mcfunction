...
execute store result entity @s Pose.RightArm[0] float 1 run scoreboard players get @s HomeRotY
execute store result entity @s Pose.LeftArm[0] float 1 run scoreboard players get @s HomeRotY
