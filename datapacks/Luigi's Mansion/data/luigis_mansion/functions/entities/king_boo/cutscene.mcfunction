...
execute unless entity @s[scores={ActionTime=..20}] unless entity @s[scores={ActionTime=42..81}] run function luigis_mansion:entities/king_boo/move_forward_barrier
