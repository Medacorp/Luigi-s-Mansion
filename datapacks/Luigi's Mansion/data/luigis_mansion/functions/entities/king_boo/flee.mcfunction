...
execute if score #temp Move matches ..-1 at @s facing entity @p[tag=!spectator,tag=vacuuming] feet rotated ~-180 0 run function luigis_mansion:entities/king_boo/move_pulled
