...
scoreboard players set @s[scores={Dialog=306}] AnimationProg 0
...
scoreboard players set @s[scores={Dialog=367}] AnimationProg 0
...
execute if entity @s[scores={Dialog=367..}] as @a[tag=same_room,tag=!spectator] unless entity @s[scores={MusicGroup=0,MusicType=36}] run function luigis_mansion:other/music/set/danger
