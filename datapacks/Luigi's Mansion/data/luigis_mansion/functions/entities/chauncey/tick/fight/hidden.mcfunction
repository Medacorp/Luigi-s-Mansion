...
execute at @s[scores={Dialog=1783,PathStep=10}] run effect give @a[distance=..1,gamemode=!spectator] minecraft:instant_damage 1 0 true
execute at @s[scores={Dialog=1783,PathStep=10}] run scoreboard players set @a[distance=..1,gamemode=!spectator] ForcedDamage 4
