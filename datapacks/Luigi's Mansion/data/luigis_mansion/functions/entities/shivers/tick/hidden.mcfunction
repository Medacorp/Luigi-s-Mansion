...
execute if entity @s[scores={PathStep=43..52,Sound=0},tag=panic,tag=!vanish] run playsound luigis_mansion:entity.shivers.panic hostile @a[tag=same_room] ~ ~ ~ 1
scoreboard players set @s[scores={PathStep=43..52,Sound=0},tag=panic,tag=!vanish] Sound 40
