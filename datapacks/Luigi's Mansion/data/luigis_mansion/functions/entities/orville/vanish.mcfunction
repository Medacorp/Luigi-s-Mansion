...
execute if entity @s[scores={ActionTime=1},tag=visible] run playsound luigis_mansion:entity.orville.disappear hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={ActionTime=40}] run function luigis_mansion:entities/orville/turn_invisible
