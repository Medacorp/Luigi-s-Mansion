...
execute if entity @s[scores={ActionTime=20}] as @e[tag=ice_spike] if score @s Room = @e[distance=..0.1,limit=1,tag=ice_spike] Room run scoreboard players set @s WaitTime 0
