execute if entity @s[tag=dead,tag=normal_death] run playsound luigis_mansion:entity.haunted_plate.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dead,tag=element_death] run playsound luigis_mansion:entity.haunted_plate.element_death hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={WaitTime=60..},tag=!moving] run playsound luigis_mansion:entity.haunted_plate.spawn hostile @a[tag=same_room] ~ ~ ~ 1
