...
execute if entity @s[tag=!talk,tag=!vanish] if entity @a[gamemode=!spectator,distance=..5] run function luigis_mansion:entities/melody_pianissima/tick/normal/play
