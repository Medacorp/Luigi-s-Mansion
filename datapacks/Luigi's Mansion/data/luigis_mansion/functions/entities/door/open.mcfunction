...
execute if entity @s[tag=!locked,tag=!unlock] positioned ^ ^ ^0.5 rotated ~-180 ~ run teleport @a[tag=try_opening_door,limit=1,sort=nearest] ~ ~ ~ ~ ~
...
execute if entity @s[tag=locked] positioned ^ ^ ^0.5 rotated ~-180 ~ run teleport @a[tag=try_opening_door,limit=1,sort=nearest] ~ ~ ~ ~ ~
...
execute if entity @s[tag=unlock] positioned ^ ^ ^0.5 rotated ~-180 ~ run teleport @a[tag=try_opening_door,limit=1,sort=nearest] ~ ~ ~ ~ ~
