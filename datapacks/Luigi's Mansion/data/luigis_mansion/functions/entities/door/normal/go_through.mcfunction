...
execute in minecraft:overworld if entity @s[x=720.0,y=102,z=7.0,dx=0,dy=1,dz=0,y_rotation=0..-180] in luigis_mansion:normal run teleport @s 756.0 11 8
execute in minecraft:overworld if entity @s[x=720.0,y=102,z=8.0,dx=0,dy=1,dz=0,y_rotation=0..-180] in luigis_mansion:normal run teleport @s 756.0 11 9
#hallway 1-parlor
...
#parlor-anteroom
teleport @s[x=713.0,y=20,z=21.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 694.0 20 26
teleport @s[x=694.0,y=20,z=26.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 714.0 20 21
...
stopsound @s[x=738.0,y=20,z=58.0,dx=0,dy=1,dz=0,y_rotation=-180..0] ambient luigis_mansion:music.mansion.room.nursery
scoreboard players set @s[x=738.0,y=20,z=58.0,dx=0,dy=1,dz=0,y_rotation=-180..0] RoomNoise 0
...
#hallway 4-ball room
scoreboard players set @s[x=706.0,y=11,z=-22.0,dx=0,dy=1,dz=0,y_rotation=90..-90] RoomNoise 0
teleport @s[x=706.0,y=11,z=-22.0,dx=0,dy=1,dz=0,y_rotation=90..-90] 705 11 -38.0
teleport @s[x=705.0,y=11,z=-38.0,dx=0,dy=1,dz=0,y_rotation=-90..90] 706 11 -21.0
#ball room-storage room
teleport @s[x=696.0,y=11,z=-64.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 690.0 11 -64
teleport @s[x=690.0,y=11,z=-64.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 697.0 11 -64
...
teleport @s[x=719.0,y=11,z=-28.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 736.0 11 -32
teleport @s[x=735.0,y=11,z=-32.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 719.0 11 -28
...
teleport @s[x=719.0,y=11,z=65.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 739.0 11 61
teleport @s[x=738.0,y=11,z=61.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 719.0 11 65
#hallway 5-conservatory
stopsound @s[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0,y_rotation=-180..0] ambient luigis_mansion:music.mansion.melody
scoreboard players set @s[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0,y_rotation=-180..0] RoomNoise 0
teleport @s[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 663.0 11 -6
scoreboard players reset @s[x=663.0,y=11,z=-6.0,dx=0,dy=1,dz=0,y_rotation=0..-180] Time
teleport @s[x=663.0,y=11,z=-6.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 680.0 11 0
...
#kitchen-boneyard
scoreboard players set @s[x=698.0,y=11,z=88.0,dx=0,dy=1,dz=0,y_rotation=-180..0] RoomNoise 0
...
#hallway 6-courtyard
teleport @s[x=668.0,y=11,z=8.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 653.0 102 21
scoreboard players set @s[x=653.0,y=102,z=21.0,dx=0,dy=1,dz=0,y_rotation=0..-180] RoomNoise 0
teleport @s[x=653.0,y=102,z=21.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 669.0 11 8
#courtyard-rec room
scoreboard players set @s[x=653.0,y=102,z=-38.0,dx=0,dy=1,dz=0,y_rotation=0..-180] RoomNoise 0
teleport @s[x=653.0,y=102,z=-38.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 639.0 11 -58
teleport @s[x=638.0,y=11,z=-58.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 653.0 102 -38
#rec room-hallway 8
teleport @s[x=648.0,y=11,z=-44.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 661.0 11 -44
teleport @s[x=660.0,y=11,z=-44.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 648.0 11 -44
#hallway 5-hallway 8
...
#hallway 8-tea room
teleport @s[x=660.0,y=20,z=-44.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 648.0 20 -44
teleport @s[x=648.0,y=20,z=-44.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 661.0 20 -44
#hallway 8-hallway 9
...
stopsound @s[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0,y_rotation=0..-180] ambient luigis_mansion:music.mansion.melody
scoreboard players set @s[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0,y_rotation=0..-180] RoomNoise 0
teleport @s[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 675.0 11 70
teleport @s[x=674.0,y=11,z=70.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 685.0 11 5
...
teleport @s[x=729.0,y=20,z=56.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 738.0 20 44
teleport @s[x=737.0,y=20,z=44.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 729.0 20 56
#hallway 15-safari room
teleport @s[x=719.0,y=29,z=-34.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 734.0 29 -39
teleport @s[x=733.0,y=29,z=-39.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 719.0 29 -34
...
teleport @s[x=725.0,y=29,z=-13.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 682.0 120 -13
teleport @s[x=682.0,y=120,z=-13.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 726.0 29 -13
#balcony 2-hallway 18
teleport @s[x=682.0,y=120,z=28.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 725.0 29 44
teleport @s[x=724.0,y=29,z=44.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 682.0 120 28
...
teleport @s[x=713.0,y=2,z=-47.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 699.0 2 -47
teleport @s[x=699.0,y=2,z=-47.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 714.0 2 -47
#hallway 7-cellar
teleport @s[x=719.0,y=2,z=-47.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 736.0 2 -47
teleport @s[x=735.0,y=2,z=-47.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 719.0 2 -47
#cellar-hallway 20
...
teleport @s[x=700.0,y=2,z=-18.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 685.0 2 -18
teleport @s[x=685.0,y=2,z=-18.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 701.0 2 -18
#telephone room-clockwork room
scoreboard players set @s[x=752.0,y=29,z=6.0,dx=0,dy=1,dz=0,y_rotation=-180..0] RoomNoise 0
teleport @s[x=737.0,y=29,z=6.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 698.0 120 -4
scoreboard players reset @s[x=698.0,y=120,z=-4.0,dx=0,dy=1,dz=0,y_rotation=0..-180] Time
teleport @s[x=698.0,y=120,z=-4.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 738.0 29 6
#hallway 19-armory
...
teleport @s[x=745.0,y=29,z=58.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 712.0 29 60
teleport @s[x=712.0,y=29,z=60.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 746.0 29 58
...
teleport @s[x=719.0,y=20,z=-30.0,dx=0,dy=1,dz=0,y_rotation=0..-180] 736.0 20 -34
teleport @s[x=735.0,y=20,z=-34.0,dx=0,dy=1,dz=0,y_rotation=-180..0] 719.0 20 -30
