...
execute if entity @s[tag=hallway_22_secret_altar] if data storage luigis_mansion:data current_state.current_data.rooms.secret_altar{cleared:1b} if entity @e[x=636.5,y=94,z=33.5,distance=..0.7,type=minecraft:item_frame,nbt={Item:{id:"minecraft:painting"}},limit=1] run tag @s add locked
