...
execute if entity @s[scores={Dialog=11}] at @e[tag=same_room,tag=!spectator] positioned ^ ^ ^8 if entity @s[distance=..8] run function luigis_mansion:entities/slim_bankshot/turn_invisible
