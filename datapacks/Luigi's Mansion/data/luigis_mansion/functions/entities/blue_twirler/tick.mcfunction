execute if entity @s[tag=dying,tag=normal_death,scores={DeathTime=1}] run playsound luigis_mansion:entity.blue_twirler.vacuumed hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=dying,tag=element_death,scores={DeathTime=1}] run playsound luigis_mansion:entity.blue_twirler.element_death hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @a[tag=!spectator,distance=..0.7,limit=1] if entity @s[tag=!vanish,tag=!appear,tag=!dying,tag=!dead,tag=!removed_from_existence,tag=!basher,tag=!hurt,tag=!fleeing,tag=!element_hurt] unless entity @s[tag=attack,tag=body_slam] run function luigis_mansion:entities/blue_twirler/collide
...
execute if entity @s[tag=basher] run function luigis_mansion:entities/blue_twirler/select_attack/basher
