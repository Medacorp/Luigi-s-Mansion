...
execute if entity @s[scores={Dialog=31..421}] as @a[tag=same_room,tag=!spectator] unless entity @s[scores={MusicGroup=0,MusicType=23}] run function luigis_mansion:other/music/set/talking_ghost
...
execute if entity @s[scores={Dialog=198}] as @a[tag=same_room,tag=!spectator,tag=!stand_still,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/stand_still
...
execute if entity @s[scores={Dialog=422..}] as @a[tag=same_room,tag=!spectator] unless entity @s[scores={MusicGroup=0,MusicType=36}] run function luigis_mansion:other/music/set/danger
...
execute if entity @s[scores={Dialog=483..},tag=!vanish] run function luigis_mansion:animations/sir_weston/melted
execute unless entity @s[scores={Dialog=422..}] run function luigis_mansion:animations/sir_weston/idle

scoreboard players operation #temp Time = @s Dialog
scoreboard players remove #temp Time 423
execute if entity @s[scores={Dialog=423..482},tag=!vanish] unless score #temp Time matches 0 as @e[tag=this_model,tag=sir_weston_ice,limit=1] at @s run function luigis_mansion:entities/sir_weston/melt_ice
