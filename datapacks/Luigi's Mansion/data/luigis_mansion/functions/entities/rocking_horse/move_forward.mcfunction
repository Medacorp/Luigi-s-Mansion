execute if block ~ ~ ~ minecraft:barrier unless block ^ ^ ^1 minecraft:barrier unless block ^ ^1 ^1 minecraft:barrier run teleport @s ^ ^ ^0.05
execute unless block ^ ^ ^0.6 minecraft:barrier unless block ^ ^1 ^0.6 minecraft:barrier run teleport @s ^ ^ ^0.05
