...
execute at @s[tag=!held] run scoreboard players set @a[distance=..1,tag=!spectator] ForcedDamage -1
execute at @s[tag=!held] as @a[distance=..1,tag=!spectator] run function luigis_mansion:entities/player/knockback/small
