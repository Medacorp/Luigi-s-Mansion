...
execute at @s[scores={ActionTime=20},tag=spin_attack] run effect give @a[distance=..2,gamemode=!spectator] minecraft:instant_damage 1 0 true
execute at @s[scores={ActionTime=20},tag=spin_attack] run scoreboard players set @a[distance=..2,gamemode=!spectator] ForcedDamage 4
execute at @s[scores={ActionTime=20},tag=spin_attack,tag=stop_dancing] unless entity @a[distance=..2,gamemode=!spectator] run tag @s add complain
execute at @s[scores={ActionTime=20},tag=spin_attack,tag=stop_dancing] if entity @a[distance=..2,gamemode=!spectator] run scoreboard players set @s WaitTime 40
...
execute at @s[scores={ActionTime=20},tag=!spin_attack] positioned ^ ^ ^0.7 run effect give @a[distance=..1,gamemode=!spectator] minecraft:instant_damage 1 0 true
execute at @s[scores={ActionTime=20},tag=!spin_attack] positioned ^ ^ ^0.7 run scoreboard players set @a[distance=..1,gamemode=!spectator] ForcedDamage 4
execute at @s[scores={ActionTime=20},tag=!spin_attack,tag=stop_dancing] positioned ^ ^ ^0.7 unless entity @a[distance=..1,gamemode=!spectator] run tag @s add complain
execute at @s[scores={ActionTime=20},tag=!spin_attack,tag=stop_dancing] positioned ^ ^ ^0.7 if entity @a[distance=..1,gamemode=!spectator] run scoreboard players set @s WaitTime 40
