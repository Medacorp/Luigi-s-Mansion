...
execute if entity @s[scores={AnimationProg=1..2}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.05 ~ ~ ~
teleport @s[scores={AnimationProg=3..7}] ~ ~-0.5 ~ ~ ~
execute if entity @s[scores={AnimationProg=3..7}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1 ~ ~ ~
teleport @s[scores={AnimationProg=8..10}] ~ ~-0.55 ~ ~ ~
execute if entity @s[scores={AnimationProg=8..10}] run teleport @e[tag=this_model,tag=body,limit=1] ~ ~-1.05 ~ ~ ~
...
execute if entity @s[scores={AnimationProg=6..10}] store result entity @e[tag=this_model,tag=body,limit=1] Pose.RightArm[0] float 1 run scoreboard players remove #temp Time 2
