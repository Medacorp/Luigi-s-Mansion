# Move with
teleport @s[tag=!sneak_pos,nbt=!{Small:1b}] ^-.35 ^-1.7 ^ ~ ~
teleport @s[tag=sneak_pos,nbt=!{Small:1b}] ^-.35 ^-1.76 ^ ~ ~
teleport @s[tag=!sneak_pos,nbt={Small:1b}] ^-.24 ^-0.9 ^ ~ ~
teleport @s[tag=sneak_pos,nbt={Small:1b}] ^-.24 ^-0.96 ^ ~ ~
