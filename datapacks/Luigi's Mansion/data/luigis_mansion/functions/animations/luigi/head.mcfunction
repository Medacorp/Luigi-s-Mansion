...
data modify entity @s[tag=dark_room] ArmorItems[3].tag.CustomModelData set value 20
data modify entity @s[tag=!dark_room] ArmorItems[3].tag.CustomModelData set value 19
