...
execute if entity @s[tag=sneaking,tag=!looking_at_map] run function luigis_mansion:animations/luigi/sneaking/left_leg
...
execute at @s[scores={KnockbackType=-2}] run function luigis_mansion:animations/luigi/scared/bashed/left_leg
...
execute at @s[scores={KnockbackType=7..8}] run function luigis_mansion:animations/luigi/knockback/grab/left_leg
execute at @s[scores={KnockbackType=9}] run function luigis_mansion:animations/luigi/knockback/bite/left_leg
