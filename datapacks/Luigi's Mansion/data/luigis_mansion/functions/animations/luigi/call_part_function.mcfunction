...
execute if entity @s[tag=source,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/source
execute if entity @s[tag=left_leg,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/left_leg
execute if entity @s[tag=right_leg,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/right_leg
execute if entity @s[tag=left_arm,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/left_arm
execute if entity @s[tag=right_arm,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/right_arm
execute if entity @s[tag=chest,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/chest
execute if entity @s[tag=head,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/head
execute if entity @s[tag=poltergust_body,tag=revive_animation] run function luigis_mansion:animations/luigi/revive/chest