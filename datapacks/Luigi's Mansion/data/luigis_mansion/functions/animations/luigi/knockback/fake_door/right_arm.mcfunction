...
execute if entity @s[scores={AnimationProg=6..15},tag=!left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 400
execute if entity @s[scores={AnimationProg=111..120},tag=left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 225
execute if entity @s[scores={AnimationProg=111..120},tag=!left_door] store result entity @s Pose.Head[1] float 0.01 run scoreboard players add #temp Time 450
