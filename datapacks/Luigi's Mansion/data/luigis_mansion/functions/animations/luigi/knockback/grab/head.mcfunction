...
execute if entity @s[scores={AnimationProg=1..16}] store result entity @s Pose.Head[0] float 1 run scoreboard players set #temp Time -10
scoreboard players reset #temp Time
data merge entity @s[scores={AnimationProg=16}] {Pose:{Head:[-10.0f,0.0f,0.01f]}}
data merge entity @s[scores={AnimationProg=16},tag=flipped_gravity] {Pose:{Head:[-10.0f,0.0f,-180.0f]}}
