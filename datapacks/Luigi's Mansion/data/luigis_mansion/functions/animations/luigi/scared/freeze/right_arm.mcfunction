...
execute if entity @s[scores={AnimationProg=1..30}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=71..80}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players add #temp Time 9
execute store result score #temp Time run data get entity @s Pose.Head[2] 10
...
execute if entity @s[scores={AnimationProg=79..80}] store result entity @s Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
