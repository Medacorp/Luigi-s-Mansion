...
execute unless entity @s[scores={HomeX=0,HomeZ=0}] at @s[tag=!looking_at_map] positioned ^ ^-1.65 ^.25 rotated as @a[tag=this_luigi,limit=1] rotated ~ 0 positioned ^ ^ ^-0.5 if entity @a[tag=this_luigi,limit=1,distance=..0.49] run tag @s add moving_backwards
execute unless entity @s[scores={HomeX=0,HomeZ=0}] at @s[tag=!looking_at_map,tag=!moving_backwards] facing entity @a[tag=this_luigi,limit=1] feet rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
execute at @s[tag=!looking_at_map,tag=moving_backwards] rotated as @a[tag=this_luigi,limit=1] rotated ~ 0 run teleport @s ~ ~ ~ ~ ~
