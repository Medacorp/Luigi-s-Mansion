...
execute if entity @s[scores={AnimationProg=15..19}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 12
