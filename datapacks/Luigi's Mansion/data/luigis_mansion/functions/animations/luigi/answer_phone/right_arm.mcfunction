...
execute at @s if score #mirrored Selected matches 0 rotated ~ 0 run teleport @s[scores={AnimationProg=17..},tag=!flipped_gravity,nbt=!{Small:1b}] ^ ^-0.2 ^-0.2
execute at @s if score #mirrored Selected matches 0 rotated ~ 0 run teleport @s[scores={AnimationProg=17..},tag=!flipped_gravity,nbt={Small:1b}] ^ ^-0.1 ^-0.1
execute at @s if score #mirrored Selected matches 0 rotated ~ 0 run teleport @s[scores={AnimationProg=17..},tag=flipped_gravity,nbt=!{Small:1b}] ^ ^0.2 ^-0.2
execute at @s if score #mirrored Selected matches 0 rotated ~ 0 run teleport @s[scores={AnimationProg=17..},tag=flipped_gravity,nbt={Small:1b}] ^ ^0.1 ^-0.1
...
execute if entity @s[scores={AnimationProg=1..5}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 20
...
execute if entity @s[scores={AnimationProg=21..30}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[2] float 0.1 run scoreboard players remove #temp Time 5
execute if entity @s[scores={AnimationProg=31..40}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[2] float 0.1 run scoreboard players add #temp Time 5
