...
execute at @s if score #mirrored Selected matches 0 run teleport @s[scores={AnimationProg=17..},tag=!flipped_gravity,nbt=!{Small:1b}] ~ ~-0.2 ~
execute at @s if score #mirrored Selected matches 0 run teleport @s[scores={AnimationProg=17..},tag=!flipped_gravity,nbt={Small:1b}] ~ ~-0.1 ~ 
execute at @s if score #mirrored Selected matches 0 run teleport @s[scores={AnimationProg=17..},tag=flipped_gravity,nbt=!{Small:1b}] ~ ~0.2 ~
execute at @s if score #mirrored Selected matches 0 run teleport @s[scores={AnimationProg=17..},tag=flipped_gravity,nbt={Small:1b}] ~ ~0.1 ~ 
