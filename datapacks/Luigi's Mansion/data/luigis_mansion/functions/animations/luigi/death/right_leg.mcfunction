...
execute at @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 run teleport @s[tag=!flipped_gravity] ^0.072 ^-0.028 ^
execute at @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 run teleport @s[tag=flipped_gravity] ^-0.072 ^0.028 ^
...
execute if entity @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[2] float 1 run scoreboard players add #temp Time 5
...
execute if entity @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 0 store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 4
execute if entity @s[scores={DeathTime=31..40}] if score #mirrored Selected matches 1 store result entity @s Pose.Head[0] float 1 run scoreboard players add #temp Time 2
