...
data merge entity @s[scores={AnimationProg=1}] {Pose:{Head:[20.0f,-180.0f,-70.0f]}}
data merge entity @s[scores={AnimationProg=1},tag=flipped_gravity] {Pose:{Head:[20.0f,-180.0f,110.0f]}}
