...
data merge entity @e[tag=this_model,tag=right_arm,limit=1] {Pose:{Head:[-90.0f,20.0f,0.01f]}}
data merge entity @e[tag=this_model,tag=left_arm,limit=1] {Pose:{Head:[-110.0f,-35.0f,0.01f]}}