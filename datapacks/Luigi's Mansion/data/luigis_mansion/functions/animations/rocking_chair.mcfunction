...
execute if entity @s[scores={AnimationProg=30}] run playsound luigis_mansion:entity.rocking_chair.move_backward hostile @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={AnimationProg=70}] run playsound luigis_mansion:entity.rocking_chair.move_forward hostile @a[tag=same_room] ~ ~ ~ 1
