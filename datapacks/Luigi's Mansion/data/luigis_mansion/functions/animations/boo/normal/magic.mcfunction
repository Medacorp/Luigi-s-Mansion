...
data modify entity @s[scores={AnimationProg=160,ActionTime=4},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:51}
data modify entity @s[scores={AnimationProg=160,ActionTime=5},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:52}
data modify entity @s[scores={AnimationProg=160,ActionTime=6},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:53}
data modify entity @s[scores={AnimationProg=160,ActionTime=7},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:54}
data modify entity @s[scores={AnimationProg=160,ActionTime=8},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:55}
data modify entity @s[scores={AnimationProg=160,ActionTime=9},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:56}
data modify entity @s[scores={AnimationProg=160,ActionTime=10},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:57}
data modify entity @s[scores={AnimationProg=160,ActionTime=11},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:58}
data modify entity @s[scores={AnimationProg=160,ActionTime=12},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:59}
data modify entity @s[scores={AnimationProg=160,ActionTime=13},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:60}
data modify entity @s[scores={AnimationProg=160,ActionTime=14},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:61}
data modify entity @s[scores={AnimationProg=160,ActionTime=15},tag=boolossus] ArmorItems[3].tag merge value {CustomModelData:62}
