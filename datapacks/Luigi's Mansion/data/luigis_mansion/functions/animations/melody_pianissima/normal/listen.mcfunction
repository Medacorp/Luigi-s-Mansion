...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=melody_pianissima_right_arm,limit=1] {Pose:{Head:[-70.0f,-20.0f,0.01f]}}
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,tag=melody_pianissima_left_arm,limit=1] {Pose:{Head:[-40.0f,20.0f,0.01f]}}
