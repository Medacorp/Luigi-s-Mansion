...
execute if entity @s[scores={AnimationProg=1..160}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 0.01 run scoreboard players remove #temp Time 675
execute store result score #temp Time run data get entity @s Pose.Head[1]
execute if entity @s[scores={AnimationProg=221..225}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=226..235}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProg=236..240}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
