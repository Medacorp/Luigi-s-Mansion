...
execute if entity @s[scores={AnimationProg=1}] run data merge entity @e[tag=this_model,limit=1] {Pose:{RightArm:[0.0f,0.0f,0.01f],LeftArm:[0.0f,0.0f,0.01f],Head:[-10.0f,0.0f,0.0f]}}
...
execute if entity @s[scores={AnimationProg=1..3}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProg=4..9}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProg=10..12}] store result entity @e[tag=this_model,limit=1] Pose.Head[0] float 1 run scoreboard players remove #temp Time 2
execute store result score #temp Time run data get entity @e[tag=this_model,limit=1] Pose.RightArm[0]
execute if entity @s[scores={AnimationProg=1..3}] store result entity @e[tag=this_model,limit=1] Pose.RightArm[0] float 1 run scoreboard players add #temp Time 20
execute if entity @s[scores={AnimationProg=4..9}] store result entity @e[tag=this_model,limit=1] Pose.RightArm[0] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProg=10..12}] store result entity @e[tag=this_model,limit=1] Pose.RightArm[0] float 1 run scoreboard players add #temp Time 20
execute store result score #temp Time run data get entity @e[tag=this_model,limit=1] Pose.LeftArm[0]
execute if entity @s[scores={AnimationProg=1..3}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 20
execute if entity @s[scores={AnimationProg=4..9}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[0] float 1 run scoreboard players add #temp Time 20
execute if entity @s[scores={AnimationProg=10..12}] store result entity @e[tag=this_model,limit=1] Pose.LeftArm[0] float 1 run scoreboard players remove #temp Time 20
