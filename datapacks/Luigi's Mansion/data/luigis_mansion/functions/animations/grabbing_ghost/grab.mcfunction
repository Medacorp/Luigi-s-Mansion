...
execute if entity @s[scores={AnimationProg=1..18}] store result entity @s Pose.RightArm[0] float 0.1 run scoreboard players remove #temp Time 5
execute store result score #temp Time run data get entity @s Pose.LeftArm[0] 10
execute if entity @s[scores={AnimationProg=1..18}] store result entity @s Pose.LeftArm[0] float 0.1 run scoreboard players remove #temp Time 5
