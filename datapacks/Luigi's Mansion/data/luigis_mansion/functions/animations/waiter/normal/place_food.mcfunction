...
data modify entity @s[scores={AnimationProg=3}] HandItems[0].tag.CustomModelData set value 89
data modify entity @s[scores={AnimationProg=5}] HandItems[1].tag.CustomModelData set value 89
