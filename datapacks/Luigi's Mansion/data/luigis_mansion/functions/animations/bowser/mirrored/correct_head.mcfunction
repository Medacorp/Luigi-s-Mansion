...
execute if entity @s[scores={AnimationProg=21..30}] store result entity @s Pose.Head[0] float 1 run scoreboard players remove #temp Time 10
execute store result score #temp Time run data get entity @s Pose.Head[1]
execute if entity @s[scores={AnimationProg=21..30}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 18
...
execute if entity @s[scores={AnimationProg=21..30}] store result entity @e[tag=this_model,tag=right_arm,limit=1] Pose.Head[1] float 0.1 run scoreboard players add #temp Time 14
...
execute if entity @s[scores={AnimationProg=21..30}] store result entity @e[tag=this_model,tag=left_arm,limit=1] Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 14
