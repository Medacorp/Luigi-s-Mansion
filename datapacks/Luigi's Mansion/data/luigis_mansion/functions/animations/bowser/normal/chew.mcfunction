...
execute if entity @s[scores={AnimationProg=1..20}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 7
...
execute if entity @s[scores={AnimationProg=41..60}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players remove #temp Time 30
execute if entity @s[scores={AnimationProg=61..80}] store result entity @s Pose.Head[1] float 0.1 run scoreboard players add #temp Time 15
