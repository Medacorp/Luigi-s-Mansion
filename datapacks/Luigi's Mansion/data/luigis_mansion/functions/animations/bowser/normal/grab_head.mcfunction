...
execute if entity @s[scores={AnimationProg=11..15}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 3
execute if entity @s[scores={AnimationProg=16..25}] store result entity @s Pose.Head[1] float 1 run scoreboard players remove #temp Time 3
execute if entity @s[scores={AnimationProg=26..30}] store result entity @s Pose.Head[1] float 1 run scoreboard players add #temp Time 3
...
execute if entity @s[scores={ActionTime=11}] run playsound luigis_mansion:entity.bowser.grab_head hostile @a[tag=same_room] ~ ~ ~ 3
