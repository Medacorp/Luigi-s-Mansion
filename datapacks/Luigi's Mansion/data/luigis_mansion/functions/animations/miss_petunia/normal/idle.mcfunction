...
execute if entity @s[scores={AnimationProg=1..5}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 10
execute if entity @s[scores={AnimationProg=6..15}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players remove #temp Time 10
execute if entity @s[scores={AnimationProg=16..20}] store result entity @e[tag=this_model,tag=!miss_petunia_shadow,tag=right_arm,limit=1] Pose.Head[1] float 1 run scoreboard players add #temp Time 10
