...
execute if entity @s[scores={Dialog=1}] run fill 690 3 15 688 6 15 minecraft:moving_piston
execute if entity @s[scores={Dialog=1}] run fill 690 3 16 688 7 19 minecraft:water[level=8] replace minecraft:water
