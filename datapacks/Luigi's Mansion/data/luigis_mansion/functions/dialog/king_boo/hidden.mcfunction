...
execute if entity @s[scores={Dialog=1895..}] positioned 635 94 33 if entity @a[distance=..0.7,gamemode=!spectator,limit=1] as @a run function luigis_mansion:room/hidden/king_boo_battle/warp_to