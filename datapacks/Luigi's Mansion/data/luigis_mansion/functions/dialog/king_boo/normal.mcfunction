...
execute if entity @s[scores={Dialog=776}] run playsound luigis_mansion:entity.king_boo.laugh_2 hostile @a[tag=same_room] ~ ~ ~ 1
...
tag @s[scores={Dialog=1596}] add magic
scoreboard players set @s[scores={Dialog=1596}] AnimationProg 0
execute if entity @s[scores={Dialog=1596}] run function #luigis_mansion:room/normal/secret_altar/turn_lights/off
execute if entity @s[scores={Dialog=1596}] run playsound luigis_mansion:entity.king_boo.magic hostile @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=1895..}] positioned 635 94 -18 if entity @a[distance=..0.7,gamemode=!spectator,limit=1] as @a run function luigis_mansion:room/normal/king_boo_battle/warp_to