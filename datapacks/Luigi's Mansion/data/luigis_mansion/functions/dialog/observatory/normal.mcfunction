...
execute if entity @s[scores={Dialog=22}] run summon minecraft:marker 643 21 -89 {Tags:["observatory_facing"],Rotation:[-180.0f,0.0f]}
teleport @s[scores={Dialog=1..21}] 643 20 -80 -180 0
execute if entity @s[scores={Dialog=22}] run setblock 643 20 -89 minecraft:barrier
execute if entity @s[scores={Dialog=300}] run setblock 643 20 -89 minecraft:air
...
teleport @s[scores={Dialog=222..299}] 643 21 -89 107.2 3.8
...
execute if entity @s[scores={Dialog=340}] run function luigis_mansion:room/normal/observatory/destroy
