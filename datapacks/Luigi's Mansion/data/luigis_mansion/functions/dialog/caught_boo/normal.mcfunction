...
execute if entity @s[scores={GBHDialog=112,Variant=-4}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.ohmoogah_luigi_odoh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={GBHDialog=10378,Variant=-2}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.bohh_squirtbottlelaugh neutral @s ~ ~ ~ 1
