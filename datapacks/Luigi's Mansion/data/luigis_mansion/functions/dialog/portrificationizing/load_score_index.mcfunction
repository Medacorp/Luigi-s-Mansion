...
execute if score #temp Time matches 1 run data modify storage luigis_mansion:data current_high_score set from storage luigis_mansion:data high_scores[-1]
