...
execute if entity @s[scores={Dialog=1}] run playsound luigis_mansion:block.boo_hatch block @a[tag=same_room] 685 11 61 1
...
execute if entity @s[scores={Dialog=140}] as @a[tag=same_room] positioned 685 10 61 run function luigis_mansion:entities/player/scare/bash_no_move
