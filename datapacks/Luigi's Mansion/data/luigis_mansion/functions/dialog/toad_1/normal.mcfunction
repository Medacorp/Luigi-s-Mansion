...
execute if entity @s[scores={Dialog=1..1284}] as @a[tag=same_room] unless entity @s[scores={MusicGroup=0,MusicType=10}] run function luigis_mansion:other/music/set/toad
...
execute if entity @s[scores={Dialog=1062}] run function luigis_mansion:room/normal/foyer/clear
execute if entity @s[scores={Dialog=1062}] run function luigis_mansion:room/normal/hallway_1/clear
...
execute if entity @s[scores={Dialog=1284}] run scoreboard players set @a Toad1Choice 
