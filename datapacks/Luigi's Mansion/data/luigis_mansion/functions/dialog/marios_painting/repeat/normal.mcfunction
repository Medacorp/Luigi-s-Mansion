...
execute if entity @s[scores={Dialog=1..252,IdleTime=0..},tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/stand_still
...
execute if entity @s[scores={Dialog=1..}] positioned 648 93 -10 run function luigis_mansion_3ds_remake:entities/player/set_position
