...
execute if entity @s[scores={Dialog=624}] run data modify storage luigis_mansion:data rooms.gallery merge value {cleared:1b}
execute if entity @s[scores={Dialog=624}] run advancement grant @a until luigis_mansion:lab/gallery
execute if entity @s[scores={Dialog=624}] if entity @a[tag=looking_at_map,limit=1] run function luigis_mansion:items/gameboy_horror/map/display/lab/gallery
tag @s[scores={Dialog=624}] remove talk
