...
execute if entity @s[scores={Dialog=82..209}] if entity @a[scores={EGaddGallChoice=1}] as @a[tag=same_room,tag=!spectator,tag=!thinking,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/thinking
...
execute if entity @s[scores={Dialog=210}] if entity @a[scores={EGaddGallChoice=1}] as @a[tag=same_room,tag=!spectator,tag=!nod,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/nod
...
execute if entity @s[scores={Dialog=514..1217}] if entity @a[scores={EGaddGallChoice=1}] as @a[tag=same_room,tag=!spectator,tag=!high_health_idle,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/high_health_idle_no_sound
...
execute if entity @s[scores={Dialog=1218}] if entity @a[scores={EGaddGallChoice=1}] as @a[tag=same_room,tag=!spectator,tag=!stand_still,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/stand_still
...
execute if entity @s[scores={Dialog=834}] if entity @a[scores={EGaddGallChoice=2}] as @a[tag=same_room,tag=!spectator,tag=!enthusiastic,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/enthusiastic
execute if entity @s[scores={Dialog=854}] if entity @a[scores={EGaddGallChoice=2}] run scoreboard players set @s Dialog 1354
...
execute if entity @s[scores={Dialog=126}] if entity @a[scores={EGaddGallChoice=3}] run scoreboard players set @s Dialog 1354
execute if entity @s[scores={Dialog=82..97}] if entity @a[scores={EGaddGallChoice=4}] as @a[tag=same_room,tag=!spectator,tag=!thinking,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/thinking
