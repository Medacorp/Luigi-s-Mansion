summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion:entity.spooky"}',Invisible:1b,NoGravity:1b,CustomNameVisible:0b,Marker:0b,Invulnerable:1b,ArmorItems:[{},{},{},{}],Pose:{Head:[0.0f,0.0f,0.01f]},Tags:["spooky","portrait_ghost","pearl_dropper","ghost","this_entity"],DisabledSlots:2039583}
...
scoreboard players set @e[tag=spooky,tag=this_entity,limit=1] HealthOffset 5
