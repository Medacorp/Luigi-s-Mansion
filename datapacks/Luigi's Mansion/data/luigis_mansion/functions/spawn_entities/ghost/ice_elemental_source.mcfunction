summon minecraft:marker ~ ~ ~ {CustomName:'{"translate":"luigis_mansion:entity.ice_elemental_source"}',NoGravity:1b,Marker:1b,CustomNameVisible:0b,Invulnerable:1b,Tags:["elemental_source","ice","enabled","this_entity"]}
