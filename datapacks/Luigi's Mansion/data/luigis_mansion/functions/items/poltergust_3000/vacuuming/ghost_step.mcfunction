...
execute unless entity @s[distance=..0.7] if score #temp Steps matches 15 run function luigis_mansion:items/poltergust_3000/vacuuming/detach
execute unless entity @s[distance=..0.7] if score #temp Steps matches ..14 positioned ^ ^ ^0.5 run function luigis_mansion:items/poltergust_3000/vacuuming/ghost_step