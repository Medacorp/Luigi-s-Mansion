...
execute positioned as @s[tag=elemental_ghost,scores={SpawnTime=21..}] if entity @a[tag=me,distance=..1.2,limit=1] run function luigis_mansion:items/poltergust_3000/latch_onto_ghost
