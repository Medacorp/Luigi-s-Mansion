...
execute if entity @s[tag=this_room,tag=!vacuumable] run playsound luigis_mansion:item.poltergust_3000.vaporize player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=this_room,tag=vacuumable] run playsound luigis_mansion:item.poltergust_3000.vaporize_vacuumable player @a[tag=same_room] ~ ~ ~ 1
