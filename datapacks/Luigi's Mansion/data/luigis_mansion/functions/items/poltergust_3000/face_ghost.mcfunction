execute as @e[tag=ghost,tag=being_vacuumed] run function luigis_mansion:items/poltergust_3000/face_ghost/add_to_average
...
execute as @e[tag=temp,limit=1] run function luigis_mansion:items/poltergust_3000/face_ghost/get_average
