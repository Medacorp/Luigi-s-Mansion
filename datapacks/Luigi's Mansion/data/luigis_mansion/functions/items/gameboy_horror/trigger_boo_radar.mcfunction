...
execute unless entity @e[tag=radar_detect,distance=..4] if entity @s[nbt=!{Inventory:[{tag:{Damage:4,luigis_mansion:{id:"luigis_mansion:gameboy_horror"}}}]}] run function luigis_mansion:items/gameboy_horror/turn_radar_yellow
execute if entity @e[tag=radar_detect,distance=..4] if entity @s[nbt=!{Inventory:[{tag:{Damage:5,luigis_mansion:{id:"luigis_mansion:gameboy_horror"}}}]}] run function luigis_mansion:items/gameboy_horror/turn_radar_red