...
execute at @e[tag=target,tag=!spooky,type=!minecraft:player] run particle minecraft:dust 0.7 1 1 1 ~ ~0.6 ~ 0.3 0.3 0.3 0 5 normal @s
execute at @e[tag=target,tag=spooky,type=!minecraft:player] run particle minecraft:dust 0.7 1 1 1 ~ ~1.6 ~ 0.3 0.3 0.3 0 5 normal @s
