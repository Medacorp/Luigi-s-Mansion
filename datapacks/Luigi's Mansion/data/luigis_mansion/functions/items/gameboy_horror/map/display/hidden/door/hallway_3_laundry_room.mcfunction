execute unless data storage luigis_mansion:data current_state.current_data.used_keys{laundry_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3703 60 -23 clockwise_90
execute if data storage luigis_mansion:data current_state.current_data.used_keys{laundry_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3703 60 -23 clockwise_90
