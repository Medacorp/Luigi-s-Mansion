execute unless data storage luigis_mansion:data {used_parlor_key:1b} run place template luigis_mansion:gameboy_horror_map/door/double_locked 3698 110 6
execute if data storage luigis_mansion:data {used_parlor_key:1b} run place template luigis_mansion:gameboy_horror_map/door/double_unlocked 3698 110 6
