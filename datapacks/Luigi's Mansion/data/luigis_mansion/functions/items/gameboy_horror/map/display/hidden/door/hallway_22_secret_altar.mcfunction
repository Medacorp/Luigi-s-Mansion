execute unless data storage luigis_mansion:data current_state.current_data.used_keys{secret_altar:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3653 10 32
execute if data storage luigis_mansion:data current_state.current_data.used_keys{secret_altar:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3653 10 32
