execute unless data storage luigis_mansion:data current_state.current_data.used_keys{billiards_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_locked 3671 60 -4
execute if data storage luigis_mansion:data current_state.current_data.used_keys{billiards_room:1b} run place template luigis_mansion:gameboy_horror_map/door/single_unlocked 3671 60 -4
