...
execute unless entity @s[scores={IdleTime=..-1},tag=!idle] if entity @s[tag=!small_second_run,nbt={Inventory:[{tag:{luigis_mansion:{id:"luigis_mansion:flashlight"}}}]}] run function #luigis_mansion:items/flashlight/types
