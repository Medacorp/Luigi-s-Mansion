...
execute at @s[scores={Shrunk=0},nbt={OnGround:0b,ActiveEffects:[{Id:25b}]}] rotated ~ 0 run summon minecraft:marker ^ ^0.1 ^1 {Tags:["interact","manual","check","1","up"]}
execute at @s[scores={Shrunk=0},nbt={OnGround:0b,ActiveEffects:[{Id:25b}]}] rotated ~ 0 run summon minecraft:marker ^ ^1.1 ^1 {Tags:["interact","manual","check","2"]}
execute at @s[scores={Shrunk=0},nbt={OnGround:0b,ActiveEffects:[{Id:25b}]}] rotated ~ 0 run summon minecraft:marker ^ ^-0.9 ^1 {Tags:["interact","manual","check","3"]}
...
execute if entity @e[tag=interact,tag=manual,tag=can_interact,tag=1,limit=1] run tag @s add 1
execute if entity @e[tag=interact,tag=manual,tag=can_interact,tag=2,limit=1] run tag @s[tag=!1] add 2
...
execute unless entity @s[scores={InteractionTime=1..}] unless entity @s[scores={YellTime=1..}] run function #luigis_mansion:room/yell
