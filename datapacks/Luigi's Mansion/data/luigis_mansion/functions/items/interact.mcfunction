...
execute if entity @s[scores={UseItem=1..},nbt={SelectedItem:{tag:{luigis_mansion:{id:"luigis_mansion:interact"}}}}] unless entity @s[scores={InteractionTime=1..}] run function luigis_mansion:items/interact/trigger
