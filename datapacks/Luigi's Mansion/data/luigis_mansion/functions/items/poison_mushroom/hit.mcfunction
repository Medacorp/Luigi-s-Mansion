...
execute if score #temp ActionTime matches 1.. if entity @s[scores={Room=1..}] positioned ~ ~1 ~ as @e[tag=gold_coin,distance=..0.7] unless entity @s[scores={SpawnedTime=1..}] run scoreboard players set @s SpawnedTime 100
